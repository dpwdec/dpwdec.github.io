...
And that's it! You should now have a basic image upload system ready and working! You could now look into expanding the upload capabilities or refactoring the upload system to use asynchronous calls for a more fluid user experience, it's up to you! If you want to see the full code and all the commits you can find it on my github [here](https://github.com/dpwdec/express-image-upload). Enjoy!
<!--stackedit_data:
eyJoaXN0b3J5IjpbMTczNTY2ODg0MV19
-->