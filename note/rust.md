...
You can **use absolute module references** by using the `crate` keyword at the beginning of the reference path.
```rust
mod some_module {
  // ---snip---
}

crate::some_module::another_module
```
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTIwMjA1OTc0NjksMTM4MzIwODg3MCwxMT
