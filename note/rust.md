...
### External Files
You can **import a file from the same directory as your project's `main` file** by referencing it with `crate`
...
`life times`
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTQ2MzU2MDkxMSwtMTA2OTU2ODg5NiwxOT
