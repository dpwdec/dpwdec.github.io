...
You can **assert that something is true** in several ways: By using the `IsTrue` method on `Assert`. By using the 
```csharp
Assert.IsTrue(true); // => passes
```
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTM5Nzg4MTY2MywtMTczMjA3MjU3NCwxMj
