...
You can use strum to **deserialize an enum from a string representation** by using the `EnumString` trait with the `std::str:;FromStr`
...
```
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTIxNDcwODMwMTAsMTM5ODk4OTU3Ml19
-->