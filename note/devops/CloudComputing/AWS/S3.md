...
You can **host the contents of a bucket as a static website** by going to `Properties -> Static Website Hosting -> Edit` and setting your `
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbMTA1NTg1NDAwNiwtNDI2MjA2ODM2LC0xNz
