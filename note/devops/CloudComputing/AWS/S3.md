...
You can **make all objects in a bucket public** by going to the `Permissions` tab of the bucket and then editing the `Bucket Policy` section.
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTEyNjYzOTU1MDgsLTE3ODA0MzE0NTcsMz
