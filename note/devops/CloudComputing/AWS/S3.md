...
There is **read after write consistency** for `PUT` on new objects.

There is **eventual consistency** for overwrite `PUT` and `DELETE` 




<!--stackedit_data:
eyJoaXN0b3J5IjpbLTE1ODU0Mzc2NjEsLTk0MDQ4NjIxNiwxNj
