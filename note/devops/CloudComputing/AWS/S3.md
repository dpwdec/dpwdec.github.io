...
You can **access objects from S3** using the `getObjects` method on the `S3` object. This is an asynchronous function that takes the `bucketName` (as it appears in the bucket) and a path to the object you want to access.
```js
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTM5NzU3MjU1OCwyMTQzNTk1Nzk5LC0xMD
