...
If you make everything in a bucket public you should see an warning in the buckets section showing `Access` as `Public`.

You can **host the contents of a bucket as a static website** by going to `Properties -> Static Website Hosting -> Edit` and setting your `index` and `error` page HTML documents as entry points for your site.
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbMTYwMDE4NDY3NywtNDI2MjA2ODM2LC0xNz
gwNDMxNDU3LDM3MTQ0OTc3NywtMTMyMzc2MDQxMCw4NzMxOTY1
MTAsMTY2Njk4MzE1MywtMTc2Njk0MTQ0MywxMDY1MDIxNDI0LC
04NzgxODA2MSw2NDc3NjEzOCwyMDg5MzgzMjAsLTk0MDQ4NjIx
NiwxNjgwMDE0OTk2LC0yMTIyNjQ1NDA0LC0xOTExOTgzMDddfQ
==
-->