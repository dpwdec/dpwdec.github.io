...
**Transfer Acceleration** is used for speeding up and securing long distance file transfers between users and an S3 b
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTU1NTEyODM4OSwtODc4MTgwNjEsNjQ3Nz
