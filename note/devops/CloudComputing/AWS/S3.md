...
You can **access objects from S3** using the `getObjects` method on the `S3` object. This is an asynchronous function that takes an object `Bucket` property that describes the name of the bucket, and a `Key` property which is a path to the object you want to access.
```js
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTEwNDE0OTg2NTMsMjE0MzU5NTc5OSwtMT
A2NzU0Nzg0OSwtNDI2MjA2ODM2LC0xNzgwNDMxNDU3LDM3MTQ0
OTc3NywtMTMyMzc2MDQxMCw4NzMxOTY1MTAsMTY2Njk4MzE1My
wtMTc2Njk0MTQ0MywxMDY1MDIxNDI0LC04NzgxODA2MSw2NDc3
NjEzOCwyMDg5MzgzMjAsLTk0MDQ4NjIxNiwxNjgwMDE0OTk2LC
0yMTIyNjQ1NDA0LC0xOTExOTgzMDddfQ==
-->