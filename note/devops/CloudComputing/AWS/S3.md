...
You can **access S3 specific automation functions**

You can **access objects from S3** using the `getObjects` method on the `S3`
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTE3MTc3NDA3ODEsMjE0MzU5NTc5OSwtMT
