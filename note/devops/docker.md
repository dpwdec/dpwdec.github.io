...
You can **start a container that has stopped** using the `start` command. You can use the container name here or the `CONTAINER ID`.
```bash
...
```
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTExMjEzMDk4MTYsMTc1MzEyOTg5Miw2MT
