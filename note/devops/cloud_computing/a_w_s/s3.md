...
You can **give a cloudfront user access to an S3** using a policy that specifies the ARN of the Cloudfront distribution's access user (*not* the distribution's ARN) as well as an `Action` which
```json
{
    "Version": "2008-10-17",
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTE1OTExODMyNTMsLTIwODQ4Nzc4MjEsNz
Q5NTMwOTc2LDIxNDM1OTU3OTksLTEwNjc1NDc4NDksLTQyNjIw
NjgzNiwtMTc4MDQzMTQ1NywzNzE0NDk3NzcsLTEzMjM3NjA0MT
AsODczMTk2NTEwLDE2NjY5ODMxNTMsLTE3NjY5NDE0NDMsMTA2
NTAyMTQyNCwtODc4MTgwNjEsNjQ3NzYxMzgsMjA4OTM4MzIwLC
05NDA0ODYyMTYsMTY4MDAxNDk5NiwtMjEyMjY0NTQwNCwtMTkx
MTk4MzA3XX0=
-->