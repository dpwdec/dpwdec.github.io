...
If this cookie was sent to the `http://some-website.com/about` then *the cookie will be passed through* and the 
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTE2NDcxMDc0MTAsNTk4Mzk2Mzk2LC0xOT
