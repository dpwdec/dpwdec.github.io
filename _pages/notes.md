...
<ul>
    <div name="contents-index">
        ...
        <l>
            <input type="checkbox" id="eDSEFHpcfd" checked>
            <label for="eDSEFHpcfd">Math</label>
            <ul>
                <l>
                    <input type="checkbox" id="FtLRVFaNKY">
                    <label for="FtLRVFaNKY">Exponentials</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="nWFtixWXHS">
                    <label for="nWFtixWXHS">Linear Algebra</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="sroYVTDLRz">
                    <label for="sroYVTDLRz">Logarithms</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="jWrQBTfvZY">
                    <label for="jWrQBTfvZY">Sequences</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="eynMdVfpYb">
                    <label for="eynMdVfpYb">Single Variable Calculus</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="fupNYEsDyk">
                    <label for="fupNYEsDyk">Trigonometry</label>
                    <ul>
        ...
        <l>
            <input type="checkbox" id="AOHtNNOIaN" checked>
            <label for="AOHtNNOIaN">Programming</label>
            <ul>
                <l>
                    <input type="checkbox" id="TOrOOXxklr">
                    <label for="TOrOOXxklr">Ansible</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="VgKsZnDAFU">
                    <label for="VgKsZnDAFU">Architecture</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="FprJxQxTwq">
                    <label for="FprJxQxTwq">Computer Graphics</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="qskLPWmpMp">
                    <label for="qskLPWmpMp">Databases</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="MwiNDjvnFO">
                    <label for="MwiNDjvnFO">Devops</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="gnaqvyOsHD">
                            <label for="gnaqvyOsHD">Cloud Providers</label>
                            <ul>
                                <l>
                                    <input type="checkbox" id="XrxcsVIJyR">
                                    <label for="XrxcsVIJyR">AWS</label>
                                    <ul>
                                        <l>
                                            <input type="checkbox" id="QTkLuKjLUB">
                                            <label for="QTkLuKjLUB">Cli</label>
                                            <ul>
                                        ...
                                        <l>
                                            <input type="checkbox" id="CAhQzygpmL">
                                            <label for="CAhQzygpmL">Dotnet</label>
                                            <ul>
                                        ...
                                        <l>
                                            <input type="checkbox" id="FEOUOCUHBN">
                                            <label for="FEOUOCUHBN">Ec 2</label>
                                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="nBQGqWGqjv">
                            <label for="nBQGqWGqjv">Events</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="mgTfgjItIL">
                            <label for="mgTfgjItIL">Localstack</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="zBDvxTvkPv">
                            <label for="zBDvxTvkPv">Pulumi</label>
                            <ul>
                                <l>
                                    <input type="checkbox" id="VhmFTUWuma">
                                    <label for="VhmFTUWuma">Dotnet</label>
                                    <ul>
                        ...
                        <l>
                            <input type="checkbox" id="PfDfdhcnvG">
                            <label for="PfDfdhcnvG">Serverless Framework</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="ZJTTjgdPND">
                            <label for="ZJTTjgdPND">Terraform</label>
                            <ul>
                                <l>
                                    <input type="checkbox" id="SEjmmuiDvP">
                                    <label for="SEjmmuiDvP">Functions</label>
                                    <ul>
                                ...
                                <l>
                                    <input type="checkbox" id="PfIpfDWuWc">
                                    <label for="PfIpfDWuWc">Meta Arguments</label>
                                    <ul>
                ...
                <l>
                    <input type="checkbox" id="kMkxhCuZiJ">
                    <label for="kMkxhCuZiJ">Docker</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="fAPjsBDCrA">
                    <label for="fAPjsBDCrA">Dotnet</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="ehPaYgoNqE">
                            <label for="ehPaYgoNqE">Cli</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="qYJrPqTuOk">
                    <label for="qYJrPqTuOk">Functional Programming</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="rPwFegieoo">
                    <label for="rPwFegieoo">Git</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="eWtMUUnvbd">
                            <label for="eWtMUUnvbd">Github</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="dgwYSYZULp">
                    <label for="dgwYSYZULp">Go</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="FWhZFAhIIF">
                    <label for="FWhZFAhIIF">Haskell</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="sMSeUYhHjn">
                    <label for="sMSeUYhHjn">Js</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="fCgaIkrSUO">
                            <label for="fCgaIkrSUO">Node</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="glQCSyIBiA">
                            <label for="glQCSyIBiA">D3</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="XigQjoGeTo">
                            <label for="XigQjoGeTo">Mocha</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="DCfNfNfWTX">
                            <label for="DCfNfNfWTX">P5js</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="hSYBcKrJFx">
                            <label for="hSYBcKrJFx">Typescript</label>
                            <ul>
                                <l>
                                    <input type="checkbox" id="mQthYdLyss">
                                    <label for="mQthYdLyss">Testing</label>
                                    <ul>
                ...
                <l>
                    <input type="checkbox" id="NnmnYoqAtG">
                    <label for="NnmnYoqAtG">Kafka</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="YArnjuGCIL">
                    <label for="YArnjuGCIL">Kubernetes</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="LiGdONNpxf">
                    <label for="LiGdONNpxf">Language</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="xDDUoXZrna">
                    <label for="xDDUoXZrna">Linux</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="xBxvMtWsLP">
                            <label for="xBxvMtWsLP">Bash</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="iMxWabOcXk">
                    <label for="iMxWabOcXk">Oauth</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="fASPnCgCTt">
                    <label for="fASPnCgCTt">Prometheus</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="DxwihQKyro">
                    <label for="DxwihQKyro">Python</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="btPkjaqMmU">
                            <label for="btPkjaqMmU">Data Classes</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="eJXQmKtWUv">
                            <label for="eJXQmKtWUv">Libraries</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="pPHnnkhhUq">
                    <label for="pPHnnkhhUq">React</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="kMesTqYUoV">
                    <label for="kMesTqYUoV">Regular Expressions</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="ykufozDZKB">
                    <label for="ykufozDZKB">Rust</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="EIuyYxgBoP">
                            <label for="EIuyYxgBoP">Serde</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="uTGDFdgFqP">
                    <label for="uTGDFdgFqP">Shaders</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="gkocdtsaix">
                            <label for="gkocdtsaix">Glsl</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="vZhgvxmtoW">
                    <label for="vZhgvxmtoW">Vim</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="vOLpNnYvpI">
                    <label for="vOLpNnYvpI">Web</label>
                    <ul>
