...
<ul>
    <div name="contents-index">
        ...
        <l>
            <input type="checkbox" id="UvhQDFrfjB" checked>
            <label for="UvhQDFrfjB">Math</label>
            <ul>
                <l>
                    <input type="checkbox" id="kSCWcxVlTr">
                    <label for="kSCWcxVlTr">Exponentials</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="uVlCGFODfw">
                    <label for="uVlCGFODfw">Linear Algebra</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="SUiHgMIDVW">
                    <label for="SUiHgMIDVW">Logarithms</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="aPhTVYINEe">
                    <label for="aPhTVYINEe">Sequences</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="roJchZWWKY">
                    <label for="roJchZWWKY">Single Variable Calculus</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="ZxCUWIkiXr">
                    <label for="ZxCUWIkiXr">Trigonometry</label>
                    <ul>
        ...
        <l>
            <input type="checkbox" id="fpogrEYpbI" checked>
            <label for="fpogrEYpbI">Programming</label>
            <ul>
                <l>
                    <input type="checkbox" id="OSHihmrJVg">
                    <label for="OSHihmrJVg">Ansible</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="LjKzvHVIxv">
                    <label for="LjKzvHVIxv">Architecture</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="HQecyKDCKZ">
                    <label for="HQecyKDCKZ">Computer Graphics</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="cgGRFfNfoy">
                    <label for="cgGRFfNfoy">Databases</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="wAYnEDJUvf">
                    <label for="wAYnEDJUvf">Devops</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="xAfparSgGn">
                            <label for="xAfparSgGn">Cloud Providers</label>
                            <ul>
                                <l>
                                    <input type="checkbox" id="lvRZzZBSfo">
                                    <label for="lvRZzZBSfo">AWS</label>
                                    <ul>
                                        <l>
                                            <input type="checkbox" id="WJuHeWbSBX">
                                            <label for="WJuHeWbSBX">Cli</label>
                                            <ul>
                                        ...
                                        <l>
                                            <input type="checkbox" id="dmwcFAtgEK">
                                            <label for="dmwcFAtgEK">Dotnet</label>
                                            <ul>
                                        ...
                                        <l>
                                            <input type="checkbox" id="YywrRpfdoa">
                                            <label for="YywrRpfdoa">Ec 2</label>
                                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="kisfRWZIiS">
                            <label for="kisfRWZIiS">Events</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="GrDqJbhExs">
                            <label for="GrDqJbhExs">Localstack</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="spdfggxLLY">
                            <label for="spdfggxLLY">Pulumi</label>
                            <ul>
                                <l>
                                    <input type="checkbox" id="iJgubEMbZx">
                                    <label for="iJgubEMbZx">Dotnet</label>
                                    <ul>
                        ...
                        <l>
                            <input type="checkbox" id="hLZivSnvOT">
                            <label for="hLZivSnvOT">Serverless Framework</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="orIRTXTFDT">
                            <label for="orIRTXTFDT">Terraform</label>
                            <ul>
                                <l>
                                    <input type="checkbox" id="cjNnQUAPOJ">
                                    <label for="cjNnQUAPOJ">Functions</label>
                                    <ul>
                                ...
                                <l>
                                    <input type="checkbox" id="uqQOwXhvoF">
                                    <label for="uqQOwXhvoF">Meta Arguments</label>
                                    <ul>
                ...
                <l>
                    <input type="checkbox" id="lgcwBdAVGj">
                    <label for="lgcwBdAVGj">Docker</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="EKcgplBPRf">
                    <label for="EKcgplBPRf">Dotnet</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="WisZGFQrbh">
                            <label for="WisZGFQrbh">Cli</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="KfZNNBrZtR">
                    <label for="KfZNNBrZtR">Functional Programming</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="LROiSkCQRs">
                    <label for="LROiSkCQRs">Git</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="LKuTzIoxLU">
                            <label for="LKuTzIoxLU">Github</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="jkqnkKZShG">
                    <label for="jkqnkKZShG">Go</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="hjtdmfTbgr">
                    <label for="hjtdmfTbgr">Haskell</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="ZBEbZGbKWQ">
                    <label for="ZBEbZGbKWQ">Js</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="hxaUiWtDMA">
                            <label for="hxaUiWtDMA">Node</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="HpDOGXqpCb">
                            <label for="HpDOGXqpCb">D3</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="LELxeRwNhF">
                            <label for="LELxeRwNhF">Mocha</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="bUptbHFnBV">
                            <label for="bUptbHFnBV">P5js</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="ubQRhoqCrJ">
                            <label for="ubQRhoqCrJ">Typescript</label>
                            <ul>
                                <l>
                                    <input type="checkbox" id="QtStopKMhi">
                                    <label for="QtStopKMhi">Testing</label>
                                    <ul>
                ...
                <l>
                    <input type="checkbox" id="TaKwHzPYEw">
                    <label for="TaKwHzPYEw">Kafka</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="ynPmvZgfbL">
                    <label for="ynPmvZgfbL">Kubernetes</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="ObJhooDPhQ">
                    <label for="ObJhooDPhQ">Language</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="uFIBuLWqTf">
                    <label for="uFIBuLWqTf">Linux</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="aLOiCcRIfZ">
                            <label for="aLOiCcRIfZ">Bash</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="aCAkCWRzUn">
                    <label for="aCAkCWRzUn">Oauth</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="fmXGQawgHY">
                    <label for="fmXGQawgHY">Python</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="pOUnPUJFRe">
                            <label for="pOUnPUJFRe">Data Classes</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="fVGetYpTdV">
                            <label for="fVGetYpTdV">Libraries</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="wIXmLenrVt">
                    <label for="wIXmLenrVt">React</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="pWKKFdYoxw">
                    <label for="pWKKFdYoxw">Regular Expressions</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="NiBslxTrcC">
                    <label for="NiBslxTrcC">Rust</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="hwFMKVXgyq">
                            <label for="hwFMKVXgyq">Serde</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="YDmuWUABuW">
                    <label for="YDmuWUABuW">Vim</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="vexIXqQnQS">
                    <label for="vexIXqQnQS">Web</label>
                    <ul>
