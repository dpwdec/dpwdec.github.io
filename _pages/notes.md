...
<ul>
    <div name="contents-index">
        ...
        <l>
            <input type="checkbox" id="jPcRXFkwSp" checked>
            <label for="jPcRXFkwSp">Math</label>
            <ul>
                <l>
                    <input type="checkbox" id="KVrTkCNNOA">
                    <label for="KVrTkCNNOA">Exponentials</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="jIcTtEeSeq">
                    <label for="jIcTtEeSeq">Linear Algebra</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="PyRccgJtpD">
                    <label for="PyRccgJtpD">Logarithms</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="xoxMHTKiAW">
                    <label for="xoxMHTKiAW">Sequences</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="lULmLrUxFM">
                    <label for="lULmLrUxFM">Single Variable Calculus</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="aIULkgHpEq">
                    <label for="aIULkgHpEq">Trigonometry</label>
                    <ul>
        ...
        <l>
            <input type="checkbox" id="FPrKnVAPfA" checked>
            <label for="FPrKnVAPfA">Programming</label>
            <ul>
                <l>
                    <input type="checkbox" id="ZLgEWlfBNb">
                    <label for="ZLgEWlfBNb">Ansible</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="sYYVhxfQFp">
                    <label for="sYYVhxfQFp">Architecture</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="mdyrWxmDsz">
                    <label for="mdyrWxmDsz">Computer Graphics</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="QSvafCKWYp">
                    <label for="QSvafCKWYp">Databases</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="pDTHBTDwky">
                    <label for="pDTHBTDwky">Devops</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="OWFbPLusod">
                            <label for="OWFbPLusod">Cloud Providers</label>
                            <ul>
                                <l>
                                    <input type="checkbox" id="BQzuvvnCeg">
                                    <label for="BQzuvvnCeg">AWS</label>
                                    <ul>
                                        <l>
                                            <input type="checkbox" id="PJBpwqBBCH">
                                            <label for="PJBpwqBBCH">Cli</label>
                                            <ul>
                                        ...
                                        <l>
                                            <input type="checkbox" id="SVowZVkwoa">
                                            <label for="SVowZVkwoa">Dotnet</label>
                                            <ul>
                                        ...
                                        <l>
                                            <input type="checkbox" id="nnGsdLHNaD">
                                            <label for="nnGsdLHNaD">Ec 2</label>
                                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="qYZAmCntnm">
                            <label for="qYZAmCntnm">Events</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="XxxKhOWWNb">
                            <label for="XxxKhOWWNb">Localstack</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="mKPcZwUAOa">
                            <label for="mKPcZwUAOa">Pulumi</label>
                            <ul>
                                <l>
                                    <input type="checkbox" id="PswEtoksav">
                                    <label for="PswEtoksav">Dotnet</label>
                                    <ul>
                        ...
                        <l>
                            <input type="checkbox" id="WZXKwsGEcy">
                            <label for="WZXKwsGEcy">Serverless Framework</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="JphRmyWfQs">
                            <label for="JphRmyWfQs">Terraform</label>
                            <ul>
                                <l>
                                    <input type="checkbox" id="zwAYKCvqUS">
                                    <label for="zwAYKCvqUS">Functions</label>
                                    <ul>
                                ...
                                <l>
                                    <input type="checkbox" id="yoPJILlPqk">
                                    <label for="yoPJILlPqk">Meta Arguments</label>
                                    <ul>
                ...
                <l>
                    <input type="checkbox" id="zULYCQcMur">
                    <label for="zULYCQcMur">Docker</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="FQDANAiTMw">
                    <label for="FQDANAiTMw">Dotnet</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="JrPPAKTwDU">
                            <label for="JrPPAKTwDU">Cli</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="tHnvPPwOMx">
                    <label for="tHnvPPwOMx">Functional Programming</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="IwmPlxeWUv">
                    <label for="IwmPlxeWUv">Git</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="jCAPpaFyhG">
                            <label for="jCAPpaFyhG">Github</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="aSgGGkOsjH">
                    <label for="aSgGGkOsjH">Go</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="uogkKvKarU">
                    <label for="uogkKvKarU">Haskell</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="FoGZXeLdpy">
                    <label for="FoGZXeLdpy">Js</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="xdenIFkhgK">
                            <label for="xdenIFkhgK">Node</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="mVFMxawaxw">
                            <label for="mVFMxawaxw">D3</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="TDTMNefmSf">
                            <label for="TDTMNefmSf">Mocha</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="aWoLcEZUMH">
                            <label for="aWoLcEZUMH">P5js</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="BNPigKKwjB">
                            <label for="BNPigKKwjB">Typescript</label>
                            <ul>
                                <l>
                                    <input type="checkbox" id="ozhdNrEOMR">
                                    <label for="ozhdNrEOMR">Testing</label>
                                    <ul>
                ...
                <l>
                    <input type="checkbox" id="KSkmXwvzRx">
                    <label for="KSkmXwvzRx">Kafka</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="njeDosUFAp">
                    <label for="njeDosUFAp">Kubernetes</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="drwamdNQsS">
                    <label for="drwamdNQsS">Language</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="EEHxyqgFVf">
                    <label for="EEHxyqgFVf">Linux</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="KesCZURXBc">
                            <label for="KesCZURXBc">Bash</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="eCVudijCWg">
                    <label for="eCVudijCWg">Oauth</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="RnvKKWrFpL">
                    <label for="RnvKKWrFpL">Prometheus</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="fAJUInbgsB">
                    <label for="fAJUInbgsB">Python</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="FlUXPIAAcx">
                            <label for="FlUXPIAAcx">Data Classes</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="lCRNgJeVHT">
                            <label for="lCRNgJeVHT">Libraries</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="YUVnaiAHSz">
                    <label for="YUVnaiAHSz">React</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="CfvatjRksF">
                    <label for="CfvatjRksF">Regular Expressions</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="piNvNBDbQD">
                    <label for="piNvNBDbQD">Rust</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="pWBTbenXUn">
                            <label for="pWBTbenXUn">Serde</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="EMgsBzsApj">
                    <label for="EMgsBzsApj">Shaders</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="iydaKGXRal">
                            <label for="iydaKGXRal">Glsl</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="oVbTgPLqWg">
                    <label for="oVbTgPLqWg">Vim</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="VHJMApTfiV">
                    <label for="VHJMApTfiV">Web</label>
                    <ul>
