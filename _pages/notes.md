...
<ul>
    <div name="contents-index">
        ...
        <l>
            <input type="checkbox" id="VcVnDvNqdk" checked>
            <label for="VcVnDvNqdk">Math</label>
            <ul>
                <l>
                    <input type="checkbox" id="tQJKqcQNQa">
                    <label for="tQJKqcQNQa">Exponentials</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="XSJIKSmEWE">
                    <label for="XSJIKSmEWE">Linear Algebra</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="OqzRcVlvKX">
                    <label for="OqzRcVlvKX">Logarithms</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="tVKjFVYcIB">
                    <label for="tVKjFVYcIB">Sequences</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="aqKXtrFUYA">
                    <label for="aqKXtrFUYA">Single Variable Calculus</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="KPJJhApySb">
                    <label for="KPJJhApySb">Trigonometry</label>
                    <ul>
        ...
        <l>
            <input type="checkbox" id="KGPOyfTcJV" checked>
            <label for="KGPOyfTcJV">Programming</label>
            <ul>
                <l>
                    <input type="checkbox" id="EjWeNfHVEF">
                    <label for="EjWeNfHVEF">Ansible</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="LlVBZkfRWq">
                    <label for="LlVBZkfRWq">Architecture</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="mbFGNYHjvF">
                    <label for="mbFGNYHjvF">Computer Graphics</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="TlqDCRFklU">
                    <label for="TlqDCRFklU">Databases</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="zRAUTrcysU">
                    <label for="zRAUTrcysU">Devops</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="zzluKpoBCy">
                            <label for="zzluKpoBCy">Cloud Providers</label>
                            <ul>
                                <l>
                                    <input type="checkbox" id="RaQRIEmtrH">
                                    <label for="RaQRIEmtrH">AWS</label>
                                    <ul>
                                        <l>
                                            <input type="checkbox" id="NFLmpDtYEA">
                                            <label for="NFLmpDtYEA">Cli</label>
                                            <ul>
                                        ...
                                        <l>
                                            <input type="checkbox" id="piCMAVRIjs">
                                            <label for="piCMAVRIjs">Dotnet</label>
                                            <ul>
                                        ...
                                        <l>
                                            <input type="checkbox" id="aeOSFXhLxp">
                                            <label for="aeOSFXhLxp">Ec 2</label>
                                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="rwZZRDQlip">
                            <label for="rwZZRDQlip">Events</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="wGGsgYNkkK">
                            <label for="wGGsgYNkkK">Localstack</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="XekAbQYhEV">
                            <label for="XekAbQYhEV">Pulumi</label>
                            <ul>
                                <l>
                                    <input type="checkbox" id="PZbRndRZat">
                                    <label for="PZbRndRZat">Dotnet</label>
                                    <ul>
                        ...
                        <l>
                            <input type="checkbox" id="MCOSsfGEnR">
                            <label for="MCOSsfGEnR">Serverless Framework</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="cRhZDUNMZp">
                            <label for="cRhZDUNMZp">Terraform</label>
                            <ul>
                                <l>
                                    <input type="checkbox" id="HUFQwwnjir">
                                    <label for="HUFQwwnjir">Functions</label>
                                    <ul>
                                ...
                                <l>
                                    <input type="checkbox" id="euyTRoetrR">
                                    <label for="euyTRoetrR">Meta Arguments</label>
                                    <ul>
                ...
                <l>
                    <input type="checkbox" id="iatbaFgNWR">
                    <label for="iatbaFgNWR">Docker</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="gikOAxkxRl">
                    <label for="gikOAxkxRl">Dotnet</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="KVqYrMkuqD">
                            <label for="KVqYrMkuqD">Cli</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="ozAApgwFiG">
                    <label for="ozAApgwFiG">Functional Programming</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="cgyJPiQIqi">
                    <label for="cgyJPiQIqi">Git</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="ApeOKQBjnR">
                            <label for="ApeOKQBjnR">Github</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="mHhycDwWbe">
                    <label for="mHhycDwWbe">Go</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="JkDQJBYBPM">
                    <label for="JkDQJBYBPM">Haskell</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="uJBYXvgMhF">
                    <label for="uJBYXvgMhF">Js</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="lTDUCWFcfy">
                            <label for="lTDUCWFcfy">Node</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="tJaFYvrYXe">
                            <label for="tJaFYvrYXe">D3</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="AhtdZagzyi">
                            <label for="AhtdZagzyi">Mocha</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="FEGPxUCHBl">
                            <label for="FEGPxUCHBl">P5js</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="vCUFIEHHFW">
                            <label for="vCUFIEHHFW">Typescript</label>
                            <ul>
                                <l>
                                    <input type="checkbox" id="GGdYQeNKzJ">
                                    <label for="GGdYQeNKzJ">Testing</label>
                                    <ul>
                ...
                <l>
                    <input type="checkbox" id="LdLhLQUmkI">
                    <label for="LdLhLQUmkI">Kafka</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="svwjHkLnIH">
                    <label for="svwjHkLnIH">Kubernetes</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="KRvLbuZSYr">
                    <label for="KRvLbuZSYr">Language</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="DuhTqwKFwV">
                    <label for="DuhTqwKFwV">Linux</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="BzndCjfiUl">
                            <label for="BzndCjfiUl">Bash</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="XQUHVsgTcM">
                    <label for="XQUHVsgTcM">Oauth</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="FwcsbGIszl">
                    <label for="FwcsbGIszl">Prometheus</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="TudYNAIvfU">
                    <label for="TudYNAIvfU">Python</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="nJUSMAWCKV">
                            <label for="nJUSMAWCKV">Data Classes</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="WMReuTeWFA">
                            <label for="WMReuTeWFA">Libraries</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="pQHoabzrBv">
                    <label for="pQHoabzrBv">React</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="jtEQOmwWYV">
                    <label for="jtEQOmwWYV">Regular Expressions</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="kuqjxOfrNr">
                    <label for="kuqjxOfrNr">Rust</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="NhtwvhBQJI">
                            <label for="NhtwvhBQJI">Serde</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="UOOSKtaiEH">
                    <label for="UOOSKtaiEH">Shaders</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="iGRwGcvEFr">
                            <label for="iGRwGcvEFr">Glsl</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="wkYQOSGLTC">
                    <label for="wkYQOSGLTC">Vim</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="fuUxYoPfBr">
                    <label for="fuUxYoPfBr">Web</label>
                    <ul>
