...
<ul>
    <div name="contents-index">
        ...
        <l>
            <input type="checkbox" id="gayizAhpuY" checked>
            <label for="gayizAhpuY">Math</label>
            <ul>
                <l>
                    <input type="checkbox" id="XYBrQFAyKH">
                    <label for="XYBrQFAyKH">Exponentials</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="yVLeIxKqju">
                    <label for="yVLeIxKqju">Linear Algebra</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="iWbBgEbUex">
                    <label for="iWbBgEbUex">Logarithms</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="bWbHfIxkaw">
                    <label for="bWbHfIxkaw">Sequences</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="MLASZCYiCY">
                    <label for="MLASZCYiCY">Single Variable Calculus</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="xXDHGrBpqe">
                    <label for="xXDHGrBpqe">Trigonometry</label>
                    <ul>
        ...
        <l>
            <input type="checkbox" id="xiFsbgYeIK" checked>
            <label for="xiFsbgYeIK">Programming</label>
            <ul>
                <l>
                    <input type="checkbox" id="tydIzIlZJM">
                    <label for="tydIzIlZJM">Ansible</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="kGeuPtnbIL">
                    <label for="kGeuPtnbIL">Architecture</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="vIcZNqAOVr">
                    <label for="vIcZNqAOVr">Computer Graphics</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="uJeMSrRjay">
                    <label for="uJeMSrRjay">Databases</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="hmMYtfVLae">
                    <label for="hmMYtfVLae">Devops</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="aAsARVrexL">
                            <label for="aAsARVrexL">Cloud Computing</label>
                            <ul>
                                <l>
                                    <input type="checkbox" id="NgCyfKGNtI">
                                    <label for="NgCyfKGNtI">AWS</label>
                                    <ul>
                                        <l>
                                            <input type="checkbox" id="wOPSYwCFsC">
                                            <label for="wOPSYwCFsC">Cli</label>
                                            <ul>
                                        ...
                                        <l>
                                            <input type="checkbox" id="rqJXdeUJZw">
                                            <label for="rqJXdeUJZw">Dotnet</label>
                                            <ul>
                                        ...
                                        <l>
                                            <input type="checkbox" id="YkZTlVAWlu">
                                            <label for="YkZTlVAWlu">Ec 2</label>
                                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="FNKYHtVdkr">
                            <label for="FNKYHtVdkr">Events</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="AdDWbBDxFJ">
                            <label for="AdDWbBDxFJ">Localstack</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="nsKVTsaavp">
                            <label for="nsKVTsaavp">Oauth</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="TNzhNZJCcG">
                            <label for="TNzhNZJCcG">Pulumi</label>
                            <ul>
                                <l>
                                    <input type="checkbox" id="PKeclhFPpt">
                                    <label for="PKeclhFPpt">Dotnet</label>
                                    <ul>
                        ...
                        <l>
                            <input type="checkbox" id="iDkdXFciie">
                            <label for="iDkdXFciie">Terraform</label>
                            <ul>
                                <l>
                                    <input type="checkbox" id="aJfVWRwlOD">
                                    <label for="aJfVWRwlOD">Functions</label>
                                    <ul>
                                ...
                                <l>
                                    <input type="checkbox" id="TnoJiFyFQz">
                                    <label for="TnoJiFyFQz">Meta Arguments</label>
                                    <ul>
                ...
                <l>
                    <input type="checkbox" id="WanTesUfdt">
                    <label for="WanTesUfdt">Docker</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="qRsezWMsHI">
                    <label for="qRsezWMsHI">Dotnet</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="AstbphcBRD">
                            <label for="AstbphcBRD">Cli</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="vctONnVCeO">
                    <label for="vctONnVCeO">Functional Programming</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="HxejwxlAIJ">
                    <label for="HxejwxlAIJ">Git</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="VweMUTjtUU">
                            <label for="VweMUTjtUU">Github</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="qKSaYkdbEw">
                    <label for="qKSaYkdbEw">Go</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="QjujzBeLoV">
                    <label for="QjujzBeLoV">Haskell</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="xDMfTZIkyx">
                    <label for="xDMfTZIkyx">Js</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="GeGdTykOBv">
                            <label for="GeGdTykOBv">Node</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="pvSBWkqDRZ">
                            <label for="pvSBWkqDRZ">D3</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="KGYbEFehOL">
                            <label for="KGYbEFehOL">Mocha</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="xMvHqOeWQf">
                            <label for="xMvHqOeWQf">P5js</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="FAiJgAZRqT">
                            <label for="FAiJgAZRqT">Typescript</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="VHFObxurjD">
                    <label for="VHFObxurjD">Kafka</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="yCfqNjopNW">
                    <label for="yCfqNjopNW">Kubernetes</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="arRDORbQCL">
                    <label for="arRDORbQCL">Language</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="wAxxksyQEG">
                    <label for="wAxxksyQEG">Linux</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="EehQMoTRSa">
                            <label for="EehQMoTRSa">Bash</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="eMRsXBHzVt">
                    <label for="eMRsXBHzVt">Python</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="PLXXiJonBN">
                            <label for="PLXXiJonBN">Data Classes</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="TuwFYXsYdS">
                            <label for="TuwFYXsYdS">Libraries</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="zgddXcwMOx">
                    <label for="zgddXcwMOx">React</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="uOzYxYgrVR">
                    <label for="uOzYxYgrVR">Regular Expressions</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="PCPGHxSemg">
                    <label for="PCPGHxSemg">Rust</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="ifHgeRPrav">
                            <label for="ifHgeRPrav">Serde</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="HseXhRqzri">
                    <label for="HseXhRqzri">Vim</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="UiWoxAIZSx">
                    <label for="UiWoxAIZSx">Web</label>
                    <ul>
