...
<ul>
    <div name="contents-index">
        ...
        <l>
            <input type="checkbox" id="URAZUaXEBs" checked>
            <label for="URAZUaXEBs">Math</label>
            <ul>
                <l>
                    <input type="checkbox" id="NJkoJcgAkE">
                    <label for="NJkoJcgAkE">Exponentials</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="YsEyjWLHCV">
                    <label for="YsEyjWLHCV">Linear Algebra</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="GVUDdGxUfR">
                    <label for="GVUDdGxUfR">Logarithms</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="rFIHawselu">
                    <label for="rFIHawselu">Sequences</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="GtoesGFAWE">
                    <label for="GtoesGFAWE">Single Variable Calculus</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="etoVanVwGt">
                    <label for="etoVanVwGt">Trigonometry</label>
                    <ul>
        ...
        <l>
            <input type="checkbox" id="UdNOpqybyn" checked>
            <label for="UdNOpqybyn">Programming</label>
            <ul>
                <l>
                    <input type="checkbox" id="isEsFdyWko">
                    <label for="isEsFdyWko">Ansible</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="SDWXVAYXGX">
                    <label for="SDWXVAYXGX">Architecture</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="nPbimTqnHw">
                    <label for="nPbimTqnHw">Computer Graphics</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="CbvlWoTWet">
                    <label for="CbvlWoTWet">Databases</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="RZChhlvAvK">
                    <label for="RZChhlvAvK">Devops</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="KDPrOlYBTU">
                            <label for="KDPrOlYBTU">Cloud Providers</label>
                            <ul>
                                <l>
                                    <input type="checkbox" id="vIMQHoLaGr">
                                    <label for="vIMQHoLaGr">AWS</label>
                                    <ul>
                                        <l>
                                            <input type="checkbox" id="sKeAiQaSij">
                                            <label for="sKeAiQaSij">Cli</label>
                                            <ul>
                                        ...
                                        <l>
                                            <input type="checkbox" id="gWwToWmqMR">
                                            <label for="gWwToWmqMR">Dotnet</label>
                                            <ul>
                                        ...
                                        <l>
                                            <input type="checkbox" id="XogRWccQjV">
                                            <label for="XogRWccQjV">Ec 2</label>
                                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="GjHEIwhZJR">
                            <label for="GjHEIwhZJR">Events</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="BJJTugSFFa">
                            <label for="BJJTugSFFa">Localstack</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="LTcrvoyXhT">
                            <label for="LTcrvoyXhT">Pulumi</label>
                            <ul>
                                <l>
                                    <input type="checkbox" id="HJyyWWOWsj">
                                    <label for="HJyyWWOWsj">Dotnet</label>
                                    <ul>
                        ...
                        <l>
                            <input type="checkbox" id="seyLkaoPcW">
                            <label for="seyLkaoPcW">Serverless Framework</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="jcUgqevtRj">
                            <label for="jcUgqevtRj">Terraform</label>
                            <ul>
                                <l>
                                    <input type="checkbox" id="SCYLQVyEci">
                                    <label for="SCYLQVyEci">Functions</label>
                                    <ul>
                                ...
                                <l>
                                    <input type="checkbox" id="aGqIYqooGs">
                                    <label for="aGqIYqooGs">Meta Arguments</label>
                                    <ul>
                ...
                <l>
                    <input type="checkbox" id="pNoMeyolNX">
                    <label for="pNoMeyolNX">Docker</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="fQQSeQMhgB">
                    <label for="fQQSeQMhgB">Dotnet</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="FlcsEZREle">
                            <label for="FlcsEZREle">Cli</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="YfezJTPICY">
                    <label for="YfezJTPICY">Functional Programming</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="VtbILjeVDw">
                    <label for="VtbILjeVDw">Git</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="sbvsJTGneQ">
                            <label for="sbvsJTGneQ">Github</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="mgUSSdKtoC">
                    <label for="mgUSSdKtoC">Go</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="enXGbLBITv">
                    <label for="enXGbLBITv">Haskell</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="ciDAdUhSEZ">
                    <label for="ciDAdUhSEZ">Js</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="YWvdhJhKji">
                            <label for="YWvdhJhKji">Node</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="gMIclcEvIr">
                            <label for="gMIclcEvIr">D3</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="BKziHrmknb">
                            <label for="BKziHrmknb">Mocha</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="tRCxQMdQjJ">
                            <label for="tRCxQMdQjJ">P5js</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="SDQuQMhmwi">
                            <label for="SDQuQMhmwi">Typescript</label>
                            <ul>
                                <l>
                                    <input type="checkbox" id="QqbdNbffjT">
                                    <label for="QqbdNbffjT">Testing</label>
                                    <ul>
                ...
                <l>
                    <input type="checkbox" id="UuHfWOmBrh">
                    <label for="UuHfWOmBrh">Kafka</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="qmxKWsVkaM">
                    <label for="qmxKWsVkaM">Kubernetes</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="BeJdKCwZiP">
                    <label for="BeJdKCwZiP">Language</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="raXVuhWGax">
                    <label for="raXVuhWGax">Linux</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="UnZbriLfjT">
                            <label for="UnZbriLfjT">Bash</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="xapzjMhqOk">
                    <label for="xapzjMhqOk">Oauth</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="GobmbKvLWj">
                    <label for="GobmbKvLWj">Prometheus</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="woHxXsmixY">
                    <label for="woHxXsmixY">Python</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="qhjfiNEmFJ">
                            <label for="qhjfiNEmFJ">Data Classes</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="SbjHqHjCfA">
                            <label for="SbjHqHjCfA">Libraries</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="wtKinLerbE">
                    <label for="wtKinLerbE">React</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="MdOQmPGQCS">
                    <label for="MdOQmPGQCS">Regular Expressions</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="AltsTsjiBV">
                    <label for="AltsTsjiBV">Rust</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="meIXvkCSJj">
                            <label for="meIXvkCSJj">Serde</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="TKOyiPJKkT">
                    <label for="TKOyiPJKkT">Shaders</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="AfWpAlaaCD">
                            <label for="AfWpAlaaCD">Glsl</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="gxykIUztdZ">
                    <label for="gxykIUztdZ">Vim</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="SidyXWvUpQ">
                    <label for="SidyXWvUpQ">Web</label>
                    <ul>
