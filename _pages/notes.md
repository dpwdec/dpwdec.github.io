...
<ul>
    <div name="contents-index">
        ...
        <l>
            <input type="checkbox" id="Nngneknlxv" checked>
            <label for="Nngneknlxv">Math</label>
            <ul>
                <l>
                    <input type="checkbox" id="APFFloUGBj">
                    <label for="APFFloUGBj">Exponentials</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="MQTCjxZFKL">
                    <label for="MQTCjxZFKL">Linear Algebra</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="QiaQyvkbJs">
                    <label for="QiaQyvkbJs">Logarithms</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="lwWLFBEqqd">
                    <label for="lwWLFBEqqd">Sequences</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="uQRFRFBwSC">
                    <label for="uQRFRFBwSC">Single Variable Calculus</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="RyZYovuGtt">
                    <label for="RyZYovuGtt">Trigonometry</label>
                    <ul>
        ...
        <l>
            <input type="checkbox" id="NUoyoDsupp" checked>
            <label for="NUoyoDsupp">Programming</label>
            <ul>
                <l>
                    <input type="checkbox" id="cqOACPCvEJ">
                    <label for="cqOACPCvEJ">Ansible</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="EBUDWxQVcA">
                    <label for="EBUDWxQVcA">Architecture</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="eJoaGrRRLU">
                    <label for="eJoaGrRRLU">Computer Graphics</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="WMOQmKNrhC">
                    <label for="WMOQmKNrhC">Databases</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="nmzzFCpDEN">
                    <label for="nmzzFCpDEN">Devops</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="luEqfFkthJ">
                            <label for="luEqfFkthJ">Cloud Computing</label>
                            <ul>
                                <l>
                                    <input type="checkbox" id="oVvdEJgqid">
                                    <label for="oVvdEJgqid">AWS</label>
                                    <ul>
                                        <l>
                                            <input type="checkbox" id="gdcqUqlAWa">
                                            <label for="gdcqUqlAWa">Cli</label>
                                            <ul>
                                        ...
                                        <l>
                                            <input type="checkbox" id="RLflbxedPS">
                                            <label for="RLflbxedPS">Dotnet</label>
                                            <ul>
                                        ...
                                        <l>
                                            <input type="checkbox" id="pSMSAAQoTZ">
                                            <label for="pSMSAAQoTZ">Ec 2</label>
                                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="yimWGrFKqO">
                            <label for="yimWGrFKqO">Events</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="afWkJxsCkR">
                            <label for="afWkJxsCkR">Localstack</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="whFQCKxGMS">
                            <label for="whFQCKxGMS">Oauth</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="VnCReZWLjm">
                            <label for="VnCReZWLjm">Pulumi</label>
                            <ul>
                                <l>
                                    <input type="checkbox" id="xDtZSByuvb">
                                    <label for="xDtZSByuvb">Dotnet</label>
                                    <ul>
                        ...
                        <l>
                            <input type="checkbox" id="AMYgxVBLSM">
                            <label for="AMYgxVBLSM">Terraform</label>
                            <ul>
                                <l>
                                    <input type="checkbox" id="PPXJBoWrhf">
                                    <label for="PPXJBoWrhf">Functions</label>
                                    <ul>
                                ...
                                <l>
                                    <input type="checkbox" id="SXMvwAdUVs">
                                    <label for="SXMvwAdUVs">Meta Arguments</label>
                                    <ul>
                ...
                <l>
                    <input type="checkbox" id="CedZVskqNA">
                    <label for="CedZVskqNA">Docker</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="abqIszaTDw">
                    <label for="abqIszaTDw">Dotnet</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="YSJbLkFojG">
                            <label for="YSJbLkFojG">Cli</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="hekxUpzNsS">
                    <label for="hekxUpzNsS">Functional Programming</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="KWXFpUFzil">
                    <label for="KWXFpUFzil">Git</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="mVVHiSujgQ">
                            <label for="mVVHiSujgQ">Github</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="dAhnpxQwaI">
                    <label for="dAhnpxQwaI">Go</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="kWHvTfjdCn">
                    <label for="kWHvTfjdCn">Haskell</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="zMIdTbQryG">
                    <label for="zMIdTbQryG">Js</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="PgdOnJjWHO">
                            <label for="PgdOnJjWHO">Node</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="kmevvucrEQ">
                            <label for="kmevvucrEQ">D3</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="LvJQNtgVmS">
                            <label for="LvJQNtgVmS">Mocha</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="sjpaPbHYXx">
                            <label for="sjpaPbHYXx">P5js</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="QPhoydGJmz">
                            <label for="QPhoydGJmz">Typescript</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="QspnkthZVV">
                    <label for="QspnkthZVV">Kafka</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="HkcNJPRrFZ">
                    <label for="HkcNJPRrFZ">Kubernetes</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="yHIAyePsWB">
                    <label for="yHIAyePsWB">Language</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="ToIVBaXPpK">
                    <label for="ToIVBaXPpK">Linux</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="SpsjONRsUg">
                            <label for="SpsjONRsUg">Bash</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="SVitZSlwly">
                    <label for="SVitZSlwly">Python</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="fXVGAimzOI">
                            <label for="fXVGAimzOI">Data Classes</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="jOxaKACrtr">
                            <label for="jOxaKACrtr">Libraries</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="qlEUgRqZql">
                    <label for="qlEUgRqZql">React</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="zvnHzeCCKF">
                    <label for="zvnHzeCCKF">Regular Expressions</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="CXJsMtZbfu">
                    <label for="CXJsMtZbfu">Rust</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="xfByjGQpJd">
                            <label for="xfByjGQpJd">Serde</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="cGnDJmwdgs">
                    <label for="cGnDJmwdgs">Vim</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="XalGxLdkFv">
                    <label for="XalGxLdkFv">Web</label>
                    <ul>
