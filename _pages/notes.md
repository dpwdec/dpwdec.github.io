...
<ul>
    <div name="contents-index">
        ...
        <l>
            <input type="checkbox" id="ZtfNnytXEJ" checked>
            <label for="ZtfNnytXEJ">Math</label>
            <ul>
                <l>
                    <input type="checkbox" id="tSddTDfUSi">
                    <label for="tSddTDfUSi">Exponentials</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="PdqKoSBKWt">
                    <label for="PdqKoSBKWt">Linear Algebra</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="JWbNItMoxv">
                    <label for="JWbNItMoxv">Logarithms</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="ftixNkrtHB">
                    <label for="ftixNkrtHB">Sequences</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="oRCasbFbyw">
                    <label for="oRCasbFbyw">Single Variable Calculus</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="MkFkIHLNDg">
                    <label for="MkFkIHLNDg">Trigonometry</label>
                    <ul>
        ...
        <l>
            <input type="checkbox" id="tmrDysNpUr" checked>
            <label for="tmrDysNpUr">Programming</label>
            <ul>
                <l>
                    <input type="checkbox" id="CekCAQdNZh">
                    <label for="CekCAQdNZh">Ansible</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="TBvMDYRERZ">
                    <label for="TBvMDYRERZ">Architecture</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="UYRbEfGGIY">
                    <label for="UYRbEfGGIY">Computer Graphics</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="uutFWyeeHe">
                    <label for="uutFWyeeHe">Databases</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="HzkylwFqfd">
                    <label for="HzkylwFqfd">Devops</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="pWXLbxsxYm">
                            <label for="pWXLbxsxYm">Cloud Providers</label>
                            <ul>
                                <l>
                                    <input type="checkbox" id="clrdVokcpy">
                                    <label for="clrdVokcpy">AWS</label>
                                    <ul>
                                        <l>
                                            <input type="checkbox" id="JqsxTNLeEu">
                                            <label for="JqsxTNLeEu">Cli</label>
                                            <ul>
                                        ...
                                        <l>
                                            <input type="checkbox" id="JjkqHqHrps">
                                            <label for="JjkqHqHrps">Dotnet</label>
                                            <ul>
                                        ...
                                        <l>
                                            <input type="checkbox" id="DCHwnYJZry">
                                            <label for="DCHwnYJZry">Ec 2</label>
                                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="kFZjqgopno">
                            <label for="kFZjqgopno">Events</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="cJXDHtVBEl">
                            <label for="cJXDHtVBEl">Localstack</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="AYdBvCuknU">
                            <label for="AYdBvCuknU">Pulumi</label>
                            <ul>
                                <l>
                                    <input type="checkbox" id="jBnZroIYCQ">
                                    <label for="jBnZroIYCQ">Dotnet</label>
                                    <ul>
                        ...
                        <l>
                            <input type="checkbox" id="AvlybsNEDS">
                            <label for="AvlybsNEDS">Serverless Framework</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="VtNSlNXkPM">
                            <label for="VtNSlNXkPM">Terraform</label>
                            <ul>
                                <l>
                                    <input type="checkbox" id="AymfgOncwi">
                                    <label for="AymfgOncwi">Functions</label>
                                    <ul>
                                ...
                                <l>
                                    <input type="checkbox" id="aLcpdfQhCW">
                                    <label for="aLcpdfQhCW">Meta Arguments</label>
                                    <ul>
                ...
                <l>
                    <input type="checkbox" id="frKOcYIhBp">
                    <label for="frKOcYIhBp">Docker</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="DQOKLwbtlP">
                    <label for="DQOKLwbtlP">Dotnet</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="PticbakDOT">
                            <label for="PticbakDOT">Cli</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="TSxPYlUgIT">
                    <label for="TSxPYlUgIT">Functional Programming</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="IpuonQFirf">
                    <label for="IpuonQFirf">Git</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="wLGqiusmKZ">
                            <label for="wLGqiusmKZ">Github</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="tiwusfNsPg">
                    <label for="tiwusfNsPg">Go</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="qRpVLtfpUp">
                    <label for="qRpVLtfpUp">Haskell</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="JMJzkavnQJ">
                    <label for="JMJzkavnQJ">Js</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="EKhjPToHxS">
                            <label for="EKhjPToHxS">Node</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="YOjUuaBedf">
                            <label for="YOjUuaBedf">D3</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="IcMLJfUYZw">
                            <label for="IcMLJfUYZw">Mocha</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="dBkbUSoaKH">
                            <label for="dBkbUSoaKH">P5js</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="sEZOJtCSmO">
                            <label for="sEZOJtCSmO">Typescript</label>
                            <ul>
                                <l>
                                    <input type="checkbox" id="CBFjkGBHhc">
                                    <label for="CBFjkGBHhc">Testing</label>
                                    <ul>
                ...
                <l>
                    <input type="checkbox" id="MnksTfUaff">
                    <label for="MnksTfUaff">Kafka</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="jLswkyEOCu">
                    <label for="jLswkyEOCu">Kubernetes</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="slWxCbduFg">
                    <label for="slWxCbduFg">Language</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="bMXJwdRCYG">
                    <label for="bMXJwdRCYG">Linux</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="HWntpnEudp">
                            <label for="HWntpnEudp">Bash</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="iYvrFOwzXd">
                    <label for="iYvrFOwzXd">Oauth</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="ErImbpUHpH">
                    <label for="ErImbpUHpH">Python</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="reqIlchtzM">
                            <label for="reqIlchtzM">Data Classes</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="lhTUSIrNUG">
                            <label for="lhTUSIrNUG">Libraries</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="EypgdciFlm">
                    <label for="EypgdciFlm">React</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="XWmzvxXqfI">
                    <label for="XWmzvxXqfI">Regular Expressions</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="IEKSmhcvIp">
                    <label for="IEKSmhcvIp">Rust</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="WefIpMtRsy">
                            <label for="WefIpMtRsy">Serde</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="TIQluUhdTg">
                    <label for="TIQluUhdTg">Shaders</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="niDTvCxUHT">
                            <label for="niDTvCxUHT">Glsl</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="LEOWGZjvnL">
                    <label for="LEOWGZjvnL">Vim</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="bRRtdSfFcG">
                    <label for="bRRtdSfFcG">Web</label>
                    <ul>
