...
<ul>
    <div name="contents-index">
        ...
        <l>
            <input type="checkbox" id="HtxPAkmhsf" checked>
            <label for="HtxPAkmhsf">Math</label>
            <ul>
                <l>
                    <input type="checkbox" id="UmzGSriunp">
                    <label for="UmzGSriunp">Exponentials</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="uCfjbAGgpK">
                    <label for="uCfjbAGgpK">Linear Algebra</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="tzLfACTfAh">
                    <label for="tzLfACTfAh">Logarithms</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="zeTvbNzjbA">
                    <label for="zeTvbNzjbA">Sequences</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="bvedTjKSbF">
                    <label for="bvedTjKSbF">Single Variable Calculus</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="sKDGieCCTJ">
                    <label for="sKDGieCCTJ">Trigonometry</label>
                    <ul>
        ...
        <l>
            <input type="checkbox" id="nsrUtlWGva" checked>
            <label for="nsrUtlWGva">Programming</label>
            <ul>
                <l>
                    <input type="checkbox" id="EQwyNNYRJE">
                    <label for="EQwyNNYRJE">Ansible</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="cCGUFvLXMw">
                    <label for="cCGUFvLXMw">Architecture</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="EIpTqQsZCA">
                    <label for="EIpTqQsZCA">Computer Graphics</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="htiIdJwDmZ">
                    <label for="htiIdJwDmZ">Databases</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="LeugIlGzHJ">
                    <label for="LeugIlGzHJ">Devops</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="DxwrTzHLKg">
                            <label for="DxwrTzHLKg">Cloud Computing</label>
                            <ul>
                                <l>
                                    <input type="checkbox" id="KUnVgQYOrH">
                                    <label for="KUnVgQYOrH">AWS</label>
                                    <ul>
                                        <l>
                                            <input type="checkbox" id="kTnEXmJooW">
                                            <label for="kTnEXmJooW">Cli</label>
                                            <ul>
                                        ...
                                        <l>
                                            <input type="checkbox" id="SowQmfQUPt">
                                            <label for="SowQmfQUPt">Dotnet</label>
                                            <ul>
                                        ...
                                        <l>
                                            <input type="checkbox" id="CLdLFfHIRx">
                                            <label for="CLdLFfHIRx">Ec 2</label>
                                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="BmKCUKvwRH">
                            <label for="BmKCUKvwRH">Events</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="dZUOrOlPFP">
                            <label for="dZUOrOlPFP">Localstack</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="ObRjMUgLiE">
                            <label for="ObRjMUgLiE">Oauth</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="EZBMyClngJ">
                            <label for="EZBMyClngJ">Pulumi</label>
                            <ul>
                                <l>
                                    <input type="checkbox" id="NQIFiKsNUS">
                                    <label for="NQIFiKsNUS">Dotnet</label>
                                    <ul>
                        ...
                        <l>
                            <input type="checkbox" id="mgzRCSvrxM">
                            <label for="mgzRCSvrxM">Terraform</label>
                            <ul>
                                <l>
                                    <input type="checkbox" id="jhuaeeBVym">
                                    <label for="jhuaeeBVym">Functions</label>
                                    <ul>
                                ...
                                <l>
                                    <input type="checkbox" id="jSfecSpRfT">
                                    <label for="jSfecSpRfT">Meta Arguments</label>
                                    <ul>
                ...
                <l>
                    <input type="checkbox" id="rMXSjuahaT">
                    <label for="rMXSjuahaT">Docker</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="xMYZGVLKLC">
                    <label for="xMYZGVLKLC">Dotnet</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="gHSDGotPFU">
                            <label for="gHSDGotPFU">Cli</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="vWlIzlBLwP">
                    <label for="vWlIzlBLwP">Functional Programming</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="YXArDxPWjy">
                    <label for="YXArDxPWjy">Git</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="AaCCGlRwOb">
                            <label for="AaCCGlRwOb">Github</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="XVpLPlWcjV">
                    <label for="XVpLPlWcjV">Go</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="iYxvkDbjXE">
                    <label for="iYxvkDbjXE">Haskell</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="mlNUdQeIoX">
                    <label for="mlNUdQeIoX">Js</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="WdSUXitDIi">
                            <label for="WdSUXitDIi">Node</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="ocjvmIJBLh">
                            <label for="ocjvmIJBLh">D3</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="LZyKacdbeO">
                            <label for="LZyKacdbeO">Mocha</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="RBpGrLmkRW">
                            <label for="RBpGrLmkRW">P5js</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="gBtFAEUaNw">
                            <label for="gBtFAEUaNw">Typescript</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="cDJGZvgbnf">
                    <label for="cDJGZvgbnf">Kafka</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="tdkHNpUDij">
                    <label for="tdkHNpUDij">Kubernetes</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="cNVhzoEjtN">
                    <label for="cNVhzoEjtN">Language</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="YSExbKSZnr">
                    <label for="YSExbKSZnr">Linux</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="kejGjQImQF">
                            <label for="kejGjQImQF">Bash</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="CDzQttkkTH">
                    <label for="CDzQttkkTH">Python</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="JvvqHcBADa">
                            <label for="JvvqHcBADa">Data Classes</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="ncoLITyvBG">
                            <label for="ncoLITyvBG">Libraries</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="oKVfsKrbBF">
                    <label for="oKVfsKrbBF">React</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="lnyXMunHiF">
                    <label for="lnyXMunHiF">Regular Expressions</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="jkXwqnqMtH">
                    <label for="jkXwqnqMtH">Rust</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="jSrrEWZRsT">
                            <label for="jSrrEWZRsT">Serde</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="abFLHjGzdT">
                    <label for="abFLHjGzdT">Vim</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="zJQDglImZh">
                    <label for="zJQDglImZh">Web</label>
                    <ul>
