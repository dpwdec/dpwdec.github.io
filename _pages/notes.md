...
<ul>
    <div name="contents-index">
        ...
        <l>
            <input type="checkbox" id="JTuEKXxwSi" checked>
            <label for="JTuEKXxwSi">Math</label>
            <ul>
                <l>
                    <input type="checkbox" id="nYZdwNffrM">
                    <label for="nYZdwNffrM">Exponentials</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="RlmhTBhQSj">
                    <label for="RlmhTBhQSj">Linear Algebra</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="odHdmXhptA">
                    <label for="odHdmXhptA">Logarithms</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="jMTlAyjlpD">
                    <label for="jMTlAyjlpD">Sequences</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="ZNrbYrRpSK">
                    <label for="ZNrbYrRpSK">Single Variable Calculus</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="NRvZrjGdFH">
                    <label for="NRvZrjGdFH">Trigonometry</label>
                    <ul>
        ...
        <l>
            <input type="checkbox" id="aFjGqebbxk" checked>
            <label for="aFjGqebbxk">Programming</label>
            <ul>
                <l>
                    <input type="checkbox" id="SZstTaJrTl">
                    <label for="SZstTaJrTl">Ansible</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="UKgemqyFXq">
                    <label for="UKgemqyFXq">Architecture</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="lCVayhOCGN">
                    <label for="lCVayhOCGN">Computer Graphics</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="oFILtErnse">
                    <label for="oFILtErnse">Databases</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="bCdmLhOqYZ">
                    <label for="bCdmLhOqYZ">Devops</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="uloYkkQJlE">
                            <label for="uloYkkQJlE">Cloud Providers</label>
                            <ul>
                                <l>
                                    <input type="checkbox" id="RVBoBIhzpf">
                                    <label for="RVBoBIhzpf">AWS</label>
                                    <ul>
                                        <l>
                                            <input type="checkbox" id="rtTzyHjZkQ">
                                            <label for="rtTzyHjZkQ">Cli</label>
                                            <ul>
                                        ...
                                        <l>
                                            <input type="checkbox" id="JvvkDiGLyq">
                                            <label for="JvvkDiGLyq">Dotnet</label>
                                            <ul>
                                        ...
                                        <l>
                                            <input type="checkbox" id="AePdIQNBBR">
                                            <label for="AePdIQNBBR">Ec 2</label>
                                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="WpmDirKIxh">
                            <label for="WpmDirKIxh">Events</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="lohfyACOHe">
                            <label for="lohfyACOHe">Localstack</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="FldWKUoBVK">
                            <label for="FldWKUoBVK">Pulumi</label>
                            <ul>
                                <l>
                                    <input type="checkbox" id="DljGVqezUG">
                                    <label for="DljGVqezUG">Dotnet</label>
                                    <ul>
                        ...
                        <l>
                            <input type="checkbox" id="nnJlgyZxtv">
                            <label for="nnJlgyZxtv">Serverless Framework</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="LQSgYAtYSO">
                            <label for="LQSgYAtYSO">Terraform</label>
                            <ul>
                                <l>
                                    <input type="checkbox" id="snRzqcVeGZ">
                                    <label for="snRzqcVeGZ">Functions</label>
                                    <ul>
                                ...
                                <l>
                                    <input type="checkbox" id="ycrcwNhtLJ">
                                    <label for="ycrcwNhtLJ">Meta Arguments</label>
                                    <ul>
                ...
                <l>
                    <input type="checkbox" id="qQEpKVIvEZ">
                    <label for="qQEpKVIvEZ">Docker</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="IbAbUdaggZ">
                    <label for="IbAbUdaggZ">Dotnet</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="CAbLszCBsK">
                            <label for="CAbLszCBsK">Cli</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="lGBlRqNHaP">
                    <label for="lGBlRqNHaP">Functional Programming</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="NQLTJmZySV">
                    <label for="NQLTJmZySV">Git</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="OtUoQKaJVl">
                            <label for="OtUoQKaJVl">Github</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="JPlnmibLRO">
                    <label for="JPlnmibLRO">Go</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="kGospJOWNb">
                    <label for="kGospJOWNb">Haskell</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="yqAgXlqeEZ">
                    <label for="yqAgXlqeEZ">Js</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="jdFFYCWpSN">
                            <label for="jdFFYCWpSN">Node</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="TaaOqXbsIp">
                            <label for="TaaOqXbsIp">D3</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="JujutktGWQ">
                            <label for="JujutktGWQ">Mocha</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="KbBOnDYTyZ">
                            <label for="KbBOnDYTyZ">P5js</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="hXXLqkqmdC">
                            <label for="hXXLqkqmdC">Typescript</label>
                            <ul>
                                <l>
                                    <input type="checkbox" id="bGjhURFQiF">
                                    <label for="bGjhURFQiF">Testing</label>
                                    <ul>
                ...
                <l>
                    <input type="checkbox" id="hSjZFkmLDN">
                    <label for="hSjZFkmLDN">Kafka</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="wnczFxCDyc">
                    <label for="wnczFxCDyc">Kubernetes</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="QEdnGiytGn">
                    <label for="QEdnGiytGn">Language</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="ALQqMdmSnv">
                    <label for="ALQqMdmSnv">Linux</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="qBUwVIfJJe">
                            <label for="qBUwVIfJJe">Bash</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="yJIeXnsYfw">
                    <label for="yJIeXnsYfw">Oauth</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="SpBbZDxKhc">
                    <label for="SpBbZDxKhc">Prometheus</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="qQstdOZxPt">
                    <label for="qQstdOZxPt">Python</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="pcPmGxSLfI">
                            <label for="pcPmGxSLfI">Data Classes</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="XZoemseNSf">
                            <label for="XZoemseNSf">Libraries</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="zEggdsAVcm">
                    <label for="zEggdsAVcm">React</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="kOmUsheeNY">
                    <label for="kOmUsheeNY">Regular Expressions</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="UjOsgrrJkx">
                    <label for="UjOsgrrJkx">Rust</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="sGceZenxfj">
                            <label for="sGceZenxfj">Serde</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="yvEJWdFZRL">
                    <label for="yvEJWdFZRL">Shaders</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="VdKwixLbwO">
                            <label for="VdKwixLbwO">Glsl</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="ebKYSUmJHc">
                    <label for="ebKYSUmJHc">Vim</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="AfGWiXnWoN">
                    <label for="AfGWiXnWoN">Web</label>
                    <ul>
