...
<ul>
    <div name="contents-index">
        ...
        <l>
            <input type="checkbox" id="yNyThpCFwS" checked>
            <label for="yNyThpCFwS">Math</label>
            <ul>
                <l>
                    <input type="checkbox" id="vmJXmlTPIe">
                    <label for="vmJXmlTPIe">Exponentials</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="EpFZEGrzoL">
                    <label for="EpFZEGrzoL">Linear Algebra</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="FmjnnIsMbY">
                    <label for="FmjnnIsMbY">Logarithms</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="vUmMvRZvHw">
                    <label for="vUmMvRZvHw">Sequences</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="WYlZFDfKjj">
                    <label for="WYlZFDfKjj">Single Variable Calculus</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="mzaJEICXjB">
                    <label for="mzaJEICXjB">Trigonometry</label>
                    <ul>
        ...
        <l>
            <input type="checkbox" id="eOMiLxhjMB" checked>
            <label for="eOMiLxhjMB">Programming</label>
            <ul>
                <l>
                    <input type="checkbox" id="hAFUzvMpLy">
                    <label for="hAFUzvMpLy">Ansible</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="KVTtEHwnHf">
                    <label for="KVTtEHwnHf">Architecture</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="KXWKTrxGVP">
                    <label for="KXWKTrxGVP">Computer Graphics</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="dmKzjRdGuf">
                    <label for="dmKzjRdGuf">Databases</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="cIPOwxPSib">
                    <label for="cIPOwxPSib">Devops</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="mRSokiVanw">
                            <label for="mRSokiVanw">Cloud Providers</label>
                            <ul>
                                <l>
                                    <input type="checkbox" id="HXZKrRgQdN">
                                    <label for="HXZKrRgQdN">AWS</label>
                                    <ul>
                                        <l>
                                            <input type="checkbox" id="OUMXgyclso">
                                            <label for="OUMXgyclso">Cli</label>
                                            <ul>
                                        ...
                                        <l>
                                            <input type="checkbox" id="UvkiusDqFh">
                                            <label for="UvkiusDqFh">Dotnet</label>
                                            <ul>
                                        ...
                                        <l>
                                            <input type="checkbox" id="EaZzHkJtRp">
                                            <label for="EaZzHkJtRp">Ec 2</label>
                                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="zIadKvbVHL">
                            <label for="zIadKvbVHL">Events</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="QcUvbdxLcY">
                            <label for="QcUvbdxLcY">Localstack</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="wgJYpkJVWI">
                            <label for="wgJYpkJVWI">Pulumi</label>
                            <ul>
                                <l>
                                    <input type="checkbox" id="HboDVqeZIb">
                                    <label for="HboDVqeZIb">Dotnet</label>
                                    <ul>
                        ...
                        <l>
                            <input type="checkbox" id="CZIaJDtgAq">
                            <label for="CZIaJDtgAq">Serverless Framework</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="UCSPYqmOwT">
                            <label for="UCSPYqmOwT">Terraform</label>
                            <ul>
                                <l>
                                    <input type="checkbox" id="ELYqbElsla">
                                    <label for="ELYqbElsla">Functions</label>
                                    <ul>
                                ...
                                <l>
                                    <input type="checkbox" id="SBCornWmUI">
                                    <label for="SBCornWmUI">Meta Arguments</label>
                                    <ul>
                ...
                <l>
                    <input type="checkbox" id="xyBxPRmcbq">
                    <label for="xyBxPRmcbq">Docker</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="IRJFxSqSxK">
                    <label for="IRJFxSqSxK">Dotnet</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="ModSbosnZM">
                            <label for="ModSbosnZM">Cli</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="xXhEtQfnmr">
                    <label for="xXhEtQfnmr">Functional Programming</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="fIzHLERTsy">
                    <label for="fIzHLERTsy">Git</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="TeEWPKkljE">
                            <label for="TeEWPKkljE">Github</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="Pqtbmpiqwx">
                    <label for="Pqtbmpiqwx">Go</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="ZpLwDhhAvo">
                    <label for="ZpLwDhhAvo">Haskell</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="HthVDWefEM">
                    <label for="HthVDWefEM">Js</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="vBJeXhibIt">
                            <label for="vBJeXhibIt">Node</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="GzDAlayfJW">
                            <label for="GzDAlayfJW">D3</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="jFJsFuYKvd">
                            <label for="jFJsFuYKvd">Mocha</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="MejzWCfXBy">
                            <label for="MejzWCfXBy">P5js</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="vqZCUyGTLO">
                            <label for="vqZCUyGTLO">Typescript</label>
                            <ul>
                                <l>
                                    <input type="checkbox" id="PLCLwkymzB">
                                    <label for="PLCLwkymzB">Testing</label>
                                    <ul>
                ...
                <l>
                    <input type="checkbox" id="XbNvItjqjk">
                    <label for="XbNvItjqjk">Kafka</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="utOHQQGdsv">
                    <label for="utOHQQGdsv">Kubernetes</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="dwRPzVSfvW">
                    <label for="dwRPzVSfvW">Language</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="XefcsSwFwZ">
                    <label for="XefcsSwFwZ">Linux</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="mLgEFOGpKV">
                            <label for="mLgEFOGpKV">Bash</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="tmEeYwPzJv">
                    <label for="tmEeYwPzJv">Oauth</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="tVYlVBNsva">
                    <label for="tVYlVBNsva">Python</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="PutMjVoFqP">
                            <label for="PutMjVoFqP">Data Classes</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="jGXZbfZIbU">
                            <label for="jGXZbfZIbU">Libraries</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="UXPVLhNWZx">
                    <label for="UXPVLhNWZx">React</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="gWDXDNyosP">
                    <label for="gWDXDNyosP">Regular Expressions</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="pFSGUuwBwl">
                    <label for="pFSGUuwBwl">Rust</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="AWUDSOiqCV">
                            <label for="AWUDSOiqCV">Serde</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="BlTJVFZsqU">
                    <label for="BlTJVFZsqU">Shaders</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="barOprWNKp">
                            <label for="barOprWNKp">Glsl</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="aIoTJxrsAm">
                    <label for="aIoTJxrsAm">Vim</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="CqyoWsbeZL">
                    <label for="CqyoWsbeZL">Web</label>
                    <ul>
