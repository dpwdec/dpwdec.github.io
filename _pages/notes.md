...
<ul>
    <div name="contents-index">
        ...
        <l>
            <input type="checkbox" id="kPakGhtAkm" checked>
            <label for="kPakGhtAkm">Math</label>
            <ul>
                <l>
                    <input type="checkbox" id="YalUkRkoAj">
                    <label for="YalUkRkoAj">Exponentials</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="CDZpwXWpLI">
                    <label for="CDZpwXWpLI">Linear Algebra</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="bFHlNMhIxh">
                    <label for="bFHlNMhIxh">Logarithms</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="SAwbXPZuxX">
                    <label for="SAwbXPZuxX">Sequences</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="jsThqfJpxl">
                    <label for="jsThqfJpxl">Single Variable Calculus</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="ylCjuYApWR">
                    <label for="ylCjuYApWR">Trigonometry</label>
                    <ul>
        ...
        <l>
            <input type="checkbox" id="meyvEwdhyP" checked>
            <label for="meyvEwdhyP">Programming</label>
            <ul>
                <l>
                    <input type="checkbox" id="yPVhsVhAQm">
                    <label for="yPVhsVhAQm">Ansible</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="wylgeeFzBg">
                    <label for="wylgeeFzBg">Architecture</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="OPhocOVhRB">
                    <label for="OPhocOVhRB">Computer Graphics</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="xNROcXLqZI">
                    <label for="xNROcXLqZI">Databases</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="GPiYzZNdBl">
                    <label for="GPiYzZNdBl">Devops</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="UbXTTDlWnE">
                            <label for="UbXTTDlWnE">Cloud Providers</label>
                            <ul>
                                <l>
                                    <input type="checkbox" id="KSPpgbkhId">
                                    <label for="KSPpgbkhId">AWS</label>
                                    <ul>
                                        <l>
                                            <input type="checkbox" id="jwGFKQEJyQ">
                                            <label for="jwGFKQEJyQ">Cli</label>
                                            <ul>
                                        ...
                                        <l>
                                            <input type="checkbox" id="pCQucxfrjk">
                                            <label for="pCQucxfrjk">Dotnet</label>
                                            <ul>
                                        ...
                                        <l>
                                            <input type="checkbox" id="yVyqcgYMXi">
                                            <label for="yVyqcgYMXi">Ec 2</label>
                                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="vOImAaYlmn">
                            <label for="vOImAaYlmn">Events</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="EgkdSpZhGv">
                            <label for="EgkdSpZhGv">Localstack</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="mTgmYRkBRi">
                            <label for="mTgmYRkBRi">Pulumi</label>
                            <ul>
                                <l>
                                    <input type="checkbox" id="xUpftBAKUE">
                                    <label for="xUpftBAKUE">Dotnet</label>
                                    <ul>
                        ...
                        <l>
                            <input type="checkbox" id="DjmMhMTWwj">
                            <label for="DjmMhMTWwj">Serverless Framework</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="vUsaEFpzfR">
                            <label for="vUsaEFpzfR">Terraform</label>
                            <ul>
                                <l>
                                    <input type="checkbox" id="xMesOwgyQo">
                                    <label for="xMesOwgyQo">Functions</label>
                                    <ul>
                                ...
                                <l>
                                    <input type="checkbox" id="TfkxuEbqKd">
                                    <label for="TfkxuEbqKd">Meta Arguments</label>
                                    <ul>
                ...
                <l>
                    <input type="checkbox" id="DOJbmaphaP">
                    <label for="DOJbmaphaP">Docker</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="INVxHLFWXp">
                    <label for="INVxHLFWXp">Dotnet</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="jbJEoaBBbk">
                            <label for="jbJEoaBBbk">Cli</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="dUJgYdKDgb">
                    <label for="dUJgYdKDgb">Functional Programming</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="fdWQbtOdHx">
                    <label for="fdWQbtOdHx">Git</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="oYMrKpppNW">
                            <label for="oYMrKpppNW">Github</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="deazDymyGD">
                    <label for="deazDymyGD">Go</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="jtjVaLyzlq">
                    <label for="jtjVaLyzlq">Haskell</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="YDykawlZOD">
                    <label for="YDykawlZOD">Js</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="JvgBLjOCWI">
                            <label for="JvgBLjOCWI">Node</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="wDTtEFdzIU">
                            <label for="wDTtEFdzIU">D3</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="BiOxINMatC">
                            <label for="BiOxINMatC">Mocha</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="wgRFuMsjcy">
                            <label for="wgRFuMsjcy">P5js</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="zNKPTBBEtx">
                            <label for="zNKPTBBEtx">Typescript</label>
                            <ul>
                                <l>
                                    <input type="checkbox" id="DZovEcijmz">
                                    <label for="DZovEcijmz">Testing</label>
                                    <ul>
                ...
                <l>
                    <input type="checkbox" id="iTFRCeoEji">
                    <label for="iTFRCeoEji">Kafka</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="dGgtzvCwwh">
                    <label for="dGgtzvCwwh">Kubernetes</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="moYugIPNft">
                    <label for="moYugIPNft">Language</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="VqjjjGWgTk">
                    <label for="VqjjjGWgTk">Linux</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="iLvtplSqwi">
                            <label for="iLvtplSqwi">Bash</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="tSVciALARf">
                    <label for="tSVciALARf">Oauth</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="lfcriWaAdB">
                    <label for="lfcriWaAdB">Prometheus</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="GLSWUQBCdc">
                    <label for="GLSWUQBCdc">Python</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="ZyFbZelZqD">
                            <label for="ZyFbZelZqD">Data Classes</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="PRqasUgBPD">
                            <label for="PRqasUgBPD">Libraries</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="VzERPTFNct">
                    <label for="VzERPTFNct">React</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="uSBmOpIZUo">
                    <label for="uSBmOpIZUo">Regular Expressions</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="nZVxMvLgZP">
                    <label for="nZVxMvLgZP">Rust</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="FxYfdgTpoO">
                            <label for="FxYfdgTpoO">Serde</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="anlUMMbWUg">
                    <label for="anlUMMbWUg">Shaders</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="rlbjbdpkRn">
                            <label for="rlbjbdpkRn">Glsl</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="fLxNgAMRdB">
                    <label for="fLxNgAMRdB">Vim</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="DeIVfhMBkk">
                    <label for="DeIVfhMBkk">Web</label>
                    <ul>
