...
<ul>
    <div name="contents-index">
        ...
        <l>
            <input type="checkbox" id="kYNBhqZqaA" checked>
            <label for="kYNBhqZqaA">Math</label>
            <ul>
                <l>
                    <input type="checkbox" id="EhDyDftPfB">
                    <label for="EhDyDftPfB">Exponentials</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="euzjtOwPhT">
                    <label for="euzjtOwPhT">Linear Algebra</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="FgxxMdXPvB">
                    <label for="FgxxMdXPvB">Logarithms</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="uVNsyRvkMK">
                    <label for="uVNsyRvkMK">Sequences</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="zKSUHpYlME">
                    <label for="zKSUHpYlME">Single Variable Calculus</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="uhPVBPfnSb">
                    <label for="uhPVBPfnSb">Trigonometry</label>
                    <ul>
        ...
        <l>
            <input type="checkbox" id="ZGhmgtlSHw" checked>
            <label for="ZGhmgtlSHw">Programming</label>
            <ul>
                <l>
                    <input type="checkbox" id="IBrclVZqEU">
                    <label for="IBrclVZqEU">Ansible</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="XrOPOSpEjD">
                    <label for="XrOPOSpEjD">Architecture</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="xZJlLkXqzK">
                    <label for="xZJlLkXqzK">Computer Graphics</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="btYUtzxHaB">
                    <label for="btYUtzxHaB">Databases</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="NvcZLGmtvL">
                    <label for="NvcZLGmtvL">Devops</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="ZnOZgOczNl">
                            <label for="ZnOZgOczNl">Cloud Providers</label>
                            <ul>
                                <l>
                                    <input type="checkbox" id="wQjQgbtJfO">
                                    <label for="wQjQgbtJfO">AWS</label>
                                    <ul>
                                        <l>
                                            <input type="checkbox" id="DWdjQlZkRA">
                                            <label for="DWdjQlZkRA">Cli</label>
                                            <ul>
                                        ...
                                        <l>
                                            <input type="checkbox" id="LmHXMOjUDc">
                                            <label for="LmHXMOjUDc">Dotnet</label>
                                            <ul>
                                        ...
                                        <l>
                                            <input type="checkbox" id="WneBtUfYCE">
                                            <label for="WneBtUfYCE">Ec 2</label>
                                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="ACLEJNfknJ">
                            <label for="ACLEJNfknJ">Events</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="daTfUcsiDV">
                            <label for="daTfUcsiDV">Localstack</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="cFLyGcLAST">
                            <label for="cFLyGcLAST">Pulumi</label>
                            <ul>
                                <l>
                                    <input type="checkbox" id="IzruVllmYw">
                                    <label for="IzruVllmYw">Dotnet</label>
                                    <ul>
                        ...
                        <l>
                            <input type="checkbox" id="ghMAJzlrlW">
                            <label for="ghMAJzlrlW">Serverless Framework</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="vLQvxPwzvb">
                            <label for="vLQvxPwzvb">Terraform</label>
                            <ul>
                                <l>
                                    <input type="checkbox" id="iBptlQbQNG">
                                    <label for="iBptlQbQNG">Functions</label>
                                    <ul>
                                ...
                                <l>
                                    <input type="checkbox" id="HLnUZVsemG">
                                    <label for="HLnUZVsemG">Meta Arguments</label>
                                    <ul>
                ...
                <l>
                    <input type="checkbox" id="LRknGoqBeT">
                    <label for="LRknGoqBeT">Docker</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="todLPYLCxI">
                    <label for="todLPYLCxI">Dotnet</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="MBqbbjFbWm">
                            <label for="MBqbbjFbWm">Cli</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="GBXNUryHBZ">
                    <label for="GBXNUryHBZ">Functional Programming</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="pcQxzGoLZm">
                    <label for="pcQxzGoLZm">Git</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="ibmDuSqksO">
                            <label for="ibmDuSqksO">Github</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="adHFVBGsbx">
                    <label for="adHFVBGsbx">Go</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="MmXOvDOJaE">
                    <label for="MmXOvDOJaE">Haskell</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="frQSlDlTRZ">
                    <label for="frQSlDlTRZ">Js</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="VhrWmZwwLm">
                            <label for="VhrWmZwwLm">Node</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="VhgSBiMDuk">
                            <label for="VhgSBiMDuk">D3</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="yzLJSbeXRH">
                            <label for="yzLJSbeXRH">Mocha</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="uRWbLhRHMm">
                            <label for="uRWbLhRHMm">P5js</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="yASDomRElu">
                            <label for="yASDomRElu">Typescript</label>
                            <ul>
                                <l>
                                    <input type="checkbox" id="vfgOACVKOs">
                                    <label for="vfgOACVKOs">Testing</label>
                                    <ul>
                ...
                <l>
                    <input type="checkbox" id="pZNlKZiSZv">
                    <label for="pZNlKZiSZv">Kafka</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="JVRTRVzeRL">
                    <label for="JVRTRVzeRL">Kubernetes</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="gKnodZISEi">
                    <label for="gKnodZISEi">Language</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="hDCNtwoMoa">
                    <label for="hDCNtwoMoa">Linux</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="IDCDKQhekd">
                            <label for="IDCDKQhekd">Bash</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="hjGjDDsUaf">
                    <label for="hjGjDDsUaf">Oauth</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="NOmVeeMqWk">
                    <label for="NOmVeeMqWk">Prometheus</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="GKNFwFNWEl">
                    <label for="GKNFwFNWEl">Python</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="tWDkIfoqCQ">
                            <label for="tWDkIfoqCQ">Data Classes</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="FpZkRDBnMu">
                            <label for="FpZkRDBnMu">Libraries</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="GATrRiwlMS">
                    <label for="GATrRiwlMS">React</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="NWLdmKrQiv">
                    <label for="NWLdmKrQiv">Regular Expressions</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="RLEakYHyJY">
                    <label for="RLEakYHyJY">Rust</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="PPfKVGGQkz">
                            <label for="PPfKVGGQkz">Serde</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="KlWcTkzMit">
                    <label for="KlWcTkzMit">Shaders</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="gtUdSrpXFM">
                            <label for="gtUdSrpXFM">Glsl</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="pNABGhTEZe">
                    <label for="pNABGhTEZe">Vim</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="zlpZtmKZGh">
                    <label for="zlpZtmKZGh">Web</label>
                    <ul>
