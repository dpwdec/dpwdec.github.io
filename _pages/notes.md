...
<ul>
    <div name="contents-index">
        ...
        <l>
            <input type="checkbox" id="VuryztmXfh" checked>
            <label for="VuryztmXfh">Math</label>
            <ul>
                <l>
                    <input type="checkbox" id="hxbPWDGeMa">
                    <label for="hxbPWDGeMa">Exponentials</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="fyPSbXtNqH">
                    <label for="fyPSbXtNqH">Linear Algebra</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="jtzhvSwXIM">
                    <label for="jtzhvSwXIM">Logarithms</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="dfnsDHTUcU">
                    <label for="dfnsDHTUcU">Sequences</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="TtSKzFDhFv">
                    <label for="TtSKzFDhFv">Single Variable Calculus</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="EQQDheTbnA">
                    <label for="EQQDheTbnA">Trigonometry</label>
                    <ul>
        ...
        <l>
            <input type="checkbox" id="uYNIVmLQko" checked>
            <label for="uYNIVmLQko">Programming</label>
            <ul>
                <l>
                    <input type="checkbox" id="XOOXRsFwfJ">
                    <label for="XOOXRsFwfJ">Ansible</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="oDvEjRAjOS">
                    <label for="oDvEjRAjOS">Architecture</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="ODTjAdikqM">
                    <label for="ODTjAdikqM">Computer Graphics</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="upGycFJOeC">
                    <label for="upGycFJOeC">Databases</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="HxeRCLGFlR">
                    <label for="HxeRCLGFlR">Devops</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="XVgtXGDsfD">
                            <label for="XVgtXGDsfD">Cloud Providers</label>
                            <ul>
                                <l>
                                    <input type="checkbox" id="TBlAeaDeZW">
                                    <label for="TBlAeaDeZW">AWS</label>
                                    <ul>
                                        <l>
                                            <input type="checkbox" id="iWHctDJrOy">
                                            <label for="iWHctDJrOy">Cli</label>
                                            <ul>
                                        ...
                                        <l>
                                            <input type="checkbox" id="EjyGWrwYnT">
                                            <label for="EjyGWrwYnT">Dotnet</label>
                                            <ul>
                                        ...
                                        <l>
                                            <input type="checkbox" id="IxKNBnNWji">
                                            <label for="IxKNBnNWji">Ec 2</label>
                                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="mFewYTZZWg">
                            <label for="mFewYTZZWg">Events</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="gwszfNeCYj">
                            <label for="gwszfNeCYj">Localstack</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="FfaXvHLJcD">
                            <label for="FfaXvHLJcD">Pulumi</label>
                            <ul>
                                <l>
                                    <input type="checkbox" id="xitQJVwtJE">
                                    <label for="xitQJVwtJE">Dotnet</label>
                                    <ul>
                        ...
                        <l>
                            <input type="checkbox" id="wCxXeEVSjR">
                            <label for="wCxXeEVSjR">Serverless Framework</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="RqvKgSVTCS">
                            <label for="RqvKgSVTCS">Terraform</label>
                            <ul>
                                <l>
                                    <input type="checkbox" id="jWjBaNoFjL">
                                    <label for="jWjBaNoFjL">Functions</label>
                                    <ul>
                                ...
                                <l>
                                    <input type="checkbox" id="DeIbJYyNhq">
                                    <label for="DeIbJYyNhq">Meta Arguments</label>
                                    <ul>
                ...
                <l>
                    <input type="checkbox" id="eEEIvKgJfM">
                    <label for="eEEIvKgJfM">Docker</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="UauHwIQVjN">
                    <label for="UauHwIQVjN">Dotnet</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="SJQgPmfTCj">
                            <label for="SJQgPmfTCj">Cli</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="wpJcsqFzYU">
                    <label for="wpJcsqFzYU">Functional Programming</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="JQuXCKgLwe">
                    <label for="JQuXCKgLwe">Git</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="AyEWbwLnet">
                            <label for="AyEWbwLnet">Github</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="xtcdxBAvYn">
                    <label for="xtcdxBAvYn">Go</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="pqNIhqMUvu">
                    <label for="pqNIhqMUvu">Haskell</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="mCnvYOBWcs">
                    <label for="mCnvYOBWcs">Js</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="RHFGYzLfoH">
                            <label for="RHFGYzLfoH">Node</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="svmoytWHAk">
                            <label for="svmoytWHAk">D3</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="wmTQnboTVt">
                            <label for="wmTQnboTVt">Mocha</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="RPDOpknhhG">
                            <label for="RPDOpknhhG">P5js</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="BCcjJEPnni">
                            <label for="BCcjJEPnni">Typescript</label>
                            <ul>
                                <l>
                                    <input type="checkbox" id="pIOxMQAYTK">
                                    <label for="pIOxMQAYTK">Testing</label>
                                    <ul>
                ...
                <l>
                    <input type="checkbox" id="PrCiMbcBIW">
                    <label for="PrCiMbcBIW">Kafka</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="Rcrgendwio">
                    <label for="Rcrgendwio">Kubernetes</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="dRLgzrbfSP">
                    <label for="dRLgzrbfSP">Language</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="iRAcqOxDGr">
                    <label for="iRAcqOxDGr">Linux</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="CEbMhkpNfu">
                            <label for="CEbMhkpNfu">Bash</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="xuqATYnrEK">
                    <label for="xuqATYnrEK">Oauth</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="rycQKQHLOq">
                    <label for="rycQKQHLOq">Prometheus</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="sZBrQoWVSC">
                    <label for="sZBrQoWVSC">Python</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="lOruhZPQkX">
                            <label for="lOruhZPQkX">Data Classes</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="vfLYQxsBwY">
                            <label for="vfLYQxsBwY">Libraries</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="IzUPTvfnVq">
                    <label for="IzUPTvfnVq">React</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="WnomFYeZum">
                    <label for="WnomFYeZum">Regular Expressions</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="pxxAcljNBv">
                    <label for="pxxAcljNBv">Rust</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="pILzqKXowg">
                            <label for="pILzqKXowg">Serde</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="MlBJJngYkj">
                    <label for="MlBJJngYkj">Shaders</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="AhMJdAHAHb">
                            <label for="AhMJdAHAHb">Glsl</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="TUWqRXqkwK">
                    <label for="TUWqRXqkwK">Vim</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="DtjRYEaPDE">
                    <label for="DtjRYEaPDE">Web</label>
                    <ul>
