...
<ul>
    <div name="contents-index">
        ...
        <l>
            <input type="checkbox" id="MPRDbBMArd" checked>
            <label for="MPRDbBMArd">Math</label>
            <ul>
                <l>
                    <input type="checkbox" id="DDVDPulUog">
                    <label for="DDVDPulUog">Exponentials</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="RDoeIFGjki">
                    <label for="RDoeIFGjki">Linear Algebra</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="fyKARvLXwm">
                    <label for="fyKARvLXwm">Logarithms</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="vvUnEzJazN">
                    <label for="vvUnEzJazN">Sequences</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="rYzdawlerX">
                    <label for="rYzdawlerX">Single Variable Calculus</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="KpBurRkTxE">
                    <label for="KpBurRkTxE">Trigonometry</label>
                    <ul>
        ...
        <l>
            <input type="checkbox" id="mVZVkWtsrH" checked>
            <label for="mVZVkWtsrH">Programming</label>
            <ul>
                <l>
                    <input type="checkbox" id="iaXLLqHBWo">
                    <label for="iaXLLqHBWo">Ansible</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="PWiHeGrfJu">
                    <label for="PWiHeGrfJu">Architecture</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="nyyWQnSzuS">
                    <label for="nyyWQnSzuS">Computer Graphics</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="iYiFhzPGhb">
                    <label for="iYiFhzPGhb">Databases</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="VfnNEYZVip">
                    <label for="VfnNEYZVip">Devops</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="CrnWoiWrgj">
                            <label for="CrnWoiWrgj">Cloud Computing</label>
                            <ul>
                                <l>
                                    <input type="checkbox" id="RfXzxmLOfm">
                                    <label for="RfXzxmLOfm">AWS</label>
                                    <ul>
                                        <l>
                                            <input type="checkbox" id="gHkmsDgpeZ">
                                            <label for="gHkmsDgpeZ">Cli</label>
                                            <ul>
                                        ...
                                        <l>
                                            <input type="checkbox" id="ZrBDHquKbJ">
                                            <label for="ZrBDHquKbJ">Dotnet</label>
                                            <ul>
                                        ...
                                        <l>
                                            <input type="checkbox" id="ClXpfttKqM">
                                            <label for="ClXpfttKqM">Ec 2</label>
                                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="NkAHcbtuPU">
                            <label for="NkAHcbtuPU">Events</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="AmEjVWAWTU">
                            <label for="AmEjVWAWTU">Oauth</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="jkGJVADJUi">
                            <label for="jkGJVADJUi">Pulumi</label>
                            <ul>
                                <l>
                                    <input type="checkbox" id="GeaOoeeAsa">
                                    <label for="GeaOoeeAsa">Dotnet</label>
                                    <ul>
                        ...
                        <l>
                            <input type="checkbox" id="cZovyEjJMP">
                            <label for="cZovyEjJMP">Terraform</label>
                            <ul>
                                <l>
                                    <input type="checkbox" id="qSEhNpvdhw">
                                    <label for="qSEhNpvdhw">Functions</label>
                                    <ul>
                                ...
                                <l>
                                    <input type="checkbox" id="RZNzBPJBVG">
                                    <label for="RZNzBPJBVG">Meta Arguments</label>
                                    <ul>
                ...
                <l>
                    <input type="checkbox" id="IFMVvvkhpr">
                    <label for="IFMVvvkhpr">Docker</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="xuZHItayrZ">
                    <label for="xuZHItayrZ">Dotnet</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="gxyTwbwRDF">
                            <label for="gxyTwbwRDF">Cli</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="KpWsbsIXOV">
                    <label for="KpWsbsIXOV">Functional Programming</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="xxYfVNNQbi">
                    <label for="xxYfVNNQbi">Git</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="OvlVmPDREa">
                            <label for="OvlVmPDREa">Github</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="sPkzKOkONW">
                    <label for="sPkzKOkONW">Go</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="XKnDRhpLSc">
                    <label for="XKnDRhpLSc">Haskell</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="rcryGgvBrG">
                    <label for="rcryGgvBrG">Js</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="ltlEdLPVRM">
                            <label for="ltlEdLPVRM">Node</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="cTdzULGlyw">
                            <label for="cTdzULGlyw">Mocha</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="XsLSvFSapL">
                            <label for="XsLSvFSapL">P5js</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="zuyORuMuHQ">
                            <label for="zuyORuMuHQ">Typescript</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="nVJJMDGfFh">
                    <label for="nVJJMDGfFh">Kafka</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="naYVtseYcl">
                    <label for="naYVtseYcl">Kubernetes</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="tGfQBhdPJI">
                    <label for="tGfQBhdPJI">Language</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="exXllLEMwO">
                    <label for="exXllLEMwO">Linux</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="MasmONyZQw">
                    <label for="MasmONyZQw">Python</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="AwloqnkyWm">
                            <label for="AwloqnkyWm">Data Classes</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="xikUaTTiDz">
                            <label for="xikUaTTiDz">Libraries</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="pwxfOoXywH">
                    <label for="pwxfOoXywH">React</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="wqdlErLNGr">
                    <label for="wqdlErLNGr">Regular Expressions</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="jbTDQcmFXq">
                    <label for="jbTDQcmFXq">Rust</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="EwCVImmRmB">
                            <label for="EwCVImmRmB">Serde</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="mOdnaCrlMD">
                    <label for="mOdnaCrlMD">Vim</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="hMAyQFSXxb">
                    <label for="hMAyQFSXxb">Web</label>
                    <ul>
