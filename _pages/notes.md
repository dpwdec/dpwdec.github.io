...
<ul>
    <div name="contents-index">
        ...
        <l>
            <input type="checkbox" id="ZvGdKzoFuS" checked>
            <label for="ZvGdKzoFuS">Math</label>
            <ul>
                <l>
                    <input type="checkbox" id="IKhSOCytmG">
                    <label for="IKhSOCytmG">Exponentials</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="tHqLYmriMM">
                    <label for="tHqLYmriMM">Linear Algebra</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="NOkPRGSfrv">
                    <label for="NOkPRGSfrv">Logarithms</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="UuXmrPegxj">
                    <label for="UuXmrPegxj">Sequences</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="CBQzEeKKOC">
                    <label for="CBQzEeKKOC">Single Variable Calculus</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="fbzVsOnXwP">
                    <label for="fbzVsOnXwP">Trigonometry</label>
                    <ul>
        ...
        <l>
            <input type="checkbox" id="bcVlJjkmbU" checked>
            <label for="bcVlJjkmbU">Programming</label>
            <ul>
                <l>
                    <input type="checkbox" id="fbkEtZHYED">
                    <label for="fbkEtZHYED">Ansible</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="iDEVKGTBXP">
                    <label for="iDEVKGTBXP">Architecture</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="cLpJTZeQIF">
                    <label for="cLpJTZeQIF">Computer Graphics</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="wZsvCUkjbV">
                    <label for="wZsvCUkjbV">Databases</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="mDSVCAFDfz">
                    <label for="mDSVCAFDfz">Devops</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="ERquKhonOp">
                            <label for="ERquKhonOp">Cloud Providers</label>
                            <ul>
                                <l>
                                    <input type="checkbox" id="ftNeGzYEWx">
                                    <label for="ftNeGzYEWx">AWS</label>
                                    <ul>
                                        <l>
                                            <input type="checkbox" id="CVJdYgcISL">
                                            <label for="CVJdYgcISL">Cli</label>
                                            <ul>
                                        ...
                                        <l>
                                            <input type="checkbox" id="ZKxvcGhljg">
                                            <label for="ZKxvcGhljg">Dotnet</label>
                                            <ul>
                                        ...
                                        <l>
                                            <input type="checkbox" id="hXvimCtrEC">
                                            <label for="hXvimCtrEC">Ec 2</label>
                                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="EtVJiJrRxz">
                            <label for="EtVJiJrRxz">Events</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="MSRkAefFgt">
                            <label for="MSRkAefFgt">Localstack</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="DlBrOluunM">
                            <label for="DlBrOluunM">Pulumi</label>
                            <ul>
                                <l>
                                    <input type="checkbox" id="QmZNGZiwFf">
                                    <label for="QmZNGZiwFf">Dotnet</label>
                                    <ul>
                        ...
                        <l>
                            <input type="checkbox" id="IfYLShbPWf">
                            <label for="IfYLShbPWf">Serverless Framework</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="yBrLIDUmcQ">
                            <label for="yBrLIDUmcQ">Terraform</label>
                            <ul>
                                <l>
                                    <input type="checkbox" id="cEPXZkDZcD">
                                    <label for="cEPXZkDZcD">Functions</label>
                                    <ul>
                                ...
                                <l>
                                    <input type="checkbox" id="dZnTQWIZAi">
                                    <label for="dZnTQWIZAi">Meta Arguments</label>
                                    <ul>
                ...
                <l>
                    <input type="checkbox" id="jAqNnrvqOy">
                    <label for="jAqNnrvqOy">Docker</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="ziztFpivyt">
                    <label for="ziztFpivyt">Dotnet</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="ooUWDZhjCs">
                            <label for="ooUWDZhjCs">Cli</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="DEXVPXelLd">
                    <label for="DEXVPXelLd">Functional Programming</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="eLMqZPYkGR">
                    <label for="eLMqZPYkGR">Git</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="nfocROykNY">
                            <label for="nfocROykNY">Github</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="wnExnAJcLs">
                    <label for="wnExnAJcLs">Go</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="oyoOpiROmt">
                    <label for="oyoOpiROmt">Haskell</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="eYphBLFTET">
                    <label for="eYphBLFTET">Js</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="fnraZjqFjC">
                            <label for="fnraZjqFjC">Node</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="uGoofcjNxg">
                            <label for="uGoofcjNxg">D3</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="PcUuMQnjJF">
                            <label for="PcUuMQnjJF">Mocha</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="UvFNecLlXI">
                            <label for="UvFNecLlXI">P5js</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="bYdLYDbTqv">
                            <label for="bYdLYDbTqv">Typescript</label>
                            <ul>
                                <l>
                                    <input type="checkbox" id="vtbzLaNqLD">
                                    <label for="vtbzLaNqLD">Testing</label>
                                    <ul>
                ...
                <l>
                    <input type="checkbox" id="JevjFpKRZa">
                    <label for="JevjFpKRZa">Kafka</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="bEKQOXVviv">
                    <label for="bEKQOXVviv">Kubernetes</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="VitizlggWH">
                    <label for="VitizlggWH">Language</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="LXKZOloxaC">
                    <label for="LXKZOloxaC">Linux</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="HcgFMqkOao">
                            <label for="HcgFMqkOao">Bash</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="nVHnGqJael">
                    <label for="nVHnGqJael">Oauth</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="VLMYyuANlF">
                    <label for="VLMYyuANlF">Python</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="KxUHNCKyAA">
                            <label for="KxUHNCKyAA">Data Classes</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="TydwrgqCdh">
                            <label for="TydwrgqCdh">Libraries</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="DCtofwgwmS">
                    <label for="DCtofwgwmS">React</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="BUTDfcWXVp">
                    <label for="BUTDfcWXVp">Regular Expressions</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="yPfLXJVxMa">
                    <label for="yPfLXJVxMa">Rust</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="BTNYKOvjXC">
                            <label for="BTNYKOvjXC">Serde</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="BWWiDDzTnD">
                    <label for="BWWiDDzTnD">Shaders</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="GYCTWrDhiz">
                            <label for="GYCTWrDhiz">Glsl</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="UDkpkZXNGN">
                    <label for="UDkpkZXNGN">Vim</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="UFCdAxEMMo">
                    <label for="UFCdAxEMMo">Web</label>
                    <ul>
