...
<ul>
    <div name="contents-index">
        ...
        <l>
            <input type="checkbox" id="RQszqnUUvB" checked>
            <label for="RQszqnUUvB">Math</label>
            <ul>
                <l>
                    <input type="checkbox" id="ImMQtRHQqg">
                    <label for="ImMQtRHQqg">Exponentials</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="YwpcWauexX">
                    <label for="YwpcWauexX">Linear Algebra</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="mOHZzIwotH">
                    <label for="mOHZzIwotH">Logarithms</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="VMgsWtWLWY">
                    <label for="VMgsWtWLWY">Sequences</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="ttRzIBiVat">
                    <label for="ttRzIBiVat">Single Variable Calculus</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="fQZniNsHPT">
                    <label for="fQZniNsHPT">Trigonometry</label>
                    <ul>
        ...
        <l>
            <input type="checkbox" id="xcDKToEyBy" checked>
            <label for="xcDKToEyBy">Programming</label>
            <ul>
                <l>
                    <input type="checkbox" id="peJreirKBe">
                    <label for="peJreirKBe">Ansible</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="JroUzFHaMM">
                    <label for="JroUzFHaMM">Architecture</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="gWaMWGTAdj">
                    <label for="gWaMWGTAdj">Computer Graphics</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="XHRasFgBvH">
                    <label for="XHRasFgBvH">Databases</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="WRDyAGEdru">
                    <label for="WRDyAGEdru">Devops</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="cKkLuRDCYe">
                            <label for="cKkLuRDCYe">Cloud Providers</label>
                            <ul>
                                <l>
                                    <input type="checkbox" id="BoIeYBgafD">
                                    <label for="BoIeYBgafD">AWS</label>
                                    <ul>
                                        <l>
                                            <input type="checkbox" id="ENJqezYxZn">
                                            <label for="ENJqezYxZn">Cli</label>
                                            <ul>
                                        ...
                                        <l>
                                            <input type="checkbox" id="bBAbhCyzke">
                                            <label for="bBAbhCyzke">Dotnet</label>
                                            <ul>
                                        ...
                                        <l>
                                            <input type="checkbox" id="pLuXiBzjyz">
                                            <label for="pLuXiBzjyz">Ec 2</label>
                                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="iWSoFZJuDu">
                            <label for="iWSoFZJuDu">Events</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="nkFbyAVuhA">
                            <label for="nkFbyAVuhA">Localstack</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="MzPHGdIvZu">
                            <label for="MzPHGdIvZu">Pulumi</label>
                            <ul>
                                <l>
                                    <input type="checkbox" id="vTZYdgPpWb">
                                    <label for="vTZYdgPpWb">Dotnet</label>
                                    <ul>
                        ...
                        <l>
                            <input type="checkbox" id="SfVrCddisZ">
                            <label for="SfVrCddisZ">Serverless Framework</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="sxsBeRkkxN">
                            <label for="sxsBeRkkxN">Terraform</label>
                            <ul>
                                <l>
                                    <input type="checkbox" id="GvgXEqkKMf">
                                    <label for="GvgXEqkKMf">Functions</label>
                                    <ul>
                                ...
                                <l>
                                    <input type="checkbox" id="YaPiAfNbCi">
                                    <label for="YaPiAfNbCi">Meta Arguments</label>
                                    <ul>
                ...
                <l>
                    <input type="checkbox" id="wRWSOuNucT">
                    <label for="wRWSOuNucT">Docker</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="fVsslhkSrn">
                    <label for="fVsslhkSrn">Dotnet</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="hvYuZcDDzi">
                            <label for="hvYuZcDDzi">Cli</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="GtshEFeqzc">
                    <label for="GtshEFeqzc">Functional Programming</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="hKenLCBKcn">
                    <label for="hKenLCBKcn">Git</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="HFLatNraWv">
                            <label for="HFLatNraWv">Github</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="SbRbjhWtAX">
                    <label for="SbRbjhWtAX">Go</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="VojRnpByee">
                    <label for="VojRnpByee">Haskell</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="hvJdMAmsIj">
                    <label for="hvJdMAmsIj">Js</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="IkCCZtdurW">
                            <label for="IkCCZtdurW">Node</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="bSwfOCBhgg">
                            <label for="bSwfOCBhgg">D3</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="aYbReZCIEE">
                            <label for="aYbReZCIEE">Mocha</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="cwjuBGNZZp">
                            <label for="cwjuBGNZZp">P5js</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="RASqpAHBhA">
                            <label for="RASqpAHBhA">Typescript</label>
                            <ul>
                                <l>
                                    <input type="checkbox" id="aQkCLNRAWe">
                                    <label for="aQkCLNRAWe">Testing</label>
                                    <ul>
                ...
                <l>
                    <input type="checkbox" id="RgnndVzvsQ">
                    <label for="RgnndVzvsQ">Kafka</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="JFviOfqBXz">
                    <label for="JFviOfqBXz">Kubernetes</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="ihHYsGsqYU">
                    <label for="ihHYsGsqYU">Language</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="XLhtMsgvXr">
                    <label for="XLhtMsgvXr">Linux</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="bkWLcQvKQS">
                            <label for="bkWLcQvKQS">Bash</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="ZHabfHEZlz">
                    <label for="ZHabfHEZlz">Oauth</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="RCbJAGLzCd">
                    <label for="RCbJAGLzCd">Prometheus</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="ShNkhsnVSm">
                    <label for="ShNkhsnVSm">Python</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="MMMXAEFEOd">
                            <label for="MMMXAEFEOd">Data Classes</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="xxEWIDLHan">
                            <label for="xxEWIDLHan">Libraries</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="XBGNPksltW">
                    <label for="XBGNPksltW">React</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="hERAgJOgfY">
                    <label for="hERAgJOgfY">Regular Expressions</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="ZhFUVpUgAi">
                    <label for="ZhFUVpUgAi">Rust</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="PzlQhpQykr">
                            <label for="PzlQhpQykr">Serde</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="jreHOsYRoS">
                    <label for="jreHOsYRoS">Shaders</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="mfNFNlPXeG">
                            <label for="mfNFNlPXeG">Glsl</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="konIgwsofC">
                    <label for="konIgwsofC">Vim</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="SlkVfTggCN">
                    <label for="SlkVfTggCN">Web</label>
                    <ul>
