...
<ul>
    <div name="contents-index">
        ...
        <l>
            <input type="checkbox" id="ctoiBEMnNt" checked>
            <label for="ctoiBEMnNt">Math</label>
            <ul>
                <l>
                    <input type="checkbox" id="WWLJLAzAzs">
                    <label for="WWLJLAzAzs">Exponentials</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="tZdgmDrTWU">
                    <label for="tZdgmDrTWU">Linear Algebra</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="JbelXaVHEv">
                    <label for="JbelXaVHEv">Logarithms</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="epyCOyWbpl">
                    <label for="epyCOyWbpl">Sequences</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="AHZbvKMBJp">
                    <label for="AHZbvKMBJp">Single Variable Calculus</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="FdatWUrNhx">
                    <label for="FdatWUrNhx">Trigonometry</label>
                    <ul>
        ...
        <l>
            <input type="checkbox" id="gRyxZHPKzV" checked>
            <label for="gRyxZHPKzV">Programming</label>
            <ul>
                <l>
                    <input type="checkbox" id="pHaxvoitgr">
                    <label for="pHaxvoitgr">Ansible</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="mwIOOWEvIo">
                    <label for="mwIOOWEvIo">Architecture</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="lPfwVYlHPw">
                    <label for="lPfwVYlHPw">Computer Graphics</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="dmSSYritsF">
                    <label for="dmSSYritsF">Databases</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="HtQXHXYmSv">
                    <label for="HtQXHXYmSv">Devops</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="wjFtiASVnM">
                            <label for="wjFtiASVnM">Cloud Computing</label>
                            <ul>
                                <l>
                                    <input type="checkbox" id="KZsoJrWacS">
                                    <label for="KZsoJrWacS">AWS</label>
                                    <ul>
                                        <l>
                                            <input type="checkbox" id="UvNnZLTnLl">
                                            <label for="UvNnZLTnLl">Cli</label>
                                            <ul>
                                        ...
                                        <l>
                                            <input type="checkbox" id="nPbpXmfQdC">
                                            <label for="nPbpXmfQdC">Dotnet</label>
                                            <ul>
                                        ...
                                        <l>
                                            <input type="checkbox" id="SPEPYaYIhz">
                                            <label for="SPEPYaYIhz">Ec 2</label>
                                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="mIqbqclxQt">
                            <label for="mIqbqclxQt">Events</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="TJosTjGSAA">
                            <label for="TJosTjGSAA">Oauth</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="YuXkqOZQZC">
                            <label for="YuXkqOZQZC">Pulumi</label>
                            <ul>
                                <l>
                                    <input type="checkbox" id="rEiJfwXXBA">
                                    <label for="rEiJfwXXBA">Dotnet</label>
                                    <ul>
                        ...
                        <l>
                            <input type="checkbox" id="sCdoXWneKx">
                            <label for="sCdoXWneKx">Terraform</label>
                            <ul>
                                <l>
                                    <input type="checkbox" id="QQqvqTeMiw">
                                    <label for="QQqvqTeMiw">Functions</label>
                                    <ul>
                                ...
                                <l>
                                    <input type="checkbox" id="blFWAMLMbF">
                                    <label for="blFWAMLMbF">Meta Arguments</label>
                                    <ul>
                ...
                <l>
                    <input type="checkbox" id="BgAmoOepNe">
                    <label for="BgAmoOepNe">Docker</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="TfXYtHnpah">
                    <label for="TfXYtHnpah">Dotnet</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="SqMGGCorTd">
                            <label for="SqMGGCorTd">Cli</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="zIYAaaVHUQ">
                    <label for="zIYAaaVHUQ">Functional Programming</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="obYeDBwDlm">
                    <label for="obYeDBwDlm">Git</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="VccNphioeT">
                            <label for="VccNphioeT">Github</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="VaEJRAAWdw">
                    <label for="VaEJRAAWdw">Go</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="CwhVeDiEMd">
                    <label for="CwhVeDiEMd">Haskell</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="RhXZxpZUuU">
                    <label for="RhXZxpZUuU">Js</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="DMquDYHNji">
                            <label for="DMquDYHNji">Node</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="ZDvvRIodRe">
                            <label for="ZDvvRIodRe">Mocha</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="aazgubINGS">
                            <label for="aazgubINGS">P5js</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="OXTqIwDnnc">
                            <label for="OXTqIwDnnc">Typescript</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="UhPeTaxscw">
                    <label for="UhPeTaxscw">Kafka</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="ocmRcXRywf">
                    <label for="ocmRcXRywf">Kubernetes</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="LglYWqggMx">
                    <label for="LglYWqggMx">Language</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="YlZkNMHbOj">
                    <label for="YlZkNMHbOj">Linux</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="EntZMSfFXP">
                    <label for="EntZMSfFXP">Python</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="gjCDHRcTXG">
                            <label for="gjCDHRcTXG">Data Classes</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="nhWzBmFoUM">
                            <label for="nhWzBmFoUM">Libraries</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="jzyiyoFebl">
                    <label for="jzyiyoFebl">React</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="enwuAuhpty">
                    <label for="enwuAuhpty">Regular Expressions</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="MJDwiEwsbK">
                    <label for="MJDwiEwsbK">Rust</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="DyjiAWPXfL">
                            <label for="DyjiAWPXfL">Serde</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="yILLELIWUd">
                    <label for="yILLELIWUd">Vim</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="zJvbnmMsXL">
                    <label for="zJvbnmMsXL">Web</label>
                    <ul>
