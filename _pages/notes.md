...
<ul>
    <div name="contents-index">
        ...
        <l>
            <input type="checkbox" id="YxvWGxRZVp" checked>
            <label for="YxvWGxRZVp">Math</label>
            <ul>
                <l>
                    <input type="checkbox" id="PgtGfZPnZt">
                    <label for="PgtGfZPnZt">Exponentials</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="BSYGTQJDfp">
                    <label for="BSYGTQJDfp">Linear Algebra</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="yNSENOjmww">
                    <label for="yNSENOjmww">Logarithms</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="XJSvUReybR">
                    <label for="XJSvUReybR">Sequences</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="iUydekoXjR">
                    <label for="iUydekoXjR">Single Variable Calculus</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="UKwCGugIhx">
                    <label for="UKwCGugIhx">Trigonometry</label>
                    <ul>
        ...
        <l>
            <input type="checkbox" id="fMzMVeTFee" checked>
            <label for="fMzMVeTFee">Programming</label>
            <ul>
                <l>
                    <input type="checkbox" id="sWBmKOeGVc">
                    <label for="sWBmKOeGVc">Ansible</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="MweXYMmfrF">
                    <label for="MweXYMmfrF">Architecture</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="MhxEPikvIg">
                    <label for="MhxEPikvIg">Computer Graphics</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="UpTerSWWzs">
                    <label for="UpTerSWWzs">Databases</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="fcvPEeNPAJ">
                    <label for="fcvPEeNPAJ">Devops</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="NpNIcjopjE">
                            <label for="NpNIcjopjE">Cloud Computing</label>
                            <ul>
                                <l>
                                    <input type="checkbox" id="YxAmBHIvDW">
                                    <label for="YxAmBHIvDW">AWS</label>
                                    <ul>
                                        <l>
                                            <input type="checkbox" id="kTbXCgzWNk">
                                            <label for="kTbXCgzWNk">Cli</label>
                                            <ul>
                                        ...
                                        <l>
                                            <input type="checkbox" id="gaVNbYVorg">
                                            <label for="gaVNbYVorg">Dotnet</label>
                                            <ul>
                                        ...
                                        <l>
                                            <input type="checkbox" id="zempctCaGF">
                                            <label for="zempctCaGF">Ec 2</label>
                                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="UCwUQKuVkK">
                            <label for="UCwUQKuVkK">Events</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="tMNIMiFsZT">
                            <label for="tMNIMiFsZT">Oauth</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="bDxwEtqRWJ">
                            <label for="bDxwEtqRWJ">Pulumi</label>
                            <ul>
                                <l>
                                    <input type="checkbox" id="KtxruHxKrC">
                                    <label for="KtxruHxKrC">Dotnet</label>
                                    <ul>
                        ...
                        <l>
                            <input type="checkbox" id="dwSgZzflFR">
                            <label for="dwSgZzflFR">Terraform</label>
                            <ul>
                                <l>
                                    <input type="checkbox" id="uJxesOyLHO">
                                    <label for="uJxesOyLHO">Functions</label>
                                    <ul>
                                ...
                                <l>
                                    <input type="checkbox" id="gIVBtBSPhH">
                                    <label for="gIVBtBSPhH">Meta Arguments</label>
                                    <ul>
                ...
                <l>
                    <input type="checkbox" id="ynLTKKJKva">
                    <label for="ynLTKKJKva">Docker</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="RGyHPXcezR">
                    <label for="RGyHPXcezR">Dotnet</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="DpHazhTSCw">
                            <label for="DpHazhTSCw">Cli</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="UpBAtwZpfV">
                    <label for="UpBAtwZpfV">Functional Programming</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="TOhHjsRgqo">
                    <label for="TOhHjsRgqo">Git</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="ZejUnImCRT">
                            <label for="ZejUnImCRT">Github</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="HHlAyqqyuc">
                    <label for="HHlAyqqyuc">Go</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="MlrYyWIDeE">
                    <label for="MlrYyWIDeE">Haskell</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="rYBEeGoITy">
                    <label for="rYBEeGoITy">Js</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="PDdizQZujN">
                            <label for="PDdizQZujN">Node</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="taiAzDdJJl">
                            <label for="taiAzDdJJl">D3</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="hwdVzUamyY">
                            <label for="hwdVzUamyY">Mocha</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="CsCqmqMAFk">
                            <label for="CsCqmqMAFk">P5js</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="Vayvyxscje">
                            <label for="Vayvyxscje">Typescript</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="IyUqMUEBBw">
                    <label for="IyUqMUEBBw">Kafka</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="EHeixrFcrv">
                    <label for="EHeixrFcrv">Kubernetes</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="osCKihUxEs">
                    <label for="osCKihUxEs">Language</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="DxdkufHqGl">
                    <label for="DxdkufHqGl">Linux</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="dJjyofhbTG">
                    <label for="dJjyofhbTG">Python</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="SmRGGSlxnk">
                            <label for="SmRGGSlxnk">Data Classes</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="WAusdiHQmz">
                            <label for="WAusdiHQmz">Libraries</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="JXLVFuoEaF">
                    <label for="JXLVFuoEaF">React</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="ysCZWyVIyK">
                    <label for="ysCZWyVIyK">Regular Expressions</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="teLDFtguBi">
                    <label for="teLDFtguBi">Rust</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="AtOArksdrJ">
                            <label for="AtOArksdrJ">Serde</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="uMKswCKcOx">
                    <label for="uMKswCKcOx">Vim</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="TByYlxQDjm">
                    <label for="TByYlxQDjm">Web</label>
                    <ul>
