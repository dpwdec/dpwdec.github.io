...
<ul>
    <div name="contents-index">
        ...
        <l>
            <input type="checkbox" id="csfiGUGIeR" checked>
            <label for="csfiGUGIeR">Math</label>
            <ul>
                <l>
                    <input type="checkbox" id="pqxuMjMLtu">
                    <label for="pqxuMjMLtu">Exponentials</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="MMliMPZBZJ">
                    <label for="MMliMPZBZJ">Linear Algebra</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="QsccEdVKdL">
                    <label for="QsccEdVKdL">Logarithms</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="PjLxyyCjaB">
                    <label for="PjLxyyCjaB">Sequences</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="ctgjtHjrUH">
                    <label for="ctgjtHjrUH">Single Variable Calculus</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="pZUOBxxJji">
                    <label for="pZUOBxxJji">Trigonometry</label>
                    <ul>
        ...
        <l>
            <input type="checkbox" id="DbBcwLgDCP" checked>
            <label for="DbBcwLgDCP">Programming</label>
            <ul>
                <l>
                    <input type="checkbox" id="GYGMdpVdtP">
                    <label for="GYGMdpVdtP">Ansible</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="ccjMejLaHz">
                    <label for="ccjMejLaHz">Architecture</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="UMbpRRQOdR">
                    <label for="UMbpRRQOdR">Computer Graphics</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="HAOQdbqtka">
                    <label for="HAOQdbqtka">Databases</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="fVezXEQJSY">
                    <label for="fVezXEQJSY">Devops</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="KYMyRCxdEf">
                            <label for="KYMyRCxdEf">Cloud Providers</label>
                            <ul>
                                <l>
                                    <input type="checkbox" id="DPBxcRdBZs">
                                    <label for="DPBxcRdBZs">AWS</label>
                                    <ul>
                                        <l>
                                            <input type="checkbox" id="hnmZTvZGwx">
                                            <label for="hnmZTvZGwx">Cli</label>
                                            <ul>
                                        ...
                                        <l>
                                            <input type="checkbox" id="cUvYjKXsYo">
                                            <label for="cUvYjKXsYo">Dotnet</label>
                                            <ul>
                                        ...
                                        <l>
                                            <input type="checkbox" id="NgoZxDtFok">
                                            <label for="NgoZxDtFok">Ec 2</label>
                                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="PAQxSKJFrZ">
                            <label for="PAQxSKJFrZ">Events</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="vTQgKCpDNp">
                            <label for="vTQgKCpDNp">Localstack</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="TsqTjwNpbu">
                            <label for="TsqTjwNpbu">Pulumi</label>
                            <ul>
                                <l>
                                    <input type="checkbox" id="KhAgWPVIrR">
                                    <label for="KhAgWPVIrR">Dotnet</label>
                                    <ul>
                        ...
                        <l>
                            <input type="checkbox" id="uYlzygkpXT">
                            <label for="uYlzygkpXT">Serverless Framework</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="xtCkfAsiVW">
                            <label for="xtCkfAsiVW">Terraform</label>
                            <ul>
                                <l>
                                    <input type="checkbox" id="WYbvmyyHXP">
                                    <label for="WYbvmyyHXP">Functions</label>
                                    <ul>
                                ...
                                <l>
                                    <input type="checkbox" id="uzmiKtspXj">
                                    <label for="uzmiKtspXj">Meta Arguments</label>
                                    <ul>
                ...
                <l>
                    <input type="checkbox" id="pSDNISCNrp">
                    <label for="pSDNISCNrp">Docker</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="UfexGBdyxQ">
                    <label for="UfexGBdyxQ">Dotnet</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="CJkoSMbwiL">
                            <label for="CJkoSMbwiL">Cli</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="yQvnpWEJbf">
                    <label for="yQvnpWEJbf">Functional Programming</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="MwlxsiObiz">
                    <label for="MwlxsiObiz">Git</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="OHSuAwwtTG">
                            <label for="OHSuAwwtTG">Github</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="gQUuoakvyk">
                    <label for="gQUuoakvyk">Go</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="hqMxaUqqMq">
                    <label for="hqMxaUqqMq">Haskell</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="sgliqCazjP">
                    <label for="sgliqCazjP">Js</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="gsLsfJlGcO">
                            <label for="gsLsfJlGcO">Node</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="JmSxRfFoRI">
                            <label for="JmSxRfFoRI">D3</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="YnLhcUistt">
                            <label for="YnLhcUistt">Mocha</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="ZUthntRlrX">
                            <label for="ZUthntRlrX">P5js</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="YUQzmfqFDB">
                            <label for="YUQzmfqFDB">Typescript</label>
                            <ul>
                                <l>
                                    <input type="checkbox" id="LxFtMQuEPN">
                                    <label for="LxFtMQuEPN">Testing</label>
                                    <ul>
                ...
                <l>
                    <input type="checkbox" id="EHLweJdLoS">
                    <label for="EHLweJdLoS">Kafka</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="YSgoMYEgZv">
                    <label for="YSgoMYEgZv">Kubernetes</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="FvrBsIcSHV">
                    <label for="FvrBsIcSHV">Language</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="aEkeyWiXjl">
                    <label for="aEkeyWiXjl">Linux</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="ZeGqyAwksP">
                            <label for="ZeGqyAwksP">Bash</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="ZSjZjrlRBF">
                    <label for="ZSjZjrlRBF">Oauth</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="BlQHauClfM">
                    <label for="BlQHauClfM">Python</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="qsZtmJXoaQ">
                            <label for="qsZtmJXoaQ">Data Classes</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="DjjjqnKpfj">
                            <label for="DjjjqnKpfj">Libraries</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="GoCpyVdtjz">
                    <label for="GoCpyVdtjz">React</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="SKJmhtcFkT">
                    <label for="SKJmhtcFkT">Regular Expressions</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="pmiteSqrWu">
                    <label for="pmiteSqrWu">Rust</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="boLFXosdDn">
                            <label for="boLFXosdDn">Serde</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="syXvWmyUEk">
                    <label for="syXvWmyUEk">Vim</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="CpmlNCdemk">
                    <label for="CpmlNCdemk">Web</label>
                    <ul>
