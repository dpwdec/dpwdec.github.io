...
<ul>
    <div name="contents-index">
        ...
        <l>
            <input type="checkbox" id="fKLMbKdLeN" checked>
            <label for="fKLMbKdLeN">Math</label>
            <ul>
                <l>
                    <input type="checkbox" id="EfQQMaRVNm">
                    <label for="EfQQMaRVNm">Exponentials</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="jsvNsLctKJ">
                    <label for="jsvNsLctKJ">Linear Algebra</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="QNSVODdfor">
                    <label for="QNSVODdfor">Logarithms</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="RBJhhSCFio">
                    <label for="RBJhhSCFio">Sequences</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="Mjqtuykvyt">
                    <label for="Mjqtuykvyt">Single Variable Calculus</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="CBQLKnXEbE">
                    <label for="CBQLKnXEbE">Trigonometry</label>
                    <ul>
        ...
        <l>
            <input type="checkbox" id="ELlHvBxHlv" checked>
            <label for="ELlHvBxHlv">Programming</label>
            <ul>
                <l>
                    <input type="checkbox" id="REaUjHnYaJ">
                    <label for="REaUjHnYaJ">Ansible</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="kBitSOjUJS">
                    <label for="kBitSOjUJS">Architecture</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="PgokxsinzS">
                    <label for="PgokxsinzS">Computer Graphics</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="WUIaliIcNB">
                    <label for="WUIaliIcNB">Databases</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="zqqIjINMht">
                    <label for="zqqIjINMht">Devops</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="BkvHYPaqES">
                            <label for="BkvHYPaqES">Cloud Computing</label>
                            <ul>
                                <l>
                                    <input type="checkbox" id="FUNWLxKRak">
                                    <label for="FUNWLxKRak">AWS</label>
                                    <ul>
                                        <l>
                                            <input type="checkbox" id="omTIptLxDg">
                                            <label for="omTIptLxDg">Cli</label>
                                            <ul>
                                        ...
                                        <l>
                                            <input type="checkbox" id="XblIzAVKfx">
                                            <label for="XblIzAVKfx">Dotnet</label>
                                            <ul>
                                        ...
                                        <l>
                                            <input type="checkbox" id="quOqdKUQSj">
                                            <label for="quOqdKUQSj">Ec 2</label>
                                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="srzejvhOBl">
                            <label for="srzejvhOBl">Events</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="zVgDSFrWXD">
                            <label for="zVgDSFrWXD">Oauth</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="ZZITsrUjPS">
                            <label for="ZZITsrUjPS">Pulumi</label>
                            <ul>
                                <l>
                                    <input type="checkbox" id="jNdJDwczRW">
                                    <label for="jNdJDwczRW">Dotnet</label>
                                    <ul>
                        ...
                        <l>
                            <input type="checkbox" id="THwTcZPFgi">
                            <label for="THwTcZPFgi">Terraform</label>
                            <ul>
                                <l>
                                    <input type="checkbox" id="MTpQFyZaTf">
                                    <label for="MTpQFyZaTf">Functions</label>
                                    <ul>
                                ...
                                <l>
                                    <input type="checkbox" id="MYYdefEeDL">
                                    <label for="MYYdefEeDL">Meta Arguments</label>
                                    <ul>
                ...
                <l>
                    <input type="checkbox" id="efrTiUcjtb">
                    <label for="efrTiUcjtb">Docker</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="fTimfaFrwo">
                    <label for="fTimfaFrwo">Dotnet</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="ZDVtoAoEkN">
                            <label for="ZDVtoAoEkN">Cli</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="aVANsYECWp">
                    <label for="aVANsYECWp">Functional Programming</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="pyeYeKFXHJ">
                    <label for="pyeYeKFXHJ">Git</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="hrRJBNIJtz">
                            <label for="hrRJBNIJtz">Github</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="DItKHusvHr">
                    <label for="DItKHusvHr">Go</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="NzRgIXQgTA">
                    <label for="NzRgIXQgTA">Haskell</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="MxFDhQdYVf">
                    <label for="MxFDhQdYVf">Js</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="FLameJefSP">
                            <label for="FLameJefSP">Node</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="xzGijSLvbo">
                            <label for="xzGijSLvbo">D3</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="gjwbcHBbfB">
                            <label for="gjwbcHBbfB">Mocha</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="dlVLvOlXGN">
                            <label for="dlVLvOlXGN">P5js</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="PnhvAGbgMz">
                            <label for="PnhvAGbgMz">Typescript</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="StPPejgqqG">
                    <label for="StPPejgqqG">Kafka</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="rVFFGiqQba">
                    <label for="rVFFGiqQba">Kubernetes</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="BcMXqnglpO">
                    <label for="BcMXqnglpO">Language</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="uBmYcMnQoz">
                    <label for="uBmYcMnQoz">Linux</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="OgGNSipugH">
                    <label for="OgGNSipugH">Python</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="ecbvkXdEzt">
                            <label for="ecbvkXdEzt">Data Classes</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="nolbCwgIpr">
                            <label for="nolbCwgIpr">Libraries</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="lRZKyjnMFs">
                    <label for="lRZKyjnMFs">React</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="mUEIbYZotE">
                    <label for="mUEIbYZotE">Regular Expressions</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="mBfSXSxVcz">
                    <label for="mBfSXSxVcz">Rust</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="ODsCfvMllG">
                            <label for="ODsCfvMllG">Serde</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="cFSgntygrH">
                    <label for="cFSgntygrH">Vim</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="DfYbuqSKpi">
                    <label for="DfYbuqSKpi">Web</label>
                    <ul>
