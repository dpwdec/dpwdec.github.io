...
<ul>
    <div name="contents-index">
        ...
        <l>
            <input type="checkbox" id="mlDEaVFDcx" checked>
            <label for="mlDEaVFDcx">Math</label>
            <ul>
                <l>
                    <input type="checkbox" id="tCJulLFUUb">
                    <label for="tCJulLFUUb">Exponentials</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="cKgBDtlKAy">
                    <label for="cKgBDtlKAy">Linear Algebra</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="dqpjabroWZ">
                    <label for="dqpjabroWZ">Logarithms</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="RWtLurukYo">
                    <label for="RWtLurukYo">Sequences</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="STTOunLvqg">
                    <label for="STTOunLvqg">Single Variable Calculus</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="IGZRlGKuvp">
                    <label for="IGZRlGKuvp">Trigonometry</label>
                    <ul>
        ...
        <l>
            <input type="checkbox" id="yPdCMMwUgf" checked>
            <label for="yPdCMMwUgf">Programming</label>
            <ul>
                <l>
                    <input type="checkbox" id="fsVyoFmQvE">
                    <label for="fsVyoFmQvE">Ansible</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="KUxeHvfPyu">
                    <label for="KUxeHvfPyu">Architecture</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="oQvdsBeHvy">
                    <label for="oQvdsBeHvy">Computer Graphics</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="IDZDLWvhhK">
                    <label for="IDZDLWvhhK">Databases</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="UhxKBRDtaS">
                    <label for="UhxKBRDtaS">Devops</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="TAUCNvQpEI">
                            <label for="TAUCNvQpEI">Cloud Providers</label>
                            <ul>
                                <l>
                                    <input type="checkbox" id="wqrGIbcecQ">
                                    <label for="wqrGIbcecQ">AWS</label>
                                    <ul>
                                        <l>
                                            <input type="checkbox" id="TigajgqKut">
                                            <label for="TigajgqKut">Cli</label>
                                            <ul>
                                        ...
                                        <l>
                                            <input type="checkbox" id="eaVsnSjlYe">
                                            <label for="eaVsnSjlYe">Dotnet</label>
                                            <ul>
                                        ...
                                        <l>
                                            <input type="checkbox" id="TFspeeVQzx">
                                            <label for="TFspeeVQzx">Ec 2</label>
                                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="OQRbSkUlku">
                            <label for="OQRbSkUlku">Events</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="tHpWgLaGkk">
                            <label for="tHpWgLaGkk">Localstack</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="QbaukZNnEd">
                            <label for="QbaukZNnEd">Pulumi</label>
                            <ul>
                                <l>
                                    <input type="checkbox" id="UXZNAvZhGp">
                                    <label for="UXZNAvZhGp">Dotnet</label>
                                    <ul>
                        ...
                        <l>
                            <input type="checkbox" id="rHduaepJiY">
                            <label for="rHduaepJiY">Serverless Framework</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="FavJVGiEkC">
                            <label for="FavJVGiEkC">Terraform</label>
                            <ul>
                                <l>
                                    <input type="checkbox" id="lpWEaFpXJE">
                                    <label for="lpWEaFpXJE">Functions</label>
                                    <ul>
                                ...
                                <l>
                                    <input type="checkbox" id="dveTqpKrTy">
                                    <label for="dveTqpKrTy">Meta Arguments</label>
                                    <ul>
                ...
                <l>
                    <input type="checkbox" id="wsbLabPelO">
                    <label for="wsbLabPelO">Docker</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="JeszSGoKvn">
                    <label for="JeszSGoKvn">Dotnet</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="YUuubKAEVU">
                            <label for="YUuubKAEVU">Cli</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="WXYnwmjbRJ">
                    <label for="WXYnwmjbRJ">Functional Programming</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="jwAWOgJXmz">
                    <label for="jwAWOgJXmz">Git</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="pTfgpcnDBI">
                            <label for="pTfgpcnDBI">Github</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="FocTDlAIXO">
                    <label for="FocTDlAIXO">Go</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="PRbuVRUhPF">
                    <label for="PRbuVRUhPF">Haskell</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="GcIldfAUip">
                    <label for="GcIldfAUip">Js</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="eOcYZRrUmM">
                            <label for="eOcYZRrUmM">Node</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="KGAZIRKktJ">
                            <label for="KGAZIRKktJ">D3</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="ZAsZwplZHI">
                            <label for="ZAsZwplZHI">Mocha</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="GKWjpjtogK">
                            <label for="GKWjpjtogK">P5js</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="CIiTPpXeMv">
                            <label for="CIiTPpXeMv">Typescript</label>
                            <ul>
                                <l>
                                    <input type="checkbox" id="xlwuVZtOFv">
                                    <label for="xlwuVZtOFv">Testing</label>
                                    <ul>
                ...
                <l>
                    <input type="checkbox" id="isAQpXEBOZ">
                    <label for="isAQpXEBOZ">Kafka</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="yNCRYLIBEB">
                    <label for="yNCRYLIBEB">Kubernetes</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="mKShowrvPj">
                    <label for="mKShowrvPj">Language</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="tWmFOaPUCQ">
                    <label for="tWmFOaPUCQ">Linux</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="IUgbihDYzg">
                            <label for="IUgbihDYzg">Bash</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="EqoTQDcnIe">
                    <label for="EqoTQDcnIe">Oauth</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="OPsXSNdfaB">
                    <label for="OPsXSNdfaB">Prometheus</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="fftXuRtuwk">
                    <label for="fftXuRtuwk">Python</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="bNwpHGRwaY">
                            <label for="bNwpHGRwaY">Data Classes</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="pTBAzFojID">
                            <label for="pTBAzFojID">Libraries</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="UNzmQGGMCF">
                    <label for="UNzmQGGMCF">React</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="noNmFmztGF">
                    <label for="noNmFmztGF">Regular Expressions</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="AUQuPSmNzB">
                    <label for="AUQuPSmNzB">Rust</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="gofMwSllNk">
                            <label for="gofMwSllNk">Serde</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="OJXZPZSNhb">
                    <label for="OJXZPZSNhb">Shaders</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="LgNIkgOJvP">
                            <label for="LgNIkgOJvP">Glsl</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="ixiJkmfoZS">
                    <label for="ixiJkmfoZS">Vim</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="DitmIXBcFL">
                    <label for="DitmIXBcFL">Web</label>
                    <ul>
