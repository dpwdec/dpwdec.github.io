...
<ul>
    <div name="contents-index">
        ...
        <l>
            <input type="checkbox" id="sBRFgScdqQ" checked>
            <label for="sBRFgScdqQ">Math</label>
            <ul>
                <l>
                    <input type="checkbox" id="gytYEMTVkr">
                    <label for="gytYEMTVkr">Exponentials</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="spWczcHzry">
                    <label for="spWczcHzry">Linear Algebra</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="kPHYZjDALK">
                    <label for="kPHYZjDALK">Logarithms</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="dfVPklERRa">
                    <label for="dfVPklERRa">Sequences</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="zIDvOTswqE">
                    <label for="zIDvOTswqE">Single Variable Calculus</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="xIMtXphgUH">
                    <label for="xIMtXphgUH">Trigonometry</label>
                    <ul>
        ...
        <l>
            <input type="checkbox" id="dpeemsqpBE" checked>
            <label for="dpeemsqpBE">Programming</label>
            <ul>
                <l>
                    <input type="checkbox" id="MIUFCCwgVV">
                    <label for="MIUFCCwgVV">Ansible</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="QArOCRARII">
                    <label for="QArOCRARII">Architecture</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="ueRajdnLxM">
                    <label for="ueRajdnLxM">Computer Graphics</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="MqrltrntlL">
                    <label for="MqrltrntlL">Databases</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="NPfYmlBNeZ">
                    <label for="NPfYmlBNeZ">Devops</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="PPXZaEDCxP">
                            <label for="PPXZaEDCxP">Cloud Providers</label>
                            <ul>
                                <l>
                                    <input type="checkbox" id="jKfQSLiSKQ">
                                    <label for="jKfQSLiSKQ">AWS</label>
                                    <ul>
                                        <l>
                                            <input type="checkbox" id="rXlxdaYdAZ">
                                            <label for="rXlxdaYdAZ">Cli</label>
                                            <ul>
                                        ...
                                        <l>
                                            <input type="checkbox" id="QmwJfRZdpa">
                                            <label for="QmwJfRZdpa">Dotnet</label>
                                            <ul>
                                        ...
                                        <l>
                                            <input type="checkbox" id="EaKNLHxQCR">
                                            <label for="EaKNLHxQCR">Ec 2</label>
                                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="OMvZHtWfgO">
                            <label for="OMvZHtWfgO">Events</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="MvIHHugrZU">
                            <label for="MvIHHugrZU">Localstack</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="VTtnoHZhsM">
                            <label for="VTtnoHZhsM">Pulumi</label>
                            <ul>
                                <l>
                                    <input type="checkbox" id="xIHPQYiCWk">
                                    <label for="xIHPQYiCWk">Dotnet</label>
                                    <ul>
                        ...
                        <l>
                            <input type="checkbox" id="zytDxzdDXc">
                            <label for="zytDxzdDXc">Serverless Framework</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="FxATyYpqOM">
                            <label for="FxATyYpqOM">Terraform</label>
                            <ul>
                                <l>
                                    <input type="checkbox" id="vMYGgLDYAN">
                                    <label for="vMYGgLDYAN">Functions</label>
                                    <ul>
                                ...
                                <l>
                                    <input type="checkbox" id="wjFiAkAdal">
                                    <label for="wjFiAkAdal">Meta Arguments</label>
                                    <ul>
                ...
                <l>
                    <input type="checkbox" id="rixjFgbQcz">
                    <label for="rixjFgbQcz">Docker</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="umVPtMKlUi">
                    <label for="umVPtMKlUi">Dotnet</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="snEuJwmdVO">
                            <label for="snEuJwmdVO">Cli</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="CVcECKwisp">
                    <label for="CVcECKwisp">Functional Programming</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="bzZXeiauig">
                    <label for="bzZXeiauig">Git</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="qxDPZGDuRI">
                            <label for="qxDPZGDuRI">Github</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="hDvwYWYHwf">
                    <label for="hDvwYWYHwf">Go</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="BORqnqsYNF">
                    <label for="BORqnqsYNF">Haskell</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="YUBcXajhyo">
                    <label for="YUBcXajhyo">Js</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="xYvMLGtwyn">
                            <label for="xYvMLGtwyn">Node</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="jhRjJSeykB">
                            <label for="jhRjJSeykB">D3</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="ETXNEhTWhN">
                            <label for="ETXNEhTWhN">Mocha</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="QDZVHrevCJ">
                            <label for="QDZVHrevCJ">P5js</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="eXydKuWALt">
                            <label for="eXydKuWALt">Typescript</label>
                            <ul>
                                <l>
                                    <input type="checkbox" id="uCnHAJPDvF">
                                    <label for="uCnHAJPDvF">Testing</label>
                                    <ul>
                ...
                <l>
                    <input type="checkbox" id="FupWgjppJb">
                    <label for="FupWgjppJb">Kafka</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="osMpdHreVl">
                    <label for="osMpdHreVl">Kubernetes</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="tXREAZENPx">
                    <label for="tXREAZENPx">Language</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="lVBRelOgml">
                    <label for="lVBRelOgml">Linux</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="rxZWKOfJmK">
                            <label for="rxZWKOfJmK">Bash</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="XOGZTqITPf">
                    <label for="XOGZTqITPf">Oauth</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="gvRQaYKOeZ">
                    <label for="gvRQaYKOeZ">Prometheus</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="SjVKPzZXqL">
                    <label for="SjVKPzZXqL">Python</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="BufbuojhMq">
                            <label for="BufbuojhMq">Data Classes</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="ippoePDjju">
                            <label for="ippoePDjju">Libraries</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="krfmexmkEb">
                    <label for="krfmexmkEb">React</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="EAPXCOZuLf">
                    <label for="EAPXCOZuLf">Regular Expressions</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="fKsIPRPQpF">
                    <label for="fKsIPRPQpF">Rust</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="CbwUSbAnde">
                            <label for="CbwUSbAnde">Serde</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="PerVhegQnc">
                    <label for="PerVhegQnc">Shaders</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="OVBpsJrkhz">
                            <label for="OVBpsJrkhz">Glsl</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="DLPHIHNJGc">
                    <label for="DLPHIHNJGc">Vim</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="QRJSZlPrCN">
                    <label for="QRJSZlPrCN">Web</label>
                    <ul>
