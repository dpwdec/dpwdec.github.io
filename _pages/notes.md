...
<ul>
    <div name="contents-index">
        ...
        <l>
            <input type="checkbox" id="UzlLHzaVwf" checked>
            <label for="UzlLHzaVwf">Math</label>
            <ul>
                <l>
                    <input type="checkbox" id="KowhDJEnpl">
                    <label for="KowhDJEnpl">Exponentials</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="ZTlQmNxBtx">
                    <label for="ZTlQmNxBtx">Linear Algebra</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="HlwpnZJbbr">
                    <label for="HlwpnZJbbr">Logarithms</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="irjRxLnApp">
                    <label for="irjRxLnApp">Sequences</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="MdtFFMEUFB">
                    <label for="MdtFFMEUFB">Single Variable Calculus</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="BjjCzVRzUh">
                    <label for="BjjCzVRzUh">Trigonometry</label>
                    <ul>
        ...
        <l>
            <input type="checkbox" id="RXFVJBkrHG" checked>
            <label for="RXFVJBkrHG">Programming</label>
            <ul>
                <l>
                    <input type="checkbox" id="cIqjyAkyXw">
                    <label for="cIqjyAkyXw">Ansible</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="fcjnzEOkPz">
                    <label for="fcjnzEOkPz">Architecture</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="oGMCSEForU">
                    <label for="oGMCSEForU">Computer Graphics</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="GfzZMqKcmi">
                    <label for="GfzZMqKcmi">Databases</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="xuZaJhBRJd">
                    <label for="xuZaJhBRJd">Devops</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="xSqciVIJaO">
                            <label for="xSqciVIJaO">Cloud Providers</label>
                            <ul>
                                <l>
                                    <input type="checkbox" id="mcaFqACRNk">
                                    <label for="mcaFqACRNk">AWS</label>
                                    <ul>
                                        <l>
                                            <input type="checkbox" id="jLkpvgZUyY">
                                            <label for="jLkpvgZUyY">Cli</label>
                                            <ul>
                                        ...
                                        <l>
                                            <input type="checkbox" id="UlLuqoqYKe">
                                            <label for="UlLuqoqYKe">Dotnet</label>
                                            <ul>
                                        ...
                                        <l>
                                            <input type="checkbox" id="gPUbgapjjE">
                                            <label for="gPUbgapjjE">Ec 2</label>
                                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="JVATbFwbBK">
                            <label for="JVATbFwbBK">Events</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="KyFBLVdoUK">
                            <label for="KyFBLVdoUK">Localstack</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="TWJUnojvbL">
                            <label for="TWJUnojvbL">Pulumi</label>
                            <ul>
                                <l>
                                    <input type="checkbox" id="dzhVJohLOy">
                                    <label for="dzhVJohLOy">Dotnet</label>
                                    <ul>
                        ...
                        <l>
                            <input type="checkbox" id="jgBRGUShwX">
                            <label for="jgBRGUShwX">Serverless Framework</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="JeNlsFogsn">
                            <label for="JeNlsFogsn">Terraform</label>
                            <ul>
                                <l>
                                    <input type="checkbox" id="llWZleHkKZ">
                                    <label for="llWZleHkKZ">Functions</label>
                                    <ul>
                                ...
                                <l>
                                    <input type="checkbox" id="yIrudLxeyK">
                                    <label for="yIrudLxeyK">Meta Arguments</label>
                                    <ul>
                ...
                <l>
                    <input type="checkbox" id="ShRxWhZxLw">
                    <label for="ShRxWhZxLw">Docker</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="TCJIEtEcKn">
                    <label for="TCJIEtEcKn">Dotnet</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="jTLCegjIpk">
                            <label for="jTLCegjIpk">Cli</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="fMYHKihZce">
                    <label for="fMYHKihZce">Functional Programming</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="xIrkGbtKPo">
                    <label for="xIrkGbtKPo">Git</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="OBsUawdBhG">
                            <label for="OBsUawdBhG">Github</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="NNLTqFaxaL">
                    <label for="NNLTqFaxaL">Go</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="SfjkbcTFwx">
                    <label for="SfjkbcTFwx">Haskell</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="GcZLXATedV">
                    <label for="GcZLXATedV">Js</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="SQqdAEYIFB">
                            <label for="SQqdAEYIFB">Node</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="mEDmNKwZEX">
                            <label for="mEDmNKwZEX">D3</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="TONUHPMErt">
                            <label for="TONUHPMErt">Mocha</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="cZMTTGlUEv">
                            <label for="cZMTTGlUEv">P5js</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="FqQiQNOJJW">
                            <label for="FqQiQNOJJW">Typescript</label>
                            <ul>
                                <l>
                                    <input type="checkbox" id="RNHIwomEkz">
                                    <label for="RNHIwomEkz">Testing</label>
                                    <ul>
                ...
                <l>
                    <input type="checkbox" id="IhirBgRIwU">
                    <label for="IhirBgRIwU">Kafka</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="rXWhJKbJuO">
                    <label for="rXWhJKbJuO">Kubernetes</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="aXsKxhyiYR">
                    <label for="aXsKxhyiYR">Language</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="lwfInYEIjU">
                    <label for="lwfInYEIjU">Linux</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="HwpVZrKLrK">
                            <label for="HwpVZrKLrK">Bash</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="BgkRzLxwLU">
                    <label for="BgkRzLxwLU">Oauth</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="sNzdZZbjbo">
                    <label for="sNzdZZbjbo">Python</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="FNlnjMRRQJ">
                            <label for="FNlnjMRRQJ">Data Classes</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="NVwMPOrzTP">
                            <label for="NVwMPOrzTP">Libraries</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="cKxYppCZRk">
                    <label for="cKxYppCZRk">React</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="hiLaIMDbIG">
                    <label for="hiLaIMDbIG">Regular Expressions</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="esfotveHBM">
                    <label for="esfotveHBM">Rust</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="wKvvzxkxqX">
                            <label for="wKvvzxkxqX">Serde</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="HmnCdIdYqT">
                    <label for="HmnCdIdYqT">Vim</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="pIcCxoAUDZ">
                    <label for="pIcCxoAUDZ">Web</label>
                    <ul>
