...
<ul>
    <div name="contents-index">
        ...
        <l>
            <input type="checkbox" id="KkyxDPSsKq" checked>
            <label for="KkyxDPSsKq">Math</label>
            <ul>
                <l>
                    <input type="checkbox" id="wNzTZLwjHj">
                    <label for="wNzTZLwjHj">Exponentials</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="LfhTgoUYwT">
                    <label for="LfhTgoUYwT">Linear Algebra</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="EIWXcGbOrs">
                    <label for="EIWXcGbOrs">Logarithms</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="AsrWmKPwJy">
                    <label for="AsrWmKPwJy">Sequences</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="xAAWtWoeOS">
                    <label for="xAAWtWoeOS">Single Variable Calculus</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="uAfrnnMiBg">
                    <label for="uAfrnnMiBg">Trigonometry</label>
                    <ul>
        ...
        <l>
            <input type="checkbox" id="LMFeVmZkLf" checked>
            <label for="LMFeVmZkLf">Programming</label>
            <ul>
                <l>
                    <input type="checkbox" id="RqUvQTlNPJ">
                    <label for="RqUvQTlNPJ">Ansible</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="ioTTjUlqJU">
                    <label for="ioTTjUlqJU">Architecture</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="vFFNuYNfma">
                    <label for="vFFNuYNfma">Computer Graphics</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="QSquJSZGAr">
                    <label for="QSquJSZGAr">Databases</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="PAzkknyrrb">
                    <label for="PAzkknyrrb">Devops</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="UohsUUdCol">
                            <label for="UohsUUdCol">Cloud Providers</label>
                            <ul>
                                <l>
                                    <input type="checkbox" id="WzrRWtgCBE">
                                    <label for="WzrRWtgCBE">AWS</label>
                                    <ul>
                                        <l>
                                            <input type="checkbox" id="xSOZYvcFvN">
                                            <label for="xSOZYvcFvN">Cli</label>
                                            <ul>
                                        ...
                                        <l>
                                            <input type="checkbox" id="SRLOdcuFMD">
                                            <label for="SRLOdcuFMD">Dotnet</label>
                                            <ul>
                                        ...
                                        <l>
                                            <input type="checkbox" id="ssCAqOwsQn">
                                            <label for="ssCAqOwsQn">Ec 2</label>
                                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="vCeKtiwmyW">
                            <label for="vCeKtiwmyW">Events</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="zLwnyRfqOJ">
                            <label for="zLwnyRfqOJ">Localstack</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="pDYVmPiMMI">
                            <label for="pDYVmPiMMI">Pulumi</label>
                            <ul>
                                <l>
                                    <input type="checkbox" id="yUCiXKkiSK">
                                    <label for="yUCiXKkiSK">Dotnet</label>
                                    <ul>
                        ...
                        <l>
                            <input type="checkbox" id="jVLivgNQnz">
                            <label for="jVLivgNQnz">Serverless Framework</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="cgGbzGjnuM">
                            <label for="cgGbzGjnuM">Terraform</label>
                            <ul>
                                <l>
                                    <input type="checkbox" id="wDzMMtcwUi">
                                    <label for="wDzMMtcwUi">Functions</label>
                                    <ul>
                                ...
                                <l>
                                    <input type="checkbox" id="CLkQCvHgvu">
                                    <label for="CLkQCvHgvu">Meta Arguments</label>
                                    <ul>
                ...
                <l>
                    <input type="checkbox" id="zOCpkjOixY">
                    <label for="zOCpkjOixY">Docker</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="GRdnCsEiSJ">
                    <label for="GRdnCsEiSJ">Dotnet</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="BgSJwxBMbU">
                            <label for="BgSJwxBMbU">Cli</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="ifZePkvOlq">
                    <label for="ifZePkvOlq">Functional Programming</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="LtLSSvSGhT">
                    <label for="LtLSSvSGhT">Git</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="lqmsrTXWYQ">
                            <label for="lqmsrTXWYQ">Github</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="wPMqmNIIPn">
                    <label for="wPMqmNIIPn">Go</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="NGOJoxeqmZ">
                    <label for="NGOJoxeqmZ">Haskell</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="pMyjTNdYNZ">
                    <label for="pMyjTNdYNZ">Js</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="wkBATHraJK">
                            <label for="wkBATHraJK">Node</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="EITfxZtOKO">
                            <label for="EITfxZtOKO">D3</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="YhVqEAYfmA">
                            <label for="YhVqEAYfmA">Mocha</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="LYTBlDeUhr">
                            <label for="LYTBlDeUhr">P5js</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="fjQoOBGxUE">
                            <label for="fjQoOBGxUE">Typescript</label>
                            <ul>
                                <l>
                                    <input type="checkbox" id="RpTAXnYnsH">
                                    <label for="RpTAXnYnsH">Testing</label>
                                    <ul>
                ...
                <l>
                    <input type="checkbox" id="XGaEIGtXHc">
                    <label for="XGaEIGtXHc">Kafka</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="dbaeuGRgrd">
                    <label for="dbaeuGRgrd">Kubernetes</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="CgUprYAuZs">
                    <label for="CgUprYAuZs">Language</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="EHwilqvAbe">
                    <label for="EHwilqvAbe">Linux</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="yohdUVyaGY">
                            <label for="yohdUVyaGY">Bash</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="vnEYeyzfiH">
                    <label for="vnEYeyzfiH">Oauth</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="jbZabflkMf">
                    <label for="jbZabflkMf">Prometheus</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="axgiVrlZEc">
                    <label for="axgiVrlZEc">Python</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="IMSzsYxSOq">
                            <label for="IMSzsYxSOq">Data Classes</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="czagpkKOyZ">
                            <label for="czagpkKOyZ">Libraries</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="AzkDqCfmqk">
                    <label for="AzkDqCfmqk">React</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="wbfHWbMTiH">
                    <label for="wbfHWbMTiH">Regular Expressions</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="WnsLcLSXJT">
                    <label for="WnsLcLSXJT">Rust</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="nWRkPzoSCf">
                            <label for="nWRkPzoSCf">Serde</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="sffRHETmIe">
                    <label for="sffRHETmIe">Shaders</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="eQqwvDPWqM">
                            <label for="eQqwvDPWqM">Glsl</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="GmTGfRtEmE">
                    <label for="GmTGfRtEmE">Vim</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="PzmSeBKswA">
                    <label for="PzmSeBKswA">Web</label>
                    <ul>
