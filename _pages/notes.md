...
<ul>
    <div name="contents-index">
        ...
        <l>
            <input type="checkbox" id="zRzqJRhPPr" checked>
            <label for="zRzqJRhPPr">Math</label>
            <ul>
                <l>
                    <input type="checkbox" id="EHKjzleRaT">
                    <label for="EHKjzleRaT">Exponentials</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="NtBsavAVGp">
                    <label for="NtBsavAVGp">Linear Algebra</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="keFPdUgJqU">
                    <label for="keFPdUgJqU">Logarithms</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="ZurhCjnNOF">
                    <label for="ZurhCjnNOF">Sequences</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="gujdeBBqwp">
                    <label for="gujdeBBqwp">Single Variable Calculus</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="eUViksYItn">
                    <label for="eUViksYItn">Trigonometry</label>
                    <ul>
        ...
        <l>
            <input type="checkbox" id="cfTShzDvoe" checked>
            <label for="cfTShzDvoe">Programming</label>
            <ul>
                <l>
                    <input type="checkbox" id="ycsiXtBtHn">
                    <label for="ycsiXtBtHn">Ansible</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="dlPnWwQGFC">
                    <label for="dlPnWwQGFC">Architecture</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="xvcYtySSKv">
                    <label for="xvcYtySSKv">Computer Graphics</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="eJQLjvoFSu">
                    <label for="eJQLjvoFSu">Databases</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="NfYUdiDkKH">
                    <label for="NfYUdiDkKH">Devops</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="dzLiagzMQM">
                            <label for="dzLiagzMQM">Cloud Providers</label>
                            <ul>
                                <l>
                                    <input type="checkbox" id="AspJmttnho">
                                    <label for="AspJmttnho">AWS</label>
                                    <ul>
                                        <l>
                                            <input type="checkbox" id="ZKQGcbnIir">
                                            <label for="ZKQGcbnIir">Cli</label>
                                            <ul>
                                        ...
                                        <l>
                                            <input type="checkbox" id="kSzzsQAlXA">
                                            <label for="kSzzsQAlXA">Dotnet</label>
                                            <ul>
                                        ...
                                        <l>
                                            <input type="checkbox" id="HmmEwweMmH">
                                            <label for="HmmEwweMmH">Ec 2</label>
                                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="rapMdLWVPX">
                            <label for="rapMdLWVPX">Events</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="HVVQeTgKsh">
                            <label for="HVVQeTgKsh">Localstack</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="kfazqUyBso">
                            <label for="kfazqUyBso">Pulumi</label>
                            <ul>
                                <l>
                                    <input type="checkbox" id="vMOjpiHJeS">
                                    <label for="vMOjpiHJeS">Dotnet</label>
                                    <ul>
                        ...
                        <l>
                            <input type="checkbox" id="kTxHaYcpqI">
                            <label for="kTxHaYcpqI">Serverless Framework</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="FBUPAcORIQ">
                            <label for="FBUPAcORIQ">Terraform</label>
                            <ul>
                                <l>
                                    <input type="checkbox" id="CsmbPAZoQp">
                                    <label for="CsmbPAZoQp">Functions</label>
                                    <ul>
                                ...
                                <l>
                                    <input type="checkbox" id="wavgMtrfUF">
                                    <label for="wavgMtrfUF">Meta Arguments</label>
                                    <ul>
                ...
                <l>
                    <input type="checkbox" id="UTObTAPHex">
                    <label for="UTObTAPHex">Docker</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="brFCOThPDv">
                    <label for="brFCOThPDv">Dotnet</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="xTPnidRoki">
                            <label for="xTPnidRoki">Cli</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="IfcspEodTW">
                    <label for="IfcspEodTW">Functional Programming</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="YlgwgvYngN">
                    <label for="YlgwgvYngN">Git</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="NSabzutyVl">
                            <label for="NSabzutyVl">Github</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="HdhGVQBBwA">
                    <label for="HdhGVQBBwA">Go</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="wFlfkDxkeS">
                    <label for="wFlfkDxkeS">Haskell</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="ZtHqilWECA">
                    <label for="ZtHqilWECA">Js</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="VpuEqDFQky">
                            <label for="VpuEqDFQky">Node</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="YdMcDDckuP">
                            <label for="YdMcDDckuP">D3</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="rUREFhaeBr">
                            <label for="rUREFhaeBr">Mocha</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="KdjwCaANNx">
                            <label for="KdjwCaANNx">P5js</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="tXYvswDjQr">
                            <label for="tXYvswDjQr">Typescript</label>
                            <ul>
                                <l>
                                    <input type="checkbox" id="DdShTkAcpW">
                                    <label for="DdShTkAcpW">Testing</label>
                                    <ul>
                ...
                <l>
                    <input type="checkbox" id="eQroTnbRku">
                    <label for="eQroTnbRku">Kafka</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="ITuYyMWaAx">
                    <label for="ITuYyMWaAx">Kubernetes</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="kbpDTukexj">
                    <label for="kbpDTukexj">Language</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="csjPgSUUQh">
                    <label for="csjPgSUUQh">Linux</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="IxFDugGXFQ">
                            <label for="IxFDugGXFQ">Bash</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="QFMjuCHYVj">
                    <label for="QFMjuCHYVj">Oauth</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="AIBDQVKbjK">
                    <label for="AIBDQVKbjK">Python</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="uldVvHfXsV">
                            <label for="uldVvHfXsV">Data Classes</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="lLPRwRbRbB">
                            <label for="lLPRwRbRbB">Libraries</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="XbJAlFHJGv">
                    <label for="XbJAlFHJGv">React</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="SjGKSXFGcZ">
                    <label for="SjGKSXFGcZ">Regular Expressions</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="STmMrCfxvb">
                    <label for="STmMrCfxvb">Rust</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="XxbsUzFlgN">
                            <label for="XxbsUzFlgN">Serde</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="yfdnmumwDl">
                    <label for="yfdnmumwDl">Shaders</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="cgCuWXpdtZ">
                            <label for="cgCuWXpdtZ">Glsl</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="PaClqJkTUG">
                    <label for="PaClqJkTUG">Vim</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="LSvoZVICed">
                    <label for="LSvoZVICed">Web</label>
                    <ul>
