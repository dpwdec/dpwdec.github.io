...
<ul>
    <div name="contents-index">
        ...
        <l>
            <input type="checkbox" id="wAgnpWAtws" checked>
            <label for="wAgnpWAtws">Math</label>
            <ul>
                <l>
                    <input type="checkbox" id="LtjeRxzwAW">
                    <label for="LtjeRxzwAW">Exponentials</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="bhlciEKZcs">
                    <label for="bhlciEKZcs">Linear Algebra</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="gOkEahnYsg">
                    <label for="gOkEahnYsg">Logarithms</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="ukVmYnRWuO">
                    <label for="ukVmYnRWuO">Sequences</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="iMjGdCzkkf">
                    <label for="iMjGdCzkkf">Single Variable Calculus</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="CrXFhyWfnP">
                    <label for="CrXFhyWfnP">Trigonometry</label>
                    <ul>
        ...
        <l>
            <input type="checkbox" id="UnCTdbvzHv" checked>
            <label for="UnCTdbvzHv">Programming</label>
            <ul>
                <l>
                    <input type="checkbox" id="lBJuuDaMBr">
                    <label for="lBJuuDaMBr">Ansible</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="dqHGyrsfKX">
                    <label for="dqHGyrsfKX">Architecture</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="KlkUXwbxEj">
                    <label for="KlkUXwbxEj">Computer Graphics</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="EmHstdnKeQ">
                    <label for="EmHstdnKeQ">Databases</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="xyCqTqtUlp">
                    <label for="xyCqTqtUlp">Devops</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="qNcbmiqBXg">
                            <label for="qNcbmiqBXg">Cloud Providers</label>
                            <ul>
                                <l>
                                    <input type="checkbox" id="eymHCLAAMF">
                                    <label for="eymHCLAAMF">AWS</label>
                                    <ul>
                                        <l>
                                            <input type="checkbox" id="NnFtCrqgMv">
                                            <label for="NnFtCrqgMv">Cli</label>
                                            <ul>
                                        ...
                                        <l>
                                            <input type="checkbox" id="BpeSmtscYz">
                                            <label for="BpeSmtscYz">Dotnet</label>
                                            <ul>
                                        ...
                                        <l>
                                            <input type="checkbox" id="JshZLwuLZc">
                                            <label for="JshZLwuLZc">Ec 2</label>
                                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="hLfAjNbaEO">
                            <label for="hLfAjNbaEO">Events</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="HpZZnzjqSh">
                            <label for="HpZZnzjqSh">Localstack</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="EyHomwWftq">
                            <label for="EyHomwWftq">Pulumi</label>
                            <ul>
                                <l>
                                    <input type="checkbox" id="gwglOSrjdF">
                                    <label for="gwglOSrjdF">Dotnet</label>
                                    <ul>
                        ...
                        <l>
                            <input type="checkbox" id="AAIVSpuPcR">
                            <label for="AAIVSpuPcR">Serverless Framework</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="CRoofhQbxQ">
                            <label for="CRoofhQbxQ">Terraform</label>
                            <ul>
                                <l>
                                    <input type="checkbox" id="KcCwWPPvcX">
                                    <label for="KcCwWPPvcX">Functions</label>
                                    <ul>
                                ...
                                <l>
                                    <input type="checkbox" id="JlXmjasnui">
                                    <label for="JlXmjasnui">Meta Arguments</label>
                                    <ul>
                ...
                <l>
                    <input type="checkbox" id="PZUsFNsSVw">
                    <label for="PZUsFNsSVw">Docker</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="TaMACKwdqG">
                    <label for="TaMACKwdqG">Dotnet</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="KUYssIooek">
                            <label for="KUYssIooek">Cli</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="SqLWBlRFoI">
                    <label for="SqLWBlRFoI">Functional Programming</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="kSakUBIGpZ">
                    <label for="kSakUBIGpZ">Git</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="QIFWNBbIeW">
                            <label for="QIFWNBbIeW">Github</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="RFfhuzwGdD">
                    <label for="RFfhuzwGdD">Go</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="WaurXTAynk">
                    <label for="WaurXTAynk">Haskell</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="qZHreoDnrj">
                    <label for="qZHreoDnrj">Js</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="OCOErusyFs">
                            <label for="OCOErusyFs">Node</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="bHlgLCJiXL">
                            <label for="bHlgLCJiXL">D3</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="hYCzQLZKij">
                            <label for="hYCzQLZKij">Mocha</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="WxOuXPjVrt">
                            <label for="WxOuXPjVrt">P5js</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="hwMiTfMPNz">
                            <label for="hwMiTfMPNz">Typescript</label>
                            <ul>
                                <l>
                                    <input type="checkbox" id="HogqvhAOTY">
                                    <label for="HogqvhAOTY">Testing</label>
                                    <ul>
                ...
                <l>
                    <input type="checkbox" id="SAiILBQxZI">
                    <label for="SAiILBQxZI">Kafka</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="yPRlUTVYbO">
                    <label for="yPRlUTVYbO">Kubernetes</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="geSXggBBsy">
                    <label for="geSXggBBsy">Language</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="mzVzDfbGBB">
                    <label for="mzVzDfbGBB">Linux</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="NwAVlABksg">
                            <label for="NwAVlABksg">Bash</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="ZGdRMvBWBG">
                    <label for="ZGdRMvBWBG">Oauth</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="paWKVjeHJl">
                    <label for="paWKVjeHJl">Prometheus</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="COtCynOKxR">
                    <label for="COtCynOKxR">Python</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="CjKmYkKowP">
                            <label for="CjKmYkKowP">Data Classes</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="gZVZZJiCZP">
                            <label for="gZVZZJiCZP">Libraries</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="IjzgbboTPN">
                    <label for="IjzgbboTPN">React</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="xXsTBTAYvt">
                    <label for="xXsTBTAYvt">Regular Expressions</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="LMNgGjAfvq">
                    <label for="LMNgGjAfvq">Rust</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="qLuHHEVXsZ">
                            <label for="qLuHHEVXsZ">Serde</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="SlCYerTmUu">
                    <label for="SlCYerTmUu">Shaders</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="eWFhTyBWoo">
                            <label for="eWFhTyBWoo">Glsl</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="ZVRExmLyza">
                    <label for="ZVRExmLyza">Vim</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="XltiKyrZCo">
                    <label for="XltiKyrZCo">Web</label>
                    <ul>
