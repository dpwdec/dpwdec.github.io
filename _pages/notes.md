...
<ul>
    <div name="contents-index">
        ...
        <l>
            <input type="checkbox" id="OietakhEvL" checked>
            <label for="OietakhEvL">Math</label>
            <ul>
                <l>
                    <input type="checkbox" id="ignOpJUgLO">
                    <label for="ignOpJUgLO">Exponentials</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="SoBQEvUeVt">
                    <label for="SoBQEvUeVt">Linear Algebra</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="fArHLzoZQw">
                    <label for="fArHLzoZQw">Logarithms</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="ZkklCQAKUo">
                    <label for="ZkklCQAKUo">Sequences</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="eXMXkXjJqk">
                    <label for="eXMXkXjJqk">Single Variable Calculus</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="JFAcDgXXxO">
                    <label for="JFAcDgXXxO">Trigonometry</label>
                    <ul>
        ...
        <l>
            <input type="checkbox" id="bakPZrQFha" checked>
            <label for="bakPZrQFha">Programming</label>
            <ul>
                <l>
                    <input type="checkbox" id="PNPNGukYUC">
                    <label for="PNPNGukYUC">Ansible</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="XoXkQFYFBt">
                    <label for="XoXkQFYFBt">Architecture</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="XSCBUtFcFe">
                    <label for="XSCBUtFcFe">Computer Graphics</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="uUITgnADmN">
                    <label for="uUITgnADmN">Databases</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="NqtmmAVEsL">
                    <label for="NqtmmAVEsL">Devops</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="hSBRsSxGaj">
                            <label for="hSBRsSxGaj">Cloud Providers</label>
                            <ul>
                                <l>
                                    <input type="checkbox" id="ypZQBFrAMN">
                                    <label for="ypZQBFrAMN">AWS</label>
                                    <ul>
                                        <l>
                                            <input type="checkbox" id="sZafcCjDXM">
                                            <label for="sZafcCjDXM">Cli</label>
                                            <ul>
                                        ...
                                        <l>
                                            <input type="checkbox" id="OOuzrmEjdV">
                                            <label for="OOuzrmEjdV">Dotnet</label>
                                            <ul>
                                        ...
                                        <l>
                                            <input type="checkbox" id="ewgEfuqXgT">
                                            <label for="ewgEfuqXgT">Ec 2</label>
                                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="NpadwlhqRF">
                            <label for="NpadwlhqRF">Events</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="IOnPRuteBN">
                            <label for="IOnPRuteBN">Localstack</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="ehRImaEuyy">
                            <label for="ehRImaEuyy">Pulumi</label>
                            <ul>
                                <l>
                                    <input type="checkbox" id="KwSCcVKZQX">
                                    <label for="KwSCcVKZQX">Dotnet</label>
                                    <ul>
                        ...
                        <l>
                            <input type="checkbox" id="ZbewfOGcrl">
                            <label for="ZbewfOGcrl">Serverless Framework</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="bwherFpLXU">
                            <label for="bwherFpLXU">Terraform</label>
                            <ul>
                                <l>
                                    <input type="checkbox" id="JLqCKIKIAz">
                                    <label for="JLqCKIKIAz">Functions</label>
                                    <ul>
                                ...
                                <l>
                                    <input type="checkbox" id="cdRiovkUWs">
                                    <label for="cdRiovkUWs">Meta Arguments</label>
                                    <ul>
                ...
                <l>
                    <input type="checkbox" id="CkbDhitJKX">
                    <label for="CkbDhitJKX">Docker</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="EBoOIadFcl">
                    <label for="EBoOIadFcl">Dotnet</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="fbMGcPFuXO">
                            <label for="fbMGcPFuXO">Cli</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="xnrdpFLbbt">
                    <label for="xnrdpFLbbt">Functional Programming</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="nygaNHlfGw">
                    <label for="nygaNHlfGw">Git</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="XXWLtndfKB">
                            <label for="XXWLtndfKB">Github</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="DujiLyghzF">
                    <label for="DujiLyghzF">Go</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="GpAmElPyHs">
                    <label for="GpAmElPyHs">Haskell</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="OiSgdOhpir">
                    <label for="OiSgdOhpir">Js</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="yNShvmkErC">
                            <label for="yNShvmkErC">Node</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="zDDEYqkHWf">
                            <label for="zDDEYqkHWf">D3</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="fmJsEpHlCD">
                            <label for="fmJsEpHlCD">Mocha</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="GNPxmYojju">
                            <label for="GNPxmYojju">P5js</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="aaGcGotccW">
                            <label for="aaGcGotccW">Typescript</label>
                            <ul>
                                <l>
                                    <input type="checkbox" id="gMvRtMTdIY">
                                    <label for="gMvRtMTdIY">Testing</label>
                                    <ul>
                ...
                <l>
                    <input type="checkbox" id="uVWdJNrwWg">
                    <label for="uVWdJNrwWg">Kafka</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="dMomuCohKg">
                    <label for="dMomuCohKg">Kubernetes</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="jnuuuqbztb">
                    <label for="jnuuuqbztb">Language</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="UJcqGmujQC">
                    <label for="UJcqGmujQC">Linux</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="mmCJTIxwat">
                            <label for="mmCJTIxwat">Bash</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="SxrWpwxDhW">
                    <label for="SxrWpwxDhW">Oauth</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="rVzjUqISoz">
                    <label for="rVzjUqISoz">Prometheus</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="heKcsgEYFj">
                    <label for="heKcsgEYFj">Python</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="gJndRPltxg">
                            <label for="gJndRPltxg">Data Classes</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="rvRcQlxtBD">
                            <label for="rvRcQlxtBD">Libraries</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="lwTJriyeET">
                    <label for="lwTJriyeET">React</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="eljbWttJRk">
                    <label for="eljbWttJRk">Regular Expressions</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="BZCiwuHZAJ">
                    <label for="BZCiwuHZAJ">Rust</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="tZQerEyJKC">
                            <label for="tZQerEyJKC">Serde</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="fthveJSjER">
                    <label for="fthveJSjER">Shaders</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="AKAWwXZsxt">
                            <label for="AKAWwXZsxt">Glsl</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="MmdaPqSSTs">
                    <label for="MmdaPqSSTs">Vim</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="XtjltKqfcz">
                    <label for="XtjltKqfcz">Web</label>
                    <ul>
