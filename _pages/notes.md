...
<ul>
    <div name="contents-index">
        ...
        <l>
            <input type="checkbox" id="eBZFefiDFV" checked>
            <label for="eBZFefiDFV">Math</label>
            <ul>
                <l>
                    <input type="checkbox" id="diElVEhTrd">
                    <label for="diElVEhTrd">Exponentials</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="dySNaoOHnX">
                    <label for="dySNaoOHnX">Linear Algebra</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="IVJojRUBYr">
                    <label for="IVJojRUBYr">Logarithms</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="dwMgQcsYqh">
                    <label for="dwMgQcsYqh">Sequences</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="ckuDblgYSJ">
                    <label for="ckuDblgYSJ">Single Variable Calculus</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="RipNJXkudy">
                    <label for="RipNJXkudy">Trigonometry</label>
                    <ul>
        ...
        <l>
            <input type="checkbox" id="VGuCviDIkk" checked>
            <label for="VGuCviDIkk">Programming</label>
            <ul>
                <l>
                    <input type="checkbox" id="ZxwMRjDvGF">
                    <label for="ZxwMRjDvGF">Ansible</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="VelYMgpMNY">
                    <label for="VelYMgpMNY">Architecture</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="YGBVkCoIwW">
                    <label for="YGBVkCoIwW">Computer Graphics</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="mYxYcJxfVv">
                    <label for="mYxYcJxfVv">Databases</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="EFrhCiEArx">
                    <label for="EFrhCiEArx">Devops</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="nUugBwIdBG">
                            <label for="nUugBwIdBG">Cloud Providers</label>
                            <ul>
                                <l>
                                    <input type="checkbox" id="YuwILmkwIU">
                                    <label for="YuwILmkwIU">AWS</label>
                                    <ul>
                                        <l>
                                            <input type="checkbox" id="QSfoOqGUJN">
                                            <label for="QSfoOqGUJN">Cli</label>
                                            <ul>
                                        ...
                                        <l>
                                            <input type="checkbox" id="aIfijpujBR">
                                            <label for="aIfijpujBR">Dotnet</label>
                                            <ul>
                                        ...
                                        <l>
                                            <input type="checkbox" id="YjEdIOMpVg">
                                            <label for="YjEdIOMpVg">Ec 2</label>
                                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="jZnDGjgTMv">
                            <label for="jZnDGjgTMv">Events</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="FNTmzcFWzM">
                            <label for="FNTmzcFWzM">Localstack</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="EbUFvLsVIW">
                            <label for="EbUFvLsVIW">Pulumi</label>
                            <ul>
                                <l>
                                    <input type="checkbox" id="bQaHCExkkf">
                                    <label for="bQaHCExkkf">Dotnet</label>
                                    <ul>
                        ...
                        <l>
                            <input type="checkbox" id="MDeOAphvMB">
                            <label for="MDeOAphvMB">Serverless Framework</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="dNfVxHFnSj">
                            <label for="dNfVxHFnSj">Terraform</label>
                            <ul>
                                <l>
                                    <input type="checkbox" id="DdYJNiOkUt">
                                    <label for="DdYJNiOkUt">Functions</label>
                                    <ul>
                                ...
                                <l>
                                    <input type="checkbox" id="SOqxuJCzZD">
                                    <label for="SOqxuJCzZD">Meta Arguments</label>
                                    <ul>
                ...
                <l>
                    <input type="checkbox" id="CSTchBOiZy">
                    <label for="CSTchBOiZy">Docker</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="mMKnbIPhAA">
                    <label for="mMKnbIPhAA">Dotnet</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="yLuDEEVkZQ">
                            <label for="yLuDEEVkZQ">Cli</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="NIjXpUTGVn">
                    <label for="NIjXpUTGVn">Functional Programming</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="YVdcjBgiyw">
                    <label for="YVdcjBgiyw">Git</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="kRrCUAYUXM">
                            <label for="kRrCUAYUXM">Github</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="QfTykkuxZM">
                    <label for="QfTykkuxZM">Go</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="myeScYXFVv">
                    <label for="myeScYXFVv">Haskell</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="ggTYSkuniD">
                    <label for="ggTYSkuniD">Js</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="hRMtHzFDoN">
                            <label for="hRMtHzFDoN">Node</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="InhvTbVqwj">
                            <label for="InhvTbVqwj">D3</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="bljQtiDvoY">
                            <label for="bljQtiDvoY">Mocha</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="ETFyDeYcjN">
                            <label for="ETFyDeYcjN">P5js</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="EKgzGljUeM">
                            <label for="EKgzGljUeM">Typescript</label>
                            <ul>
                                <l>
                                    <input type="checkbox" id="wKOlQZTnmi">
                                    <label for="wKOlQZTnmi">Testing</label>
                                    <ul>
                ...
                <l>
                    <input type="checkbox" id="iCXelFgEOv">
                    <label for="iCXelFgEOv">Kafka</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="uLqvuYAqlA">
                    <label for="uLqvuYAqlA">Kubernetes</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="UJYZgBHXCq">
                    <label for="UJYZgBHXCq">Language</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="ogZPympdAC">
                    <label for="ogZPympdAC">Linux</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="ZwEmPHQOcs">
                            <label for="ZwEmPHQOcs">Bash</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="dUNzGyzTKG">
                    <label for="dUNzGyzTKG">Oauth</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="pyUZqlTifg">
                    <label for="pyUZqlTifg">Python</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="OmLeHXDiHG">
                            <label for="OmLeHXDiHG">Data Classes</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="eoZgxluDBa">
                            <label for="eoZgxluDBa">Libraries</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="qyjPkPQJVd">
                    <label for="qyjPkPQJVd">React</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="NVLWXqNjOt">
                    <label for="NVLWXqNjOt">Regular Expressions</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="TUfUJGthyu">
                    <label for="TUfUJGthyu">Rust</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="twWaYkUxZX">
                            <label for="twWaYkUxZX">Serde</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="GQNqLyZVVM">
                    <label for="GQNqLyZVVM">Shaders</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="SpOOZlgjSg">
                            <label for="SpOOZlgjSg">Glsl</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="nMhpTZlTDD">
                    <label for="nMhpTZlTDD">Vim</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="CaJBPitcTP">
                    <label for="CaJBPitcTP">Web</label>
                    <ul>
