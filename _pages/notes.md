...
<ul>
    <div name="contents-index">
        ...
        <l>
            <input type="checkbox" id="fkAjxpegsR" checked>
            <label for="fkAjxpegsR">Math</label>
            <ul>
                <l>
                    <input type="checkbox" id="rbxenRbVyo">
                    <label for="rbxenRbVyo">Exponentials</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="JCwdgeNkQe">
                    <label for="JCwdgeNkQe">Linear Algebra</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="vpMFABzQFl">
                    <label for="vpMFABzQFl">Logarithms</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="MTgIDnwDCf">
                    <label for="MTgIDnwDCf">Sequences</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="zchOOHOQRk">
                    <label for="zchOOHOQRk">Single Variable Calculus</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="ZAnBDXJTrv">
                    <label for="ZAnBDXJTrv">Trigonometry</label>
                    <ul>
        ...
        <l>
            <input type="checkbox" id="YMnYuqPEcC" checked>
            <label for="YMnYuqPEcC">Programming</label>
            <ul>
                <l>
                    <input type="checkbox" id="YDmodynXKQ">
                    <label for="YDmodynXKQ">Ansible</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="tKupYsCThK">
                    <label for="tKupYsCThK">Architecture</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="GpMjuVYGAi">
                    <label for="GpMjuVYGAi">Computer Graphics</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="kVTDGAoZWx">
                    <label for="kVTDGAoZWx">Databases</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="uxhmrYwzkO">
                    <label for="uxhmrYwzkO">Devops</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="jLhTWDOkJH">
                            <label for="jLhTWDOkJH">Cloud Computing</label>
                            <ul>
                                <l>
                                    <input type="checkbox" id="RKvFTKwkEL">
                                    <label for="RKvFTKwkEL">AWS</label>
                                    <ul>
                                        <l>
                                            <input type="checkbox" id="jDPKCeJbMj">
                                            <label for="jDPKCeJbMj">Cli</label>
                                            <ul>
                                        ...
                                        <l>
                                            <input type="checkbox" id="RAIVEfXQYE">
                                            <label for="RAIVEfXQYE">Dotnet</label>
                                            <ul>
                                        ...
                                        <l>
                                            <input type="checkbox" id="ntboRGfnsq">
                                            <label for="ntboRGfnsq">Ec 2</label>
                                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="UMsKLNitvG">
                            <label for="UMsKLNitvG">Events</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="iMilYUgELU">
                            <label for="iMilYUgELU">Oauth</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="qWJRWdophH">
                            <label for="qWJRWdophH">Pulumi</label>
                            <ul>
                                <l>
                                    <input type="checkbox" id="CwLLGFGdTu">
                                    <label for="CwLLGFGdTu">Dotnet</label>
                                    <ul>
                        ...
                        <l>
                            <input type="checkbox" id="MjJaHXBdwT">
                            <label for="MjJaHXBdwT">Terraform</label>
                            <ul>
                                <l>
                                    <input type="checkbox" id="YfAqUbPDoy">
                                    <label for="YfAqUbPDoy">Functions</label>
                                    <ul>
                                ...
                                <l>
                                    <input type="checkbox" id="zSsbQkwcnG">
                                    <label for="zSsbQkwcnG">Meta Arguments</label>
                                    <ul>
                ...
                <l>
                    <input type="checkbox" id="YbhobjtQfI">
                    <label for="YbhobjtQfI">Docker</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="soaphhPJUg">
                    <label for="soaphhPJUg">Dotnet</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="gdmgqjuNfL">
                            <label for="gdmgqjuNfL">Cli</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="vJGpbGoAVB">
                    <label for="vJGpbGoAVB">Functional Programming</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="IQgeDpAfKt">
                    <label for="IQgeDpAfKt">Git</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="vUnxSzaqJT">
                            <label for="vUnxSzaqJT">Github</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="UYojocwSnV">
                    <label for="UYojocwSnV">Go</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="YhhptDvCiX">
                    <label for="YhhptDvCiX">Haskell</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="whlhHiqzOR">
                    <label for="whlhHiqzOR">Js</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="kEXXUfxMGt">
                            <label for="kEXXUfxMGt">Node</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="TsegkFvwcC">
                            <label for="TsegkFvwcC">Mocha</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="XAgQBBcePI">
                            <label for="XAgQBBcePI">P5js</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="KJShjxHlnf">
                            <label for="KJShjxHlnf">Typescript</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="jpnAxUVfMW">
                    <label for="jpnAxUVfMW">Kafka</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="rrSRnFhZbE">
                    <label for="rrSRnFhZbE">Kubernetes</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="EJNHqxnuyT">
                    <label for="EJNHqxnuyT">Language</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="vpSjgQJJKf">
                    <label for="vpSjgQJJKf">Linux</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="RDMxrkvhLr">
                    <label for="RDMxrkvhLr">Python</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="fmxWmbiZSo">
                            <label for="fmxWmbiZSo">Data Classes</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="WBHihYhSTi">
                            <label for="WBHihYhSTi">Libraries</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="NHhOgGDAOn">
                    <label for="NHhOgGDAOn">React</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="xoZyuBzXgE">
                    <label for="xoZyuBzXgE">Regular Expressions</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="RTptXtgpUA">
                    <label for="RTptXtgpUA">Rust</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="qNoIdgqDOR">
                            <label for="qNoIdgqDOR">Serde</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="opZOOSAnqz">
                    <label for="opZOOSAnqz">Vim</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="DceukapWiC">
                    <label for="DceukapWiC">Web</label>
                    <ul>
