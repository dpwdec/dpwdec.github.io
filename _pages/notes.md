...
<ul>
    <div name="contents-index">
        ...
        <l>
            <input type="checkbox" id="iEwxWEsbam" checked>
            <label for="iEwxWEsbam">Math</label>
            <ul>
                <l>
                    <input type="checkbox" id="kvJxRQOFMb">
                    <label for="kvJxRQOFMb">Exponentials</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="utHoRCKnQZ">
                    <label for="utHoRCKnQZ">Linear Algebra</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="yDQBmWwqyA">
                    <label for="yDQBmWwqyA">Logarithms</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="ouedimVrjD">
                    <label for="ouedimVrjD">Sequences</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="vURyjbOKWa">
                    <label for="vURyjbOKWa">Single Variable Calculus</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="hzqbCVKovI">
                    <label for="hzqbCVKovI">Trigonometry</label>
                    <ul>
        ...
        <l>
            <input type="checkbox" id="trEiNrWZAA" checked>
            <label for="trEiNrWZAA">Programming</label>
            <ul>
                <l>
                    <input type="checkbox" id="gXDYiQPBAY">
                    <label for="gXDYiQPBAY">Ansible</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="hYeJcsZzOt">
                    <label for="hYeJcsZzOt">Architecture</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="pGEpqqsiUv">
                    <label for="pGEpqqsiUv">Computer Graphics</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="XCFYiPRACG">
                    <label for="XCFYiPRACG">Databases</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="KPieJdMBtf">
                    <label for="KPieJdMBtf">Devops</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="dJxnbPXzxe">
                            <label for="dJxnbPXzxe">Cloud Computing</label>
                            <ul>
                                <l>
                                    <input type="checkbox" id="XAfISIkzss">
                                    <label for="XAfISIkzss">AWS</label>
                                    <ul>
                                        <l>
                                            <input type="checkbox" id="OSoUsutAqj">
                                            <label for="OSoUsutAqj">Cli</label>
                                            <ul>
                                        ...
                                        <l>
                                            <input type="checkbox" id="pQlfOmOGDb">
                                            <label for="pQlfOmOGDb">Dotnet</label>
                                            <ul>
                                        ...
                                        <l>
                                            <input type="checkbox" id="aBKuqElBgr">
                                            <label for="aBKuqElBgr">Ec 2</label>
                                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="XGntujJapm">
                            <label for="XGntujJapm">Events</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="tfKnaRMEkP">
                            <label for="tfKnaRMEkP">Oauth</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="BhFBECjeTQ">
                            <label for="BhFBECjeTQ">Pulumi</label>
                            <ul>
                                <l>
                                    <input type="checkbox" id="HkkKhFjQFC">
                                    <label for="HkkKhFjQFC">Dotnet</label>
                                    <ul>
                        ...
                        <l>
                            <input type="checkbox" id="tMmRmTHeVf">
                            <label for="tMmRmTHeVf">Terraform</label>
                            <ul>
                                <l>
                                    <input type="checkbox" id="QKxzMlCJQH">
                                    <label for="QKxzMlCJQH">Functions</label>
                                    <ul>
                                ...
                                <l>
                                    <input type="checkbox" id="JqXvhtHxzH">
                                    <label for="JqXvhtHxzH">Meta Arguments</label>
                                    <ul>
                ...
                <l>
                    <input type="checkbox" id="wbnyAndGuW">
                    <label for="wbnyAndGuW">Docker</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="qUNstuuGly">
                    <label for="qUNstuuGly">Dotnet</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="zFtsPWliCX">
                            <label for="zFtsPWliCX">Cli</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="pFnDRRcXTa">
                    <label for="pFnDRRcXTa">Functional Programming</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="atuOnRwFoC">
                    <label for="atuOnRwFoC">Git</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="BgbzzevXQW">
                            <label for="BgbzzevXQW">Github</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="fMPKODxEnP">
                    <label for="fMPKODxEnP">Go</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="fcsntGycjQ">
                    <label for="fcsntGycjQ">Haskell</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="hXnoCiCOSo">
                    <label for="hXnoCiCOSo">Js</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="GUQHLAWfrZ">
                            <label for="GUQHLAWfrZ">Node</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="LhpnTAfGNU">
                            <label for="LhpnTAfGNU">D3</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="fLTxSqjQep">
                            <label for="fLTxSqjQep">Mocha</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="PMGSMUuMSc">
                            <label for="PMGSMUuMSc">P5js</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="BubKyhcOOq">
                            <label for="BubKyhcOOq">Typescript</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="QVRmpBqAAZ">
                    <label for="QVRmpBqAAZ">Kafka</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="jcOYdioueR">
                    <label for="jcOYdioueR">Kubernetes</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="rmXpXRlgxn">
                    <label for="rmXpXRlgxn">Language</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="ChtQKRPpuq">
                    <label for="ChtQKRPpuq">Linux</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="FuTeIuXPqv">
                    <label for="FuTeIuXPqv">Python</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="rTuMcBQTnx">
                            <label for="rTuMcBQTnx">Data Classes</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="FBijHQWnrC">
                            <label for="FBijHQWnrC">Libraries</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="HrXvIenmsD">
                    <label for="HrXvIenmsD">React</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="nyQtYZBpid">
                    <label for="nyQtYZBpid">Regular Expressions</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="JEuCkwlMZE">
                    <label for="JEuCkwlMZE">Rust</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="RkykJkoNPK">
                            <label for="RkykJkoNPK">Serde</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="wYDqFNVcSR">
                    <label for="wYDqFNVcSR">Vim</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="IFVzlgVsOf">
                    <label for="IFVzlgVsOf">Web</label>
                    <ul>
