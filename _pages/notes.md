...
<ul>
    <div name="contents-index">
        ...
        <l>
            <input type="checkbox" id="lIuHnYFFeK" checked>
            <label for="lIuHnYFFeK">Math</label>
            <ul>
                <l>
                    <input type="checkbox" id="rqTjEeeuwk">
                    <label for="rqTjEeeuwk">Exponentials</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="suXYJNthxq">
                    <label for="suXYJNthxq">Linear Algebra</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="jvBqClWPyX">
                    <label for="jvBqClWPyX">Logarithms</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="WcSkVdiBBy">
                    <label for="WcSkVdiBBy">Sequences</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="RmOUBmPEyH">
                    <label for="RmOUBmPEyH">Single Variable Calculus</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="jcznERSqbA">
                    <label for="jcznERSqbA">Trigonometry</label>
                    <ul>
        ...
        <l>
            <input type="checkbox" id="bUuakcSSrR" checked>
            <label for="bUuakcSSrR">Programming</label>
            <ul>
                <l>
                    <input type="checkbox" id="DnquZHKAZV">
                    <label for="DnquZHKAZV">Ansible</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="bFEcSKimdg">
                    <label for="bFEcSKimdg">Architecture</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="spnigOIqjM">
                    <label for="spnigOIqjM">Computer Graphics</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="WBLItlHJwU">
                    <label for="WBLItlHJwU">Databases</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="dQSDxAuCIs">
                    <label for="dQSDxAuCIs">Devops</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="ryszREgHot">
                            <label for="ryszREgHot">Cloud Providers</label>
                            <ul>
                                <l>
                                    <input type="checkbox" id="JnyRyauJRZ">
                                    <label for="JnyRyauJRZ">AWS</label>
                                    <ul>
                                        <l>
                                            <input type="checkbox" id="ABGFQDjyvm">
                                            <label for="ABGFQDjyvm">Cli</label>
                                            <ul>
                                        ...
                                        <l>
                                            <input type="checkbox" id="aMYAuKTTBt">
                                            <label for="aMYAuKTTBt">Dotnet</label>
                                            <ul>
                                        ...
                                        <l>
                                            <input type="checkbox" id="TZTkYIFloD">
                                            <label for="TZTkYIFloD">Ec 2</label>
                                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="mfZSwCNTvs">
                            <label for="mfZSwCNTvs">Events</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="WVoOilFvrp">
                            <label for="WVoOilFvrp">Localstack</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="pcgEHAVGWE">
                            <label for="pcgEHAVGWE">Pulumi</label>
                            <ul>
                                <l>
                                    <input type="checkbox" id="GAtutGTsnu">
                                    <label for="GAtutGTsnu">Dotnet</label>
                                    <ul>
                        ...
                        <l>
                            <input type="checkbox" id="YAveCrCRWV">
                            <label for="YAveCrCRWV">Serverless Framework</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="fYjpjzkJXz">
                            <label for="fYjpjzkJXz">Terraform</label>
                            <ul>
                                <l>
                                    <input type="checkbox" id="rLZKlWFQge">
                                    <label for="rLZKlWFQge">Functions</label>
                                    <ul>
                                ...
                                <l>
                                    <input type="checkbox" id="alCJkeFmKP">
                                    <label for="alCJkeFmKP">Meta Arguments</label>
                                    <ul>
                ...
                <l>
                    <input type="checkbox" id="gqmLcTayQj">
                    <label for="gqmLcTayQj">Docker</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="kqPyAwllnn">
                    <label for="kqPyAwllnn">Dotnet</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="GFYMZGVOWL">
                            <label for="GFYMZGVOWL">Cli</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="VcGOGBuqFf">
                    <label for="VcGOGBuqFf">Functional Programming</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="tkusfHQGwB">
                    <label for="tkusfHQGwB">Git</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="QZqRpWWceK">
                            <label for="QZqRpWWceK">Github</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="TVcDfVICIj">
                    <label for="TVcDfVICIj">Go</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="FMTnsCwYkW">
                    <label for="FMTnsCwYkW">Haskell</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="VjeHjlAHjZ">
                    <label for="VjeHjlAHjZ">Js</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="pJIUUPvmYm">
                            <label for="pJIUUPvmYm">Node</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="nymjHZKBoZ">
                            <label for="nymjHZKBoZ">D3</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="OvQHzrgQhz">
                            <label for="OvQHzrgQhz">Mocha</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="ePUHDZqYzk">
                            <label for="ePUHDZqYzk">P5js</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="iNlTXNEwka">
                            <label for="iNlTXNEwka">Typescript</label>
                            <ul>
                                <l>
                                    <input type="checkbox" id="AfSchjiZok">
                                    <label for="AfSchjiZok">Testing</label>
                                    <ul>
                ...
                <l>
                    <input type="checkbox" id="MFxLHUGZVL">
                    <label for="MFxLHUGZVL">Kafka</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="mbZAjrnKwz">
                    <label for="mbZAjrnKwz">Kubernetes</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="nNRrufJFFM">
                    <label for="nNRrufJFFM">Language</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="VEAjpPqOIo">
                    <label for="VEAjpPqOIo">Linux</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="zDVtKsYRmX">
                            <label for="zDVtKsYRmX">Bash</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="FmBooOPtDN">
                    <label for="FmBooOPtDN">Oauth</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="iTrNCPQsVg">
                    <label for="iTrNCPQsVg">Python</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="WAcKeSoDcA">
                            <label for="WAcKeSoDcA">Data Classes</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="BNvoGbsWQE">
                            <label for="BNvoGbsWQE">Libraries</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="HqbqSiKMUY">
                    <label for="HqbqSiKMUY">React</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="owpFcVOlsV">
                    <label for="owpFcVOlsV">Regular Expressions</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="olzIVWbmjL">
                    <label for="olzIVWbmjL">Rust</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="aUbAwsIHBk">
                            <label for="aUbAwsIHBk">Serde</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="dmPxvnGDVY">
                    <label for="dmPxvnGDVY">Shaders</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="AjfNOvpicX">
                            <label for="AjfNOvpicX">Glsl</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="WmVCCFhale">
                    <label for="WmVCCFhale">Vim</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="hBWfGdiTci">
                    <label for="hBWfGdiTci">Web</label>
                    <ul>
