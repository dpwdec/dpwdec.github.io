...
<ul>
    <div name="contents-index">
        ...
        <l>
            <input type="checkbox" id="WrYfRfcDkT" checked>
            <label for="WrYfRfcDkT">Math</label>
            <ul>
                <l>
                    <input type="checkbox" id="ycGTpdpuVC">
                    <label for="ycGTpdpuVC">Exponentials</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="bSOcIvbKII">
                    <label for="bSOcIvbKII">Linear Algebra</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="EZYbohXzgp">
                    <label for="EZYbohXzgp">Logarithms</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="WapmYlTJHs">
                    <label for="WapmYlTJHs">Sequences</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="mVEQTUeHlX">
                    <label for="mVEQTUeHlX">Single Variable Calculus</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="ZYyghabRmH">
                    <label for="ZYyghabRmH">Trigonometry</label>
                    <ul>
        ...
        <l>
            <input type="checkbox" id="IVzjmPWOFF" checked>
            <label for="IVzjmPWOFF">Programming</label>
            <ul>
                <l>
                    <input type="checkbox" id="EzSFxQkdpT">
                    <label for="EzSFxQkdpT">Ansible</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="CkMlMyNwpo">
                    <label for="CkMlMyNwpo">Architecture</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="GVjoyoghEw">
                    <label for="GVjoyoghEw">Computer Graphics</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="iRJvOuaoEP">
                    <label for="iRJvOuaoEP">Databases</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="QAFQwdeydL">
                    <label for="QAFQwdeydL">Devops</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="AcejSbOcyE">
                            <label for="AcejSbOcyE">Cloud Providers</label>
                            <ul>
                                <l>
                                    <input type="checkbox" id="owIVbpMLKg">
                                    <label for="owIVbpMLKg">AWS</label>
                                    <ul>
                                        <l>
                                            <input type="checkbox" id="MumtqtSWCE">
                                            <label for="MumtqtSWCE">Cli</label>
                                            <ul>
                                        ...
                                        <l>
                                            <input type="checkbox" id="PHVXuZHovq">
                                            <label for="PHVXuZHovq">Dotnet</label>
                                            <ul>
                                        ...
                                        <l>
                                            <input type="checkbox" id="sbribMXVBf">
                                            <label for="sbribMXVBf">Ec 2</label>
                                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="PVWLBDkOQv">
                            <label for="PVWLBDkOQv">Events</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="jcXkQJPYHW">
                            <label for="jcXkQJPYHW">Localstack</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="dRCamIMYzr">
                            <label for="dRCamIMYzr">Pulumi</label>
                            <ul>
                                <l>
                                    <input type="checkbox" id="srevOmTzlv">
                                    <label for="srevOmTzlv">Dotnet</label>
                                    <ul>
                        ...
                        <l>
                            <input type="checkbox" id="xagsOkZhoP">
                            <label for="xagsOkZhoP">Serverless Framework</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="LFvNBfLTlK">
                            <label for="LFvNBfLTlK">Terraform</label>
                            <ul>
                                <l>
                                    <input type="checkbox" id="eEWSWOnBAm">
                                    <label for="eEWSWOnBAm">Functions</label>
                                    <ul>
                                ...
                                <l>
                                    <input type="checkbox" id="msPnUMUmMS">
                                    <label for="msPnUMUmMS">Meta Arguments</label>
                                    <ul>
                ...
                <l>
                    <input type="checkbox" id="mVzecdaeVX">
                    <label for="mVzecdaeVX">Docker</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="hTbwScouAa">
                    <label for="hTbwScouAa">Dotnet</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="VFRBmMLnFP">
                            <label for="VFRBmMLnFP">Cli</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="gYoZSrneHo">
                    <label for="gYoZSrneHo">Functional Programming</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="gNtYQJNxEe">
                    <label for="gNtYQJNxEe">Git</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="zJjtKxthch">
                            <label for="zJjtKxthch">Github</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="LlLLBEhuBA">
                    <label for="LlLLBEhuBA">Go</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="FuwgHOHRjL">
                    <label for="FuwgHOHRjL">Haskell</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="aeDuzJtJyH">
                    <label for="aeDuzJtJyH">Js</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="HWDpKeiKhs">
                            <label for="HWDpKeiKhs">Node</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="OoTFdDKOSL">
                            <label for="OoTFdDKOSL">D3</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="FleNsdUKHo">
                            <label for="FleNsdUKHo">Mocha</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="DptKkUpmBz">
                            <label for="DptKkUpmBz">P5js</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="CgkEbyGahc">
                            <label for="CgkEbyGahc">Typescript</label>
                            <ul>
                                <l>
                                    <input type="checkbox" id="nPThoicHvG">
                                    <label for="nPThoicHvG">Testing</label>
                                    <ul>
                ...
                <l>
                    <input type="checkbox" id="aeHlkgqdBg">
                    <label for="aeHlkgqdBg">Kafka</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="dPOiMtHpzF">
                    <label for="dPOiMtHpzF">Kubernetes</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="KYhwSUXIxs">
                    <label for="KYhwSUXIxs">Language</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="KHsVEnxRRs">
                    <label for="KHsVEnxRRs">Linux</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="JiNpKSuNUG">
                            <label for="JiNpKSuNUG">Bash</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="ghStyfZLkv">
                    <label for="ghStyfZLkv">Oauth</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="ZhlQULfrFz">
                    <label for="ZhlQULfrFz">Python</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="IBFzGGIchw">
                            <label for="IBFzGGIchw">Data Classes</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="MCBIUfhlJi">
                            <label for="MCBIUfhlJi">Libraries</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="SuSIaVhUDQ">
                    <label for="SuSIaVhUDQ">React</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="FOiiuMiVjj">
                    <label for="FOiiuMiVjj">Regular Expressions</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="OMFBqsaJMJ">
                    <label for="OMFBqsaJMJ">Rust</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="spalgzNIZl">
                            <label for="spalgzNIZl">Serde</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="fofThYQkKf">
                    <label for="fofThYQkKf">Vim</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="ACwyXGtarg">
                    <label for="ACwyXGtarg">Web</label>
                    <ul>
