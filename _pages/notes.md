...
<ul>
    <div name="contents-index">
        ...
        <l>
            <input type="checkbox" id="iZaWWfBdda" checked>
            <label for="iZaWWfBdda">Math</label>
            <ul>
                <l>
                    <input type="checkbox" id="DJGzOrYrUo">
                    <label for="DJGzOrYrUo">Exponentials</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="bVCvVNuEMh">
                    <label for="bVCvVNuEMh">Linear Algebra</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="FbHQdHyhii">
                    <label for="FbHQdHyhii">Logarithms</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="qKywWkTmUr">
                    <label for="qKywWkTmUr">Sequences</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="VkbhsvBMSF">
                    <label for="VkbhsvBMSF">Single Variable Calculus</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="huoXGpsuxk">
                    <label for="huoXGpsuxk">Trigonometry</label>
                    <ul>
        ...
        <l>
            <input type="checkbox" id="NbarwelDwK" checked>
            <label for="NbarwelDwK">Programming</label>
            <ul>
                <l>
                    <input type="checkbox" id="DbJNVROGcJ">
                    <label for="DbJNVROGcJ">Ansible</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="xzZVAARauB">
                    <label for="xzZVAARauB">Architecture</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="ngxMGCLhAY">
                    <label for="ngxMGCLhAY">Computer Graphics</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="UuKBjRbPiW">
                    <label for="UuKBjRbPiW">Databases</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="ajpqXhQfeL">
                    <label for="ajpqXhQfeL">Devops</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="YeMJNrSFFE">
                            <label for="YeMJNrSFFE">Cloud Providers</label>
                            <ul>
                                <l>
                                    <input type="checkbox" id="PEHGGUcbeX">
                                    <label for="PEHGGUcbeX">AWS</label>
                                    <ul>
                                        <l>
                                            <input type="checkbox" id="blQlJTYLwi">
                                            <label for="blQlJTYLwi">Cli</label>
                                            <ul>
                                        ...
                                        <l>
                                            <input type="checkbox" id="QkxBtwXKGC">
                                            <label for="QkxBtwXKGC">Dotnet</label>
                                            <ul>
                                        ...
                                        <l>
                                            <input type="checkbox" id="TSuqwIdHzJ">
                                            <label for="TSuqwIdHzJ">Ec 2</label>
                                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="zFtCRzkZYB">
                            <label for="zFtCRzkZYB">Events</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="bXeWjjCqBn">
                            <label for="bXeWjjCqBn">Localstack</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="mPeagtZxvm">
                            <label for="mPeagtZxvm">Pulumi</label>
                            <ul>
                                <l>
                                    <input type="checkbox" id="WPTmYoEvEq">
                                    <label for="WPTmYoEvEq">Dotnet</label>
                                    <ul>
                        ...
                        <l>
                            <input type="checkbox" id="ZnbMJGqpaJ">
                            <label for="ZnbMJGqpaJ">Serverless Framework</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="Vgijlphevv">
                            <label for="Vgijlphevv">Terraform</label>
                            <ul>
                                <l>
                                    <input type="checkbox" id="UaRZJvUCXH">
                                    <label for="UaRZJvUCXH">Functions</label>
                                    <ul>
                                ...
                                <l>
                                    <input type="checkbox" id="ZmxbMEbxFF">
                                    <label for="ZmxbMEbxFF">Meta Arguments</label>
                                    <ul>
                ...
                <l>
                    <input type="checkbox" id="QxogseVnOR">
                    <label for="QxogseVnOR">Docker</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="UbiYnxuYZH">
                    <label for="UbiYnxuYZH">Dotnet</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="pTgzkMwjPo">
                            <label for="pTgzkMwjPo">Cli</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="eSLnoxVkTv">
                    <label for="eSLnoxVkTv">Functional Programming</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="CWXggHTYCz">
                    <label for="CWXggHTYCz">Git</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="ImwuXiWYSO">
                            <label for="ImwuXiWYSO">Github</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="GOLLHWtWNX">
                    <label for="GOLLHWtWNX">Go</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="qKpAJVepMR">
                    <label for="qKpAJVepMR">Haskell</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="cjDTPtiMEq">
                    <label for="cjDTPtiMEq">Js</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="rorwCNmjsG">
                            <label for="rorwCNmjsG">Node</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="HhVXQExUoY">
                            <label for="HhVXQExUoY">D3</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="HpUxqqcceo">
                            <label for="HpUxqqcceo">Mocha</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="mFuAvsKDlJ">
                            <label for="mFuAvsKDlJ">P5js</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="UtghcfogCF">
                            <label for="UtghcfogCF">Typescript</label>
                            <ul>
                                <l>
                                    <input type="checkbox" id="QBgoDQxpzF">
                                    <label for="QBgoDQxpzF">Testing</label>
                                    <ul>
                ...
                <l>
                    <input type="checkbox" id="FhobOBkjsQ">
                    <label for="FhobOBkjsQ">Kafka</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="WpRxnjAfyN">
                    <label for="WpRxnjAfyN">Kubernetes</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="scPzHIazCJ">
                    <label for="scPzHIazCJ">Language</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="brIRaNqwza">
                    <label for="brIRaNqwza">Linux</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="ecdJOJdGHR">
                            <label for="ecdJOJdGHR">Bash</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="xkekZdzEsN">
                    <label for="xkekZdzEsN">Oauth</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="utFuBNkvVo">
                    <label for="utFuBNkvVo">Prometheus</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="dnSUlcPxZO">
                    <label for="dnSUlcPxZO">Python</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="WMtZWONiNo">
                            <label for="WMtZWONiNo">Data Classes</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="qIswxdJAdn">
                            <label for="qIswxdJAdn">Libraries</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="OzRnDUrvIu">
                    <label for="OzRnDUrvIu">React</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="eULOpvdRXx">
                    <label for="eULOpvdRXx">Regular Expressions</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="oTtrOzfRBa">
                    <label for="oTtrOzfRBa">Rust</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="odaGPhycaD">
                            <label for="odaGPhycaD">Serde</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="zhVoPLsFOj">
                    <label for="zhVoPLsFOj">Shaders</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="TMhPDHXRNh">
                            <label for="TMhPDHXRNh">Glsl</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="liSmFZTLlK">
                    <label for="liSmFZTLlK">Vim</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="XvQagmiQdw">
                    <label for="XvQagmiQdw">Web</label>
                    <ul>
