...
<ul>
    <div name="contents-index">
        ...
        <l>
            <input type="checkbox" id="IprAhkrQro" checked>
            <label for="IprAhkrQro">Math</label>
            <ul>
                <l>
                    <input type="checkbox" id="metndlbphz">
                    <label for="metndlbphz">Exponentials</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="roZpSqtBwB">
                    <label for="roZpSqtBwB">Linear Algebra</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="BJTOOaqovF">
                    <label for="BJTOOaqovF">Logarithms</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="JQeZfIjYVC">
                    <label for="JQeZfIjYVC">Sequences</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="NdCSzloYDI">
                    <label for="NdCSzloYDI">Single Variable Calculus</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="hGAWGTacqK">
                    <label for="hGAWGTacqK">Trigonometry</label>
                    <ul>
        ...
        <l>
            <input type="checkbox" id="wgWzIWPcIk" checked>
            <label for="wgWzIWPcIk">Programming</label>
            <ul>
                <l>
                    <input type="checkbox" id="DYnLoCFlzt">
                    <label for="DYnLoCFlzt">Ansible</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="UGNawHrSji">
                    <label for="UGNawHrSji">Architecture</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="CZXVaTyyWW">
                    <label for="CZXVaTyyWW">Computer Graphics</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="RFyPkFWnqV">
                    <label for="RFyPkFWnqV">Databases</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="diLfJYWFIW">
                    <label for="diLfJYWFIW">Devops</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="qOpZVoUeDW">
                            <label for="qOpZVoUeDW">Cloud Providers</label>
                            <ul>
                                <l>
                                    <input type="checkbox" id="CegVNkShCD">
                                    <label for="CegVNkShCD">AWS</label>
                                    <ul>
                                        <l>
                                            <input type="checkbox" id="TKsdwKRKjb">
                                            <label for="TKsdwKRKjb">Cli</label>
                                            <ul>
                                        ...
                                        <l>
                                            <input type="checkbox" id="KuAkSEeGmW">
                                            <label for="KuAkSEeGmW">Dotnet</label>
                                            <ul>
                                        ...
                                        <l>
                                            <input type="checkbox" id="fSTyrZkUEd">
                                            <label for="fSTyrZkUEd">Ec 2</label>
                                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="YIjjuWPjAu">
                            <label for="YIjjuWPjAu">Events</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="zrbhbKcFzU">
                            <label for="zrbhbKcFzU">Localstack</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="LngGcujokh">
                            <label for="LngGcujokh">Pulumi</label>
                            <ul>
                                <l>
                                    <input type="checkbox" id="iIgywziWQp">
                                    <label for="iIgywziWQp">Dotnet</label>
                                    <ul>
                        ...
                        <l>
                            <input type="checkbox" id="cMtjNckERN">
                            <label for="cMtjNckERN">Serverless Framework</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="MXbdRVOlmd">
                            <label for="MXbdRVOlmd">Terraform</label>
                            <ul>
                                <l>
                                    <input type="checkbox" id="pOqVgmTQpO">
                                    <label for="pOqVgmTQpO">Functions</label>
                                    <ul>
                                ...
                                <l>
                                    <input type="checkbox" id="XSKhIjCUpQ">
                                    <label for="XSKhIjCUpQ">Meta Arguments</label>
                                    <ul>
                ...
                <l>
                    <input type="checkbox" id="fpzOuRCULS">
                    <label for="fpzOuRCULS">Docker</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="vEJDKDzqJG">
                    <label for="vEJDKDzqJG">Dotnet</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="ZKNnJyPLLe">
                            <label for="ZKNnJyPLLe">Cli</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="aIcKDbTuGq">
                    <label for="aIcKDbTuGq">Functional Programming</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="xeNUsnQrES">
                    <label for="xeNUsnQrES">Git</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="xSQrVQaeSp">
                            <label for="xSQrVQaeSp">Github</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="SfbVGGFQGo">
                    <label for="SfbVGGFQGo">Go</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="wuvOOtKogw">
                    <label for="wuvOOtKogw">Haskell</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="wovXhgfLdD">
                    <label for="wovXhgfLdD">Js</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="TBKKJeICmR">
                            <label for="TBKKJeICmR">Node</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="aQpjntuCDr">
                            <label for="aQpjntuCDr">D3</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="cwABzUFkgi">
                            <label for="cwABzUFkgi">Mocha</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="rEOdOYUvgr">
                            <label for="rEOdOYUvgr">P5js</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="djXnfdiBqe">
                            <label for="djXnfdiBqe">Typescript</label>
                            <ul>
                                <l>
                                    <input type="checkbox" id="UPEnykxNWM">
                                    <label for="UPEnykxNWM">Testing</label>
                                    <ul>
                ...
                <l>
                    <input type="checkbox" id="CwfYYVngJp">
                    <label for="CwfYYVngJp">Kafka</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="lLQzMZfNPm">
                    <label for="lLQzMZfNPm">Kubernetes</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="evKNSpdpbo">
                    <label for="evKNSpdpbo">Language</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="RoCKSNZkfM">
                    <label for="RoCKSNZkfM">Linux</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="dcxIyVvejU">
                            <label for="dcxIyVvejU">Bash</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="bCmPLmQXpV">
                    <label for="bCmPLmQXpV">Oauth</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="TUhTwZenGK">
                    <label for="TUhTwZenGK">Python</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="chsLbOdtbY">
                            <label for="chsLbOdtbY">Data Classes</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="GOhGyafFLJ">
                            <label for="GOhGyafFLJ">Libraries</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="zIxBnyuPdD">
                    <label for="zIxBnyuPdD">React</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="iMGgqmKfhp">
                    <label for="iMGgqmKfhp">Regular Expressions</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="mYtsjFycep">
                    <label for="mYtsjFycep">Rust</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="nCSeojxYtn">
                            <label for="nCSeojxYtn">Serde</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="qefapoZNqY">
                    <label for="qefapoZNqY">Shaders</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="GZgtuPZIMv">
                            <label for="GZgtuPZIMv">Glsl</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="atpeyIHxsR">
                    <label for="atpeyIHxsR">Vim</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="MqZAxiBtjc">
                    <label for="MqZAxiBtjc">Web</label>
                    <ul>
