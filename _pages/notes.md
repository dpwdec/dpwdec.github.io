...
<ul>
    <div name="contents-index">
        ...
        <l>
            <input type="checkbox" id="vwpBoiCBGr" checked>
            <label for="vwpBoiCBGr">Math</label>
            <ul>
                <l>
                    <input type="checkbox" id="mDRQrTKnvf">
                    <label for="mDRQrTKnvf">Exponentials</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="skpFLdBJXs">
                    <label for="skpFLdBJXs">Linear Algebra</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="kSioAkhWCM">
                    <label for="kSioAkhWCM">Logarithms</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="cbFXUYCCrR">
                    <label for="cbFXUYCCrR">Sequences</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="yXJqautaSw">
                    <label for="yXJqautaSw">Single Variable Calculus</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="apdvQKYQwG">
                    <label for="apdvQKYQwG">Trigonometry</label>
                    <ul>
        ...
        <l>
            <input type="checkbox" id="biLeteBBAQ" checked>
            <label for="biLeteBBAQ">Programming</label>
            <ul>
                <l>
                    <input type="checkbox" id="kcGglclOhG">
                    <label for="kcGglclOhG">Ansible</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="oCVgauygMu">
                    <label for="oCVgauygMu">Architecture</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="NwImENxNHc">
                    <label for="NwImENxNHc">Computer Graphics</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="wTBEwTzTUp">
                    <label for="wTBEwTzTUp">Databases</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="HSeZBOUndx">
                    <label for="HSeZBOUndx">Devops</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="FPBaaXIfjn">
                            <label for="FPBaaXIfjn">Cloud Providers</label>
                            <ul>
                                <l>
                                    <input type="checkbox" id="kgTmFUQggL">
                                    <label for="kgTmFUQggL">AWS</label>
                                    <ul>
                                        <l>
                                            <input type="checkbox" id="YHSTCftWhK">
                                            <label for="YHSTCftWhK">Cli</label>
                                            <ul>
                                        ...
                                        <l>
                                            <input type="checkbox" id="JHuzLwnqAk">
                                            <label for="JHuzLwnqAk">Dotnet</label>
                                            <ul>
                                        ...
                                        <l>
                                            <input type="checkbox" id="NFyvixSYBf">
                                            <label for="NFyvixSYBf">Ec 2</label>
                                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="sGcwbEwobs">
                            <label for="sGcwbEwobs">Events</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="ArtIvAtVjw">
                            <label for="ArtIvAtVjw">Localstack</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="XtlYHGpUAw">
                            <label for="XtlYHGpUAw">Pulumi</label>
                            <ul>
                                <l>
                                    <input type="checkbox" id="QOqMJhAVIw">
                                    <label for="QOqMJhAVIw">Dotnet</label>
                                    <ul>
                        ...
                        <l>
                            <input type="checkbox" id="KOoTADrgBm">
                            <label for="KOoTADrgBm">Serverless Framework</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="VdoswOfept">
                            <label for="VdoswOfept">Terraform</label>
                            <ul>
                                <l>
                                    <input type="checkbox" id="EGBHXeXeri">
                                    <label for="EGBHXeXeri">Functions</label>
                                    <ul>
                                ...
                                <l>
                                    <input type="checkbox" id="gJeVCDrVCE">
                                    <label for="gJeVCDrVCE">Meta Arguments</label>
                                    <ul>
                ...
                <l>
                    <input type="checkbox" id="wxuPIvuDjE">
                    <label for="wxuPIvuDjE">Docker</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="nlrTIoXMrR">
                    <label for="nlrTIoXMrR">Dotnet</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="iwKjoifUBC">
                            <label for="iwKjoifUBC">Cli</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="ucaXkKKLjA">
                    <label for="ucaXkKKLjA">Functional Programming</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="GbLJlmbGbK">
                    <label for="GbLJlmbGbK">Git</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="NRugVWuFkF">
                            <label for="NRugVWuFkF">Github</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="sWuouiZtLr">
                    <label for="sWuouiZtLr">Go</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="sNVTQcqGgC">
                    <label for="sNVTQcqGgC">Haskell</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="hRgbyoISiK">
                    <label for="hRgbyoISiK">Js</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="mJSjTAdxTn">
                            <label for="mJSjTAdxTn">Node</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="hONuksUCYI">
                            <label for="hONuksUCYI">D3</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="TYDeupjsHN">
                            <label for="TYDeupjsHN">Mocha</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="agrGYWTWxL">
                            <label for="agrGYWTWxL">P5js</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="ZiMjzsHcMq">
                            <label for="ZiMjzsHcMq">Typescript</label>
                            <ul>
                                <l>
                                    <input type="checkbox" id="ddweGidVyb">
                                    <label for="ddweGidVyb">Testing</label>
                                    <ul>
                ...
                <l>
                    <input type="checkbox" id="FnmyBervWT">
                    <label for="FnmyBervWT">Kafka</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="pciYfkMRnJ">
                    <label for="pciYfkMRnJ">Kubernetes</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="udvQtWyOLM">
                    <label for="udvQtWyOLM">Language</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="qkGNbbOUge">
                    <label for="qkGNbbOUge">Linux</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="VyiLSgEvai">
                            <label for="VyiLSgEvai">Bash</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="QvOtOCQaWu">
                    <label for="QvOtOCQaWu">Oauth</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="kzaobCmgMt">
                    <label for="kzaobCmgMt">Python</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="IwWSWYUcLL">
                            <label for="IwWSWYUcLL">Data Classes</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="DlJiTTNvNv">
                            <label for="DlJiTTNvNv">Libraries</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="nPafOqpICV">
                    <label for="nPafOqpICV">React</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="crAHitkNZV">
                    <label for="crAHitkNZV">Regular Expressions</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="QTrvQModUd">
                    <label for="QTrvQModUd">Rust</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="MLvrorGPbc">
                            <label for="MLvrorGPbc">Serde</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="fdUjyekDFK">
                    <label for="fdUjyekDFK">Shaders</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="bCvQzFzNPk">
                            <label for="bCvQzFzNPk">Glsl</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="GubeRmbcqm">
                    <label for="GubeRmbcqm">Vim</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="QTNpamKNwW">
                    <label for="QTNpamKNwW">Web</label>
                    <ul>
