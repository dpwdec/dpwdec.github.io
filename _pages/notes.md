...
<ul>
    <div name="contents-index">
        ...
        <l>
            <input type="checkbox" id="EDSifmWQCA" checked>
            <label for="EDSifmWQCA">Math</label>
            <ul>
                <l>
                    <input type="checkbox" id="wuoldUskWz">
                    <label for="wuoldUskWz">Exponentials</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="QvEGpVPStF">
                    <label for="QvEGpVPStF">Linear Algebra</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="bpJPHKTkVh">
                    <label for="bpJPHKTkVh">Logarithms</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="BMSVQSQbCg">
                    <label for="BMSVQSQbCg">Sequences</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="UQlitYdwdQ">
                    <label for="UQlitYdwdQ">Single Variable Calculus</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="NNyrvJnMyr">
                    <label for="NNyrvJnMyr">Trigonometry</label>
                    <ul>
        ...
        <l>
            <input type="checkbox" id="tHXsDAwSET" checked>
            <label for="tHXsDAwSET">Programming</label>
            <ul>
                <l>
                    <input type="checkbox" id="KjoqXZHnyE">
                    <label for="KjoqXZHnyE">Ansible</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="GUFABXDUKF">
                    <label for="GUFABXDUKF">Architecture</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="FubDZqgqlY">
                    <label for="FubDZqgqlY">Computer Graphics</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="CisXfswArq">
                    <label for="CisXfswArq">Databases</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="TRLcVfGlXj">
                    <label for="TRLcVfGlXj">Devops</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="DJMWCKiCmG">
                            <label for="DJMWCKiCmG">Cloud Providers</label>
                            <ul>
                                <l>
                                    <input type="checkbox" id="THBTwQkYae">
                                    <label for="THBTwQkYae">AWS</label>
                                    <ul>
                                        <l>
                                            <input type="checkbox" id="LztzwgwvVq">
                                            <label for="LztzwgwvVq">Cli</label>
                                            <ul>
                                        ...
                                        <l>
                                            <input type="checkbox" id="MOTtmwlxhY">
                                            <label for="MOTtmwlxhY">Dotnet</label>
                                            <ul>
                                        ...
                                        <l>
                                            <input type="checkbox" id="VXcllDMSLO">
                                            <label for="VXcllDMSLO">Ec 2</label>
                                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="pXYepXAGMQ">
                            <label for="pXYepXAGMQ">Events</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="NNpWwdbQGa">
                            <label for="NNpWwdbQGa">Localstack</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="renKWkIPhK">
                            <label for="renKWkIPhK">Pulumi</label>
                            <ul>
                                <l>
                                    <input type="checkbox" id="TaBCZmOWfK">
                                    <label for="TaBCZmOWfK">Dotnet</label>
                                    <ul>
                        ...
                        <l>
                            <input type="checkbox" id="xTjBLSBxKm">
                            <label for="xTjBLSBxKm">Serverless Framework</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="DbrZjYfkqd">
                            <label for="DbrZjYfkqd">Terraform</label>
                            <ul>
                                <l>
                                    <input type="checkbox" id="XIuFdcwGnO">
                                    <label for="XIuFdcwGnO">Functions</label>
                                    <ul>
                                ...
                                <l>
                                    <input type="checkbox" id="aqeTYppxDF">
                                    <label for="aqeTYppxDF">Meta Arguments</label>
                                    <ul>
                ...
                <l>
                    <input type="checkbox" id="hANrnKBBDZ">
                    <label for="hANrnKBBDZ">Docker</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="BwvwloODEs">
                    <label for="BwvwloODEs">Dotnet</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="hqzmLNcmhE">
                            <label for="hqzmLNcmhE">Cli</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="NRtGYRzUIF">
                    <label for="NRtGYRzUIF">Functional Programming</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="OEwOamqHor">
                    <label for="OEwOamqHor">Git</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="iMnRJIVlgm">
                            <label for="iMnRJIVlgm">Github</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="EoVVxEpBff">
                    <label for="EoVVxEpBff">Go</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="RSlaotLdVK">
                    <label for="RSlaotLdVK">Haskell</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="WtOKcCnHpL">
                    <label for="WtOKcCnHpL">Js</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="HHEuXZjmRI">
                            <label for="HHEuXZjmRI">Node</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="LkbxmIYKrJ">
                            <label for="LkbxmIYKrJ">D3</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="AxxmnSexro">
                            <label for="AxxmnSexro">Mocha</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="trBilIoGNg">
                            <label for="trBilIoGNg">P5js</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="sEEEbPFYAK">
                            <label for="sEEEbPFYAK">Typescript</label>
                            <ul>
                                <l>
                                    <input type="checkbox" id="iBlSfwjPDW">
                                    <label for="iBlSfwjPDW">Testing</label>
                                    <ul>
                ...
                <l>
                    <input type="checkbox" id="OrcKxEieDd">
                    <label for="OrcKxEieDd">Kafka</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="hlfldkZXUD">
                    <label for="hlfldkZXUD">Kubernetes</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="XWEYEhWQRO">
                    <label for="XWEYEhWQRO">Language</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="VmUMmKDvzP">
                    <label for="VmUMmKDvzP">Linux</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="TOcxLGnzgJ">
                            <label for="TOcxLGnzgJ">Bash</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="grvbxkqGnU">
                    <label for="grvbxkqGnU">Oauth</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="xFzIqznqlS">
                    <label for="xFzIqznqlS">Python</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="CtKlhUXTuJ">
                            <label for="CtKlhUXTuJ">Data Classes</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="LYFvomeRRL">
                            <label for="LYFvomeRRL">Libraries</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="TYduiAtdwZ">
                    <label for="TYduiAtdwZ">React</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="ByGIMOszTP">
                    <label for="ByGIMOszTP">Regular Expressions</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="lHvmzSlrSb">
                    <label for="lHvmzSlrSb">Rust</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="wsVnsZfFVQ">
                            <label for="wsVnsZfFVQ">Serde</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="OlgrCDRubT">
                    <label for="OlgrCDRubT">Vim</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="HxCzQOFBHk">
                    <label for="HxCzQOFBHk">Web</label>
                    <ul>
