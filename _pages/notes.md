...
<ul>
    <div name="contents-index">
        ...
        <l>
            <input type="checkbox" id="VEeRDcirYE" checked>
            <label for="VEeRDcirYE">Math</label>
            <ul>
                <l>
                    <input type="checkbox" id="btjNFkiWPm">
                    <label for="btjNFkiWPm">Exponentials</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="VxTIXkdTkR">
                    <label for="VxTIXkdTkR">Linear Algebra</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="UvolasecOw">
                    <label for="UvolasecOw">Logarithms</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="JzanqjzPEy">
                    <label for="JzanqjzPEy">Sequences</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="xnEIFRqUBg">
                    <label for="xnEIFRqUBg">Single Variable Calculus</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="NPOSyoTLCt">
                    <label for="NPOSyoTLCt">Trigonometry</label>
                    <ul>
        ...
        <l>
            <input type="checkbox" id="GIevYfdOrz" checked>
            <label for="GIevYfdOrz">Programming</label>
            <ul>
                <l>
                    <input type="checkbox" id="vCtQlQopJw">
                    <label for="vCtQlQopJw">Ansible</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="OaGWbEwwji">
                    <label for="OaGWbEwwji">Architecture</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="LntKMGIWzj">
                    <label for="LntKMGIWzj">Computer Graphics</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="HinRDnnlao">
                    <label for="HinRDnnlao">Databases</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="wRsHQOZELD">
                    <label for="wRsHQOZELD">Devops</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="DHVQIOTGlQ">
                            <label for="DHVQIOTGlQ">Cloud Providers</label>
                            <ul>
                                <l>
                                    <input type="checkbox" id="PaEuaqqVlK">
                                    <label for="PaEuaqqVlK">AWS</label>
                                    <ul>
                                        <l>
                                            <input type="checkbox" id="lTPHbixMoz">
                                            <label for="lTPHbixMoz">Cli</label>
                                            <ul>
                                        ...
                                        <l>
                                            <input type="checkbox" id="vsDOJahoWe">
                                            <label for="vsDOJahoWe">Dotnet</label>
                                            <ul>
                                        ...
                                        <l>
                                            <input type="checkbox" id="afTltvwsgb">
                                            <label for="afTltvwsgb">Ec 2</label>
                                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="yyKimvJFQk">
                            <label for="yyKimvJFQk">Events</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="cLnzlibsGE">
                            <label for="cLnzlibsGE">Localstack</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="DjsYNUNhmi">
                            <label for="DjsYNUNhmi">Pulumi</label>
                            <ul>
                                <l>
                                    <input type="checkbox" id="OhQdJqXWEV">
                                    <label for="OhQdJqXWEV">Dotnet</label>
                                    <ul>
                        ...
                        <l>
                            <input type="checkbox" id="eulfkBGyQr">
                            <label for="eulfkBGyQr">Serverless Framework</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="jKNzYHklUk">
                            <label for="jKNzYHklUk">Terraform</label>
                            <ul>
                                <l>
                                    <input type="checkbox" id="bXOKETiKAH">
                                    <label for="bXOKETiKAH">Functions</label>
                                    <ul>
                                ...
                                <l>
                                    <input type="checkbox" id="uoYFwYRjPU">
                                    <label for="uoYFwYRjPU">Meta Arguments</label>
                                    <ul>
                ...
                <l>
                    <input type="checkbox" id="hpaUoBLcaB">
                    <label for="hpaUoBLcaB">Docker</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="YqkFgIEpVc">
                    <label for="YqkFgIEpVc">Dotnet</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="ErKxCcfjRb">
                            <label for="ErKxCcfjRb">Cli</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="TsIqtRDJTu">
                    <label for="TsIqtRDJTu">Functional Programming</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="QDjNObvfkv">
                    <label for="QDjNObvfkv">Git</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="SjQQOJsUgc">
                            <label for="SjQQOJsUgc">Github</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="IALrRJeEuy">
                    <label for="IALrRJeEuy">Go</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="SlLQRxrZOd">
                    <label for="SlLQRxrZOd">Haskell</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="iwvNJvtWik">
                    <label for="iwvNJvtWik">Js</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="dkNkLxhDSW">
                            <label for="dkNkLxhDSW">Node</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="EXjTizWlZI">
                            <label for="EXjTizWlZI">D3</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="BPERFdfIek">
                            <label for="BPERFdfIek">Mocha</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="YeZJAEzaDo">
                            <label for="YeZJAEzaDo">P5js</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="kMqoKWcUWW">
                            <label for="kMqoKWcUWW">Typescript</label>
                            <ul>
                                <l>
                                    <input type="checkbox" id="mnaIaaCSuv">
                                    <label for="mnaIaaCSuv">Testing</label>
                                    <ul>
                ...
                <l>
                    <input type="checkbox" id="fYBVkwIuhf">
                    <label for="fYBVkwIuhf">Kafka</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="UFPPcRPfdQ">
                    <label for="UFPPcRPfdQ">Kubernetes</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="UmdUrVfddw">
                    <label for="UmdUrVfddw">Language</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="eLJpylFsOi">
                    <label for="eLJpylFsOi">Linux</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="EUGCcYrosD">
                            <label for="EUGCcYrosD">Bash</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="YUkoYeoduA">
                    <label for="YUkoYeoduA">Oauth</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="gHhvFvMOKU">
                    <label for="gHhvFvMOKU">Prometheus</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="uCAUHjfHOw">
                    <label for="uCAUHjfHOw">Python</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="kdFZPLMVae">
                            <label for="kdFZPLMVae">Data Classes</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="CQLxBmMouG">
                            <label for="CQLxBmMouG">Libraries</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="xLgtWSCSIu">
                    <label for="xLgtWSCSIu">React</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="faQmpZOJkV">
                    <label for="faQmpZOJkV">Regular Expressions</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="ZRuncDHQSq">
                    <label for="ZRuncDHQSq">Rust</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="kJfPEWcYcr">
                            <label for="kJfPEWcYcr">Serde</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="HmPsuDfEMf">
                    <label for="HmPsuDfEMf">Shaders</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="sTconRRkwx">
                            <label for="sTconRRkwx">Glsl</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="PaUKhHZHYn">
                    <label for="PaUKhHZHYn">Vim</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="xzmCYMiRSB">
                    <label for="xzmCYMiRSB">Web</label>
                    <ul>
