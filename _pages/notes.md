...
<ul>
    <div name="contents-index">
        ...
        <l>
            <input type="checkbox" id="iPjQVQOSCt" checked>
            <label for="iPjQVQOSCt">Math</label>
            <ul>
                <l>
                    <input type="checkbox" id="KCsEHmiYWe">
                    <label for="KCsEHmiYWe">Exponentials</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="APkclMepay">
                    <label for="APkclMepay">Linear Algebra</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="kZegOIcDTf">
                    <label for="kZegOIcDTf">Logarithms</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="uRbbrVsEtK">
                    <label for="uRbbrVsEtK">Sequences</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="cLimkqjtyg">
                    <label for="cLimkqjtyg">Single Variable Calculus</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="dXcBPZygZn">
                    <label for="dXcBPZygZn">Trigonometry</label>
                    <ul>
        ...
        <l>
            <input type="checkbox" id="xbMdtcUFec" checked>
            <label for="xbMdtcUFec">Programming</label>
            <ul>
                <l>
                    <input type="checkbox" id="xUnWGMDjEt">
                    <label for="xUnWGMDjEt">Ansible</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="mVmgTJztIT">
                    <label for="mVmgTJztIT">Architecture</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="yIjXVwmSwT">
                    <label for="yIjXVwmSwT">Computer Graphics</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="QrVUJIUTjW">
                    <label for="QrVUJIUTjW">Databases</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="koobrmCiER">
                    <label for="koobrmCiER">Devops</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="MeFlmpUQIo">
                            <label for="MeFlmpUQIo">Cloud Computing</label>
                            <ul>
                                <l>
                                    <input type="checkbox" id="yOVTSSGBFE">
                                    <label for="yOVTSSGBFE">AWS</label>
                                    <ul>
                                        <l>
                                            <input type="checkbox" id="GFrHoTeqbx">
                                            <label for="GFrHoTeqbx">Cli</label>
                                            <ul>
                                        ...
                                        <l>
                                            <input type="checkbox" id="GPaxijxkvA">
                                            <label for="GPaxijxkvA">Dotnet</label>
                                            <ul>
                                        ...
                                        <l>
                                            <input type="checkbox" id="jRprGroxxj">
                                            <label for="jRprGroxxj">Ec 2</label>
                                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="KSscEVokIs">
                            <label for="KSscEVokIs">Events</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="NHILignaqR">
                            <label for="NHILignaqR">Oauth</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="UhyAaWEKWe">
                            <label for="UhyAaWEKWe">Pulumi</label>
                            <ul>
                                <l>
                                    <input type="checkbox" id="RafAADVpeV">
                                    <label for="RafAADVpeV">Dotnet</label>
                                    <ul>
                        ...
                        <l>
                            <input type="checkbox" id="CWIPcidNWf">
                            <label for="CWIPcidNWf">Terraform</label>
                            <ul>
                                <l>
                                    <input type="checkbox" id="ZFDdTnqzWX">
                                    <label for="ZFDdTnqzWX">Functions</label>
                                    <ul>
                                ...
                                <l>
                                    <input type="checkbox" id="YTiVWFBRer">
                                    <label for="YTiVWFBRer">Meta Arguments</label>
                                    <ul>
                ...
                <l>
                    <input type="checkbox" id="NKERYhsPbw">
                    <label for="NKERYhsPbw">Docker</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="BGDQQVCyxA">
                    <label for="BGDQQVCyxA">Dotnet</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="whjrzckzmW">
                            <label for="whjrzckzmW">Cli</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="OSpGOObCPn">
                    <label for="OSpGOObCPn">Functional Programming</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="QfulfOWAbb">
                    <label for="QfulfOWAbb">Git</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="wzHVhKgPFp">
                            <label for="wzHVhKgPFp">Github</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="lFYypsnyCl">
                    <label for="lFYypsnyCl">Go</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="TZJtMsYjRe">
                    <label for="TZJtMsYjRe">Haskell</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="cxlUTVJcRv">
                    <label for="cxlUTVJcRv">Js</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="rjQzDTpszE">
                            <label for="rjQzDTpszE">Node</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="cEmLFwBUeR">
                            <label for="cEmLFwBUeR">Mocha</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="BMRWMxKyvf">
                            <label for="BMRWMxKyvf">P5js</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="luHzMlXMOD">
                            <label for="luHzMlXMOD">Typescript</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="VvZlePkqgr">
                    <label for="VvZlePkqgr">Kafka</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="QjIirjbhyF">
                    <label for="QjIirjbhyF">Kubernetes</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="axkdkMzbql">
                    <label for="axkdkMzbql">Language</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="HXDrYcbjJg">
                    <label for="HXDrYcbjJg">Linux</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="KLxkDXOzqY">
                    <label for="KLxkDXOzqY">Python</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="NawhRMOIzG">
                            <label for="NawhRMOIzG">Data Classes</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="TJhtsYvbBj">
                            <label for="TJhtsYvbBj">Libraries</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="GhvhQPPJsZ">
                    <label for="GhvhQPPJsZ">React</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="awSWeydhys">
                    <label for="awSWeydhys">Regular Expressions</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="fwwjYPeYCB">
                    <label for="fwwjYPeYCB">Rust</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="IDGlJUHQhI">
                            <label for="IDGlJUHQhI">Serde</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="khwlIolWfv">
                    <label for="khwlIolWfv">Vim</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="fWHwxNnJoz">
                    <label for="fWHwxNnJoz">Web</label>
                    <ul>
