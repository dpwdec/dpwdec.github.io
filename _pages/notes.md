...
<ul>
    <div name="contents-index">
        ...
        <l>
            <input type="checkbox" id="UQxMJgLWQV" checked>
            <label for="UQxMJgLWQV">Math</label>
            <ul>
                <l>
                    <input type="checkbox" id="JkdoEstcur">
                    <label for="JkdoEstcur">Exponentials</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="CFudLNZEHG">
                    <label for="CFudLNZEHG">Linear Algebra</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="mAshseGrHZ">
                    <label for="mAshseGrHZ">Logarithms</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="uxQOpxHgqE">
                    <label for="uxQOpxHgqE">Sequences</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="FfQCVbnTvF">
                    <label for="FfQCVbnTvF">Single Variable Calculus</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="AxJozErGJK">
                    <label for="AxJozErGJK">Trigonometry</label>
                    <ul>
        ...
        <l>
            <input type="checkbox" id="tsAxXVuCyS" checked>
            <label for="tsAxXVuCyS">Programming</label>
            <ul>
                <l>
                    <input type="checkbox" id="mBzUOLKrom">
                    <label for="mBzUOLKrom">Ansible</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="nJnLRTQbQG">
                    <label for="nJnLRTQbQG">Architecture</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="fkHnxXdUwJ">
                    <label for="fkHnxXdUwJ">Computer Graphics</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="JslNubSXcw">
                    <label for="JslNubSXcw">Databases</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="CxQWEZfJof">
                    <label for="CxQWEZfJof">Devops</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="XKBtENhmZl">
                            <label for="XKBtENhmZl">Cloud Computing</label>
                            <ul>
                                <l>
                                    <input type="checkbox" id="aCpZKnrCYS">
                                    <label for="aCpZKnrCYS">AWS</label>
                                    <ul>
                                        <l>
                                            <input type="checkbox" id="TDvsIKZdZV">
                                            <label for="TDvsIKZdZV">Cli</label>
                                            <ul>
                                        ...
                                        <l>
                                            <input type="checkbox" id="etLrohVNWn">
                                            <label for="etLrohVNWn">Dotnet</label>
                                            <ul>
                                        ...
                                        <l>
                                            <input type="checkbox" id="tuMITlyPPn">
                                            <label for="tuMITlyPPn">Ec 2</label>
                                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="aBYIJQxnlc">
                            <label for="aBYIJQxnlc">Events</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="cSzbDuSmFA">
                            <label for="cSzbDuSmFA">Localstack</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="HhAsfuOAWz">
                            <label for="HhAsfuOAWz">Oauth</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="HfMyDMILNu">
                            <label for="HfMyDMILNu">Pulumi</label>
                            <ul>
                                <l>
                                    <input type="checkbox" id="jCypgxyAhQ">
                                    <label for="jCypgxyAhQ">Dotnet</label>
                                    <ul>
                        ...
                        <l>
                            <input type="checkbox" id="CtNXHOKybn">
                            <label for="CtNXHOKybn">Terraform</label>
                            <ul>
                                <l>
                                    <input type="checkbox" id="XZOqPoeaTf">
                                    <label for="XZOqPoeaTf">Functions</label>
                                    <ul>
                                ...
                                <l>
                                    <input type="checkbox" id="hpRXcmQrzQ">
                                    <label for="hpRXcmQrzQ">Meta Arguments</label>
                                    <ul>
                ...
                <l>
                    <input type="checkbox" id="baRzLZDojw">
                    <label for="baRzLZDojw">Docker</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="iOYoHnWCUj">
                    <label for="iOYoHnWCUj">Dotnet</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="viWdhPQvAJ">
                            <label for="viWdhPQvAJ">Cli</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="SryxZKuZQG">
                    <label for="SryxZKuZQG">Functional Programming</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="mxbQtyBYGG">
                    <label for="mxbQtyBYGG">Git</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="TTRsxDNSEa">
                            <label for="TTRsxDNSEa">Github</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="NHotZhcFOG">
                    <label for="NHotZhcFOG">Go</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="yuGStWIxZx">
                    <label for="yuGStWIxZx">Haskell</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="aqnmllaSlH">
                    <label for="aqnmllaSlH">Js</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="oLDfXSiOzC">
                            <label for="oLDfXSiOzC">Node</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="CzPCGAUjJm">
                            <label for="CzPCGAUjJm">D3</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="NjELTfXFdm">
                            <label for="NjELTfXFdm">Mocha</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="zQKgGbyRuG">
                            <label for="zQKgGbyRuG">P5js</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="kfYRbNvAgh">
                            <label for="kfYRbNvAgh">Typescript</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="yVBNeRuLou">
                    <label for="yVBNeRuLou">Kafka</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="daTeTkKTWI">
                    <label for="daTeTkKTWI">Kubernetes</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="kCslghKrBl">
                    <label for="kCslghKrBl">Language</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="KKdWGfyQHB">
                    <label for="KKdWGfyQHB">Linux</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="WKvonbJAfw">
                            <label for="WKvonbJAfw">Bash</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="XCUkcrvRfw">
                    <label for="XCUkcrvRfw">Python</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="vTirmrSEVy">
                            <label for="vTirmrSEVy">Data Classes</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="DwSNNuABmQ">
                            <label for="DwSNNuABmQ">Libraries</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="LGQNMWpPwm">
                    <label for="LGQNMWpPwm">React</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="tDfPucfeTB">
                    <label for="tDfPucfeTB">Regular Expressions</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="JUeNPFnoiv">
                    <label for="JUeNPFnoiv">Rust</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="VHDJxiZezV">
                            <label for="VHDJxiZezV">Serde</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="wljebDrYdo">
                    <label for="wljebDrYdo">Vim</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="ANgCMMeinw">
                    <label for="ANgCMMeinw">Web</label>
                    <ul>
