...
<ul>
    <div name="contents-index">
        ...
        <l>
            <input type="checkbox" id="ZmZNSJDvfn" checked>
            <label for="ZmZNSJDvfn">Math</label>
            <ul>
                <l>
                    <input type="checkbox" id="aDcZNjRgrQ">
                    <label for="aDcZNjRgrQ">Exponentials</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="lIoFQFRKAa">
                    <label for="lIoFQFRKAa">Linear Algebra</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="boLVnFCDwL">
                    <label for="boLVnFCDwL">Logarithms</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="adVyrsQPCs">
                    <label for="adVyrsQPCs">Sequences</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="tZKLYUghaf">
                    <label for="tZKLYUghaf">Single Variable Calculus</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="pufireiNnW">
                    <label for="pufireiNnW">Trigonometry</label>
                    <ul>
        ...
        <l>
            <input type="checkbox" id="MfpUSKfjXs" checked>
            <label for="MfpUSKfjXs">Programming</label>
            <ul>
                <l>
                    <input type="checkbox" id="CohMuihVQQ">
                    <label for="CohMuihVQQ">Ansible</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="eeJJhJezsd">
                    <label for="eeJJhJezsd">Architecture</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="SBGCGsgFQy">
                    <label for="SBGCGsgFQy">Computer Graphics</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="MxKzaBaIqM">
                    <label for="MxKzaBaIqM">Databases</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="krSXgqGxBs">
                    <label for="krSXgqGxBs">Devops</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="EYFpCKoOeO">
                            <label for="EYFpCKoOeO">Cloud Computing</label>
                            <ul>
                                <l>
                                    <input type="checkbox" id="euAthGmqTW">
                                    <label for="euAthGmqTW">AWS</label>
                                    <ul>
                                        <l>
                                            <input type="checkbox" id="mjliYLeDWB">
                                            <label for="mjliYLeDWB">Cli</label>
                                            <ul>
                                        ...
                                        <l>
                                            <input type="checkbox" id="EyYAzfghUA">
                                            <label for="EyYAzfghUA">Dotnet</label>
                                            <ul>
                                        ...
                                        <l>
                                            <input type="checkbox" id="fErGSXizBt">
                                            <label for="fErGSXizBt">Ec 2</label>
                                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="NDyflNeEXB">
                            <label for="NDyflNeEXB">Events</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="NIaHCVGjhG">
                            <label for="NIaHCVGjhG">Localstack</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="mnDlhsEHJL">
                            <label for="mnDlhsEHJL">Oauth</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="TzZPgPZspy">
                            <label for="TzZPgPZspy">Pulumi</label>
                            <ul>
                                <l>
                                    <input type="checkbox" id="maEzaCpTrb">
                                    <label for="maEzaCpTrb">Dotnet</label>
                                    <ul>
                        ...
                        <l>
                            <input type="checkbox" id="kjVKhhAdMb">
                            <label for="kjVKhhAdMb">Terraform</label>
                            <ul>
                                <l>
                                    <input type="checkbox" id="irUzFjytoR">
                                    <label for="irUzFjytoR">Functions</label>
                                    <ul>
                                ...
                                <l>
                                    <input type="checkbox" id="oweohaqfUA">
                                    <label for="oweohaqfUA">Meta Arguments</label>
                                    <ul>
                ...
                <l>
                    <input type="checkbox" id="ZNUaUOIawc">
                    <label for="ZNUaUOIawc">Docker</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="bCwqlGuQox">
                    <label for="bCwqlGuQox">Dotnet</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="XMjcmKFxlO">
                            <label for="XMjcmKFxlO">Cli</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="yrlozFaGDc">
                    <label for="yrlozFaGDc">Functional Programming</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="uVQseDOCqI">
                    <label for="uVQseDOCqI">Git</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="QAfgKywPvn">
                            <label for="QAfgKywPvn">Github</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="lReVQfrtAw">
                    <label for="lReVQfrtAw">Go</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="xlJGfHLitQ">
                    <label for="xlJGfHLitQ">Haskell</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="jHaKgGoWgF">
                    <label for="jHaKgGoWgF">Js</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="YWQGAFbolC">
                            <label for="YWQGAFbolC">Node</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="rViktlOkdD">
                            <label for="rViktlOkdD">D3</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="QDlvOgxnoP">
                            <label for="QDlvOgxnoP">Mocha</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="vJPiyiajdm">
                            <label for="vJPiyiajdm">P5js</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="DXGbqzhJhs">
                            <label for="DXGbqzhJhs">Typescript</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="nCGvxLTlbP">
                    <label for="nCGvxLTlbP">Kafka</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="tWjSbPjjkT">
                    <label for="tWjSbPjjkT">Kubernetes</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="sDhwBHVDnS">
                    <label for="sDhwBHVDnS">Language</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="lOIxtsKvhy">
                    <label for="lOIxtsKvhy">Linux</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="WYkFyaCWWF">
                    <label for="WYkFyaCWWF">Python</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="XzTDAUDfze">
                            <label for="XzTDAUDfze">Data Classes</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="jhGFhmzroT">
                            <label for="jhGFhmzroT">Libraries</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="cwopiYqggx">
                    <label for="cwopiYqggx">React</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="CJeDvPMiWV">
                    <label for="CJeDvPMiWV">Regular Expressions</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="cFfaxaHDeA">
                    <label for="cFfaxaHDeA">Rust</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="nkgXBpjExL">
                            <label for="nkgXBpjExL">Serde</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="SdVCVFklJT">
                    <label for="SdVCVFklJT">Vim</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="KAQAlEuuRS">
                    <label for="KAQAlEuuRS">Web</label>
                    <ul>
