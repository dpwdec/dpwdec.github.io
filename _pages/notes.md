...
<ul>
    <div name="contents-index">
        ...
        <l>
            <input type="checkbox" id="izLLIvtlIp" checked>
            <label for="izLLIvtlIp">Math</label>
            <ul>
                <l>
                    <input type="checkbox" id="YRbufWJMJX">
                    <label for="YRbufWJMJX">Exponentials</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="XugVxYOCRM">
                    <label for="XugVxYOCRM">Linear Algebra</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="VvWmLYdhMY">
                    <label for="VvWmLYdhMY">Logarithms</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="VTEzlZPNIb">
                    <label for="VTEzlZPNIb">Sequences</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="tBgJnEKWoc">
                    <label for="tBgJnEKWoc">Single Variable Calculus</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="dtIMTxklvY">
                    <label for="dtIMTxklvY">Trigonometry</label>
                    <ul>
        ...
        <l>
            <input type="checkbox" id="SdghUDLlpH" checked>
            <label for="SdghUDLlpH">Programming</label>
            <ul>
                <l>
                    <input type="checkbox" id="tQRfbCsOTO">
                    <label for="tQRfbCsOTO">Ansible</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="lkeQOKHMfA">
                    <label for="lkeQOKHMfA">Architecture</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="XebiweaZRN">
                    <label for="XebiweaZRN">Computer Graphics</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="RWCBByIiix">
                    <label for="RWCBByIiix">Databases</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="eYWrfqiqer">
                    <label for="eYWrfqiqer">Devops</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="BVQsXmhUXZ">
                            <label for="BVQsXmhUXZ">Cloud Computing</label>
                            <ul>
                                <l>
                                    <input type="checkbox" id="pnOhDvMSpd">
                                    <label for="pnOhDvMSpd">AWS</label>
                                    <ul>
                                        <l>
                                            <input type="checkbox" id="FJWFLPvzrV">
                                            <label for="FJWFLPvzrV">Cli</label>
                                            <ul>
                                        ...
                                        <l>
                                            <input type="checkbox" id="NlOKDqjWSH">
                                            <label for="NlOKDqjWSH">Dotnet</label>
                                            <ul>
                                        ...
                                        <l>
                                            <input type="checkbox" id="VVEzoBFzuG">
                                            <label for="VVEzoBFzuG">Ec 2</label>
                                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="bzUlkSaEpv">
                            <label for="bzUlkSaEpv">Events</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="AxXdVcoAcr">
                            <label for="AxXdVcoAcr">Oauth</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="QauQYtbRBH">
                            <label for="QauQYtbRBH">Pulumi</label>
                            <ul>
                                <l>
                                    <input type="checkbox" id="nnnCmmSyQg">
                                    <label for="nnnCmmSyQg">Dotnet</label>
                                    <ul>
                        ...
                        <l>
                            <input type="checkbox" id="RCrFbRNsry">
                            <label for="RCrFbRNsry">Terraform</label>
                            <ul>
                                <l>
                                    <input type="checkbox" id="BILXWvMVTr">
                                    <label for="BILXWvMVTr">Functions</label>
                                    <ul>
                                ...
                                <l>
                                    <input type="checkbox" id="yDBJGHGmAe">
                                    <label for="yDBJGHGmAe">Meta Arguments</label>
                                    <ul>
                ...
                <l>
                    <input type="checkbox" id="ceNQDYQujN">
                    <label for="ceNQDYQujN">Docker</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="ZuZmrhBzmc">
                    <label for="ZuZmrhBzmc">Dotnet</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="uyhGThlaJe">
                            <label for="uyhGThlaJe">Cli</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="VWxrnQVrWS">
                    <label for="VWxrnQVrWS">Functional Programming</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="EHNQTMwBje">
                    <label for="EHNQTMwBje">Git</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="VdADHcVEQj">
                            <label for="VdADHcVEQj">Github</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="dbYTJObtwP">
                    <label for="dbYTJObtwP">Go</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="PXjAsssNXX">
                    <label for="PXjAsssNXX">Haskell</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="sZRVabbbag">
                    <label for="sZRVabbbag">Js</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="rANxvraHEr">
                            <label for="rANxvraHEr">Node</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="ogOPUeyXHz">
                            <label for="ogOPUeyXHz">Mocha</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="lQIsLMyVki">
                            <label for="lQIsLMyVki">P5js</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="ttXjboQbux">
                            <label for="ttXjboQbux">Typescript</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="LKBskuHVFO">
                    <label for="LKBskuHVFO">Kafka</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="VEyEMEEtiv">
                    <label for="VEyEMEEtiv">Kubernetes</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="EnVoBUJgaV">
                    <label for="EnVoBUJgaV">Language</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="UFbpSJEIun">
                    <label for="UFbpSJEIun">Linux</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="yzZjMGrAQs">
                    <label for="yzZjMGrAQs">Python</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="uzvqWgUZhw">
                            <label for="uzvqWgUZhw">Data Classes</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="wNbSoeifTl">
                            <label for="wNbSoeifTl">Libraries</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="LtRHZBAqaX">
                    <label for="LtRHZBAqaX">React</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="VPUEBVLkux">
                    <label for="VPUEBVLkux">Regular Expressions</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="mzPAkiSgVx">
                    <label for="mzPAkiSgVx">Rust</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="AFzcRTsalk">
                            <label for="AFzcRTsalk">Serde</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="ZBCBFhpVkT">
                    <label for="ZBCBFhpVkT">Vim</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="CWGYuHfZIJ">
                    <label for="CWGYuHfZIJ">Web</label>
                    <ul>
