...
<ul>
    <div name="contents-index">
        ...
        <l>
            <input type="checkbox" id="digTncakhT" checked>
            <label for="digTncakhT">Math</label>
            <ul>
                <l>
                    <input type="checkbox" id="eEkPMswiId">
                    <label for="eEkPMswiId">Exponentials</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="gSZvazGIib">
                    <label for="gSZvazGIib">Linear Algebra</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="hhTkXdsirL">
                    <label for="hhTkXdsirL">Logarithms</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="WNfhuSfOVM">
                    <label for="WNfhuSfOVM">Sequences</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="ggqgVbWUCT">
                    <label for="ggqgVbWUCT">Single Variable Calculus</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="aXaQuKlRIM">
                    <label for="aXaQuKlRIM">Trigonometry</label>
                    <ul>
        ...
        <l>
            <input type="checkbox" id="sGOHNNVOZK" checked>
            <label for="sGOHNNVOZK">Programming</label>
            <ul>
                <l>
                    <input type="checkbox" id="dSzbekvRrd">
                    <label for="dSzbekvRrd">Ansible</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="OeKbrhLMpu">
                    <label for="OeKbrhLMpu">Architecture</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="FHsQmdaAZq">
                    <label for="FHsQmdaAZq">Computer Graphics</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="rRNyiHYwxy">
                    <label for="rRNyiHYwxy">Databases</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="oFvPoGHSYc">
                    <label for="oFvPoGHSYc">Devops</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="jYEoyNnkfw">
                            <label for="jYEoyNnkfw">Cloud Providers</label>
                            <ul>
                                <l>
                                    <input type="checkbox" id="KBtBKZoZaR">
                                    <label for="KBtBKZoZaR">AWS</label>
                                    <ul>
                                        <l>
                                            <input type="checkbox" id="LCoQMVMSKL">
                                            <label for="LCoQMVMSKL">Cli</label>
                                            <ul>
                                        ...
                                        <l>
                                            <input type="checkbox" id="nDzhpNreYV">
                                            <label for="nDzhpNreYV">Dotnet</label>
                                            <ul>
                                        ...
                                        <l>
                                            <input type="checkbox" id="NKVOlAXoVL">
                                            <label for="NKVOlAXoVL">Ec 2</label>
                                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="sKMpepfOvU">
                            <label for="sKMpepfOvU">Events</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="nZqNUWrLnD">
                            <label for="nZqNUWrLnD">Localstack</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="hqfDkeTjJc">
                            <label for="hqfDkeTjJc">Pulumi</label>
                            <ul>
                                <l>
                                    <input type="checkbox" id="OIJmQGXksv">
                                    <label for="OIJmQGXksv">Dotnet</label>
                                    <ul>
                        ...
                        <l>
                            <input type="checkbox" id="mayDAQaNIx">
                            <label for="mayDAQaNIx">Serverless Framework</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="RaLRlXTHhc">
                            <label for="RaLRlXTHhc">Terraform</label>
                            <ul>
                                <l>
                                    <input type="checkbox" id="ntxdhMBOIA">
                                    <label for="ntxdhMBOIA">Functions</label>
                                    <ul>
                                ...
                                <l>
                                    <input type="checkbox" id="YaztyJbbzt">
                                    <label for="YaztyJbbzt">Meta Arguments</label>
                                    <ul>
                ...
                <l>
                    <input type="checkbox" id="TndPTxPmhf">
                    <label for="TndPTxPmhf">Docker</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="NxeKlxKAla">
                    <label for="NxeKlxKAla">Dotnet</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="AdxCDDBxst">
                            <label for="AdxCDDBxst">Cli</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="NMAAbSHRIV">
                    <label for="NMAAbSHRIV">Functional Programming</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="hnkgZFdTiT">
                    <label for="hnkgZFdTiT">Git</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="TLOCHAcpHF">
                            <label for="TLOCHAcpHF">Github</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="VFgJONaZMC">
                    <label for="VFgJONaZMC">Go</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="GQVEWUoxrn">
                    <label for="GQVEWUoxrn">Haskell</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="BxldirbmPB">
                    <label for="BxldirbmPB">Js</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="HpDObnCsnM">
                            <label for="HpDObnCsnM">Node</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="DgYVPdlvuI">
                            <label for="DgYVPdlvuI">D3</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="mFpxcECCLW">
                            <label for="mFpxcECCLW">Mocha</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="fenpqlOFyU">
                            <label for="fenpqlOFyU">P5js</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="edBuuSBhTh">
                            <label for="edBuuSBhTh">Typescript</label>
                            <ul>
                                <l>
                                    <input type="checkbox" id="OtucihEbFV">
                                    <label for="OtucihEbFV">Testing</label>
                                    <ul>
                ...
                <l>
                    <input type="checkbox" id="tjBJKHmfta">
                    <label for="tjBJKHmfta">Kafka</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="DIQsjGUdMd">
                    <label for="DIQsjGUdMd">Kubernetes</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="kUnQfHarFK">
                    <label for="kUnQfHarFK">Language</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="GYjNjbKYup">
                    <label for="GYjNjbKYup">Linux</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="HoRcZEBRwn">
                            <label for="HoRcZEBRwn">Bash</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="NYvUhfYtYr">
                    <label for="NYvUhfYtYr">Oauth</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="znSPVhRZlz">
                    <label for="znSPVhRZlz">Prometheus</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="ghsSsmBMsA">
                    <label for="ghsSsmBMsA">Python</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="HkGjQHbCSm">
                            <label for="HkGjQHbCSm">Data Classes</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="gxmIbKfVrI">
                            <label for="gxmIbKfVrI">Libraries</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="eWoftubYXC">
                    <label for="eWoftubYXC">React</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="cqPIqeczWk">
                    <label for="cqPIqeczWk">Regular Expressions</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="cGLqnksYkU">
                    <label for="cGLqnksYkU">Rust</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="MOQtAlboJQ">
                            <label for="MOQtAlboJQ">Serde</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="OWsrgAoXbc">
                    <label for="OWsrgAoXbc">Shaders</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="KXnlmBOiGr">
                            <label for="KXnlmBOiGr">Glsl</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="vTzpyqryfM">
                    <label for="vTzpyqryfM">Vim</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="PofkbgaCie">
                    <label for="PofkbgaCie">Web</label>
                    <ul>
