...
<ul>
    <div name="contents-index">
        ...
        <l>
            <input type="checkbox" id="fZyQPNqOtZ" checked>
            <label for="fZyQPNqOtZ">Math</label>
            <ul>
                <l>
                    <input type="checkbox" id="SRhNmLETnw">
                    <label for="SRhNmLETnw">Exponentials</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="bmTYqVYyws">
                    <label for="bmTYqVYyws">Linear Algebra</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="aUOHWyDwnx">
                    <label for="aUOHWyDwnx">Logarithms</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="UEgiVedyOh">
                    <label for="UEgiVedyOh">Sequences</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="mnticGKPtL">
                    <label for="mnticGKPtL">Single Variable Calculus</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="LQhDfBrmma">
                    <label for="LQhDfBrmma">Trigonometry</label>
                    <ul>
        ...
        <l>
            <input type="checkbox" id="FiTdlwlZkC" checked>
            <label for="FiTdlwlZkC">Programming</label>
            <ul>
                <l>
                    <input type="checkbox" id="nGTQuJqCSv">
                    <label for="nGTQuJqCSv">Ansible</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="yvvRSiLqyL">
                    <label for="yvvRSiLqyL">Architecture</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="iEAiHUNKxK">
                    <label for="iEAiHUNKxK">Computer Graphics</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="wqTwDJyoZb">
                    <label for="wqTwDJyoZb">Databases</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="gnHXuIJQSC">
                    <label for="gnHXuIJQSC">Devops</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="TJNSjknBzD">
                            <label for="TJNSjknBzD">Cloud Providers</label>
                            <ul>
                                <l>
                                    <input type="checkbox" id="lZfVjhTKQs">
                                    <label for="lZfVjhTKQs">AWS</label>
                                    <ul>
                                        <l>
                                            <input type="checkbox" id="zNdWdMqqqQ">
                                            <label for="zNdWdMqqqQ">Cli</label>
                                            <ul>
                                        ...
                                        <l>
                                            <input type="checkbox" id="zgIFqjyTgd">
                                            <label for="zgIFqjyTgd">Dotnet</label>
                                            <ul>
                                        ...
                                        <l>
                                            <input type="checkbox" id="SmTsDgCEjL">
                                            <label for="SmTsDgCEjL">Ec 2</label>
                                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="lLBBKoCPBC">
                            <label for="lLBBKoCPBC">Events</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="dOWqKCVVav">
                            <label for="dOWqKCVVav">Localstack</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="HSqVofndfi">
                            <label for="HSqVofndfi">Pulumi</label>
                            <ul>
                                <l>
                                    <input type="checkbox" id="ejhqydEZjU">
                                    <label for="ejhqydEZjU">Dotnet</label>
                                    <ul>
                        ...
                        <l>
                            <input type="checkbox" id="CvMLcBKqLD">
                            <label for="CvMLcBKqLD">Serverless Framework</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="atpIeLBdIs">
                            <label for="atpIeLBdIs">Terraform</label>
                            <ul>
                                <l>
                                    <input type="checkbox" id="GtNZvEmbeH">
                                    <label for="GtNZvEmbeH">Functions</label>
                                    <ul>
                                ...
                                <l>
                                    <input type="checkbox" id="nIEzCygtMS">
                                    <label for="nIEzCygtMS">Meta Arguments</label>
                                    <ul>
                ...
                <l>
                    <input type="checkbox" id="ocRFUGHnGi">
                    <label for="ocRFUGHnGi">Docker</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="fwDkKxIxmF">
                    <label for="fwDkKxIxmF">Dotnet</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="MKEssiyfXq">
                            <label for="MKEssiyfXq">Cli</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="zQIMBSPajp">
                    <label for="zQIMBSPajp">Functional Programming</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="frNRQUXphW">
                    <label for="frNRQUXphW">Git</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="GGnwEkweRV">
                            <label for="GGnwEkweRV">Github</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="NkHsKwNOrW">
                    <label for="NkHsKwNOrW">Go</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="mNIruomXde">
                    <label for="mNIruomXde">Haskell</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="uOgFpPFwxe">
                    <label for="uOgFpPFwxe">Js</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="RTOlpsQxwa">
                            <label for="RTOlpsQxwa">Node</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="ffbTJafoeh">
                            <label for="ffbTJafoeh">D3</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="GeQGOQhDvH">
                            <label for="GeQGOQhDvH">Mocha</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="ppKOvqNPDR">
                            <label for="ppKOvqNPDR">P5js</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="ETfYXXJMhs">
                            <label for="ETfYXXJMhs">Typescript</label>
                            <ul>
                                <l>
                                    <input type="checkbox" id="RiFviXkvFc">
                                    <label for="RiFviXkvFc">Testing</label>
                                    <ul>
                ...
                <l>
                    <input type="checkbox" id="RvTuLGrRmM">
                    <label for="RvTuLGrRmM">Kafka</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="mcuALGdyfq">
                    <label for="mcuALGdyfq">Kubernetes</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="BLIkWSRMmj">
                    <label for="BLIkWSRMmj">Language</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="wuCLaoaFqb">
                    <label for="wuCLaoaFqb">Linux</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="gANGBvryXH">
                            <label for="gANGBvryXH">Bash</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="jCIBunWhoS">
                    <label for="jCIBunWhoS">Oauth</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="ZbBAvuaJGE">
                    <label for="ZbBAvuaJGE">Prometheus</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="QlwqkQAbYN">
                    <label for="QlwqkQAbYN">Python</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="AnwdyNEFdo">
                            <label for="AnwdyNEFdo">Data Classes</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="ZjQsSvscnu">
                            <label for="ZjQsSvscnu">Libraries</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="RJTUaWYoiH">
                    <label for="RJTUaWYoiH">React</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="RcwWTjoekZ">
                    <label for="RcwWTjoekZ">Regular Expressions</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="yFFilerYWM">
                    <label for="yFFilerYWM">Rust</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="yWIKFVHkWB">
                            <label for="yWIKFVHkWB">Serde</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="rVAQhYaBjZ">
                    <label for="rVAQhYaBjZ">Shaders</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="mdlLDFNZHp">
                            <label for="mdlLDFNZHp">Glsl</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="aLWhzNYKLk">
                    <label for="aLWhzNYKLk">Vim</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="zFdtmFgXbD">
                    <label for="zFdtmFgXbD">Web</label>
                    <ul>
