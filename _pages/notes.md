...
<ul>
    <div name="contents-index">
        ...
        <l>
            <input type="checkbox" id="XNPvhKcYnz" checked>
            <label for="XNPvhKcYnz">Math</label>
            <ul>
                <l>
                    <input type="checkbox" id="OcjTiuDWcl">
                    <label for="OcjTiuDWcl">Exponentials</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="uwaGRBDKsq">
                    <label for="uwaGRBDKsq">Linear Algebra</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="DncqAFKocX">
                    <label for="DncqAFKocX">Logarithms</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="KmAbmeUjED">
                    <label for="KmAbmeUjED">Sequences</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="iMRZjRotep">
                    <label for="iMRZjRotep">Single Variable Calculus</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="lhfcBSTupQ">
                    <label for="lhfcBSTupQ">Trigonometry</label>
                    <ul>
        ...
        <l>
            <input type="checkbox" id="QRJEIZrGlU" checked>
            <label for="QRJEIZrGlU">Programming</label>
            <ul>
                <l>
                    <input type="checkbox" id="ZypLuCeVwi">
                    <label for="ZypLuCeVwi">Ansible</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="LlreQvMwgg">
                    <label for="LlreQvMwgg">Architecture</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="WJbhsIobAG">
                    <label for="WJbhsIobAG">Computer Graphics</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="rZSFxIYJWg">
                    <label for="rZSFxIYJWg">Databases</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="fuYkoQHoNd">
                    <label for="fuYkoQHoNd">Devops</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="HkLoTMTInz">
                            <label for="HkLoTMTInz">Cloud Providers</label>
                            <ul>
                                <l>
                                    <input type="checkbox" id="IrrKCJjWCO">
                                    <label for="IrrKCJjWCO">AWS</label>
                                    <ul>
                                        <l>
                                            <input type="checkbox" id="UJMMbfuwRO">
                                            <label for="UJMMbfuwRO">Cli</label>
                                            <ul>
                                        ...
                                        <l>
                                            <input type="checkbox" id="fMwvSGmjvK">
                                            <label for="fMwvSGmjvK">Dotnet</label>
                                            <ul>
                                        ...
                                        <l>
                                            <input type="checkbox" id="udLpVJQiWH">
                                            <label for="udLpVJQiWH">Ec 2</label>
                                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="LbpfjoYIci">
                            <label for="LbpfjoYIci">Events</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="WNqWQCEhQj">
                            <label for="WNqWQCEhQj">Localstack</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="NfKdAIdDtK">
                            <label for="NfKdAIdDtK">Pulumi</label>
                            <ul>
                                <l>
                                    <input type="checkbox" id="bxbhomQXvJ">
                                    <label for="bxbhomQXvJ">Dotnet</label>
                                    <ul>
                        ...
                        <l>
                            <input type="checkbox" id="KLWwtlcAoG">
                            <label for="KLWwtlcAoG">Serverless Framework</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="dUgFIurjQl">
                            <label for="dUgFIurjQl">Terraform</label>
                            <ul>
                                <l>
                                    <input type="checkbox" id="hOxNhrAxvz">
                                    <label for="hOxNhrAxvz">Functions</label>
                                    <ul>
                                ...
                                <l>
                                    <input type="checkbox" id="FvVsEkQVUU">
                                    <label for="FvVsEkQVUU">Meta Arguments</label>
                                    <ul>
                ...
                <l>
                    <input type="checkbox" id="TAuPkBLkZL">
                    <label for="TAuPkBLkZL">Docker</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="cewLLjAcon">
                    <label for="cewLLjAcon">Dotnet</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="QovNtbHnth">
                            <label for="QovNtbHnth">Cli</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="KCQrRgoEjs">
                    <label for="KCQrRgoEjs">Functional Programming</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="oFVvPZiCJG">
                    <label for="oFVvPZiCJG">Git</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="yCyVAjfSFx">
                            <label for="yCyVAjfSFx">Github</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="WApqhuCpcY">
                    <label for="WApqhuCpcY">Go</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="FYCDSOIdWi">
                    <label for="FYCDSOIdWi">Haskell</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="eaVrpugypi">
                    <label for="eaVrpugypi">Js</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="guuurejegO">
                            <label for="guuurejegO">Node</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="hZOWNbNwCZ">
                            <label for="hZOWNbNwCZ">D3</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="GKGkICiDDd">
                            <label for="GKGkICiDDd">Mocha</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="EJtmkfdnzL">
                            <label for="EJtmkfdnzL">P5js</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="rySOyAJgIx">
                            <label for="rySOyAJgIx">Typescript</label>
                            <ul>
                                <l>
                                    <input type="checkbox" id="fczeZnrnxD">
                                    <label for="fczeZnrnxD">Testing</label>
                                    <ul>
                ...
                <l>
                    <input type="checkbox" id="iBgBKbBZpn">
                    <label for="iBgBKbBZpn">Kafka</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="dlccZmMxMA">
                    <label for="dlccZmMxMA">Kubernetes</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="ZKQUwxSeKv">
                    <label for="ZKQUwxSeKv">Language</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="BewTYtJcBn">
                    <label for="BewTYtJcBn">Linux</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="MxcyWIiSKV">
                            <label for="MxcyWIiSKV">Bash</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="EbIpyAiQEY">
                    <label for="EbIpyAiQEY">Oauth</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="gagNjuPmOA">
                    <label for="gagNjuPmOA">Prometheus</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="rNhEtXeDaN">
                    <label for="rNhEtXeDaN">Python</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="rujtZYiQjm">
                            <label for="rujtZYiQjm">Data Classes</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="LEyNGOWTvv">
                            <label for="LEyNGOWTvv">Libraries</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="STVKQnAGVP">
                    <label for="STVKQnAGVP">React</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="eAVhmNrYWJ">
                    <label for="eAVhmNrYWJ">Regular Expressions</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="retpXivcBc">
                    <label for="retpXivcBc">Rust</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="KxhHztjHxN">
                            <label for="KxhHztjHxN">Serde</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="gSnmnYescR">
                    <label for="gSnmnYescR">Shaders</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="pcmXfAREFR">
                            <label for="pcmXfAREFR">Glsl</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="ifyLCTqBfp">
                    <label for="ifyLCTqBfp">Vim</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="lzdVTjofwv">
                    <label for="lzdVTjofwv">Web</label>
                    <ul>
