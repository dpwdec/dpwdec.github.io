...
<ul>
    <div name="contents-index">
        ...
        <l>
            <input type="checkbox" id="ksFXTLmHwd" checked>
            <label for="ksFXTLmHwd">Math</label>
            <ul>
                <l>
                    <input type="checkbox" id="gSrfcatoSv">
                    <label for="gSrfcatoSv">Exponentials</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="hFPEpbqlYz">
                    <label for="hFPEpbqlYz">Linear Algebra</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="PxJTGSGSxy">
                    <label for="PxJTGSGSxy">Logarithms</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="EnJuixkxjv">
                    <label for="EnJuixkxjv">Sequences</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="ozKoeIKlSO">
                    <label for="ozKoeIKlSO">Single Variable Calculus</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="ckSpdrQLHE">
                    <label for="ckSpdrQLHE">Trigonometry</label>
                    <ul>
        ...
        <l>
            <input type="checkbox" id="swFLxJNqCd" checked>
            <label for="swFLxJNqCd">Programming</label>
            <ul>
                <l>
                    <input type="checkbox" id="OWyeyNQodZ">
                    <label for="OWyeyNQodZ">Ansible</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="kOBhnJvCpC">
                    <label for="kOBhnJvCpC">Architecture</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="eQYrtRKxUG">
                    <label for="eQYrtRKxUG">Computer Graphics</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="CLlXziYiJj">
                    <label for="CLlXziYiJj">Databases</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="cTQIXeADYZ">
                    <label for="cTQIXeADYZ">Devops</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="cdRDQoEKZd">
                            <label for="cdRDQoEKZd">Cloud Providers</label>
                            <ul>
                                <l>
                                    <input type="checkbox" id="QwbulDMtNW">
                                    <label for="QwbulDMtNW">AWS</label>
                                    <ul>
                                        <l>
                                            <input type="checkbox" id="TuUpKYjdGk">
                                            <label for="TuUpKYjdGk">Cli</label>
                                            <ul>
                                        ...
                                        <l>
                                            <input type="checkbox" id="kPAUBEWuXb">
                                            <label for="kPAUBEWuXb">Dotnet</label>
                                            <ul>
                                        ...
                                        <l>
                                            <input type="checkbox" id="UtLqjRkpEQ">
                                            <label for="UtLqjRkpEQ">Ec 2</label>
                                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="pVUWkgQnLO">
                            <label for="pVUWkgQnLO">Events</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="daagIpjOZg">
                            <label for="daagIpjOZg">Localstack</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="orTaBKDOse">
                            <label for="orTaBKDOse">Pulumi</label>
                            <ul>
                                <l>
                                    <input type="checkbox" id="frkwdtFMPP">
                                    <label for="frkwdtFMPP">Dotnet</label>
                                    <ul>
                        ...
                        <l>
                            <input type="checkbox" id="zPPVNIOiba">
                            <label for="zPPVNIOiba">Serverless Framework</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="TUqPmsJzdw">
                            <label for="TUqPmsJzdw">Terraform</label>
                            <ul>
                                <l>
                                    <input type="checkbox" id="vnXzdBRiVu">
                                    <label for="vnXzdBRiVu">Functions</label>
                                    <ul>
                                ...
                                <l>
                                    <input type="checkbox" id="sYAwYbmEro">
                                    <label for="sYAwYbmEro">Meta Arguments</label>
                                    <ul>
                ...
                <l>
                    <input type="checkbox" id="VnrKNAsUrk">
                    <label for="VnrKNAsUrk">Docker</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="LjpvhrdKjx">
                    <label for="LjpvhrdKjx">Dotnet</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="knRPZkOgWz">
                            <label for="knRPZkOgWz">Cli</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="YMNmkhVZcS">
                    <label for="YMNmkhVZcS">Functional Programming</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="hdGXRLjxfa">
                    <label for="hdGXRLjxfa">Git</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="dmQFNXFVch">
                            <label for="dmQFNXFVch">Github</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="inubenfrdO">
                    <label for="inubenfrdO">Go</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="CboSUBPaIP">
                    <label for="CboSUBPaIP">Haskell</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="ZtEVySjZvs">
                    <label for="ZtEVySjZvs">Js</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="BTyHSdhsGY">
                            <label for="BTyHSdhsGY">Node</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="JIXWLmSEqG">
                            <label for="JIXWLmSEqG">D3</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="lkeuiWgbhz">
                            <label for="lkeuiWgbhz">Mocha</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="zUWvIRINip">
                            <label for="zUWvIRINip">P5js</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="JYQNzPlaJb">
                            <label for="JYQNzPlaJb">Typescript</label>
                            <ul>
                                <l>
                                    <input type="checkbox" id="bNJBDAtxEB">
                                    <label for="bNJBDAtxEB">Testing</label>
                                    <ul>
                ...
                <l>
                    <input type="checkbox" id="WKYFnrXgmt">
                    <label for="WKYFnrXgmt">Kafka</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="VUOkWugWTL">
                    <label for="VUOkWugWTL">Kubernetes</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="wFOnqCXaKO">
                    <label for="wFOnqCXaKO">Language</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="yPgTzzEcUQ">
                    <label for="yPgTzzEcUQ">Linux</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="UyHOLEYXzU">
                            <label for="UyHOLEYXzU">Bash</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="Qdsilvrqpe">
                    <label for="Qdsilvrqpe">Oauth</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="KMQHSrOxZV">
                    <label for="KMQHSrOxZV">Prometheus</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="ccGXDJhvxs">
                    <label for="ccGXDJhvxs">Python</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="BaGvyQdgPb">
                            <label for="BaGvyQdgPb">Data Classes</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="WKGQtgGlVG">
                            <label for="WKGQtgGlVG">Libraries</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="RhucqwvvVJ">
                    <label for="RhucqwvvVJ">React</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="klccOlnino">
                    <label for="klccOlnino">Regular Expressions</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="mrMSFWCyAq">
                    <label for="mrMSFWCyAq">Rust</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="vHPZnkKIDN">
                            <label for="vHPZnkKIDN">Serde</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="pPDganIfNY">
                    <label for="pPDganIfNY">Shaders</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="hAtqVGotSO">
                            <label for="hAtqVGotSO">Glsl</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="IaEIHzsJIb">
                    <label for="IaEIHzsJIb">Vim</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="pXsCpZElfy">
                    <label for="pXsCpZElfy">Web</label>
                    <ul>
