...
<ul>
    <div name="contents-index">
        ...
        <l>
            <input type="checkbox" id="YlZdSNMQdF" checked>
            <label for="YlZdSNMQdF">Math</label>
            <ul>
                <l>
                    <input type="checkbox" id="DVgjjjitAQ">
                    <label for="DVgjjjitAQ">Exponentials</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="zzVcckFsrQ">
                    <label for="zzVcckFsrQ">Linear Algebra</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="hJLGJraGLT">
                    <label for="hJLGJraGLT">Logarithms</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="GFnzcrFaeh">
                    <label for="GFnzcrFaeh">Sequences</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="foXaCYpcYT">
                    <label for="foXaCYpcYT">Single Variable Calculus</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="JvGqsceNkK">
                    <label for="JvGqsceNkK">Trigonometry</label>
                    <ul>
        ...
        <l>
            <input type="checkbox" id="GAhgLqYRro" checked>
            <label for="GAhgLqYRro">Programming</label>
            <ul>
                <l>
                    <input type="checkbox" id="plyLWYfTtk">
                    <label for="plyLWYfTtk">Ansible</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="NQapOvsHfB">
                    <label for="NQapOvsHfB">Architecture</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="xAkJdbaQwP">
                    <label for="xAkJdbaQwP">Computer Graphics</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="uKawTRslkn">
                    <label for="uKawTRslkn">Databases</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="YRfmYSTOzp">
                    <label for="YRfmYSTOzp">Devops</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="ZsxWLUNlPH">
                            <label for="ZsxWLUNlPH">Cloud Providers</label>
                            <ul>
                                <l>
                                    <input type="checkbox" id="egFpvJmBxm">
                                    <label for="egFpvJmBxm">AWS</label>
                                    <ul>
                                        <l>
                                            <input type="checkbox" id="AsGkGffGxX">
                                            <label for="AsGkGffGxX">Cli</label>
                                            <ul>
                                        ...
                                        <l>
                                            <input type="checkbox" id="GKbxOHvTfI">
                                            <label for="GKbxOHvTfI">Dotnet</label>
                                            <ul>
                                        ...
                                        <l>
                                            <input type="checkbox" id="SpEdgbKpIV">
                                            <label for="SpEdgbKpIV">Ec 2</label>
                                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="rwpFqXasTT">
                            <label for="rwpFqXasTT">Events</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="yAkywrXukK">
                            <label for="yAkywrXukK">Localstack</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="tKKSGOGFUo">
                            <label for="tKKSGOGFUo">Pulumi</label>
                            <ul>
                                <l>
                                    <input type="checkbox" id="xotJsOPqfZ">
                                    <label for="xotJsOPqfZ">Dotnet</label>
                                    <ul>
                        ...
                        <l>
                            <input type="checkbox" id="laNrJRZgPq">
                            <label for="laNrJRZgPq">Serverless Framework</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="kNVJPDZWrC">
                            <label for="kNVJPDZWrC">Terraform</label>
                            <ul>
                                <l>
                                    <input type="checkbox" id="rgvkgqfPDS">
                                    <label for="rgvkgqfPDS">Functions</label>
                                    <ul>
                                ...
                                <l>
                                    <input type="checkbox" id="WBkPMhCZOP">
                                    <label for="WBkPMhCZOP">Meta Arguments</label>
                                    <ul>
                ...
                <l>
                    <input type="checkbox" id="KXmtiPpzlQ">
                    <label for="KXmtiPpzlQ">Docker</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="MKNoitYMOr">
                    <label for="MKNoitYMOr">Dotnet</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="CrYMEloxOB">
                            <label for="CrYMEloxOB">Cli</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="KYTxhAjkKN">
                    <label for="KYTxhAjkKN">Functional Programming</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="qbbkHLQqcR">
                    <label for="qbbkHLQqcR">Git</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="fLjEFdvApe">
                            <label for="fLjEFdvApe">Github</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="smPLvWjjmL">
                    <label for="smPLvWjjmL">Go</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="wfrPIphGhR">
                    <label for="wfrPIphGhR">Haskell</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="XvSjdabILp">
                    <label for="XvSjdabILp">Js</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="FQWxEMhPja">
                            <label for="FQWxEMhPja">Node</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="wLnnMyOGOm">
                            <label for="wLnnMyOGOm">D3</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="tTBzYuSgkh">
                            <label for="tTBzYuSgkh">Mocha</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="yHVWfhdpOd">
                            <label for="yHVWfhdpOd">P5js</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="DPXqNzqHrj">
                            <label for="DPXqNzqHrj">Typescript</label>
                            <ul>
                                <l>
                                    <input type="checkbox" id="pkWluqRTwk">
                                    <label for="pkWluqRTwk">Testing</label>
                                    <ul>
                ...
                <l>
                    <input type="checkbox" id="Hadmmxqmjm">
                    <label for="Hadmmxqmjm">Kafka</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="mEdXgByjyO">
                    <label for="mEdXgByjyO">Kubernetes</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="sweiLPUreu">
                    <label for="sweiLPUreu">Language</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="WJCUssxDfX">
                    <label for="WJCUssxDfX">Linux</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="bCzjojfWPg">
                            <label for="bCzjojfWPg">Bash</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="RCckOAWihy">
                    <label for="RCckOAWihy">Oauth</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="mQLMyBvysm">
                    <label for="mQLMyBvysm">Prometheus</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="XSupnqxZkj">
                    <label for="XSupnqxZkj">Python</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="JKeefkWUtA">
                            <label for="JKeefkWUtA">Data Classes</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="kLfUjcsZEE">
                            <label for="kLfUjcsZEE">Libraries</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="sjIDfACKdU">
                    <label for="sjIDfACKdU">React</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="eYLpaapCMi">
                    <label for="eYLpaapCMi">Regular Expressions</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="nlhvJAwpnw">
                    <label for="nlhvJAwpnw">Rust</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="omdEqSeEGX">
                            <label for="omdEqSeEGX">Serde</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="htehmWYtSr">
                    <label for="htehmWYtSr">Shaders</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="StebNYbfbd">
                            <label for="StebNYbfbd">Glsl</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="SRlgliMhKK">
                    <label for="SRlgliMhKK">Vim</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="edFyvOhVUJ">
                    <label for="edFyvOhVUJ">Web</label>
                    <ul>
