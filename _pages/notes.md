...
<ul>
    <div name="contents-index">
        ...
        <l>
            <input type="checkbox" id="QedGesqqHr" checked>
            <label for="QedGesqqHr">Math</label>
            <ul>
                <l>
                    <input type="checkbox" id="pWjseKDNet">
                    <label for="pWjseKDNet">Exponentials</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="ycXgegSKVZ">
                    <label for="ycXgegSKVZ">Linear Algebra</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="btNwXXkPBV">
                    <label for="btNwXXkPBV">Logarithms</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="xSjqKGjbAt">
                    <label for="xSjqKGjbAt">Sequences</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="PeJjmNlXaz">
                    <label for="PeJjmNlXaz">Single Variable Calculus</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="KtVaQRzatk">
                    <label for="KtVaQRzatk">Trigonometry</label>
                    <ul>
        ...
        <l>
            <input type="checkbox" id="gpMGbcEwzc" checked>
            <label for="gpMGbcEwzc">Programming</label>
            <ul>
                <l>
                    <input type="checkbox" id="xeKnjKrTBz">
                    <label for="xeKnjKrTBz">Ansible</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="cnqfLwJkfb">
                    <label for="cnqfLwJkfb">Architecture</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="MjJBhyQstW">
                    <label for="MjJBhyQstW">Computer Graphics</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="PcluBzCChZ">
                    <label for="PcluBzCChZ">Databases</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="gFsMCKYCak">
                    <label for="gFsMCKYCak">Devops</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="pGNhWpCItn">
                            <label for="pGNhWpCItn">Cloud Providers</label>
                            <ul>
                                <l>
                                    <input type="checkbox" id="gxTWVrXrAx">
                                    <label for="gxTWVrXrAx">AWS</label>
                                    <ul>
                                        <l>
                                            <input type="checkbox" id="ySwaxuvccf">
                                            <label for="ySwaxuvccf">Cli</label>
                                            <ul>
                                        ...
                                        <l>
                                            <input type="checkbox" id="lZCjKrNDFf">
                                            <label for="lZCjKrNDFf">Dotnet</label>
                                            <ul>
                                        ...
                                        <l>
                                            <input type="checkbox" id="jMaflPBucE">
                                            <label for="jMaflPBucE">Ec 2</label>
                                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="PErSxvnYag">
                            <label for="PErSxvnYag">Events</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="ZbbcZOroBc">
                            <label for="ZbbcZOroBc">Localstack</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="YWAZYDCovR">
                            <label for="YWAZYDCovR">Pulumi</label>
                            <ul>
                                <l>
                                    <input type="checkbox" id="BvfLFCOCqA">
                                    <label for="BvfLFCOCqA">Dotnet</label>
                                    <ul>
                        ...
                        <l>
                            <input type="checkbox" id="tHTjGkwWBZ">
                            <label for="tHTjGkwWBZ">Serverless Framework</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="khbKaoCgky">
                            <label for="khbKaoCgky">Terraform</label>
                            <ul>
                                <l>
                                    <input type="checkbox" id="vkcdckvYlI">
                                    <label for="vkcdckvYlI">Functions</label>
                                    <ul>
                                ...
                                <l>
                                    <input type="checkbox" id="LigSawQtvf">
                                    <label for="LigSawQtvf">Meta Arguments</label>
                                    <ul>
                ...
                <l>
                    <input type="checkbox" id="NEtgDZXDUE">
                    <label for="NEtgDZXDUE">Docker</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="HmQJyAFblZ">
                    <label for="HmQJyAFblZ">Dotnet</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="ChWuiVeTPq">
                            <label for="ChWuiVeTPq">Cli</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="pyumsZTXXh">
                    <label for="pyumsZTXXh">Functional Programming</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="pLilktuuEh">
                    <label for="pLilktuuEh">Git</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="slWinevfNA">
                            <label for="slWinevfNA">Github</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="XghTBBUqea">
                    <label for="XghTBBUqea">Go</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="quVliKqous">
                    <label for="quVliKqous">Haskell</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="tQoHUmBuJZ">
                    <label for="tQoHUmBuJZ">Js</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="MUIVAfCFBJ">
                            <label for="MUIVAfCFBJ">Node</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="oQweMvlDVq">
                            <label for="oQweMvlDVq">D3</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="vPKWGUISqD">
                            <label for="vPKWGUISqD">Mocha</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="MTLmCFcxzM">
                            <label for="MTLmCFcxzM">P5js</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="MBwmSiZkBF">
                            <label for="MBwmSiZkBF">Typescript</label>
                            <ul>
                                <l>
                                    <input type="checkbox" id="xVsZlndXDX">
                                    <label for="xVsZlndXDX">Testing</label>
                                    <ul>
                ...
                <l>
                    <input type="checkbox" id="SUpiXGAkzg">
                    <label for="SUpiXGAkzg">Kafka</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="wmecvvjaZz">
                    <label for="wmecvvjaZz">Kubernetes</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="clnGEuZDBo">
                    <label for="clnGEuZDBo">Language</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="HKODeBWVhp">
                    <label for="HKODeBWVhp">Linux</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="zzYMXivwXd">
                            <label for="zzYMXivwXd">Bash</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="RTdRmFMaAK">
                    <label for="RTdRmFMaAK">Oauth</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="QXNbIhEfBS">
                    <label for="QXNbIhEfBS">Python</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="lmhPVSxFdw">
                            <label for="lmhPVSxFdw">Data Classes</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="TdDqgWgcpu">
                            <label for="TdDqgWgcpu">Libraries</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="QVzXEqcBmJ">
                    <label for="QVzXEqcBmJ">React</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="BiIGvYSlvs">
                    <label for="BiIGvYSlvs">Regular Expressions</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="rabKiiypCu">
                    <label for="rabKiiypCu">Rust</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="PzvCujHoPp">
                            <label for="PzvCujHoPp">Serde</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="ghXKHpKBjd">
                    <label for="ghXKHpKBjd">Vim</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="AAuJsoxzki">
                    <label for="AAuJsoxzki">Web</label>
                    <ul>
