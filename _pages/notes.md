...
<ul>
    <div name="contents-index">
        ...
        <l>
            <input type="checkbox" id="pcxGRhnCaT" checked>
            <label for="pcxGRhnCaT">Math</label>
            <ul>
                <l>
                    <input type="checkbox" id="nbjPFrcUWC">
                    <label for="nbjPFrcUWC">Exponentials</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="FdoxDKwVPH">
                    <label for="FdoxDKwVPH">Linear Algebra</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="YpSZVlrAiQ">
                    <label for="YpSZVlrAiQ">Logarithms</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="MYKGzovWHm">
                    <label for="MYKGzovWHm">Sequences</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="PAgDMdJbqG">
                    <label for="PAgDMdJbqG">Single Variable Calculus</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="ubsxIfLRii">
                    <label for="ubsxIfLRii">Trigonometry</label>
                    <ul>
        ...
        <l>
            <input type="checkbox" id="EOvrDIXpqw" checked>
            <label for="EOvrDIXpqw">Programming</label>
            <ul>
                <l>
                    <input type="checkbox" id="mTPWzRsNjh">
                    <label for="mTPWzRsNjh">Ansible</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="TedVBOqwOJ">
                    <label for="TedVBOqwOJ">Architecture</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="rLXURCbsob">
                    <label for="rLXURCbsob">Computer Graphics</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="tBNlzbxnXS">
                    <label for="tBNlzbxnXS">Databases</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="DuReEGWbfD">
                    <label for="DuReEGWbfD">Devops</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="gAmzyhVAZG">
                            <label for="gAmzyhVAZG">Cloud Computing</label>
                            <ul>
                                <l>
                                    <input type="checkbox" id="NMoUJtXQnL">
                                    <label for="NMoUJtXQnL">AWS</label>
                                    <ul>
                                        <l>
                                            <input type="checkbox" id="UJoirUmPlW">
                                            <label for="UJoirUmPlW">Cli</label>
                                            <ul>
                                        ...
                                        <l>
                                            <input type="checkbox" id="JSGIHWmuVm">
                                            <label for="JSGIHWmuVm">Dotnet</label>
                                            <ul>
                                        ...
                                        <l>
                                            <input type="checkbox" id="MCLkcNrbtG">
                                            <label for="MCLkcNrbtG">Ec 2</label>
                                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="DFRnnTGZcg">
                            <label for="DFRnnTGZcg">Events</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="fMGIBqOSsQ">
                            <label for="fMGIBqOSsQ">Localstack</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="hUVIEXBKTq">
                            <label for="hUVIEXBKTq">Oauth</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="YFFISDMydk">
                            <label for="YFFISDMydk">Pulumi</label>
                            <ul>
                                <l>
                                    <input type="checkbox" id="JdubXjuSgq">
                                    <label for="JdubXjuSgq">Dotnet</label>
                                    <ul>
                        ...
                        <l>
                            <input type="checkbox" id="EUbRCiZCPl">
                            <label for="EUbRCiZCPl">Terraform</label>
                            <ul>
                                <l>
                                    <input type="checkbox" id="amrFSdhtdU">
                                    <label for="amrFSdhtdU">Functions</label>
                                    <ul>
                                ...
                                <l>
                                    <input type="checkbox" id="HxEzVkEStA">
                                    <label for="HxEzVkEStA">Meta Arguments</label>
                                    <ul>
                ...
                <l>
                    <input type="checkbox" id="AqPTayLife">
                    <label for="AqPTayLife">Docker</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="JpmNbIvqWq">
                    <label for="JpmNbIvqWq">Dotnet</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="URRiKbSfPL">
                            <label for="URRiKbSfPL">Cli</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="FIDcgEiZiM">
                    <label for="FIDcgEiZiM">Functional Programming</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="zKgYzsKxkN">
                    <label for="zKgYzsKxkN">Git</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="zbubnlzQIG">
                            <label for="zbubnlzQIG">Github</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="NBdieJRgDt">
                    <label for="NBdieJRgDt">Go</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="zZZECeOQAs">
                    <label for="zZZECeOQAs">Haskell</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="fAfrrmYNPN">
                    <label for="fAfrrmYNPN">Js</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="KjYarrVceL">
                            <label for="KjYarrVceL">Node</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="JLKHanbmgL">
                            <label for="JLKHanbmgL">D3</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="HEMOfbXaRz">
                            <label for="HEMOfbXaRz">Mocha</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="zzOGmLzgxn">
                            <label for="zzOGmLzgxn">P5js</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="oycjlFwWln">
                            <label for="oycjlFwWln">Typescript</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="XJzDdxsuAW">
                    <label for="XJzDdxsuAW">Kafka</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="OmdDmnvEfq">
                    <label for="OmdDmnvEfq">Kubernetes</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="tSkyVeyxoy">
                    <label for="tSkyVeyxoy">Language</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="RVrimRLmES">
                    <label for="RVrimRLmES">Linux</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="kUSVhvbPFw">
                    <label for="kUSVhvbPFw">Python</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="djGLDKqhBp">
                            <label for="djGLDKqhBp">Data Classes</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="yEPkViTCOM">
                            <label for="yEPkViTCOM">Libraries</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="RqRmirXVeu">
                    <label for="RqRmirXVeu">React</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="BJDRzjShGA">
                    <label for="BJDRzjShGA">Regular Expressions</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="PDKOynKxZq">
                    <label for="PDKOynKxZq">Rust</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="xNzKglrcLV">
                            <label for="xNzKglrcLV">Serde</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="dFspGchNWn">
                    <label for="dFspGchNWn">Vim</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="eSAVbijwoN">
                    <label for="eSAVbijwoN">Web</label>
                    <ul>
