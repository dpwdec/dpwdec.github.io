...
<ul>
    <div name="contents-index">
        ...
        <l>
            <input type="checkbox" id="WviGnIZGSn" checked>
            <label for="WviGnIZGSn">Math</label>
            <ul>
                <l>
                    <input type="checkbox" id="vMUjfeSGoc">
                    <label for="vMUjfeSGoc">Exponentials</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="NEKmRiZLlx">
                    <label for="NEKmRiZLlx">Linear Algebra</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="yNgKIDZweF">
                    <label for="yNgKIDZweF">Logarithms</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="JhcUuEOwvu">
                    <label for="JhcUuEOwvu">Sequences</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="xxKJUBwcOy">
                    <label for="xxKJUBwcOy">Single Variable Calculus</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="roWnFLOCAt">
                    <label for="roWnFLOCAt">Trigonometry</label>
                    <ul>
        ...
        <l>
            <input type="checkbox" id="XfHoiBTwDx" checked>
            <label for="XfHoiBTwDx">Programming</label>
            <ul>
                <l>
                    <input type="checkbox" id="DkunkocXYI">
                    <label for="DkunkocXYI">Ansible</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="zJpmWePXdH">
                    <label for="zJpmWePXdH">Architecture</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="ltTlHnYldi">
                    <label for="ltTlHnYldi">Computer Graphics</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="PazoJibQnD">
                    <label for="PazoJibQnD">Databases</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="LLhwWtBdzE">
                    <label for="LLhwWtBdzE">Devops</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="XIbBbsmCfk">
                            <label for="XIbBbsmCfk">Cloud Computing</label>
                            <ul>
                                <l>
                                    <input type="checkbox" id="GQGBLayjKE">
                                    <label for="GQGBLayjKE">AWS</label>
                                    <ul>
                                        <l>
                                            <input type="checkbox" id="OXKpSmhSCO">
                                            <label for="OXKpSmhSCO">Cli</label>
                                            <ul>
                                        ...
                                        <l>
                                            <input type="checkbox" id="sHONrMNJwb">
                                            <label for="sHONrMNJwb">Dotnet</label>
                                            <ul>
                                        ...
                                        <l>
                                            <input type="checkbox" id="rHqTVcgeup">
                                            <label for="rHqTVcgeup">Ec 2</label>
                                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="cceFvAQYpx">
                            <label for="cceFvAQYpx">Events</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="XqyxjxdOpX">
                            <label for="XqyxjxdOpX">Oauth</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="gAFNwVNxGd">
                            <label for="gAFNwVNxGd">Pulumi</label>
                            <ul>
                                <l>
                                    <input type="checkbox" id="vPEYIblQew">
                                    <label for="vPEYIblQew">Dotnet</label>
                                    <ul>
                        ...
                        <l>
                            <input type="checkbox" id="koNXQBvGHd">
                            <label for="koNXQBvGHd">Terraform</label>
                            <ul>
                                <l>
                                    <input type="checkbox" id="vuqUEIiQaU">
                                    <label for="vuqUEIiQaU">Functions</label>
                                    <ul>
                                ...
                                <l>
                                    <input type="checkbox" id="GwVqulROWD">
                                    <label for="GwVqulROWD">Meta Arguments</label>
                                    <ul>
                ...
                <l>
                    <input type="checkbox" id="MdIXVnUxme">
                    <label for="MdIXVnUxme">Docker</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="inTCPXgefK">
                    <label for="inTCPXgefK">Dotnet</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="nAKnfyXSgS">
                            <label for="nAKnfyXSgS">Cli</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="HPODIudBUM">
                    <label for="HPODIudBUM">Functional Programming</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="zkmaGvHOAk">
                    <label for="zkmaGvHOAk">Git</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="fCpWAypwar">
                            <label for="fCpWAypwar">Github</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="zNNMmoslkY">
                    <label for="zNNMmoslkY">Go</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="mnVHgSyPGs">
                    <label for="mnVHgSyPGs">Haskell</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="AxcGddtuxZ">
                    <label for="AxcGddtuxZ">Js</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="LIFQIljdCo">
                            <label for="LIFQIljdCo">Node</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="PXAXumrvdm">
                            <label for="PXAXumrvdm">Mocha</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="vqsQbPmEfc">
                            <label for="vqsQbPmEfc">P5js</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="EmTpWNpXTH">
                            <label for="EmTpWNpXTH">Typescript</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="AojDnupdHB">
                    <label for="AojDnupdHB">Kafka</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="eObYzebmOj">
                    <label for="eObYzebmOj">Kubernetes</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="pBRScbBZQp">
                    <label for="pBRScbBZQp">Language</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="SwdQUBeEth">
                    <label for="SwdQUBeEth">Linux</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="cYohwzzyZS">
                    <label for="cYohwzzyZS">Python</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="kOjHuPtHNh">
                            <label for="kOjHuPtHNh">Data Classes</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="amZMrlLJTO">
                            <label for="amZMrlLJTO">Libraries</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="GNKMrgHsGy">
                    <label for="GNKMrgHsGy">React</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="nczJqcmhez">
                    <label for="nczJqcmhez">Regular Expressions</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="mxZNGLyRnP">
                    <label for="mxZNGLyRnP">Rust</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="hABSEZcKam">
                            <label for="hABSEZcKam">Serde</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="uiFmqeEzXk">
                    <label for="uiFmqeEzXk">Vim</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="vuERFajOoo">
                    <label for="vuERFajOoo">Web</label>
                    <ul>
