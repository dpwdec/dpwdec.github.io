...
<ul>
    <div name="contents-index">
        ...
        <l>
            <input type="checkbox" id="aBrveIzDhB" checked>
            <label for="aBrveIzDhB">Math</label>
            <ul>
                <l>
                    <input type="checkbox" id="hcnMCQsgSf">
                    <label for="hcnMCQsgSf">Exponentials</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="FLjnIHMclc">
                    <label for="FLjnIHMclc">Linear Algebra</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="yqoGLNpAnD">
                    <label for="yqoGLNpAnD">Logarithms</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="naWaOpZTmC">
                    <label for="naWaOpZTmC">Sequences</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="vNPkcFfBJs">
                    <label for="vNPkcFfBJs">Single Variable Calculus</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="FCDUABiznY">
                    <label for="FCDUABiznY">Trigonometry</label>
                    <ul>
        ...
        <l>
            <input type="checkbox" id="iRjHyEgnQv" checked>
            <label for="iRjHyEgnQv">Programming</label>
            <ul>
                <l>
                    <input type="checkbox" id="nzKbsLTLPC">
                    <label for="nzKbsLTLPC">Ansible</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="njAufGvAEc">
                    <label for="njAufGvAEc">Architecture</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="vZkhbteJBz">
                    <label for="vZkhbteJBz">Computer Graphics</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="JZbrRdIQLE">
                    <label for="JZbrRdIQLE">Databases</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="rGTJfrkAGN">
                    <label for="rGTJfrkAGN">Devops</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="EyCxuZiIaq">
                            <label for="EyCxuZiIaq">Cloud Providers</label>
                            <ul>
                                <l>
                                    <input type="checkbox" id="JmvKhjMoEF">
                                    <label for="JmvKhjMoEF">AWS</label>
                                    <ul>
                                        <l>
                                            <input type="checkbox" id="zNeGFgMWrs">
                                            <label for="zNeGFgMWrs">Cli</label>
                                            <ul>
                                        ...
                                        <l>
                                            <input type="checkbox" id="MIyfKUAKWp">
                                            <label for="MIyfKUAKWp">Dotnet</label>
                                            <ul>
                                        ...
                                        <l>
                                            <input type="checkbox" id="CrmQwsHDJg">
                                            <label for="CrmQwsHDJg">Ec 2</label>
                                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="nODVCQuKvl">
                            <label for="nODVCQuKvl">Events</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="leKWZgEesf">
                            <label for="leKWZgEesf">Localstack</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="vrfIjkcCWj">
                            <label for="vrfIjkcCWj">Pulumi</label>
                            <ul>
                                <l>
                                    <input type="checkbox" id="vnbWMcAvqW">
                                    <label for="vnbWMcAvqW">Dotnet</label>
                                    <ul>
                        ...
                        <l>
                            <input type="checkbox" id="gCrHwdFAHr">
                            <label for="gCrHwdFAHr">Serverless Framework</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="QhGRLZKSTN">
                            <label for="QhGRLZKSTN">Terraform</label>
                            <ul>
                                <l>
                                    <input type="checkbox" id="feEvTAmBKi">
                                    <label for="feEvTAmBKi">Functions</label>
                                    <ul>
                                ...
                                <l>
                                    <input type="checkbox" id="CERNKyDgGk">
                                    <label for="CERNKyDgGk">Meta Arguments</label>
                                    <ul>
                ...
                <l>
                    <input type="checkbox" id="sGGMKWWKFL">
                    <label for="sGGMKWWKFL">Docker</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="RcMSsPhiSM">
                    <label for="RcMSsPhiSM">Dotnet</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="LRTYtKIFbN">
                            <label for="LRTYtKIFbN">Cli</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="nxspnmLYXy">
                    <label for="nxspnmLYXy">Functional Programming</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="oTlLFSFNVB">
                    <label for="oTlLFSFNVB">Git</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="jjkmmMEDTr">
                            <label for="jjkmmMEDTr">Github</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="DmdkxUBkzz">
                    <label for="DmdkxUBkzz">Go</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="enFujemmnT">
                    <label for="enFujemmnT">Haskell</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="FAjPUFfiQO">
                    <label for="FAjPUFfiQO">Js</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="PxUnSZPDfv">
                            <label for="PxUnSZPDfv">Node</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="WTKsPgqqpT">
                            <label for="WTKsPgqqpT">D3</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="dlSMHEeRMJ">
                            <label for="dlSMHEeRMJ">Mocha</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="yvGnIHuzEV">
                            <label for="yvGnIHuzEV">P5js</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="cdfIgoFePy">
                            <label for="cdfIgoFePy">Typescript</label>
                            <ul>
                                <l>
                                    <input type="checkbox" id="xfVdfUWHQu">
                                    <label for="xfVdfUWHQu">Testing</label>
                                    <ul>
                ...
                <l>
                    <input type="checkbox" id="gxQzUjEiOF">
                    <label for="gxQzUjEiOF">Kafka</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="zbELKklFLa">
                    <label for="zbELKklFLa">Kubernetes</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="IdatJjMaqw">
                    <label for="IdatJjMaqw">Language</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="XhVsZZMLdH">
                    <label for="XhVsZZMLdH">Linux</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="gwJeHMWErr">
                            <label for="gwJeHMWErr">Bash</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="dySqUkNjug">
                    <label for="dySqUkNjug">Oauth</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="lXkjiaJQpD">
                    <label for="lXkjiaJQpD">Python</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="oPjgNfLmpx">
                            <label for="oPjgNfLmpx">Data Classes</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="tcnJVDjDfc">
                            <label for="tcnJVDjDfc">Libraries</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="YsyNRqbrHs">
                    <label for="YsyNRqbrHs">React</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="VJUbdAxIfV">
                    <label for="VJUbdAxIfV">Regular Expressions</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="MTCyNfyrcn">
                    <label for="MTCyNfyrcn">Rust</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="hZjLirEAIj">
                            <label for="hZjLirEAIj">Serde</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="iRxVTCWtog">
                    <label for="iRxVTCWtog">Vim</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="TILuPCeETL">
                    <label for="TILuPCeETL">Web</label>
                    <ul>
