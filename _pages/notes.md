...
<ul>
    <div name="contents-index">
        ...
        <l>
            <input type="checkbox" id="WMzqIfqZVd" checked>
            <label for="WMzqIfqZVd">Math</label>
            <ul>
                <l>
                    <input type="checkbox" id="CqCFrNTJHO">
                    <label for="CqCFrNTJHO">Exponentials</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="uGArHqLEdr">
                    <label for="uGArHqLEdr">Linear Algebra</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="BZNYhLlCta">
                    <label for="BZNYhLlCta">Logarithms</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="HrgeagfvYa">
                    <label for="HrgeagfvYa">Sequences</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="fXWXeJbcrJ">
                    <label for="fXWXeJbcrJ">Single Variable Calculus</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="TdjomiKvkB">
                    <label for="TdjomiKvkB">Trigonometry</label>
                    <ul>
        ...
        <l>
            <input type="checkbox" id="TsxWXjQmzk" checked>
            <label for="TsxWXjQmzk">Programming</label>
            <ul>
                <l>
                    <input type="checkbox" id="HPRnarFNbe">
                    <label for="HPRnarFNbe">Ansible</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="fXgQYwgWTw">
                    <label for="fXgQYwgWTw">Architecture</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="SsvsnAbwhs">
                    <label for="SsvsnAbwhs">Computer Graphics</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="bsWbkRVfZF">
                    <label for="bsWbkRVfZF">Databases</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="RkwqbGSLWa">
                    <label for="RkwqbGSLWa">Devops</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="kTJyyUbOiq">
                            <label for="kTJyyUbOiq">Cloud Computing</label>
                            <ul>
                                <l>
                                    <input type="checkbox" id="bKHiqUWcAX">
                                    <label for="bKHiqUWcAX">AWS</label>
                                    <ul>
                                        <l>
                                            <input type="checkbox" id="AqXtazXynR">
                                            <label for="AqXtazXynR">Cli</label>
                                            <ul>
                                        ...
                                        <l>
                                            <input type="checkbox" id="kOYyfVKYBx">
                                            <label for="kOYyfVKYBx">Dotnet</label>
                                            <ul>
                                        ...
                                        <l>
                                            <input type="checkbox" id="OVsBhMXmgm">
                                            <label for="OVsBhMXmgm">Ec 2</label>
                                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="JHsWiLIjey">
                            <label for="JHsWiLIjey">Events</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="YLfQpiuIBM">
                            <label for="YLfQpiuIBM">Localstack</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="kQPUBnDeSV">
                            <label for="kQPUBnDeSV">Oauth</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="oBoltxknDr">
                            <label for="oBoltxknDr">Pulumi</label>
                            <ul>
                                <l>
                                    <input type="checkbox" id="lAqOmUIJNz">
                                    <label for="lAqOmUIJNz">Dotnet</label>
                                    <ul>
                        ...
                        <l>
                            <input type="checkbox" id="jyeZWzZHUG">
                            <label for="jyeZWzZHUG">Terraform</label>
                            <ul>
                                <l>
                                    <input type="checkbox" id="FwZnIsFABv">
                                    <label for="FwZnIsFABv">Functions</label>
                                    <ul>
                                ...
                                <l>
                                    <input type="checkbox" id="bhGGesHXLh">
                                    <label for="bhGGesHXLh">Meta Arguments</label>
                                    <ul>
                ...
                <l>
                    <input type="checkbox" id="ivfnwJbAnG">
                    <label for="ivfnwJbAnG">Docker</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="rclaxfuPuP">
                    <label for="rclaxfuPuP">Dotnet</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="fEOfjeCVHT">
                            <label for="fEOfjeCVHT">Cli</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="qXsAwLSdZo">
                    <label for="qXsAwLSdZo">Functional Programming</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="BVRiRQBeEe">
                    <label for="BVRiRQBeEe">Git</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="NacbVACWJf">
                            <label for="NacbVACWJf">Github</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="yTOvWltcfW">
                    <label for="yTOvWltcfW">Go</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="quMVSOGUAM">
                    <label for="quMVSOGUAM">Haskell</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="jrOcVTxmwP">
                    <label for="jrOcVTxmwP">Js</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="hCnHEMwAQQ">
                            <label for="hCnHEMwAQQ">Node</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="ssHZBsuUoQ">
                            <label for="ssHZBsuUoQ">D3</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="NaaUEbwkUU">
                            <label for="NaaUEbwkUU">Mocha</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="vToJkxgvoc">
                            <label for="vToJkxgvoc">P5js</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="KGXnfAFMot">
                            <label for="KGXnfAFMot">Typescript</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="FgaDDEACLu">
                    <label for="FgaDDEACLu">Kafka</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="OEJbhjhVez">
                    <label for="OEJbhjhVez">Kubernetes</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="NkvlWCUZHF">
                    <label for="NkvlWCUZHF">Language</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="NaMSDnHNix">
                    <label for="NaMSDnHNix">Linux</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="WwOCDRFCtC">
                            <label for="WwOCDRFCtC">Bash</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="eptfcHHxmu">
                    <label for="eptfcHHxmu">Python</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="vHSDazPUdF">
                            <label for="vHSDazPUdF">Data Classes</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="OyzhCiYeIs">
                            <label for="OyzhCiYeIs">Libraries</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="UzFnWWaCBT">
                    <label for="UzFnWWaCBT">React</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="JwYqcXmtYq">
                    <label for="JwYqcXmtYq">Regular Expressions</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="IINbaPLMEW">
                    <label for="IINbaPLMEW">Rust</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="XBYhPuBBTr">
                            <label for="XBYhPuBBTr">Serde</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="WPDmdPAdod">
                    <label for="WPDmdPAdod">Vim</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="FLmvvFaBJk">
                    <label for="FLmvvFaBJk">Web</label>
                    <ul>
