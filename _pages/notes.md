...
<ul>
    <div name="contents-index">
        ...
        <l>
            <input type="checkbox" id="WUlItQgkln" checked>
            <label for="WUlItQgkln">Math</label>
            <ul>
                <l>
                    <input type="checkbox" id="DsHfoOYebA">
                    <label for="DsHfoOYebA">Exponentials</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="XGQAAvZngz">
                    <label for="XGQAAvZngz">Linear Algebra</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="vAsXZreWkz">
                    <label for="vAsXZreWkz">Logarithms</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="wKqLYDfmdX">
                    <label for="wKqLYDfmdX">Sequences</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="xNlnvOwCQl">
                    <label for="xNlnvOwCQl">Single Variable Calculus</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="OYXoJLcNBq">
                    <label for="OYXoJLcNBq">Trigonometry</label>
                    <ul>
        ...
        <l>
            <input type="checkbox" id="dJIilmWxHU" checked>
            <label for="dJIilmWxHU">Programming</label>
            <ul>
                <l>
                    <input type="checkbox" id="nqJprsZCDr">
                    <label for="nqJprsZCDr">Ansible</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="RvoEcBpXHq">
                    <label for="RvoEcBpXHq">Architecture</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="NTbCkMGAOX">
                    <label for="NTbCkMGAOX">Computer Graphics</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="rgNZGqpfYJ">
                    <label for="rgNZGqpfYJ">Databases</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="LOCDcJwyJS">
                    <label for="LOCDcJwyJS">Devops</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="NeDoFnnYOa">
                            <label for="NeDoFnnYOa">Cloud Providers</label>
                            <ul>
                                <l>
                                    <input type="checkbox" id="vIWKaoCvDw">
                                    <label for="vIWKaoCvDw">AWS</label>
                                    <ul>
                                        <l>
                                            <input type="checkbox" id="SwZEuGDTPg">
                                            <label for="SwZEuGDTPg">Cli</label>
                                            <ul>
                                        ...
                                        <l>
                                            <input type="checkbox" id="iFHZmeKxxL">
                                            <label for="iFHZmeKxxL">Dotnet</label>
                                            <ul>
                                        ...
                                        <l>
                                            <input type="checkbox" id="npsTGsvsAa">
                                            <label for="npsTGsvsAa">Ec 2</label>
                                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="jIcZVveOnc">
                            <label for="jIcZVveOnc">Events</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="IbANocCSEW">
                            <label for="IbANocCSEW">Localstack</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="dhZAERFEZc">
                            <label for="dhZAERFEZc">Pulumi</label>
                            <ul>
                                <l>
                                    <input type="checkbox" id="XPdQOMGqiE">
                                    <label for="XPdQOMGqiE">Dotnet</label>
                                    <ul>
                        ...
                        <l>
                            <input type="checkbox" id="HUzEZTZlfU">
                            <label for="HUzEZTZlfU">Serverless Framework</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="AtfLkMXYwm">
                            <label for="AtfLkMXYwm">Terraform</label>
                            <ul>
                                <l>
                                    <input type="checkbox" id="JYJzDWbJbN">
                                    <label for="JYJzDWbJbN">Functions</label>
                                    <ul>
                                ...
                                <l>
                                    <input type="checkbox" id="gAisJCwoQy">
                                    <label for="gAisJCwoQy">Meta Arguments</label>
                                    <ul>
                ...
                <l>
                    <input type="checkbox" id="vtbjmGxUpX">
                    <label for="vtbjmGxUpX">Docker</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="UTmDyknvgT">
                    <label for="UTmDyknvgT">Dotnet</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="UAwWcPiaaM">
                            <label for="UAwWcPiaaM">Cli</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="SWGLnRTlyw">
                    <label for="SWGLnRTlyw">Functional Programming</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="BDgixtwTKH">
                    <label for="BDgixtwTKH">Git</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="rGbZRhJnFS">
                            <label for="rGbZRhJnFS">Github</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="qZjqbOoOFL">
                    <label for="qZjqbOoOFL">Go</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="qEdDmOKArL">
                    <label for="qEdDmOKArL">Haskell</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="LprTmDglGF">
                    <label for="LprTmDglGF">Js</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="FnXwVVSwhJ">
                            <label for="FnXwVVSwhJ">Node</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="JlbduDHMJo">
                            <label for="JlbduDHMJo">D3</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="TUJEullUPu">
                            <label for="TUJEullUPu">Mocha</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="azUNQfhUmv">
                            <label for="azUNQfhUmv">P5js</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="ziWRKgYvJm">
                            <label for="ziWRKgYvJm">Typescript</label>
                            <ul>
                                <l>
                                    <input type="checkbox" id="CPRpVyKxIg">
                                    <label for="CPRpVyKxIg">Testing</label>
                                    <ul>
                ...
                <l>
                    <input type="checkbox" id="ZtrjxbNGTU">
                    <label for="ZtrjxbNGTU">Kafka</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="chlqmNpLoj">
                    <label for="chlqmNpLoj">Kubernetes</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="dyAfmqubBP">
                    <label for="dyAfmqubBP">Language</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="IrPWWIbzXi">
                    <label for="IrPWWIbzXi">Linux</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="UmTQlUjzah">
                            <label for="UmTQlUjzah">Bash</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="xHKcMtwpYa">
                    <label for="xHKcMtwpYa">Oauth</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="FDbQIPXQhN">
                    <label for="FDbQIPXQhN">Prometheus</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="ZGNhsCgkxm">
                    <label for="ZGNhsCgkxm">Python</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="EYjeGpGnBp">
                            <label for="EYjeGpGnBp">Data Classes</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="NumaNuMXVH">
                            <label for="NumaNuMXVH">Libraries</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="XeyAfkuaGI">
                    <label for="XeyAfkuaGI">React</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="BQhebggulV">
                    <label for="BQhebggulV">Regular Expressions</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="dfhlRYztXu">
                    <label for="dfhlRYztXu">Rust</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="FIEfEKDcUX">
                            <label for="FIEfEKDcUX">Serde</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="tDmnmTYCAG">
                    <label for="tDmnmTYCAG">Shaders</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="RmSYYWUmzn">
                            <label for="RmSYYWUmzn">Glsl</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="StqnsRndKo">
                    <label for="StqnsRndKo">Vim</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="ypmztGoqSu">
                    <label for="ypmztGoqSu">Web</label>
                    <ul>
