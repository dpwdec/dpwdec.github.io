...
<ul>
    <div name="contents-index">
        ...
        <l>
            <input type="checkbox" id="bPrSUPcPwT" checked>
            <label for="bPrSUPcPwT">Math</label>
            <ul>
                <l>
                    <input type="checkbox" id="KAkOsIktIl">
                    <label for="KAkOsIktIl">Exponentials</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="CCQorlTglP">
                    <label for="CCQorlTglP">Linear Algebra</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="GcfsIzzxQs">
                    <label for="GcfsIzzxQs">Logarithms</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="ZppGSYvlEe">
                    <label for="ZppGSYvlEe">Sequences</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="NmeuSWumEF">
                    <label for="NmeuSWumEF">Single Variable Calculus</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="bMSWfXlMdd">
                    <label for="bMSWfXlMdd">Trigonometry</label>
                    <ul>
        ...
        <l>
            <input type="checkbox" id="ttAQFdQxyo" checked>
            <label for="ttAQFdQxyo">Programming</label>
            <ul>
                <l>
                    <input type="checkbox" id="IFEpsNycvo">
                    <label for="IFEpsNycvo">Ansible</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="WEXeCRWiFg">
                    <label for="WEXeCRWiFg">Architecture</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="fIeAuhApxZ">
                    <label for="fIeAuhApxZ">Computer Graphics</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="cKqrpxGtSU">
                    <label for="cKqrpxGtSU">Databases</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="XBLkcZLRce">
                    <label for="XBLkcZLRce">Devops</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="cwiElDcnLK">
                            <label for="cwiElDcnLK">Cloud Providers</label>
                            <ul>
                                <l>
                                    <input type="checkbox" id="ymoVhverhk">
                                    <label for="ymoVhverhk">AWS</label>
                                    <ul>
                                        <l>
                                            <input type="checkbox" id="MqvEQCvzcY">
                                            <label for="MqvEQCvzcY">Cli</label>
                                            <ul>
                                        ...
                                        <l>
                                            <input type="checkbox" id="YySOSRRCdN">
                                            <label for="YySOSRRCdN">Dotnet</label>
                                            <ul>
                                        ...
                                        <l>
                                            <input type="checkbox" id="LzHUSsvHHt">
                                            <label for="LzHUSsvHHt">Ec 2</label>
                                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="bsCzFnJsJF">
                            <label for="bsCzFnJsJF">Events</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="TuHpmEdIcZ">
                            <label for="TuHpmEdIcZ">Localstack</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="lZugFUwWma">
                            <label for="lZugFUwWma">Pulumi</label>
                            <ul>
                                <l>
                                    <input type="checkbox" id="EBubHVxznb">
                                    <label for="EBubHVxznb">Dotnet</label>
                                    <ul>
                        ...
                        <l>
                            <input type="checkbox" id="QEuAVsGWeJ">
                            <label for="QEuAVsGWeJ">Serverless Framework</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="KPgjsaNhaN">
                            <label for="KPgjsaNhaN">Terraform</label>
                            <ul>
                                <l>
                                    <input type="checkbox" id="AylYvifAkC">
                                    <label for="AylYvifAkC">Functions</label>
                                    <ul>
                                ...
                                <l>
                                    <input type="checkbox" id="DQYOmJkDwQ">
                                    <label for="DQYOmJkDwQ">Meta Arguments</label>
                                    <ul>
                ...
                <l>
                    <input type="checkbox" id="phTFTZCxDv">
                    <label for="phTFTZCxDv">Docker</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="JdMRTyLMyD">
                    <label for="JdMRTyLMyD">Dotnet</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="cUMOQJfgij">
                            <label for="cUMOQJfgij">Cli</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="OJmlaBAHUq">
                    <label for="OJmlaBAHUq">Functional Programming</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="LEsUBfAVKe">
                    <label for="LEsUBfAVKe">Git</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="TpTEJBSzIr">
                            <label for="TpTEJBSzIr">Github</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="NzdlkAjjCN">
                    <label for="NzdlkAjjCN">Go</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="ZJMVzlATDq">
                    <label for="ZJMVzlATDq">Haskell</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="TEHZAnqdtK">
                    <label for="TEHZAnqdtK">Js</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="sKusuOCYGE">
                            <label for="sKusuOCYGE">Node</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="bqTBDwneIp">
                            <label for="bqTBDwneIp">D3</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="hNmFKFEKpQ">
                            <label for="hNmFKFEKpQ">Mocha</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="CZPMfqdHly">
                            <label for="CZPMfqdHly">P5js</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="BxVfxtziPQ">
                            <label for="BxVfxtziPQ">Typescript</label>
                            <ul>
                                <l>
                                    <input type="checkbox" id="NbYuMkpqvL">
                                    <label for="NbYuMkpqvL">Testing</label>
                                    <ul>
                ...
                <l>
                    <input type="checkbox" id="pztFNctIaq">
                    <label for="pztFNctIaq">Kafka</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="rvvGWvHGFB">
                    <label for="rvvGWvHGFB">Kubernetes</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="nmcoTOpRSn">
                    <label for="nmcoTOpRSn">Language</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="HynRuGbzVH">
                    <label for="HynRuGbzVH">Linux</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="ZxmdmNFuzd">
                            <label for="ZxmdmNFuzd">Bash</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="UtKAJZWgET">
                    <label for="UtKAJZWgET">Oauth</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="QnQcdiuJGC">
                    <label for="QnQcdiuJGC">Prometheus</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="evvMotSMRV">
                    <label for="evvMotSMRV">Python</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="uiBlpbpAHY">
                            <label for="uiBlpbpAHY">Data Classes</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="HqQmCwOfsj">
                            <label for="HqQmCwOfsj">Libraries</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="XhcijHMKVo">
                    <label for="XhcijHMKVo">React</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="pZndKLjJiF">
                    <label for="pZndKLjJiF">Regular Expressions</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="PrpQRmKrIv">
                    <label for="PrpQRmKrIv">Rust</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="hAUfbFxdzG">
                            <label for="hAUfbFxdzG">Serde</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="VvKPOAsYCX">
                    <label for="VvKPOAsYCX">Shaders</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="otSYBMNbsT">
                            <label for="otSYBMNbsT">Glsl</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="MtaMtikjEC">
                    <label for="MtaMtikjEC">Vim</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="CgaRtzkwqV">
                    <label for="CgaRtzkwqV">Web</label>
                    <ul>
