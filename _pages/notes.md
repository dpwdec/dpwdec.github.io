...
<ul>
    <div name="contents-index">
        ...
        <l>
            <input type="checkbox" id="HWbYZPENnW" checked>
            <label for="HWbYZPENnW">Math</label>
            <ul>
                <l>
                    <input type="checkbox" id="makozIsWZC">
                    <label for="makozIsWZC">Exponentials</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="qzNolpjPbU">
                    <label for="qzNolpjPbU">Linear Algebra</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="atvgQuICHK">
                    <label for="atvgQuICHK">Logarithms</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="lUCmCUFAXk">
                    <label for="lUCmCUFAXk">Sequences</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="BGvsvDKkPW">
                    <label for="BGvsvDKkPW">Single Variable Calculus</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="QXQVUNgvzt">
                    <label for="QXQVUNgvzt">Trigonometry</label>
                    <ul>
        ...
        <l>
            <input type="checkbox" id="xjYaLwjijM" checked>
            <label for="xjYaLwjijM">Programming</label>
            <ul>
                <l>
                    <input type="checkbox" id="RYQoXzeVwH">
                    <label for="RYQoXzeVwH">Ansible</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="vZhlcdmEat">
                    <label for="vZhlcdmEat">Architecture</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="ZSHSKCkMdR">
                    <label for="ZSHSKCkMdR">Computer Graphics</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="kepnVimUUz">
                    <label for="kepnVimUUz">Databases</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="YssIVktPZk">
                    <label for="YssIVktPZk">Devops</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="HEyrehsQSI">
                            <label for="HEyrehsQSI">Cloud Providers</label>
                            <ul>
                                <l>
                                    <input type="checkbox" id="DeYvRXGywl">
                                    <label for="DeYvRXGywl">AWS</label>
                                    <ul>
                                        <l>
                                            <input type="checkbox" id="WSvnIlMTij">
                                            <label for="WSvnIlMTij">Cli</label>
                                            <ul>
                                        ...
                                        <l>
                                            <input type="checkbox" id="rhVTaNIFvc">
                                            <label for="rhVTaNIFvc">Dotnet</label>
                                            <ul>
                                        ...
                                        <l>
                                            <input type="checkbox" id="TUxrTnBYAm">
                                            <label for="TUxrTnBYAm">Ec 2</label>
                                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="ifUvNHXAqB">
                            <label for="ifUvNHXAqB">Events</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="ZsXJSORijs">
                            <label for="ZsXJSORijs">Localstack</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="GsMenaZPLo">
                            <label for="GsMenaZPLo">Pulumi</label>
                            <ul>
                                <l>
                                    <input type="checkbox" id="NcAfAdbMUS">
                                    <label for="NcAfAdbMUS">Dotnet</label>
                                    <ul>
                        ...
                        <l>
                            <input type="checkbox" id="hzlAsrHspL">
                            <label for="hzlAsrHspL">Serverless Framework</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="nJDxyDZGrZ">
                            <label for="nJDxyDZGrZ">Terraform</label>
                            <ul>
                                <l>
                                    <input type="checkbox" id="YHxxxBrNAm">
                                    <label for="YHxxxBrNAm">Functions</label>
                                    <ul>
                                ...
                                <l>
                                    <input type="checkbox" id="SEbsRqrlbI">
                                    <label for="SEbsRqrlbI">Meta Arguments</label>
                                    <ul>
                ...
                <l>
                    <input type="checkbox" id="pngFXfSHiD">
                    <label for="pngFXfSHiD">Docker</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="bTprTimkiV">
                    <label for="bTprTimkiV">Dotnet</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="UTLmNYCrLe">
                            <label for="UTLmNYCrLe">Cli</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="icwrsKEpqQ">
                    <label for="icwrsKEpqQ">Functional Programming</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="vWSuYFbbBb">
                    <label for="vWSuYFbbBb">Git</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="xXAafyPMbc">
                            <label for="xXAafyPMbc">Github</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="zBnMxlTTlj">
                    <label for="zBnMxlTTlj">Go</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="DkaOhFuOmA">
                    <label for="DkaOhFuOmA">Haskell</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="tleHlycbTs">
                    <label for="tleHlycbTs">Js</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="qDoFrhtqoQ">
                            <label for="qDoFrhtqoQ">Node</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="vTReJoDOuI">
                            <label for="vTReJoDOuI">D3</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="MYYYQCpPDS">
                            <label for="MYYYQCpPDS">Mocha</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="udfHEkDHlE">
                            <label for="udfHEkDHlE">P5js</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="FQyVwmPsCC">
                            <label for="FQyVwmPsCC">Typescript</label>
                            <ul>
                                <l>
                                    <input type="checkbox" id="gdFzGoccFw">
                                    <label for="gdFzGoccFw">Testing</label>
                                    <ul>
                ...
                <l>
                    <input type="checkbox" id="VAlYcPqARq">
                    <label for="VAlYcPqARq">Kafka</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="VFBSiOrLYa">
                    <label for="VFBSiOrLYa">Kubernetes</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="wYFPIObWlE">
                    <label for="wYFPIObWlE">Language</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="otjTllpRRM">
                    <label for="otjTllpRRM">Linux</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="sYRoLmMEQY">
                            <label for="sYRoLmMEQY">Bash</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="cqdhsnlexo">
                    <label for="cqdhsnlexo">Oauth</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="wlDGuCArOo">
                    <label for="wlDGuCArOo">Prometheus</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="tJqyRuVBjg">
                    <label for="tJqyRuVBjg">Python</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="JVsmXTGIbh">
                            <label for="JVsmXTGIbh">Data Classes</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="qxvbmvhgWs">
                            <label for="qxvbmvhgWs">Libraries</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="EyHEYcmCbO">
                    <label for="EyHEYcmCbO">React</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="yrHWhcPJUh">
                    <label for="yrHWhcPJUh">Regular Expressions</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="sEDSOaVdsf">
                    <label for="sEDSOaVdsf">Rust</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="yWjZpAvGOT">
                            <label for="yWjZpAvGOT">Serde</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="HezDkcBIsF">
                    <label for="HezDkcBIsF">Shaders</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="wlaxrfzbjK">
                            <label for="wlaxrfzbjK">Glsl</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="nwNhvLuycy">
                    <label for="nwNhvLuycy">Vim</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="aoIDTQHKnF">
                    <label for="aoIDTQHKnF">Web</label>
                    <ul>
