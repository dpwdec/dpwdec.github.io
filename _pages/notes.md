...
<ul>
    <div name="contents-index">
        ...
        <l>
            <input type="checkbox" id="ynRUAOJFgr" checked>
            <label for="ynRUAOJFgr">Math</label>
            <ul>
                <l>
                    <input type="checkbox" id="FIguUAoNLM">
                    <label for="FIguUAoNLM">Exponentials</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="EFofHEhmxT">
                    <label for="EFofHEhmxT">Linear Algebra</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="fJdkgMNQFg">
                    <label for="fJdkgMNQFg">Logarithms</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="ZYTYmVCFbE">
                    <label for="ZYTYmVCFbE">Sequences</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="QunMeftGwy">
                    <label for="QunMeftGwy">Single Variable Calculus</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="JAFnpESHZL">
                    <label for="JAFnpESHZL">Trigonometry</label>
                    <ul>
        ...
        <l>
            <input type="checkbox" id="VKBdKaYMOT" checked>
            <label for="VKBdKaYMOT">Programming</label>
            <ul>
                <l>
                    <input type="checkbox" id="OZgkqBJxlS">
                    <label for="OZgkqBJxlS">Ansible</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="TrEnIOeFlI">
                    <label for="TrEnIOeFlI">Architecture</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="VuzTJxZblT">
                    <label for="VuzTJxZblT">Computer Graphics</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="KSeFrCsoOX">
                    <label for="KSeFrCsoOX">Databases</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="fIJVxOMwFV">
                    <label for="fIJVxOMwFV">Devops</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="RQGdvVNQiu">
                            <label for="RQGdvVNQiu">Cloud Providers</label>
                            <ul>
                                <l>
                                    <input type="checkbox" id="FREfQZwzPL">
                                    <label for="FREfQZwzPL">AWS</label>
                                    <ul>
                                        <l>
                                            <input type="checkbox" id="IcZUytBzLR">
                                            <label for="IcZUytBzLR">Cli</label>
                                            <ul>
                                        ...
                                        <l>
                                            <input type="checkbox" id="zQqoHiFQPz">
                                            <label for="zQqoHiFQPz">Dotnet</label>
                                            <ul>
                                        ...
                                        <l>
                                            <input type="checkbox" id="gsfifIWLgS">
                                            <label for="gsfifIWLgS">Ec 2</label>
                                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="DmNGwyfaRv">
                            <label for="DmNGwyfaRv">Events</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="ZDYzdSgNgE">
                            <label for="ZDYzdSgNgE">Localstack</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="dkTMRDzIXs">
                            <label for="dkTMRDzIXs">Pulumi</label>
                            <ul>
                                <l>
                                    <input type="checkbox" id="GeYYOScsiD">
                                    <label for="GeYYOScsiD">Dotnet</label>
                                    <ul>
                        ...
                        <l>
                            <input type="checkbox" id="YrAlbUbkZP">
                            <label for="YrAlbUbkZP">Serverless Framework</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="yRuIQlVCLe">
                            <label for="yRuIQlVCLe">Terraform</label>
                            <ul>
                                <l>
                                    <input type="checkbox" id="oGfwcfMrXs">
                                    <label for="oGfwcfMrXs">Functions</label>
                                    <ul>
                                ...
                                <l>
                                    <input type="checkbox" id="HQYvtmBlML">
                                    <label for="HQYvtmBlML">Meta Arguments</label>
                                    <ul>
                ...
                <l>
                    <input type="checkbox" id="CyzkukmsJm">
                    <label for="CyzkukmsJm">Docker</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="KyhoqzXGaM">
                    <label for="KyhoqzXGaM">Dotnet</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="zQkHNRYzxV">
                            <label for="zQkHNRYzxV">Cli</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="VXkNPWVYJF">
                    <label for="VXkNPWVYJF">Functional Programming</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="kIHfDJKPCz">
                    <label for="kIHfDJKPCz">Git</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="wLiMqiuhJi">
                            <label for="wLiMqiuhJi">Github</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="oLwSpdbzdc">
                    <label for="oLwSpdbzdc">Go</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="HBekkwlDUT">
                    <label for="HBekkwlDUT">Haskell</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="nubapHSeKa">
                    <label for="nubapHSeKa">Js</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="MUoKgIomJA">
                            <label for="MUoKgIomJA">Node</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="SfWYxMfohz">
                            <label for="SfWYxMfohz">D3</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="yTyTcHtulX">
                            <label for="yTyTcHtulX">Mocha</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="sHwOdWmucp">
                            <label for="sHwOdWmucp">P5js</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="IkWFWWNpoG">
                            <label for="IkWFWWNpoG">Typescript</label>
                            <ul>
                                <l>
                                    <input type="checkbox" id="IUseROiRki">
                                    <label for="IUseROiRki">Testing</label>
                                    <ul>
                ...
                <l>
                    <input type="checkbox" id="VqBtGKwNpV">
                    <label for="VqBtGKwNpV">Kafka</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="CuaUqsttit">
                    <label for="CuaUqsttit">Kubernetes</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="QSLiQKjPGR">
                    <label for="QSLiQKjPGR">Language</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="nvIrpXWylA">
                    <label for="nvIrpXWylA">Linux</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="YHdukMvWjA">
                            <label for="YHdukMvWjA">Bash</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="pjUWxQLLyb">
                    <label for="pjUWxQLLyb">Oauth</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="aokOKIzFLJ">
                    <label for="aokOKIzFLJ">Prometheus</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="EQZTgaiKqy">
                    <label for="EQZTgaiKqy">Python</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="wiOTJyQfom">
                            <label for="wiOTJyQfom">Data Classes</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="yPbqlaGeFp">
                            <label for="yPbqlaGeFp">Libraries</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="SxWpOcsJTi">
                    <label for="SxWpOcsJTi">React</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="krrZkliyrM">
                    <label for="krrZkliyrM">Regular Expressions</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="oAJCNZoSZs">
                    <label for="oAJCNZoSZs">Rust</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="fleyrwmlGr">
                            <label for="fleyrwmlGr">Serde</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="uwvNpTKiXC">
                    <label for="uwvNpTKiXC">Shaders</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="OMfziPPnZV">
                            <label for="OMfziPPnZV">Glsl</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="nJfGXVhCsO">
                    <label for="nJfGXVhCsO">Vim</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="ufhjvEmiej">
                    <label for="ufhjvEmiej">Web</label>
                    <ul>
