...
<ul>
    <div name="contents-index">
        ...
        <l>
            <input type="checkbox" id="hoMuZVAkBG" checked>
            <label for="hoMuZVAkBG">Math</label>
            <ul>
                <l>
                    <input type="checkbox" id="gXRMmEayjg">
                    <label for="gXRMmEayjg">Exponentials</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="PfMsRAKcNg">
                    <label for="PfMsRAKcNg">Linear Algebra</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="iPqnNnqOUs">
                    <label for="iPqnNnqOUs">Logarithms</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="pMrDiKNtKo">
                    <label for="pMrDiKNtKo">Sequences</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="cInqiZvDeA">
                    <label for="cInqiZvDeA">Single Variable Calculus</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="tyftAxEDDb">
                    <label for="tyftAxEDDb">Trigonometry</label>
                    <ul>
        ...
        <l>
            <input type="checkbox" id="zuwiRPwMID" checked>
            <label for="zuwiRPwMID">Programming</label>
            <ul>
                <l>
                    <input type="checkbox" id="bfCGSvMGzl">
                    <label for="bfCGSvMGzl">Ansible</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="SDlSagqNCN">
                    <label for="SDlSagqNCN">Architecture</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="cxMdIGGZzG">
                    <label for="cxMdIGGZzG">Computer Graphics</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="pomVEhXZKX">
                    <label for="pomVEhXZKX">Databases</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="xGwZqQtxVS">
                    <label for="xGwZqQtxVS">Devops</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="YYDYVSYmpi">
                            <label for="YYDYVSYmpi">Cloud Providers</label>
                            <ul>
                                <l>
                                    <input type="checkbox" id="WYqTlSViql">
                                    <label for="WYqTlSViql">AWS</label>
                                    <ul>
                                        <l>
                                            <input type="checkbox" id="JzKXGfHbPH">
                                            <label for="JzKXGfHbPH">Cli</label>
                                            <ul>
                                        ...
                                        <l>
                                            <input type="checkbox" id="oZbTLNkHSj">
                                            <label for="oZbTLNkHSj">Dotnet</label>
                                            <ul>
                                        ...
                                        <l>
                                            <input type="checkbox" id="TWqvmeejoP">
                                            <label for="TWqvmeejoP">Ec 2</label>
                                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="iwfpfieeAm">
                            <label for="iwfpfieeAm">Events</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="sEIKbFYXVD">
                            <label for="sEIKbFYXVD">Localstack</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="sYgcMICGmR">
                            <label for="sYgcMICGmR">Pulumi</label>
                            <ul>
                                <l>
                                    <input type="checkbox" id="EvAWQAvncF">
                                    <label for="EvAWQAvncF">Dotnet</label>
                                    <ul>
                        ...
                        <l>
                            <input type="checkbox" id="pJWLmQjTwi">
                            <label for="pJWLmQjTwi">Serverless Framework</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="VxfPvdqtsE">
                            <label for="VxfPvdqtsE">Terraform</label>
                            <ul>
                                <l>
                                    <input type="checkbox" id="SFNfVsZTiz">
                                    <label for="SFNfVsZTiz">Functions</label>
                                    <ul>
                                ...
                                <l>
                                    <input type="checkbox" id="RcVEslqfhQ">
                                    <label for="RcVEslqfhQ">Meta Arguments</label>
                                    <ul>
                ...
                <l>
                    <input type="checkbox" id="NyqfDpJiwi">
                    <label for="NyqfDpJiwi">Docker</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="tDKJXrAtvd">
                    <label for="tDKJXrAtvd">Dotnet</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="FrChErkNZG">
                            <label for="FrChErkNZG">Cli</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="pRVArTvSCn">
                    <label for="pRVArTvSCn">Functional Programming</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="MumxzuSIOe">
                    <label for="MumxzuSIOe">Git</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="oBxzXOtadf">
                            <label for="oBxzXOtadf">Github</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="zhEjGODidd">
                    <label for="zhEjGODidd">Go</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="xIUBmBKwVy">
                    <label for="xIUBmBKwVy">Haskell</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="UwZHDnXdpn">
                    <label for="UwZHDnXdpn">Js</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="oWUbBbepRq">
                            <label for="oWUbBbepRq">Node</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="yYrUBplozk">
                            <label for="yYrUBplozk">D3</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="zQsumQZbVl">
                            <label for="zQsumQZbVl">Mocha</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="wWZOFaqvep">
                            <label for="wWZOFaqvep">P5js</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="pgGYoOmDcx">
                            <label for="pgGYoOmDcx">Typescript</label>
                            <ul>
                                <l>
                                    <input type="checkbox" id="qkVTzwLcgV">
                                    <label for="qkVTzwLcgV">Testing</label>
                                    <ul>
                ...
                <l>
                    <input type="checkbox" id="oQSKJDLEWK">
                    <label for="oQSKJDLEWK">Kafka</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="DAWGqaPlQm">
                    <label for="DAWGqaPlQm">Kubernetes</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="VZFXSDIqHS">
                    <label for="VZFXSDIqHS">Language</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="mlhvhQWTqM">
                    <label for="mlhvhQWTqM">Linux</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="wMBmGptryM">
                            <label for="wMBmGptryM">Bash</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="vJKPXEwlqQ">
                    <label for="vJKPXEwlqQ">Oauth</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="pFstGaYpFF">
                    <label for="pFstGaYpFF">Prometheus</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="sPhfxKrrfh">
                    <label for="sPhfxKrrfh">Python</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="msJUMZUOtG">
                            <label for="msJUMZUOtG">Data Classes</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="HmethCwYaQ">
                            <label for="HmethCwYaQ">Libraries</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="SpuBsGLGrj">
                    <label for="SpuBsGLGrj">React</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="ObnfuPNKvH">
                    <label for="ObnfuPNKvH">Regular Expressions</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="aUillTWlnX">
                    <label for="aUillTWlnX">Rust</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="sDfHQnUhUL">
                            <label for="sDfHQnUhUL">Serde</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="BulbwMBQNK">
                    <label for="BulbwMBQNK">Shaders</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="NBIrLDREco">
                            <label for="NBIrLDREco">Glsl</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="VSXeDyGmhq">
                    <label for="VSXeDyGmhq">Vim</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="CJJbPDRzKC">
                    <label for="CJJbPDRzKC">Web</label>
                    <ul>
