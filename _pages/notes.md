...
<ul>
    <div name="contents-index">
        ...
        <l>
            <input type="checkbox" id="eZJnjgfTfH" checked>
            <label for="eZJnjgfTfH">Math</label>
            <ul>
                <l>
                    <input type="checkbox" id="YbfkmlfABw">
                    <label for="YbfkmlfABw">Exponentials</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="itAWCYFAEo">
                    <label for="itAWCYFAEo">Linear Algebra</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="vXFSodInEL">
                    <label for="vXFSodInEL">Logarithms</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="wWdEkMdlYX">
                    <label for="wWdEkMdlYX">Sequences</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="SffgpTISSl">
                    <label for="SffgpTISSl">Single Variable Calculus</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="EeojxbHICr">
                    <label for="EeojxbHICr">Trigonometry</label>
                    <ul>
        ...
        <l>
            <input type="checkbox" id="AggyTzwpnv" checked>
            <label for="AggyTzwpnv">Programming</label>
            <ul>
                <l>
                    <input type="checkbox" id="GDzMGwjhRq">
                    <label for="GDzMGwjhRq">Ansible</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="OurQhDYgvR">
                    <label for="OurQhDYgvR">Architecture</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="rpBbqKCMio">
                    <label for="rpBbqKCMio">Computer Graphics</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="OdVKbnqIcW">
                    <label for="OdVKbnqIcW">Databases</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="gcFWCfQtIH">
                    <label for="gcFWCfQtIH">Devops</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="jRcKAZmUwn">
                            <label for="jRcKAZmUwn">Cloud Providers</label>
                            <ul>
                                <l>
                                    <input type="checkbox" id="mbLdQkgTSP">
                                    <label for="mbLdQkgTSP">AWS</label>
                                    <ul>
                                        <l>
                                            <input type="checkbox" id="AiVrpceFTj">
                                            <label for="AiVrpceFTj">Cli</label>
                                            <ul>
                                        ...
                                        <l>
                                            <input type="checkbox" id="ikLGpbcDFV">
                                            <label for="ikLGpbcDFV">Dotnet</label>
                                            <ul>
                                        ...
                                        <l>
                                            <input type="checkbox" id="eTtmkazKZC">
                                            <label for="eTtmkazKZC">Ec 2</label>
                                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="VafsvCkrta">
                            <label for="VafsvCkrta">Events</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="QgsTgvxVhK">
                            <label for="QgsTgvxVhK">Localstack</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="wFFVSvEAnB">
                            <label for="wFFVSvEAnB">Pulumi</label>
                            <ul>
                                <l>
                                    <input type="checkbox" id="zdBUnvUwQS">
                                    <label for="zdBUnvUwQS">Dotnet</label>
                                    <ul>
                        ...
                        <l>
                            <input type="checkbox" id="TEUBXRXbZx">
                            <label for="TEUBXRXbZx">Serverless Framework</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="CbLTgpBSjg">
                            <label for="CbLTgpBSjg">Terraform</label>
                            <ul>
                                <l>
                                    <input type="checkbox" id="iLlQJXZcTt">
                                    <label for="iLlQJXZcTt">Functions</label>
                                    <ul>
                                ...
                                <l>
                                    <input type="checkbox" id="vKyhbMmETR">
                                    <label for="vKyhbMmETR">Meta Arguments</label>
                                    <ul>
                ...
                <l>
                    <input type="checkbox" id="EJAgUXNHbY">
                    <label for="EJAgUXNHbY">Docker</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="OXvflwVqQi">
                    <label for="OXvflwVqQi">Dotnet</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="HzeoxcyUUg">
                            <label for="HzeoxcyUUg">Cli</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="tqxsakpPyo">
                    <label for="tqxsakpPyo">Functional Programming</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="ollAAjCRdb">
                    <label for="ollAAjCRdb">Git</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="KPFIayFoja">
                            <label for="KPFIayFoja">Github</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="pOfzRzZoFU">
                    <label for="pOfzRzZoFU">Go</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="UiPNzbrYQd">
                    <label for="UiPNzbrYQd">Haskell</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="EbTQXkhlhq">
                    <label for="EbTQXkhlhq">Js</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="BGUPPWXVUE">
                            <label for="BGUPPWXVUE">Node</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="HigSNwoQfH">
                            <label for="HigSNwoQfH">D3</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="tneewEaYgg">
                            <label for="tneewEaYgg">Mocha</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="fRxnzFRdmP">
                            <label for="fRxnzFRdmP">P5js</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="abtqohDRIN">
                            <label for="abtqohDRIN">Typescript</label>
                            <ul>
                                <l>
                                    <input type="checkbox" id="MVMKEiXZIA">
                                    <label for="MVMKEiXZIA">Testing</label>
                                    <ul>
                ...
                <l>
                    <input type="checkbox" id="SHfuVwGqHJ">
                    <label for="SHfuVwGqHJ">Kafka</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="UVghUPQTLk">
                    <label for="UVghUPQTLk">Kubernetes</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="FIABopWzLL">
                    <label for="FIABopWzLL">Language</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="DbMuMDovfj">
                    <label for="DbMuMDovfj">Linux</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="FrWdSIueEQ">
                            <label for="FrWdSIueEQ">Bash</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="aaCdEmiSFT">
                    <label for="aaCdEmiSFT">Oauth</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="sUMQNKdhmH">
                    <label for="sUMQNKdhmH">Prometheus</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="nFFosaqOAF">
                    <label for="nFFosaqOAF">Python</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="ixvHYrVDPd">
                            <label for="ixvHYrVDPd">Data Classes</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="ReRJdTUoTo">
                            <label for="ReRJdTUoTo">Libraries</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="VRUZxRAKJt">
                    <label for="VRUZxRAKJt">React</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="QJQXrDdbqp">
                    <label for="QJQXrDdbqp">Regular Expressions</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="MbsGWYboQi">
                    <label for="MbsGWYboQi">Rust</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="YVAPhQmwvU">
                            <label for="YVAPhQmwvU">Serde</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="PAdltauDcr">
                    <label for="PAdltauDcr">Shaders</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="fKcFQhsVzJ">
                            <label for="fKcFQhsVzJ">Glsl</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="dKStlMhaKB">
                    <label for="dKStlMhaKB">Vim</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="exLrkUlobt">
                    <label for="exLrkUlobt">Web</label>
                    <ul>
