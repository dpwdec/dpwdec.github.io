...
<ul>
    <div name="contents-index">
        ...
        <l>
            <input type="checkbox" id="ejHeABUpDR" checked>
            <label for="ejHeABUpDR">Math</label>
            <ul>
                <l>
                    <input type="checkbox" id="KaNsvMpRGx">
                    <label for="KaNsvMpRGx">Exponentials</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="NNDANLNbNb">
                    <label for="NNDANLNbNb">Linear Algebra</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="zLZzZumcSj">
                    <label for="zLZzZumcSj">Logarithms</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="QDFKwrNhVF">
                    <label for="QDFKwrNhVF">Sequences</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="JXCebCfDEK">
                    <label for="JXCebCfDEK">Single Variable Calculus</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="JHJZNliOte">
                    <label for="JHJZNliOte">Trigonometry</label>
                    <ul>
        ...
        <l>
            <input type="checkbox" id="NOeRjqmlMD" checked>
            <label for="NOeRjqmlMD">Programming</label>
            <ul>
                <l>
                    <input type="checkbox" id="MTrEwRUpNA">
                    <label for="MTrEwRUpNA">Ansible</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="UErrlhMqUC">
                    <label for="UErrlhMqUC">Architecture</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="xFAkGgYhle">
                    <label for="xFAkGgYhle">Computer Graphics</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="oTkOvPqnIg">
                    <label for="oTkOvPqnIg">Databases</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="bxplyLsTLf">
                    <label for="bxplyLsTLf">Devops</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="quxebkWeuy">
                            <label for="quxebkWeuy">Cloud Computing</label>
                            <ul>
                                <l>
                                    <input type="checkbox" id="YhSHQTuWdu">
                                    <label for="YhSHQTuWdu">AWS</label>
                                    <ul>
                                        <l>
                                            <input type="checkbox" id="pBIYXMCRMR">
                                            <label for="pBIYXMCRMR">Cli</label>
                                            <ul>
                                        ...
                                        <l>
                                            <input type="checkbox" id="wEYtxrFLRX">
                                            <label for="wEYtxrFLRX">Ec 2</label>
                                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="eXaxiZvhpO">
                            <label for="eXaxiZvhpO">Events</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="LFGTFrFPSt">
                            <label for="LFGTFrFPSt">Oauth</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="UoKUzFUXBG">
                            <label for="UoKUzFUXBG">Pulumi</label>
                            <ul>
                                <l>
                                    <input type="checkbox" id="qVHEpRtGbt">
                                    <label for="qVHEpRtGbt">Dotnet</label>
                                    <ul>
                        ...
                        <l>
                            <input type="checkbox" id="XSxvnnACkb">
                            <label for="XSxvnnACkb">Terraform</label>
                            <ul>
                                <l>
                                    <input type="checkbox" id="eUcaANmchJ">
                                    <label for="eUcaANmchJ">Functions</label>
                                    <ul>
                                ...
                                <l>
                                    <input type="checkbox" id="zctfKjqRkQ">
                                    <label for="zctfKjqRkQ">Meta Arguments</label>
                                    <ul>
                ...
                <l>
                    <input type="checkbox" id="HjYHohBPPH">
                    <label for="HjYHohBPPH">Docker</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="fublVwSIYT">
                    <label for="fublVwSIYT">Dotnet</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="XgBKcttVzs">
                            <label for="XgBKcttVzs">Cli</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="tEyvNbgbxz">
                    <label for="tEyvNbgbxz">Functional Programming</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="PoyTMYesSt">
                    <label for="PoyTMYesSt">Git</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="iUvNjagQcz">
                            <label for="iUvNjagQcz">Github</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="kzsJWmGuNL">
                    <label for="kzsJWmGuNL">Go</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="gojnAFULap">
                    <label for="gojnAFULap">Haskell</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="bCdxtFVrSb">
                    <label for="bCdxtFVrSb">Js</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="rkaENBqFJX">
                            <label for="rkaENBqFJX">Node</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="qMwcSJEBEz">
                            <label for="qMwcSJEBEz">Mocha</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="jAIwVtPnII">
                            <label for="jAIwVtPnII">P5js</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="TaoIUyUpSm">
                            <label for="TaoIUyUpSm">Typescript</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="AtklthvQXV">
                    <label for="AtklthvQXV">Kafka</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="CpiEvJJjPe">
                    <label for="CpiEvJJjPe">Kubernetes</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="EygkOPxxCf">
                    <label for="EygkOPxxCf">Language</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="MWqHefDPqJ">
                    <label for="MWqHefDPqJ">Linux</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="vqOsMUrxIW">
                    <label for="vqOsMUrxIW">Python</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="xiuOvzvZPl">
                            <label for="xiuOvzvZPl">Data Classes</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="qmddwUZUjU">
                            <label for="qmddwUZUjU">Libraries</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="aBgxpOThyR">
                    <label for="aBgxpOThyR">React</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="wbnQXKfnSA">
                    <label for="wbnQXKfnSA">Regular Expressions</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="soarsEyzGp">
                    <label for="soarsEyzGp">Rust</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="IZsbjQizUZ">
                            <label for="IZsbjQizUZ">Serde</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="fBONSQrWkR">
                    <label for="fBONSQrWkR">Vim</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="jxFyLcbOGw">
                    <label for="jxFyLcbOGw">Web</label>
                    <ul>
