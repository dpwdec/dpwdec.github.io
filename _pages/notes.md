...
<ul>
    <div name="contents-index">
        ...
        <l>
            <input type="checkbox" id="UctStFhqYJ" checked>
            <label for="UctStFhqYJ">Math</label>
            <ul>
                <l>
                    <input type="checkbox" id="DbWHrKWpCa">
                    <label for="DbWHrKWpCa">Exponentials</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="trVJwsilAD">
                    <label for="trVJwsilAD">Linear Algebra</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="QaDQaNWTmt">
                    <label for="QaDQaNWTmt">Logarithms</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="WTQVugnExC">
                    <label for="WTQVugnExC">Sequences</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="fXYUBNySPo">
                    <label for="fXYUBNySPo">Single Variable Calculus</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="exLToDpzLw">
                    <label for="exLToDpzLw">Trigonometry</label>
                    <ul>
        ...
        <l>
            <input type="checkbox" id="lTLZpZEmfc" checked>
            <label for="lTLZpZEmfc">Programming</label>
            <ul>
                <l>
                    <input type="checkbox" id="okmKamgZXj">
                    <label for="okmKamgZXj">Ansible</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="EmSUSuhiZZ">
                    <label for="EmSUSuhiZZ">Architecture</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="WoUhrOzIYI">
                    <label for="WoUhrOzIYI">Computer Graphics</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="jEoJwIiLXa">
                    <label for="jEoJwIiLXa">Databases</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="kcxwYZaawZ">
                    <label for="kcxwYZaawZ">Devops</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="IyaEfmUesa">
                            <label for="IyaEfmUesa">Cloud Computing</label>
                            <ul>
                                <l>
                                    <input type="checkbox" id="suHoZRofZk">
                                    <label for="suHoZRofZk">AWS</label>
                                    <ul>
                                        <l>
                                            <input type="checkbox" id="rSBxcXLHye">
                                            <label for="rSBxcXLHye">Cli</label>
                                            <ul>
                                        ...
                                        <l>
                                            <input type="checkbox" id="ztCmOHyUSO">
                                            <label for="ztCmOHyUSO">Dotnet</label>
                                            <ul>
                                        ...
                                        <l>
                                            <input type="checkbox" id="ganpcKmzGt">
                                            <label for="ganpcKmzGt">Ec 2</label>
                                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="OfXToKhLNK">
                            <label for="OfXToKhLNK">Events</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="wApibjEEjG">
                            <label for="wApibjEEjG">Localstack</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="INMRRblyXM">
                            <label for="INMRRblyXM">Oauth</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="VnIkHmezRJ">
                            <label for="VnIkHmezRJ">Pulumi</label>
                            <ul>
                                <l>
                                    <input type="checkbox" id="hWVEeboivA">
                                    <label for="hWVEeboivA">Dotnet</label>
                                    <ul>
                        ...
                        <l>
                            <input type="checkbox" id="FsRCovjcLz">
                            <label for="FsRCovjcLz">Terraform</label>
                            <ul>
                                <l>
                                    <input type="checkbox" id="rMiXJGmvLt">
                                    <label for="rMiXJGmvLt">Functions</label>
                                    <ul>
                                ...
                                <l>
                                    <input type="checkbox" id="VgYflsnvDx">
                                    <label for="VgYflsnvDx">Meta Arguments</label>
                                    <ul>
                ...
                <l>
                    <input type="checkbox" id="agiANXsyJA">
                    <label for="agiANXsyJA">Docker</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="hUbZNTlQpY">
                    <label for="hUbZNTlQpY">Dotnet</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="ycfUSXQBmZ">
                            <label for="ycfUSXQBmZ">Cli</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="EvrftRMXnh">
                    <label for="EvrftRMXnh">Functional Programming</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="lNbxkyFqwn">
                    <label for="lNbxkyFqwn">Git</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="GloZtOuoOU">
                            <label for="GloZtOuoOU">Github</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="lXGlQZUzPk">
                    <label for="lXGlQZUzPk">Go</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="RSCRoAGkvR">
                    <label for="RSCRoAGkvR">Haskell</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="cAsYkZsHVA">
                    <label for="cAsYkZsHVA">Js</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="FmXAgqfRqy">
                            <label for="FmXAgqfRqy">Node</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="EEMYERMXOL">
                            <label for="EEMYERMXOL">D3</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="MvxOOdOKNb">
                            <label for="MvxOOdOKNb">Mocha</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="BkbPzJUnwe">
                            <label for="BkbPzJUnwe">P5js</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="zZHzBYXHdc">
                            <label for="zZHzBYXHdc">Typescript</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="DnxmPctxrZ">
                    <label for="DnxmPctxrZ">Kafka</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="QitsXenpbe">
                    <label for="QitsXenpbe">Kubernetes</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="UWwneakrCt">
                    <label for="UWwneakrCt">Language</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="qERzBFrGdq">
                    <label for="qERzBFrGdq">Linux</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="FlOTvDoZuK">
                            <label for="FlOTvDoZuK">Bash</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="uFnbBFKKtg">
                    <label for="uFnbBFKKtg">Python</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="wzKktToGeQ">
                            <label for="wzKktToGeQ">Data Classes</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="BMyhrSiAjs">
                            <label for="BMyhrSiAjs">Libraries</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="EexbDdMgqG">
                    <label for="EexbDdMgqG">React</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="mNWWBPUKZg">
                    <label for="mNWWBPUKZg">Regular Expressions</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="uaDbQGLCvV">
                    <label for="uaDbQGLCvV">Rust</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="yLJIujnXgA">
                            <label for="yLJIujnXgA">Serde</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="lBSwvsxxgD">
                    <label for="lBSwvsxxgD">Vim</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="SqEAaiubPk">
                    <label for="SqEAaiubPk">Web</label>
                    <ul>
