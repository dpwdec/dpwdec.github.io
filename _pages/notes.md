...
<ul>
    <div name="contents-index">
        ...
        <l>
            <input type="checkbox" id="vrpLTzYltC" checked>
            <label for="vrpLTzYltC">Math</label>
            <ul>
                <l>
                    <input type="checkbox" id="MEdISaIuCS">
                    <label for="MEdISaIuCS">Exponentials</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="GCmxCBilbA">
                    <label for="GCmxCBilbA">Linear Algebra</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="aWxZviQchc">
                    <label for="aWxZviQchc">Logarithms</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="DfehEyvCxu">
                    <label for="DfehEyvCxu">Sequences</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="xGtlgxqDdh">
                    <label for="xGtlgxqDdh">Single Variable Calculus</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="YOsACgsqEV">
                    <label for="YOsACgsqEV">Trigonometry</label>
                    <ul>
        ...
        <l>
            <input type="checkbox" id="LMYJHCoOif" checked>
            <label for="LMYJHCoOif">Programming</label>
            <ul>
                <l>
                    <input type="checkbox" id="XjxFojVtqt">
                    <label for="XjxFojVtqt">Ansible</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="kBwEmYkhfV">
                    <label for="kBwEmYkhfV">Architecture</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="otPrQptwSu">
                    <label for="otPrQptwSu">Computer Graphics</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="wHltxkeSxN">
                    <label for="wHltxkeSxN">Databases</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="WBNXWPxcdA">
                    <label for="WBNXWPxcdA">Devops</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="rRybdEnpwb">
                            <label for="rRybdEnpwb">Cloud Computing</label>
                            <ul>
                                <l>
                                    <input type="checkbox" id="oqtfBsOGRd">
                                    <label for="oqtfBsOGRd">AWS</label>
                                    <ul>
                                        <l>
                                            <input type="checkbox" id="bObbgVWLYA">
                                            <label for="bObbgVWLYA">Cli</label>
                                            <ul>
                                        ...
                                        <l>
                                            <input type="checkbox" id="bYZCWhCFMJ">
                                            <label for="bYZCWhCFMJ">Dotnet</label>
                                            <ul>
                                        ...
                                        <l>
                                            <input type="checkbox" id="gTTGqnCaVB">
                                            <label for="gTTGqnCaVB">Ec 2</label>
                                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="FbbDJtgzAa">
                            <label for="FbbDJtgzAa">Events</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="ZLxTLrgKBQ">
                            <label for="ZLxTLrgKBQ">Oauth</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="xQoCUHFfKf">
                            <label for="xQoCUHFfKf">Pulumi</label>
                            <ul>
                                <l>
                                    <input type="checkbox" id="SlTvAbNRpb">
                                    <label for="SlTvAbNRpb">Dotnet</label>
                                    <ul>
                        ...
                        <l>
                            <input type="checkbox" id="FYAdLvPUSW">
                            <label for="FYAdLvPUSW">Terraform</label>
                            <ul>
                                <l>
                                    <input type="checkbox" id="xKNzNEtSDC">
                                    <label for="xKNzNEtSDC">Functions</label>
                                    <ul>
                                ...
                                <l>
                                    <input type="checkbox" id="xYhSpkqGCN">
                                    <label for="xYhSpkqGCN">Meta Arguments</label>
                                    <ul>
                ...
                <l>
                    <input type="checkbox" id="cNdaFEIgpv">
                    <label for="cNdaFEIgpv">Docker</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="ziKeulAKTI">
                    <label for="ziKeulAKTI">Dotnet</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="trrICcHPgp">
                            <label for="trrICcHPgp">Cli</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="wRwDTpgbMn">
                    <label for="wRwDTpgbMn">Functional Programming</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="UUZiUNmTnQ">
                    <label for="UUZiUNmTnQ">Git</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="KqitxmLRUo">
                            <label for="KqitxmLRUo">Github</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="cXSJGtmptP">
                    <label for="cXSJGtmptP">Go</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="uNdgiRAbky">
                    <label for="uNdgiRAbky">Haskell</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="PdGDRziyuT">
                    <label for="PdGDRziyuT">Js</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="IPUsnaMtUq">
                            <label for="IPUsnaMtUq">Node</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="AtwOODGSKm">
                            <label for="AtwOODGSKm">Mocha</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="xkENdJUBhr">
                            <label for="xkENdJUBhr">P5js</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="wNIEWaSPZK">
                            <label for="wNIEWaSPZK">Typescript</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="mDJPXwOMvm">
                    <label for="mDJPXwOMvm">Kafka</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="jYFWdXYTQl">
                    <label for="jYFWdXYTQl">Kubernetes</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="LNkyjwjxro">
                    <label for="LNkyjwjxro">Language</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="QALuAyNuKQ">
                    <label for="QALuAyNuKQ">Linux</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="AmCKcbsLkR">
                    <label for="AmCKcbsLkR">Python</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="GVnzdJmYFf">
                            <label for="GVnzdJmYFf">Data Classes</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="XOttXPzBJt">
                            <label for="XOttXPzBJt">Libraries</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="qPiYhQytPS">
                    <label for="qPiYhQytPS">React</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="xzJqMODlki">
                    <label for="xzJqMODlki">Regular Expressions</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="anlcBMpLbA">
                    <label for="anlcBMpLbA">Rust</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="YGxicsPvAt">
                            <label for="YGxicsPvAt">Serde</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="dZUkoHPODQ">
                    <label for="dZUkoHPODQ">Vim</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="LZNQVqozrk">
                    <label for="LZNQVqozrk">Web</label>
                    <ul>
