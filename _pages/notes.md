...
<ul>
    <div name="contents-index">
        ...
        <l>
            <input type="checkbox" id="MBhPQsZGpd" checked>
            <label for="MBhPQsZGpd">Math</label>
            <ul>
                <l>
                    <input type="checkbox" id="DpVzEafWWh">
                    <label for="DpVzEafWWh">Exponentials</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="RXOvnoTvZH">
                    <label for="RXOvnoTvZH">Linear Algebra</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="ORFBXQlAFV">
                    <label for="ORFBXQlAFV">Logarithms</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="mJcRxgUkKf">
                    <label for="mJcRxgUkKf">Sequences</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="JwRnmbCoWM">
                    <label for="JwRnmbCoWM">Single Variable Calculus</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="znDQPEDorP">
                    <label for="znDQPEDorP">Trigonometry</label>
                    <ul>
        ...
        <l>
            <input type="checkbox" id="YkjQjAarqY" checked>
            <label for="YkjQjAarqY">Programming</label>
            <ul>
                <l>
                    <input type="checkbox" id="DpqThJlUeK">
                    <label for="DpqThJlUeK">Ansible</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="qDyjoMsTrm">
                    <label for="qDyjoMsTrm">Architecture</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="VwtHHvyAQt">
                    <label for="VwtHHvyAQt">Computer Graphics</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="iiIiIMadiZ">
                    <label for="iiIiIMadiZ">Databases</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="LGTixtQYgx">
                    <label for="LGTixtQYgx">Devops</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="AxrpXqqqcF">
                            <label for="AxrpXqqqcF">Cloud Providers</label>
                            <ul>
                                <l>
                                    <input type="checkbox" id="sLBoEHQMoa">
                                    <label for="sLBoEHQMoa">AWS</label>
                                    <ul>
                                        <l>
                                            <input type="checkbox" id="VQyDIhleLx">
                                            <label for="VQyDIhleLx">Cli</label>
                                            <ul>
                                        ...
                                        <l>
                                            <input type="checkbox" id="hwQlViTZkw">
                                            <label for="hwQlViTZkw">Dotnet</label>
                                            <ul>
                                        ...
                                        <l>
                                            <input type="checkbox" id="FgNsXIjsPh">
                                            <label for="FgNsXIjsPh">Ec 2</label>
                                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="dMxhEmnYEM">
                            <label for="dMxhEmnYEM">Events</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="TYnKkdmlJG">
                            <label for="TYnKkdmlJG">Localstack</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="WYLkaksdqy">
                            <label for="WYLkaksdqy">Pulumi</label>
                            <ul>
                                <l>
                                    <input type="checkbox" id="zJlvxBBsYO">
                                    <label for="zJlvxBBsYO">Dotnet</label>
                                    <ul>
                        ...
                        <l>
                            <input type="checkbox" id="jVfooBCCtC">
                            <label for="jVfooBCCtC">Serverless Framework</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="bSwZAtfKwn">
                            <label for="bSwZAtfKwn">Terraform</label>
                            <ul>
                                <l>
                                    <input type="checkbox" id="phhfzSlxax">
                                    <label for="phhfzSlxax">Functions</label>
                                    <ul>
                                ...
                                <l>
                                    <input type="checkbox" id="UXGrosXIoA">
                                    <label for="UXGrosXIoA">Meta Arguments</label>
                                    <ul>
                ...
                <l>
                    <input type="checkbox" id="FOjMHUDCXH">
                    <label for="FOjMHUDCXH">Docker</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="NfKndKyXGd">
                    <label for="NfKndKyXGd">Dotnet</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="aMYapeqDae">
                            <label for="aMYapeqDae">Cli</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="rjxZDVDNWO">
                    <label for="rjxZDVDNWO">Functional Programming</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="TFGEHdpnQG">
                    <label for="TFGEHdpnQG">Git</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="JhjkEQhxlN">
                            <label for="JhjkEQhxlN">Github</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="fkWTwiXpag">
                    <label for="fkWTwiXpag">Go</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="wZmpkgOfrP">
                    <label for="wZmpkgOfrP">Haskell</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="zFsTPKdMao">
                    <label for="zFsTPKdMao">Js</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="dfRojFZKef">
                            <label for="dfRojFZKef">Node</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="BCsSxzHYGI">
                            <label for="BCsSxzHYGI">D3</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="cIUnVOKkOJ">
                            <label for="cIUnVOKkOJ">Mocha</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="IcCUnJBIBV">
                            <label for="IcCUnJBIBV">P5js</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="WwdJjyfYYV">
                            <label for="WwdJjyfYYV">Typescript</label>
                            <ul>
                                <l>
                                    <input type="checkbox" id="wwxgrzkYBz">
                                    <label for="wwxgrzkYBz">Testing</label>
                                    <ul>
                ...
                <l>
                    <input type="checkbox" id="sHKQUhWsUF">
                    <label for="sHKQUhWsUF">Kafka</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="DhXslNKpCy">
                    <label for="DhXslNKpCy">Kubernetes</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="RxHCVFnUfr">
                    <label for="RxHCVFnUfr">Language</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="LfBWAKdOCU">
                    <label for="LfBWAKdOCU">Linux</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="GDJedQSYYh">
                            <label for="GDJedQSYYh">Bash</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="ifvlIiBvdy">
                    <label for="ifvlIiBvdy">Oauth</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="uijWFYVsSC">
                    <label for="uijWFYVsSC">Prometheus</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="BtHwvMJOgU">
                    <label for="BtHwvMJOgU">Python</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="NeALIMQyqJ">
                            <label for="NeALIMQyqJ">Data Classes</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="fguulwIYGn">
                            <label for="fguulwIYGn">Libraries</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="zQbgJPsIkl">
                    <label for="zQbgJPsIkl">React</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="WhIVczHXEr">
                    <label for="WhIVczHXEr">Regular Expressions</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="XNJKRUcXST">
                    <label for="XNJKRUcXST">Rust</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="lmQUQIQAAs">
                            <label for="lmQUQIQAAs">Serde</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="LjqQLOqYmB">
                    <label for="LjqQLOqYmB">Shaders</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="JItJljFnIj">
                            <label for="JItJljFnIj">Glsl</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="xuNLarnEYX">
                    <label for="xuNLarnEYX">Vim</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="RcqHGBBcDe">
                    <label for="RcqHGBBcDe">Web</label>
                    <ul>
