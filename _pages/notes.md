...
<ul>
    <div name="contents-index">
        ...
        <l>
            <input type="checkbox" id="RMDlhzqULi" checked>
            <label for="RMDlhzqULi">Math</label>
            <ul>
                <l>
                    <input type="checkbox" id="jvFfReiWNf">
                    <label for="jvFfReiWNf">Exponentials</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="PjANwLHuew">
                    <label for="PjANwLHuew">Linear Algebra</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="YhFaunOWbB">
                    <label for="YhFaunOWbB">Logarithms</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="MThhwpTwdL">
                    <label for="MThhwpTwdL">Sequences</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="DulXNXyhiO">
                    <label for="DulXNXyhiO">Single Variable Calculus</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="YphASNzsYD">
                    <label for="YphASNzsYD">Trigonometry</label>
                    <ul>
        ...
        <l>
            <input type="checkbox" id="pQHxwVfkCe" checked>
            <label for="pQHxwVfkCe">Programming</label>
            <ul>
                <l>
                    <input type="checkbox" id="PAgGBqLoSH">
                    <label for="PAgGBqLoSH">Ansible</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="qjIlaajaAY">
                    <label for="qjIlaajaAY">Architecture</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="YOGErBOEcb">
                    <label for="YOGErBOEcb">Computer Graphics</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="uSDRNgPiTd">
                    <label for="uSDRNgPiTd">Databases</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="mNogzOWNeC">
                    <label for="mNogzOWNeC">Devops</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="lxRKKEjvoo">
                            <label for="lxRKKEjvoo">Cloud Computing</label>
                            <ul>
                                <l>
                                    <input type="checkbox" id="ZHVKjYHjBO">
                                    <label for="ZHVKjYHjBO">AWS</label>
                                    <ul>
                                        <l>
                                            <input type="checkbox" id="kxwkipAmmL">
                                            <label for="kxwkipAmmL">Cli</label>
                                            <ul>
                                        ...
                                        <l>
                                            <input type="checkbox" id="lEJLXxnSAE">
                                            <label for="lEJLXxnSAE">Dotnet</label>
                                            <ul>
                                        ...
                                        <l>
                                            <input type="checkbox" id="muIYvWfmyN">
                                            <label for="muIYvWfmyN">Ec 2</label>
                                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="dIbRPdxtXd">
                            <label for="dIbRPdxtXd">Events</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="NauyaDQBIm">
                            <label for="NauyaDQBIm">Localstack</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="kvfvZcFhDF">
                            <label for="kvfvZcFhDF">Oauth</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="stxTexpfNe">
                            <label for="stxTexpfNe">Pulumi</label>
                            <ul>
                                <l>
                                    <input type="checkbox" id="THJrmkDffi">
                                    <label for="THJrmkDffi">Dotnet</label>
                                    <ul>
                        ...
                        <l>
                            <input type="checkbox" id="ipLDHeVsiE">
                            <label for="ipLDHeVsiE">Terraform</label>
                            <ul>
                                <l>
                                    <input type="checkbox" id="RNkTqfzQhx">
                                    <label for="RNkTqfzQhx">Functions</label>
                                    <ul>
                                ...
                                <l>
                                    <input type="checkbox" id="eEelashnVa">
                                    <label for="eEelashnVa">Meta Arguments</label>
                                    <ul>
                ...
                <l>
                    <input type="checkbox" id="cEktpxFdQe">
                    <label for="cEktpxFdQe">Docker</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="fAiAiIjMyp">
                    <label for="fAiAiIjMyp">Dotnet</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="OzbyMGoMuY">
                            <label for="OzbyMGoMuY">Cli</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="OqKIIGbWWn">
                    <label for="OqKIIGbWWn">Functional Programming</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="WtyhqIAKVb">
                    <label for="WtyhqIAKVb">Git</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="EPEYJXhXnI">
                            <label for="EPEYJXhXnI">Github</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="SbqjPhonqw">
                    <label for="SbqjPhonqw">Go</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="eGxqEDxsef">
                    <label for="eGxqEDxsef">Haskell</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="JuPLwZRvIi">
                    <label for="JuPLwZRvIi">Js</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="jOLKAwUDHk">
                            <label for="jOLKAwUDHk">Node</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="kJilFXYdSN">
                            <label for="kJilFXYdSN">D3</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="BWbDfThupP">
                            <label for="BWbDfThupP">Mocha</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="edpNBEVHjI">
                            <label for="edpNBEVHjI">P5js</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="CrNgezKCvg">
                            <label for="CrNgezKCvg">Typescript</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="TWOxOGgGdb">
                    <label for="TWOxOGgGdb">Kafka</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="cAcDIdrXzm">
                    <label for="cAcDIdrXzm">Kubernetes</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="dDWrOQsCuN">
                    <label for="dDWrOQsCuN">Language</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="UtGeJrCvFE">
                    <label for="UtGeJrCvFE">Linux</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="LBagEArtwS">
                    <label for="LBagEArtwS">Python</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="EBMfazcHaD">
                            <label for="EBMfazcHaD">Data Classes</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="iYlSpnwWTZ">
                            <label for="iYlSpnwWTZ">Libraries</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="kmBfeuPlxE">
                    <label for="kmBfeuPlxE">React</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="JCFnPQlAJI">
                    <label for="JCFnPQlAJI">Regular Expressions</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="LrqtotMKlX">
                    <label for="LrqtotMKlX">Rust</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="GAmGzSmBqb">
                            <label for="GAmGzSmBqb">Serde</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="XpctHyWSTD">
                    <label for="XpctHyWSTD">Vim</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="rDiLaGFcIv">
                    <label for="rDiLaGFcIv">Web</label>
                    <ul>
