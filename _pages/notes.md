...
<ul>
    <div name="contents-index">
        ...
        <l>
            <input type="checkbox" id="uMxwazvBYn" checked>
            <label for="uMxwazvBYn">Math</label>
            <ul>
                <l>
                    <input type="checkbox" id="ACUQzcXHRX">
                    <label for="ACUQzcXHRX">Exponentials</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="lSCQXcugQX">
                    <label for="lSCQXcugQX">Linear Algebra</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="xFfQbpNXJa">
                    <label for="xFfQbpNXJa">Logarithms</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="uGDLFwqOOs">
                    <label for="uGDLFwqOOs">Sequences</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="UKQYvqeDDy">
                    <label for="UKQYvqeDDy">Single Variable Calculus</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="PGtzZLVPeT">
                    <label for="PGtzZLVPeT">Trigonometry</label>
                    <ul>
        ...
        <l>
            <input type="checkbox" id="upkOOcJErQ" checked>
            <label for="upkOOcJErQ">Programming</label>
            <ul>
                <l>
                    <input type="checkbox" id="vjNolSAgiA">
                    <label for="vjNolSAgiA">Ansible</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="dpofWEsexl">
                    <label for="dpofWEsexl">Architecture</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="YgCzWrPmHb">
                    <label for="YgCzWrPmHb">Computer Graphics</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="XgrRqxDlwo">
                    <label for="XgrRqxDlwo">Databases</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="gRVDkKZbOb">
                    <label for="gRVDkKZbOb">Devops</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="UZAIVvALeJ">
                            <label for="UZAIVvALeJ">Cloud Providers</label>
                            <ul>
                                <l>
                                    <input type="checkbox" id="zYIUTHqdJC">
                                    <label for="zYIUTHqdJC">AWS</label>
                                    <ul>
                                        <l>
                                            <input type="checkbox" id="DzenPznWct">
                                            <label for="DzenPznWct">Cli</label>
                                            <ul>
                                        ...
                                        <l>
                                            <input type="checkbox" id="JZMBuPTUag">
                                            <label for="JZMBuPTUag">Dotnet</label>
                                            <ul>
                                        ...
                                        <l>
                                            <input type="checkbox" id="zbfocbUPGg">
                                            <label for="zbfocbUPGg">Ec 2</label>
                                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="qftzFaXUnV">
                            <label for="qftzFaXUnV">Events</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="UKKHGBsEdx">
                            <label for="UKKHGBsEdx">Localstack</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="ttmAsDqUlD">
                            <label for="ttmAsDqUlD">Pulumi</label>
                            <ul>
                                <l>
                                    <input type="checkbox" id="WpHjjXiUXg">
                                    <label for="WpHjjXiUXg">Dotnet</label>
                                    <ul>
                        ...
                        <l>
                            <input type="checkbox" id="XnWNPPUBXj">
                            <label for="XnWNPPUBXj">Serverless Framework</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="gaKgmWidmL">
                            <label for="gaKgmWidmL">Terraform</label>
                            <ul>
                                <l>
                                    <input type="checkbox" id="njeAHvDsLC">
                                    <label for="njeAHvDsLC">Functions</label>
                                    <ul>
                                ...
                                <l>
                                    <input type="checkbox" id="gGFEVmbTAp">
                                    <label for="gGFEVmbTAp">Meta Arguments</label>
                                    <ul>
                ...
                <l>
                    <input type="checkbox" id="iCFHUbtPSQ">
                    <label for="iCFHUbtPSQ">Docker</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="ZUFnQxXEmK">
                    <label for="ZUFnQxXEmK">Dotnet</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="nusFOCmbeA">
                            <label for="nusFOCmbeA">Cli</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="GiWloLzxjH">
                    <label for="GiWloLzxjH">Functional Programming</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="JCvXojKZDc">
                    <label for="JCvXojKZDc">Git</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="ekFDdBVqDU">
                            <label for="ekFDdBVqDU">Github</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="OklkTtariG">
                    <label for="OklkTtariG">Go</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="hmzATgkMKx">
                    <label for="hmzATgkMKx">Haskell</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="XKKclcUtir">
                    <label for="XKKclcUtir">Js</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="iYPGeVOech">
                            <label for="iYPGeVOech">Node</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="hqBPkGiZsH">
                            <label for="hqBPkGiZsH">D3</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="xXtpIXvXpS">
                            <label for="xXtpIXvXpS">Mocha</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="BHJHtmHlOy">
                            <label for="BHJHtmHlOy">P5js</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="hIpxSyonBE">
                            <label for="hIpxSyonBE">Typescript</label>
                            <ul>
                                <l>
                                    <input type="checkbox" id="yBkgBjElKD">
                                    <label for="yBkgBjElKD">Testing</label>
                                    <ul>
                ...
                <l>
                    <input type="checkbox" id="PQhNgHkKXP">
                    <label for="PQhNgHkKXP">Kafka</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="PrTLniqFku">
                    <label for="PrTLniqFku">Kubernetes</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="KhdqqDmkbd">
                    <label for="KhdqqDmkbd">Language</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="oWZOOTxGJX">
                    <label for="oWZOOTxGJX">Linux</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="ksSkKGqgFx">
                            <label for="ksSkKGqgFx">Bash</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="qxdfhRYhzm">
                    <label for="qxdfhRYhzm">Oauth</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="NIOMCTuVWb">
                    <label for="NIOMCTuVWb">Python</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="YquQqfkUMu">
                            <label for="YquQqfkUMu">Data Classes</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="xMcdRToInN">
                            <label for="xMcdRToInN">Libraries</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="FFGhqeZPpG">
                    <label for="FFGhqeZPpG">React</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="DYLWrMsKcY">
                    <label for="DYLWrMsKcY">Regular Expressions</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="ithhxHPWab">
                    <label for="ithhxHPWab">Rust</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="saEArEUuAU">
                            <label for="saEArEUuAU">Serde</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="UjPWwNnjjn">
                    <label for="UjPWwNnjjn">Vim</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="dvCqAvTqom">
                    <label for="dvCqAvTqom">Web</label>
                    <ul>
