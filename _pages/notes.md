...
<ul>
    <div name="contents-index">
        ...
        <l>
            <input type="checkbox" id="GWxjTobhpu" checked>
            <label for="GWxjTobhpu">Math</label>
            <ul>
                <l>
                    <input type="checkbox" id="EyPehmLzeH">
                    <label for="EyPehmLzeH">Exponentials</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="LSlVEFUobT">
                    <label for="LSlVEFUobT">Linear Algebra</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="cOUZfjOLkd">
                    <label for="cOUZfjOLkd">Logarithms</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="NYapRwgGwp">
                    <label for="NYapRwgGwp">Sequences</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="bChUHsKWhw">
                    <label for="bChUHsKWhw">Single Variable Calculus</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="WNdblraLij">
                    <label for="WNdblraLij">Trigonometry</label>
                    <ul>
        ...
        <l>
            <input type="checkbox" id="civasQbJgq" checked>
            <label for="civasQbJgq">Programming</label>
            <ul>
                <l>
                    <input type="checkbox" id="ocwcxBWaGm">
                    <label for="ocwcxBWaGm">Ansible</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="LeZbLXESsb">
                    <label for="LeZbLXESsb">Architecture</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="riwuwtZFMV">
                    <label for="riwuwtZFMV">Computer Graphics</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="WhSAhIDHrB">
                    <label for="WhSAhIDHrB">Databases</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="iuxDkAcwRt">
                    <label for="iuxDkAcwRt">Devops</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="JATvZATPpg">
                            <label for="JATvZATPpg">Cloud Providers</label>
                            <ul>
                                <l>
                                    <input type="checkbox" id="bspvBVRdbU">
                                    <label for="bspvBVRdbU">AWS</label>
                                    <ul>
                                        <l>
                                            <input type="checkbox" id="MWktYjgNsG">
                                            <label for="MWktYjgNsG">Cli</label>
                                            <ul>
                                        ...
                                        <l>
                                            <input type="checkbox" id="IlIzAesFtq">
                                            <label for="IlIzAesFtq">Dotnet</label>
                                            <ul>
                                        ...
                                        <l>
                                            <input type="checkbox" id="DpDAgdQhiT">
                                            <label for="DpDAgdQhiT">Ec 2</label>
                                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="YSmFxqArTT">
                            <label for="YSmFxqArTT">Events</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="mHZRTypRnu">
                            <label for="mHZRTypRnu">Localstack</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="wQssDoXLwP">
                            <label for="wQssDoXLwP">Pulumi</label>
                            <ul>
                                <l>
                                    <input type="checkbox" id="cVEaltHtmg">
                                    <label for="cVEaltHtmg">Dotnet</label>
                                    <ul>
                        ...
                        <l>
                            <input type="checkbox" id="gPKCQAsbEx">
                            <label for="gPKCQAsbEx">Serverless Framework</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="eeFohSuWWq">
                            <label for="eeFohSuWWq">Terraform</label>
                            <ul>
                                <l>
                                    <input type="checkbox" id="lpWZKRMRXI">
                                    <label for="lpWZKRMRXI">Functions</label>
                                    <ul>
                                ...
                                <l>
                                    <input type="checkbox" id="yxcyAGjskT">
                                    <label for="yxcyAGjskT">Meta Arguments</label>
                                    <ul>
                ...
                <l>
                    <input type="checkbox" id="biuKqwNZGn">
                    <label for="biuKqwNZGn">Docker</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="XNNgXbHaiA">
                    <label for="XNNgXbHaiA">Dotnet</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="zfxCRXwEXc">
                            <label for="zfxCRXwEXc">Cli</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="pVeSkpqWGk">
                    <label for="pVeSkpqWGk">Functional Programming</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="LHchnjPPPY">
                    <label for="LHchnjPPPY">Git</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="bkgOmzAAZQ">
                            <label for="bkgOmzAAZQ">Github</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="uZovXatjkf">
                    <label for="uZovXatjkf">Go</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="ygCbNrWXEi">
                    <label for="ygCbNrWXEi">Haskell</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="mAcCXahEtv">
                    <label for="mAcCXahEtv">Js</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="VqOBwjICYc">
                            <label for="VqOBwjICYc">Node</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="mPzPtwLezY">
                            <label for="mPzPtwLezY">D3</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="oDlQscJnGp">
                            <label for="oDlQscJnGp">Mocha</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="sHmENvCOTF">
                            <label for="sHmENvCOTF">P5js</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="qmmWFlzOPR">
                            <label for="qmmWFlzOPR">Typescript</label>
                            <ul>
                                <l>
                                    <input type="checkbox" id="mJHJtRGNga">
                                    <label for="mJHJtRGNga">Testing</label>
                                    <ul>
                ...
                <l>
                    <input type="checkbox" id="QPQuxpMxzB">
                    <label for="QPQuxpMxzB">Kafka</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="svDJWhrdWS">
                    <label for="svDJWhrdWS">Kubernetes</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="CWCkWMbHXt">
                    <label for="CWCkWMbHXt">Language</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="pxSvxAOUwd">
                    <label for="pxSvxAOUwd">Linux</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="escuPtcAwa">
                            <label for="escuPtcAwa">Bash</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="lLpuCvRCar">
                    <label for="lLpuCvRCar">Oauth</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="IcdInxykLt">
                    <label for="IcdInxykLt">Prometheus</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="YswqIyqhsI">
                    <label for="YswqIyqhsI">Python</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="HyrUyFqwfr">
                            <label for="HyrUyFqwfr">Data Classes</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="vtXvwlYHFa">
                            <label for="vtXvwlYHFa">Libraries</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="jNAVgIwKSm">
                    <label for="jNAVgIwKSm">React</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="yOtTtpDOFq">
                    <label for="yOtTtpDOFq">Regular Expressions</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="DoHSppktZZ">
                    <label for="DoHSppktZZ">Rust</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="lfWGYxoOjD">
                            <label for="lfWGYxoOjD">Serde</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="RgcSUNDvpH">
                    <label for="RgcSUNDvpH">Shaders</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="dLtkTarcSW">
                            <label for="dLtkTarcSW">Glsl</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="EsnhwIFgKT">
                    <label for="EsnhwIFgKT">Vim</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="BWXygHGuIG">
                    <label for="BWXygHGuIG">Web</label>
                    <ul>
