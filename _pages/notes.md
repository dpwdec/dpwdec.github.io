...
<ul>
    <div name="contents-index">
        ...
        <l>
            <input type="checkbox" id="NVGFXRacgw" checked>
            <label for="NVGFXRacgw">Math</label>
            <ul>
                <l>
                    <input type="checkbox" id="FKQbTvPIqD">
                    <label for="FKQbTvPIqD">Exponentials</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="FKuHcLVlvW">
                    <label for="FKuHcLVlvW">Linear Algebra</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="GIkZNDguAI">
                    <label for="GIkZNDguAI">Logarithms</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="oNGoyTKjjR">
                    <label for="oNGoyTKjjR">Sequences</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="EBbYiOsCPu">
                    <label for="EBbYiOsCPu">Single Variable Calculus</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="ZXqswdZmbe">
                    <label for="ZXqswdZmbe">Trigonometry</label>
                    <ul>
        ...
        <l>
            <input type="checkbox" id="mvjkWYvnZQ" checked>
            <label for="mvjkWYvnZQ">Programming</label>
            <ul>
                <l>
                    <input type="checkbox" id="ECKudZPSUK">
                    <label for="ECKudZPSUK">Ansible</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="hIZzpJkuis">
                    <label for="hIZzpJkuis">Architecture</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="hhAPdgLrte">
                    <label for="hhAPdgLrte">Computer Graphics</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="hzcBeaMBiM">
                    <label for="hzcBeaMBiM">Databases</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="HCXBHsMrKT">
                    <label for="HCXBHsMrKT">Devops</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="wOPFSvTUcW">
                            <label for="wOPFSvTUcW">Cloud Providers</label>
                            <ul>
                                <l>
                                    <input type="checkbox" id="PsmAkGMEBy">
                                    <label for="PsmAkGMEBy">AWS</label>
                                    <ul>
                                        <l>
                                            <input type="checkbox" id="fiGrjzvQNj">
                                            <label for="fiGrjzvQNj">Cli</label>
                                            <ul>
                                        ...
                                        <l>
                                            <input type="checkbox" id="oUWftrGQzo">
                                            <label for="oUWftrGQzo">Dotnet</label>
                                            <ul>
                                        ...
                                        <l>
                                            <input type="checkbox" id="ppFyUvRQaJ">
                                            <label for="ppFyUvRQaJ">Ec 2</label>
                                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="CBJtKbMOYH">
                            <label for="CBJtKbMOYH">Events</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="fPNIdRAFES">
                            <label for="fPNIdRAFES">Localstack</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="xvODpxvWIQ">
                            <label for="xvODpxvWIQ">Pulumi</label>
                            <ul>
                                <l>
                                    <input type="checkbox" id="YWQhrQmlmu">
                                    <label for="YWQhrQmlmu">Dotnet</label>
                                    <ul>
                        ...
                        <l>
                            <input type="checkbox" id="GylDwXbLFn">
                            <label for="GylDwXbLFn">Serverless Framework</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="QBOVhGZDns">
                            <label for="QBOVhGZDns">Terraform</label>
                            <ul>
                                <l>
                                    <input type="checkbox" id="PCNnbuDoMa">
                                    <label for="PCNnbuDoMa">Functions</label>
                                    <ul>
                                ...
                                <l>
                                    <input type="checkbox" id="TwUyBpzOYP">
                                    <label for="TwUyBpzOYP">Meta Arguments</label>
                                    <ul>
                ...
                <l>
                    <input type="checkbox" id="ThrDDfKeIg">
                    <label for="ThrDDfKeIg">Docker</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="qhNYQjsZYp">
                    <label for="qhNYQjsZYp">Dotnet</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="YJgxtDRkkX">
                            <label for="YJgxtDRkkX">Cli</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="CfjiletRsC">
                    <label for="CfjiletRsC">Functional Programming</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="ObvDCaGaEF">
                    <label for="ObvDCaGaEF">Git</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="gPxRzkoyyP">
                            <label for="gPxRzkoyyP">Github</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="AtijXRSqaL">
                    <label for="AtijXRSqaL">Go</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="RdIfOadnFp">
                    <label for="RdIfOadnFp">Haskell</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="lmRpFUHKiQ">
                    <label for="lmRpFUHKiQ">Js</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="TKBgKgVHcA">
                            <label for="TKBgKgVHcA">Node</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="VkxOBvoGGA">
                            <label for="VkxOBvoGGA">D3</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="TYAvfxiHFG">
                            <label for="TYAvfxiHFG">Mocha</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="gmECkzSkkZ">
                            <label for="gmECkzSkkZ">P5js</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="KhIWpoQwUC">
                            <label for="KhIWpoQwUC">Typescript</label>
                            <ul>
                                <l>
                                    <input type="checkbox" id="YJGSmCRzEL">
                                    <label for="YJGSmCRzEL">Testing</label>
                                    <ul>
                ...
                <l>
                    <input type="checkbox" id="GpbOfQbylG">
                    <label for="GpbOfQbylG">Kafka</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="TbLxJlabbe">
                    <label for="TbLxJlabbe">Kubernetes</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="HOcYjJttSR">
                    <label for="HOcYjJttSR">Language</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="ZEUoAnGpyS">
                    <label for="ZEUoAnGpyS">Linux</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="nTweQqXuSQ">
                            <label for="nTweQqXuSQ">Bash</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="GRgwrGkTfM">
                    <label for="GRgwrGkTfM">Oauth</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="ZALMPRoXCf">
                    <label for="ZALMPRoXCf">Prometheus</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="PxXHBxTEkc">
                    <label for="PxXHBxTEkc">Python</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="dtznhzSXwM">
                            <label for="dtznhzSXwM">Data Classes</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="cgETUpmxqb">
                            <label for="cgETUpmxqb">Libraries</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="zuloUhYVkf">
                    <label for="zuloUhYVkf">React</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="byvfbBwklJ">
                    <label for="byvfbBwklJ">Regular Expressions</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="DVSievovOO">
                    <label for="DVSievovOO">Rust</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="UzCLJsygkp">
                            <label for="UzCLJsygkp">Serde</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="rxOGBLipko">
                    <label for="rxOGBLipko">Shaders</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="hvmzmAFYUH">
                            <label for="hvmzmAFYUH">Glsl</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="ffIrGiuAhj">
                    <label for="ffIrGiuAhj">Vim</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="tsuxcGAjUd">
                    <label for="tsuxcGAjUd">Web</label>
                    <ul>
