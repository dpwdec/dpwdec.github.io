...
<ul>
    <div name="contents-index">
        ...
        <l>
            <input type="checkbox" id="HOenGsRhbH" checked>
            <label for="HOenGsRhbH">Math</label>
            <ul>
                <l>
                    <input type="checkbox" id="tmEDUWFlWR">
                    <label for="tmEDUWFlWR">Exponentials</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="xQuweGfzYA">
                    <label for="xQuweGfzYA">Linear Algebra</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="cAWQwgUMtp">
                    <label for="cAWQwgUMtp">Logarithms</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="ntKflKRRnl">
                    <label for="ntKflKRRnl">Sequences</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="mclbyqusmK">
                    <label for="mclbyqusmK">Single Variable Calculus</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="UEIqCSboDh">
                    <label for="UEIqCSboDh">Trigonometry</label>
                    <ul>
        ...
        <l>
            <input type="checkbox" id="wFJMomhpOn" checked>
            <label for="wFJMomhpOn">Programming</label>
            <ul>
                <l>
                    <input type="checkbox" id="SjuvbTityl">
                    <label for="SjuvbTityl">Ansible</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="hwNCJpXLrS">
                    <label for="hwNCJpXLrS">Architecture</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="oDiCXiJrZo">
                    <label for="oDiCXiJrZo">Computer Graphics</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="WRQFVXevGp">
                    <label for="WRQFVXevGp">Databases</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="ubYDilSCBQ">
                    <label for="ubYDilSCBQ">Devops</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="nljGxNGyWO">
                            <label for="nljGxNGyWO">Cloud Providers</label>
                            <ul>
                                <l>
                                    <input type="checkbox" id="PfblsHJwFb">
                                    <label for="PfblsHJwFb">AWS</label>
                                    <ul>
                                        <l>
                                            <input type="checkbox" id="sAzOpCoDEF">
                                            <label for="sAzOpCoDEF">Cli</label>
                                            <ul>
                                        ...
                                        <l>
                                            <input type="checkbox" id="XvTpJVVcmH">
                                            <label for="XvTpJVVcmH">Dotnet</label>
                                            <ul>
                                        ...
                                        <l>
                                            <input type="checkbox" id="WETSmtYRwB">
                                            <label for="WETSmtYRwB">Ec 2</label>
                                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="dXbefxTtfB">
                            <label for="dXbefxTtfB">Events</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="QfymgiWpoC">
                            <label for="QfymgiWpoC">Localstack</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="rjwbccTxHN">
                            <label for="rjwbccTxHN">Pulumi</label>
                            <ul>
                                <l>
                                    <input type="checkbox" id="UatIEXXhnn">
                                    <label for="UatIEXXhnn">Dotnet</label>
                                    <ul>
                        ...
                        <l>
                            <input type="checkbox" id="NrNenJlrSf">
                            <label for="NrNenJlrSf">Serverless Framework</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="pjaQzOFVDs">
                            <label for="pjaQzOFVDs">Terraform</label>
                            <ul>
                                <l>
                                    <input type="checkbox" id="IzbzfGzpeT">
                                    <label for="IzbzfGzpeT">Functions</label>
                                    <ul>
                                ...
                                <l>
                                    <input type="checkbox" id="vDisVOrszP">
                                    <label for="vDisVOrszP">Meta Arguments</label>
                                    <ul>
                ...
                <l>
                    <input type="checkbox" id="GpMjhRWiGN">
                    <label for="GpMjhRWiGN">Docker</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="ItYCmJkVkz">
                    <label for="ItYCmJkVkz">Dotnet</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="CBBLcTXmYc">
                            <label for="CBBLcTXmYc">Cli</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="MJwtSLUwIN">
                    <label for="MJwtSLUwIN">Functional Programming</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="PHfotsqeWN">
                    <label for="PHfotsqeWN">Git</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="DQsvkkabXc">
                            <label for="DQsvkkabXc">Github</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="knpUclBbmX">
                    <label for="knpUclBbmX">Go</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="lqyWdBuDyr">
                    <label for="lqyWdBuDyr">Haskell</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="MNCrndELsM">
                    <label for="MNCrndELsM">Js</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="XsQmZjWvyz">
                            <label for="XsQmZjWvyz">Node</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="GKDCIAvTur">
                            <label for="GKDCIAvTur">D3</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="TVKTPDLHbT">
                            <label for="TVKTPDLHbT">Mocha</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="ywrmoYsCbC">
                            <label for="ywrmoYsCbC">P5js</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="YExEctCMUL">
                            <label for="YExEctCMUL">Typescript</label>
                            <ul>
                                <l>
                                    <input type="checkbox" id="rrOPGmrUrl">
                                    <label for="rrOPGmrUrl">Testing</label>
                                    <ul>
                ...
                <l>
                    <input type="checkbox" id="SVFCEhAxGI">
                    <label for="SVFCEhAxGI">Kafka</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="koEIbsQqTh">
                    <label for="koEIbsQqTh">Kubernetes</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="EdPUDfHKOs">
                    <label for="EdPUDfHKOs">Language</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="GydJHDKlOG">
                    <label for="GydJHDKlOG">Linux</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="AhcOKSPGrY">
                            <label for="AhcOKSPGrY">Bash</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="UolpvCYGGZ">
                    <label for="UolpvCYGGZ">Oauth</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="NmBvXVhlZX">
                    <label for="NmBvXVhlZX">Python</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="dQohdYHwWs">
                            <label for="dQohdYHwWs">Data Classes</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="AokImsdyXf">
                            <label for="AokImsdyXf">Libraries</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="qOSsyNxisS">
                    <label for="qOSsyNxisS">React</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="eIwXtRwsce">
                    <label for="eIwXtRwsce">Regular Expressions</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="ELCGRfBmjg">
                    <label for="ELCGRfBmjg">Rust</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="LtNTGGZvMj">
                            <label for="LtNTGGZvMj">Serde</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="URQjTiyWkY">
                    <label for="URQjTiyWkY">Vim</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="iQiOwlpdfy">
                    <label for="iQiOwlpdfy">Web</label>
                    <ul>
