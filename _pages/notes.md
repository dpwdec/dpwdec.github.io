...
<ul>
    <div name="contents-index">
        ...
        <l>
            <input type="checkbox" id="FNbLveEvlA" checked>
            <label for="FNbLveEvlA">Math</label>
            <ul>
                <l>
                    <input type="checkbox" id="oSqBoKzzzc">
                    <label for="oSqBoKzzzc">Exponentials</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="UwnDnYGOBV">
                    <label for="UwnDnYGOBV">Linear Algebra</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="XzzYXdeXAk">
                    <label for="XzzYXdeXAk">Logarithms</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="YmnUbhKdsW">
                    <label for="YmnUbhKdsW">Sequences</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="CyAshKewAQ">
                    <label for="CyAshKewAQ">Single Variable Calculus</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="wiKYAjXTKq">
                    <label for="wiKYAjXTKq">Trigonometry</label>
                    <ul>
        ...
        <l>
            <input type="checkbox" id="jSeNJZmRww" checked>
            <label for="jSeNJZmRww">Programming</label>
            <ul>
                <l>
                    <input type="checkbox" id="OlzKRJHSkE">
                    <label for="OlzKRJHSkE">Ansible</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="SeBQPOPDMP">
                    <label for="SeBQPOPDMP">Architecture</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="CNgsuIJeAp">
                    <label for="CNgsuIJeAp">Computer Graphics</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="iyuDyFEMQD">
                    <label for="iyuDyFEMQD">Databases</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="VUIaYkTMKX">
                    <label for="VUIaYkTMKX">Devops</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="oWyTlHIEBg">
                            <label for="oWyTlHIEBg">Cloud Providers</label>
                            <ul>
                                <l>
                                    <input type="checkbox" id="SkqvfqiDgJ">
                                    <label for="SkqvfqiDgJ">AWS</label>
                                    <ul>
                                        <l>
                                            <input type="checkbox" id="tCpqRVVMDJ">
                                            <label for="tCpqRVVMDJ">Cli</label>
                                            <ul>
                                        ...
                                        <l>
                                            <input type="checkbox" id="DbRTCGczzR">
                                            <label for="DbRTCGczzR">Dotnet</label>
                                            <ul>
                                        ...
                                        <l>
                                            <input type="checkbox" id="bQkyaDmUBq">
                                            <label for="bQkyaDmUBq">Ec 2</label>
                                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="ovjnbwheHW">
                            <label for="ovjnbwheHW">Events</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="PQcQNonrvj">
                            <label for="PQcQNonrvj">Localstack</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="esXxkPbitZ">
                            <label for="esXxkPbitZ">Pulumi</label>
                            <ul>
                                <l>
                                    <input type="checkbox" id="NwOfDSdLGQ">
                                    <label for="NwOfDSdLGQ">Dotnet</label>
                                    <ul>
                        ...
                        <l>
                            <input type="checkbox" id="HnaCAnMzjR">
                            <label for="HnaCAnMzjR">Serverless Framework</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="yfArHbVHCZ">
                            <label for="yfArHbVHCZ">Terraform</label>
                            <ul>
                                <l>
                                    <input type="checkbox" id="rDieQryBZH">
                                    <label for="rDieQryBZH">Functions</label>
                                    <ul>
                                ...
                                <l>
                                    <input type="checkbox" id="hChqzWOwdy">
                                    <label for="hChqzWOwdy">Meta Arguments</label>
                                    <ul>
                ...
                <l>
                    <input type="checkbox" id="iwIcZZsoeE">
                    <label for="iwIcZZsoeE">Docker</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="UMiVDSBvsS">
                    <label for="UMiVDSBvsS">Dotnet</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="ZnnnoNSFoV">
                            <label for="ZnnnoNSFoV">Cli</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="cktCLGJNdz">
                    <label for="cktCLGJNdz">Functional Programming</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="VeXgkbkSaS">
                    <label for="VeXgkbkSaS">Git</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="LfDbqHZVok">
                            <label for="LfDbqHZVok">Github</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="slWAtdhxvQ">
                    <label for="slWAtdhxvQ">Go</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="ZutpRoglJO">
                    <label for="ZutpRoglJO">Haskell</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="lVWmkoUmng">
                    <label for="lVWmkoUmng">Js</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="LhRXTiNyTY">
                            <label for="LhRXTiNyTY">Node</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="DXXSvpHMQO">
                            <label for="DXXSvpHMQO">D3</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="LfELMenapi">
                            <label for="LfELMenapi">Mocha</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="oEAezAEPCP">
                            <label for="oEAezAEPCP">P5js</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="LbHcTFRRBV">
                            <label for="LbHcTFRRBV">Typescript</label>
                            <ul>
                                <l>
                                    <input type="checkbox" id="veSHdXUYLe">
                                    <label for="veSHdXUYLe">Testing</label>
                                    <ul>
                ...
                <l>
                    <input type="checkbox" id="bKjSvCcTxp">
                    <label for="bKjSvCcTxp">Kafka</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="lCbExltKAP">
                    <label for="lCbExltKAP">Kubernetes</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="SHFwraLCZi">
                    <label for="SHFwraLCZi">Language</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="HxsgsrOEUu">
                    <label for="HxsgsrOEUu">Linux</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="FVamrjShzj">
                            <label for="FVamrjShzj">Bash</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="aDaBCeHIVS">
                    <label for="aDaBCeHIVS">Oauth</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="YhekAUiBJJ">
                    <label for="YhekAUiBJJ">Prometheus</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="kgWFcEmVvf">
                    <label for="kgWFcEmVvf">Python</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="RmzctpptEp">
                            <label for="RmzctpptEp">Data Classes</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="glIeAEVdDH">
                            <label for="glIeAEVdDH">Libraries</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="YazoXZmLhs">
                    <label for="YazoXZmLhs">React</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="uHuzZSWtpl">
                    <label for="uHuzZSWtpl">Regular Expressions</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="KoWfAUtDUi">
                    <label for="KoWfAUtDUi">Rust</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="UOtHmaGvQP">
                            <label for="UOtHmaGvQP">Serde</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="SzEoshKvuQ">
                    <label for="SzEoshKvuQ">Shaders</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="DzZwAhbsgt">
                            <label for="DzZwAhbsgt">Glsl</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="vuqrUgicJa">
                    <label for="vuqrUgicJa">Vim</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="qTuAZwpyxK">
                    <label for="qTuAZwpyxK">Web</label>
                    <ul>
