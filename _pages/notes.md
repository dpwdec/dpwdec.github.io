...
<ul>
    <div name="contents-index">
        ...
        <l>
            <input type="checkbox" id="LVWCEgMaRH" checked>
            <label for="LVWCEgMaRH">Math</label>
            <ul>
                <l>
                    <input type="checkbox" id="LhDvZMenFa">
                    <label for="LhDvZMenFa">Exponentials</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="DOrvoXBMDe">
                    <label for="DOrvoXBMDe">Linear Algebra</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="QCjwsKLNeX">
                    <label for="QCjwsKLNeX">Logarithms</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="eTzETeupnk">
                    <label for="eTzETeupnk">Sequences</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="TDMlkwTJmc">
                    <label for="TDMlkwTJmc">Single Variable Calculus</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="QOwkxFADDM">
                    <label for="QOwkxFADDM">Trigonometry</label>
                    <ul>
        ...
        <l>
            <input type="checkbox" id="TWlZzzaSLj" checked>
            <label for="TWlZzzaSLj">Programming</label>
            <ul>
                <l>
                    <input type="checkbox" id="HPdLrjJBme">
                    <label for="HPdLrjJBme">Ansible</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="IeOzVuYiMI">
                    <label for="IeOzVuYiMI">Architecture</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="cvKaFtgutd">
                    <label for="cvKaFtgutd">Computer Graphics</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="cZzolevZbH">
                    <label for="cZzolevZbH">Databases</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="GnWOKQIcbJ">
                    <label for="GnWOKQIcbJ">Devops</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="hwOFYhHRyP">
                            <label for="hwOFYhHRyP">Cloud Computing</label>
                            <ul>
                                <l>
                                    <input type="checkbox" id="LnWqOJvLeC">
                                    <label for="LnWqOJvLeC">AWS</label>
                                    <ul>
                                        <l>
                                            <input type="checkbox" id="XHEvbtMLRg">
                                            <label for="XHEvbtMLRg">Cli</label>
                                            <ul>
                                        ...
                                        <l>
                                            <input type="checkbox" id="HCpKJccFCa">
                                            <label for="HCpKJccFCa">Dotnet</label>
                                            <ul>
                                        ...
                                        <l>
                                            <input type="checkbox" id="QmHfzEzkNc">
                                            <label for="QmHfzEzkNc">Ec 2</label>
                                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="CkpnOWPzXs">
                            <label for="CkpnOWPzXs">Events</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="QczyisssLd">
                            <label for="QczyisssLd">Localstack</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="PWnOqxmXdh">
                            <label for="PWnOqxmXdh">Oauth</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="UawcfNXaaf">
                            <label for="UawcfNXaaf">Pulumi</label>
                            <ul>
                                <l>
                                    <input type="checkbox" id="RTwpTUPltk">
                                    <label for="RTwpTUPltk">Dotnet</label>
                                    <ul>
                        ...
                        <l>
                            <input type="checkbox" id="fBSqcVYySx">
                            <label for="fBSqcVYySx">Terraform</label>
                            <ul>
                                <l>
                                    <input type="checkbox" id="DhYenfKXzp">
                                    <label for="DhYenfKXzp">Functions</label>
                                    <ul>
                                ...
                                <l>
                                    <input type="checkbox" id="CTdIKdAvQB">
                                    <label for="CTdIKdAvQB">Meta Arguments</label>
                                    <ul>
                ...
                <l>
                    <input type="checkbox" id="kHnNevWkxS">
                    <label for="kHnNevWkxS">Docker</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="fBvFSZbhoy">
                    <label for="fBvFSZbhoy">Dotnet</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="aHgKQdkzkq">
                            <label for="aHgKQdkzkq">Cli</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="ReatRjxSVo">
                    <label for="ReatRjxSVo">Functional Programming</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="QNDMdYaQMT">
                    <label for="QNDMdYaQMT">Git</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="PSbBMEfjwD">
                            <label for="PSbBMEfjwD">Github</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="xJHEJrhUPX">
                    <label for="xJHEJrhUPX">Go</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="IPpIpUWOUq">
                    <label for="IPpIpUWOUq">Haskell</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="aKbDRBuWHc">
                    <label for="aKbDRBuWHc">Js</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="QYOGlcXHdH">
                            <label for="QYOGlcXHdH">Node</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="bMXUbsgRpa">
                            <label for="bMXUbsgRpa">D3</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="pDwASnHQNx">
                            <label for="pDwASnHQNx">Mocha</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="ISmvCBYxGi">
                            <label for="ISmvCBYxGi">P5js</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="nrpbRBJfzO">
                            <label for="nrpbRBJfzO">Typescript</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="mCPUxqKmwl">
                    <label for="mCPUxqKmwl">Kafka</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="ImcLaqRUaL">
                    <label for="ImcLaqRUaL">Kubernetes</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="nNskkdOxTE">
                    <label for="nNskkdOxTE">Language</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="VcMCLBhzeC">
                    <label for="VcMCLBhzeC">Linux</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="LjChgSXonW">
                    <label for="LjChgSXonW">Python</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="eOHaQtSgtq">
                            <label for="eOHaQtSgtq">Data Classes</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="GZtFaFKwXK">
                            <label for="GZtFaFKwXK">Libraries</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="UwIxTqRKWo">
                    <label for="UwIxTqRKWo">React</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="PIMxgiUsOF">
                    <label for="PIMxgiUsOF">Regular Expressions</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="ZLqxebQgWP">
                    <label for="ZLqxebQgWP">Rust</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="QWrCNhfVmZ">
                            <label for="QWrCNhfVmZ">Serde</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="HbWFCHZLOk">
                    <label for="HbWFCHZLOk">Vim</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="roMakxpAjI">
                    <label for="roMakxpAjI">Web</label>
                    <ul>
