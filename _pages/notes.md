...
<ul>
    <div name="contents-index">
        ...
        <l>
            <input type="checkbox" id="XjIYXaADdH" checked>
            <label for="XjIYXaADdH">Math</label>
            <ul>
                <l>
                    <input type="checkbox" id="kjYsZWpcxQ">
                    <label for="kjYsZWpcxQ">Exponentials</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="nVQIyNAHsy">
                    <label for="nVQIyNAHsy">Linear Algebra</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="wZDtlhJlzG">
                    <label for="wZDtlhJlzG">Logarithms</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="tWvasBhvOR">
                    <label for="tWvasBhvOR">Sequences</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="KOZtbIPsvL">
                    <label for="KOZtbIPsvL">Single Variable Calculus</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="UYgSnVyzlp">
                    <label for="UYgSnVyzlp">Trigonometry</label>
                    <ul>
        ...
        <l>
            <input type="checkbox" id="lrdPxDmmZO" checked>
            <label for="lrdPxDmmZO">Programming</label>
            <ul>
                <l>
                    <input type="checkbox" id="GpDJHRDTcp">
                    <label for="GpDJHRDTcp">Ansible</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="EqaZAFEaty">
                    <label for="EqaZAFEaty">Architecture</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="wZXLOQGrKq">
                    <label for="wZXLOQGrKq">Computer Graphics</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="EgWiyQWndc">
                    <label for="EgWiyQWndc">Databases</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="ixpuuaJmah">
                    <label for="ixpuuaJmah">Devops</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="tVwZcqafnl">
                            <label for="tVwZcqafnl">Cloud Computing</label>
                            <ul>
                                <l>
                                    <input type="checkbox" id="ZUrusPMGzh">
                                    <label for="ZUrusPMGzh">AWS</label>
                                    <ul>
                                        <l>
                                            <input type="checkbox" id="LjpoQqBeUp">
                                            <label for="LjpoQqBeUp">Ec 2</label>
                                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="DJxWpdwpob">
                            <label for="DJxWpdwpob">Events</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="AgYYcfvqHn">
                            <label for="AgYYcfvqHn">Oauth</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="AvTQFfeHsg">
                            <label for="AvTQFfeHsg">Pulumi</label>
                            <ul>
                                <l>
                                    <input type="checkbox" id="YAiOfjfdlg">
                                    <label for="YAiOfjfdlg">Dotnet</label>
                                    <ul>
                        ...
                        <l>
                            <input type="checkbox" id="KNZLvyxNkq">
                            <label for="KNZLvyxNkq">Terraform</label>
                            <ul>
                                <l>
                                    <input type="checkbox" id="uKQncMZVJU">
                                    <label for="uKQncMZVJU">Functions</label>
                                    <ul>
                                ...
                                <l>
                                    <input type="checkbox" id="BdqChIgEEF">
                                    <label for="BdqChIgEEF">Meta Arguments</label>
                                    <ul>
                ...
                <l>
                    <input type="checkbox" id="kGAyVjrmTR">
                    <label for="kGAyVjrmTR">Docker</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="qoreBAswFQ">
                    <label for="qoreBAswFQ">Dotnet</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="ZyeeYeZoJJ">
                            <label for="ZyeeYeZoJJ">Cli</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="KJoLRuugZL">
                    <label for="KJoLRuugZL">Functional Programming</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="lCsOwzSJKw">
                    <label for="lCsOwzSJKw">Git</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="nATFdcahsv">
                            <label for="nATFdcahsv">Github</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="HMEZanndix">
                    <label for="HMEZanndix">Go</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="dZVwXcBlnB">
                    <label for="dZVwXcBlnB">Haskell</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="yOameBgPnV">
                    <label for="yOameBgPnV">Js</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="kDZtwzwDhy">
                            <label for="kDZtwzwDhy">Node</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="IypXQxyaSk">
                            <label for="IypXQxyaSk">Mocha</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="dwUyQbKmOP">
                            <label for="dwUyQbKmOP">P5js</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="zOWOZzhCnQ">
                            <label for="zOWOZzhCnQ">Typescript</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="lmyGCduQhR">
                    <label for="lmyGCduQhR">Kafka</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="wTktmZARdI">
                    <label for="wTktmZARdI">Kubernetes</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="yKjZLKRYtF">
                    <label for="yKjZLKRYtF">Language</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="etTWMdKSGd">
                    <label for="etTWMdKSGd">Linux</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="MyGNgstuma">
                    <label for="MyGNgstuma">Python</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="STqDRuUUgq">
                            <label for="STqDRuUUgq">Data Classes</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="siyVVjXsUR">
                            <label for="siyVVjXsUR">Libraries</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="eyCtoUZLAS">
                    <label for="eyCtoUZLAS">React</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="PAQiYOypzu">
                    <label for="PAQiYOypzu">Regular Expressions</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="GPMXzFEetR">
                    <label for="GPMXzFEetR">Rust</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="QvyvTRdctx">
                            <label for="QvyvTRdctx">Serde</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="ZgrrxlVVEi">
                    <label for="ZgrrxlVVEi">Vim</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="RrWHDlaeaI">
                    <label for="RrWHDlaeaI">Web</label>
                    <ul>
