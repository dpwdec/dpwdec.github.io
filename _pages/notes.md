...
<ul>
    <div name="contents-index">
        ...
        <l>
            <input type="checkbox" id="wBvcVOqJRW" checked>
            <label for="wBvcVOqJRW">Math</label>
            <ul>
                <l>
                    <input type="checkbox" id="DpUAnSRJAx">
                    <label for="DpUAnSRJAx">Exponentials</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="OcWjgzZekw">
                    <label for="OcWjgzZekw">Linear Algebra</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="tCHfXgYDGH">
                    <label for="tCHfXgYDGH">Logarithms</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="VLhKfDRLIa">
                    <label for="VLhKfDRLIa">Sequences</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="dWYcxbAinH">
                    <label for="dWYcxbAinH">Single Variable Calculus</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="FCYoJSfXPC">
                    <label for="FCYoJSfXPC">Trigonometry</label>
                    <ul>
        ...
        <l>
            <input type="checkbox" id="UVqWrNxviS" checked>
            <label for="UVqWrNxviS">Programming</label>
            <ul>
                <l>
                    <input type="checkbox" id="aIoyZMbmyA">
                    <label for="aIoyZMbmyA">Ansible</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="JSEYlbxThh">
                    <label for="JSEYlbxThh">Architecture</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="wBUwLRKVxc">
                    <label for="wBUwLRKVxc">Computer Graphics</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="ghBqaQOfyW">
                    <label for="ghBqaQOfyW">Databases</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="dnrKVwRDUL">
                    <label for="dnrKVwRDUL">Devops</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="BaBwiGuVDl">
                            <label for="BaBwiGuVDl">Cloud Providers</label>
                            <ul>
                                <l>
                                    <input type="checkbox" id="CrhVJtebCL">
                                    <label for="CrhVJtebCL">AWS</label>
                                    <ul>
                                        <l>
                                            <input type="checkbox" id="BmRxTuLtmX">
                                            <label for="BmRxTuLtmX">Cli</label>
                                            <ul>
                                        ...
                                        <l>
                                            <input type="checkbox" id="nglXNDyBfc">
                                            <label for="nglXNDyBfc">Dotnet</label>
                                            <ul>
                                        ...
                                        <l>
                                            <input type="checkbox" id="ItkgnUoFEP">
                                            <label for="ItkgnUoFEP">Ec 2</label>
                                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="ivDyiYYLhp">
                            <label for="ivDyiYYLhp">Events</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="urKuduQyvD">
                            <label for="urKuduQyvD">Localstack</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="YjdqBfMOoI">
                            <label for="YjdqBfMOoI">Pulumi</label>
                            <ul>
                                <l>
                                    <input type="checkbox" id="auhwCzmHhq">
                                    <label for="auhwCzmHhq">Dotnet</label>
                                    <ul>
                        ...
                        <l>
                            <input type="checkbox" id="SaFBaPcDoq">
                            <label for="SaFBaPcDoq">Serverless Framework</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="itSNPdqARr">
                            <label for="itSNPdqARr">Terraform</label>
                            <ul>
                                <l>
                                    <input type="checkbox" id="YQpVktMuds">
                                    <label for="YQpVktMuds">Functions</label>
                                    <ul>
                                ...
                                <l>
                                    <input type="checkbox" id="OJJvvfbxCl">
                                    <label for="OJJvvfbxCl">Meta Arguments</label>
                                    <ul>
                ...
                <l>
                    <input type="checkbox" id="eIzgiqtedJ">
                    <label for="eIzgiqtedJ">Docker</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="cDOOYJgidX">
                    <label for="cDOOYJgidX">Dotnet</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="lmqJYQTLFJ">
                            <label for="lmqJYQTLFJ">Cli</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="lkwJhyUYJQ">
                    <label for="lkwJhyUYJQ">Functional Programming</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="mDmzzToXjc">
                    <label for="mDmzzToXjc">Git</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="uXJygvVoWW">
                            <label for="uXJygvVoWW">Github</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="aDShmHHSVJ">
                    <label for="aDShmHHSVJ">Go</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="LNZsuHmSsE">
                    <label for="LNZsuHmSsE">Haskell</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="JFNAuCsRVo">
                    <label for="JFNAuCsRVo">Js</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="cFtMAwYHuX">
                            <label for="cFtMAwYHuX">Node</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="dBNSrvUSmf">
                            <label for="dBNSrvUSmf">D3</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="ijYHENlmkn">
                            <label for="ijYHENlmkn">Mocha</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="uZPEpqkIiZ">
                            <label for="uZPEpqkIiZ">P5js</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="KKfkZAmtoe">
                            <label for="KKfkZAmtoe">Typescript</label>
                            <ul>
                                <l>
                                    <input type="checkbox" id="GhxjkJasFZ">
                                    <label for="GhxjkJasFZ">Testing</label>
                                    <ul>
                ...
                <l>
                    <input type="checkbox" id="FAubxPTwdJ">
                    <label for="FAubxPTwdJ">Kafka</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="uxnEyUjHhx">
                    <label for="uxnEyUjHhx">Kubernetes</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="BQhQdNmHQR">
                    <label for="BQhQdNmHQR">Language</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="hqXiXcZUUX">
                    <label for="hqXiXcZUUX">Linux</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="lJITMafEox">
                            <label for="lJITMafEox">Bash</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="FMeKlIInPz">
                    <label for="FMeKlIInPz">Oauth</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="FJoLdLzgRX">
                    <label for="FJoLdLzgRX">Prometheus</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="pkgAeVhMgc">
                    <label for="pkgAeVhMgc">Python</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="dPRvYdyCJn">
                            <label for="dPRvYdyCJn">Data Classes</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="wtxDPNbWll">
                            <label for="wtxDPNbWll">Libraries</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="lCZZsoumLJ">
                    <label for="lCZZsoumLJ">React</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="ZskcWTheXa">
                    <label for="ZskcWTheXa">Regular Expressions</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="cOYXOaxmlO">
                    <label for="cOYXOaxmlO">Rust</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="uGkyYNHRSO">
                            <label for="uGkyYNHRSO">Serde</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="xCJFuxKwMr">
                    <label for="xCJFuxKwMr">Shaders</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="nhQgNfGIgY">
                            <label for="nhQgNfGIgY">Glsl</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="OFkuGCajGr">
                    <label for="OFkuGCajGr">Vim</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="iowPiOLERK">
                    <label for="iowPiOLERK">Web</label>
                    <ul>
