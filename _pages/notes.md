...
<ul>
    <div name="contents-index">
        ...
        <l>
            <input type="checkbox" id="RxmqjpxoFD" checked>
            <label for="RxmqjpxoFD">Math</label>
            <ul>
                <l>
                    <input type="checkbox" id="YQupUgZFMN">
                    <label for="YQupUgZFMN">Exponentials</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="gQHIfuIfPK">
                    <label for="gQHIfuIfPK">Linear Algebra</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="RojPfgWHPD">
                    <label for="RojPfgWHPD">Logarithms</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="OBzoFSCcVv">
                    <label for="OBzoFSCcVv">Sequences</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="vylQGmYspS">
                    <label for="vylQGmYspS">Single Variable Calculus</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="HqrCFoqUMH">
                    <label for="HqrCFoqUMH">Trigonometry</label>
                    <ul>
        ...
        <l>
            <input type="checkbox" id="LwFrmiSCuW" checked>
            <label for="LwFrmiSCuW">Programming</label>
            <ul>
                <l>
                    <input type="checkbox" id="dsEjJdicdU">
                    <label for="dsEjJdicdU">Ansible</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="BLmIjDTjGZ">
                    <label for="BLmIjDTjGZ">Architecture</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="xcMHdtaZNY">
                    <label for="xcMHdtaZNY">Computer Graphics</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="TUPWFuYjpP">
                    <label for="TUPWFuYjpP">Databases</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="ByzGfmjzfH">
                    <label for="ByzGfmjzfH">Devops</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="ExHlGygolf">
                            <label for="ExHlGygolf">Cloud Providers</label>
                            <ul>
                                <l>
                                    <input type="checkbox" id="bBAbzvJDrg">
                                    <label for="bBAbzvJDrg">AWS</label>
                                    <ul>
                                        <l>
                                            <input type="checkbox" id="ceJCfQIKNg">
                                            <label for="ceJCfQIKNg">Cli</label>
                                            <ul>
                                        ...
                                        <l>
                                            <input type="checkbox" id="JxdknoEbWL">
                                            <label for="JxdknoEbWL">Dotnet</label>
                                            <ul>
                                        ...
                                        <l>
                                            <input type="checkbox" id="NriSMJUpew">
                                            <label for="NriSMJUpew">Ec 2</label>
                                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="qTEWNEELSh">
                            <label for="qTEWNEELSh">Events</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="AXVuXmTZVe">
                            <label for="AXVuXmTZVe">Localstack</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="ZjiQHRdTNr">
                            <label for="ZjiQHRdTNr">Pulumi</label>
                            <ul>
                                <l>
                                    <input type="checkbox" id="VtEuOjbDDW">
                                    <label for="VtEuOjbDDW">Dotnet</label>
                                    <ul>
                        ...
                        <l>
                            <input type="checkbox" id="LOXSvJpdwz">
                            <label for="LOXSvJpdwz">Serverless Framework</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="xVLavYfwDn">
                            <label for="xVLavYfwDn">Terraform</label>
                            <ul>
                                <l>
                                    <input type="checkbox" id="TtXuusnBOw">
                                    <label for="TtXuusnBOw">Functions</label>
                                    <ul>
                                ...
                                <l>
                                    <input type="checkbox" id="gsReXSimfB">
                                    <label for="gsReXSimfB">Meta Arguments</label>
                                    <ul>
                ...
                <l>
                    <input type="checkbox" id="XRFBESdaUG">
                    <label for="XRFBESdaUG">Docker</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="rrfqCZurqs">
                    <label for="rrfqCZurqs">Dotnet</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="MZAZcZPQVj">
                            <label for="MZAZcZPQVj">Cli</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="JUNhpweYaB">
                    <label for="JUNhpweYaB">Functional Programming</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="JPakOIZSIJ">
                    <label for="JPakOIZSIJ">Git</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="PprgiNMGft">
                            <label for="PprgiNMGft">Github</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="uiAPIZaQMJ">
                    <label for="uiAPIZaQMJ">Go</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="HXbXgSOMKO">
                    <label for="HXbXgSOMKO">Haskell</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="LSWBxVAEIK">
                    <label for="LSWBxVAEIK">Js</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="dhGZJYfEpE">
                            <label for="dhGZJYfEpE">Node</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="AWvorfllRm">
                            <label for="AWvorfllRm">D3</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="ILAsTJyZsO">
                            <label for="ILAsTJyZsO">Mocha</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="hLfYfVhLrR">
                            <label for="hLfYfVhLrR">P5js</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="vLCjTXJKGp">
                            <label for="vLCjTXJKGp">Typescript</label>
                            <ul>
                                <l>
                                    <input type="checkbox" id="YnrmxMKdkz">
                                    <label for="YnrmxMKdkz">Testing</label>
                                    <ul>
                ...
                <l>
                    <input type="checkbox" id="BIltOxJPyc">
                    <label for="BIltOxJPyc">Kafka</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="mzpBEdnEzh">
                    <label for="mzpBEdnEzh">Kubernetes</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="PmvDELLGQs">
                    <label for="PmvDELLGQs">Language</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="fBQBRyOguC">
                    <label for="fBQBRyOguC">Linux</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="hpUomCuqps">
                            <label for="hpUomCuqps">Bash</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="vmlHNmtnLV">
                    <label for="vmlHNmtnLV">Oauth</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="WmiFgqgmIN">
                    <label for="WmiFgqgmIN">Prometheus</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="amyhnDdush">
                    <label for="amyhnDdush">Python</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="KzseYPzAgK">
                            <label for="KzseYPzAgK">Data Classes</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="FGlTwyQnHA">
                            <label for="FGlTwyQnHA">Libraries</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="AdKkKTpQlt">
                    <label for="AdKkKTpQlt">React</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="TziotsPlRD">
                    <label for="TziotsPlRD">Regular Expressions</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="LTbInmLsyQ">
                    <label for="LTbInmLsyQ">Rust</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="viXFHLaYcS">
                            <label for="viXFHLaYcS">Serde</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="KDPcYEVgSE">
                    <label for="KDPcYEVgSE">Shaders</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="DhjpilvJGe">
                            <label for="DhjpilvJGe">Glsl</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="ISugkosnhF">
                    <label for="ISugkosnhF">Vim</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="vWbIURXBgA">
                    <label for="vWbIURXBgA">Web</label>
                    <ul>
