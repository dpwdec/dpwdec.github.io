...
<ul>
    <div name="contents-index">
        ...
        <l>
            <input type="checkbox" id="acCxQUJfQO" checked>
            <label for="acCxQUJfQO">Math</label>
            <ul>
                <l>
                    <input type="checkbox" id="lNOYCkUAPG">
                    <label for="lNOYCkUAPG">Exponentials</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="fvklPoIigd">
                    <label for="fvklPoIigd">Linear Algebra</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="puuyKMCJEU">
                    <label for="puuyKMCJEU">Logarithms</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="prGEgEnBGY">
                    <label for="prGEgEnBGY">Sequences</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="SaHlkrItCA">
                    <label for="SaHlkrItCA">Single Variable Calculus</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="nAjrochkSx">
                    <label for="nAjrochkSx">Trigonometry</label>
                    <ul>
        ...
        <l>
            <input type="checkbox" id="negrCwRciU" checked>
            <label for="negrCwRciU">Programming</label>
            <ul>
                <l>
                    <input type="checkbox" id="ImUoaTxaqN">
                    <label for="ImUoaTxaqN">Ansible</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="bYHLGcgdlY">
                    <label for="bYHLGcgdlY">Architecture</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="DgpboxKbKb">
                    <label for="DgpboxKbKb">Computer Graphics</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="BsdxjsMwMy">
                    <label for="BsdxjsMwMy">Databases</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="PusSAUFAwE">
                    <label for="PusSAUFAwE">Devops</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="OfKrAnOyJU">
                            <label for="OfKrAnOyJU">Cloud Providers</label>
                            <ul>
                                <l>
                                    <input type="checkbox" id="UgUnCQCSIN">
                                    <label for="UgUnCQCSIN">AWS</label>
                                    <ul>
                                        <l>
                                            <input type="checkbox" id="uaqltipnik">
                                            <label for="uaqltipnik">Cli</label>
                                            <ul>
                                        ...
                                        <l>
                                            <input type="checkbox" id="VwcnfynRVz">
                                            <label for="VwcnfynRVz">Dotnet</label>
                                            <ul>
                                        ...
                                        <l>
                                            <input type="checkbox" id="TedDLYTbTi">
                                            <label for="TedDLYTbTi">Ec 2</label>
                                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="xrWismmdhF">
                            <label for="xrWismmdhF">Events</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="SkeTCRYKLv">
                            <label for="SkeTCRYKLv">Localstack</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="dcxHhfKMra">
                            <label for="dcxHhfKMra">Pulumi</label>
                            <ul>
                                <l>
                                    <input type="checkbox" id="LgPeQnCgVj">
                                    <label for="LgPeQnCgVj">Dotnet</label>
                                    <ul>
                        ...
                        <l>
                            <input type="checkbox" id="OPNQwtaLlM">
                            <label for="OPNQwtaLlM">Serverless Framework</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="gCbcjmeCyV">
                            <label for="gCbcjmeCyV">Terraform</label>
                            <ul>
                                <l>
                                    <input type="checkbox" id="hkDFJpCkxy">
                                    <label for="hkDFJpCkxy">Functions</label>
                                    <ul>
                                ...
                                <l>
                                    <input type="checkbox" id="oNrVGVzkwW">
                                    <label for="oNrVGVzkwW">Meta Arguments</label>
                                    <ul>
                ...
                <l>
                    <input type="checkbox" id="UdbYdHOpOx">
                    <label for="UdbYdHOpOx">Docker</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="WfVGxyzMxK">
                    <label for="WfVGxyzMxK">Dotnet</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="KFNFgkdVJm">
                            <label for="KFNFgkdVJm">Cli</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="wnujofIXDB">
                    <label for="wnujofIXDB">Functional Programming</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="KukHDnNUcL">
                    <label for="KukHDnNUcL">Git</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="AiHRKDCfGd">
                            <label for="AiHRKDCfGd">Github</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="sqCJRqDDwx">
                    <label for="sqCJRqDDwx">Go</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="KWZQzbdrSF">
                    <label for="KWZQzbdrSF">Haskell</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="xavbNtxtXl">
                    <label for="xavbNtxtXl">Js</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="TvBYoxPASQ">
                            <label for="TvBYoxPASQ">Node</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="MWiABWSAcf">
                            <label for="MWiABWSAcf">D3</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="ITqBZRYCHr">
                            <label for="ITqBZRYCHr">Mocha</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="qStQikGKnV">
                            <label for="qStQikGKnV">P5js</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="AjzOhKKhyk">
                            <label for="AjzOhKKhyk">Typescript</label>
                            <ul>
                                <l>
                                    <input type="checkbox" id="ndhTetgtAM">
                                    <label for="ndhTetgtAM">Testing</label>
                                    <ul>
                ...
                <l>
                    <input type="checkbox" id="kisfEJfqjt">
                    <label for="kisfEJfqjt">Kafka</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="DVkFhxIrGn">
                    <label for="DVkFhxIrGn">Kubernetes</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="MqGLGVjJTm">
                    <label for="MqGLGVjJTm">Language</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="tODyLxozUy">
                    <label for="tODyLxozUy">Linux</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="yWEjGHLUUv">
                            <label for="yWEjGHLUUv">Bash</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="yDcFakbOhd">
                    <label for="yDcFakbOhd">Oauth</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="kCxKsUYUsq">
                    <label for="kCxKsUYUsq">Prometheus</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="CuXgddgnHh">
                    <label for="CuXgddgnHh">Python</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="PhLezBvWdU">
                            <label for="PhLezBvWdU">Data Classes</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="pCarCMinSX">
                            <label for="pCarCMinSX">Libraries</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="eiIvLeuRUC">
                    <label for="eiIvLeuRUC">React</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="KTkJzzpnOr">
                    <label for="KTkJzzpnOr">Regular Expressions</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="LXbvfhsAAJ">
                    <label for="LXbvfhsAAJ">Rust</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="BIpDvTwkUz">
                            <label for="BIpDvTwkUz">Serde</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="AuiSjmLxuF">
                    <label for="AuiSjmLxuF">Shaders</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="FQuegiuqIy">
                            <label for="FQuegiuqIy">Glsl</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="FdeptmKdug">
                    <label for="FdeptmKdug">Vim</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="lXQAeLqpIy">
                    <label for="lXQAeLqpIy">Web</label>
                    <ul>
