...
<ul>
    <div name="contents-index">
        ...
        <l>
            <input type="checkbox" id="bAtxZfyXbP" checked>
            <label for="bAtxZfyXbP">Math</label>
            <ul>
                <l>
                    <input type="checkbox" id="AnBcnuDZwo">
                    <label for="AnBcnuDZwo">Exponentials</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="PwMULTytSK">
                    <label for="PwMULTytSK">Linear Algebra</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="LaOktQiHJJ">
                    <label for="LaOktQiHJJ">Logarithms</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="ftcTnrZRAM">
                    <label for="ftcTnrZRAM">Sequences</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="tqwLWjTpwc">
                    <label for="tqwLWjTpwc">Single Variable Calculus</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="HGPnVowknM">
                    <label for="HGPnVowknM">Trigonometry</label>
                    <ul>
        ...
        <l>
            <input type="checkbox" id="VlGwsogynQ" checked>
            <label for="VlGwsogynQ">Programming</label>
            <ul>
                <l>
                    <input type="checkbox" id="UyUVBFulDE">
                    <label for="UyUVBFulDE">Ansible</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="eJfxrsiJXI">
                    <label for="eJfxrsiJXI">Architecture</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="AshPfuaixh">
                    <label for="AshPfuaixh">Computer Graphics</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="nuuBvadIdG">
                    <label for="nuuBvadIdG">Databases</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="iAVIiPVnCD">
                    <label for="iAVIiPVnCD">Devops</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="LerlwHoigX">
                            <label for="LerlwHoigX">Cloud Providers</label>
                            <ul>
                                <l>
                                    <input type="checkbox" id="LlFhBENIBc">
                                    <label for="LlFhBENIBc">AWS</label>
                                    <ul>
                                        <l>
                                            <input type="checkbox" id="tNOAevKRUL">
                                            <label for="tNOAevKRUL">Cli</label>
                                            <ul>
                                        ...
                                        <l>
                                            <input type="checkbox" id="PZnTXrYRQA">
                                            <label for="PZnTXrYRQA">Dotnet</label>
                                            <ul>
                                        ...
                                        <l>
                                            <input type="checkbox" id="dEFmSIBOwm">
                                            <label for="dEFmSIBOwm">Ec 2</label>
                                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="DAqKrMbvoM">
                            <label for="DAqKrMbvoM">Events</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="pJlUyTWaPG">
                            <label for="pJlUyTWaPG">Localstack</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="HHqGNkHAkf">
                            <label for="HHqGNkHAkf">Pulumi</label>
                            <ul>
                                <l>
                                    <input type="checkbox" id="IcksDCZqTy">
                                    <label for="IcksDCZqTy">Dotnet</label>
                                    <ul>
                        ...
                        <l>
                            <input type="checkbox" id="zpDiXscLpK">
                            <label for="zpDiXscLpK">Serverless Framework</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="LuojdKOjWK">
                            <label for="LuojdKOjWK">Terraform</label>
                            <ul>
                                <l>
                                    <input type="checkbox" id="mdCRXSEYoJ">
                                    <label for="mdCRXSEYoJ">Functions</label>
                                    <ul>
                                ...
                                <l>
                                    <input type="checkbox" id="kbiwcZQaBz">
                                    <label for="kbiwcZQaBz">Meta Arguments</label>
                                    <ul>
                ...
                <l>
                    <input type="checkbox" id="hHWjyDYTzQ">
                    <label for="hHWjyDYTzQ">Docker</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="SGkBcTsAdj">
                    <label for="SGkBcTsAdj">Dotnet</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="HdHhyoahtR">
                            <label for="HdHhyoahtR">Cli</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="bzejcyaaZG">
                    <label for="bzejcyaaZG">Functional Programming</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="gaxdiCvmiK">
                    <label for="gaxdiCvmiK">Git</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="kbwyNmWKOT">
                            <label for="kbwyNmWKOT">Github</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="fIRTjlhQdI">
                    <label for="fIRTjlhQdI">Go</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="NTJDCxHzav">
                    <label for="NTJDCxHzav">Haskell</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="HkTSvpJEHB">
                    <label for="HkTSvpJEHB">Js</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="uccbJghEJO">
                            <label for="uccbJghEJO">Node</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="BxWzboOhJL">
                            <label for="BxWzboOhJL">D3</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="CGyfuIMdDe">
                            <label for="CGyfuIMdDe">Mocha</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="ABTcHOEzEU">
                            <label for="ABTcHOEzEU">P5js</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="hxdTkTHxmq">
                            <label for="hxdTkTHxmq">Typescript</label>
                            <ul>
                                <l>
                                    <input type="checkbox" id="gSlkYDBXVi">
                                    <label for="gSlkYDBXVi">Testing</label>
                                    <ul>
                ...
                <l>
                    <input type="checkbox" id="QzLzSxiIgL">
                    <label for="QzLzSxiIgL">Kafka</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="QkrXBIiZcG">
                    <label for="QkrXBIiZcG">Kubernetes</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="NnacUVnkXK">
                    <label for="NnacUVnkXK">Language</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="qzPVSQRaEB">
                    <label for="qzPVSQRaEB">Linux</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="ZbdwvFdwjM">
                            <label for="ZbdwvFdwjM">Bash</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="XMinLgAhJD">
                    <label for="XMinLgAhJD">Oauth</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="KQbVueYZXW">
                    <label for="KQbVueYZXW">Prometheus</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="XoknSGIhrm">
                    <label for="XoknSGIhrm">Python</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="mLwnVitfYG">
                            <label for="mLwnVitfYG">Data Classes</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="uicjGWEElJ">
                            <label for="uicjGWEElJ">Libraries</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="zdSkbjLRvi">
                    <label for="zdSkbjLRvi">React</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="WdcBGHGqRY">
                    <label for="WdcBGHGqRY">Regular Expressions</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="vxGNnFkiRU">
                    <label for="vxGNnFkiRU">Rust</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="YnYyFDqaCr">
                            <label for="YnYyFDqaCr">Serde</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="cXYfIZdxNw">
                    <label for="cXYfIZdxNw">Shaders</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="BDsDvijzkm">
                            <label for="BDsDvijzkm">Glsl</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="uPgmbmAgHO">
                    <label for="uPgmbmAgHO">Vim</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="OBwoVoqsrz">
                    <label for="OBwoVoqsrz">Web</label>
                    <ul>
