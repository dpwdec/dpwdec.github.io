...
<ul>
    <div name="contents-index">
        ...
        <l>
            <input type="checkbox" id="AOemBkPLoP" checked>
            <label for="AOemBkPLoP">Math</label>
            <ul>
                <l>
                    <input type="checkbox" id="zVfVBMjilp">
                    <label for="zVfVBMjilp">Exponentials</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="cNxZlmvjBk">
                    <label for="cNxZlmvjBk">Linear Algebra</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="vqDvoyPhsZ">
                    <label for="vqDvoyPhsZ">Logarithms</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="tTeIQCCLln">
                    <label for="tTeIQCCLln">Sequences</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="JpNPnYiyzN">
                    <label for="JpNPnYiyzN">Single Variable Calculus</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="nNUjassaoR">
                    <label for="nNUjassaoR">Trigonometry</label>
                    <ul>
        ...
        <l>
            <input type="checkbox" id="EPslOhglUk" checked>
            <label for="EPslOhglUk">Programming</label>
            <ul>
                <l>
                    <input type="checkbox" id="qflyBuSNMI">
                    <label for="qflyBuSNMI">Ansible</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="NsvgIDKcfu">
                    <label for="NsvgIDKcfu">Architecture</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="SDKgKivqUo">
                    <label for="SDKgKivqUo">Computer Graphics</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="AzUGuIRYjy">
                    <label for="AzUGuIRYjy">Databases</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="QYGjAmQIMq">
                    <label for="QYGjAmQIMq">Devops</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="mSEQvHDzlB">
                            <label for="mSEQvHDzlB">Cloud Providers</label>
                            <ul>
                                <l>
                                    <input type="checkbox" id="HHauZZtcaw">
                                    <label for="HHauZZtcaw">AWS</label>
                                    <ul>
                                        <l>
                                            <input type="checkbox" id="oQgocbLNxK">
                                            <label for="oQgocbLNxK">Cli</label>
                                            <ul>
                                        ...
                                        <l>
                                            <input type="checkbox" id="FcSNsFheyn">
                                            <label for="FcSNsFheyn">Dotnet</label>
                                            <ul>
                                        ...
                                        <l>
                                            <input type="checkbox" id="LNDgeFqHYE">
                                            <label for="LNDgeFqHYE">Ec 2</label>
                                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="JRbKUErDwq">
                            <label for="JRbKUErDwq">Events</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="ydKTdyiQWa">
                            <label for="ydKTdyiQWa">Localstack</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="uUhCaQpywt">
                            <label for="uUhCaQpywt">Pulumi</label>
                            <ul>
                                <l>
                                    <input type="checkbox" id="WGxYtQKfQf">
                                    <label for="WGxYtQKfQf">Dotnet</label>
                                    <ul>
                        ...
                        <l>
                            <input type="checkbox" id="cuuyyWBIdF">
                            <label for="cuuyyWBIdF">Serverless Framework</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="rSHZpoFzIs">
                            <label for="rSHZpoFzIs">Terraform</label>
                            <ul>
                                <l>
                                    <input type="checkbox" id="UCqwpyhHCs">
                                    <label for="UCqwpyhHCs">Functions</label>
                                    <ul>
                                ...
                                <l>
                                    <input type="checkbox" id="DQVPFxMFJs">
                                    <label for="DQVPFxMFJs">Meta Arguments</label>
                                    <ul>
                ...
                <l>
                    <input type="checkbox" id="XFckeFHdXQ">
                    <label for="XFckeFHdXQ">Docker</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="dlXhMvVTJb">
                    <label for="dlXhMvVTJb">Dotnet</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="QfQayjPQno">
                            <label for="QfQayjPQno">Cli</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="bnvPWJxqCK">
                    <label for="bnvPWJxqCK">Functional Programming</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="RCazchTrBg">
                    <label for="RCazchTrBg">Git</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="njTTLvBnvP">
                            <label for="njTTLvBnvP">Github</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="AifbSfAZMJ">
                    <label for="AifbSfAZMJ">Go</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="AnAmzAnLXI">
                    <label for="AnAmzAnLXI">Haskell</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="TDLUrgAmNp">
                    <label for="TDLUrgAmNp">Js</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="jAdwfTRuaM">
                            <label for="jAdwfTRuaM">Node</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="WIiuaDftAi">
                            <label for="WIiuaDftAi">D3</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="WQZraVNtUX">
                            <label for="WQZraVNtUX">Mocha</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="pubxXHiUWO">
                            <label for="pubxXHiUWO">P5js</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="AokpIoFVck">
                            <label for="AokpIoFVck">Typescript</label>
                            <ul>
                                <l>
                                    <input type="checkbox" id="arFeDiwXmn">
                                    <label for="arFeDiwXmn">Testing</label>
                                    <ul>
                ...
                <l>
                    <input type="checkbox" id="UDirXqmqbf">
                    <label for="UDirXqmqbf">Kafka</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="flhiqMJQcx">
                    <label for="flhiqMJQcx">Kubernetes</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="bctjEcdcgj">
                    <label for="bctjEcdcgj">Language</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="JJIAdqCgie">
                    <label for="JJIAdqCgie">Linux</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="JIgatlknHq">
                            <label for="JIgatlknHq">Bash</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="maiTBWSVHa">
                    <label for="maiTBWSVHa">Oauth</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="tTJCyUphQt">
                    <label for="tTJCyUphQt">Prometheus</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="BuLIPrJZen">
                    <label for="BuLIPrJZen">Python</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="voAYxNRvrM">
                            <label for="voAYxNRvrM">Data Classes</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="mQPndzWtKV">
                            <label for="mQPndzWtKV">Libraries</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="ZsDpQejWkW">
                    <label for="ZsDpQejWkW">React</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="rbRVClLWEL">
                    <label for="rbRVClLWEL">Regular Expressions</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="dCFZvoBqgV">
                    <label for="dCFZvoBqgV">Rust</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="gcTQsIzlmk">
                            <label for="gcTQsIzlmk">Serde</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="nCkTNwgIyr">
                    <label for="nCkTNwgIyr">Shaders</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="tQseVdBFPg">
                            <label for="tQseVdBFPg">Glsl</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="HUoNuCAzKg">
                    <label for="HUoNuCAzKg">Vim</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="OmibVltVjn">
                    <label for="OmibVltVjn">Web</label>
                    <ul>
