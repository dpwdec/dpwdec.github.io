...
<ul>
    <div name="contents-index">
        ...
        <l>
            <input type="checkbox" id="luhAdFIOjc" checked>
            <label for="luhAdFIOjc">Math</label>
            <ul>
                <l>
                    <input type="checkbox" id="pfWOZuvrlD">
                    <label for="pfWOZuvrlD">Exponentials</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="VWGvCakGEl">
                    <label for="VWGvCakGEl">Linear Algebra</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="ZHFWrEISgs">
                    <label for="ZHFWrEISgs">Logarithms</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="XfgslnyUBH">
                    <label for="XfgslnyUBH">Sequences</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="hShHUkvTDH">
                    <label for="hShHUkvTDH">Single Variable Calculus</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="GoPlqmVPtw">
                    <label for="GoPlqmVPtw">Trigonometry</label>
                    <ul>
        ...
        <l>
            <input type="checkbox" id="tGKZjLogwk" checked>
            <label for="tGKZjLogwk">Programming</label>
            <ul>
                <l>
                    <input type="checkbox" id="xDhZhULrGL">
                    <label for="xDhZhULrGL">Ansible</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="pDLPrOSLXY">
                    <label for="pDLPrOSLXY">Architecture</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="mNHSjhXuTb">
                    <label for="mNHSjhXuTb">Computer Graphics</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="bqYYPoUokX">
                    <label for="bqYYPoUokX">Databases</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="HBXDXSklww">
                    <label for="HBXDXSklww">Devops</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="sCcCZrCHdU">
                            <label for="sCcCZrCHdU">Cloud Providers</label>
                            <ul>
                                <l>
                                    <input type="checkbox" id="jFhHuCDlGp">
                                    <label for="jFhHuCDlGp">AWS</label>
                                    <ul>
                                        <l>
                                            <input type="checkbox" id="YrbbwfsjBr">
                                            <label for="YrbbwfsjBr">Cli</label>
                                            <ul>
                                        ...
                                        <l>
                                            <input type="checkbox" id="FJHcdvhpSo">
                                            <label for="FJHcdvhpSo">Dotnet</label>
                                            <ul>
                                        ...
                                        <l>
                                            <input type="checkbox" id="cZSLfYDYwt">
                                            <label for="cZSLfYDYwt">Ec 2</label>
                                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="MVwzNEnKJl">
                            <label for="MVwzNEnKJl">Events</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="WQwcADvvrG">
                            <label for="WQwcADvvrG">Localstack</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="SjXNxzobDV">
                            <label for="SjXNxzobDV">Pulumi</label>
                            <ul>
                                <l>
                                    <input type="checkbox" id="MBqninXCsI">
                                    <label for="MBqninXCsI">Dotnet</label>
                                    <ul>
                        ...
                        <l>
                            <input type="checkbox" id="qHUHIMIMhy">
                            <label for="qHUHIMIMhy">Serverless Framework</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="fcUMaoTTtD">
                            <label for="fcUMaoTTtD">Terraform</label>
                            <ul>
                                <l>
                                    <input type="checkbox" id="PRoQUuIRnu">
                                    <label for="PRoQUuIRnu">Functions</label>
                                    <ul>
                                ...
                                <l>
                                    <input type="checkbox" id="KtfWNxjkqU">
                                    <label for="KtfWNxjkqU">Meta Arguments</label>
                                    <ul>
                ...
                <l>
                    <input type="checkbox" id="jCqWsawYeL">
                    <label for="jCqWsawYeL">Docker</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="SpmOwhuAIT">
                    <label for="SpmOwhuAIT">Dotnet</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="fjQYTvPqrC">
                            <label for="fjQYTvPqrC">Cli</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="wUAPaIrAsJ">
                    <label for="wUAPaIrAsJ">Functional Programming</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="JcjdtpDjDF">
                    <label for="JcjdtpDjDF">Git</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="SaTUmwEFIy">
                            <label for="SaTUmwEFIy">Github</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="qPMnrvDvJy">
                    <label for="qPMnrvDvJy">Go</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="xhaZVFbykL">
                    <label for="xhaZVFbykL">Haskell</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="pzePDlLnvq">
                    <label for="pzePDlLnvq">Js</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="HVuNSrHSqk">
                            <label for="HVuNSrHSqk">Node</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="soMAaRPuIs">
                            <label for="soMAaRPuIs">D3</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="APuldwLPmz">
                            <label for="APuldwLPmz">Mocha</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="RdaXrWBbdF">
                            <label for="RdaXrWBbdF">P5js</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="BOodeyYuJZ">
                            <label for="BOodeyYuJZ">Typescript</label>
                            <ul>
                                <l>
                                    <input type="checkbox" id="ZsxjJHtqDi">
                                    <label for="ZsxjJHtqDi">Testing</label>
                                    <ul>
                ...
                <l>
                    <input type="checkbox" id="HhubmqWPrj">
                    <label for="HhubmqWPrj">Kafka</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="JtUHnnogAI">
                    <label for="JtUHnnogAI">Kubernetes</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="WOaghDUEZF">
                    <label for="WOaghDUEZF">Language</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="LMTCbJSDSb">
                    <label for="LMTCbJSDSb">Linux</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="sdwxcNiKsK">
                            <label for="sdwxcNiKsK">Bash</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="MLXBYelqut">
                    <label for="MLXBYelqut">Oauth</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="jCUivDAZCH">
                    <label for="jCUivDAZCH">Prometheus</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="atvaxDUAsy">
                    <label for="atvaxDUAsy">Python</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="ndhGcnhuWI">
                            <label for="ndhGcnhuWI">Data Classes</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="MjtbdaukFT">
                            <label for="MjtbdaukFT">Libraries</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="xcyOvSbXqX">
                    <label for="xcyOvSbXqX">React</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="rtFiSTJMvI">
                    <label for="rtFiSTJMvI">Regular Expressions</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="ghyFcebLpY">
                    <label for="ghyFcebLpY">Rust</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="LtcKXApANl">
                            <label for="LtcKXApANl">Serde</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="CXNtNwDupa">
                    <label for="CXNtNwDupa">Shaders</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="YzTeXtnGAY">
                            <label for="YzTeXtnGAY">Glsl</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="oaLGRDangU">
                    <label for="oaLGRDangU">Vim</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="xtknrsFRpd">
                    <label for="xtknrsFRpd">Web</label>
                    <ul>
