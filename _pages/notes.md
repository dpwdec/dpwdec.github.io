...
<ul>
    <div name="contents-index">
        ...
        <l>
            <input type="checkbox" id="bLPMHVONCB" checked>
            <label for="bLPMHVONCB">Math</label>
            <ul>
                <l>
                    <input type="checkbox" id="MBEGWtJUjD">
                    <label for="MBEGWtJUjD">Exponentials</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="TJLFiWJyfu">
                    <label for="TJLFiWJyfu">Linear Algebra</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="OZmJwdLdHs">
                    <label for="OZmJwdLdHs">Logarithms</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="JJcLjhpNRp">
                    <label for="JJcLjhpNRp">Sequences</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="QTkErHRQcB">
                    <label for="QTkErHRQcB">Single Variable Calculus</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="wvGxTJoMBo">
                    <label for="wvGxTJoMBo">Trigonometry</label>
                    <ul>
        ...
        <l>
            <input type="checkbox" id="AhIkjwfHmd" checked>
            <label for="AhIkjwfHmd">Programming</label>
            <ul>
                <l>
                    <input type="checkbox" id="BBTzpLAjYe">
                    <label for="BBTzpLAjYe">Ansible</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="RRqpvdBnHd">
                    <label for="RRqpvdBnHd">Architecture</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="KQHUwovVWc">
                    <label for="KQHUwovVWc">Computer Graphics</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="zpbmIOCwMV">
                    <label for="zpbmIOCwMV">Databases</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="HHPtXnFEQL">
                    <label for="HHPtXnFEQL">Devops</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="kdNmHkajQt">
                            <label for="kdNmHkajQt">Cloud Providers</label>
                            <ul>
                                <l>
                                    <input type="checkbox" id="KAOjOXEcNK">
                                    <label for="KAOjOXEcNK">AWS</label>
                                    <ul>
                                        <l>
                                            <input type="checkbox" id="OROFobySof">
                                            <label for="OROFobySof">Cli</label>
                                            <ul>
                                        ...
                                        <l>
                                            <input type="checkbox" id="PCKntplDgb">
                                            <label for="PCKntplDgb">Dotnet</label>
                                            <ul>
                                        ...
                                        <l>
                                            <input type="checkbox" id="FwcEbMdezt">
                                            <label for="FwcEbMdezt">Ec 2</label>
                                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="ISkEKFUPhp">
                            <label for="ISkEKFUPhp">Events</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="tXoNRsjJwR">
                            <label for="tXoNRsjJwR">Localstack</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="KFruhNBcPP">
                            <label for="KFruhNBcPP">Pulumi</label>
                            <ul>
                                <l>
                                    <input type="checkbox" id="pnfjAfRTgM">
                                    <label for="pnfjAfRTgM">Dotnet</label>
                                    <ul>
                        ...
                        <l>
                            <input type="checkbox" id="rtfPOqdTKW">
                            <label for="rtfPOqdTKW">Serverless Framework</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="qNmzqKeUHY">
                            <label for="qNmzqKeUHY">Terraform</label>
                            <ul>
                                <l>
                                    <input type="checkbox" id="KqwKttzNUh">
                                    <label for="KqwKttzNUh">Functions</label>
                                    <ul>
                                ...
                                <l>
                                    <input type="checkbox" id="BpqsAouCPV">
                                    <label for="BpqsAouCPV">Meta Arguments</label>
                                    <ul>
                ...
                <l>
                    <input type="checkbox" id="QTZghhTEZS">
                    <label for="QTZghhTEZS">Docker</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="iYLVMTnpCd">
                    <label for="iYLVMTnpCd">Dotnet</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="jiDmipWTAz">
                            <label for="jiDmipWTAz">Cli</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="UcuIJISVbF">
                    <label for="UcuIJISVbF">Functional Programming</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="JnQpMTVIeY">
                    <label for="JnQpMTVIeY">Git</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="VxpEgYuOvd">
                            <label for="VxpEgYuOvd">Github</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="jJuKsZhWlc">
                    <label for="jJuKsZhWlc">Go</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="UcozOPUhCU">
                    <label for="UcozOPUhCU">Haskell</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="msTwtKjsMD">
                    <label for="msTwtKjsMD">Js</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="yrXTOgwucR">
                            <label for="yrXTOgwucR">Node</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="orQAZDALXY">
                            <label for="orQAZDALXY">D3</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="hLUhVXevtv">
                            <label for="hLUhVXevtv">Mocha</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="poSwvKwJJg">
                            <label for="poSwvKwJJg">P5js</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="fBHScFZJXZ">
                            <label for="fBHScFZJXZ">Typescript</label>
                            <ul>
                                <l>
                                    <input type="checkbox" id="zHktJwdswV">
                                    <label for="zHktJwdswV">Testing</label>
                                    <ul>
                ...
                <l>
                    <input type="checkbox" id="ZSLqxFoAws">
                    <label for="ZSLqxFoAws">Kafka</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="TMzvHuzyzR">
                    <label for="TMzvHuzyzR">Kubernetes</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="HSmCqcWpez">
                    <label for="HSmCqcWpez">Language</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="rmOFVLRUYr">
                    <label for="rmOFVLRUYr">Linux</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="MNRRazFaoL">
                            <label for="MNRRazFaoL">Bash</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="qJZoOrwnhA">
                    <label for="qJZoOrwnhA">Oauth</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="QFUGzSBvHZ">
                    <label for="QFUGzSBvHZ">Prometheus</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="ZEzpzoyiDq">
                    <label for="ZEzpzoyiDq">Python</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="CBNExZvoUF">
                            <label for="CBNExZvoUF">Data Classes</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="XknCEPeWGs">
                            <label for="XknCEPeWGs">Libraries</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="KeEzMOyHJa">
                    <label for="KeEzMOyHJa">React</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="FzvseVijBg">
                    <label for="FzvseVijBg">Regular Expressions</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="kJAKDPsZsk">
                    <label for="kJAKDPsZsk">Rust</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="ZcCufjEAzk">
                            <label for="ZcCufjEAzk">Serde</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="reRdFAstFI">
                    <label for="reRdFAstFI">Shaders</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="TTyiGPkkrT">
                            <label for="TTyiGPkkrT">Glsl</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="jhwOOZegUx">
                    <label for="jhwOOZegUx">Vim</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="iephkcnUit">
                    <label for="iephkcnUit">Web</label>
                    <ul>
