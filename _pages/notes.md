...
<ul>
    <div name="contents-index">
        ...
        <l>
            <input type="checkbox" id="DtQbxaTUud" checked>
            <label for="DtQbxaTUud">Math</label>
            <ul>
                <l>
                    <input type="checkbox" id="oxKtCuXcqp">
                    <label for="oxKtCuXcqp">Exponentials</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="tDlgNDmDoO">
                    <label for="tDlgNDmDoO">Linear Algebra</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="MhNfIPRgPU">
                    <label for="MhNfIPRgPU">Logarithms</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="gCOyUejthG">
                    <label for="gCOyUejthG">Sequences</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="xzCSQZiLaK">
                    <label for="xzCSQZiLaK">Single Variable Calculus</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="gYsegynOYO">
                    <label for="gYsegynOYO">Trigonometry</label>
                    <ul>
        ...
        <l>
            <input type="checkbox" id="nuHpHqUFcG" checked>
            <label for="nuHpHqUFcG">Programming</label>
            <ul>
                <l>
                    <input type="checkbox" id="ixAtrCBNLY">
                    <label for="ixAtrCBNLY">Ansible</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="UHtKZuxQKs">
                    <label for="UHtKZuxQKs">Architecture</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="ZMLUZsHMgG">
                    <label for="ZMLUZsHMgG">Computer Graphics</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="VFLrOMsSsJ">
                    <label for="VFLrOMsSsJ">Databases</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="CybJcRtjql">
                    <label for="CybJcRtjql">Devops</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="MTSnhbNIxL">
                            <label for="MTSnhbNIxL">Cloud Providers</label>
                            <ul>
                                <l>
                                    <input type="checkbox" id="LKQbTSHhaU">
                                    <label for="LKQbTSHhaU">AWS</label>
                                    <ul>
                                        <l>
                                            <input type="checkbox" id="LSHhiJkNSz">
                                            <label for="LSHhiJkNSz">Cli</label>
                                            <ul>
                                        ...
                                        <l>
                                            <input type="checkbox" id="VvSlIbeQJx">
                                            <label for="VvSlIbeQJx">Dotnet</label>
                                            <ul>
                                        ...
                                        <l>
                                            <input type="checkbox" id="RBQVqBnuXZ">
                                            <label for="RBQVqBnuXZ">Ec 2</label>
                                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="DjgQItdpGZ">
                            <label for="DjgQItdpGZ">Events</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="dbwcBHXLld">
                            <label for="dbwcBHXLld">Localstack</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="zlRWYRvxmH">
                            <label for="zlRWYRvxmH">Pulumi</label>
                            <ul>
                                <l>
                                    <input type="checkbox" id="oIyGedwtRc">
                                    <label for="oIyGedwtRc">Dotnet</label>
                                    <ul>
                        ...
                        <l>
                            <input type="checkbox" id="khqdjQyhsU">
                            <label for="khqdjQyhsU">Serverless Framework</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="VISkUaxOFW">
                            <label for="VISkUaxOFW">Terraform</label>
                            <ul>
                                <l>
                                    <input type="checkbox" id="VadGrXonGd">
                                    <label for="VadGrXonGd">Functions</label>
                                    <ul>
                                ...
                                <l>
                                    <input type="checkbox" id="tfSvIorbUH">
                                    <label for="tfSvIorbUH">Meta Arguments</label>
                                    <ul>
                ...
                <l>
                    <input type="checkbox" id="YwcYWTOWJf">
                    <label for="YwcYWTOWJf">Docker</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="setKDWSLdA">
                    <label for="setKDWSLdA">Dotnet</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="eFmyZmaxML">
                            <label for="eFmyZmaxML">Cli</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="iYllrhLHUJ">
                    <label for="iYllrhLHUJ">Functional Programming</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="weVbYzhUNr">
                    <label for="weVbYzhUNr">Git</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="nGnLPjVLfB">
                            <label for="nGnLPjVLfB">Github</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="CskGluhjfY">
                    <label for="CskGluhjfY">Go</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="oKGYHhuqWJ">
                    <label for="oKGYHhuqWJ">Haskell</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="FIohGUgiHx">
                    <label for="FIohGUgiHx">Js</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="uHGcoTPETh">
                            <label for="uHGcoTPETh">Node</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="OXKgOsyWqa">
                            <label for="OXKgOsyWqa">D3</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="UKBoObFHao">
                            <label for="UKBoObFHao">Mocha</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="ktviWKPvsq">
                            <label for="ktviWKPvsq">P5js</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="hTzaBJMrED">
                            <label for="hTzaBJMrED">Typescript</label>
                            <ul>
                                <l>
                                    <input type="checkbox" id="NiLSQAcBTE">
                                    <label for="NiLSQAcBTE">Testing</label>
                                    <ul>
                ...
                <l>
                    <input type="checkbox" id="WDlRUspWFA">
                    <label for="WDlRUspWFA">Kafka</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="QfkksuSKGx">
                    <label for="QfkksuSKGx">Kubernetes</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="znLNDPoUoQ">
                    <label for="znLNDPoUoQ">Language</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="ZSLNweQSxx">
                    <label for="ZSLNweQSxx">Linux</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="okdiEuLMVP">
                            <label for="okdiEuLMVP">Bash</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="UfrsGwiapN">
                    <label for="UfrsGwiapN">Oauth</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="nReyieaMdv">
                    <label for="nReyieaMdv">Prometheus</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="ClhaOKMQqG">
                    <label for="ClhaOKMQqG">Python</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="oSMELxuJrb">
                            <label for="oSMELxuJrb">Data Classes</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="ORnlpXnTTO">
                            <label for="ORnlpXnTTO">Libraries</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="VDyxXDuLxu">
                    <label for="VDyxXDuLxu">React</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="AIsqoeVjRl">
                    <label for="AIsqoeVjRl">Regular Expressions</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="FsoJJGGsgw">
                    <label for="FsoJJGGsgw">Rust</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="TaTGNHSwIT">
                            <label for="TaTGNHSwIT">Serde</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="KyMYXUYQPX">
                    <label for="KyMYXUYQPX">Shaders</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="tHgNrYFnFe">
                            <label for="tHgNrYFnFe">Glsl</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="VeZixTDtAU">
                    <label for="VeZixTDtAU">Vim</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="uRYPXjGAxq">
                    <label for="uRYPXjGAxq">Web</label>
                    <ul>
