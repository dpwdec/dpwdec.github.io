...
<ul>
    <div name="contents-index">
        ...
        <l>
            <input type="checkbox" id="TNKDNMvaCO" checked>
            <label for="TNKDNMvaCO">Math</label>
            <ul>
                <l>
                    <input type="checkbox" id="eHgEsBiBwV">
                    <label for="eHgEsBiBwV">Exponentials</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="othpTsSQgO">
                    <label for="othpTsSQgO">Linear Algebra</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="oMDiWjREuQ">
                    <label for="oMDiWjREuQ">Logarithms</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="FacYtQauaY">
                    <label for="FacYtQauaY">Sequences</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="rlwMDZGLKe">
                    <label for="rlwMDZGLKe">Single Variable Calculus</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="yQumVYXufm">
                    <label for="yQumVYXufm">Trigonometry</label>
                    <ul>
        ...
        <l>
            <input type="checkbox" id="dPVchRSYSR" checked>
            <label for="dPVchRSYSR">Programming</label>
            <ul>
                <l>
                    <input type="checkbox" id="FBARRGqkEp">
                    <label for="FBARRGqkEp">Ansible</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="qfTGNastxd">
                    <label for="qfTGNastxd">Architecture</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="jfRvuZaXOE">
                    <label for="jfRvuZaXOE">Computer Graphics</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="HTHrUImwiI">
                    <label for="HTHrUImwiI">Databases</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="YmmJxyeQan">
                    <label for="YmmJxyeQan">Devops</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="okmfewYsiU">
                            <label for="okmfewYsiU">Cloud Computing</label>
                            <ul>
                                <l>
                                    <input type="checkbox" id="GZUqcFXust">
                                    <label for="GZUqcFXust">AWS</label>
                                    <ul>
                                        <l>
                                            <input type="checkbox" id="omSPpAfBQu">
                                            <label for="omSPpAfBQu">Cli</label>
                                            <ul>
                                        ...
                                        <l>
                                            <input type="checkbox" id="mJzFFAATEC">
                                            <label for="mJzFFAATEC">Dotnet</label>
                                            <ul>
                                        ...
                                        <l>
                                            <input type="checkbox" id="jzfRlOcfxX">
                                            <label for="jzfRlOcfxX">Ec 2</label>
                                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="KrsysBQBXd">
                            <label for="KrsysBQBXd">Events</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="KIEFHrNjGq">
                            <label for="KIEFHrNjGq">Oauth</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="CUsLlicGig">
                            <label for="CUsLlicGig">Pulumi</label>
                            <ul>
                                <l>
                                    <input type="checkbox" id="qbzjMacTfX">
                                    <label for="qbzjMacTfX">Dotnet</label>
                                    <ul>
                        ...
                        <l>
                            <input type="checkbox" id="MamkEPoRoA">
                            <label for="MamkEPoRoA">Terraform</label>
                            <ul>
                                <l>
                                    <input type="checkbox" id="owbJXACkol">
                                    <label for="owbJXACkol">Functions</label>
                                    <ul>
                                ...
                                <l>
                                    <input type="checkbox" id="JZwGirCcEM">
                                    <label for="JZwGirCcEM">Meta Arguments</label>
                                    <ul>
                ...
                <l>
                    <input type="checkbox" id="ZMayRCbvdm">
                    <label for="ZMayRCbvdm">Docker</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="WxQvrBYJoW">
                    <label for="WxQvrBYJoW">Dotnet</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="drcaaBDUta">
                            <label for="drcaaBDUta">Cli</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="XMWKQyFOjS">
                    <label for="XMWKQyFOjS">Functional Programming</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="FjJTlUORSd">
                    <label for="FjJTlUORSd">Git</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="ETSKyqTEQh">
                            <label for="ETSKyqTEQh">Github</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="biUTEKMeSK">
                    <label for="biUTEKMeSK">Go</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="GMndrvGlrF">
                    <label for="GMndrvGlrF">Haskell</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="ryhLxXHmJG">
                    <label for="ryhLxXHmJG">Js</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="wFzsRAqZmM">
                            <label for="wFzsRAqZmM">Node</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="OlkqFuvrgM">
                            <label for="OlkqFuvrgM">D3</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="mTivkGUkLg">
                            <label for="mTivkGUkLg">Mocha</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="XgUiOHEiHN">
                            <label for="XgUiOHEiHN">P5js</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="btdswenGyZ">
                            <label for="btdswenGyZ">Typescript</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="UtLxSxVxfc">
                    <label for="UtLxSxVxfc">Kafka</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="ijFTiERLrv">
                    <label for="ijFTiERLrv">Kubernetes</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="LlIUwCpNHf">
                    <label for="LlIUwCpNHf">Language</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="CKgJzBmRrq">
                    <label for="CKgJzBmRrq">Linux</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="izhiqSSoGx">
                    <label for="izhiqSSoGx">Python</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="zDrcUGkkuv">
                            <label for="zDrcUGkkuv">Data Classes</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="uDSNVCLQXR">
                            <label for="uDSNVCLQXR">Libraries</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="YvhWTsMBON">
                    <label for="YvhWTsMBON">React</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="HNNbiYtaqp">
                    <label for="HNNbiYtaqp">Regular Expressions</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="yRtgpdiRjp">
                    <label for="yRtgpdiRjp">Rust</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="rUoGwyMsdM">
                            <label for="rUoGwyMsdM">Serde</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="AIDxpPLtPC">
                    <label for="AIDxpPLtPC">Vim</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="RiouZMTGkR">
                    <label for="RiouZMTGkR">Web</label>
                    <ul>
