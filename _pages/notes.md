...
<ul>
    <div name="contents-index">
        ...
        <l>
            <input type="checkbox" id="QEVOHgBKZF" checked>
            <label for="QEVOHgBKZF">Math</label>
            <ul>
                <l>
                    <input type="checkbox" id="euOdePeYYA">
                    <label for="euOdePeYYA">Exponentials</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="mcbYJOBSLJ">
                    <label for="mcbYJOBSLJ">Linear Algebra</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="UjJcJnAAuk">
                    <label for="UjJcJnAAuk">Logarithms</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="rIlNnNQESS">
                    <label for="rIlNnNQESS">Sequences</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="mdAYxmEcYj">
                    <label for="mdAYxmEcYj">Single Variable Calculus</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="IKPKsGnebO">
                    <label for="IKPKsGnebO">Trigonometry</label>
                    <ul>
        ...
        <l>
            <input type="checkbox" id="CKsSQWJdaH" checked>
            <label for="CKsSQWJdaH">Programming</label>
            <ul>
                <l>
                    <input type="checkbox" id="QsrIapAfIY">
                    <label for="QsrIapAfIY">Ansible</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="uAKXVgNTJv">
                    <label for="uAKXVgNTJv">Architecture</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="ZDETfpUqAB">
                    <label for="ZDETfpUqAB">Computer Graphics</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="OgYppfBvVX">
                    <label for="OgYppfBvVX">Databases</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="tUHvGnhBVG">
                    <label for="tUHvGnhBVG">Devops</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="asTICKyGBE">
                            <label for="asTICKyGBE">Cloud Computing</label>
                            <ul>
                                <l>
                                    <input type="checkbox" id="AstiwwnHie">
                                    <label for="AstiwwnHie">AWS</label>
                                    <ul>
                                        <l>
                                            <input type="checkbox" id="CyLNHuxKSY">
                                            <label for="CyLNHuxKSY">Cli</label>
                                            <ul>
                                        ...
                                        <l>
                                            <input type="checkbox" id="nXLGYyyBXl">
                                            <label for="nXLGYyyBXl">Dotnet</label>
                                            <ul>
                                        ...
                                        <l>
                                            <input type="checkbox" id="NeqFSjufNm">
                                            <label for="NeqFSjufNm">Ec 2</label>
                                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="hbaJogHMUZ">
                            <label for="hbaJogHMUZ">Events</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="jGwzaxFpdU">
                            <label for="jGwzaxFpdU">Localstack</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="gHOZLyMQJZ">
                            <label for="gHOZLyMQJZ">Oauth</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="ILCTadPLTI">
                            <label for="ILCTadPLTI">Pulumi</label>
                            <ul>
                                <l>
                                    <input type="checkbox" id="aFlWgxhwTR">
                                    <label for="aFlWgxhwTR">Dotnet</label>
                                    <ul>
                        ...
                        <l>
                            <input type="checkbox" id="ppcDuWQgJG">
                            <label for="ppcDuWQgJG">Terraform</label>
                            <ul>
                                <l>
                                    <input type="checkbox" id="GXQueMwClL">
                                    <label for="GXQueMwClL">Functions</label>
                                    <ul>
                                ...
                                <l>
                                    <input type="checkbox" id="THnVPzTOrS">
                                    <label for="THnVPzTOrS">Meta Arguments</label>
                                    <ul>
                ...
                <l>
                    <input type="checkbox" id="EQqQhPxCsI">
                    <label for="EQqQhPxCsI">Docker</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="UWdSWWzsPZ">
                    <label for="UWdSWWzsPZ">Dotnet</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="epqaAqpbNA">
                            <label for="epqaAqpbNA">Cli</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="TaBoKoeQzg">
                    <label for="TaBoKoeQzg">Functional Programming</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="aEUEJgacoW">
                    <label for="aEUEJgacoW">Git</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="TblsZRBOkZ">
                            <label for="TblsZRBOkZ">Github</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="gAcKmJvkyM">
                    <label for="gAcKmJvkyM">Go</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="MVpoFrtaPf">
                    <label for="MVpoFrtaPf">Haskell</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="oEynHqyeVq">
                    <label for="oEynHqyeVq">Js</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="lmKDEvfZpp">
                            <label for="lmKDEvfZpp">Node</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="yWrhzfnskS">
                            <label for="yWrhzfnskS">D3</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="BnjwVsiwPb">
                            <label for="BnjwVsiwPb">Mocha</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="GrCGXxUUFl">
                            <label for="GrCGXxUUFl">P5js</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="RtkyreULen">
                            <label for="RtkyreULen">Typescript</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="mjwkJHIZao">
                    <label for="mjwkJHIZao">Kafka</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="EEbRZGZfvs">
                    <label for="EEbRZGZfvs">Kubernetes</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="rNeSxqtheW">
                    <label for="rNeSxqtheW">Language</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="KJavPxTNft">
                    <label for="KJavPxTNft">Linux</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="hheBgGtIGR">
                    <label for="hheBgGtIGR">Python</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="cTevzuoTQV">
                            <label for="cTevzuoTQV">Data Classes</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="EbFuIjmNMS">
                            <label for="EbFuIjmNMS">Libraries</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="lpMeAwlShC">
                    <label for="lpMeAwlShC">React</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="dLaXseOUEn">
                    <label for="dLaXseOUEn">Regular Expressions</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="MISeAzOXzL">
                    <label for="MISeAzOXzL">Rust</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="sCFCjOfxMB">
                            <label for="sCFCjOfxMB">Serde</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="DQAinNphBg">
                    <label for="DQAinNphBg">Vim</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="gKipfmzHIF">
                    <label for="gKipfmzHIF">Web</label>
                    <ul>
