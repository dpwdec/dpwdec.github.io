...
<ul>
    <div name="contents-index">
        ...
        <l>
            <input type="checkbox" id="thVRwOswWo" checked>
            <label for="thVRwOswWo">Math</label>
            <ul>
                <l>
                    <input type="checkbox" id="OzZUFvJDjt">
                    <label for="OzZUFvJDjt">Exponentials</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="tAQGxxBeOS">
                    <label for="tAQGxxBeOS">Linear Algebra</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="PBHUqLAviW">
                    <label for="PBHUqLAviW">Logarithms</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="vhtKUZVkZP">
                    <label for="vhtKUZVkZP">Sequences</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="PcCvYnxcNA">
                    <label for="PcCvYnxcNA">Single Variable Calculus</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="NCNULIHAGQ">
                    <label for="NCNULIHAGQ">Trigonometry</label>
                    <ul>
        ...
        <l>
            <input type="checkbox" id="yNQCgemGgn" checked>
            <label for="yNQCgemGgn">Programming</label>
            <ul>
                <l>
                    <input type="checkbox" id="rsVrODnAkO">
                    <label for="rsVrODnAkO">Ansible</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="MbyRZRRlEt">
                    <label for="MbyRZRRlEt">Architecture</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="LLOBxuTOLg">
                    <label for="LLOBxuTOLg">Computer Graphics</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="DECkHqrXPc">
                    <label for="DECkHqrXPc">Databases</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="ZEOtKlUmkn">
                    <label for="ZEOtKlUmkn">Devops</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="PUlEHPulZb">
                            <label for="PUlEHPulZb">Cloud Computing</label>
                            <ul>
                                <l>
                                    <input type="checkbox" id="tpWSgirxOO">
                                    <label for="tpWSgirxOO">AWS</label>
                                    <ul>
                                        <l>
                                            <input type="checkbox" id="syjNHfOxTu">
                                            <label for="syjNHfOxTu">Cli</label>
                                            <ul>
                                        ...
                                        <l>
                                            <input type="checkbox" id="ZRdABMlrqu">
                                            <label for="ZRdABMlrqu">Dotnet</label>
                                            <ul>
                                        ...
                                        <l>
                                            <input type="checkbox" id="nRzpEIukhz">
                                            <label for="nRzpEIukhz">Ec 2</label>
                                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="jgsplKYylq">
                            <label for="jgsplKYylq">Events</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="NKyhdBJgrW">
                            <label for="NKyhdBJgrW">Localstack</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="aEIHFMjDbM">
                            <label for="aEIHFMjDbM">Oauth</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="BNZfOWvQnb">
                            <label for="BNZfOWvQnb">Pulumi</label>
                            <ul>
                                <l>
                                    <input type="checkbox" id="FbtLYteqWG">
                                    <label for="FbtLYteqWG">Dotnet</label>
                                    <ul>
                        ...
                        <l>
                            <input type="checkbox" id="ZUrXVkRZTT">
                            <label for="ZUrXVkRZTT">Terraform</label>
                            <ul>
                                <l>
                                    <input type="checkbox" id="iYvmeWtYyz">
                                    <label for="iYvmeWtYyz">Functions</label>
                                    <ul>
                                ...
                                <l>
                                    <input type="checkbox" id="vpVlEYhZFM">
                                    <label for="vpVlEYhZFM">Meta Arguments</label>
                                    <ul>
                ...
                <l>
                    <input type="checkbox" id="UbzfDCtmSg">
                    <label for="UbzfDCtmSg">Docker</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="djnGiHsnjz">
                    <label for="djnGiHsnjz">Dotnet</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="CHyvVFYaCJ">
                            <label for="CHyvVFYaCJ">Cli</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="lhRIYbqKbV">
                    <label for="lhRIYbqKbV">Functional Programming</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="qYeoBbBVYy">
                    <label for="qYeoBbBVYy">Git</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="nuvIcPRbFI">
                            <label for="nuvIcPRbFI">Github</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="urTctVOViU">
                    <label for="urTctVOViU">Go</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="OISIyScZfk">
                    <label for="OISIyScZfk">Haskell</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="jplMIFwSrz">
                    <label for="jplMIFwSrz">Js</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="aEvITXpwfC">
                            <label for="aEvITXpwfC">Node</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="ZveutNaUqc">
                            <label for="ZveutNaUqc">D3</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="dKlcQQIpfK">
                            <label for="dKlcQQIpfK">Mocha</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="CkCsrhJQcy">
                            <label for="CkCsrhJQcy">P5js</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="lQDjJDaBzW">
                            <label for="lQDjJDaBzW">Typescript</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="IgyjwJMPeb">
                    <label for="IgyjwJMPeb">Kafka</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="bbwLeAUvyp">
                    <label for="bbwLeAUvyp">Kubernetes</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="ZjgvRnJUkv">
                    <label for="ZjgvRnJUkv">Language</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="VXEgpMptZm">
                    <label for="VXEgpMptZm">Linux</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="obJrWvrcfx">
                    <label for="obJrWvrcfx">Python</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="cznjRMcJPO">
                            <label for="cznjRMcJPO">Data Classes</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="NotzeLRPHO">
                            <label for="NotzeLRPHO">Libraries</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="CMxKdtthpN">
                    <label for="CMxKdtthpN">React</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="mczvaXLRuu">
                    <label for="mczvaXLRuu">Regular Expressions</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="bSCvnErILE">
                    <label for="bSCvnErILE">Rust</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="CbSTaxshHp">
                            <label for="CbSTaxshHp">Serde</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="iQFHoiLEMu">
                    <label for="iQFHoiLEMu">Vim</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="AgnVcjwEkg">
                    <label for="AgnVcjwEkg">Web</label>
                    <ul>
