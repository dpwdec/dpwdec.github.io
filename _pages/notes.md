...
<ul>
    <div name="contents-index">
        ...
        <l>
            <input type="checkbox" id="TTnfiYtysu" checked>
            <label for="TTnfiYtysu">Math</label>
            <ul>
                <l>
                    <input type="checkbox" id="JCIUKwQvln">
                    <label for="JCIUKwQvln">Exponentials</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="tqSdJhygNA">
                    <label for="tqSdJhygNA">Linear Algebra</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="GUaEtmdEpT">
                    <label for="GUaEtmdEpT">Logarithms</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="ugByiGcKKP">
                    <label for="ugByiGcKKP">Sequences</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="FPVoTXNVxs">
                    <label for="FPVoTXNVxs">Single Variable Calculus</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="SHYSBuDGda">
                    <label for="SHYSBuDGda">Trigonometry</label>
                    <ul>
        ...
        <l>
            <input type="checkbox" id="KTRjVpnaKo" checked>
            <label for="KTRjVpnaKo">Programming</label>
            <ul>
                <l>
                    <input type="checkbox" id="DtzbFECrla">
                    <label for="DtzbFECrla">Ansible</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="daXAgDroHw">
                    <label for="daXAgDroHw">Architecture</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="vpooLvJkuG">
                    <label for="vpooLvJkuG">Computer Graphics</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="qnpGkwwHBn">
                    <label for="qnpGkwwHBn">Databases</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="hVKBYAuCtb">
                    <label for="hVKBYAuCtb">Devops</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="yNuOQbhbjr">
                            <label for="yNuOQbhbjr">Cloud Computing</label>
                            <ul>
                                <l>
                                    <input type="checkbox" id="RdZXWHgNNE">
                                    <label for="RdZXWHgNNE">AWS</label>
                                    <ul>
                                        <l>
                                            <input type="checkbox" id="yZWqvrubwX">
                                            <label for="yZWqvrubwX">Cli</label>
                                            <ul>
                                        ...
                                        <l>
                                            <input type="checkbox" id="cgKxKHmbua">
                                            <label for="cgKxKHmbua">Ec 2</label>
                                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="RZKSfljVQa">
                            <label for="RZKSfljVQa">Events</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="teeASmLHCr">
                            <label for="teeASmLHCr">Oauth</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="pGBqtWceTF">
                            <label for="pGBqtWceTF">Pulumi</label>
                            <ul>
                                <l>
                                    <input type="checkbox" id="RNqmKGiRPn">
                                    <label for="RNqmKGiRPn">Dotnet</label>
                                    <ul>
                        ...
                        <l>
                            <input type="checkbox" id="NLXmnRZzEB">
                            <label for="NLXmnRZzEB">Terraform</label>
                            <ul>
                                <l>
                                    <input type="checkbox" id="iolvhOBGux">
                                    <label for="iolvhOBGux">Functions</label>
                                    <ul>
                                ...
                                <l>
                                    <input type="checkbox" id="BLTHoLujre">
                                    <label for="BLTHoLujre">Meta Arguments</label>
                                    <ul>
                ...
                <l>
                    <input type="checkbox" id="gsaCPvLrpk">
                    <label for="gsaCPvLrpk">Docker</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="jhceWcZWeo">
                    <label for="jhceWcZWeo">Dotnet</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="FKmLGtUyHV">
                            <label for="FKmLGtUyHV">Cli</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="TSZbDjNtOF">
                    <label for="TSZbDjNtOF">Functional Programming</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="WUJBOaXNxv">
                    <label for="WUJBOaXNxv">Git</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="zfIYOZhXkx">
                            <label for="zfIYOZhXkx">Github</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="gwPxpcSjFp">
                    <label for="gwPxpcSjFp">Go</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="aHwvOaZhVB">
                    <label for="aHwvOaZhVB">Haskell</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="uPnFoTgPoC">
                    <label for="uPnFoTgPoC">Js</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="okyvTbUDZJ">
                            <label for="okyvTbUDZJ">Node</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="rcdMMvXljz">
                            <label for="rcdMMvXljz">Mocha</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="rQPpxDxHUG">
                            <label for="rQPpxDxHUG">P5js</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="ydcvVpLaSn">
                            <label for="ydcvVpLaSn">Typescript</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="BJuPPiLmKT">
                    <label for="BJuPPiLmKT">Kafka</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="OMyRKcwBen">
                    <label for="OMyRKcwBen">Kubernetes</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="RmieYwuRnY">
                    <label for="RmieYwuRnY">Language</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="MvQuRpVORQ">
                    <label for="MvQuRpVORQ">Linux</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="hxTKSkGZsT">
                    <label for="hxTKSkGZsT">Python</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="wCaBeobgjm">
                            <label for="wCaBeobgjm">Data Classes</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="MmPviOQNeB">
                            <label for="MmPviOQNeB">Libraries</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="zoUbZPOGtN">
                    <label for="zoUbZPOGtN">React</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="MPdstAqCMX">
                    <label for="MPdstAqCMX">Regular Expressions</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="LphsVznypC">
                    <label for="LphsVznypC">Rust</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="itSnQMvrMe">
                            <label for="itSnQMvrMe">Serde</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="GACorKwmlt">
                    <label for="GACorKwmlt">Vim</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="wXyPpwnBVo">
                    <label for="wXyPpwnBVo">Web</label>
                    <ul>
