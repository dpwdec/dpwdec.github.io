...
<ul>
    <div name="contents-index">
        ...
        <l>
            <input type="checkbox" id="BgHGxkHZJs" checked>
            <label for="BgHGxkHZJs">Math</label>
            <ul>
                <l>
                    <input type="checkbox" id="fLLyedEniy">
                    <label for="fLLyedEniy">Exponentials</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="qTZWzBXsAH">
                    <label for="qTZWzBXsAH">Linear Algebra</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="uxXqYmqIRE">
                    <label for="uxXqYmqIRE">Logarithms</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="fTHLALogbe">
                    <label for="fTHLALogbe">Sequences</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="LmlCosiGMg">
                    <label for="LmlCosiGMg">Single Variable Calculus</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="UumKsvSHRB">
                    <label for="UumKsvSHRB">Trigonometry</label>
                    <ul>
        ...
        <l>
            <input type="checkbox" id="gRJyqFeHEC" checked>
            <label for="gRJyqFeHEC">Programming</label>
            <ul>
                <l>
                    <input type="checkbox" id="FsDXcCSCku">
                    <label for="FsDXcCSCku">Ansible</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="tsflxXhrmT">
                    <label for="tsflxXhrmT">Architecture</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="umuyxkKfss">
                    <label for="umuyxkKfss">Computer Graphics</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="fxPSugVVhE">
                    <label for="fxPSugVVhE">Databases</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="KOFxNevRjR">
                    <label for="KOFxNevRjR">Devops</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="NAWmbBSFkW">
                            <label for="NAWmbBSFkW">Cloud Providers</label>
                            <ul>
                                <l>
                                    <input type="checkbox" id="BoYBOIGypl">
                                    <label for="BoYBOIGypl">AWS</label>
                                    <ul>
                                        <l>
                                            <input type="checkbox" id="oGbPhKGgPp">
                                            <label for="oGbPhKGgPp">Cli</label>
                                            <ul>
                                        ...
                                        <l>
                                            <input type="checkbox" id="IBWaECtqWg">
                                            <label for="IBWaECtqWg">Dotnet</label>
                                            <ul>
                                        ...
                                        <l>
                                            <input type="checkbox" id="wFzmVCrcxH">
                                            <label for="wFzmVCrcxH">Ec 2</label>
                                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="pNOegtFXZV">
                            <label for="pNOegtFXZV">Events</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="BSExxlgCdt">
                            <label for="BSExxlgCdt">Localstack</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="hyYIiLobAG">
                            <label for="hyYIiLobAG">Pulumi</label>
                            <ul>
                                <l>
                                    <input type="checkbox" id="MbLQiaplHf">
                                    <label for="MbLQiaplHf">Dotnet</label>
                                    <ul>
                        ...
                        <l>
                            <input type="checkbox" id="KNcCCpaCtd">
                            <label for="KNcCCpaCtd">Serverless Framework</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="StkhcJceWL">
                            <label for="StkhcJceWL">Terraform</label>
                            <ul>
                                <l>
                                    <input type="checkbox" id="yQZsaoLKnY">
                                    <label for="yQZsaoLKnY">Functions</label>
                                    <ul>
                                ...
                                <l>
                                    <input type="checkbox" id="woIsKiVeRY">
                                    <label for="woIsKiVeRY">Meta Arguments</label>
                                    <ul>
                ...
                <l>
                    <input type="checkbox" id="YLYFtASwoI">
                    <label for="YLYFtASwoI">Docker</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="isLrLJHVDr">
                    <label for="isLrLJHVDr">Dotnet</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="ZNqxIcWzpF">
                            <label for="ZNqxIcWzpF">Cli</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="rYKuSVyixa">
                    <label for="rYKuSVyixa">Functional Programming</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="oRJnqIdxwr">
                    <label for="oRJnqIdxwr">Git</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="AgvkaocnSI">
                            <label for="AgvkaocnSI">Github</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="vOBLwSwXGc">
                    <label for="vOBLwSwXGc">Go</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="XRzWROwtrC">
                    <label for="XRzWROwtrC">Haskell</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="ccrSKaPHip">
                    <label for="ccrSKaPHip">Js</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="dVLWjYIGOZ">
                            <label for="dVLWjYIGOZ">Node</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="kNGTaGPdxX">
                            <label for="kNGTaGPdxX">D3</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="vXLXfHqdhJ">
                            <label for="vXLXfHqdhJ">Mocha</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="aURNwbCnPI">
                            <label for="aURNwbCnPI">P5js</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="FvaOcawOZU">
                            <label for="FvaOcawOZU">Typescript</label>
                            <ul>
                                <l>
                                    <input type="checkbox" id="eRGZxfxJxV">
                                    <label for="eRGZxfxJxV">Testing</label>
                                    <ul>
                ...
                <l>
                    <input type="checkbox" id="lctrxPHkgk">
                    <label for="lctrxPHkgk">Kafka</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="YPgLPIfMuk">
                    <label for="YPgLPIfMuk">Kubernetes</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="eYLtoVCFzX">
                    <label for="eYLtoVCFzX">Language</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="ydceBrMXzl">
                    <label for="ydceBrMXzl">Linux</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="MfFUMlIjdL">
                            <label for="MfFUMlIjdL">Bash</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="uHAvRdrzkf">
                    <label for="uHAvRdrzkf">Oauth</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="CbkhIRUDvF">
                    <label for="CbkhIRUDvF">Prometheus</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="FAdMwoKFVs">
                    <label for="FAdMwoKFVs">Python</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="sgoMCfEaUD">
                            <label for="sgoMCfEaUD">Data Classes</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="bYVfBvcXpR">
                            <label for="bYVfBvcXpR">Libraries</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="qCoNREYJGv">
                    <label for="qCoNREYJGv">React</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="KttePsyjCF">
                    <label for="KttePsyjCF">Regular Expressions</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="xYeZHwtJcS">
                    <label for="xYeZHwtJcS">Rust</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="IZlDeMDtuc">
                            <label for="IZlDeMDtuc">Serde</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="oSqTcCXYTy">
                    <label for="oSqTcCXYTy">Shaders</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="kgXjLpbUHN">
                            <label for="kgXjLpbUHN">Glsl</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="hzWzdEgtyD">
                    <label for="hzWzdEgtyD">Vim</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="QuRifhWmrJ">
                    <label for="QuRifhWmrJ">Web</label>
                    <ul>
