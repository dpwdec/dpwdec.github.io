...
<ul>
    <div name="contents-index">
        ...
        <l>
            <input type="checkbox" id="cgyOqetaus" checked>
            <label for="cgyOqetaus">Math</label>
            <ul>
                <l>
                    <input type="checkbox" id="Bjdhwmewzl">
                    <label for="Bjdhwmewzl">Exponentials</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="edTbNBRYNS">
                    <label for="edTbNBRYNS">Linear Algebra</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="YzQPxFMMok">
                    <label for="YzQPxFMMok">Logarithms</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="RRLVKDmnAR">
                    <label for="RRLVKDmnAR">Sequences</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="wNkHQShxKK">
                    <label for="wNkHQShxKK">Single Variable Calculus</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="HLinvxbjKC">
                    <label for="HLinvxbjKC">Trigonometry</label>
                    <ul>
        ...
        <l>
            <input type="checkbox" id="WqeeHAJGop" checked>
            <label for="WqeeHAJGop">Programming</label>
            <ul>
                <l>
                    <input type="checkbox" id="wWZNCOtXan">
                    <label for="wWZNCOtXan">Ansible</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="LCyIUEIvVN">
                    <label for="LCyIUEIvVN">Architecture</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="xTVAVnWrcd">
                    <label for="xTVAVnWrcd">Computer Graphics</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="ZbERVtYxEM">
                    <label for="ZbERVtYxEM">Databases</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="kloxutODlw">
                    <label for="kloxutODlw">Devops</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="JXjzmMefVl">
                            <label for="JXjzmMefVl">Cloud Providers</label>
                            <ul>
                                <l>
                                    <input type="checkbox" id="gXnPYXVtnM">
                                    <label for="gXnPYXVtnM">AWS</label>
                                    <ul>
                                        <l>
                                            <input type="checkbox" id="gagGPCyXAl">
                                            <label for="gagGPCyXAl">Cli</label>
                                            <ul>
                                        ...
                                        <l>
                                            <input type="checkbox" id="lsRNgYQPrX">
                                            <label for="lsRNgYQPrX">Dotnet</label>
                                            <ul>
                                        ...
                                        <l>
                                            <input type="checkbox" id="IwTlqblrcs">
                                            <label for="IwTlqblrcs">Ec 2</label>
                                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="BzgKJFmQfY">
                            <label for="BzgKJFmQfY">Events</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="HrzrEnOojS">
                            <label for="HrzrEnOojS">Localstack</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="jpJZiKpFXs">
                            <label for="jpJZiKpFXs">Pulumi</label>
                            <ul>
                                <l>
                                    <input type="checkbox" id="YyUIDOgURj">
                                    <label for="YyUIDOgURj">Dotnet</label>
                                    <ul>
                        ...
                        <l>
                            <input type="checkbox" id="dhIFYuZnbn">
                            <label for="dhIFYuZnbn">Serverless Framework</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="QXimbAbfKw">
                            <label for="QXimbAbfKw">Terraform</label>
                            <ul>
                                <l>
                                    <input type="checkbox" id="xOcUUgERDo">
                                    <label for="xOcUUgERDo">Functions</label>
                                    <ul>
                                ...
                                <l>
                                    <input type="checkbox" id="uHIwSWUjFJ">
                                    <label for="uHIwSWUjFJ">Meta Arguments</label>
                                    <ul>
                ...
                <l>
                    <input type="checkbox" id="MEDLiYIvsv">
                    <label for="MEDLiYIvsv">Docker</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="VQkoADvTOz">
                    <label for="VQkoADvTOz">Dotnet</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="ZYBOETzlvD">
                            <label for="ZYBOETzlvD">Cli</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="thbxIPKEYT">
                    <label for="thbxIPKEYT">Functional Programming</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="SpdBxnJCnE">
                    <label for="SpdBxnJCnE">Git</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="kxPsqamRLA">
                            <label for="kxPsqamRLA">Github</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="ivMUhxPxDb">
                    <label for="ivMUhxPxDb">Go</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="EcgUYfOgGu">
                    <label for="EcgUYfOgGu">Haskell</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="ghoQHGUjfo">
                    <label for="ghoQHGUjfo">Js</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="XtdNwDIcDC">
                            <label for="XtdNwDIcDC">Node</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="JqVnSELIuI">
                            <label for="JqVnSELIuI">D3</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="PFYvEaippb">
                            <label for="PFYvEaippb">Mocha</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="WWBpRKvUzz">
                            <label for="WWBpRKvUzz">P5js</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="BLkGMZTBik">
                            <label for="BLkGMZTBik">Typescript</label>
                            <ul>
                                <l>
                                    <input type="checkbox" id="FrWwWIXyco">
                                    <label for="FrWwWIXyco">Testing</label>
                                    <ul>
                ...
                <l>
                    <input type="checkbox" id="vOSiMsoSYI">
                    <label for="vOSiMsoSYI">Kafka</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="ZVitvrWZdc">
                    <label for="ZVitvrWZdc">Kubernetes</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="UQSPMTOTTc">
                    <label for="UQSPMTOTTc">Language</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="GDMMEYFHba">
                    <label for="GDMMEYFHba">Linux</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="oryzcZJXRk">
                            <label for="oryzcZJXRk">Bash</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="USoRYTvolp">
                    <label for="USoRYTvolp">Oauth</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="YVuYllFIqC">
                    <label for="YVuYllFIqC">Prometheus</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="NBbKdTlBzT">
                    <label for="NBbKdTlBzT">Python</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="wNOZvntgPx">
                            <label for="wNOZvntgPx">Data Classes</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="ctUSTqFprZ">
                            <label for="ctUSTqFprZ">Libraries</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="wWvqwUlXfU">
                    <label for="wWvqwUlXfU">React</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="ORSKDSatyg">
                    <label for="ORSKDSatyg">Regular Expressions</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="hvyXZCFhFF">
                    <label for="hvyXZCFhFF">Rust</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="isZvZIxPpJ">
                            <label for="isZvZIxPpJ">Serde</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="BZFTLMEKvf">
                    <label for="BZFTLMEKvf">Shaders</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="LpAQOOvoxb">
                            <label for="LpAQOOvoxb">Glsl</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="EJBlArGlBO">
                    <label for="EJBlArGlBO">Vim</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="AEzJwdZyju">
                    <label for="AEzJwdZyju">Web</label>
                    <ul>
