...
<ul>
    <div name="contents-index">
        ...
        <l>
            <input type="checkbox" id="uExGqZzCov" checked>
            <label for="uExGqZzCov">Math</label>
            <ul>
                <l>
                    <input type="checkbox" id="xJhoquBDGF">
                    <label for="xJhoquBDGF">Exponentials</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="vJlLacvJeU">
                    <label for="vJlLacvJeU">Linear Algebra</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="bYIfgsCQQR">
                    <label for="bYIfgsCQQR">Logarithms</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="qaLTFrQwOF">
                    <label for="qaLTFrQwOF">Sequences</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="ywAUhqSdRd">
                    <label for="ywAUhqSdRd">Single Variable Calculus</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="DIFxHuJRye">
                    <label for="DIFxHuJRye">Trigonometry</label>
                    <ul>
        ...
        <l>
            <input type="checkbox" id="DYqhVyfQoK" checked>
            <label for="DYqhVyfQoK">Programming</label>
            <ul>
                <l>
                    <input type="checkbox" id="ujKHvkxBYH">
                    <label for="ujKHvkxBYH">Ansible</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="ReFXVjrXaB">
                    <label for="ReFXVjrXaB">Architecture</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="FHLZOSsEen">
                    <label for="FHLZOSsEen">Computer Graphics</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="AvHxrVNHED">
                    <label for="AvHxrVNHED">Databases</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="GyEPdgYaKj">
                    <label for="GyEPdgYaKj">Devops</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="TyyjjPRqFf">
                            <label for="TyyjjPRqFf">Cloud Computing</label>
                            <ul>
                                <l>
                                    <input type="checkbox" id="gMRDyNcymC">
                                    <label for="gMRDyNcymC">AWS</label>
                                    <ul>
                                        <l>
                                            <input type="checkbox" id="WHQVlqOiTz">
                                            <label for="WHQVlqOiTz">Ec 2</label>
                                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="AQFmZPRhVn">
                            <label for="AQFmZPRhVn">Events</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="XEmktdESIm">
                            <label for="XEmktdESIm">Oauth</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="ABgqpdSPTl">
                            <label for="ABgqpdSPTl">Pulumi</label>
                            <ul>
                                <l>
                                    <input type="checkbox" id="BIxgeXJTWR">
                                    <label for="BIxgeXJTWR">Dotnet</label>
                                    <ul>
                        ...
                        <l>
                            <input type="checkbox" id="lSUBEKuRBV">
                            <label for="lSUBEKuRBV">Terraform</label>
                            <ul>
                                <l>
                                    <input type="checkbox" id="vILBeAJBuI">
                                    <label for="vILBeAJBuI">Functions</label>
                                    <ul>
                                ...
                                <l>
                                    <input type="checkbox" id="xmqTeasyPh">
                                    <label for="xmqTeasyPh">Meta Arguments</label>
                                    <ul>
                ...
                <l>
                    <input type="checkbox" id="DxxSYDogmg">
                    <label for="DxxSYDogmg">Docker</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="KfdDeqgSnm">
                    <label for="KfdDeqgSnm">Dotnet</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="UMhtsFEzht">
                            <label for="UMhtsFEzht">Cli</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="gjPmsGuTHN">
                    <label for="gjPmsGuTHN">Functional Programming</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="XKQmlbdSIK">
                    <label for="XKQmlbdSIK">Git</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="qQIgpwldaE">
                            <label for="qQIgpwldaE">Github</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="DGZYOjvSwT">
                    <label for="DGZYOjvSwT">Go</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="jzhQdDkYFU">
                    <label for="jzhQdDkYFU">Haskell</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="LjBSNSBOWu">
                    <label for="LjBSNSBOWu">Js</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="SmjkpGtxuF">
                            <label for="SmjkpGtxuF">Node</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="oyNsxmHwzn">
                            <label for="oyNsxmHwzn">Mocha</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="bOiroqaMkf">
                            <label for="bOiroqaMkf">P5js</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="oZKQGkAdXC">
                            <label for="oZKQGkAdXC">Typescript</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="RaClVthjiD">
                    <label for="RaClVthjiD">Kafka</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="ebxbOtKrae">
                    <label for="ebxbOtKrae">Kubernetes</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="aUspXUVqyV">
                    <label for="aUspXUVqyV">Language</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="QemBRapeup">
                    <label for="QemBRapeup">Linux</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="sxdoRNvYRk">
                    <label for="sxdoRNvYRk">Python</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="KTNFhdLISB">
                            <label for="KTNFhdLISB">Data Classes</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="OdwtgZTmJn">
                            <label for="OdwtgZTmJn">Libraries</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="fTbdiXfmXE">
                    <label for="fTbdiXfmXE">React</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="jeOpGrKdqJ">
                    <label for="jeOpGrKdqJ">Regular Expressions</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="sYyIlCnaie">
                    <label for="sYyIlCnaie">Rust</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="eRxBkKSPxO">
                            <label for="eRxBkKSPxO">Serde</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="KBBipNSsOr">
                    <label for="KBBipNSsOr">Vim</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="NvxABlrzrV">
                    <label for="NvxABlrzrV">Web</label>
                    <ul>
