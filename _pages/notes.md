...
<ul>
    <div name="contents-index">
        ...
        <l>
            <input type="checkbox" id="GZHrMMAiIC" checked>
            <label for="GZHrMMAiIC">Math</label>
            <ul>
                <l>
                    <input type="checkbox" id="iZElEAaiPe">
                    <label for="iZElEAaiPe">Exponentials</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="pRlsPHFOpo">
                    <label for="pRlsPHFOpo">Linear Algebra</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="glMROQsFed">
                    <label for="glMROQsFed">Logarithms</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="RFNENvsfsx">
                    <label for="RFNENvsfsx">Sequences</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="RtaHQhRxUq">
                    <label for="RtaHQhRxUq">Single Variable Calculus</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="HLBirXpHLV">
                    <label for="HLBirXpHLV">Trigonometry</label>
                    <ul>
        ...
        <l>
            <input type="checkbox" id="xqMOqrYIni" checked>
            <label for="xqMOqrYIni">Programming</label>
            <ul>
                <l>
                    <input type="checkbox" id="vlkkFvDZSt">
                    <label for="vlkkFvDZSt">Ansible</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="ojVInGjofo">
                    <label for="ojVInGjofo">Architecture</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="CXgvcDwDat">
                    <label for="CXgvcDwDat">Computer Graphics</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="GGXyUQMgKm">
                    <label for="GGXyUQMgKm">Databases</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="jQoxwUxTwM">
                    <label for="jQoxwUxTwM">Devops</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="HRKLpywmyK">
                            <label for="HRKLpywmyK">Cloud Providers</label>
                            <ul>
                                <l>
                                    <input type="checkbox" id="GhnrCRLABm">
                                    <label for="GhnrCRLABm">AWS</label>
                                    <ul>
                                        <l>
                                            <input type="checkbox" id="WPuzYaunhj">
                                            <label for="WPuzYaunhj">Cli</label>
                                            <ul>
                                        ...
                                        <l>
                                            <input type="checkbox" id="vefZsrAKCq">
                                            <label for="vefZsrAKCq">Dotnet</label>
                                            <ul>
                                        ...
                                        <l>
                                            <input type="checkbox" id="MywFiuaDUM">
                                            <label for="MywFiuaDUM">Ec 2</label>
                                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="StuNRroUlT">
                            <label for="StuNRroUlT">Events</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="vPiGvQvcJi">
                            <label for="vPiGvQvcJi">Localstack</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="bHleMeWzBX">
                            <label for="bHleMeWzBX">Pulumi</label>
                            <ul>
                                <l>
                                    <input type="checkbox" id="htdwYOqJEi">
                                    <label for="htdwYOqJEi">Dotnet</label>
                                    <ul>
                        ...
                        <l>
                            <input type="checkbox" id="wGeCogqnDI">
                            <label for="wGeCogqnDI">Serverless Framework</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="aziFgQzmLj">
                            <label for="aziFgQzmLj">Terraform</label>
                            <ul>
                                <l>
                                    <input type="checkbox" id="QSPRReaxTH">
                                    <label for="QSPRReaxTH">Functions</label>
                                    <ul>
                                ...
                                <l>
                                    <input type="checkbox" id="aRhsGTyKJb">
                                    <label for="aRhsGTyKJb">Meta Arguments</label>
                                    <ul>
                ...
                <l>
                    <input type="checkbox" id="ZlzleYodck">
                    <label for="ZlzleYodck">Docker</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="fzJNRWQfBb">
                    <label for="fzJNRWQfBb">Dotnet</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="bMHPEbibav">
                            <label for="bMHPEbibav">Cli</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="DSIRBFYvud">
                    <label for="DSIRBFYvud">Functional Programming</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="PgPzpNGFwl">
                    <label for="PgPzpNGFwl">Git</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="HwgmvvObdU">
                            <label for="HwgmvvObdU">Github</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="NFLBNASCMc">
                    <label for="NFLBNASCMc">Go</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="thhmQeSiuK">
                    <label for="thhmQeSiuK">Haskell</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="MHwuGqoPRq">
                    <label for="MHwuGqoPRq">Js</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="IlMccrQahG">
                            <label for="IlMccrQahG">Node</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="SVGBExdiaO">
                            <label for="SVGBExdiaO">D3</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="cLJjnhIEJL">
                            <label for="cLJjnhIEJL">Mocha</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="ghIGVjdNIj">
                            <label for="ghIGVjdNIj">P5js</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="mDNcUufcUd">
                            <label for="mDNcUufcUd">Typescript</label>
                            <ul>
                                <l>
                                    <input type="checkbox" id="VgIlMvtmUP">
                                    <label for="VgIlMvtmUP">Testing</label>
                                    <ul>
                ...
                <l>
                    <input type="checkbox" id="nTFyQbMVrr">
                    <label for="nTFyQbMVrr">Kafka</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="wRCdyRbEgz">
                    <label for="wRCdyRbEgz">Kubernetes</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="RfTnBaGxIA">
                    <label for="RfTnBaGxIA">Language</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="CmBpTWQjVz">
                    <label for="CmBpTWQjVz">Linux</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="pMsszzauef">
                            <label for="pMsszzauef">Bash</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="drbZuNPOPN">
                    <label for="drbZuNPOPN">Oauth</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="qLTfbjoBCc">
                    <label for="qLTfbjoBCc">Prometheus</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="TxGjzTLQlg">
                    <label for="TxGjzTLQlg">Python</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="OyaGaOywQv">
                            <label for="OyaGaOywQv">Data Classes</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="jSyOhXFpoF">
                            <label for="jSyOhXFpoF">Libraries</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="uoMnCamDOj">
                    <label for="uoMnCamDOj">React</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="rusEaOLaur">
                    <label for="rusEaOLaur">Regular Expressions</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="iFxPjofgDO">
                    <label for="iFxPjofgDO">Rust</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="tsBzOxbvVw">
                            <label for="tsBzOxbvVw">Serde</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="RhiTyqBhIK">
                    <label for="RhiTyqBhIK">Shaders</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="hKdPrZsPfP">
                            <label for="hKdPrZsPfP">Glsl</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="bSdEgrEEjP">
                    <label for="bSdEgrEEjP">Vim</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="XnRGZYSvWs">
                    <label for="XnRGZYSvWs">Web</label>
                    <ul>
