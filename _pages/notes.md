...
<ul>
    <div name="contents-index">
        ...
        <l>
            <input type="checkbox" id="onkkkhTnZV" checked>
            <label for="onkkkhTnZV">Math</label>
            <ul>
                <l>
                    <input type="checkbox" id="ntQVDNMeSU">
                    <label for="ntQVDNMeSU">Exponentials</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="zNaJLMVTmi">
                    <label for="zNaJLMVTmi">Linear Algebra</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="iwPdqWWsSj">
                    <label for="iwPdqWWsSj">Logarithms</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="jrQWaafROx">
                    <label for="jrQWaafROx">Sequences</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="QqxsSQVemz">
                    <label for="QqxsSQVemz">Single Variable Calculus</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="LKwJUPgerq">
                    <label for="LKwJUPgerq">Trigonometry</label>
                    <ul>
        ...
        <l>
            <input type="checkbox" id="hoEaulqqhA" checked>
            <label for="hoEaulqqhA">Programming</label>
            <ul>
                <l>
                    <input type="checkbox" id="wmAIsLxEVZ">
                    <label for="wmAIsLxEVZ">Ansible</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="GfzbvfUTZY">
                    <label for="GfzbvfUTZY">Architecture</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="PckJJJXZeh">
                    <label for="PckJJJXZeh">Computer Graphics</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="rixeetpgLg">
                    <label for="rixeetpgLg">Databases</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="lTqLAEXfsU">
                    <label for="lTqLAEXfsU">Devops</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="hkYaGrpxiU">
                            <label for="hkYaGrpxiU">Cloud Providers</label>
                            <ul>
                                <l>
                                    <input type="checkbox" id="DDcQqIHspM">
                                    <label for="DDcQqIHspM">AWS</label>
                                    <ul>
                                        <l>
                                            <input type="checkbox" id="pNTlEMyRby">
                                            <label for="pNTlEMyRby">Cli</label>
                                            <ul>
                                        ...
                                        <l>
                                            <input type="checkbox" id="AUkgHVDVgI">
                                            <label for="AUkgHVDVgI">Dotnet</label>
                                            <ul>
                                        ...
                                        <l>
                                            <input type="checkbox" id="dBodQpscNi">
                                            <label for="dBodQpscNi">Ec 2</label>
                                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="IvPVcvKMHS">
                            <label for="IvPVcvKMHS">Events</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="dUtdTYcLXA">
                            <label for="dUtdTYcLXA">Localstack</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="lYBGkVLMYl">
                            <label for="lYBGkVLMYl">Pulumi</label>
                            <ul>
                                <l>
                                    <input type="checkbox" id="sRsQSUWBtw">
                                    <label for="sRsQSUWBtw">Dotnet</label>
                                    <ul>
                        ...
                        <l>
                            <input type="checkbox" id="iDYPxtcsND">
                            <label for="iDYPxtcsND">Serverless Framework</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="uKSqKLWXHw">
                            <label for="uKSqKLWXHw">Terraform</label>
                            <ul>
                                <l>
                                    <input type="checkbox" id="HqlQMxpEsS">
                                    <label for="HqlQMxpEsS">Functions</label>
                                    <ul>
                                ...
                                <l>
                                    <input type="checkbox" id="mcRzQDAyQp">
                                    <label for="mcRzQDAyQp">Meta Arguments</label>
                                    <ul>
                ...
                <l>
                    <input type="checkbox" id="qGdXofqRJf">
                    <label for="qGdXofqRJf">Docker</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="HpHKgllKNy">
                    <label for="HpHKgllKNy">Dotnet</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="MGKGDnEvnn">
                            <label for="MGKGDnEvnn">Cli</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="kQoZiiWZAw">
                    <label for="kQoZiiWZAw">Functional Programming</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="PKeCJYNsjF">
                    <label for="PKeCJYNsjF">Git</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="jqgAFIOxvV">
                            <label for="jqgAFIOxvV">Github</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="pCPLTxGKeu">
                    <label for="pCPLTxGKeu">Go</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="BXInpKRKis">
                    <label for="BXInpKRKis">Haskell</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="jUpEZEEMXC">
                    <label for="jUpEZEEMXC">Js</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="KYiBCuxoqc">
                            <label for="KYiBCuxoqc">Node</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="tGwCKZVlIP">
                            <label for="tGwCKZVlIP">D3</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="XSPrUFweep">
                            <label for="XSPrUFweep">Mocha</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="qeDKtLPgub">
                            <label for="qeDKtLPgub">P5js</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="OqDYrbDRXV">
                            <label for="OqDYrbDRXV">Typescript</label>
                            <ul>
                                <l>
                                    <input type="checkbox" id="WaDqFqnhMX">
                                    <label for="WaDqFqnhMX">Testing</label>
                                    <ul>
                ...
                <l>
                    <input type="checkbox" id="KbCzRqYets">
                    <label for="KbCzRqYets">Kafka</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="SruyQSycqv">
                    <label for="SruyQSycqv">Kubernetes</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="pLbaxQtIHI">
                    <label for="pLbaxQtIHI">Language</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="hMtweGgebc">
                    <label for="hMtweGgebc">Linux</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="WJFlepEjgp">
                            <label for="WJFlepEjgp">Bash</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="zFqQXGkxiK">
                    <label for="zFqQXGkxiK">Oauth</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="WpiemNTWVz">
                    <label for="WpiemNTWVz">Prometheus</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="qQPmpdIccW">
                    <label for="qQPmpdIccW">Python</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="QHpkYaDkcT">
                            <label for="QHpkYaDkcT">Data Classes</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="fNJdCkPqEZ">
                            <label for="fNJdCkPqEZ">Libraries</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="ADuXlFtqyw">
                    <label for="ADuXlFtqyw">React</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="CtCWpuMyVv">
                    <label for="CtCWpuMyVv">Regular Expressions</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="MelffVPKtk">
                    <label for="MelffVPKtk">Rust</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="ssRIsXMmRI">
                            <label for="ssRIsXMmRI">Serde</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="jjglkXBeMY">
                    <label for="jjglkXBeMY">Shaders</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="NEZcFopNoI">
                            <label for="NEZcFopNoI">Glsl</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="XdXwYmvzxT">
                    <label for="XdXwYmvzxT">Vim</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="JLYSTgrDsm">
                    <label for="JLYSTgrDsm">Web</label>
                    <ul>
