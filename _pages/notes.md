...
<ul>
    <div name="contents-index">
        ...
        <l>
            <input type="checkbox" id="aDMuQYZkGV" checked>
            <label for="aDMuQYZkGV">Math</label>
            <ul>
                <l>
                    <input type="checkbox" id="vPTLkreaJl">
                    <label for="vPTLkreaJl">Exponentials</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="eYAnlJKGtI">
                    <label for="eYAnlJKGtI">Linear Algebra</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="sZpGMGOXjM">
                    <label for="sZpGMGOXjM">Logarithms</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="GpyihHtnVb">
                    <label for="GpyihHtnVb">Sequences</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="agiUjirdMq">
                    <label for="agiUjirdMq">Single Variable Calculus</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="BTynwmkUOB">
                    <label for="BTynwmkUOB">Trigonometry</label>
                    <ul>
        ...
        <l>
            <input type="checkbox" id="qbUFBPvoXo" checked>
            <label for="qbUFBPvoXo">Programming</label>
            <ul>
                <l>
                    <input type="checkbox" id="tnjRyLhUTo">
                    <label for="tnjRyLhUTo">Ansible</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="swpWGisIUk">
                    <label for="swpWGisIUk">Architecture</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="XQBRRwOAEz">
                    <label for="XQBRRwOAEz">Computer Graphics</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="HVSdoAiRPV">
                    <label for="HVSdoAiRPV">Databases</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="kjNAaiBVhT">
                    <label for="kjNAaiBVhT">Devops</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="MdfxunoPsc">
                            <label for="MdfxunoPsc">Cloud Providers</label>
                            <ul>
                                <l>
                                    <input type="checkbox" id="GaVPBvqmPs">
                                    <label for="GaVPBvqmPs">AWS</label>
                                    <ul>
                                        <l>
                                            <input type="checkbox" id="posmTDRTZm">
                                            <label for="posmTDRTZm">Cli</label>
                                            <ul>
                                        ...
                                        <l>
                                            <input type="checkbox" id="wPbXujBhab">
                                            <label for="wPbXujBhab">Dotnet</label>
                                            <ul>
                                        ...
                                        <l>
                                            <input type="checkbox" id="fugWemagbq">
                                            <label for="fugWemagbq">Ec 2</label>
                                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="LWuQrdxRzX">
                            <label for="LWuQrdxRzX">Events</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="NDlkBPDuxy">
                            <label for="NDlkBPDuxy">Localstack</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="gxFrHufuVE">
                            <label for="gxFrHufuVE">Pulumi</label>
                            <ul>
                                <l>
                                    <input type="checkbox" id="ZfhmCkjDaw">
                                    <label for="ZfhmCkjDaw">Dotnet</label>
                                    <ul>
                        ...
                        <l>
                            <input type="checkbox" id="BkRoYFzwbf">
                            <label for="BkRoYFzwbf">Serverless Framework</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="pefRTHYtiL">
                            <label for="pefRTHYtiL">Terraform</label>
                            <ul>
                                <l>
                                    <input type="checkbox" id="kaCmHIwoiF">
                                    <label for="kaCmHIwoiF">Functions</label>
                                    <ul>
                                ...
                                <l>
                                    <input type="checkbox" id="TwDzIUkgNn">
                                    <label for="TwDzIUkgNn">Meta Arguments</label>
                                    <ul>
                ...
                <l>
                    <input type="checkbox" id="osurtPZHzo">
                    <label for="osurtPZHzo">Docker</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="CYoYlZvNcn">
                    <label for="CYoYlZvNcn">Dotnet</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="iWyQkSjnnb">
                            <label for="iWyQkSjnnb">Cli</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="qZUCPBxMTk">
                    <label for="qZUCPBxMTk">Functional Programming</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="MriaGjsTyk">
                    <label for="MriaGjsTyk">Git</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="LmtAAYtPfX">
                            <label for="LmtAAYtPfX">Github</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="XMSzKZcIKY">
                    <label for="XMSzKZcIKY">Go</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="xcrLgxvDcj">
                    <label for="xcrLgxvDcj">Haskell</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="fKQYdaFpRa">
                    <label for="fKQYdaFpRa">Js</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="NOzVOVfbwE">
                            <label for="NOzVOVfbwE">Node</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="yUonVHKEEy">
                            <label for="yUonVHKEEy">D3</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="KxYazqiXkd">
                            <label for="KxYazqiXkd">Mocha</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="pYcfiRXfwx">
                            <label for="pYcfiRXfwx">P5js</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="vGAncwOTBg">
                            <label for="vGAncwOTBg">Typescript</label>
                            <ul>
                                <l>
                                    <input type="checkbox" id="mIAyGLuXPx">
                                    <label for="mIAyGLuXPx">Testing</label>
                                    <ul>
                ...
                <l>
                    <input type="checkbox" id="lFbWGakyvL">
                    <label for="lFbWGakyvL">Kafka</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="FIBfHiVIpW">
                    <label for="FIBfHiVIpW">Kubernetes</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="oyWOvDkyDV">
                    <label for="oyWOvDkyDV">Language</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="NJeojLGUhw">
                    <label for="NJeojLGUhw">Linux</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="AMYWEvwslT">
                            <label for="AMYWEvwslT">Bash</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="FSJkHUYFVC">
                    <label for="FSJkHUYFVC">Oauth</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="JqpKiTFDrP">
                    <label for="JqpKiTFDrP">Python</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="pukqOwJQwc">
                            <label for="pukqOwJQwc">Data Classes</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="KDbWNmfyOB">
                            <label for="KDbWNmfyOB">Libraries</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="hLwOOdMPJD">
                    <label for="hLwOOdMPJD">React</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="rxVDZUHOQy">
                    <label for="rxVDZUHOQy">Regular Expressions</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="ZkLqAgbwcd">
                    <label for="ZkLqAgbwcd">Rust</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="LCDBRCcVka">
                            <label for="LCDBRCcVka">Serde</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="uDtCzNMSCv">
                    <label for="uDtCzNMSCv">Shaders</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="APKQWsRHKr">
                            <label for="APKQWsRHKr">Glsl</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="mHugQpMdGm">
                    <label for="mHugQpMdGm">Vim</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="VYdICaXHXT">
                    <label for="VYdICaXHXT">Web</label>
                    <ul>
