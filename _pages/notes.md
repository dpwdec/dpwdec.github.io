...
<ul>
    <div name="contents-index">
        ...
        <l>
            <input type="checkbox" id="XjVTDZLgYD" checked>
            <label for="XjVTDZLgYD">Math</label>
            <ul>
                <l>
                    <input type="checkbox" id="qRouSuVZmu">
                    <label for="qRouSuVZmu">Exponentials</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="enWVWLwcBX">
                    <label for="enWVWLwcBX">Linear Algebra</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="tczXqjPPZO">
                    <label for="tczXqjPPZO">Logarithms</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="GBbHAztwvq">
                    <label for="GBbHAztwvq">Sequences</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="FknPOfAskq">
                    <label for="FknPOfAskq">Single Variable Calculus</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="msqJxrfGcX">
                    <label for="msqJxrfGcX">Trigonometry</label>
                    <ul>
        ...
        <l>
            <input type="checkbox" id="niIwoXJmly" checked>
            <label for="niIwoXJmly">Programming</label>
            <ul>
                <l>
                    <input type="checkbox" id="lHcODcKnTO">
                    <label for="lHcODcKnTO">Ansible</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="oAqBwjDSMp">
                    <label for="oAqBwjDSMp">Architecture</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="dPGPZjicnY">
                    <label for="dPGPZjicnY">Computer Graphics</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="KziLsGfpZF">
                    <label for="KziLsGfpZF">Databases</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="tSvunFElwf">
                    <label for="tSvunFElwf">Devops</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="lAqKYcAmnF">
                            <label for="lAqKYcAmnF">Cloud Providers</label>
                            <ul>
                                <l>
                                    <input type="checkbox" id="JzriQGDgPb">
                                    <label for="JzriQGDgPb">AWS</label>
                                    <ul>
                                        <l>
                                            <input type="checkbox" id="hwCkJUrPQZ">
                                            <label for="hwCkJUrPQZ">Cli</label>
                                            <ul>
                                        ...
                                        <l>
                                            <input type="checkbox" id="BingJCoDqH">
                                            <label for="BingJCoDqH">Dotnet</label>
                                            <ul>
                                        ...
                                        <l>
                                            <input type="checkbox" id="OgdgTahTGe">
                                            <label for="OgdgTahTGe">Ec 2</label>
                                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="iHrvrFOFax">
                            <label for="iHrvrFOFax">Events</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="DNnDQmqeXp">
                            <label for="DNnDQmqeXp">Localstack</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="YqPWpQvzbH">
                            <label for="YqPWpQvzbH">Pulumi</label>
                            <ul>
                                <l>
                                    <input type="checkbox" id="YIECWsYAKD">
                                    <label for="YIECWsYAKD">Dotnet</label>
                                    <ul>
                        ...
                        <l>
                            <input type="checkbox" id="OaESrANyPd">
                            <label for="OaESrANyPd">Serverless Framework</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="AFftXIOwiu">
                            <label for="AFftXIOwiu">Terraform</label>
                            <ul>
                                <l>
                                    <input type="checkbox" id="rlBIsNIwcB">
                                    <label for="rlBIsNIwcB">Functions</label>
                                    <ul>
                                ...
                                <l>
                                    <input type="checkbox" id="GHjmYyyhow">
                                    <label for="GHjmYyyhow">Meta Arguments</label>
                                    <ul>
                ...
                <l>
                    <input type="checkbox" id="zwihCTAuGQ">
                    <label for="zwihCTAuGQ">Docker</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="GAZBsLeOGp">
                    <label for="GAZBsLeOGp">Dotnet</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="MqvRsJRJSf">
                            <label for="MqvRsJRJSf">Cli</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="RirKXImLKG">
                    <label for="RirKXImLKG">Functional Programming</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="QtvzoFeqTM">
                    <label for="QtvzoFeqTM">Git</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="pZDtUFkQpA">
                            <label for="pZDtUFkQpA">Github</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="BTaQUkVyqX">
                    <label for="BTaQUkVyqX">Go</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="ePpZMuTsZR">
                    <label for="ePpZMuTsZR">Haskell</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="VIJeXdetpk">
                    <label for="VIJeXdetpk">Js</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="cdbHPDhOpF">
                            <label for="cdbHPDhOpF">Node</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="CLpBAlpoVA">
                            <label for="CLpBAlpoVA">D3</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="fgLLIaYcjT">
                            <label for="fgLLIaYcjT">Mocha</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="kzEuHmRePD">
                            <label for="kzEuHmRePD">P5js</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="OCVtLvJNDy">
                            <label for="OCVtLvJNDy">Typescript</label>
                            <ul>
                                <l>
                                    <input type="checkbox" id="InvLwmWDQA">
                                    <label for="InvLwmWDQA">Testing</label>
                                    <ul>
                ...
                <l>
                    <input type="checkbox" id="szqzaUllkc">
                    <label for="szqzaUllkc">Kafka</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="GPEcppSqYh">
                    <label for="GPEcppSqYh">Kubernetes</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="sHLWZROgPB">
                    <label for="sHLWZROgPB">Language</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="cvzyYOeZVj">
                    <label for="cvzyYOeZVj">Linux</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="wwVhdJqazq">
                            <label for="wwVhdJqazq">Bash</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="kkwAgblpbT">
                    <label for="kkwAgblpbT">Oauth</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="khBBvAObpR">
                    <label for="khBBvAObpR">Prometheus</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="YYLUlxjKcP">
                    <label for="YYLUlxjKcP">Python</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="XgfEKvePJP">
                            <label for="XgfEKvePJP">Data Classes</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="JlxAPmDHgx">
                            <label for="JlxAPmDHgx">Libraries</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="gDUApiNMLq">
                    <label for="gDUApiNMLq">React</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="SNxyCWlocc">
                    <label for="SNxyCWlocc">Regular Expressions</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="vggGpJyAfH">
                    <label for="vggGpJyAfH">Rust</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="kpMAtnsfNv">
                            <label for="kpMAtnsfNv">Serde</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="qVrJRexMJy">
                    <label for="qVrJRexMJy">Shaders</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="IxgwBGPGvp">
                            <label for="IxgwBGPGvp">Glsl</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="FKFXpIMMlB">
                    <label for="FKFXpIMMlB">Vim</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="iJiNNDidRl">
                    <label for="iJiNNDidRl">Web</label>
                    <ul>
