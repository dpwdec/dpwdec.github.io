...
<ul>
    <div name="contents-index">
        ...
        <l>
            <input type="checkbox" id="pSpEMEmoej" checked>
            <label for="pSpEMEmoej">Math</label>
            <ul>
                <l>
                    <input type="checkbox" id="tNWDPlDsIO">
                    <label for="tNWDPlDsIO">Exponentials</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="JhMklSEFjz">
                    <label for="JhMklSEFjz">Linear Algebra</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="YbEtmtgHnx">
                    <label for="YbEtmtgHnx">Logarithms</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="YXqtaopmnI">
                    <label for="YXqtaopmnI">Sequences</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="GLUeaSGBnE">
                    <label for="GLUeaSGBnE">Single Variable Calculus</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="CDQBUoQVeD">
                    <label for="CDQBUoQVeD">Trigonometry</label>
                    <ul>
        ...
        <l>
            <input type="checkbox" id="nquJriourj" checked>
            <label for="nquJriourj">Programming</label>
            <ul>
                <l>
                    <input type="checkbox" id="IQtdmKWzkp">
                    <label for="IQtdmKWzkp">Ansible</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="DfhOqgMkEn">
                    <label for="DfhOqgMkEn">Architecture</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="pWlQlxaTxR">
                    <label for="pWlQlxaTxR">Computer Graphics</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="anYdrYcVjf">
                    <label for="anYdrYcVjf">Databases</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="IEnXjvUdmw">
                    <label for="IEnXjvUdmw">Devops</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="IOkAnlELQu">
                            <label for="IOkAnlELQu">Cloud Providers</label>
                            <ul>
                                <l>
                                    <input type="checkbox" id="qhPQoIjXDx">
                                    <label for="qhPQoIjXDx">AWS</label>
                                    <ul>
                                        <l>
                                            <input type="checkbox" id="cMlEZvQoxB">
                                            <label for="cMlEZvQoxB">Cli</label>
                                            <ul>
                                        ...
                                        <l>
                                            <input type="checkbox" id="GszgInyvGr">
                                            <label for="GszgInyvGr">Dotnet</label>
                                            <ul>
                                        ...
                                        <l>
                                            <input type="checkbox" id="mUQkpNnTnJ">
                                            <label for="mUQkpNnTnJ">Ec 2</label>
                                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="TFTjQqEhIn">
                            <label for="TFTjQqEhIn">Events</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="FmAfpJlJXE">
                            <label for="FmAfpJlJXE">Localstack</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="MKElPVLVae">
                            <label for="MKElPVLVae">Pulumi</label>
                            <ul>
                                <l>
                                    <input type="checkbox" id="dSSuYiVGPy">
                                    <label for="dSSuYiVGPy">Dotnet</label>
                                    <ul>
                        ...
                        <l>
                            <input type="checkbox" id="aCIGdtsCZt">
                            <label for="aCIGdtsCZt">Serverless Framework</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="jVQkOsoKjq">
                            <label for="jVQkOsoKjq">Terraform</label>
                            <ul>
                                <l>
                                    <input type="checkbox" id="uXFucOPXIF">
                                    <label for="uXFucOPXIF">Functions</label>
                                    <ul>
                                ...
                                <l>
                                    <input type="checkbox" id="byYHJxExDK">
                                    <label for="byYHJxExDK">Meta Arguments</label>
                                    <ul>
                ...
                <l>
                    <input type="checkbox" id="HUPCrKNJtw">
                    <label for="HUPCrKNJtw">Docker</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="iwZAIoGkAs">
                    <label for="iwZAIoGkAs">Dotnet</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="wkYpGRjzBe">
                            <label for="wkYpGRjzBe">Cli</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="iaHXsuyeit">
                    <label for="iaHXsuyeit">Functional Programming</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="BmJwWjumFA">
                    <label for="BmJwWjumFA">Git</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="mVWsZdiKuh">
                            <label for="mVWsZdiKuh">Github</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="wVYYQxrJha">
                    <label for="wVYYQxrJha">Go</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="PoAVMQMPER">
                    <label for="PoAVMQMPER">Haskell</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="wDHqZtHQSh">
                    <label for="wDHqZtHQSh">Js</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="FfpAmZVvvL">
                            <label for="FfpAmZVvvL">Node</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="cyWfENNKqC">
                            <label for="cyWfENNKqC">D3</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="PqQUnVoNUE">
                            <label for="PqQUnVoNUE">Mocha</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="lgFmJxHqqj">
                            <label for="lgFmJxHqqj">P5js</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="GkNjUuOdbp">
                            <label for="GkNjUuOdbp">Typescript</label>
                            <ul>
                                <l>
                                    <input type="checkbox" id="wgucPwJevQ">
                                    <label for="wgucPwJevQ">Testing</label>
                                    <ul>
                ...
                <l>
                    <input type="checkbox" id="UglxyaEWtb">
                    <label for="UglxyaEWtb">Kafka</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="TGUMkDuLdB">
                    <label for="TGUMkDuLdB">Kubernetes</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="CYuKlKELVR">
                    <label for="CYuKlKELVR">Language</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="utGCQubWvu">
                    <label for="utGCQubWvu">Linux</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="jRnmYRMVVR">
                            <label for="jRnmYRMVVR">Bash</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="RpNEnqXlxf">
                    <label for="RpNEnqXlxf">Oauth</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="NbSxaVUGWH">
                    <label for="NbSxaVUGWH">Prometheus</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="CuGdpQKgFr">
                    <label for="CuGdpQKgFr">Python</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="PxJnorEiwh">
                            <label for="PxJnorEiwh">Data Classes</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="EOaojFypyj">
                            <label for="EOaojFypyj">Libraries</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="plCKKEJVyR">
                    <label for="plCKKEJVyR">React</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="JcmSrJPmCH">
                    <label for="JcmSrJPmCH">Regular Expressions</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="fbTqtyjOtR">
                    <label for="fbTqtyjOtR">Rust</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="RokyjvOQRO">
                            <label for="RokyjvOQRO">Serde</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="VYLqIxPzgB">
                    <label for="VYLqIxPzgB">Shaders</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="ERdpNfrIJt">
                            <label for="ERdpNfrIJt">Glsl</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="nDHDyHjEFD">
                    <label for="nDHDyHjEFD">Vim</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="jeLVJFJHMs">
                    <label for="jeLVJFJHMs">Web</label>
                    <ul>
