...
<ul>
    <div name="contents-index">
        ...
        <l>
            <input type="checkbox" id="JDLCTYPjSA" checked>
            <label for="JDLCTYPjSA">Math</label>
            <ul>
                <l>
                    <input type="checkbox" id="JWDZElEKhR">
                    <label for="JWDZElEKhR">Exponentials</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="zPifSayKkM">
                    <label for="zPifSayKkM">Linear Algebra</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="eNySdStXkB">
                    <label for="eNySdStXkB">Logarithms</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="yhhKYygceT">
                    <label for="yhhKYygceT">Sequences</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="FsItYppNbC">
                    <label for="FsItYppNbC">Single Variable Calculus</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="BlPoZjCbPf">
                    <label for="BlPoZjCbPf">Trigonometry</label>
                    <ul>
        ...
        <l>
            <input type="checkbox" id="XQBoKsTdfr" checked>
            <label for="XQBoKsTdfr">Programming</label>
            <ul>
                <l>
                    <input type="checkbox" id="oAUeVWXLFI">
                    <label for="oAUeVWXLFI">Ansible</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="VnUWzCGmNz">
                    <label for="VnUWzCGmNz">Architecture</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="AFoARlsHRu">
                    <label for="AFoARlsHRu">Computer Graphics</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="HmITkesStM">
                    <label for="HmITkesStM">Databases</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="hLvAwyLQuL">
                    <label for="hLvAwyLQuL">Devops</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="eAcdEmjGpx">
                            <label for="eAcdEmjGpx">Cloud Providers</label>
                            <ul>
                                <l>
                                    <input type="checkbox" id="FmiJqFzXkV">
                                    <label for="FmiJqFzXkV">AWS</label>
                                    <ul>
                                        <l>
                                            <input type="checkbox" id="FDeckQclkq">
                                            <label for="FDeckQclkq">Cli</label>
                                            <ul>
                                        ...
                                        <l>
                                            <input type="checkbox" id="JAqiTFGFtP">
                                            <label for="JAqiTFGFtP">Dotnet</label>
                                            <ul>
                                        ...
                                        <l>
                                            <input type="checkbox" id="PBlTcdmOlB">
                                            <label for="PBlTcdmOlB">Ec 2</label>
                                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="jwdnWJxnpZ">
                            <label for="jwdnWJxnpZ">Events</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="VEbzNEdqLj">
                            <label for="VEbzNEdqLj">Localstack</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="TlDzJBdDHv">
                            <label for="TlDzJBdDHv">Pulumi</label>
                            <ul>
                                <l>
                                    <input type="checkbox" id="QGEXSgFOrL">
                                    <label for="QGEXSgFOrL">Dotnet</label>
                                    <ul>
                        ...
                        <l>
                            <input type="checkbox" id="MGnkdyMlzw">
                            <label for="MGnkdyMlzw">Serverless Framework</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="DjTfGeNzCD">
                            <label for="DjTfGeNzCD">Terraform</label>
                            <ul>
                                <l>
                                    <input type="checkbox" id="NADDGamLyE">
                                    <label for="NADDGamLyE">Functions</label>
                                    <ul>
                                ...
                                <l>
                                    <input type="checkbox" id="IRNYqATyhH">
                                    <label for="IRNYqATyhH">Meta Arguments</label>
                                    <ul>
                ...
                <l>
                    <input type="checkbox" id="oayCdMcCmG">
                    <label for="oayCdMcCmG">Docker</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="ZiuRzNWBvb">
                    <label for="ZiuRzNWBvb">Dotnet</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="RWnclQjuQo">
                            <label for="RWnclQjuQo">Cli</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="BsdLQRksGI">
                    <label for="BsdLQRksGI">Functional Programming</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="GvRJiKEyXq">
                    <label for="GvRJiKEyXq">Git</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="uXGILYQAhk">
                            <label for="uXGILYQAhk">Github</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="SANKWRDgxW">
                    <label for="SANKWRDgxW">Go</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="noItvlYzsy">
                    <label for="noItvlYzsy">Haskell</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="vjDBGRMWqF">
                    <label for="vjDBGRMWqF">Js</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="hOIjwyZlwp">
                            <label for="hOIjwyZlwp">Node</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="lCYytAQzNp">
                            <label for="lCYytAQzNp">D3</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="tEHVwSOeBP">
                            <label for="tEHVwSOeBP">Mocha</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="BvbusdqbXT">
                            <label for="BvbusdqbXT">P5js</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="xAaSBCSERS">
                            <label for="xAaSBCSERS">Typescript</label>
                            <ul>
                                <l>
                                    <input type="checkbox" id="XNkrFzjCMe">
                                    <label for="XNkrFzjCMe">Testing</label>
                                    <ul>
                ...
                <l>
                    <input type="checkbox" id="rViPtLVwFp">
                    <label for="rViPtLVwFp">Kafka</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="KGpxkKRiJk">
                    <label for="KGpxkKRiJk">Kubernetes</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="vBVGSOCCro">
                    <label for="vBVGSOCCro">Language</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="xPqRVVgEfl">
                    <label for="xPqRVVgEfl">Linux</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="RttmhnqPAs">
                            <label for="RttmhnqPAs">Bash</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="EZAhSANlOr">
                    <label for="EZAhSANlOr">Oauth</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="iREBXlNnpJ">
                    <label for="iREBXlNnpJ">Prometheus</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="satUrpNNUF">
                    <label for="satUrpNNUF">Python</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="cyVeyBWWMX">
                            <label for="cyVeyBWWMX">Data Classes</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="hhbQaHNsXs">
                            <label for="hhbQaHNsXs">Libraries</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="WNRwnshRUg">
                    <label for="WNRwnshRUg">React</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="MMLiVXVDAr">
                    <label for="MMLiVXVDAr">Regular Expressions</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="AhhjkIPprq">
                    <label for="AhhjkIPprq">Rust</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="RESUPgCWeD">
                            <label for="RESUPgCWeD">Serde</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="nSQAuejwFd">
                    <label for="nSQAuejwFd">Shaders</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="ivKEBOQxyY">
                            <label for="ivKEBOQxyY">Glsl</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="fyrYozPpbX">
                    <label for="fyrYozPpbX">Vim</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="jBdRgojSlN">
                    <label for="jBdRgojSlN">Web</label>
                    <ul>
