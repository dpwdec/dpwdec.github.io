...
<ul>
    <div name="contents-index">
        ...
        <l>
            <input type="checkbox" id="YHFUSTTykW" checked>
            <label for="YHFUSTTykW">Math</label>
            <ul>
                <l>
                    <input type="checkbox" id="NtSGbuxTcj">
                    <label for="NtSGbuxTcj">Exponentials</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="cSxZOEDAKF">
                    <label for="cSxZOEDAKF">Linear Algebra</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="IuLIqqIWLE">
                    <label for="IuLIqqIWLE">Logarithms</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="ZVlWwEbXKl">
                    <label for="ZVlWwEbXKl">Sequences</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="ZtEMAXNdvX">
                    <label for="ZtEMAXNdvX">Single Variable Calculus</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="xEXXyVOKdR">
                    <label for="xEXXyVOKdR">Trigonometry</label>
                    <ul>
        ...
        <l>
            <input type="checkbox" id="steweLWfTf" checked>
            <label for="steweLWfTf">Programming</label>
            <ul>
                <l>
                    <input type="checkbox" id="MAICZEatMm">
                    <label for="MAICZEatMm">Ansible</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="WKFdcbupCl">
                    <label for="WKFdcbupCl">Architecture</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="PkJOmqYYNu">
                    <label for="PkJOmqYYNu">Computer Graphics</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="QSJREunRPF">
                    <label for="QSJREunRPF">Databases</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="wWdBMAoGly">
                    <label for="wWdBMAoGly">Devops</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="ZjibVQgVEi">
                            <label for="ZjibVQgVEi">Cloud Providers</label>
                            <ul>
                                <l>
                                    <input type="checkbox" id="MEdUNxjrWo">
                                    <label for="MEdUNxjrWo">AWS</label>
                                    <ul>
                                        <l>
                                            <input type="checkbox" id="XuptDasaMm">
                                            <label for="XuptDasaMm">Cli</label>
                                            <ul>
                                        ...
                                        <l>
                                            <input type="checkbox" id="XNgnLBlMwU">
                                            <label for="XNgnLBlMwU">Dotnet</label>
                                            <ul>
                                        ...
                                        <l>
                                            <input type="checkbox" id="EwoDZMnslx">
                                            <label for="EwoDZMnslx">Ec 2</label>
                                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="OtwSgJeZUT">
                            <label for="OtwSgJeZUT">Events</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="uUBvsbKdkU">
                            <label for="uUBvsbKdkU">Localstack</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="pEdGjGSRnc">
                            <label for="pEdGjGSRnc">Pulumi</label>
                            <ul>
                                <l>
                                    <input type="checkbox" id="ATQqHPsGqq">
                                    <label for="ATQqHPsGqq">Dotnet</label>
                                    <ul>
                        ...
                        <l>
                            <input type="checkbox" id="WzhbATkYtd">
                            <label for="WzhbATkYtd">Serverless Framework</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="fdrqusovrT">
                            <label for="fdrqusovrT">Terraform</label>
                            <ul>
                                <l>
                                    <input type="checkbox" id="UEIyIuAIhm">
                                    <label for="UEIyIuAIhm">Functions</label>
                                    <ul>
                                ...
                                <l>
                                    <input type="checkbox" id="UeCeTHWZxp">
                                    <label for="UeCeTHWZxp">Meta Arguments</label>
                                    <ul>
                ...
                <l>
                    <input type="checkbox" id="RrNEhOnvwy">
                    <label for="RrNEhOnvwy">Docker</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="ojKgroWTTa">
                    <label for="ojKgroWTTa">Dotnet</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="BBxBPskfBH">
                            <label for="BBxBPskfBH">Cli</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="SDzxOvOPHS">
                    <label for="SDzxOvOPHS">Functional Programming</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="tHkDrFOYkf">
                    <label for="tHkDrFOYkf">Git</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="iIKyKtYgkU">
                            <label for="iIKyKtYgkU">Github</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="YMqfESPzaq">
                    <label for="YMqfESPzaq">Go</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="lWtqAuKUzc">
                    <label for="lWtqAuKUzc">Haskell</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="jjQCkUCeMQ">
                    <label for="jjQCkUCeMQ">Js</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="pbYseAeHTQ">
                            <label for="pbYseAeHTQ">Node</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="DLAjZsVHKs">
                            <label for="DLAjZsVHKs">D3</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="ZZKLgTeFRb">
                            <label for="ZZKLgTeFRb">Mocha</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="VQQhUWyPSd">
                            <label for="VQQhUWyPSd">P5js</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="zfufCQNuGx">
                            <label for="zfufCQNuGx">Typescript</label>
                            <ul>
                                <l>
                                    <input type="checkbox" id="kPgnZDUNRQ">
                                    <label for="kPgnZDUNRQ">Testing</label>
                                    <ul>
                ...
                <l>
                    <input type="checkbox" id="zLZlrOjhhy">
                    <label for="zLZlrOjhhy">Kafka</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="zZeSNvAirM">
                    <label for="zZeSNvAirM">Kubernetes</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="GJOTDHvApm">
                    <label for="GJOTDHvApm">Language</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="kUazrAhcIh">
                    <label for="kUazrAhcIh">Linux</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="QIwogTbzzB">
                            <label for="QIwogTbzzB">Bash</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="wgZLRvovWg">
                    <label for="wgZLRvovWg">Oauth</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="KQAKzipFOb">
                    <label for="KQAKzipFOb">Prometheus</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="aYlnhTwuot">
                    <label for="aYlnhTwuot">Python</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="ZzbwYyquMn">
                            <label for="ZzbwYyquMn">Data Classes</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="uPXwPdbsqA">
                            <label for="uPXwPdbsqA">Libraries</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="RbvZjsbxOl">
                    <label for="RbvZjsbxOl">React</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="oqnfvfZXdE">
                    <label for="oqnfvfZXdE">Regular Expressions</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="wHDgGKeQvE">
                    <label for="wHDgGKeQvE">Rust</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="sthAlglDeW">
                            <label for="sthAlglDeW">Serde</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="BffCswgUUc">
                    <label for="BffCswgUUc">Shaders</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="MBIJuzkDZV">
                            <label for="MBIJuzkDZV">Glsl</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="zuidhdRTTv">
                    <label for="zuidhdRTTv">Vim</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="IMFOigILrs">
                    <label for="IMFOigILrs">Web</label>
                    <ul>
