...
<ul>
    <div name="contents-index">
        ...
        <l>
            <input type="checkbox" id="neRxUgwyLE" checked>
            <label for="neRxUgwyLE">Math</label>
            <ul>
                <l>
                    <input type="checkbox" id="kWHEWAKrfY">
                    <label for="kWHEWAKrfY">Exponentials</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="YcwCFSTBXZ">
                    <label for="YcwCFSTBXZ">Linear Algebra</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="UJZqGizTZp">
                    <label for="UJZqGizTZp">Logarithms</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="ABNxPJohaw">
                    <label for="ABNxPJohaw">Sequences</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="TIBEJwGATZ">
                    <label for="TIBEJwGATZ">Single Variable Calculus</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="HDdZyvyADn">
                    <label for="HDdZyvyADn">Trigonometry</label>
                    <ul>
        ...
        <l>
            <input type="checkbox" id="tYvRWhliss" checked>
            <label for="tYvRWhliss">Programming</label>
            <ul>
                <l>
                    <input type="checkbox" id="sBUzPuKYFA">
                    <label for="sBUzPuKYFA">Ansible</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="MfxcgBANMs">
                    <label for="MfxcgBANMs">Architecture</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="ZAyrYzRwdO">
                    <label for="ZAyrYzRwdO">Computer Graphics</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="COVstJCflj">
                    <label for="COVstJCflj">Databases</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="tyLsWdsfVE">
                    <label for="tyLsWdsfVE">Devops</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="Lbitlabyuc">
                            <label for="Lbitlabyuc">Cloud Computing</label>
                            <ul>
                                <l>
                                    <input type="checkbox" id="PQXAxTwvEj">
                                    <label for="PQXAxTwvEj">AWS</label>
                                    <ul>
                                        <l>
                                            <input type="checkbox" id="RRNxkHxBDR">
                                            <label for="RRNxkHxBDR">Cli</label>
                                            <ul>
                                        ...
                                        <l>
                                            <input type="checkbox" id="fsALmgJEMz">
                                            <label for="fsALmgJEMz">Dotnet</label>
                                            <ul>
                                        ...
                                        <l>
                                            <input type="checkbox" id="JqPSpkrASR">
                                            <label for="JqPSpkrASR">Ec 2</label>
                                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="YkXXrRrlxg">
                            <label for="YkXXrRrlxg">Events</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="lpagRqrEgc">
                            <label for="lpagRqrEgc">Oauth</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="lfbtEwchoJ">
                            <label for="lfbtEwchoJ">Pulumi</label>
                            <ul>
                                <l>
                                    <input type="checkbox" id="cFmLqcsSWy">
                                    <label for="cFmLqcsSWy">Dotnet</label>
                                    <ul>
                        ...
                        <l>
                            <input type="checkbox" id="sHqjimoegu">
                            <label for="sHqjimoegu">Terraform</label>
                            <ul>
                                <l>
                                    <input type="checkbox" id="LDsFCqmoSu">
                                    <label for="LDsFCqmoSu">Functions</label>
                                    <ul>
                                ...
                                <l>
                                    <input type="checkbox" id="xJUqEelDSS">
                                    <label for="xJUqEelDSS">Meta Arguments</label>
                                    <ul>
                ...
                <l>
                    <input type="checkbox" id="SlQyTfNLIG">
                    <label for="SlQyTfNLIG">Docker</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="EOFFcssPRk">
                    <label for="EOFFcssPRk">Dotnet</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="RIWISEkUkM">
                            <label for="RIWISEkUkM">Cli</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="mLbEhCoBeK">
                    <label for="mLbEhCoBeK">Functional Programming</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="wtPlzIzzot">
                    <label for="wtPlzIzzot">Git</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="cqPadLiGBd">
                            <label for="cqPadLiGBd">Github</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="ysswHJYyxH">
                    <label for="ysswHJYyxH">Go</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="xdwWkOPNzn">
                    <label for="xdwWkOPNzn">Haskell</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="PfWAlAmAFJ">
                    <label for="PfWAlAmAFJ">Js</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="NfYWnQymSc">
                            <label for="NfYWnQymSc">Node</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="KzwiCXaepA">
                            <label for="KzwiCXaepA">Mocha</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="outHTCvdmr">
                            <label for="outHTCvdmr">P5js</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="NvFiQHMbix">
                            <label for="NvFiQHMbix">Typescript</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="lpdRyXgHkN">
                    <label for="lpdRyXgHkN">Kafka</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="lgScUnufUM">
                    <label for="lgScUnufUM">Kubernetes</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="buqzzHGjKy">
                    <label for="buqzzHGjKy">Language</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="QiclwYKkrM">
                    <label for="QiclwYKkrM">Linux</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="udHxpUFoYa">
                    <label for="udHxpUFoYa">Python</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="ohWlPHkrkk">
                            <label for="ohWlPHkrkk">Data Classes</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="YBJgwSAVEX">
                            <label for="YBJgwSAVEX">Libraries</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="bhzKNqxljH">
                    <label for="bhzKNqxljH">React</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="IsIZDxNbQG">
                    <label for="IsIZDxNbQG">Regular Expressions</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="ZsfDtcANHn">
                    <label for="ZsfDtcANHn">Rust</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="habyHoUCZj">
                            <label for="habyHoUCZj">Serde</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="JTLyyFMEbB">
                    <label for="JTLyyFMEbB">Vim</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="FcTggvqkJP">
                    <label for="FcTggvqkJP">Web</label>
                    <ul>
