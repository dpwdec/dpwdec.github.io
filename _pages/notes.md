...
<ul>
    <div name="contents-index">
        ...
        <l>
            <input type="checkbox" id="VRvTgHgcUd" checked>
            <label for="VRvTgHgcUd">Math</label>
            <ul>
                <l>
                    <input type="checkbox" id="ekKwRDBCsu">
                    <label for="ekKwRDBCsu">Exponentials</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="RLXdPTJJeJ">
                    <label for="RLXdPTJJeJ">Linear Algebra</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="vCvMMvxllw">
                    <label for="vCvMMvxllw">Logarithms</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="RSQGBziLHn">
                    <label for="RSQGBziLHn">Sequences</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="rnhNhKBSlZ">
                    <label for="rnhNhKBSlZ">Single Variable Calculus</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="dnJTSyztJu">
                    <label for="dnJTSyztJu">Trigonometry</label>
                    <ul>
        ...
        <l>
            <input type="checkbox" id="zDxFhJpTRs" checked>
            <label for="zDxFhJpTRs">Programming</label>
            <ul>
                <l>
                    <input type="checkbox" id="HrHQSUSCPl">
                    <label for="HrHQSUSCPl">Ansible</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="maaRzbzoYQ">
                    <label for="maaRzbzoYQ">Architecture</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="iqodgTdRca">
                    <label for="iqodgTdRca">Computer Graphics</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="hqHaSqJqrg">
                    <label for="hqHaSqJqrg">Databases</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="OehetoOnFu">
                    <label for="OehetoOnFu">Devops</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="luzVVnHPsD">
                            <label for="luzVVnHPsD">Cloud Providers</label>
                            <ul>
                                <l>
                                    <input type="checkbox" id="eEoPueYPfG">
                                    <label for="eEoPueYPfG">AWS</label>
                                    <ul>
                                        <l>
                                            <input type="checkbox" id="UyswNkoxVF">
                                            <label for="UyswNkoxVF">Cli</label>
                                            <ul>
                                        ...
                                        <l>
                                            <input type="checkbox" id="BUDBYtAwZK">
                                            <label for="BUDBYtAwZK">Dotnet</label>
                                            <ul>
                                        ...
                                        <l>
                                            <input type="checkbox" id="FzcdeHbGTo">
                                            <label for="FzcdeHbGTo">Ec 2</label>
                                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="ZITvOFWScD">
                            <label for="ZITvOFWScD">Events</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="uVpHzEdknL">
                            <label for="uVpHzEdknL">Localstack</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="akjLXTuduC">
                            <label for="akjLXTuduC">Pulumi</label>
                            <ul>
                                <l>
                                    <input type="checkbox" id="ongcENwjvb">
                                    <label for="ongcENwjvb">Dotnet</label>
                                    <ul>
                        ...
                        <l>
                            <input type="checkbox" id="dgFyxyLrHL">
                            <label for="dgFyxyLrHL">Serverless Framework</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="vRmoAnutSV">
                            <label for="vRmoAnutSV">Terraform</label>
                            <ul>
                                <l>
                                    <input type="checkbox" id="ANayhYAtme">
                                    <label for="ANayhYAtme">Functions</label>
                                    <ul>
                                ...
                                <l>
                                    <input type="checkbox" id="UAEVlAixSE">
                                    <label for="UAEVlAixSE">Meta Arguments</label>
                                    <ul>
                ...
                <l>
                    <input type="checkbox" id="PCEtoPWfjg">
                    <label for="PCEtoPWfjg">Docker</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="UfUDeOjhdf">
                    <label for="UfUDeOjhdf">Dotnet</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="gpdJucYKUL">
                            <label for="gpdJucYKUL">Cli</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="qCBxHBKktl">
                    <label for="qCBxHBKktl">Functional Programming</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="rMZosDHpsh">
                    <label for="rMZosDHpsh">Git</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="aNJwAnVciB">
                            <label for="aNJwAnVciB">Github</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="rOPuEOeHnq">
                    <label for="rOPuEOeHnq">Go</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="rKxVBTuYpk">
                    <label for="rKxVBTuYpk">Haskell</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="uwEQXGDHaf">
                    <label for="uwEQXGDHaf">Js</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="LvcMRVTBQv">
                            <label for="LvcMRVTBQv">Node</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="pxqBAJFPMH">
                            <label for="pxqBAJFPMH">D3</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="eCwBodPYfo">
                            <label for="eCwBodPYfo">Mocha</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="VnLSfJGMBm">
                            <label for="VnLSfJGMBm">P5js</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="gMVfjazdBZ">
                            <label for="gMVfjazdBZ">Typescript</label>
                            <ul>
                                <l>
                                    <input type="checkbox" id="rvCtbujCSh">
                                    <label for="rvCtbujCSh">Testing</label>
                                    <ul>
                ...
                <l>
                    <input type="checkbox" id="ZpaFSVMpJz">
                    <label for="ZpaFSVMpJz">Kafka</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="yuQOTjeZFw">
                    <label for="yuQOTjeZFw">Kubernetes</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="gxjCRfbnZc">
                    <label for="gxjCRfbnZc">Language</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="VFispPWKlX">
                    <label for="VFispPWKlX">Linux</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="yZKOMufoGH">
                            <label for="yZKOMufoGH">Bash</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="AJeTMbUiXL">
                    <label for="AJeTMbUiXL">Oauth</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="FTSXGURgNW">
                    <label for="FTSXGURgNW">Python</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="kqrSWGvPTa">
                            <label for="kqrSWGvPTa">Data Classes</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="rhLhIyBJyK">
                            <label for="rhLhIyBJyK">Libraries</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="wkfojmFBIX">
                    <label for="wkfojmFBIX">React</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="SovcPqQAVR">
                    <label for="SovcPqQAVR">Regular Expressions</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="GsRDUuoNEA">
                    <label for="GsRDUuoNEA">Rust</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="vOqhSgNMsc">
                            <label for="vOqhSgNMsc">Serde</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="IsXienHzEs">
                    <label for="IsXienHzEs">Shaders</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="fRxRHSgKZW">
                            <label for="fRxRHSgKZW">Glsl</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="FlAHUmpofN">
                    <label for="FlAHUmpofN">Vim</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="qmExXRedBm">
                    <label for="qmExXRedBm">Web</label>
                    <ul>
