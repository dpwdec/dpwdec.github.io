...
<ul>
    <div name="contents-index">
        ...
        <l>
            <input type="checkbox" id="yizEzPGEyA" checked>
            <label for="yizEzPGEyA">Math</label>
            <ul>
                <l>
                    <input type="checkbox" id="ujdsffTnzV">
                    <label for="ujdsffTnzV">Exponentials</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="XIjiSxzUHx">
                    <label for="XIjiSxzUHx">Linear Algebra</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="WyTVAqjREA">
                    <label for="WyTVAqjREA">Logarithms</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="FyPzeEqdom">
                    <label for="FyPzeEqdom">Sequences</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="vpgMvkLOEI">
                    <label for="vpgMvkLOEI">Single Variable Calculus</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="pBCtwkOrOW">
                    <label for="pBCtwkOrOW">Trigonometry</label>
                    <ul>
        ...
        <l>
            <input type="checkbox" id="ChjPLjqsXT" checked>
            <label for="ChjPLjqsXT">Programming</label>
            <ul>
                <l>
                    <input type="checkbox" id="qzgcrWFMhZ">
                    <label for="qzgcrWFMhZ">Ansible</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="cGAZWuqVxL">
                    <label for="cGAZWuqVxL">Architecture</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="aTZriRKipl">
                    <label for="aTZriRKipl">Computer Graphics</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="dzTBhbLrNs">
                    <label for="dzTBhbLrNs">Databases</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="CHbbNAnezb">
                    <label for="CHbbNAnezb">Devops</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="cPEIEywvAo">
                            <label for="cPEIEywvAo">Cloud Providers</label>
                            <ul>
                                <l>
                                    <input type="checkbox" id="TKOIvejkqE">
                                    <label for="TKOIvejkqE">AWS</label>
                                    <ul>
                                        <l>
                                            <input type="checkbox" id="vFSaIFWjsw">
                                            <label for="vFSaIFWjsw">Cli</label>
                                            <ul>
                                        ...
                                        <l>
                                            <input type="checkbox" id="JutAmHfeLi">
                                            <label for="JutAmHfeLi">Dotnet</label>
                                            <ul>
                                        ...
                                        <l>
                                            <input type="checkbox" id="pLtXjWeXFf">
                                            <label for="pLtXjWeXFf">Ec 2</label>
                                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="VnhbWtEraS">
                            <label for="VnhbWtEraS">Events</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="EoHRgeIjSY">
                            <label for="EoHRgeIjSY">Localstack</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="DxOkfTnluv">
                            <label for="DxOkfTnluv">Pulumi</label>
                            <ul>
                                <l>
                                    <input type="checkbox" id="tJsEoLALmu">
                                    <label for="tJsEoLALmu">Dotnet</label>
                                    <ul>
                        ...
                        <l>
                            <input type="checkbox" id="nbarSqjhFK">
                            <label for="nbarSqjhFK">Serverless Framework</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="xlFUNSOKMG">
                            <label for="xlFUNSOKMG">Terraform</label>
                            <ul>
                                <l>
                                    <input type="checkbox" id="MOWMDuyPor">
                                    <label for="MOWMDuyPor">Functions</label>
                                    <ul>
                                ...
                                <l>
                                    <input type="checkbox" id="dzdoSJtZjN">
                                    <label for="dzdoSJtZjN">Meta Arguments</label>
                                    <ul>
                ...
                <l>
                    <input type="checkbox" id="LRBPZIiagK">
                    <label for="LRBPZIiagK">Docker</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="swLqGayfQF">
                    <label for="swLqGayfQF">Dotnet</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="RkwtUAuEYy">
                            <label for="RkwtUAuEYy">Cli</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="jpKqBoBTDM">
                    <label for="jpKqBoBTDM">Functional Programming</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="UeGEItumJi">
                    <label for="UeGEItumJi">Git</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="dfATmENeYI">
                            <label for="dfATmENeYI">Github</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="piOfgiHJIx">
                    <label for="piOfgiHJIx">Go</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="XNHfshGKgx">
                    <label for="XNHfshGKgx">Haskell</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="AxWSoOhEwp">
                    <label for="AxWSoOhEwp">Js</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="CoPotntbsE">
                            <label for="CoPotntbsE">Node</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="SEKVkfxArF">
                            <label for="SEKVkfxArF">D3</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="uthnCnAoGj">
                            <label for="uthnCnAoGj">Mocha</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="LImlyQdNlm">
                            <label for="LImlyQdNlm">P5js</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="OewftjiyaE">
                            <label for="OewftjiyaE">Typescript</label>
                            <ul>
                                <l>
                                    <input type="checkbox" id="dVbqAQuGTv">
                                    <label for="dVbqAQuGTv">Testing</label>
                                    <ul>
                ...
                <l>
                    <input type="checkbox" id="jrkSGDMYfm">
                    <label for="jrkSGDMYfm">Kafka</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="IytnbNikDT">
                    <label for="IytnbNikDT">Kubernetes</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="PvuEsajJht">
                    <label for="PvuEsajJht">Language</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="UiSvUHHHce">
                    <label for="UiSvUHHHce">Linux</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="VnzYBTGals">
                            <label for="VnzYBTGals">Bash</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="gLsXTDvuTT">
                    <label for="gLsXTDvuTT">Oauth</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="FJVMqrbsrE">
                    <label for="FJVMqrbsrE">Prometheus</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="mEiFEUWsMF">
                    <label for="mEiFEUWsMF">Python</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="OYZnonTXWs">
                            <label for="OYZnonTXWs">Data Classes</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="JNyKYWzNuu">
                            <label for="JNyKYWzNuu">Libraries</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="bAyAyBGLIb">
                    <label for="bAyAyBGLIb">React</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="cTjutQDgVK">
                    <label for="cTjutQDgVK">Regular Expressions</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="sSZzeXdIYK">
                    <label for="sSZzeXdIYK">Rust</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="ivrPpOvQWx">
                            <label for="ivrPpOvQWx">Serde</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="hubRQnIiIr">
                    <label for="hubRQnIiIr">Shaders</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="lkoGfMQzak">
                            <label for="lkoGfMQzak">Glsl</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="fiGohrsYYi">
                    <label for="fiGohrsYYi">Vim</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="nIDhwUHDYs">
                    <label for="nIDhwUHDYs">Web</label>
                    <ul>
