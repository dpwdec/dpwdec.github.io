...
<ul>
    <div name="contents-index">
        ...
        <l>
            <input type="checkbox" id="HoUxJHBrcw" checked>
            <label for="HoUxJHBrcw">Math</label>
            <ul>
                <l>
                    <input type="checkbox" id="chXwtqIzXx">
                    <label for="chXwtqIzXx">Exponentials</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="HkhUhdmyFk">
                    <label for="HkhUhdmyFk">Linear Algebra</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="YmIvAZbEVn">
                    <label for="YmIvAZbEVn">Logarithms</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="XHmWjsSqxN">
                    <label for="XHmWjsSqxN">Sequences</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="tkpKtWtbEv">
                    <label for="tkpKtWtbEv">Single Variable Calculus</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="CLkraKijQu">
                    <label for="CLkraKijQu">Trigonometry</label>
                    <ul>
        ...
        <l>
            <input type="checkbox" id="YLNwEOmduW" checked>
            <label for="YLNwEOmduW">Programming</label>
            <ul>
                <l>
                    <input type="checkbox" id="MWeFipzNJp">
                    <label for="MWeFipzNJp">Ansible</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="aCfIwyAVfo">
                    <label for="aCfIwyAVfo">Architecture</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="coLvLBrYam">
                    <label for="coLvLBrYam">Computer Graphics</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="txnFtpcwyh">
                    <label for="txnFtpcwyh">Databases</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="oRTAYajHNz">
                    <label for="oRTAYajHNz">Devops</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="oloRCPTwdo">
                            <label for="oloRCPTwdo">Cloud Providers</label>
                            <ul>
                                <l>
                                    <input type="checkbox" id="VhtLCBqGdB">
                                    <label for="VhtLCBqGdB">AWS</label>
                                    <ul>
                                        <l>
                                            <input type="checkbox" id="ZYlYOSBZOb">
                                            <label for="ZYlYOSBZOb">Cli</label>
                                            <ul>
                                        ...
                                        <l>
                                            <input type="checkbox" id="roNryRVRNO">
                                            <label for="roNryRVRNO">Dotnet</label>
                                            <ul>
                                        ...
                                        <l>
                                            <input type="checkbox" id="npwnVphKhY">
                                            <label for="npwnVphKhY">Ec 2</label>
                                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="PzEEZQOgpp">
                            <label for="PzEEZQOgpp">Events</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="UOmerAWkCb">
                            <label for="UOmerAWkCb">Localstack</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="UDFbjcXdSz">
                            <label for="UDFbjcXdSz">Pulumi</label>
                            <ul>
                                <l>
                                    <input type="checkbox" id="oRvZDiqkbi">
                                    <label for="oRvZDiqkbi">Dotnet</label>
                                    <ul>
                        ...
                        <l>
                            <input type="checkbox" id="rWktIPEyaj">
                            <label for="rWktIPEyaj">Serverless Framework</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="CSNkwrigVI">
                            <label for="CSNkwrigVI">Terraform</label>
                            <ul>
                                <l>
                                    <input type="checkbox" id="exugAYRbGz">
                                    <label for="exugAYRbGz">Functions</label>
                                    <ul>
                                ...
                                <l>
                                    <input type="checkbox" id="qOITVJgQjW">
                                    <label for="qOITVJgQjW">Meta Arguments</label>
                                    <ul>
                ...
                <l>
                    <input type="checkbox" id="wFOorRTMHY">
                    <label for="wFOorRTMHY">Docker</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="qGDTodXylp">
                    <label for="qGDTodXylp">Dotnet</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="ZSoSTFLTzy">
                            <label for="ZSoSTFLTzy">Cli</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="JNArEIKGeY">
                    <label for="JNArEIKGeY">Functional Programming</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="cGsjcXHgag">
                    <label for="cGsjcXHgag">Git</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="qILMINVVYv">
                            <label for="qILMINVVYv">Github</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="EgaFXkQZsB">
                    <label for="EgaFXkQZsB">Go</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="HcLnNcqPFh">
                    <label for="HcLnNcqPFh">Haskell</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="drhJQZDFdt">
                    <label for="drhJQZDFdt">Js</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="DKXiUghmUA">
                            <label for="DKXiUghmUA">Node</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="bBmZzeGnKu">
                            <label for="bBmZzeGnKu">D3</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="CDlnHkwItq">
                            <label for="CDlnHkwItq">Mocha</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="FEYeWRjetL">
                            <label for="FEYeWRjetL">P5js</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="AEctEwSEkT">
                            <label for="AEctEwSEkT">Typescript</label>
                            <ul>
                                <l>
                                    <input type="checkbox" id="NmVpaBqzWa">
                                    <label for="NmVpaBqzWa">Testing</label>
                                    <ul>
                ...
                <l>
                    <input type="checkbox" id="rZGbrRxWsB">
                    <label for="rZGbrRxWsB">Kafka</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="cSwnbKAsYF">
                    <label for="cSwnbKAsYF">Kubernetes</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="NWZTXDUqbf">
                    <label for="NWZTXDUqbf">Language</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="XziHGhtezZ">
                    <label for="XziHGhtezZ">Linux</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="WIxBOpbMgn">
                            <label for="WIxBOpbMgn">Bash</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="GmOKyjfqNv">
                    <label for="GmOKyjfqNv">Oauth</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="PmGqAjFNOK">
                    <label for="PmGqAjFNOK">Prometheus</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="TznkkbdOwd">
                    <label for="TznkkbdOwd">Python</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="NUHeFNGKLp">
                            <label for="NUHeFNGKLp">Data Classes</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="COXaPCpOda">
                            <label for="COXaPCpOda">Libraries</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="vBCTZToFHc">
                    <label for="vBCTZToFHc">React</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="CgyMGkmFlv">
                    <label for="CgyMGkmFlv">Regular Expressions</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="YViXJBNRQM">
                    <label for="YViXJBNRQM">Rust</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="BLNEfFPiws">
                            <label for="BLNEfFPiws">Serde</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="hrfdSVuNFG">
                    <label for="hrfdSVuNFG">Shaders</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="OqtSGtbFTn">
                            <label for="OqtSGtbFTn">Glsl</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="mJczpYAedF">
                    <label for="mJczpYAedF">Vim</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="AUiroDhhqn">
                    <label for="AUiroDhhqn">Web</label>
                    <ul>
