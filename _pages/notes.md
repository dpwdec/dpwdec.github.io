...
<ul>
    <div name="contents-index">
        ...
        <l>
            <input type="checkbox" id="KzLomuHsgM" checked>
            <label for="KzLomuHsgM">Math</label>
            <ul>
                <l>
                    <input type="checkbox" id="ZVJUwaWqCM">
                    <label for="ZVJUwaWqCM">Exponentials</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="rLKAvCSGyx">
                    <label for="rLKAvCSGyx">Linear Algebra</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="iyZLIaQBZP">
                    <label for="iyZLIaQBZP">Logarithms</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="sQFkAnftPE">
                    <label for="sQFkAnftPE">Sequences</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="gMwOLuKrhw">
                    <label for="gMwOLuKrhw">Single Variable Calculus</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="KOeKRUXDBY">
                    <label for="KOeKRUXDBY">Trigonometry</label>
                    <ul>
        ...
        <l>
            <input type="checkbox" id="RuJMbqlLsJ" checked>
            <label for="RuJMbqlLsJ">Programming</label>
            <ul>
                <l>
                    <input type="checkbox" id="CTXIrwaEha">
                    <label for="CTXIrwaEha">Ansible</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="zbrZZJwmSl">
                    <label for="zbrZZJwmSl">Architecture</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="WODfhzNEWO">
                    <label for="WODfhzNEWO">Computer Graphics</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="aqcdbQuAXF">
                    <label for="aqcdbQuAXF">Databases</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="WzfEWVWqSN">
                    <label for="WzfEWVWqSN">Devops</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="esNtsdKKGU">
                            <label for="esNtsdKKGU">Cloud Providers</label>
                            <ul>
                                <l>
                                    <input type="checkbox" id="igGQpcaPis">
                                    <label for="igGQpcaPis">AWS</label>
                                    <ul>
                                        <l>
                                            <input type="checkbox" id="hWNUOhcNMS">
                                            <label for="hWNUOhcNMS">Cli</label>
                                            <ul>
                                        ...
                                        <l>
                                            <input type="checkbox" id="dqeEfGgylL">
                                            <label for="dqeEfGgylL">Dotnet</label>
                                            <ul>
                                        ...
                                        <l>
                                            <input type="checkbox" id="ueTbXOSbcX">
                                            <label for="ueTbXOSbcX">Ec 2</label>
                                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="TlipfyZipv">
                            <label for="TlipfyZipv">Events</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="AOvTKXLzJC">
                            <label for="AOvTKXLzJC">Localstack</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="DmtVNhdBVE">
                            <label for="DmtVNhdBVE">Pulumi</label>
                            <ul>
                                <l>
                                    <input type="checkbox" id="vFcDOZGGlG">
                                    <label for="vFcDOZGGlG">Dotnet</label>
                                    <ul>
                        ...
                        <l>
                            <input type="checkbox" id="jmTSJFMnsk">
                            <label for="jmTSJFMnsk">Serverless Framework</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="kQDEcdCJyN">
                            <label for="kQDEcdCJyN">Terraform</label>
                            <ul>
                                <l>
                                    <input type="checkbox" id="XkDxYIQfXl">
                                    <label for="XkDxYIQfXl">Functions</label>
                                    <ul>
                                ...
                                <l>
                                    <input type="checkbox" id="vgJRcqbHay">
                                    <label for="vgJRcqbHay">Meta Arguments</label>
                                    <ul>
                ...
                <l>
                    <input type="checkbox" id="lzEdhtpKty">
                    <label for="lzEdhtpKty">Docker</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="RDxVcDIEUL">
                    <label for="RDxVcDIEUL">Dotnet</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="VCQuvizvTG">
                            <label for="VCQuvizvTG">Cli</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="EiITvvEVGF">
                    <label for="EiITvvEVGF">Functional Programming</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="UyepIASvSW">
                    <label for="UyepIASvSW">Git</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="ePaVKNOYbn">
                            <label for="ePaVKNOYbn">Github</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="muPfxuEXJi">
                    <label for="muPfxuEXJi">Go</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="IzblmomRCm">
                    <label for="IzblmomRCm">Haskell</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="fkAptOdkma">
                    <label for="fkAptOdkma">Js</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="YpCUjBTNys">
                            <label for="YpCUjBTNys">Node</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="rnjIqWQSCO">
                            <label for="rnjIqWQSCO">D3</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="RUvrqJSVIs">
                            <label for="RUvrqJSVIs">Mocha</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="NPieSaRxiE">
                            <label for="NPieSaRxiE">P5js</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="MsNExfIHFw">
                            <label for="MsNExfIHFw">Typescript</label>
                            <ul>
                                <l>
                                    <input type="checkbox" id="hycRdsTmNa">
                                    <label for="hycRdsTmNa">Testing</label>
                                    <ul>
                ...
                <l>
                    <input type="checkbox" id="yDYhoWszYF">
                    <label for="yDYhoWszYF">Kafka</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="XnskPFzQpu">
                    <label for="XnskPFzQpu">Kubernetes</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="uwvZnJydbv">
                    <label for="uwvZnJydbv">Language</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="jkjuTNtWjS">
                    <label for="jkjuTNtWjS">Linux</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="iRIUCZluzd">
                            <label for="iRIUCZluzd">Bash</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="WdWhNPSoVY">
                    <label for="WdWhNPSoVY">Oauth</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="HGwNPNxAVN">
                    <label for="HGwNPNxAVN">Prometheus</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="vXOzcCXtTf">
                    <label for="vXOzcCXtTf">Python</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="VGoGwZAuNl">
                            <label for="VGoGwZAuNl">Data Classes</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="qdQQKqoMdm">
                            <label for="qdQQKqoMdm">Libraries</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="uGjqkoZIGA">
                    <label for="uGjqkoZIGA">React</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="fUCuumjkXC">
                    <label for="fUCuumjkXC">Regular Expressions</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="nnGPRxliGf">
                    <label for="nnGPRxliGf">Rust</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="AfOumNgdrC">
                            <label for="AfOumNgdrC">Serde</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="qkQBjtDtLY">
                    <label for="qkQBjtDtLY">Shaders</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="ricMLopwUO">
                            <label for="ricMLopwUO">Glsl</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="fFGQwhVWil">
                    <label for="fFGQwhVWil">Vim</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="lvgOczFroD">
                    <label for="lvgOczFroD">Web</label>
                    <ul>
