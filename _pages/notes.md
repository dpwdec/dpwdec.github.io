...
<ul>
    <div name="contents-index">
        ...
        <l>
            <input type="checkbox" id="SHFDPDwFKH" checked>
            <label for="SHFDPDwFKH">Math</label>
            <ul>
                <l>
                    <input type="checkbox" id="NPFFVdTLUT">
                    <label for="NPFFVdTLUT">Exponentials</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="yLBDYNuJkK">
                    <label for="yLBDYNuJkK">Linear Algebra</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="NNFptCprRC">
                    <label for="NNFptCprRC">Logarithms</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="jJTjmMguBV">
                    <label for="jJTjmMguBV">Sequences</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="tOjvTePwog">
                    <label for="tOjvTePwog">Single Variable Calculus</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="zTwosyRoXA">
                    <label for="zTwosyRoXA">Trigonometry</label>
                    <ul>
        ...
        <l>
            <input type="checkbox" id="dmhIkyCEbL" checked>
            <label for="dmhIkyCEbL">Programming</label>
            <ul>
                <l>
                    <input type="checkbox" id="DzJDgcvHvl">
                    <label for="DzJDgcvHvl">Ansible</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="TqIyXhJsKi">
                    <label for="TqIyXhJsKi">Architecture</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="oZnjTmzCuY">
                    <label for="oZnjTmzCuY">Computer Graphics</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="uNtkXzXgYi">
                    <label for="uNtkXzXgYi">Databases</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="mzFhKeRVJf">
                    <label for="mzFhKeRVJf">Devops</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="fZzKUsiXCc">
                            <label for="fZzKUsiXCc">Cloud Computing</label>
                            <ul>
                                <l>
                                    <input type="checkbox" id="WKgcSgGhHc">
                                    <label for="WKgcSgGhHc">AWS</label>
                                    <ul>
                                        <l>
                                            <input type="checkbox" id="RGguYvzRJd">
                                            <label for="RGguYvzRJd">Cli</label>
                                            <ul>
                                        ...
                                        <l>
                                            <input type="checkbox" id="xOcDLZJyDU">
                                            <label for="xOcDLZJyDU">Dotnet</label>
                                            <ul>
                                        ...
                                        <l>
                                            <input type="checkbox" id="dfdoqGprpr">
                                            <label for="dfdoqGprpr">Ec 2</label>
                                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="mLhyIpmJFd">
                            <label for="mLhyIpmJFd">Events</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="lUHItTzxEr">
                            <label for="lUHItTzxEr">Oauth</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="KFQuLikJwH">
                            <label for="KFQuLikJwH">Pulumi</label>
                            <ul>
                                <l>
                                    <input type="checkbox" id="EQtpLvaIuh">
                                    <label for="EQtpLvaIuh">Dotnet</label>
                                    <ul>
                        ...
                        <l>
                            <input type="checkbox" id="HNxaMqllsd">
                            <label for="HNxaMqllsd">Terraform</label>
                            <ul>
                                <l>
                                    <input type="checkbox" id="BHXmPamYCQ">
                                    <label for="BHXmPamYCQ">Functions</label>
                                    <ul>
                                ...
                                <l>
                                    <input type="checkbox" id="nNunfCeAUm">
                                    <label for="nNunfCeAUm">Meta Arguments</label>
                                    <ul>
                ...
                <l>
                    <input type="checkbox" id="BLLtmKWTqw">
                    <label for="BLLtmKWTqw">Docker</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="IEkRJaoiBt">
                    <label for="IEkRJaoiBt">Dotnet</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="rLUCXUKfqQ">
                            <label for="rLUCXUKfqQ">Cli</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="wJJlkxWAui">
                    <label for="wJJlkxWAui">Functional Programming</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="VDyAFnHcgo">
                    <label for="VDyAFnHcgo">Git</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="aUNHSkDIbH">
                            <label for="aUNHSkDIbH">Github</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="TTrqvzwonE">
                    <label for="TTrqvzwonE">Go</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="loljLhhzdh">
                    <label for="loljLhhzdh">Haskell</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="bwblHoeYdR">
                    <label for="bwblHoeYdR">Js</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="CPrmENrneD">
                            <label for="CPrmENrneD">Node</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="BnlsuaKuhT">
                            <label for="BnlsuaKuhT">D3</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="GhxoLoPccp">
                            <label for="GhxoLoPccp">Mocha</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="cxVBpjzOyB">
                            <label for="cxVBpjzOyB">P5js</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="gIZIooyCss">
                            <label for="gIZIooyCss">Typescript</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="QOVKKKGfJU">
                    <label for="QOVKKKGfJU">Kafka</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="tlxaRvBTyf">
                    <label for="tlxaRvBTyf">Kubernetes</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="IXTKxTKicV">
                    <label for="IXTKxTKicV">Language</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="UbhEtypAtm">
                    <label for="UbhEtypAtm">Linux</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="vlsfzRixlo">
                    <label for="vlsfzRixlo">Python</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="ljkAaozSeC">
                            <label for="ljkAaozSeC">Data Classes</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="KNRrgQhYxi">
                            <label for="KNRrgQhYxi">Libraries</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="otdequGmbm">
                    <label for="otdequGmbm">React</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="sfDsYGNPsw">
                    <label for="sfDsYGNPsw">Regular Expressions</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="QLwiwJBYQv">
                    <label for="QLwiwJBYQv">Rust</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="BvsMdemOcx">
                            <label for="BvsMdemOcx">Serde</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="KxDginCxKj">
                    <label for="KxDginCxKj">Vim</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="IXxawoYJDb">
                    <label for="IXxawoYJDb">Web</label>
                    <ul>
