...
<ul>
    <div name="contents-index">
        ...
        <l>
            <input type="checkbox" id="ggRwjDACqM" checked>
            <label for="ggRwjDACqM">Math</label>
            <ul>
                <l>
                    <input type="checkbox" id="RBgcnwnYpE">
                    <label for="RBgcnwnYpE">Exponentials</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="foxDIAVYjc">
                    <label for="foxDIAVYjc">Linear Algebra</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="CBedVmwGhx">
                    <label for="CBedVmwGhx">Logarithms</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="KfkBILnQrg">
                    <label for="KfkBILnQrg">Sequences</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="KdOpazBhGr">
                    <label for="KdOpazBhGr">Single Variable Calculus</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="rsJRPweDpd">
                    <label for="rsJRPweDpd">Trigonometry</label>
                    <ul>
        ...
        <l>
            <input type="checkbox" id="BzAXsLwvRD" checked>
            <label for="BzAXsLwvRD">Programming</label>
            <ul>
                <l>
                    <input type="checkbox" id="OMVpwecoGa">
                    <label for="OMVpwecoGa">Ansible</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="rpTWuhbtjL">
                    <label for="rpTWuhbtjL">Architecture</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="pplgfpcQZe">
                    <label for="pplgfpcQZe">Computer Graphics</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="VIaqIIspYQ">
                    <label for="VIaqIIspYQ">Databases</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="VPjVFHNtme">
                    <label for="VPjVFHNtme">Devops</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="FCWrGkKbDD">
                            <label for="FCWrGkKbDD">Cloud Computing</label>
                            <ul>
                                <l>
                                    <input type="checkbox" id="clYFLHuLdj">
                                    <label for="clYFLHuLdj">AWS</label>
                                    <ul>
                                        <l>
                                            <input type="checkbox" id="RaRfAuPtVU">
                                            <label for="RaRfAuPtVU">Cli</label>
                                            <ul>
                                        ...
                                        <l>
                                            <input type="checkbox" id="zTCbgeGIuI">
                                            <label for="zTCbgeGIuI">Dotnet</label>
                                            <ul>
                                        ...
                                        <l>
                                            <input type="checkbox" id="ufbLaChCaE">
                                            <label for="ufbLaChCaE">Ec 2</label>
                                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="eToqBzMTRb">
                            <label for="eToqBzMTRb">Events</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="AfpnzWTDcU">
                            <label for="AfpnzWTDcU">Localstack</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="HXgQyMpfoF">
                            <label for="HXgQyMpfoF">Oauth</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="DggZojATcx">
                            <label for="DggZojATcx">Pulumi</label>
                            <ul>
                                <l>
                                    <input type="checkbox" id="kzJrMiLERV">
                                    <label for="kzJrMiLERV">Dotnet</label>
                                    <ul>
                        ...
                        <l>
                            <input type="checkbox" id="zzebgDxkuF">
                            <label for="zzebgDxkuF">Terraform</label>
                            <ul>
                                <l>
                                    <input type="checkbox" id="hwDypUWYXW">
                                    <label for="hwDypUWYXW">Functions</label>
                                    <ul>
                                ...
                                <l>
                                    <input type="checkbox" id="rpjqczoarh">
                                    <label for="rpjqczoarh">Meta Arguments</label>
                                    <ul>
                ...
                <l>
                    <input type="checkbox" id="AdBQtpGdHh">
                    <label for="AdBQtpGdHh">Docker</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="ylKDteqHmP">
                    <label for="ylKDteqHmP">Dotnet</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="NvxsvuPwdJ">
                            <label for="NvxsvuPwdJ">Cli</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="PsnrbBbDLq">
                    <label for="PsnrbBbDLq">Functional Programming</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="yzSKChPAgf">
                    <label for="yzSKChPAgf">Git</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="erSibNcqIE">
                            <label for="erSibNcqIE">Github</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="fTRYxvwasA">
                    <label for="fTRYxvwasA">Go</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="cvOmtHTpTF">
                    <label for="cvOmtHTpTF">Haskell</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="plktCVoWdt">
                    <label for="plktCVoWdt">Js</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="QILxXfKXrw">
                            <label for="QILxXfKXrw">Node</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="SdkeocOziM">
                            <label for="SdkeocOziM">D3</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="NdorzVvhjS">
                            <label for="NdorzVvhjS">Mocha</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="bRzNBjDLma">
                            <label for="bRzNBjDLma">P5js</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="yLgEbkkNYO">
                            <label for="yLgEbkkNYO">Typescript</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="LnHDxJBjbc">
                    <label for="LnHDxJBjbc">Kafka</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="aZTXQHlunp">
                    <label for="aZTXQHlunp">Kubernetes</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="lXgUIphNkH">
                    <label for="lXgUIphNkH">Language</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="EwXQUPyEZb">
                    <label for="EwXQUPyEZb">Linux</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="eHAfgNiXxS">
                            <label for="eHAfgNiXxS">Bash</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="zgwJXPmjEE">
                    <label for="zgwJXPmjEE">Python</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="qgHdCRGDaN">
                            <label for="qgHdCRGDaN">Data Classes</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="RgEXlTPRyw">
                            <label for="RgEXlTPRyw">Libraries</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="zxxZUCivrh">
                    <label for="zxxZUCivrh">React</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="jwjaJXbUbE">
                    <label for="jwjaJXbUbE">Regular Expressions</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="FpBtTXJaEy">
                    <label for="FpBtTXJaEy">Rust</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="NayDvvfCsj">
                            <label for="NayDvvfCsj">Serde</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="gRrwTGiTZm">
                    <label for="gRrwTGiTZm">Vim</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="LacQZTdawk">
                    <label for="LacQZTdawk">Web</label>
                    <ul>
