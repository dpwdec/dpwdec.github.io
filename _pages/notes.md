...
<ul>
    <div name="contents-index">
        ...
        <l>
            <input type="checkbox" id="sQqyYXGlxx" checked>
            <label for="sQqyYXGlxx">Math</label>
            <ul>
                <l>
                    <input type="checkbox" id="IeEMOlvUGs">
                    <label for="IeEMOlvUGs">Exponentials</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="UYOIhYRXAs">
                    <label for="UYOIhYRXAs">Linear Algebra</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="qaUhhysAOh">
                    <label for="qaUhhysAOh">Logarithms</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="ceaSIIJNxQ">
                    <label for="ceaSIIJNxQ">Sequences</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="zLJfPOitkB">
                    <label for="zLJfPOitkB">Single Variable Calculus</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="ujAQDObqSv">
                    <label for="ujAQDObqSv">Trigonometry</label>
                    <ul>
        ...
        <l>
            <input type="checkbox" id="qpHMcRWCpd" checked>
            <label for="qpHMcRWCpd">Programming</label>
            <ul>
                <l>
                    <input type="checkbox" id="zCUhSgFjdR">
                    <label for="zCUhSgFjdR">Ansible</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="HuMxKioLmz">
                    <label for="HuMxKioLmz">Architecture</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="QrCVKOSAMX">
                    <label for="QrCVKOSAMX">Computer Graphics</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="WljOLGegtA">
                    <label for="WljOLGegtA">Databases</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="HDMFiuRjGs">
                    <label for="HDMFiuRjGs">Devops</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="BfIEHNgUuX">
                            <label for="BfIEHNgUuX">Cloud Providers</label>
                            <ul>
                                <l>
                                    <input type="checkbox" id="EsZpNEIMQo">
                                    <label for="EsZpNEIMQo">AWS</label>
                                    <ul>
                                        <l>
                                            <input type="checkbox" id="nPobcvgdrr">
                                            <label for="nPobcvgdrr">Cli</label>
                                            <ul>
                                        ...
                                        <l>
                                            <input type="checkbox" id="FWPmxkDgon">
                                            <label for="FWPmxkDgon">Dotnet</label>
                                            <ul>
                                        ...
                                        <l>
                                            <input type="checkbox" id="MOznApjqTy">
                                            <label for="MOznApjqTy">Ec 2</label>
                                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="dzqxZJOlzG">
                            <label for="dzqxZJOlzG">Events</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="NJNzkVDocx">
                            <label for="NJNzkVDocx">Localstack</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="zituzXCAZg">
                            <label for="zituzXCAZg">Pulumi</label>
                            <ul>
                                <l>
                                    <input type="checkbox" id="SSLhsIpKTb">
                                    <label for="SSLhsIpKTb">Dotnet</label>
                                    <ul>
                        ...
                        <l>
                            <input type="checkbox" id="aUjmzySFqk">
                            <label for="aUjmzySFqk">Serverless Framework</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="VMQkZAhEjC">
                            <label for="VMQkZAhEjC">Terraform</label>
                            <ul>
                                <l>
                                    <input type="checkbox" id="nPoQBpfOYA">
                                    <label for="nPoQBpfOYA">Functions</label>
                                    <ul>
                                ...
                                <l>
                                    <input type="checkbox" id="ohQkfGEaNS">
                                    <label for="ohQkfGEaNS">Meta Arguments</label>
                                    <ul>
                ...
                <l>
                    <input type="checkbox" id="zMvlVHvKZA">
                    <label for="zMvlVHvKZA">Docker</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="qCjniRSrJH">
                    <label for="qCjniRSrJH">Dotnet</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="HUaKgBcngD">
                            <label for="HUaKgBcngD">Cli</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="HjcMHEEnuM">
                    <label for="HjcMHEEnuM">Functional Programming</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="hDrARUdlHz">
                    <label for="hDrARUdlHz">Git</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="lEFaiAoyMZ">
                            <label for="lEFaiAoyMZ">Github</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="EmaFDILwxF">
                    <label for="EmaFDILwxF">Go</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="JEBzRpyhQp">
                    <label for="JEBzRpyhQp">Haskell</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="NrEeyXzooM">
                    <label for="NrEeyXzooM">Js</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="wjyPqFUCeJ">
                            <label for="wjyPqFUCeJ">Node</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="ovrKTzofsS">
                            <label for="ovrKTzofsS">D3</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="NUjechEAuo">
                            <label for="NUjechEAuo">Mocha</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="attBlmcUuE">
                            <label for="attBlmcUuE">P5js</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="YyFndhLNMQ">
                            <label for="YyFndhLNMQ">Typescript</label>
                            <ul>
                                <l>
                                    <input type="checkbox" id="pqQwrzZaOM">
                                    <label for="pqQwrzZaOM">Testing</label>
                                    <ul>
                ...
                <l>
                    <input type="checkbox" id="EkqWgTFpRX">
                    <label for="EkqWgTFpRX">Kafka</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="BnHqsrFrqG">
                    <label for="BnHqsrFrqG">Kubernetes</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="vWqheMElbA">
                    <label for="vWqheMElbA">Language</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="zDTIVIWXNK">
                    <label for="zDTIVIWXNK">Linux</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="KyRlfPBlRi">
                            <label for="KyRlfPBlRi">Bash</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="wScOqDkQUR">
                    <label for="wScOqDkQUR">Oauth</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="kialKoubBx">
                    <label for="kialKoubBx">Prometheus</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="gFWfpKvGbC">
                    <label for="gFWfpKvGbC">Python</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="cxwVrUiQfv">
                            <label for="cxwVrUiQfv">Data Classes</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="CbItuFurCj">
                            <label for="CbItuFurCj">Libraries</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="GaaizNULHT">
                    <label for="GaaizNULHT">React</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="kUqtLVXUBq">
                    <label for="kUqtLVXUBq">Regular Expressions</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="EQnEdsplKh">
                    <label for="EQnEdsplKh">Rust</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="xEwjqRWzRv">
                            <label for="xEwjqRWzRv">Serde</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="dVrrHNEBZq">
                    <label for="dVrrHNEBZq">Shaders</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="kUnGzjrnKy">
                            <label for="kUnGzjrnKy">Glsl</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="ScOeivOuXH">
                    <label for="ScOeivOuXH">Vim</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="AkADAINMqv">
                    <label for="AkADAINMqv">Web</label>
                    <ul>
