...
<ul>
    <div name="contents-index">
        ...
        <l>
            <input type="checkbox" id="wzbVkYUZdQ" checked>
            <label for="wzbVkYUZdQ">Math</label>
            <ul>
                <l>
                    <input type="checkbox" id="HxZQJVoMxY">
                    <label for="HxZQJVoMxY">Exponentials</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="qNAIPTDRCR">
                    <label for="qNAIPTDRCR">Linear Algebra</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="RGoyRRRcZY">
                    <label for="RGoyRRRcZY">Logarithms</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="WhwmkPEuiw">
                    <label for="WhwmkPEuiw">Sequences</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="HxAZPTNyuh">
                    <label for="HxAZPTNyuh">Single Variable Calculus</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="ecCIxfUXlu">
                    <label for="ecCIxfUXlu">Trigonometry</label>
                    <ul>
        ...
        <l>
            <input type="checkbox" id="shLeinzfMB" checked>
            <label for="shLeinzfMB">Programming</label>
            <ul>
                <l>
                    <input type="checkbox" id="mSLuYHHGBf">
                    <label for="mSLuYHHGBf">Ansible</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="AuIlySNmZk">
                    <label for="AuIlySNmZk">Architecture</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="OLVRQOemMs">
                    <label for="OLVRQOemMs">Computer Graphics</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="WuGnmhEqzV">
                    <label for="WuGnmhEqzV">Databases</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="HYIvTbBSoK">
                    <label for="HYIvTbBSoK">Devops</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="GDuGWrCjpH">
                            <label for="GDuGWrCjpH">Cloud Computing</label>
                            <ul>
                                <l>
                                    <input type="checkbox" id="oanyxyiMmr">
                                    <label for="oanyxyiMmr">AWS</label>
                                    <ul>
                                        <l>
                                            <input type="checkbox" id="qUuTEIqPKe">
                                            <label for="qUuTEIqPKe">Cli</label>
                                            <ul>
                                        ...
                                        <l>
                                            <input type="checkbox" id="zUsYwVXDqe">
                                            <label for="zUsYwVXDqe">Dotnet</label>
                                            <ul>
                                        ...
                                        <l>
                                            <input type="checkbox" id="DrRuFXFMiL">
                                            <label for="DrRuFXFMiL">Ec 2</label>
                                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="hEbvuGQuql">
                            <label for="hEbvuGQuql">Events</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="MKPlLqkPWM">
                            <label for="MKPlLqkPWM">Oauth</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="zFkDPiXWhz">
                            <label for="zFkDPiXWhz">Pulumi</label>
                            <ul>
                                <l>
                                    <input type="checkbox" id="ruCYUppJiJ">
                                    <label for="ruCYUppJiJ">Dotnet</label>
                                    <ul>
                        ...
                        <l>
                            <input type="checkbox" id="KZzsLKzYXA">
                            <label for="KZzsLKzYXA">Terraform</label>
                            <ul>
                                <l>
                                    <input type="checkbox" id="QMLVpFwYue">
                                    <label for="QMLVpFwYue">Functions</label>
                                    <ul>
                                ...
                                <l>
                                    <input type="checkbox" id="VqxETyttpl">
                                    <label for="VqxETyttpl">Meta Arguments</label>
                                    <ul>
                ...
                <l>
                    <input type="checkbox" id="ekGeXJUmku">
                    <label for="ekGeXJUmku">Docker</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="HBBadgyOwv">
                    <label for="HBBadgyOwv">Dotnet</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="sEByvYonaY">
                            <label for="sEByvYonaY">Cli</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="skNSwbsgXX">
                    <label for="skNSwbsgXX">Functional Programming</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="yFqTeYpMQT">
                    <label for="yFqTeYpMQT">Git</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="EFHJPsFVGc">
                            <label for="EFHJPsFVGc">Github</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="AjIXgPZXzR">
                    <label for="AjIXgPZXzR">Go</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="FoNqFeRhlr">
                    <label for="FoNqFeRhlr">Haskell</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="gCVHSmQleL">
                    <label for="gCVHSmQleL">Js</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="TickgOoGBS">
                            <label for="TickgOoGBS">Node</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="eGpYOEgwBZ">
                            <label for="eGpYOEgwBZ">D3</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="rnHGhPQpxl">
                            <label for="rnHGhPQpxl">Mocha</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="FHppDRxVaX">
                            <label for="FHppDRxVaX">P5js</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="WqUYcZCpYS">
                            <label for="WqUYcZCpYS">Typescript</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="YLiKPeAcDG">
                    <label for="YLiKPeAcDG">Kafka</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="NCQKoDrvnr">
                    <label for="NCQKoDrvnr">Kubernetes</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="lfrhaNLyDO">
                    <label for="lfrhaNLyDO">Language</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="svbTzCNOVA">
                    <label for="svbTzCNOVA">Linux</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="nKuQGPoVNT">
                    <label for="nKuQGPoVNT">Python</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="sKdXgtyyaY">
                            <label for="sKdXgtyyaY">Data Classes</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="lQboJmnJnw">
                            <label for="lQboJmnJnw">Libraries</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="YUyVgkGWbd">
                    <label for="YUyVgkGWbd">React</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="rnreUqKyNL">
                    <label for="rnreUqKyNL">Regular Expressions</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="igehgJxgQz">
                    <label for="igehgJxgQz">Rust</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="rSnvsTRnLz">
                            <label for="rSnvsTRnLz">Serde</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="jxirLZcmXP">
                    <label for="jxirLZcmXP">Vim</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="QoHuZxyiVQ">
                    <label for="QoHuZxyiVQ">Web</label>
                    <ul>
