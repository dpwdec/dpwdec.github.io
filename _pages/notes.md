...
<ul>
    <div name="contents-index">
        ...
        <l>
            <input type="checkbox" id="fngNZfYTIA" checked>
            <label for="fngNZfYTIA">Math</label>
            <ul>
                <l>
                    <input type="checkbox" id="BBdsdcosYs">
                    <label for="BBdsdcosYs">Exponentials</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="xAYDSqSHvV">
                    <label for="xAYDSqSHvV">Linear Algebra</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="eoZUXIETBr">
                    <label for="eoZUXIETBr">Logarithms</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="JjyZkWFgTs">
                    <label for="JjyZkWFgTs">Sequences</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="tzzrkgHbXD">
                    <label for="tzzrkgHbXD">Single Variable Calculus</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="IWAIoAMYJo">
                    <label for="IWAIoAMYJo">Trigonometry</label>
                    <ul>
        ...
        <l>
            <input type="checkbox" id="UvUqKgUFol" checked>
            <label for="UvUqKgUFol">Programming</label>
            <ul>
                <l>
                    <input type="checkbox" id="EhzXOCfJOg">
                    <label for="EhzXOCfJOg">Ansible</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="MPPJYwCFlG">
                    <label for="MPPJYwCFlG">Architecture</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="scIomXLCLr">
                    <label for="scIomXLCLr">Computer Graphics</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="KJTjkAJBjv">
                    <label for="KJTjkAJBjv">Databases</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="KmXjlcAOXw">
                    <label for="KmXjlcAOXw">Devops</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="wdnezdekfT">
                            <label for="wdnezdekfT">Cloud Computing</label>
                            <ul>
                                <l>
                                    <input type="checkbox" id="OigiPupNdr">
                                    <label for="OigiPupNdr">AWS</label>
                                    <ul>
                                        <l>
                                            <input type="checkbox" id="RNngjyLiHI">
                                            <label for="RNngjyLiHI">Cli</label>
                                            <ul>
                                        ...
                                        <l>
                                            <input type="checkbox" id="AApgHzyQYT">
                                            <label for="AApgHzyQYT">Dotnet</label>
                                            <ul>
                                        ...
                                        <l>
                                            <input type="checkbox" id="mbWPzXdyiF">
                                            <label for="mbWPzXdyiF">Ec 2</label>
                                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="GcimxkWQAG">
                            <label for="GcimxkWQAG">Events</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="yyKVORZlCH">
                            <label for="yyKVORZlCH">Oauth</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="IAlgdAZDQq">
                            <label for="IAlgdAZDQq">Pulumi</label>
                            <ul>
                                <l>
                                    <input type="checkbox" id="nbMTSPoNGy">
                                    <label for="nbMTSPoNGy">Dotnet</label>
                                    <ul>
                        ...
                        <l>
                            <input type="checkbox" id="zzXlCfFvaI">
                            <label for="zzXlCfFvaI">Terraform</label>
                            <ul>
                                <l>
                                    <input type="checkbox" id="hJkAJCSPgF">
                                    <label for="hJkAJCSPgF">Functions</label>
                                    <ul>
                                ...
                                <l>
                                    <input type="checkbox" id="djOOJCKaTk">
                                    <label for="djOOJCKaTk">Meta Arguments</label>
                                    <ul>
                ...
                <l>
                    <input type="checkbox" id="bhWvKngpqQ">
                    <label for="bhWvKngpqQ">Docker</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="RpHuPbucfn">
                    <label for="RpHuPbucfn">Dotnet</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="hxxpikmSMk">
                            <label for="hxxpikmSMk">Cli</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="LTtQMAnOza">
                    <label for="LTtQMAnOza">Functional Programming</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="nvtuxqfyrd">
                    <label for="nvtuxqfyrd">Git</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="GryvZQWzSy">
                            <label for="GryvZQWzSy">Github</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="jPIWBxRvla">
                    <label for="jPIWBxRvla">Go</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="XROVfdIVDH">
                    <label for="XROVfdIVDH">Haskell</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="wIyzJwqxhV">
                    <label for="wIyzJwqxhV">Js</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="TdwYqqpMys">
                            <label for="TdwYqqpMys">Node</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="epLcmIZlQn">
                            <label for="epLcmIZlQn">D3</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="oSynrtOJpT">
                            <label for="oSynrtOJpT">Mocha</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="JxBuzChxbg">
                            <label for="JxBuzChxbg">P5js</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="IvRwheQppJ">
                            <label for="IvRwheQppJ">Typescript</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="wEUVKzgHDm">
                    <label for="wEUVKzgHDm">Kafka</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="aPIbYVsWhQ">
                    <label for="aPIbYVsWhQ">Kubernetes</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="DpXAlvTNIt">
                    <label for="DpXAlvTNIt">Language</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="nWsVUAonlA">
                    <label for="nWsVUAonlA">Linux</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="ACgpuOWOFN">
                    <label for="ACgpuOWOFN">Python</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="daCIJlexkw">
                            <label for="daCIJlexkw">Data Classes</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="TStUQWxhEH">
                            <label for="TStUQWxhEH">Libraries</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="GRusQyAcQz">
                    <label for="GRusQyAcQz">React</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="RzAFVaDDkT">
                    <label for="RzAFVaDDkT">Regular Expressions</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="uhqhBFWsLA">
                    <label for="uhqhBFWsLA">Rust</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="mlNeeHZJFg">
                            <label for="mlNeeHZJFg">Serde</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="WPTZZFiOlb">
                    <label for="WPTZZFiOlb">Vim</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="AFErvMRRmQ">
                    <label for="AFErvMRRmQ">Web</label>
                    <ul>
