...
<ul>
    <div name="contents-index">
        ...
        <l>
            <input type="checkbox" id="fImWppmgvn" checked>
            <label for="fImWppmgvn">Math</label>
            <ul>
                <l>
                    <input type="checkbox" id="lVTjuMWcNl">
                    <label for="lVTjuMWcNl">Exponentials</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="RkItULcqIy">
                    <label for="RkItULcqIy">Linear Algebra</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="HZoFahOXuk">
                    <label for="HZoFahOXuk">Logarithms</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="rxqtxVURmq">
                    <label for="rxqtxVURmq">Sequences</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="MHGTSWKLMQ">
                    <label for="MHGTSWKLMQ">Single Variable Calculus</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="bCGgBUdwmv">
                    <label for="bCGgBUdwmv">Trigonometry</label>
                    <ul>
        ...
        <l>
            <input type="checkbox" id="tiYZvEnWYo" checked>
            <label for="tiYZvEnWYo">Programming</label>
            <ul>
                <l>
                    <input type="checkbox" id="QFfrEtpjls">
                    <label for="QFfrEtpjls">Ansible</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="AxysmANVwL">
                    <label for="AxysmANVwL">Architecture</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="pXmstgBlws">
                    <label for="pXmstgBlws">Computer Graphics</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="GdScBxNeYj">
                    <label for="GdScBxNeYj">Databases</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="cnIxEeUWIg">
                    <label for="cnIxEeUWIg">Devops</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="TJVScYFiGQ">
                            <label for="TJVScYFiGQ">Cloud Providers</label>
                            <ul>
                                <l>
                                    <input type="checkbox" id="ijdYWASkHN">
                                    <label for="ijdYWASkHN">AWS</label>
                                    <ul>
                                        <l>
                                            <input type="checkbox" id="ZrMsXVYORi">
                                            <label for="ZrMsXVYORi">Cli</label>
                                            <ul>
                                        ...
                                        <l>
                                            <input type="checkbox" id="oqEHIXPaQy">
                                            <label for="oqEHIXPaQy">Dotnet</label>
                                            <ul>
                                        ...
                                        <l>
                                            <input type="checkbox" id="cTDDYMurGq">
                                            <label for="cTDDYMurGq">Ec 2</label>
                                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="XwsRgllHkE">
                            <label for="XwsRgllHkE">Events</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="ArksDwnMgY">
                            <label for="ArksDwnMgY">Localstack</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="WtejhjupBL">
                            <label for="WtejhjupBL">Pulumi</label>
                            <ul>
                                <l>
                                    <input type="checkbox" id="JCfPBmugso">
                                    <label for="JCfPBmugso">Dotnet</label>
                                    <ul>
                        ...
                        <l>
                            <input type="checkbox" id="liwmypBGWk">
                            <label for="liwmypBGWk">Serverless Framework</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="ggeuIgPUtz">
                            <label for="ggeuIgPUtz">Terraform</label>
                            <ul>
                                <l>
                                    <input type="checkbox" id="EDfgbAZFzb">
                                    <label for="EDfgbAZFzb">Functions</label>
                                    <ul>
                                ...
                                <l>
                                    <input type="checkbox" id="TJcOSXbWjs">
                                    <label for="TJcOSXbWjs">Meta Arguments</label>
                                    <ul>
                ...
                <l>
                    <input type="checkbox" id="kJzXhXCdgG">
                    <label for="kJzXhXCdgG">Docker</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="UiVkarLAUh">
                    <label for="UiVkarLAUh">Dotnet</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="PTTXAwzyuc">
                            <label for="PTTXAwzyuc">Cli</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="PesESFDwDj">
                    <label for="PesESFDwDj">Functional Programming</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="iorkyDLBmu">
                    <label for="iorkyDLBmu">Git</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="HaBOWvEbeM">
                            <label for="HaBOWvEbeM">Github</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="YqaDRhGMms">
                    <label for="YqaDRhGMms">Go</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="opYXNIeFyK">
                    <label for="opYXNIeFyK">Haskell</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="QZNigHnNcN">
                    <label for="QZNigHnNcN">Js</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="uayttLtNKr">
                            <label for="uayttLtNKr">Node</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="UeVFZxxyUv">
                            <label for="UeVFZxxyUv">D3</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="fIUhOTnUYG">
                            <label for="fIUhOTnUYG">Mocha</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="HdQWXkKjyO">
                            <label for="HdQWXkKjyO">P5js</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="OFKaSKJkfD">
                            <label for="OFKaSKJkfD">Typescript</label>
                            <ul>
                                <l>
                                    <input type="checkbox" id="nrdRvNOjyO">
                                    <label for="nrdRvNOjyO">Testing</label>
                                    <ul>
                ...
                <l>
                    <input type="checkbox" id="skWuBZooVw">
                    <label for="skWuBZooVw">Kafka</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="jaPTWJxhVf">
                    <label for="jaPTWJxhVf">Kubernetes</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="IvJBiiCjpJ">
                    <label for="IvJBiiCjpJ">Language</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="Quvqzmngcj">
                    <label for="Quvqzmngcj">Linux</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="cvQfsEUdgN">
                            <label for="cvQfsEUdgN">Bash</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="TaVFiaeedF">
                    <label for="TaVFiaeedF">Oauth</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="VIzgKxIOmS">
                    <label for="VIzgKxIOmS">Prometheus</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="aSQnDFddRW">
                    <label for="aSQnDFddRW">Python</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="innivczrCq">
                            <label for="innivczrCq">Data Classes</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="LgkRPRARwU">
                            <label for="LgkRPRARwU">Libraries</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="qBEkShcdCJ">
                    <label for="qBEkShcdCJ">React</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="VCodqgbJIm">
                    <label for="VCodqgbJIm">Regular Expressions</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="tfGIVoOFys">
                    <label for="tfGIVoOFys">Rust</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="dSEMuYrfxh">
                            <label for="dSEMuYrfxh">Serde</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="GREJPnUMsd">
                    <label for="GREJPnUMsd">Shaders</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="FjQKtjPlgW">
                            <label for="FjQKtjPlgW">Glsl</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="ewYWZrhmVn">
                    <label for="ewYWZrhmVn">Vim</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="HysQfTWSqe">
                    <label for="HysQfTWSqe">Web</label>
                    <ul>
