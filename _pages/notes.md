...
<ul>
    <div name="contents-index">
        ...
        <l>
            <input type="checkbox" id="dmCMKjJEvW" checked>
            <label for="dmCMKjJEvW">Math</label>
            <ul>
                <l>
                    <input type="checkbox" id="ItpJHlLcBJ">
                    <label for="ItpJHlLcBJ">Exponentials</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="jWEbImfPmO">
                    <label for="jWEbImfPmO">Linear Algebra</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="KyQfzAUvyo">
                    <label for="KyQfzAUvyo">Logarithms</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="FnBnAmiXct">
                    <label for="FnBnAmiXct">Sequences</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="nOFTTkWXOM">
                    <label for="nOFTTkWXOM">Single Variable Calculus</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="NUVobilJud">
                    <label for="NUVobilJud">Trigonometry</label>
                    <ul>
        ...
        <l>
            <input type="checkbox" id="vOsgNgUjFd" checked>
            <label for="vOsgNgUjFd">Programming</label>
            <ul>
                <l>
                    <input type="checkbox" id="IFzfRgIyTC">
                    <label for="IFzfRgIyTC">Ansible</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="JjMSSwSNoa">
                    <label for="JjMSSwSNoa">Architecture</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="FGPBcaePYS">
                    <label for="FGPBcaePYS">Computer Graphics</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="UuHqdxzPud">
                    <label for="UuHqdxzPud">Databases</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="MAnwoDqMlL">
                    <label for="MAnwoDqMlL">Devops</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="mvQFMvcgeS">
                            <label for="mvQFMvcgeS">Cloud Providers</label>
                            <ul>
                                <l>
                                    <input type="checkbox" id="IwyhOgeObg">
                                    <label for="IwyhOgeObg">AWS</label>
                                    <ul>
                                        <l>
                                            <input type="checkbox" id="sUSTHtWAMI">
                                            <label for="sUSTHtWAMI">Cli</label>
                                            <ul>
                                        ...
                                        <l>
                                            <input type="checkbox" id="crmiePFINi">
                                            <label for="crmiePFINi">Dotnet</label>
                                            <ul>
                                        ...
                                        <l>
                                            <input type="checkbox" id="mfZdLeICZb">
                                            <label for="mfZdLeICZb">Ec 2</label>
                                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="hdLcKKtDkO">
                            <label for="hdLcKKtDkO">Events</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="xtjHUEawbT">
                            <label for="xtjHUEawbT">Localstack</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="RmmdpTPGKb">
                            <label for="RmmdpTPGKb">Pulumi</label>
                            <ul>
                                <l>
                                    <input type="checkbox" id="ALSrXwmzDH">
                                    <label for="ALSrXwmzDH">Dotnet</label>
                                    <ul>
                        ...
                        <l>
                            <input type="checkbox" id="XKzcrTSYga">
                            <label for="XKzcrTSYga">Serverless Framework</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="yXBpQrwEaU">
                            <label for="yXBpQrwEaU">Terraform</label>
                            <ul>
                                <l>
                                    <input type="checkbox" id="DQNiFqVylg">
                                    <label for="DQNiFqVylg">Functions</label>
                                    <ul>
                                ...
                                <l>
                                    <input type="checkbox" id="tzzNaOTrDA">
                                    <label for="tzzNaOTrDA">Meta Arguments</label>
                                    <ul>
                ...
                <l>
                    <input type="checkbox" id="FfptpqBlOV">
                    <label for="FfptpqBlOV">Docker</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="LXeWOAEJNS">
                    <label for="LXeWOAEJNS">Dotnet</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="iCZnzlFTzD">
                            <label for="iCZnzlFTzD">Cli</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="PAsZAFfMxX">
                    <label for="PAsZAFfMxX">Functional Programming</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="DmBrYcBVGW">
                    <label for="DmBrYcBVGW">Git</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="kCeCqnAQkD">
                            <label for="kCeCqnAQkD">Github</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="MlcZTIOVgF">
                    <label for="MlcZTIOVgF">Go</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="eeHslATqyP">
                    <label for="eeHslATqyP">Haskell</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="kNROLyTMlz">
                    <label for="kNROLyTMlz">Js</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="gcOSlHWAeE">
                            <label for="gcOSlHWAeE">Node</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="jMNQMHhYAD">
                            <label for="jMNQMHhYAD">D3</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="GjJRkYWOxy">
                            <label for="GjJRkYWOxy">Mocha</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="lNKnrbxhbH">
                            <label for="lNKnrbxhbH">P5js</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="SyVoxfMqmZ">
                            <label for="SyVoxfMqmZ">Typescript</label>
                            <ul>
                                <l>
                                    <input type="checkbox" id="zrSMFeeaPu">
                                    <label for="zrSMFeeaPu">Testing</label>
                                    <ul>
                ...
                <l>
                    <input type="checkbox" id="xZBNNjbieu">
                    <label for="xZBNNjbieu">Kafka</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="yiNUNgkinU">
                    <label for="yiNUNgkinU">Kubernetes</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="wvwhacNGsB">
                    <label for="wvwhacNGsB">Language</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="vMEOrdLXXn">
                    <label for="vMEOrdLXXn">Linux</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="oZJXMPjLrN">
                            <label for="oZJXMPjLrN">Bash</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="RYOOISNwjq">
                    <label for="RYOOISNwjq">Oauth</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="dtSCEYoLui">
                    <label for="dtSCEYoLui">Prometheus</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="DUeiEvuFZA">
                    <label for="DUeiEvuFZA">Python</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="ZNFvrtbLIw">
                            <label for="ZNFvrtbLIw">Data Classes</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="svgnTlGzOL">
                            <label for="svgnTlGzOL">Libraries</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="OBSyvCnlNt">
                    <label for="OBSyvCnlNt">React</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="xaarsYDlnx">
                    <label for="xaarsYDlnx">Regular Expressions</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="wynOexSqqa">
                    <label for="wynOexSqqa">Rust</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="VWzbyhzlDG">
                            <label for="VWzbyhzlDG">Serde</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="AygVzdKhoG">
                    <label for="AygVzdKhoG">Shaders</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="WdmTNqpQKG">
                            <label for="WdmTNqpQKG">Glsl</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="uJSYhTHkJA">
                    <label for="uJSYhTHkJA">Vim</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="xyNDamizXI">
                    <label for="xyNDamizXI">Web</label>
                    <ul>
