...
<ul>
    <div name="contents-index">
        ...
        <l>
            <input type="checkbox" id="fpGDwDZGog" checked>
            <label for="fpGDwDZGog">Math</label>
            <ul>
                <l>
                    <input type="checkbox" id="XPeAMVykdj">
                    <label for="XPeAMVykdj">Exponentials</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="kULBNRbmrH">
                    <label for="kULBNRbmrH">Linear Algebra</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="ukSsiKgkLk">
                    <label for="ukSsiKgkLk">Logarithms</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="rLMLlWJjLr">
                    <label for="rLMLlWJjLr">Sequences</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="maBcKARXZR">
                    <label for="maBcKARXZR">Single Variable Calculus</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="OmhgtTjEFC">
                    <label for="OmhgtTjEFC">Trigonometry</label>
                    <ul>
        ...
        <l>
            <input type="checkbox" id="ZEXXArhAqE" checked>
            <label for="ZEXXArhAqE">Programming</label>
            <ul>
                <l>
                    <input type="checkbox" id="fTQhQnjTIc">
                    <label for="fTQhQnjTIc">Ansible</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="lFoxzbXSUs">
                    <label for="lFoxzbXSUs">Architecture</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="zBESjYUfgU">
                    <label for="zBESjYUfgU">Computer Graphics</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="YaygFDEXsJ">
                    <label for="YaygFDEXsJ">Databases</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="dlegGfStgB">
                    <label for="dlegGfStgB">Devops</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="KiZQLbzNcj">
                            <label for="KiZQLbzNcj">Cloud Computing</label>
                            <ul>
                                <l>
                                    <input type="checkbox" id="OVWfVAtekI">
                                    <label for="OVWfVAtekI">AWS</label>
                                    <ul>
                                        <l>
                                            <input type="checkbox" id="TycNEBtFfU">
                                            <label for="TycNEBtFfU">Cli</label>
                                            <ul>
                                        ...
                                        <l>
                                            <input type="checkbox" id="ZqXsTjzwwp">
                                            <label for="ZqXsTjzwwp">Dotnet</label>
                                            <ul>
                                        ...
                                        <l>
                                            <input type="checkbox" id="bPcNQCZLwe">
                                            <label for="bPcNQCZLwe">Ec 2</label>
                                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="hDGoFlRVuD">
                            <label for="hDGoFlRVuD">Events</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="AxILobdUrG">
                            <label for="AxILobdUrG">Localstack</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="XTxZioFnFS">
                            <label for="XTxZioFnFS">Oauth</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="busrkNOoGz">
                            <label for="busrkNOoGz">Pulumi</label>
                            <ul>
                                <l>
                                    <input type="checkbox" id="gQWcZTflWy">
                                    <label for="gQWcZTflWy">Dotnet</label>
                                    <ul>
                        ...
                        <l>
                            <input type="checkbox" id="QHrKpczHWa">
                            <label for="QHrKpczHWa">Terraform</label>
                            <ul>
                                <l>
                                    <input type="checkbox" id="sftijsHUDe">
                                    <label for="sftijsHUDe">Functions</label>
                                    <ul>
                                ...
                                <l>
                                    <input type="checkbox" id="bBaWpebQmK">
                                    <label for="bBaWpebQmK">Meta Arguments</label>
                                    <ul>
                ...
                <l>
                    <input type="checkbox" id="dkkerdMXTd">
                    <label for="dkkerdMXTd">Docker</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="NFFbDvcpOr">
                    <label for="NFFbDvcpOr">Dotnet</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="MAefGtACwI">
                            <label for="MAefGtACwI">Cli</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="sqpgHmRora">
                    <label for="sqpgHmRora">Functional Programming</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="LmefTJinKd">
                    <label for="LmefTJinKd">Git</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="hlfBUpCuKz">
                            <label for="hlfBUpCuKz">Github</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="OmwOHQNKkS">
                    <label for="OmwOHQNKkS">Go</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="AqBOZFxqrQ">
                    <label for="AqBOZFxqrQ">Haskell</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="yiJMpkszrN">
                    <label for="yiJMpkszrN">Js</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="BELyePZXXY">
                            <label for="BELyePZXXY">Node</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="yOWejlEHaE">
                            <label for="yOWejlEHaE">D3</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="SXilJIicXq">
                            <label for="SXilJIicXq">Mocha</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="FITBrazLfi">
                            <label for="FITBrazLfi">P5js</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="CzrkoTerza">
                            <label for="CzrkoTerza">Typescript</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="ZLrQIkRGLP">
                    <label for="ZLrQIkRGLP">Kafka</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="TBlsvLTZfn">
                    <label for="TBlsvLTZfn">Kubernetes</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="RDgcOjJcOX">
                    <label for="RDgcOjJcOX">Language</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="WmKSxTUGuO">
                    <label for="WmKSxTUGuO">Linux</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="lUChhffxBI">
                    <label for="lUChhffxBI">Python</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="CnZeKjBmKs">
                            <label for="CnZeKjBmKs">Data Classes</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="JrJrpVJgkg">
                            <label for="JrJrpVJgkg">Libraries</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="ucEYpVRokL">
                    <label for="ucEYpVRokL">React</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="kZKAKgzKFD">
                    <label for="kZKAKgzKFD">Regular Expressions</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="BlrjkoOBvs">
                    <label for="BlrjkoOBvs">Rust</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="oXqQidnFYw">
                            <label for="oXqQidnFYw">Serde</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="SvLuoSlHCU">
                    <label for="SvLuoSlHCU">Vim</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="aeLXPNWpOr">
                    <label for="aeLXPNWpOr">Web</label>
                    <ul>
