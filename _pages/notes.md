...
<ul>
    <div name="contents-index">
        ...
        <l>
            <input type="checkbox" id="gOOxEVmeFn" checked>
            <label for="gOOxEVmeFn">Math</label>
            <ul>
                <l>
                    <input type="checkbox" id="AgwRCoFmwy">
                    <label for="AgwRCoFmwy">Exponentials</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="UrYMAtkWmx">
                    <label for="UrYMAtkWmx">Linear Algebra</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="kLJbrLuLQb">
                    <label for="kLJbrLuLQb">Logarithms</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="vZAIxWnWgW">
                    <label for="vZAIxWnWgW">Sequences</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="SQriEXfhIJ">
                    <label for="SQriEXfhIJ">Single Variable Calculus</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="DACkucVkgr">
                    <label for="DACkucVkgr">Trigonometry</label>
                    <ul>
        ...
        <l>
            <input type="checkbox" id="ZSyFHSJHJV" checked>
            <label for="ZSyFHSJHJV">Programming</label>
            <ul>
                <l>
                    <input type="checkbox" id="aXUpJdZhZS">
                    <label for="aXUpJdZhZS">Ansible</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="jUsHLdpKam">
                    <label for="jUsHLdpKam">Architecture</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="WIdOYxzesP">
                    <label for="WIdOYxzesP">Computer Graphics</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="WiLVXOFaqW">
                    <label for="WiLVXOFaqW">Databases</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="WKTqrxUuHb">
                    <label for="WKTqrxUuHb">Devops</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="khtoBctmZE">
                            <label for="khtoBctmZE">Cloud Computing</label>
                            <ul>
                                <l>
                                    <input type="checkbox" id="xiDIDyBOCw">
                                    <label for="xiDIDyBOCw">AWS</label>
                                    <ul>
                                        <l>
                                            <input type="checkbox" id="yvRtpJVZwS">
                                            <label for="yvRtpJVZwS">Cli</label>
                                            <ul>
                                        ...
                                        <l>
                                            <input type="checkbox" id="aqGvrHFoTj">
                                            <label for="aqGvrHFoTj">Dotnet</label>
                                            <ul>
                                        ...
                                        <l>
                                            <input type="checkbox" id="AkXECsAMZh">
                                            <label for="AkXECsAMZh">Ec 2</label>
                                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="rfyEKMsiEX">
                            <label for="rfyEKMsiEX">Events</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="WViDyluKCx">
                            <label for="WViDyluKCx">Oauth</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="Jqtybzmkrp">
                            <label for="Jqtybzmkrp">Pulumi</label>
                            <ul>
                                <l>
                                    <input type="checkbox" id="IcxUkESeNd">
                                    <label for="IcxUkESeNd">Dotnet</label>
                                    <ul>
                        ...
                        <l>
                            <input type="checkbox" id="jGjAJCaekl">
                            <label for="jGjAJCaekl">Terraform</label>
                            <ul>
                                <l>
                                    <input type="checkbox" id="vJVpPVCnTJ">
                                    <label for="vJVpPVCnTJ">Functions</label>
                                    <ul>
                                ...
                                <l>
                                    <input type="checkbox" id="DVSjdKwCQt">
                                    <label for="DVSjdKwCQt">Meta Arguments</label>
                                    <ul>
                ...
                <l>
                    <input type="checkbox" id="LhAQgZxrGu">
                    <label for="LhAQgZxrGu">Docker</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="ysqaEfwViW">
                    <label for="ysqaEfwViW">Dotnet</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="zimGEkbsCu">
                            <label for="zimGEkbsCu">Cli</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="lrUxFDEkFf">
                    <label for="lrUxFDEkFf">Functional Programming</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="LvUSWRtnHa">
                    <label for="LvUSWRtnHa">Git</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="QIwWCJXwVK">
                            <label for="QIwWCJXwVK">Github</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="TKUpsZfdij">
                    <label for="TKUpsZfdij">Go</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="iyAyQRWuVJ">
                    <label for="iyAyQRWuVJ">Haskell</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="UvAGdkNiej">
                    <label for="UvAGdkNiej">Js</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="whpvATUkiE">
                            <label for="whpvATUkiE">Node</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="MhTvfVJiwJ">
                            <label for="MhTvfVJiwJ">D3</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="haYokbpJtD">
                            <label for="haYokbpJtD">Mocha</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="IfSwOKVvYw">
                            <label for="IfSwOKVvYw">P5js</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="GZUfpHDAER">
                            <label for="GZUfpHDAER">Typescript</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="MVgrLPkvRN">
                    <label for="MVgrLPkvRN">Kafka</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="nulCmJJEkp">
                    <label for="nulCmJJEkp">Kubernetes</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="skezcAOcmM">
                    <label for="skezcAOcmM">Language</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="YOcSjpzvBT">
                    <label for="YOcSjpzvBT">Linux</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="kOZEcKbJEe">
                    <label for="kOZEcKbJEe">Python</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="YJaYutyVtc">
                            <label for="YJaYutyVtc">Data Classes</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="XoMSFoSxZw">
                            <label for="XoMSFoSxZw">Libraries</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="ZVLIXrAoug">
                    <label for="ZVLIXrAoug">React</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="jbIMTfRZOA">
                    <label for="jbIMTfRZOA">Regular Expressions</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="MLUrGKnpuP">
                    <label for="MLUrGKnpuP">Rust</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="IVBTplgAHq">
                            <label for="IVBTplgAHq">Serde</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="YDHJUZJFbo">
                    <label for="YDHJUZJFbo">Vim</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="hjYJjidJro">
                    <label for="hjYJjidJro">Web</label>
                    <ul>
