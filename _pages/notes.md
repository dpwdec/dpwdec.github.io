...
<ul>
    <div name="contents-index">
        ...
        <l>
            <input type="checkbox" id="sIGMlTAQXr" checked>
            <label for="sIGMlTAQXr">Math</label>
            <ul>
                <l>
                    <input type="checkbox" id="kaEbGtPNcE">
                    <label for="kaEbGtPNcE">Exponentials</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="UTLkvglgvS">
                    <label for="UTLkvglgvS">Linear Algebra</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="iQzEWCqSIz">
                    <label for="iQzEWCqSIz">Logarithms</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="PYMtEMikyM">
                    <label for="PYMtEMikyM">Sequences</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="nJXoWiGdif">
                    <label for="nJXoWiGdif">Single Variable Calculus</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="HfaHxtnBRg">
                    <label for="HfaHxtnBRg">Trigonometry</label>
                    <ul>
        ...
        <l>
            <input type="checkbox" id="AjdatxwcEy" checked>
            <label for="AjdatxwcEy">Programming</label>
            <ul>
                <l>
                    <input type="checkbox" id="TtgirYblYU">
                    <label for="TtgirYblYU">Ansible</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="jOZEkTgIAw">
                    <label for="jOZEkTgIAw">Architecture</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="IgQcWOHCdF">
                    <label for="IgQcWOHCdF">Computer Graphics</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="dOefqouHkN">
                    <label for="dOefqouHkN">Databases</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="NFFiUxEQXA">
                    <label for="NFFiUxEQXA">Devops</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="mmvIMIAWfA">
                            <label for="mmvIMIAWfA">Cloud Providers</label>
                            <ul>
                                <l>
                                    <input type="checkbox" id="USoDbFhFnx">
                                    <label for="USoDbFhFnx">AWS</label>
                                    <ul>
                                        <l>
                                            <input type="checkbox" id="bWAqYjqsNS">
                                            <label for="bWAqYjqsNS">Cli</label>
                                            <ul>
                                        ...
                                        <l>
                                            <input type="checkbox" id="TzmINMlMFE">
                                            <label for="TzmINMlMFE">Dotnet</label>
                                            <ul>
                                        ...
                                        <l>
                                            <input type="checkbox" id="NJKunDoZtx">
                                            <label for="NJKunDoZtx">Ec 2</label>
                                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="LcyvdabsKB">
                            <label for="LcyvdabsKB">Events</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="lCSipFKdUR">
                            <label for="lCSipFKdUR">Localstack</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="tzuhOPuEMV">
                            <label for="tzuhOPuEMV">Pulumi</label>
                            <ul>
                                <l>
                                    <input type="checkbox" id="RBbnFcCPEq">
                                    <label for="RBbnFcCPEq">Dotnet</label>
                                    <ul>
                        ...
                        <l>
                            <input type="checkbox" id="AkMVmEdUGG">
                            <label for="AkMVmEdUGG">Serverless Framework</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="IHGejMFuRI">
                            <label for="IHGejMFuRI">Terraform</label>
                            <ul>
                                <l>
                                    <input type="checkbox" id="rnYkIYuXPZ">
                                    <label for="rnYkIYuXPZ">Functions</label>
                                    <ul>
                                ...
                                <l>
                                    <input type="checkbox" id="fjtqFoOhch">
                                    <label for="fjtqFoOhch">Meta Arguments</label>
                                    <ul>
                ...
                <l>
                    <input type="checkbox" id="kWcjYSvpov">
                    <label for="kWcjYSvpov">Docker</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="edoEdvVZoT">
                    <label for="edoEdvVZoT">Dotnet</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="SGSpFNnkhV">
                            <label for="SGSpFNnkhV">Cli</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="IavmUoGHOn">
                    <label for="IavmUoGHOn">Functional Programming</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="AASxfBhVxh">
                    <label for="AASxfBhVxh">Git</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="xAtDHxertp">
                            <label for="xAtDHxertp">Github</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="leUhrVtPny">
                    <label for="leUhrVtPny">Go</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="XcUCLySLFY">
                    <label for="XcUCLySLFY">Haskell</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="uvWmQPZkmR">
                    <label for="uvWmQPZkmR">Js</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="nDdNKMjRqx">
                            <label for="nDdNKMjRqx">Node</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="tLyHGgkLpE">
                            <label for="tLyHGgkLpE">D3</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="TfgrnBUtkf">
                            <label for="TfgrnBUtkf">Mocha</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="DfxOkfsszA">
                            <label for="DfxOkfsszA">P5js</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="cmpookcarA">
                            <label for="cmpookcarA">Typescript</label>
                            <ul>
                                <l>
                                    <input type="checkbox" id="jGepqyjyFz">
                                    <label for="jGepqyjyFz">Testing</label>
                                    <ul>
                ...
                <l>
                    <input type="checkbox" id="iexHgtXRzd">
                    <label for="iexHgtXRzd">Kafka</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="bgjbSrIXJw">
                    <label for="bgjbSrIXJw">Kubernetes</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="SHsVHZDdjh">
                    <label for="SHsVHZDdjh">Language</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="GELHLBAKen">
                    <label for="GELHLBAKen">Linux</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="FhbMBARarq">
                            <label for="FhbMBARarq">Bash</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="KZlCQrKVDA">
                    <label for="KZlCQrKVDA">Oauth</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="zuSjVremmY">
                    <label for="zuSjVremmY">Prometheus</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="pLZlhiLskZ">
                    <label for="pLZlhiLskZ">Python</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="NDSaxpOHIJ">
                            <label for="NDSaxpOHIJ">Data Classes</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="SDAlyDuXlp">
                            <label for="SDAlyDuXlp">Libraries</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="lMUdqDHyKz">
                    <label for="lMUdqDHyKz">React</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="yQaabOnhPB">
                    <label for="yQaabOnhPB">Regular Expressions</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="XGTVqXTDua">
                    <label for="XGTVqXTDua">Rust</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="VtlFsjzmGy">
                            <label for="VtlFsjzmGy">Serde</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="fSyBqrhULS">
                    <label for="fSyBqrhULS">Shaders</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="hKhDqSlEid">
                            <label for="hKhDqSlEid">Glsl</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="pljaUorBFl">
                    <label for="pljaUorBFl">Vim</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="CGFfqAfvNP">
                    <label for="CGFfqAfvNP">Web</label>
                    <ul>
