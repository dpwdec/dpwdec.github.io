...
<ul>
    <div name="contents-index">
        ...
        <l>
            <input type="checkbox" id="IufGexmHCL" checked>
            <label for="IufGexmHCL">Math</label>
            <ul>
                <l>
                    <input type="checkbox" id="eyrHvxTOnk">
                    <label for="eyrHvxTOnk">Exponentials</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="OaouXxYdGj">
                    <label for="OaouXxYdGj">Linear Algebra</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="xePIYBdFhO">
                    <label for="xePIYBdFhO">Logarithms</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="wGfLTAEySf">
                    <label for="wGfLTAEySf">Sequences</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="riBUnaBxyl">
                    <label for="riBUnaBxyl">Single Variable Calculus</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="XFCgCYFKwW">
                    <label for="XFCgCYFKwW">Trigonometry</label>
                    <ul>
        ...
        <l>
            <input type="checkbox" id="zcqLZzaOUo" checked>
            <label for="zcqLZzaOUo">Programming</label>
            <ul>
                <l>
                    <input type="checkbox" id="MMooLymosl">
                    <label for="MMooLymosl">Ansible</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="imkROgEjGr">
                    <label for="imkROgEjGr">Architecture</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="JSpQVIiXmw">
                    <label for="JSpQVIiXmw">Computer Graphics</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="BwcqeYCytM">
                    <label for="BwcqeYCytM">Databases</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="vgyKErgTJE">
                    <label for="vgyKErgTJE">Devops</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="pRZJYDPLyi">
                            <label for="pRZJYDPLyi">Cloud Providers</label>
                            <ul>
                                <l>
                                    <input type="checkbox" id="TxMECJmLpE">
                                    <label for="TxMECJmLpE">AWS</label>
                                    <ul>
                                        <l>
                                            <input type="checkbox" id="WmYgLWzcff">
                                            <label for="WmYgLWzcff">Cli</label>
                                            <ul>
                                        ...
                                        <l>
                                            <input type="checkbox" id="LbEbPDAGtk">
                                            <label for="LbEbPDAGtk">Dotnet</label>
                                            <ul>
                                        ...
                                        <l>
                                            <input type="checkbox" id="djCyrWctao">
                                            <label for="djCyrWctao">Ec 2</label>
                                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="BuBdViQChG">
                            <label for="BuBdViQChG">Events</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="qopInJWvNV">
                            <label for="qopInJWvNV">Localstack</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="dIiTRbKPte">
                            <label for="dIiTRbKPte">Pulumi</label>
                            <ul>
                                <l>
                                    <input type="checkbox" id="KbuFFXjwNy">
                                    <label for="KbuFFXjwNy">Dotnet</label>
                                    <ul>
                        ...
                        <l>
                            <input type="checkbox" id="zDmmkwlahW">
                            <label for="zDmmkwlahW">Serverless Framework</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="GzhIwKPPZe">
                            <label for="GzhIwKPPZe">Terraform</label>
                            <ul>
                                <l>
                                    <input type="checkbox" id="IBqAffcKpt">
                                    <label for="IBqAffcKpt">Functions</label>
                                    <ul>
                                ...
                                <l>
                                    <input type="checkbox" id="FZKREUCEBf">
                                    <label for="FZKREUCEBf">Meta Arguments</label>
                                    <ul>
                ...
                <l>
                    <input type="checkbox" id="BZzkGyQeHH">
                    <label for="BZzkGyQeHH">Docker</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="aPJVyuWszl">
                    <label for="aPJVyuWszl">Dotnet</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="PThBxJUIyD">
                            <label for="PThBxJUIyD">Cli</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="dYitkwWJiz">
                    <label for="dYitkwWJiz">Functional Programming</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="JeszUNbRKC">
                    <label for="JeszUNbRKC">Git</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="kctRIBggGD">
                            <label for="kctRIBggGD">Github</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="KgegXguyuG">
                    <label for="KgegXguyuG">Go</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="SVijPsqJWP">
                    <label for="SVijPsqJWP">Haskell</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="bEyWUcfTgB">
                    <label for="bEyWUcfTgB">Js</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="RamFovUQpS">
                            <label for="RamFovUQpS">Node</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="wrkFGALQfs">
                            <label for="wrkFGALQfs">D3</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="aYWVZPomHo">
                            <label for="aYWVZPomHo">Mocha</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="cUqcsiWuaG">
                            <label for="cUqcsiWuaG">P5js</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="vNrIJJZchn">
                            <label for="vNrIJJZchn">Typescript</label>
                            <ul>
                                <l>
                                    <input type="checkbox" id="FXIKvFiEMI">
                                    <label for="FXIKvFiEMI">Testing</label>
                                    <ul>
                ...
                <l>
                    <input type="checkbox" id="QQsRCMDVSb">
                    <label for="QQsRCMDVSb">Kafka</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="LstkbtmDsq">
                    <label for="LstkbtmDsq">Kubernetes</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="CjcFGUwHDE">
                    <label for="CjcFGUwHDE">Language</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="hUGkhTxmwL">
                    <label for="hUGkhTxmwL">Linux</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="OqogNoVwVV">
                            <label for="OqogNoVwVV">Bash</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="ephrhRSjqJ">
                    <label for="ephrhRSjqJ">Oauth</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="mqslXiwlJh">
                    <label for="mqslXiwlJh">Python</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="YusSUTjMTf">
                            <label for="YusSUTjMTf">Data Classes</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="RllRbFkxQH">
                            <label for="RllRbFkxQH">Libraries</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="JzfCBUEGUw">
                    <label for="JzfCBUEGUw">React</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="vBVPfOSYiu">
                    <label for="vBVPfOSYiu">Regular Expressions</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="BDJqzzufos">
                    <label for="BDJqzzufos">Rust</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="NfABVKyOXP">
                            <label for="NfABVKyOXP">Serde</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="QzXdzSAKhk">
                    <label for="QzXdzSAKhk">Shaders</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="HERIkmnrEE">
                            <label for="HERIkmnrEE">Glsl</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="zxsTNMRodn">
                    <label for="zxsTNMRodn">Vim</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="xrZCctcfuk">
                    <label for="xrZCctcfuk">Web</label>
                    <ul>
