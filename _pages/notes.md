...
<ul>
    <div name="contents-index">
        ...
        <l>
            <input type="checkbox" id="UaTXUyxcXF" checked>
            <label for="UaTXUyxcXF">Math</label>
            <ul>
                <l>
                    <input type="checkbox" id="YCMnfJvCnd">
                    <label for="YCMnfJvCnd">Exponentials</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="AlecRwNeOq">
                    <label for="AlecRwNeOq">Linear Algebra</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="juWYHbFmJh">
                    <label for="juWYHbFmJh">Logarithms</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="AmHFDIciAW">
                    <label for="AmHFDIciAW">Sequences</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="kEsFsJvALl">
                    <label for="kEsFsJvALl">Single Variable Calculus</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="IlOFVobxza">
                    <label for="IlOFVobxza">Trigonometry</label>
                    <ul>
        ...
        <l>
            <input type="checkbox" id="JtMuOgAWSZ" checked>
            <label for="JtMuOgAWSZ">Programming</label>
            <ul>
                <l>
                    <input type="checkbox" id="AObLqxZgfQ">
                    <label for="AObLqxZgfQ">Ansible</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="JkPRoHiFoT">
                    <label for="JkPRoHiFoT">Architecture</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="BRJSHyRuMh">
                    <label for="BRJSHyRuMh">Computer Graphics</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="JWdGNmDRym">
                    <label for="JWdGNmDRym">Databases</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="SZstHuziVh">
                    <label for="SZstHuziVh">Devops</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="VQYbkroADZ">
                            <label for="VQYbkroADZ">Cloud Providers</label>
                            <ul>
                                <l>
                                    <input type="checkbox" id="GdAzhbFsFF">
                                    <label for="GdAzhbFsFF">AWS</label>
                                    <ul>
                                        <l>
                                            <input type="checkbox" id="SswXSNPkqH">
                                            <label for="SswXSNPkqH">Cli</label>
                                            <ul>
                                        ...
                                        <l>
                                            <input type="checkbox" id="tClhPFBwCb">
                                            <label for="tClhPFBwCb">Dotnet</label>
                                            <ul>
                                        ...
                                        <l>
                                            <input type="checkbox" id="ekMPDSyoLV">
                                            <label for="ekMPDSyoLV">Ec 2</label>
                                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="fkWagyYPRV">
                            <label for="fkWagyYPRV">Events</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="gLgHBiMCIK">
                            <label for="gLgHBiMCIK">Localstack</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="WYdtjkVQrU">
                            <label for="WYdtjkVQrU">Pulumi</label>
                            <ul>
                                <l>
                                    <input type="checkbox" id="AMsfmeMhbR">
                                    <label for="AMsfmeMhbR">Dotnet</label>
                                    <ul>
                        ...
                        <l>
                            <input type="checkbox" id="AqMzdYOvbE">
                            <label for="AqMzdYOvbE">Serverless Framework</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="scsouQWZQA">
                            <label for="scsouQWZQA">Terraform</label>
                            <ul>
                                <l>
                                    <input type="checkbox" id="ocFQEORULZ">
                                    <label for="ocFQEORULZ">Functions</label>
                                    <ul>
                                ...
                                <l>
                                    <input type="checkbox" id="xotavYAYvU">
                                    <label for="xotavYAYvU">Meta Arguments</label>
                                    <ul>
                ...
                <l>
                    <input type="checkbox" id="brvSzlhFVd">
                    <label for="brvSzlhFVd">Docker</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="PsVdHfGlIU">
                    <label for="PsVdHfGlIU">Dotnet</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="hIWfhUlfqL">
                            <label for="hIWfhUlfqL">Cli</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="wtekzktWbD">
                    <label for="wtekzktWbD">Functional Programming</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="MokjcAfAXM">
                    <label for="MokjcAfAXM">Git</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="VPjTfZcAdd">
                            <label for="VPjTfZcAdd">Github</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="opzdPtgUhX">
                    <label for="opzdPtgUhX">Go</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="LbCzoNVhlt">
                    <label for="LbCzoNVhlt">Haskell</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="ewtigfgiop">
                    <label for="ewtigfgiop">Js</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="ujUzBpmSep">
                            <label for="ujUzBpmSep">Node</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="fDbKwMMVoc">
                            <label for="fDbKwMMVoc">D3</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="ObjbEfDHeK">
                            <label for="ObjbEfDHeK">Mocha</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="uakwInNlfg">
                            <label for="uakwInNlfg">P5js</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="HwjIUYJtXW">
                            <label for="HwjIUYJtXW">Typescript</label>
                            <ul>
                                <l>
                                    <input type="checkbox" id="BkwXESDAft">
                                    <label for="BkwXESDAft">Testing</label>
                                    <ul>
                ...
                <l>
                    <input type="checkbox" id="HJHlILadjj">
                    <label for="HJHlILadjj">Kafka</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="ZBitCzvhIf">
                    <label for="ZBitCzvhIf">Kubernetes</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="XMFkSJBYLM">
                    <label for="XMFkSJBYLM">Language</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="MSJQrsxXhE">
                    <label for="MSJQrsxXhE">Linux</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="VXkeYWDwVG">
                            <label for="VXkeYWDwVG">Bash</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="pMVxtTuPPm">
                    <label for="pMVxtTuPPm">Oauth</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="IuczHOQqOy">
                    <label for="IuczHOQqOy">Prometheus</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="SjSIHsYSLa">
                    <label for="SjSIHsYSLa">Python</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="hWZEwVmoQq">
                            <label for="hWZEwVmoQq">Data Classes</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="GAQBEEmtHl">
                            <label for="GAQBEEmtHl">Libraries</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="HvexdlCijB">
                    <label for="HvexdlCijB">React</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="dQTUYXaZmE">
                    <label for="dQTUYXaZmE">Regular Expressions</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="dWsunroezM">
                    <label for="dWsunroezM">Rust</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="CobyoCgdBm">
                            <label for="CobyoCgdBm">Serde</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="ShDJPhWKgf">
                    <label for="ShDJPhWKgf">Shaders</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="RskRScPFAy">
                            <label for="RskRScPFAy">Glsl</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="WwrAIeZWDX">
                    <label for="WwrAIeZWDX">Vim</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="eOSZTzmYbD">
                    <label for="eOSZTzmYbD">Web</label>
                    <ul>
