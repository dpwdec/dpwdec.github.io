...
<ul>
    <div name="contents-index">
        ...
        <l>
            <input type="checkbox" id="CBWlFWgfHF" checked>
            <label for="CBWlFWgfHF">Math</label>
            <ul>
                <l>
                    <input type="checkbox" id="wphCUqbFzN">
                    <label for="wphCUqbFzN">Exponentials</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="YVPXZLcDNG">
                    <label for="YVPXZLcDNG">Linear Algebra</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="xIGPhmNsgC">
                    <label for="xIGPhmNsgC">Logarithms</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="XGevQZtgMP">
                    <label for="XGevQZtgMP">Sequences</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="epcMSxStnN">
                    <label for="epcMSxStnN">Single Variable Calculus</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="xxFwiRBoSl">
                    <label for="xxFwiRBoSl">Trigonometry</label>
                    <ul>
        ...
        <l>
            <input type="checkbox" id="HsRkJTLzju" checked>
            <label for="HsRkJTLzju">Programming</label>
            <ul>
                <l>
                    <input type="checkbox" id="DkrYVIjSay">
                    <label for="DkrYVIjSay">Ansible</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="FdOvKpBbDf">
                    <label for="FdOvKpBbDf">Architecture</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="dQqlcQjJuE">
                    <label for="dQqlcQjJuE">Computer Graphics</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="qCVrecerFR">
                    <label for="qCVrecerFR">Databases</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="BnGPgXDLGJ">
                    <label for="BnGPgXDLGJ">Devops</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="sHkEfZkPdn">
                            <label for="sHkEfZkPdn">Cloud Computing</label>
                            <ul>
                                <l>
                                    <input type="checkbox" id="EhMLFdTsDN">
                                    <label for="EhMLFdTsDN">AWS</label>
                                    <ul>
                                        <l>
                                            <input type="checkbox" id="XyBztsCxTK">
                                            <label for="XyBztsCxTK">Cli</label>
                                            <ul>
                                        ...
                                        <l>
                                            <input type="checkbox" id="yulxRaOQdt">
                                            <label for="yulxRaOQdt">Dotnet</label>
                                            <ul>
                                        ...
                                        <l>
                                            <input type="checkbox" id="FjHFnwKFgb">
                                            <label for="FjHFnwKFgb">Ec 2</label>
                                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="VFqsWLdZCV">
                            <label for="VFqsWLdZCV">Events</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="uwvbLNRDIe">
                            <label for="uwvbLNRDIe">Oauth</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="KVqETmuSHy">
                            <label for="KVqETmuSHy">Pulumi</label>
                            <ul>
                                <l>
                                    <input type="checkbox" id="eVsGbAcOxF">
                                    <label for="eVsGbAcOxF">Dotnet</label>
                                    <ul>
                        ...
                        <l>
                            <input type="checkbox" id="gZcALUoNkQ">
                            <label for="gZcALUoNkQ">Terraform</label>
                            <ul>
                                <l>
                                    <input type="checkbox" id="hckQoBmiGz">
                                    <label for="hckQoBmiGz">Functions</label>
                                    <ul>
                                ...
                                <l>
                                    <input type="checkbox" id="GeHwsoWVZC">
                                    <label for="GeHwsoWVZC">Meta Arguments</label>
                                    <ul>
                ...
                <l>
                    <input type="checkbox" id="CZgIQOJVZW">
                    <label for="CZgIQOJVZW">Docker</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="lHcSKtzsvd">
                    <label for="lHcSKtzsvd">Dotnet</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="jMFALChvEJ">
                            <label for="jMFALChvEJ">Cli</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="YbeUoybeaB">
                    <label for="YbeUoybeaB">Functional Programming</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="AwsqBpZFFe">
                    <label for="AwsqBpZFFe">Git</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="QwIeoSYMFm">
                            <label for="QwIeoSYMFm">Github</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="CoJgbhzwRe">
                    <label for="CoJgbhzwRe">Go</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="BhxTESPYbH">
                    <label for="BhxTESPYbH">Haskell</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="WxYkorLvYA">
                    <label for="WxYkorLvYA">Js</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="KaOKQfnxrl">
                            <label for="KaOKQfnxrl">Node</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="anyxpPOmRk">
                            <label for="anyxpPOmRk">Mocha</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="YYqwSWcMKn">
                            <label for="YYqwSWcMKn">P5js</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="EXjpmCiRFK">
                            <label for="EXjpmCiRFK">Typescript</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="qpPfSCzWzl">
                    <label for="qpPfSCzWzl">Kafka</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="zSGkAklZfe">
                    <label for="zSGkAklZfe">Kubernetes</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="VKxuxeIHRD">
                    <label for="VKxuxeIHRD">Language</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="seWDCGdMbW">
                    <label for="seWDCGdMbW">Linux</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="ZXMrphhheG">
                    <label for="ZXMrphhheG">Python</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="TdHsFaTIxp">
                            <label for="TdHsFaTIxp">Data Classes</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="vBPzbxQGoU">
                            <label for="vBPzbxQGoU">Libraries</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="cAMNHuUBpJ">
                    <label for="cAMNHuUBpJ">React</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="tvgTcNFxVT">
                    <label for="tvgTcNFxVT">Regular Expressions</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="uWUbssxBjY">
                    <label for="uWUbssxBjY">Rust</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="rXnDGTzOha">
                            <label for="rXnDGTzOha">Serde</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="gXYLRlGGWa">
                    <label for="gXYLRlGGWa">Vim</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="NYCWWWDFPX">
                    <label for="NYCWWWDFPX">Web</label>
                    <ul>
