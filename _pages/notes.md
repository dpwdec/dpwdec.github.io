...
<ul>
    <div name="contents-index">
        ...
        <l>
            <input type="checkbox" id="vYqCkZvnCz" checked>
            <label for="vYqCkZvnCz">Math</label>
            <ul>
                <l>
                    <input type="checkbox" id="BqrzEntEFk">
                    <label for="BqrzEntEFk">Exponentials</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="tpiupFygOE">
                    <label for="tpiupFygOE">Linear Algebra</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="mGZRjuvhNE">
                    <label for="mGZRjuvhNE">Logarithms</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="EoXzezAFnr">
                    <label for="EoXzezAFnr">Sequences</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="FkZKTLmUIr">
                    <label for="FkZKTLmUIr">Single Variable Calculus</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="LskgXLQOxx">
                    <label for="LskgXLQOxx">Trigonometry</label>
                    <ul>
        ...
        <l>
            <input type="checkbox" id="oLsssCpzmd" checked>
            <label for="oLsssCpzmd">Programming</label>
            <ul>
                <l>
                    <input type="checkbox" id="DTSBJLdsTj">
                    <label for="DTSBJLdsTj">Ansible</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="MZdveTrixi">
                    <label for="MZdveTrixi">Architecture</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="wGiTOFCnqN">
                    <label for="wGiTOFCnqN">Computer Graphics</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="HTzLDPiEOb">
                    <label for="HTzLDPiEOb">Databases</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="MlNxDaCQsW">
                    <label for="MlNxDaCQsW">Devops</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="ygKURJWSLx">
                            <label for="ygKURJWSLx">Cloud Providers</label>
                            <ul>
                                <l>
                                    <input type="checkbox" id="ItHImTckto">
                                    <label for="ItHImTckto">AWS</label>
                                    <ul>
                                        <l>
                                            <input type="checkbox" id="KcKsRPuNUj">
                                            <label for="KcKsRPuNUj">Cli</label>
                                            <ul>
                                        ...
                                        <l>
                                            <input type="checkbox" id="ddUThMVoRS">
                                            <label for="ddUThMVoRS">Dotnet</label>
                                            <ul>
                                        ...
                                        <l>
                                            <input type="checkbox" id="HooznWInlQ">
                                            <label for="HooznWInlQ">Ec 2</label>
                                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="PkphgPqdnA">
                            <label for="PkphgPqdnA">Events</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="IeDzHVwXts">
                            <label for="IeDzHVwXts">Localstack</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="TTusjVWQXZ">
                            <label for="TTusjVWQXZ">Pulumi</label>
                            <ul>
                                <l>
                                    <input type="checkbox" id="zbRpLnljbi">
                                    <label for="zbRpLnljbi">Dotnet</label>
                                    <ul>
                        ...
                        <l>
                            <input type="checkbox" id="auKoVEpNfC">
                            <label for="auKoVEpNfC">Serverless Framework</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="TMkcRyMqdJ">
                            <label for="TMkcRyMqdJ">Terraform</label>
                            <ul>
                                <l>
                                    <input type="checkbox" id="qCzdiLGtzn">
                                    <label for="qCzdiLGtzn">Functions</label>
                                    <ul>
                                ...
                                <l>
                                    <input type="checkbox" id="kvhMkuIBYT">
                                    <label for="kvhMkuIBYT">Meta Arguments</label>
                                    <ul>
                ...
                <l>
                    <input type="checkbox" id="eOJKpUuTzG">
                    <label for="eOJKpUuTzG">Docker</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="SxnLAFwNvK">
                    <label for="SxnLAFwNvK">Dotnet</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="hltPinvQZr">
                            <label for="hltPinvQZr">Cli</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="OPIRForHVD">
                    <label for="OPIRForHVD">Functional Programming</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="RhkrHuZTix">
                    <label for="RhkrHuZTix">Git</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="jZWnOPcPsn">
                            <label for="jZWnOPcPsn">Github</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="uzeYQzRsjh">
                    <label for="uzeYQzRsjh">Go</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="aYsailkOUF">
                    <label for="aYsailkOUF">Haskell</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="BMKbsduiNT">
                    <label for="BMKbsduiNT">Js</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="KUSLyKyqrj">
                            <label for="KUSLyKyqrj">Node</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="rXXCvNNRPL">
                            <label for="rXXCvNNRPL">D3</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="SAKVxsUdYv">
                            <label for="SAKVxsUdYv">Mocha</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="xgvZGcscvr">
                            <label for="xgvZGcscvr">P5js</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="EHZSOGunlS">
                            <label for="EHZSOGunlS">Typescript</label>
                            <ul>
                                <l>
                                    <input type="checkbox" id="uxsEQOjEYy">
                                    <label for="uxsEQOjEYy">Testing</label>
                                    <ul>
                ...
                <l>
                    <input type="checkbox" id="kXBtEEyCUq">
                    <label for="kXBtEEyCUq">Kafka</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="OjqmTzLXXd">
                    <label for="OjqmTzLXXd">Kubernetes</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="gaHiZwIGmK">
                    <label for="gaHiZwIGmK">Language</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="EXctNdxLcU">
                    <label for="EXctNdxLcU">Linux</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="ZefaWzNVla">
                            <label for="ZefaWzNVla">Bash</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="zJwDndrcHi">
                    <label for="zJwDndrcHi">Oauth</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="IAPTuEmaHb">
                    <label for="IAPTuEmaHb">Python</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="NjyNqBaGKz">
                            <label for="NjyNqBaGKz">Data Classes</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="AshiwlPlLN">
                            <label for="AshiwlPlLN">Libraries</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="LGztJxGGqD">
                    <label for="LGztJxGGqD">React</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="YOybpjMuWg">
                    <label for="YOybpjMuWg">Regular Expressions</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="lrnyCetIXB">
                    <label for="lrnyCetIXB">Rust</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="dNWUefCRlP">
                            <label for="dNWUefCRlP">Serde</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="GFDROxlIjs">
                    <label for="GFDROxlIjs">Shaders</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="iAltHfayeW">
                            <label for="iAltHfayeW">Glsl</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="VcQaMElSxc">
                    <label for="VcQaMElSxc">Vim</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="uUZwiLXWKT">
                    <label for="uUZwiLXWKT">Web</label>
                    <ul>
