...
<ul>
    <div name="contents-index">
        ...
        <l>
            <input type="checkbox" id="YLgBEsTGCy" checked>
            <label for="YLgBEsTGCy">Math</label>
            <ul>
                <l>
                    <input type="checkbox" id="VXoeCJfwLs">
                    <label for="VXoeCJfwLs">Exponentials</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="JSRDclgurk">
                    <label for="JSRDclgurk">Linear Algebra</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="HUOGbIfmwG">
                    <label for="HUOGbIfmwG">Logarithms</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="XSCPoxVqZZ">
                    <label for="XSCPoxVqZZ">Sequences</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="iyDmGEpAVG">
                    <label for="iyDmGEpAVG">Single Variable Calculus</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="baiJdmYSVt">
                    <label for="baiJdmYSVt">Trigonometry</label>
                    <ul>
        ...
        <l>
            <input type="checkbox" id="kobVIOwwou" checked>
            <label for="kobVIOwwou">Programming</label>
            <ul>
                <l>
                    <input type="checkbox" id="TikNLxHipy">
                    <label for="TikNLxHipy">Ansible</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="XbcRLHjsUZ">
                    <label for="XbcRLHjsUZ">Architecture</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="mlrpgyhXer">
                    <label for="mlrpgyhXer">Computer Graphics</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="JOBLPrGFWo">
                    <label for="JOBLPrGFWo">Databases</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="kVVbUFHHoA">
                    <label for="kVVbUFHHoA">Devops</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="SpIRfbQWCs">
                            <label for="SpIRfbQWCs">Cloud Providers</label>
                            <ul>
                                <l>
                                    <input type="checkbox" id="bQqdriznxH">
                                    <label for="bQqdriznxH">AWS</label>
                                    <ul>
                                        <l>
                                            <input type="checkbox" id="FRxxGthnOL">
                                            <label for="FRxxGthnOL">Cli</label>
                                            <ul>
                                        ...
                                        <l>
                                            <input type="checkbox" id="QBBilUNcyJ">
                                            <label for="QBBilUNcyJ">Dotnet</label>
                                            <ul>
                                        ...
                                        <l>
                                            <input type="checkbox" id="BHfqIRtccR">
                                            <label for="BHfqIRtccR">Ec 2</label>
                                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="puYwlEzeGR">
                            <label for="puYwlEzeGR">Events</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="HFypZKMVQA">
                            <label for="HFypZKMVQA">Localstack</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="mFoBtGIgsT">
                            <label for="mFoBtGIgsT">Pulumi</label>
                            <ul>
                                <l>
                                    <input type="checkbox" id="LJHTWKTxed">
                                    <label for="LJHTWKTxed">Dotnet</label>
                                    <ul>
                        ...
                        <l>
                            <input type="checkbox" id="velansZJLW">
                            <label for="velansZJLW">Serverless Framework</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="BnDpaFZsMf">
                            <label for="BnDpaFZsMf">Terraform</label>
                            <ul>
                                <l>
                                    <input type="checkbox" id="agFlhWztda">
                                    <label for="agFlhWztda">Functions</label>
                                    <ul>
                                ...
                                <l>
                                    <input type="checkbox" id="RNKlMgkFAQ">
                                    <label for="RNKlMgkFAQ">Meta Arguments</label>
                                    <ul>
                ...
                <l>
                    <input type="checkbox" id="soFuitXXAb">
                    <label for="soFuitXXAb">Docker</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="KzgfsjQyhQ">
                    <label for="KzgfsjQyhQ">Dotnet</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="WCsGZuZBVw">
                            <label for="WCsGZuZBVw">Cli</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="seqzmFmYiY">
                    <label for="seqzmFmYiY">Functional Programming</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="UToOOTqENi">
                    <label for="UToOOTqENi">Git</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="fZpFvnVFIi">
                            <label for="fZpFvnVFIi">Github</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="CesBeGwSpG">
                    <label for="CesBeGwSpG">Go</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="eCazmlrbGw">
                    <label for="eCazmlrbGw">Haskell</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="sZyCAGKiat">
                    <label for="sZyCAGKiat">Js</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="xFpsMXWGQS">
                            <label for="xFpsMXWGQS">Node</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="nrrxjxmFvY">
                            <label for="nrrxjxmFvY">D3</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="RuNhMdvxXp">
                            <label for="RuNhMdvxXp">Mocha</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="UMlLmXOCOv">
                            <label for="UMlLmXOCOv">P5js</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="GAzKvwnCbn">
                            <label for="GAzKvwnCbn">Typescript</label>
                            <ul>
                                <l>
                                    <input type="checkbox" id="cnALMrcJxi">
                                    <label for="cnALMrcJxi">Testing</label>
                                    <ul>
                ...
                <l>
                    <input type="checkbox" id="GelKVvHljY">
                    <label for="GelKVvHljY">Kafka</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="siQgrOzpAw">
                    <label for="siQgrOzpAw">Kubernetes</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="MUXSlCRNsi">
                    <label for="MUXSlCRNsi">Language</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="BZMVEIlXOG">
                    <label for="BZMVEIlXOG">Linux</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="YAaClQhuQL">
                            <label for="YAaClQhuQL">Bash</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="QIJELPtpSJ">
                    <label for="QIJELPtpSJ">Oauth</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="BmNJVLvSET">
                    <label for="BmNJVLvSET">Prometheus</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="UsZaGGseax">
                    <label for="UsZaGGseax">Python</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="wEZnUuBktI">
                            <label for="wEZnUuBktI">Data Classes</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="TXdpcfqcKS">
                            <label for="TXdpcfqcKS">Libraries</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="MRacarigDW">
                    <label for="MRacarigDW">React</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="PUTLtilnqz">
                    <label for="PUTLtilnqz">Regular Expressions</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="EJfmGKclzT">
                    <label for="EJfmGKclzT">Rust</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="iPmiExDULc">
                            <label for="iPmiExDULc">Serde</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="iJLybrPRqe">
                    <label for="iJLybrPRqe">Shaders</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="NUBrTrIEQm">
                            <label for="NUBrTrIEQm">Glsl</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="mKDzsfNeSj">
                    <label for="mKDzsfNeSj">Vim</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="hCMnFiJhIB">
                    <label for="hCMnFiJhIB">Web</label>
                    <ul>
