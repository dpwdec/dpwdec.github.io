...
<ul>
    <div name="contents-index">
        ...
        <l>
            <input type="checkbox" id="dALSWyaIVP" checked>
            <label for="dALSWyaIVP">Math</label>
            <ul>
                <l>
                    <input type="checkbox" id="aJhaHlZfkq">
                    <label for="aJhaHlZfkq">Exponentials</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="DoNeJdmjyn">
                    <label for="DoNeJdmjyn">Linear Algebra</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="HiIbQWoOfH">
                    <label for="HiIbQWoOfH">Logarithms</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="MmayImpsqY">
                    <label for="MmayImpsqY">Sequences</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="IjEfLQhNnR">
                    <label for="IjEfLQhNnR">Single Variable Calculus</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="pIaCWnOOsQ">
                    <label for="pIaCWnOOsQ">Trigonometry</label>
                    <ul>
        ...
        <l>
            <input type="checkbox" id="KMgGDFLINn" checked>
            <label for="KMgGDFLINn">Programming</label>
            <ul>
                <l>
                    <input type="checkbox" id="EaEWHkxhaV">
                    <label for="EaEWHkxhaV">Ansible</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="YdVuTRmifD">
                    <label for="YdVuTRmifD">Architecture</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="obFFhUhftJ">
                    <label for="obFFhUhftJ">Computer Graphics</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="aNFRamSpSH">
                    <label for="aNFRamSpSH">Databases</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="maEfujtRvb">
                    <label for="maEfujtRvb">Devops</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="oXHPeplJRI">
                            <label for="oXHPeplJRI">Cloud Computing</label>
                            <ul>
                                <l>
                                    <input type="checkbox" id="sFPGAFelSG">
                                    <label for="sFPGAFelSG">AWS</label>
                                    <ul>
                                        <l>
                                            <input type="checkbox" id="BkNTZahXvf">
                                            <label for="BkNTZahXvf">Cli</label>
                                            <ul>
                                        ...
                                        <l>
                                            <input type="checkbox" id="nxvyfeyGHA">
                                            <label for="nxvyfeyGHA">Dotnet</label>
                                            <ul>
                                        ...
                                        <l>
                                            <input type="checkbox" id="KehSVHDezr">
                                            <label for="KehSVHDezr">Ec 2</label>
                                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="INIBkfRynD">
                            <label for="INIBkfRynD">Events</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="AZVuXkOgTF">
                            <label for="AZVuXkOgTF">Oauth</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="YjetLXGvkv">
                            <label for="YjetLXGvkv">Pulumi</label>
                            <ul>
                                <l>
                                    <input type="checkbox" id="psNPcwDahS">
                                    <label for="psNPcwDahS">Dotnet</label>
                                    <ul>
                        ...
                        <l>
                            <input type="checkbox" id="XEjtmGUlRP">
                            <label for="XEjtmGUlRP">Terraform</label>
                            <ul>
                                <l>
                                    <input type="checkbox" id="lUOaAudGqo">
                                    <label for="lUOaAudGqo">Functions</label>
                                    <ul>
                                ...
                                <l>
                                    <input type="checkbox" id="WJedVhGRMe">
                                    <label for="WJedVhGRMe">Meta Arguments</label>
                                    <ul>
                ...
                <l>
                    <input type="checkbox" id="AyejkiFvSA">
                    <label for="AyejkiFvSA">Docker</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="VkAlBFIVcB">
                    <label for="VkAlBFIVcB">Dotnet</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="ZWLNCuCNIo">
                            <label for="ZWLNCuCNIo">Cli</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="LIyqaXaeOL">
                    <label for="LIyqaXaeOL">Functional Programming</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="tQWGxGgOou">
                    <label for="tQWGxGgOou">Git</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="DlDkJcDOXO">
                            <label for="DlDkJcDOXO">Github</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="xzNsHlAdOS">
                    <label for="xzNsHlAdOS">Go</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="yxnytrFqDl">
                    <label for="yxnytrFqDl">Haskell</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="ftaVzXxaRm">
                    <label for="ftaVzXxaRm">Js</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="PlRvNGuUeT">
                            <label for="PlRvNGuUeT">Node</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="uIlinjeefw">
                            <label for="uIlinjeefw">D3</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="AHWItARCUs">
                            <label for="AHWItARCUs">Mocha</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="tfCTxnALLX">
                            <label for="tfCTxnALLX">P5js</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="SwBTehAsKe">
                            <label for="SwBTehAsKe">Typescript</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="lyYVhmBYdk">
                    <label for="lyYVhmBYdk">Kafka</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="ooSoPoEjwM">
                    <label for="ooSoPoEjwM">Kubernetes</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="iZTasGeeJx">
                    <label for="iZTasGeeJx">Language</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="kViZlUKgqA">
                    <label for="kViZlUKgqA">Linux</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="dQEJtUjIDb">
                    <label for="dQEJtUjIDb">Python</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="zpAKnRtJkg">
                            <label for="zpAKnRtJkg">Data Classes</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="NYYBrsGbHK">
                            <label for="NYYBrsGbHK">Libraries</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="DNIiFGfUhg">
                    <label for="DNIiFGfUhg">React</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="UOoggbHSWP">
                    <label for="UOoggbHSWP">Regular Expressions</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="eZpsAkYwYR">
                    <label for="eZpsAkYwYR">Rust</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="UeBuSOmizg">
                            <label for="UeBuSOmizg">Serde</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="BaijHxrrpy">
                    <label for="BaijHxrrpy">Vim</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="lzlGdCfVyH">
                    <label for="lzlGdCfVyH">Web</label>
                    <ul>
