...
<ul>
    <div name="contents-index">
        ...
        <l>
            <input type="checkbox" id="IRGhIXVrys" checked>
            <label for="IRGhIXVrys">Math</label>
            <ul>
                <l>
                    <input type="checkbox" id="gIdWSOZMuO">
                    <label for="gIdWSOZMuO">Exponentials</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="AlgfmTqKUp">
                    <label for="AlgfmTqKUp">Linear Algebra</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="aMPOAKovKC">
                    <label for="aMPOAKovKC">Logarithms</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="aPlOgMgizA">
                    <label for="aPlOgMgizA">Sequences</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="eRLWJchsex">
                    <label for="eRLWJchsex">Single Variable Calculus</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="ztcbaGnCvf">
                    <label for="ztcbaGnCvf">Trigonometry</label>
                    <ul>
        ...
        <l>
            <input type="checkbox" id="rrajcSEEAZ" checked>
            <label for="rrajcSEEAZ">Programming</label>
            <ul>
                <l>
                    <input type="checkbox" id="bafvqhDikc">
                    <label for="bafvqhDikc">Ansible</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="sXYmcAqYGY">
                    <label for="sXYmcAqYGY">Architecture</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="TXLNNVTzgY">
                    <label for="TXLNNVTzgY">Computer Graphics</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="LlEPhRPcYv">
                    <label for="LlEPhRPcYv">Databases</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="qQzrTHmOwA">
                    <label for="qQzrTHmOwA">Devops</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="XxPcgHvcPb">
                            <label for="XxPcgHvcPb">Cloud Computing</label>
                            <ul>
                                <l>
                                    <input type="checkbox" id="KwmpBOgfsz">
                                    <label for="KwmpBOgfsz">AWS</label>
                                    <ul>
                                        <l>
                                            <input type="checkbox" id="dnkvvvOSoZ">
                                            <label for="dnkvvvOSoZ">Cli</label>
                                            <ul>
                                        ...
                                        <l>
                                            <input type="checkbox" id="KmigpDIyyc">
                                            <label for="KmigpDIyyc">Dotnet</label>
                                            <ul>
                                        ...
                                        <l>
                                            <input type="checkbox" id="LCpUBmdnNf">
                                            <label for="LCpUBmdnNf">Ec 2</label>
                                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="mAYnFSUFEO">
                            <label for="mAYnFSUFEO">Events</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="VxtbIGTfkz">
                            <label for="VxtbIGTfkz">Oauth</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="DQNgXWMpBc">
                            <label for="DQNgXWMpBc">Pulumi</label>
                            <ul>
                                <l>
                                    <input type="checkbox" id="WaZTPPLXki">
                                    <label for="WaZTPPLXki">Dotnet</label>
                                    <ul>
                        ...
                        <l>
                            <input type="checkbox" id="qTkueCLzFK">
                            <label for="qTkueCLzFK">Terraform</label>
                            <ul>
                                <l>
                                    <input type="checkbox" id="EYaOBaibqx">
                                    <label for="EYaOBaibqx">Functions</label>
                                    <ul>
                                ...
                                <l>
                                    <input type="checkbox" id="KTCCiQvGgR">
                                    <label for="KTCCiQvGgR">Meta Arguments</label>
                                    <ul>
                ...
                <l>
                    <input type="checkbox" id="oATRzhdSTG">
                    <label for="oATRzhdSTG">Docker</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="iUMTHSxyif">
                    <label for="iUMTHSxyif">Dotnet</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="XqJddnPIfz">
                            <label for="XqJddnPIfz">Cli</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="IpPXwUalvs">
                    <label for="IpPXwUalvs">Functional Programming</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="DhAgQjvKef">
                    <label for="DhAgQjvKef">Git</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="pQogRjfWyw">
                            <label for="pQogRjfWyw">Github</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="sBRqjTWYRg">
                    <label for="sBRqjTWYRg">Go</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="XsgMoYBGUc">
                    <label for="XsgMoYBGUc">Haskell</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="OZoUtCymjP">
                    <label for="OZoUtCymjP">Js</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="tKzhTFfloP">
                            <label for="tKzhTFfloP">Node</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="jCfwVgMABK">
                            <label for="jCfwVgMABK">Mocha</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="dTHjqZvOaT">
                            <label for="dTHjqZvOaT">P5js</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="xcKnDUYbwe">
                            <label for="xcKnDUYbwe">Typescript</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="yLUIMSyTmp">
                    <label for="yLUIMSyTmp">Kafka</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="ymHeXmdwpE">
                    <label for="ymHeXmdwpE">Kubernetes</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="qKOwuVqZAq">
                    <label for="qKOwuVqZAq">Language</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="biFZdmPepU">
                    <label for="biFZdmPepU">Linux</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="jhPHKFxcbZ">
                    <label for="jhPHKFxcbZ">Python</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="DHPVCugzzX">
                            <label for="DHPVCugzzX">Data Classes</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="cQQeiSItts">
                            <label for="cQQeiSItts">Libraries</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="UoFyVjwfsP">
                    <label for="UoFyVjwfsP">React</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="dHpuYiwrQR">
                    <label for="dHpuYiwrQR">Regular Expressions</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="KEpvCkMnHf">
                    <label for="KEpvCkMnHf">Rust</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="FEZUEBzxgZ">
                            <label for="FEZUEBzxgZ">Serde</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="wYwgXkRavR">
                    <label for="wYwgXkRavR">Vim</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="nFRIkUSTKT">
                    <label for="nFRIkUSTKT">Web</label>
                    <ul>
