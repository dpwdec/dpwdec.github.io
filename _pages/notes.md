...
<ul>
    <div name="contents-index">
        ...
        <l>
            <input type="checkbox" id="JmCEHCzFXY" checked>
            <label for="JmCEHCzFXY">Math</label>
            <ul>
                <l>
                    <input type="checkbox" id="fVDhPZdIiY">
                    <label for="fVDhPZdIiY">Exponentials</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="NumwEQlEuX">
                    <label for="NumwEQlEuX">Linear Algebra</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="YxQUbKsKTB">
                    <label for="YxQUbKsKTB">Logarithms</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="tKgXBRMidQ">
                    <label for="tKgXBRMidQ">Sequences</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="PoaXChnkqD">
                    <label for="PoaXChnkqD">Single Variable Calculus</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="qmDTgYiKkA">
                    <label for="qmDTgYiKkA">Trigonometry</label>
                    <ul>
        ...
        <l>
            <input type="checkbox" id="eQHEnLHcMt" checked>
            <label for="eQHEnLHcMt">Programming</label>
            <ul>
                <l>
                    <input type="checkbox" id="UxUhUqHERZ">
                    <label for="UxUhUqHERZ">Ansible</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="GOocrfufUh">
                    <label for="GOocrfufUh">Architecture</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="QjTleOOIiR">
                    <label for="QjTleOOIiR">Computer Graphics</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="EHhavMNYTH">
                    <label for="EHhavMNYTH">Databases</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="mUHRPcknwU">
                    <label for="mUHRPcknwU">Devops</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="UIOgCEBosH">
                            <label for="UIOgCEBosH">Cloud Computing</label>
                            <ul>
                                <l>
                                    <input type="checkbox" id="QuWhsRDIrV">
                                    <label for="QuWhsRDIrV">AWS</label>
                                    <ul>
                                        <l>
                                            <input type="checkbox" id="oMVzGQcUWF">
                                            <label for="oMVzGQcUWF">Cli</label>
                                            <ul>
                                        ...
                                        <l>
                                            <input type="checkbox" id="fMunEpfgHL">
                                            <label for="fMunEpfgHL">Dotnet</label>
                                            <ul>
                                        ...
                                        <l>
                                            <input type="checkbox" id="WHRvwlGbIo">
                                            <label for="WHRvwlGbIo">Ec 2</label>
                                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="IEwWXjARMU">
                            <label for="IEwWXjARMU">Events</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="OzNiBpAIMA">
                            <label for="OzNiBpAIMA">Oauth</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="mimHPXWfCW">
                            <label for="mimHPXWfCW">Pulumi</label>
                            <ul>
                                <l>
                                    <input type="checkbox" id="PRsDgjtLmN">
                                    <label for="PRsDgjtLmN">Dotnet</label>
                                    <ul>
                        ...
                        <l>
                            <input type="checkbox" id="XrKJsgPxsf">
                            <label for="XrKJsgPxsf">Terraform</label>
                            <ul>
                                <l>
                                    <input type="checkbox" id="hAfBfsEfFz">
                                    <label for="hAfBfsEfFz">Functions</label>
                                    <ul>
                                ...
                                <l>
                                    <input type="checkbox" id="LOEOoQSjib">
                                    <label for="LOEOoQSjib">Meta Arguments</label>
                                    <ul>
                ...
                <l>
                    <input type="checkbox" id="wmviGbsQZu">
                    <label for="wmviGbsQZu">Docker</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="VZgKHqZBWw">
                    <label for="VZgKHqZBWw">Dotnet</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="DOGscIQYio">
                            <label for="DOGscIQYio">Cli</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="EMuruUaQsU">
                    <label for="EMuruUaQsU">Functional Programming</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="dipEuuTORs">
                    <label for="dipEuuTORs">Git</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="bMKaEhBtMD">
                            <label for="bMKaEhBtMD">Github</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="vQfeeaJeqn">
                    <label for="vQfeeaJeqn">Go</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="qSykZUMjKp">
                    <label for="qSykZUMjKp">Haskell</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="uLFHXTgFzF">
                    <label for="uLFHXTgFzF">Js</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="FDXToUmhFk">
                            <label for="FDXToUmhFk">Node</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="uyEjAAkhxR">
                            <label for="uyEjAAkhxR">Mocha</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="eVFMIrgaMK">
                            <label for="eVFMIrgaMK">P5js</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="TUtqLPRgvF">
                            <label for="TUtqLPRgvF">Typescript</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="jTIsDrppFU">
                    <label for="jTIsDrppFU">Kafka</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="ddPtEDXiGa">
                    <label for="ddPtEDXiGa">Kubernetes</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="ZdhpGTnImz">
                    <label for="ZdhpGTnImz">Language</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="pCErHFilhU">
                    <label for="pCErHFilhU">Linux</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="XgTLUOQHKm">
                    <label for="XgTLUOQHKm">Python</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="ZvQPdEoKRI">
                            <label for="ZvQPdEoKRI">Data Classes</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="IqNiKqRRLC">
                            <label for="IqNiKqRRLC">Libraries</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="UXNKwPdGOE">
                    <label for="UXNKwPdGOE">React</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="UJqamNrfHz">
                    <label for="UJqamNrfHz">Regular Expressions</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="GMASwhgKsb">
                    <label for="GMASwhgKsb">Rust</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="twVLEvYxgO">
                            <label for="twVLEvYxgO">Serde</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="fKoppWAPCf">
                    <label for="fKoppWAPCf">Vim</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="nzzKKjzhUf">
                    <label for="nzzKKjzhUf">Web</label>
                    <ul>
