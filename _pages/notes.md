...
<ul>
    <div name="contents-index">
        ...
        <l>
            <input type="checkbox" id="nMwEyBBqut" checked>
            <label for="nMwEyBBqut">Math</label>
            <ul>
                <l>
                    <input type="checkbox" id="nMHlryjSrc">
                    <label for="nMHlryjSrc">Exponentials</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="JNbBkQTKfg">
                    <label for="JNbBkQTKfg">Linear Algebra</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="YsUGIHglIH">
                    <label for="YsUGIHglIH">Logarithms</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="cpxIHgKRgQ">
                    <label for="cpxIHgKRgQ">Sequences</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="qCJIcurFmt">
                    <label for="qCJIcurFmt">Single Variable Calculus</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="fGlgxZaejD">
                    <label for="fGlgxZaejD">Trigonometry</label>
                    <ul>
        ...
        <l>
            <input type="checkbox" id="SGsOtNBClN" checked>
            <label for="SGsOtNBClN">Programming</label>
            <ul>
                <l>
                    <input type="checkbox" id="FNrXrDkVzU">
                    <label for="FNrXrDkVzU">Ansible</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="wuxkvmKrBG">
                    <label for="wuxkvmKrBG">Architecture</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="rCKFucduJB">
                    <label for="rCKFucduJB">Computer Graphics</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="JbDlcQZogP">
                    <label for="JbDlcQZogP">Databases</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="GSwmgOvtFh">
                    <label for="GSwmgOvtFh">Devops</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="gapwHNCDiA">
                            <label for="gapwHNCDiA">Cloud Providers</label>
                            <ul>
                                <l>
                                    <input type="checkbox" id="ecQJFlGiif">
                                    <label for="ecQJFlGiif">AWS</label>
                                    <ul>
                                        <l>
                                            <input type="checkbox" id="XRbblvpQdK">
                                            <label for="XRbblvpQdK">Cli</label>
                                            <ul>
                                        ...
                                        <l>
                                            <input type="checkbox" id="oOdrPKdqXt">
                                            <label for="oOdrPKdqXt">Dotnet</label>
                                            <ul>
                                        ...
                                        <l>
                                            <input type="checkbox" id="nUAGNsxUXc">
                                            <label for="nUAGNsxUXc">Ec 2</label>
                                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="KluVNZDpJt">
                            <label for="KluVNZDpJt">Events</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="UJHmUVFHif">
                            <label for="UJHmUVFHif">Localstack</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="eeHuZqOrvt">
                            <label for="eeHuZqOrvt">Pulumi</label>
                            <ul>
                                <l>
                                    <input type="checkbox" id="pWQgdHbsel">
                                    <label for="pWQgdHbsel">Dotnet</label>
                                    <ul>
                        ...
                        <l>
                            <input type="checkbox" id="CehSLmrcHP">
                            <label for="CehSLmrcHP">Serverless Framework</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="WYGYAjpyJE">
                            <label for="WYGYAjpyJE">Terraform</label>
                            <ul>
                                <l>
                                    <input type="checkbox" id="zITqKmRuKA">
                                    <label for="zITqKmRuKA">Functions</label>
                                    <ul>
                                ...
                                <l>
                                    <input type="checkbox" id="zwdpNxIHaL">
                                    <label for="zwdpNxIHaL">Meta Arguments</label>
                                    <ul>
                ...
                <l>
                    <input type="checkbox" id="EqkpsPuYoA">
                    <label for="EqkpsPuYoA">Docker</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="dBCQcpekMU">
                    <label for="dBCQcpekMU">Dotnet</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="wNbjFMecbg">
                            <label for="wNbjFMecbg">Cli</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="opyWSSScXT">
                    <label for="opyWSSScXT">Functional Programming</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="ixMmtTpfhK">
                    <label for="ixMmtTpfhK">Git</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="UyiZjoZHVr">
                            <label for="UyiZjoZHVr">Github</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="ftwnXPLDQu">
                    <label for="ftwnXPLDQu">Go</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="JxOiyBlVpa">
                    <label for="JxOiyBlVpa">Haskell</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="saHPCBPjHw">
                    <label for="saHPCBPjHw">Js</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="KtHflwBogw">
                            <label for="KtHflwBogw">Node</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="IDVPBvWhZq">
                            <label for="IDVPBvWhZq">D3</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="BoBfKWMlNl">
                            <label for="BoBfKWMlNl">Mocha</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="NKjpoiXaSR">
                            <label for="NKjpoiXaSR">P5js</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="oYBTmPjalF">
                            <label for="oYBTmPjalF">Typescript</label>
                            <ul>
                                <l>
                                    <input type="checkbox" id="twHkWvOgBc">
                                    <label for="twHkWvOgBc">Testing</label>
                                    <ul>
                ...
                <l>
                    <input type="checkbox" id="SxRbYgpxge">
                    <label for="SxRbYgpxge">Kafka</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="FjCjKDybdb">
                    <label for="FjCjKDybdb">Kubernetes</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="TmuLYWdKlQ">
                    <label for="TmuLYWdKlQ">Language</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="hfKQqLLOPq">
                    <label for="hfKQqLLOPq">Linux</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="klLsOOrbtP">
                            <label for="klLsOOrbtP">Bash</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="TaKcpJiwQN">
                    <label for="TaKcpJiwQN">Oauth</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="HAZyyeEPLs">
                    <label for="HAZyyeEPLs">Python</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="yuvjpPElPb">
                            <label for="yuvjpPElPb">Data Classes</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="EBeSRzGsfa">
                            <label for="EBeSRzGsfa">Libraries</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="iccyGFNtbm">
                    <label for="iccyGFNtbm">React</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="LwLKUCBcQO">
                    <label for="LwLKUCBcQO">Regular Expressions</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="euaWQyNVBw">
                    <label for="euaWQyNVBw">Rust</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="jfQJkDfNgH">
                            <label for="jfQJkDfNgH">Serde</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="ayYuVxdjvt">
                    <label for="ayYuVxdjvt">Vim</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="KzebzIxgQK">
                    <label for="KzebzIxgQK">Web</label>
                    <ul>
