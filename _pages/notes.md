...
<ul>
    <div name="contents-index">
        ...
        <l>
            <input type="checkbox" id="ogqTPwCWrQ" checked>
            <label for="ogqTPwCWrQ">Math</label>
            <ul>
                <l>
                    <input type="checkbox" id="WKTFISxijN">
                    <label for="WKTFISxijN">Exponentials</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="AsOMCPJkIF">
                    <label for="AsOMCPJkIF">Linear Algebra</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="JuPtaFnplv">
                    <label for="JuPtaFnplv">Logarithms</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="THumavjfTk">
                    <label for="THumavjfTk">Sequences</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="pReOfaXPxA">
                    <label for="pReOfaXPxA">Single Variable Calculus</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="TEECotJhWA">
                    <label for="TEECotJhWA">Trigonometry</label>
                    <ul>
        ...
        <l>
            <input type="checkbox" id="HbKYbtZUEf" checked>
            <label for="HbKYbtZUEf">Programming</label>
            <ul>
                <l>
                    <input type="checkbox" id="GLfXlVOlrB">
                    <label for="GLfXlVOlrB">Ansible</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="ORXvYWNlMn">
                    <label for="ORXvYWNlMn">Architecture</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="MraaNdAeam">
                    <label for="MraaNdAeam">Computer Graphics</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="ozbGVinuDw">
                    <label for="ozbGVinuDw">Databases</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="fDnstLcVry">
                    <label for="fDnstLcVry">Devops</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="iSTiphhdlw">
                            <label for="iSTiphhdlw">Cloud Providers</label>
                            <ul>
                                <l>
                                    <input type="checkbox" id="jRwIVBMPnY">
                                    <label for="jRwIVBMPnY">AWS</label>
                                    <ul>
                                        <l>
                                            <input type="checkbox" id="kMhxnWfsBA">
                                            <label for="kMhxnWfsBA">Cli</label>
                                            <ul>
                                        ...
                                        <l>
                                            <input type="checkbox" id="wyiokOgMij">
                                            <label for="wyiokOgMij">Dotnet</label>
                                            <ul>
                                        ...
                                        <l>
                                            <input type="checkbox" id="MnhayJlCkS">
                                            <label for="MnhayJlCkS">Ec 2</label>
                                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="TcHOdTWhGv">
                            <label for="TcHOdTWhGv">Events</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="UiMpjGpmso">
                            <label for="UiMpjGpmso">Localstack</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="YRkfamYzJQ">
                            <label for="YRkfamYzJQ">Pulumi</label>
                            <ul>
                                <l>
                                    <input type="checkbox" id="ObqxGZGrhm">
                                    <label for="ObqxGZGrhm">Dotnet</label>
                                    <ul>
                        ...
                        <l>
                            <input type="checkbox" id="IrssptzRSZ">
                            <label for="IrssptzRSZ">Serverless Framework</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="uCWOdAtntk">
                            <label for="uCWOdAtntk">Terraform</label>
                            <ul>
                                <l>
                                    <input type="checkbox" id="asdjpkDfbA">
                                    <label for="asdjpkDfbA">Functions</label>
                                    <ul>
                                ...
                                <l>
                                    <input type="checkbox" id="ywWsRvDcIH">
                                    <label for="ywWsRvDcIH">Meta Arguments</label>
                                    <ul>
                ...
                <l>
                    <input type="checkbox" id="KJElQRuPYe">
                    <label for="KJElQRuPYe">Docker</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="ZWCqDIKOEG">
                    <label for="ZWCqDIKOEG">Dotnet</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="DbKUuVGGkY">
                            <label for="DbKUuVGGkY">Cli</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="YVwoGTPYsM">
                    <label for="YVwoGTPYsM">Functional Programming</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="oONDXyDtSc">
                    <label for="oONDXyDtSc">Git</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="nCUCTfKUQW">
                            <label for="nCUCTfKUQW">Github</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="ExtbassoDr">
                    <label for="ExtbassoDr">Go</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="ErXjPcAXQA">
                    <label for="ErXjPcAXQA">Haskell</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="ZbWbJTpaaH">
                    <label for="ZbWbJTpaaH">Js</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="wRtfdTdVnD">
                            <label for="wRtfdTdVnD">Node</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="ntRivrdQYp">
                            <label for="ntRivrdQYp">D3</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="vTvfvASLfI">
                            <label for="vTvfvASLfI">Mocha</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="KaqHuFBwLH">
                            <label for="KaqHuFBwLH">P5js</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="qGQdLGIdxz">
                            <label for="qGQdLGIdxz">Typescript</label>
                            <ul>
                                <l>
                                    <input type="checkbox" id="CFOSNPBxlM">
                                    <label for="CFOSNPBxlM">Testing</label>
                                    <ul>
                ...
                <l>
                    <input type="checkbox" id="uWLzvKkAnW">
                    <label for="uWLzvKkAnW">Kafka</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="DpCITEfcLa">
                    <label for="DpCITEfcLa">Kubernetes</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="VbdwocTwIQ">
                    <label for="VbdwocTwIQ">Language</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="IiMAZZYzmf">
                    <label for="IiMAZZYzmf">Linux</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="jPBjHKbxCy">
                            <label for="jPBjHKbxCy">Bash</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="MLvJlMhzNo">
                    <label for="MLvJlMhzNo">Oauth</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="ZIjZXKJllO">
                    <label for="ZIjZXKJllO">Python</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="FTaxOOWgxr">
                            <label for="FTaxOOWgxr">Data Classes</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="qguAoFIWWk">
                            <label for="qguAoFIWWk">Libraries</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="vNBDiwejZj">
                    <label for="vNBDiwejZj">React</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="MIypqStwAi">
                    <label for="MIypqStwAi">Regular Expressions</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="AKrgDhCKjQ">
                    <label for="AKrgDhCKjQ">Rust</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="XXxdynTuiG">
                            <label for="XXxdynTuiG">Serde</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="LGpGTBuPlY">
                    <label for="LGpGTBuPlY">Vim</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="DEXsClIhVW">
                    <label for="DEXsClIhVW">Web</label>
                    <ul>
