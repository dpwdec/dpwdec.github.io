...
<ul>
    <div name="contents-index">
        ...
        <l>
            <input type="checkbox" id="CaHEUzdZvZ" checked>
            <label for="CaHEUzdZvZ">Math</label>
            <ul>
                <l>
                    <input type="checkbox" id="KuVwjaPOHf">
                    <label for="KuVwjaPOHf">Exponentials</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="XMqLTFHahj">
                    <label for="XMqLTFHahj">Linear Algebra</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="JeYRYQRxZK">
                    <label for="JeYRYQRxZK">Logarithms</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="IkeGVQckHq">
                    <label for="IkeGVQckHq">Sequences</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="IXGvaIHxOk">
                    <label for="IXGvaIHxOk">Single Variable Calculus</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="ChMGoMNOMc">
                    <label for="ChMGoMNOMc">Trigonometry</label>
                    <ul>
        ...
        <l>
            <input type="checkbox" id="QyfsvHsVJa" checked>
            <label for="QyfsvHsVJa">Programming</label>
            <ul>
                <l>
                    <input type="checkbox" id="UPuldFpTJI">
                    <label for="UPuldFpTJI">Ansible</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="isiBSVJdoj">
                    <label for="isiBSVJdoj">Architecture</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="lPhWXtuqGa">
                    <label for="lPhWXtuqGa">Computer Graphics</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="ZLpshrtalN">
                    <label for="ZLpshrtalN">Databases</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="kTHURJxrpm">
                    <label for="kTHURJxrpm">Devops</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="xHiWIZGSnI">
                            <label for="xHiWIZGSnI">Cloud Providers</label>
                            <ul>
                                <l>
                                    <input type="checkbox" id="zYXIfpfIVr">
                                    <label for="zYXIfpfIVr">AWS</label>
                                    <ul>
                                        <l>
                                            <input type="checkbox" id="CIfSondBbS">
                                            <label for="CIfSondBbS">Cli</label>
                                            <ul>
                                        ...
                                        <l>
                                            <input type="checkbox" id="lsMBjPytvd">
                                            <label for="lsMBjPytvd">Dotnet</label>
                                            <ul>
                                        ...
                                        <l>
                                            <input type="checkbox" id="LsQaTGMtoK">
                                            <label for="LsQaTGMtoK">Ec 2</label>
                                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="lxDkKhAvqo">
                            <label for="lxDkKhAvqo">Events</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="LfuXmvfHVU">
                            <label for="LfuXmvfHVU">Localstack</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="isFgyEThWC">
                            <label for="isFgyEThWC">Pulumi</label>
                            <ul>
                                <l>
                                    <input type="checkbox" id="OxvvlrAiLn">
                                    <label for="OxvvlrAiLn">Dotnet</label>
                                    <ul>
                        ...
                        <l>
                            <input type="checkbox" id="tKUiuxTJyj">
                            <label for="tKUiuxTJyj">Serverless Framework</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="xYizAhHnKf">
                            <label for="xYizAhHnKf">Terraform</label>
                            <ul>
                                <l>
                                    <input type="checkbox" id="BHnsfMFLRO">
                                    <label for="BHnsfMFLRO">Functions</label>
                                    <ul>
                                ...
                                <l>
                                    <input type="checkbox" id="GXVUPHlArb">
                                    <label for="GXVUPHlArb">Meta Arguments</label>
                                    <ul>
                ...
                <l>
                    <input type="checkbox" id="yKQvwsNzql">
                    <label for="yKQvwsNzql">Docker</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="sMhmYHMpYZ">
                    <label for="sMhmYHMpYZ">Dotnet</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="MioLrUdstx">
                            <label for="MioLrUdstx">Cli</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="HlzHqWKezh">
                    <label for="HlzHqWKezh">Functional Programming</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="bTvTposTze">
                    <label for="bTvTposTze">Git</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="PiKPNBEDCc">
                            <label for="PiKPNBEDCc">Github</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="wwciiXPsCk">
                    <label for="wwciiXPsCk">Go</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="jRTDbNTwKx">
                    <label for="jRTDbNTwKx">Haskell</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="UOqkvviRYv">
                    <label for="UOqkvviRYv">Js</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="QWirXBkhJo">
                            <label for="QWirXBkhJo">Node</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="nNrPoJYoGf">
                            <label for="nNrPoJYoGf">D3</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="qZVzdzDHSF">
                            <label for="qZVzdzDHSF">Mocha</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="fYJVNnqxpJ">
                            <label for="fYJVNnqxpJ">P5js</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="sLgIkdyiSV">
                            <label for="sLgIkdyiSV">Typescript</label>
                            <ul>
                                <l>
                                    <input type="checkbox" id="JRRfLdfsDD">
                                    <label for="JRRfLdfsDD">Testing</label>
                                    <ul>
                ...
                <l>
                    <input type="checkbox" id="fGfVFQOBZW">
                    <label for="fGfVFQOBZW">Kafka</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="ONZMCAuNKl">
                    <label for="ONZMCAuNKl">Kubernetes</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="HGLjTglVDg">
                    <label for="HGLjTglVDg">Language</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="ulHZIBqFQj">
                    <label for="ulHZIBqFQj">Linux</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="WTWvPEdHLF">
                            <label for="WTWvPEdHLF">Bash</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="QFNxJClgLd">
                    <label for="QFNxJClgLd">Oauth</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="AwbhVeCmYJ">
                    <label for="AwbhVeCmYJ">Prometheus</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="bKdDZfHUss">
                    <label for="bKdDZfHUss">Python</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="NuFedJwJxX">
                            <label for="NuFedJwJxX">Data Classes</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="QMbqYjJmjx">
                            <label for="QMbqYjJmjx">Libraries</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="MhYQmRtvbM">
                    <label for="MhYQmRtvbM">React</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="ZLUkVoOqoi">
                    <label for="ZLUkVoOqoi">Regular Expressions</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="oGuylcEigO">
                    <label for="oGuylcEigO">Rust</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="NPxReuWdfn">
                            <label for="NPxReuWdfn">Serde</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="qKUNBHtiYS">
                    <label for="qKUNBHtiYS">Shaders</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="nOafRuelpQ">
                            <label for="nOafRuelpQ">Glsl</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="PWAVHVWQLI">
                    <label for="PWAVHVWQLI">Vim</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="UiVKcsvNLo">
                    <label for="UiVKcsvNLo">Web</label>
                    <ul>
