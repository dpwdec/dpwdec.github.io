...
<ul>
    <div name="contents-index">
        ...
        <l>
            <input type="checkbox" id="ITgFrLyHZI" checked>
            <label for="ITgFrLyHZI">Math</label>
            <ul>
                <l>
                    <input type="checkbox" id="IjCNMljQOw">
                    <label for="IjCNMljQOw">Exponentials</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="yEzkKPIFNv">
                    <label for="yEzkKPIFNv">Linear Algebra</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="ZMvEGHTvjH">
                    <label for="ZMvEGHTvjH">Logarithms</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="NhZIAdCTrD">
                    <label for="NhZIAdCTrD">Sequences</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="CMuXEnKNwK">
                    <label for="CMuXEnKNwK">Single Variable Calculus</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="mNOuKYmpEd">
                    <label for="mNOuKYmpEd">Trigonometry</label>
                    <ul>
        ...
        <l>
            <input type="checkbox" id="hVbvGsaBNA" checked>
            <label for="hVbvGsaBNA">Programming</label>
            <ul>
                <l>
                    <input type="checkbox" id="bNPcdMfmKn">
                    <label for="bNPcdMfmKn">Ansible</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="zLwZJXugyQ">
                    <label for="zLwZJXugyQ">Architecture</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="dsYsnQGLsT">
                    <label for="dsYsnQGLsT">Computer Graphics</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="EQrYQawIoW">
                    <label for="EQrYQawIoW">Databases</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="iQafPxrWOu">
                    <label for="iQafPxrWOu">Devops</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="VFgaaHCaNI">
                            <label for="VFgaaHCaNI">Cloud Computing</label>
                            <ul>
                                <l>
                                    <input type="checkbox" id="aRCSflcihO">
                                    <label for="aRCSflcihO">AWS</label>
                                    <ul>
                                        <l>
                                            <input type="checkbox" id="fvhpmOHKbP">
                                            <label for="fvhpmOHKbP">Cli</label>
                                            <ul>
                                        ...
                                        <l>
                                            <input type="checkbox" id="FeiejWoIXn">
                                            <label for="FeiejWoIXn">Dotnet</label>
                                            <ul>
                                        ...
                                        <l>
                                            <input type="checkbox" id="psQRmjkKAM">
                                            <label for="psQRmjkKAM">Ec 2</label>
                                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="zFBWCgJMoc">
                            <label for="zFBWCgJMoc">Events</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="RmYYjZzopz">
                            <label for="RmYYjZzopz">Localstack</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="gzBTHbnxuu">
                            <label for="gzBTHbnxuu">Oauth</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="bFOtsUDTwA">
                            <label for="bFOtsUDTwA">Pulumi</label>
                            <ul>
                                <l>
                                    <input type="checkbox" id="FwCtEHLYqp">
                                    <label for="FwCtEHLYqp">Dotnet</label>
                                    <ul>
                        ...
                        <l>
                            <input type="checkbox" id="NdmCDiwcAA">
                            <label for="NdmCDiwcAA">Terraform</label>
                            <ul>
                                <l>
                                    <input type="checkbox" id="bGsxCxokYA">
                                    <label for="bGsxCxokYA">Functions</label>
                                    <ul>
                                ...
                                <l>
                                    <input type="checkbox" id="TEgKZtSSkm">
                                    <label for="TEgKZtSSkm">Meta Arguments</label>
                                    <ul>
                ...
                <l>
                    <input type="checkbox" id="hMUXCvMjjD">
                    <label for="hMUXCvMjjD">Docker</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="hIvfvOTOjD">
                    <label for="hIvfvOTOjD">Dotnet</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="YjlFTckedk">
                            <label for="YjlFTckedk">Cli</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="iQjPQekymW">
                    <label for="iQjPQekymW">Functional Programming</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="pwrMuYiWYo">
                    <label for="pwrMuYiWYo">Git</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="mDfkFovVCp">
                            <label for="mDfkFovVCp">Github</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="DQyUXJTSiH">
                    <label for="DQyUXJTSiH">Go</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="dMYhiYTgpn">
                    <label for="dMYhiYTgpn">Haskell</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="ndToPAgVni">
                    <label for="ndToPAgVni">Js</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="stspLewHAY">
                            <label for="stspLewHAY">Node</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="aiIFacPRRi">
                            <label for="aiIFacPRRi">D3</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="UZzYuCcuAb">
                            <label for="UZzYuCcuAb">Mocha</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="dHPLkcgDlX">
                            <label for="dHPLkcgDlX">P5js</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="wDzwBdgxGL">
                            <label for="wDzwBdgxGL">Typescript</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="HOAELVqoyx">
                    <label for="HOAELVqoyx">Kafka</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="wHrVTINyPu">
                    <label for="wHrVTINyPu">Kubernetes</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="GJOWRraWOP">
                    <label for="GJOWRraWOP">Language</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="vRvwrCMesS">
                    <label for="vRvwrCMesS">Linux</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="jJQIHkBqmH">
                            <label for="jJQIHkBqmH">Bash</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="kLOmqcHoEB">
                    <label for="kLOmqcHoEB">Python</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="eiInoCDfeO">
                            <label for="eiInoCDfeO">Data Classes</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="AQZIjrGyDF">
                            <label for="AQZIjrGyDF">Libraries</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="jZBpDmOczA">
                    <label for="jZBpDmOczA">React</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="VjzPzpicsf">
                    <label for="VjzPzpicsf">Regular Expressions</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="MGgBCnxqlz">
                    <label for="MGgBCnxqlz">Rust</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="mEzNzdWkvD">
                            <label for="mEzNzdWkvD">Serde</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="EQWoXgMWLx">
                    <label for="EQWoXgMWLx">Vim</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="yfjPxKBMGK">
                    <label for="yfjPxKBMGK">Web</label>
                    <ul>
