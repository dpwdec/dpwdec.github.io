...
<ul>
    <div name="contents-index">
        ...
        <l>
            <input type="checkbox" id="pFoahsrlhN" checked>
            <label for="pFoahsrlhN">Math</label>
            <ul>
                <l>
                    <input type="checkbox" id="mYyCGlNAgq">
                    <label for="mYyCGlNAgq">Exponentials</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="DJmSUiDTsG">
                    <label for="DJmSUiDTsG">Linear Algebra</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="cYXxMHbtTM">
                    <label for="cYXxMHbtTM">Logarithms</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="QNFInzGuxv">
                    <label for="QNFInzGuxv">Sequences</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="JylMpgHBmV">
                    <label for="JylMpgHBmV">Single Variable Calculus</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="AZywECIfta">
                    <label for="AZywECIfta">Trigonometry</label>
                    <ul>
        ...
        <l>
            <input type="checkbox" id="AnfavFXUYw" checked>
            <label for="AnfavFXUYw">Programming</label>
            <ul>
                <l>
                    <input type="checkbox" id="eUJQLeSrAe">
                    <label for="eUJQLeSrAe">Ansible</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="LZZnXOZhcB">
                    <label for="LZZnXOZhcB">Architecture</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="yMYTzOfmwB">
                    <label for="yMYTzOfmwB">Computer Graphics</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="AXfdSNfoTk">
                    <label for="AXfdSNfoTk">Databases</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="QNDkkUrXlg">
                    <label for="QNDkkUrXlg">Devops</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="ZOtktUJHwv">
                            <label for="ZOtktUJHwv">Cloud Computing</label>
                            <ul>
                                <l>
                                    <input type="checkbox" id="wjYqZrDCfO">
                                    <label for="wjYqZrDCfO">AWS</label>
                                    <ul>
                                        <l>
                                            <input type="checkbox" id="gzvcLnUYqi">
                                            <label for="gzvcLnUYqi">Cli</label>
                                            <ul>
                                        ...
                                        <l>
                                            <input type="checkbox" id="bIoGCCNJDO">
                                            <label for="bIoGCCNJDO">Dotnet</label>
                                            <ul>
                                        ...
                                        <l>
                                            <input type="checkbox" id="CKGsfFtarV">
                                            <label for="CKGsfFtarV">Ec 2</label>
                                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="AIVuAPLPON">
                            <label for="AIVuAPLPON">Events</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="yRtCXerruB">
                            <label for="yRtCXerruB">Oauth</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="NhkdGtfalr">
                            <label for="NhkdGtfalr">Pulumi</label>
                            <ul>
                                <l>
                                    <input type="checkbox" id="huTWeGPngx">
                                    <label for="huTWeGPngx">Dotnet</label>
                                    <ul>
                        ...
                        <l>
                            <input type="checkbox" id="veOdulowfy">
                            <label for="veOdulowfy">Terraform</label>
                            <ul>
                                <l>
                                    <input type="checkbox" id="OYNeFyxlEI">
                                    <label for="OYNeFyxlEI">Functions</label>
                                    <ul>
                                ...
                                <l>
                                    <input type="checkbox" id="oqWXHwbjWl">
                                    <label for="oqWXHwbjWl">Meta Arguments</label>
                                    <ul>
                ...
                <l>
                    <input type="checkbox" id="MdGfTtCPEE">
                    <label for="MdGfTtCPEE">Docker</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="MLAIaWTjFF">
                    <label for="MLAIaWTjFF">Dotnet</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="olxVbnggmF">
                            <label for="olxVbnggmF">Cli</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="xYGrTYhvKj">
                    <label for="xYGrTYhvKj">Functional Programming</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="fImWTohNWF">
                    <label for="fImWTohNWF">Git</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="IYRKVfRRgn">
                            <label for="IYRKVfRRgn">Github</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="ZmFyeWBwhv">
                    <label for="ZmFyeWBwhv">Go</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="OXWIaMbqyl">
                    <label for="OXWIaMbqyl">Haskell</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="WfjVXPKKJG">
                    <label for="WfjVXPKKJG">Js</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="mniYfSuRkQ">
                            <label for="mniYfSuRkQ">Node</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="xtgEBVlaIP">
                            <label for="xtgEBVlaIP">Mocha</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="ASFijNQBDn">
                            <label for="ASFijNQBDn">P5js</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="lqtgRRJDYD">
                            <label for="lqtgRRJDYD">Typescript</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="yBmZlFRriw">
                    <label for="yBmZlFRriw">Kafka</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="lBbawNIWTK">
                    <label for="lBbawNIWTK">Kubernetes</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="egiGkoKYbz">
                    <label for="egiGkoKYbz">Language</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="wiRTrulbyL">
                    <label for="wiRTrulbyL">Linux</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="ScZFXbkCjm">
                    <label for="ScZFXbkCjm">Python</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="bMmPxDwWwn">
                            <label for="bMmPxDwWwn">Data Classes</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="kIJxGEjGuB">
                            <label for="kIJxGEjGuB">Libraries</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="zXoOcwvJSC">
                    <label for="zXoOcwvJSC">React</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="JhscskqJPR">
                    <label for="JhscskqJPR">Regular Expressions</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="KWWXUIKAJL">
                    <label for="KWWXUIKAJL">Rust</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="aIxbGMflKs">
                            <label for="aIxbGMflKs">Serde</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="NiQcdvFmfJ">
                    <label for="NiQcdvFmfJ">Vim</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="ebwZbTMpHh">
                    <label for="ebwZbTMpHh">Web</label>
                    <ul>
