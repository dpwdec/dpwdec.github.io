...
<ul>
    <div name="contents-index">
        ...
        <l>
            <input type="checkbox" id="HSfvhTfjDX" checked>
            <label for="HSfvhTfjDX">Math</label>
            <ul>
                <l>
                    <input type="checkbox" id="WbSXsNBPEa">
                    <label for="WbSXsNBPEa">Exponentials</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="eMDkLSAklo">
                    <label for="eMDkLSAklo">Linear Algebra</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="WqycYmgpDY">
                    <label for="WqycYmgpDY">Logarithms</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="EtiQrkIWrw">
                    <label for="EtiQrkIWrw">Sequences</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="kanUSQOmoh">
                    <label for="kanUSQOmoh">Single Variable Calculus</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="AjjqJVkuzJ">
                    <label for="AjjqJVkuzJ">Trigonometry</label>
                    <ul>
        ...
        <l>
            <input type="checkbox" id="gpIgucdMwq" checked>
            <label for="gpIgucdMwq">Programming</label>
            <ul>
                <l>
                    <input type="checkbox" id="RrlabFsede">
                    <label for="RrlabFsede">Ansible</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="oTLVaFxxiN">
                    <label for="oTLVaFxxiN">Architecture</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="TnmdHbZqou">
                    <label for="TnmdHbZqou">Computer Graphics</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="RpioSbsZPW">
                    <label for="RpioSbsZPW">Databases</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="DUTrmvcJje">
                    <label for="DUTrmvcJje">Devops</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="QRSSNMnuVv">
                            <label for="QRSSNMnuVv">Cloud Providers</label>
                            <ul>
                                <l>
                                    <input type="checkbox" id="PBPjsVSDnv">
                                    <label for="PBPjsVSDnv">AWS</label>
                                    <ul>
                                        <l>
                                            <input type="checkbox" id="VmQlskYsqz">
                                            <label for="VmQlskYsqz">Cli</label>
                                            <ul>
                                        ...
                                        <l>
                                            <input type="checkbox" id="PCjunRAuoS">
                                            <label for="PCjunRAuoS">Dotnet</label>
                                            <ul>
                                        ...
                                        <l>
                                            <input type="checkbox" id="JwnLxbRdfM">
                                            <label for="JwnLxbRdfM">Ec 2</label>
                                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="sYBUpOKKeZ">
                            <label for="sYBUpOKKeZ">Events</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="aUhuLtiDhy">
                            <label for="aUhuLtiDhy">Localstack</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="wqppBhwBBo">
                            <label for="wqppBhwBBo">Pulumi</label>
                            <ul>
                                <l>
                                    <input type="checkbox" id="urshSTdZeb">
                                    <label for="urshSTdZeb">Dotnet</label>
                                    <ul>
                        ...
                        <l>
                            <input type="checkbox" id="nYYDZgAjsn">
                            <label for="nYYDZgAjsn">Serverless Framework</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="iMBUICADYE">
                            <label for="iMBUICADYE">Terraform</label>
                            <ul>
                                <l>
                                    <input type="checkbox" id="oakwAfeYBb">
                                    <label for="oakwAfeYBb">Functions</label>
                                    <ul>
                                ...
                                <l>
                                    <input type="checkbox" id="qyvrZmABME">
                                    <label for="qyvrZmABME">Meta Arguments</label>
                                    <ul>
                ...
                <l>
                    <input type="checkbox" id="clsNFINUtx">
                    <label for="clsNFINUtx">Docker</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="TOuGYvejaR">
                    <label for="TOuGYvejaR">Dotnet</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="vCZNNccsqd">
                            <label for="vCZNNccsqd">Cli</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="uvhYVYvUcr">
                    <label for="uvhYVYvUcr">Functional Programming</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="ASUBOiblyV">
                    <label for="ASUBOiblyV">Git</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="gERgXRFKwx">
                            <label for="gERgXRFKwx">Github</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="tjnWmdltjs">
                    <label for="tjnWmdltjs">Go</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="UwPjjwJFyK">
                    <label for="UwPjjwJFyK">Haskell</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="gVqOuiWgpP">
                    <label for="gVqOuiWgpP">Js</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="onMwjHlMub">
                            <label for="onMwjHlMub">Node</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="EvyPWsDVlo">
                            <label for="EvyPWsDVlo">D3</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="hJnQnQukwI">
                            <label for="hJnQnQukwI">Mocha</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="xKVxeJWOcC">
                            <label for="xKVxeJWOcC">P5js</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="KPEcSCWsUf">
                            <label for="KPEcSCWsUf">Typescript</label>
                            <ul>
                                <l>
                                    <input type="checkbox" id="oPpsWOhEtq">
                                    <label for="oPpsWOhEtq">Testing</label>
                                    <ul>
                ...
                <l>
                    <input type="checkbox" id="lbtFzPHRDP">
                    <label for="lbtFzPHRDP">Kafka</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="gFvaySIkzj">
                    <label for="gFvaySIkzj">Kubernetes</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="cMGHCCsmAD">
                    <label for="cMGHCCsmAD">Language</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="sbzbAIzQca">
                    <label for="sbzbAIzQca">Linux</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="zcjceiNFRc">
                            <label for="zcjceiNFRc">Bash</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="KYvJqLSsey">
                    <label for="KYvJqLSsey">Oauth</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="pSAlaGMrnB">
                    <label for="pSAlaGMrnB">Python</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="DtICRLHqLA">
                            <label for="DtICRLHqLA">Data Classes</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="vtAxeBJafE">
                            <label for="vtAxeBJafE">Libraries</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="qkndWEuBjr">
                    <label for="qkndWEuBjr">React</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="eLbZlyAFoh">
                    <label for="eLbZlyAFoh">Regular Expressions</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="IzIPgFpSco">
                    <label for="IzIPgFpSco">Rust</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="rhqOnnSKbx">
                            <label for="rhqOnnSKbx">Serde</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="MWyvQlfkKW">
                    <label for="MWyvQlfkKW">Vim</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="CecNrMcOVl">
                    <label for="CecNrMcOVl">Web</label>
                    <ul>
