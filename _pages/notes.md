...
<ul>
    <div name="contents-index">
        ...
        <l>
            <input type="checkbox" id="BUChZMLUgG" checked>
            <label for="BUChZMLUgG">Math</label>
            <ul>
                <l>
                    <input type="checkbox" id="DIGvTcvSPx">
                    <label for="DIGvTcvSPx">Exponentials</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="JofBBMExpT">
                    <label for="JofBBMExpT">Linear Algebra</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="qGDaDWlYrR">
                    <label for="qGDaDWlYrR">Logarithms</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="qJeyvJEuNb">
                    <label for="qJeyvJEuNb">Sequences</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="VmfUgyzkLP">
                    <label for="VmfUgyzkLP">Single Variable Calculus</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="LmBPkstkTk">
                    <label for="LmBPkstkTk">Trigonometry</label>
                    <ul>
        ...
        <l>
            <input type="checkbox" id="lMELBzHAJC" checked>
            <label for="lMELBzHAJC">Programming</label>
            <ul>
                <l>
                    <input type="checkbox" id="bPeqXlRdZq">
                    <label for="bPeqXlRdZq">Ansible</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="KhEWNPTjBe">
                    <label for="KhEWNPTjBe">Architecture</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="WSntKnVDca">
                    <label for="WSntKnVDca">Computer Graphics</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="YOUlGVMxCC">
                    <label for="YOUlGVMxCC">Databases</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="VzEtsvgoPI">
                    <label for="VzEtsvgoPI">Devops</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="jujpmAhpsh">
                            <label for="jujpmAhpsh">Cloud Providers</label>
                            <ul>
                                <l>
                                    <input type="checkbox" id="YZSEXeqEUf">
                                    <label for="YZSEXeqEUf">AWS</label>
                                    <ul>
                                        <l>
                                            <input type="checkbox" id="VKkwyYbmEl">
                                            <label for="VKkwyYbmEl">Cli</label>
                                            <ul>
                                        ...
                                        <l>
                                            <input type="checkbox" id="eBwdpoFQmK">
                                            <label for="eBwdpoFQmK">Dotnet</label>
                                            <ul>
                                        ...
                                        <l>
                                            <input type="checkbox" id="ykuiSnCYHM">
                                            <label for="ykuiSnCYHM">Ec 2</label>
                                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="skXKwvaKWO">
                            <label for="skXKwvaKWO">Events</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="NPRYyLXDuZ">
                            <label for="NPRYyLXDuZ">Localstack</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="mEPcwTPyRc">
                            <label for="mEPcwTPyRc">Pulumi</label>
                            <ul>
                                <l>
                                    <input type="checkbox" id="PKdDRVcFio">
                                    <label for="PKdDRVcFio">Dotnet</label>
                                    <ul>
                        ...
                        <l>
                            <input type="checkbox" id="cHUvSZAyQn">
                            <label for="cHUvSZAyQn">Serverless Framework</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="enAieoITCQ">
                            <label for="enAieoITCQ">Terraform</label>
                            <ul>
                                <l>
                                    <input type="checkbox" id="UFSdHXQBuq">
                                    <label for="UFSdHXQBuq">Functions</label>
                                    <ul>
                                ...
                                <l>
                                    <input type="checkbox" id="LRKyNuapwO">
                                    <label for="LRKyNuapwO">Meta Arguments</label>
                                    <ul>
                ...
                <l>
                    <input type="checkbox" id="wPlNGvAkMk">
                    <label for="wPlNGvAkMk">Docker</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="OKOxzlzsIl">
                    <label for="OKOxzlzsIl">Dotnet</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="FVbNUSeLcm">
                            <label for="FVbNUSeLcm">Cli</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="boyDkoiHmP">
                    <label for="boyDkoiHmP">Functional Programming</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="XPQEkgRQpF">
                    <label for="XPQEkgRQpF">Git</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="luVMRxOMxf">
                            <label for="luVMRxOMxf">Github</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="UoJahbEndr">
                    <label for="UoJahbEndr">Go</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="uvCmkPJnma">
                    <label for="uvCmkPJnma">Haskell</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="cPHndetrBJ">
                    <label for="cPHndetrBJ">Js</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="KhKEZOPyKd">
                            <label for="KhKEZOPyKd">Node</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="sdqXmOvtJT">
                            <label for="sdqXmOvtJT">D3</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="vlUelqaFfi">
                            <label for="vlUelqaFfi">Mocha</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="OFwMOplZOw">
                            <label for="OFwMOplZOw">P5js</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="TsuEQSueaW">
                            <label for="TsuEQSueaW">Typescript</label>
                            <ul>
                                <l>
                                    <input type="checkbox" id="LNTnVviONq">
                                    <label for="LNTnVviONq">Testing</label>
                                    <ul>
                ...
                <l>
                    <input type="checkbox" id="lzhKseCfDa">
                    <label for="lzhKseCfDa">Kafka</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="ymIRaWrJYf">
                    <label for="ymIRaWrJYf">Kubernetes</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="ElbbJLLHKy">
                    <label for="ElbbJLLHKy">Language</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="WyanssjKDd">
                    <label for="WyanssjKDd">Linux</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="QzMFedAbYC">
                            <label for="QzMFedAbYC">Bash</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="QRGKVJryib">
                    <label for="QRGKVJryib">Oauth</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="XfjIdOoibj">
                    <label for="XfjIdOoibj">Prometheus</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="uBubSUgTEM">
                    <label for="uBubSUgTEM">Python</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="EKStsvNIqy">
                            <label for="EKStsvNIqy">Data Classes</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="lBWMFIvzXk">
                            <label for="lBWMFIvzXk">Libraries</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="PnuPiCDTNL">
                    <label for="PnuPiCDTNL">React</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="dctxarpbZD">
                    <label for="dctxarpbZD">Regular Expressions</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="krsHBTWJMY">
                    <label for="krsHBTWJMY">Rust</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="BuTAginHun">
                            <label for="BuTAginHun">Serde</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="JoUJVLRfUg">
                    <label for="JoUJVLRfUg">Shaders</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="AfklJBhPIQ">
                            <label for="AfklJBhPIQ">Glsl</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="BftFWJBqGW">
                    <label for="BftFWJBqGW">Vim</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="wGiRbXbrnY">
                    <label for="wGiRbXbrnY">Web</label>
                    <ul>
