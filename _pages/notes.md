...
<ul>
    <div name="contents-index">
        ...
        <l>
            <input type="checkbox" id="tAwIeAdpEc" checked>
            <label for="tAwIeAdpEc">Math</label>
            <ul>
                <l>
                    <input type="checkbox" id="FEbRcIYkFG">
                    <label for="FEbRcIYkFG">Exponentials</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="IbsNzpQYsK">
                    <label for="IbsNzpQYsK">Linear Algebra</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="wsKGeiuPth">
                    <label for="wsKGeiuPth">Logarithms</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="qOpDxXkzxh">
                    <label for="qOpDxXkzxh">Sequences</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="lTOxhVPNtq">
                    <label for="lTOxhVPNtq">Single Variable Calculus</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="WfYFXgcerJ">
                    <label for="WfYFXgcerJ">Trigonometry</label>
                    <ul>
        ...
        <l>
            <input type="checkbox" id="YiRsrRuPZZ" checked>
            <label for="YiRsrRuPZZ">Programming</label>
            <ul>
                <l>
                    <input type="checkbox" id="vnloARKgrV">
                    <label for="vnloARKgrV">Ansible</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="CsMIdbFXmY">
                    <label for="CsMIdbFXmY">Architecture</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="pJpyNIpZuB">
                    <label for="pJpyNIpZuB">Computer Graphics</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="voFgAIAHqk">
                    <label for="voFgAIAHqk">Databases</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="kwNwlXeajG">
                    <label for="kwNwlXeajG">Devops</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="sTViWPemdw">
                            <label for="sTViWPemdw">Cloud Providers</label>
                            <ul>
                                <l>
                                    <input type="checkbox" id="TRUBvlTAVr">
                                    <label for="TRUBvlTAVr">AWS</label>
                                    <ul>
                                        <l>
                                            <input type="checkbox" id="SidGnwhkbK">
                                            <label for="SidGnwhkbK">Cli</label>
                                            <ul>
                                        ...
                                        <l>
                                            <input type="checkbox" id="XaBGDmsYDP">
                                            <label for="XaBGDmsYDP">Dotnet</label>
                                            <ul>
                                        ...
                                        <l>
                                            <input type="checkbox" id="ZbWCpSfVcL">
                                            <label for="ZbWCpSfVcL">Ec 2</label>
                                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="sblVwddlJE">
                            <label for="sblVwddlJE">Events</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="WxSKxbdcAU">
                            <label for="WxSKxbdcAU">Localstack</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="PzoYkhzPCe">
                            <label for="PzoYkhzPCe">Pulumi</label>
                            <ul>
                                <l>
                                    <input type="checkbox" id="rgCgWDHKwP">
                                    <label for="rgCgWDHKwP">Dotnet</label>
                                    <ul>
                        ...
                        <l>
                            <input type="checkbox" id="ajAaGbxgca">
                            <label for="ajAaGbxgca">Serverless Framework</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="jSlXlvuFDe">
                            <label for="jSlXlvuFDe">Terraform</label>
                            <ul>
                                <l>
                                    <input type="checkbox" id="RKzGTuIsAS">
                                    <label for="RKzGTuIsAS">Functions</label>
                                    <ul>
                                ...
                                <l>
                                    <input type="checkbox" id="jUPrUnOCLB">
                                    <label for="jUPrUnOCLB">Meta Arguments</label>
                                    <ul>
                ...
                <l>
                    <input type="checkbox" id="CKVcPxgBKN">
                    <label for="CKVcPxgBKN">Docker</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="EXqkoiASVJ">
                    <label for="EXqkoiASVJ">Dotnet</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="PIzrNgRqZI">
                            <label for="PIzrNgRqZI">Cli</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="wkTPUhAFmn">
                    <label for="wkTPUhAFmn">Functional Programming</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="ShpOdYBUUb">
                    <label for="ShpOdYBUUb">Git</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="qPOjBnMUQl">
                            <label for="qPOjBnMUQl">Github</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="wOmKrWzCog">
                    <label for="wOmKrWzCog">Go</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="ZMqUQkXQfA">
                    <label for="ZMqUQkXQfA">Haskell</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="KMxFYnjlaK">
                    <label for="KMxFYnjlaK">Js</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="KzBVtYyKGD">
                            <label for="KzBVtYyKGD">Node</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="IePByFKlsZ">
                            <label for="IePByFKlsZ">D3</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="MRTPiEzfzM">
                            <label for="MRTPiEzfzM">Mocha</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="KgUqaxOdvs">
                            <label for="KgUqaxOdvs">P5js</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="BSJsUJNHud">
                            <label for="BSJsUJNHud">Typescript</label>
                            <ul>
                                <l>
                                    <input type="checkbox" id="ItCgGvwoyp">
                                    <label for="ItCgGvwoyp">Testing</label>
                                    <ul>
                ...
                <l>
                    <input type="checkbox" id="KtLkmUMVnK">
                    <label for="KtLkmUMVnK">Kafka</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="QdxrWlCGFD">
                    <label for="QdxrWlCGFD">Kubernetes</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="fUnueuXqNh">
                    <label for="fUnueuXqNh">Language</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="UwwpYeALMx">
                    <label for="UwwpYeALMx">Linux</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="pETlCbhWQB">
                            <label for="pETlCbhWQB">Bash</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="OLrTlDSpNx">
                    <label for="OLrTlDSpNx">Oauth</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="IMiHjCjcwe">
                    <label for="IMiHjCjcwe">Python</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="RbOIsDIYDC">
                            <label for="RbOIsDIYDC">Data Classes</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="IVPWTdxozi">
                            <label for="IVPWTdxozi">Libraries</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="hTjhNrSnzT">
                    <label for="hTjhNrSnzT">React</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="OzemkKhHdN">
                    <label for="OzemkKhHdN">Regular Expressions</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="sVlEGLrNeE">
                    <label for="sVlEGLrNeE">Rust</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="cJHlIHFHDR">
                            <label for="cJHlIHFHDR">Serde</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="lsqQoCECkI">
                    <label for="lsqQoCECkI">Vim</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="JNeFBuNXCm">
                    <label for="JNeFBuNXCm">Web</label>
                    <ul>
