...
<ul>
    <div name="contents-index">
        ...
        <l>
            <input type="checkbox" id="HVJHRFLnxb" checked>
            <label for="HVJHRFLnxb">Math</label>
            <ul>
                <l>
                    <input type="checkbox" id="TllBucsuDt">
                    <label for="TllBucsuDt">Exponentials</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="gtFaxmmYDq">
                    <label for="gtFaxmmYDq">Linear Algebra</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="bvVuzabszD">
                    <label for="bvVuzabszD">Logarithms</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="CQEXUxFrNn">
                    <label for="CQEXUxFrNn">Sequences</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="gMNSEUVRmD">
                    <label for="gMNSEUVRmD">Single Variable Calculus</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="WszUweLoeH">
                    <label for="WszUweLoeH">Trigonometry</label>
                    <ul>
        ...
        <l>
            <input type="checkbox" id="mPYPRKIKEw" checked>
            <label for="mPYPRKIKEw">Programming</label>
            <ul>
                <l>
                    <input type="checkbox" id="PhUnVkVSjo">
                    <label for="PhUnVkVSjo">Ansible</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="anFyAHAayG">
                    <label for="anFyAHAayG">Architecture</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="jxnrAYfYAh">
                    <label for="jxnrAYfYAh">Computer Graphics</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="ynXWabRghK">
                    <label for="ynXWabRghK">Databases</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="RTSadSJcYj">
                    <label for="RTSadSJcYj">Devops</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="UxOHLmgIUm">
                            <label for="UxOHLmgIUm">Cloud Providers</label>
                            <ul>
                                <l>
                                    <input type="checkbox" id="onqoUMzdKR">
                                    <label for="onqoUMzdKR">AWS</label>
                                    <ul>
                                        <l>
                                            <input type="checkbox" id="ryzsVznGdR">
                                            <label for="ryzsVznGdR">Cli</label>
                                            <ul>
                                        ...
                                        <l>
                                            <input type="checkbox" id="QVVAoZqKLy">
                                            <label for="QVVAoZqKLy">Dotnet</label>
                                            <ul>
                                        ...
                                        <l>
                                            <input type="checkbox" id="AbXPTWyIUO">
                                            <label for="AbXPTWyIUO">Ec 2</label>
                                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="tdirRFQemN">
                            <label for="tdirRFQemN">Events</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="NPYHfrtOEV">
                            <label for="NPYHfrtOEV">Localstack</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="ewvjyCDLTA">
                            <label for="ewvjyCDLTA">Pulumi</label>
                            <ul>
                                <l>
                                    <input type="checkbox" id="smFlCUABfm">
                                    <label for="smFlCUABfm">Dotnet</label>
                                    <ul>
                        ...
                        <l>
                            <input type="checkbox" id="eXDLptqMOk">
                            <label for="eXDLptqMOk">Serverless Framework</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="OynwwpdTpT">
                            <label for="OynwwpdTpT">Terraform</label>
                            <ul>
                                <l>
                                    <input type="checkbox" id="RobrvuSxMB">
                                    <label for="RobrvuSxMB">Functions</label>
                                    <ul>
                                ...
                                <l>
                                    <input type="checkbox" id="GxaFTGnYmb">
                                    <label for="GxaFTGnYmb">Meta Arguments</label>
                                    <ul>
                ...
                <l>
                    <input type="checkbox" id="VuiGJObrNY">
                    <label for="VuiGJObrNY">Docker</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="OIafCCKpbv">
                    <label for="OIafCCKpbv">Dotnet</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="xHplFTohaO">
                            <label for="xHplFTohaO">Cli</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="EMpoTWQygl">
                    <label for="EMpoTWQygl">Functional Programming</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="IMmjZLcyPE">
                    <label for="IMmjZLcyPE">Git</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="dwWnBfpDFq">
                            <label for="dwWnBfpDFq">Github</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="wtLCtDeplb">
                    <label for="wtLCtDeplb">Go</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="uQAclViRfs">
                    <label for="uQAclViRfs">Haskell</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="duTLIundyF">
                    <label for="duTLIundyF">Js</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="IwyvDGWWWi">
                            <label for="IwyvDGWWWi">Node</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="OsHrTpCAmo">
                            <label for="OsHrTpCAmo">D3</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="sWHtVHjxTZ">
                            <label for="sWHtVHjxTZ">Mocha</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="iZbXptqUDA">
                            <label for="iZbXptqUDA">P5js</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="tIRZNaeoJi">
                            <label for="tIRZNaeoJi">Typescript</label>
                            <ul>
                                <l>
                                    <input type="checkbox" id="cNcztggaNY">
                                    <label for="cNcztggaNY">Testing</label>
                                    <ul>
                ...
                <l>
                    <input type="checkbox" id="vDuSLKUOCD">
                    <label for="vDuSLKUOCD">Kafka</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="FLOxBYchux">
                    <label for="FLOxBYchux">Kubernetes</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="RQyswpQRfO">
                    <label for="RQyswpQRfO">Language</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="zxRflpUIks">
                    <label for="zxRflpUIks">Linux</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="TEAqjLsXZu">
                            <label for="TEAqjLsXZu">Bash</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="rnSggbrdjQ">
                    <label for="rnSggbrdjQ">Oauth</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="YSPPZtmZiV">
                    <label for="YSPPZtmZiV">Python</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="sNxdbAmepq">
                            <label for="sNxdbAmepq">Data Classes</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="ZyIyQoPmFY">
                            <label for="ZyIyQoPmFY">Libraries</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="oueZHQLinY">
                    <label for="oueZHQLinY">React</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="NBIquKUaJC">
                    <label for="NBIquKUaJC">Regular Expressions</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="TaNbmHwXdC">
                    <label for="TaNbmHwXdC">Rust</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="YEVjNmyxSz">
                            <label for="YEVjNmyxSz">Serde</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="bnHIetaZgz">
                    <label for="bnHIetaZgz">Shaders</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="GUQmnaiEkk">
                            <label for="GUQmnaiEkk">Glsl</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="hGmFTaZAVP">
                    <label for="hGmFTaZAVP">Vim</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="tgqDIGmGbh">
                    <label for="tgqDIGmGbh">Web</label>
                    <ul>
