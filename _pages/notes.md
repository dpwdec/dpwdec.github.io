...
<ul>
    <div name="contents-index">
        ...
        <l>
            <input type="checkbox" id="iRZXKOCShm" checked>
            <label for="iRZXKOCShm">Math</label>
            <ul>
                <l>
                    <input type="checkbox" id="McmYakExGp">
                    <label for="McmYakExGp">Exponentials</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="jncArjCFOF">
                    <label for="jncArjCFOF">Linear Algebra</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="RmzFYsVEzR">
                    <label for="RmzFYsVEzR">Logarithms</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="cetpIClrak">
                    <label for="cetpIClrak">Sequences</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="acrzihxUoG">
                    <label for="acrzihxUoG">Single Variable Calculus</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="HZFrFsZnxL">
                    <label for="HZFrFsZnxL">Trigonometry</label>
                    <ul>
        ...
        <l>
            <input type="checkbox" id="zCOoOFxCLy" checked>
            <label for="zCOoOFxCLy">Programming</label>
            <ul>
                <l>
                    <input type="checkbox" id="dOGCOtTkxA">
                    <label for="dOGCOtTkxA">Ansible</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="YEacIDNkhp">
                    <label for="YEacIDNkhp">Architecture</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="SdukLruBUQ">
                    <label for="SdukLruBUQ">Computer Graphics</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="oPjwbeYtVW">
                    <label for="oPjwbeYtVW">Databases</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="pctceMHbcr">
                    <label for="pctceMHbcr">Devops</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="UlitaeviEs">
                            <label for="UlitaeviEs">Cloud Providers</label>
                            <ul>
                                <l>
                                    <input type="checkbox" id="BOYHNmTJwJ">
                                    <label for="BOYHNmTJwJ">AWS</label>
                                    <ul>
                                        <l>
                                            <input type="checkbox" id="nFNBtIacQV">
                                            <label for="nFNBtIacQV">Cli</label>
                                            <ul>
                                        ...
                                        <l>
                                            <input type="checkbox" id="hLnItlXFBN">
                                            <label for="hLnItlXFBN">Dotnet</label>
                                            <ul>
                                        ...
                                        <l>
                                            <input type="checkbox" id="HpSBXMBirL">
                                            <label for="HpSBXMBirL">Ec 2</label>
                                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="cIfEFkfqlh">
                            <label for="cIfEFkfqlh">Events</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="blPZIgqdas">
                            <label for="blPZIgqdas">Localstack</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="IUAIWXmigC">
                            <label for="IUAIWXmigC">Pulumi</label>
                            <ul>
                                <l>
                                    <input type="checkbox" id="OgftVoTvft">
                                    <label for="OgftVoTvft">Dotnet</label>
                                    <ul>
                        ...
                        <l>
                            <input type="checkbox" id="HMrseMVUvF">
                            <label for="HMrseMVUvF">Serverless Framework</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="MGUcuKzuVH">
                            <label for="MGUcuKzuVH">Terraform</label>
                            <ul>
                                <l>
                                    <input type="checkbox" id="WeJGyspMhL">
                                    <label for="WeJGyspMhL">Functions</label>
                                    <ul>
                                ...
                                <l>
                                    <input type="checkbox" id="EyMJsysxQq">
                                    <label for="EyMJsysxQq">Meta Arguments</label>
                                    <ul>
                ...
                <l>
                    <input type="checkbox" id="BHGxUCbSUe">
                    <label for="BHGxUCbSUe">Docker</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="HeaQBIRSEm">
                    <label for="HeaQBIRSEm">Dotnet</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="nMViJEutNr">
                            <label for="nMViJEutNr">Cli</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="MpUwrsDffb">
                    <label for="MpUwrsDffb">Functional Programming</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="IwLGESGsQc">
                    <label for="IwLGESGsQc">Git</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="JQHpBHlexo">
                            <label for="JQHpBHlexo">Github</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="dCPohomDSk">
                    <label for="dCPohomDSk">Go</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="BqCtuXtOYM">
                    <label for="BqCtuXtOYM">Haskell</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="MmhoUvWmJA">
                    <label for="MmhoUvWmJA">Js</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="cfPxxOCoMY">
                            <label for="cfPxxOCoMY">Node</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="PVtbLHzvzt">
                            <label for="PVtbLHzvzt">D3</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="UtvQxkpDHI">
                            <label for="UtvQxkpDHI">Mocha</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="nAJQVadhHO">
                            <label for="nAJQVadhHO">P5js</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="AchqAzsgLS">
                            <label for="AchqAzsgLS">Typescript</label>
                            <ul>
                                <l>
                                    <input type="checkbox" id="gYJKrgSMbj">
                                    <label for="gYJKrgSMbj">Testing</label>
                                    <ul>
                ...
                <l>
                    <input type="checkbox" id="uYLgzNHjhx">
                    <label for="uYLgzNHjhx">Kafka</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="ufUOyRtBHF">
                    <label for="ufUOyRtBHF">Kubernetes</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="RWMKJhUpab">
                    <label for="RWMKJhUpab">Language</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="arghHiROpQ">
                    <label for="arghHiROpQ">Linux</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="QlyXmdYxCF">
                            <label for="QlyXmdYxCF">Bash</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="czNiHvROSA">
                    <label for="czNiHvROSA">Oauth</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="nplctEWbLr">
                    <label for="nplctEWbLr">Python</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="WbOAgCFCDt">
                            <label for="WbOAgCFCDt">Data Classes</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="SRqgWWdYoc">
                            <label for="SRqgWWdYoc">Libraries</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="jSuFJzjsqC">
                    <label for="jSuFJzjsqC">React</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="bUbEHIEgEO">
                    <label for="bUbEHIEgEO">Regular Expressions</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="dTnOBYzCrO">
                    <label for="dTnOBYzCrO">Rust</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="jOfbhgpNnk">
                            <label for="jOfbhgpNnk">Serde</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="raBPbnEeYS">
                    <label for="raBPbnEeYS">Vim</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="CzYuGcLKnw">
                    <label for="CzYuGcLKnw">Web</label>
                    <ul>
