...
<ul>
    <div name="contents-index">
        ...
        <l>
            <input type="checkbox" id="YcdWVkuElt" checked>
            <label for="YcdWVkuElt">Math</label>
            <ul>
                <l>
                    <input type="checkbox" id="VPivIDNAiY">
                    <label for="VPivIDNAiY">Exponentials</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="VMmDbhJrtY">
                    <label for="VMmDbhJrtY">Linear Algebra</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="KMOHEQsjqK">
                    <label for="KMOHEQsjqK">Logarithms</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="bvaWRhGazP">
                    <label for="bvaWRhGazP">Sequences</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="aiChaUuyQo">
                    <label for="aiChaUuyQo">Single Variable Calculus</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="fMcGtAWtMb">
                    <label for="fMcGtAWtMb">Trigonometry</label>
                    <ul>
        ...
        <l>
            <input type="checkbox" id="smIwHRmevA" checked>
            <label for="smIwHRmevA">Programming</label>
            <ul>
                <l>
                    <input type="checkbox" id="xZpLQOBway">
                    <label for="xZpLQOBway">Ansible</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="nJgPlPciAi">
                    <label for="nJgPlPciAi">Architecture</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="daIBgPgBDw">
                    <label for="daIBgPgBDw">Computer Graphics</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="LARVMeBcoa">
                    <label for="LARVMeBcoa">Databases</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="XSdBEhPWwM">
                    <label for="XSdBEhPWwM">Devops</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="zvZJxxHRsp">
                            <label for="zvZJxxHRsp">Cloud Computing</label>
                            <ul>
                                <l>
                                    <input type="checkbox" id="HaeLJPMJmz">
                                    <label for="HaeLJPMJmz">AWS</label>
                                    <ul>
                                        <l>
                                            <input type="checkbox" id="nHkPnBbomB">
                                            <label for="nHkPnBbomB">Cli</label>
                                            <ul>
                                        ...
                                        <l>
                                            <input type="checkbox" id="aiVYTBkcob">
                                            <label for="aiVYTBkcob">Dotnet</label>
                                            <ul>
                                        ...
                                        <l>
                                            <input type="checkbox" id="PIPJbsgcMo">
                                            <label for="PIPJbsgcMo">Ec 2</label>
                                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="eYuktbvTcR">
                            <label for="eYuktbvTcR">Events</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="dzmRvXYCup">
                            <label for="dzmRvXYCup">Oauth</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="FaILJfWJzw">
                            <label for="FaILJfWJzw">Pulumi</label>
                            <ul>
                                <l>
                                    <input type="checkbox" id="QWrHMJBUal">
                                    <label for="QWrHMJBUal">Dotnet</label>
                                    <ul>
                        ...
                        <l>
                            <input type="checkbox" id="OeQXEcYQFS">
                            <label for="OeQXEcYQFS">Terraform</label>
                            <ul>
                                <l>
                                    <input type="checkbox" id="JCspCouYGD">
                                    <label for="JCspCouYGD">Functions</label>
                                    <ul>
                                ...
                                <l>
                                    <input type="checkbox" id="JShwGZXGsO">
                                    <label for="JShwGZXGsO">Meta Arguments</label>
                                    <ul>
                ...
                <l>
                    <input type="checkbox" id="KNTEgoIwIP">
                    <label for="KNTEgoIwIP">Docker</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="EwONKMougr">
                    <label for="EwONKMougr">Dotnet</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="STEiXqwiNy">
                            <label for="STEiXqwiNy">Cli</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="zDxaApMkuC">
                    <label for="zDxaApMkuC">Functional Programming</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="hFqIoVOshc">
                    <label for="hFqIoVOshc">Git</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="OHTeQZPvsj">
                            <label for="OHTeQZPvsj">Github</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="vvrLWrFIUd">
                    <label for="vvrLWrFIUd">Go</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="zxBBwRFkaC">
                    <label for="zxBBwRFkaC">Haskell</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="ZuCFHcyRIg">
                    <label for="ZuCFHcyRIg">Js</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="YbxlaxrGii">
                            <label for="YbxlaxrGii">Node</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="mFzKwzNRJb">
                            <label for="mFzKwzNRJb">D3</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="xUPzHiQQWY">
                            <label for="xUPzHiQQWY">Mocha</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="MwcKrwHrTI">
                            <label for="MwcKrwHrTI">P5js</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="JuTkQwZAqV">
                            <label for="JuTkQwZAqV">Typescript</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="jcMzmHhvzD">
                    <label for="jcMzmHhvzD">Kafka</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="OrHVpLXdMz">
                    <label for="OrHVpLXdMz">Kubernetes</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="ekhIcWfxXz">
                    <label for="ekhIcWfxXz">Language</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="vyiFrcrLnp">
                    <label for="vyiFrcrLnp">Linux</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="KdeLkYwmJW">
                    <label for="KdeLkYwmJW">Python</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="slIurbbRNb">
                            <label for="slIurbbRNb">Data Classes</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="BrwhTbBhSj">
                            <label for="BrwhTbBhSj">Libraries</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="ZTHEOmoaDv">
                    <label for="ZTHEOmoaDv">React</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="CvzopePmrI">
                    <label for="CvzopePmrI">Regular Expressions</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="DvXXORghzw">
                    <label for="DvXXORghzw">Rust</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="TrzxwguqIO">
                            <label for="TrzxwguqIO">Serde</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="yEyCUwcCEI">
                    <label for="yEyCUwcCEI">Vim</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="aSGtCPlVvA">
                    <label for="aSGtCPlVvA">Web</label>
                    <ul>
