...
<ul>
    <div name="contents-index">
        ...
        <l>
            <input type="checkbox" id="hbflPZhSfD" checked>
            <label for="hbflPZhSfD">Math</label>
            <ul>
                <l>
                    <input type="checkbox" id="eTSwDwIgPF">
                    <label for="eTSwDwIgPF">Exponentials</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="zmUHDRcyka">
                    <label for="zmUHDRcyka">Linear Algebra</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="jstvlZbiod">
                    <label for="jstvlZbiod">Logarithms</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="gegYrhgukW">
                    <label for="gegYrhgukW">Sequences</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="ozGHrJBqJN">
                    <label for="ozGHrJBqJN">Single Variable Calculus</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="crkEaWHLIl">
                    <label for="crkEaWHLIl">Trigonometry</label>
                    <ul>
        ...
        <l>
            <input type="checkbox" id="ZMbQPoKyzM" checked>
            <label for="ZMbQPoKyzM">Programming</label>
            <ul>
                <l>
                    <input type="checkbox" id="efcLUsCdEC">
                    <label for="efcLUsCdEC">Ansible</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="FueytvxVjR">
                    <label for="FueytvxVjR">Architecture</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="XztAtSlzxh">
                    <label for="XztAtSlzxh">Computer Graphics</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="SojziyNGho">
                    <label for="SojziyNGho">Databases</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="jdAgpJUMnE">
                    <label for="jdAgpJUMnE">Devops</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="vqafMhMvKD">
                            <label for="vqafMhMvKD">Cloud Providers</label>
                            <ul>
                                <l>
                                    <input type="checkbox" id="hwVNjMPmAo">
                                    <label for="hwVNjMPmAo">AWS</label>
                                    <ul>
                                        <l>
                                            <input type="checkbox" id="uvJJYKhhsT">
                                            <label for="uvJJYKhhsT">Cli</label>
                                            <ul>
                                        ...
                                        <l>
                                            <input type="checkbox" id="lKxtGOLWwV">
                                            <label for="lKxtGOLWwV">Dotnet</label>
                                            <ul>
                                        ...
                                        <l>
                                            <input type="checkbox" id="ETizsHvktQ">
                                            <label for="ETizsHvktQ">Ec 2</label>
                                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="mhzjebRuXE">
                            <label for="mhzjebRuXE">Events</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="FKAhreqamw">
                            <label for="FKAhreqamw">Localstack</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="OyzrQubSWO">
                            <label for="OyzrQubSWO">Pulumi</label>
                            <ul>
                                <l>
                                    <input type="checkbox" id="gARNFiByWj">
                                    <label for="gARNFiByWj">Dotnet</label>
                                    <ul>
                        ...
                        <l>
                            <input type="checkbox" id="MzRSAqlnjN">
                            <label for="MzRSAqlnjN">Serverless Framework</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="pXhtXGKEsw">
                            <label for="pXhtXGKEsw">Terraform</label>
                            <ul>
                                <l>
                                    <input type="checkbox" id="pkMuOhCyxW">
                                    <label for="pkMuOhCyxW">Functions</label>
                                    <ul>
                                ...
                                <l>
                                    <input type="checkbox" id="psqgILrfPI">
                                    <label for="psqgILrfPI">Meta Arguments</label>
                                    <ul>
                ...
                <l>
                    <input type="checkbox" id="ReuJPYeCmE">
                    <label for="ReuJPYeCmE">Docker</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="DSJvgHbjjV">
                    <label for="DSJvgHbjjV">Dotnet</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="cbVdTDMEuE">
                            <label for="cbVdTDMEuE">Cli</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="dVugOWnZGy">
                    <label for="dVugOWnZGy">Functional Programming</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="QVvurYdoEc">
                    <label for="QVvurYdoEc">Git</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="TwDihwNnur">
                            <label for="TwDihwNnur">Github</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="TBkRwiWUWa">
                    <label for="TBkRwiWUWa">Go</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="lpLXfyXMPP">
                    <label for="lpLXfyXMPP">Haskell</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="yWJNhQnhPs">
                    <label for="yWJNhQnhPs">Js</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="xghrJTnfgJ">
                            <label for="xghrJTnfgJ">Node</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="gHfVzRalcm">
                            <label for="gHfVzRalcm">D3</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="eaFYHUMlTQ">
                            <label for="eaFYHUMlTQ">Mocha</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="uKaPnrpTxO">
                            <label for="uKaPnrpTxO">P5js</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="CLMzNgCbeG">
                            <label for="CLMzNgCbeG">Typescript</label>
                            <ul>
                                <l>
                                    <input type="checkbox" id="NlkNphyCaF">
                                    <label for="NlkNphyCaF">Testing</label>
                                    <ul>
                ...
                <l>
                    <input type="checkbox" id="MRWPbCnqKn">
                    <label for="MRWPbCnqKn">Kafka</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="GPxKdgpzjs">
                    <label for="GPxKdgpzjs">Kubernetes</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="lpLiYrVFGX">
                    <label for="lpLiYrVFGX">Language</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="GeDJnWgFTC">
                    <label for="GeDJnWgFTC">Linux</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="vXpjlZlXqy">
                            <label for="vXpjlZlXqy">Bash</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="ctafCTOpno">
                    <label for="ctafCTOpno">Oauth</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="PAjsiPribh">
                    <label for="PAjsiPribh">Python</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="UiCvGLBrTH">
                            <label for="UiCvGLBrTH">Data Classes</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="ggumDndacX">
                            <label for="ggumDndacX">Libraries</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="dLxoybznmD">
                    <label for="dLxoybznmD">React</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="rKcwVXfsEN">
                    <label for="rKcwVXfsEN">Regular Expressions</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="WiFLjbteUQ">
                    <label for="WiFLjbteUQ">Rust</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="nxDVjyVYlR">
                            <label for="nxDVjyVYlR">Serde</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="cpMJSINIua">
                    <label for="cpMJSINIua">Vim</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="LvLqFLntom">
                    <label for="LvLqFLntom">Web</label>
                    <ul>
