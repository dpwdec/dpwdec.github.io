...
<ul>
    <div name="contents-index">
        ...
        <l>
            <input type="checkbox" id="FYHYybwrEh" checked>
            <label for="FYHYybwrEh">Math</label>
            <ul>
                <l>
                    <input type="checkbox" id="zMDkjEabsD">
                    <label for="zMDkjEabsD">Exponentials</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="KtFiTOrvhq">
                    <label for="KtFiTOrvhq">Linear Algebra</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="YUZNpXsTfL">
                    <label for="YUZNpXsTfL">Logarithms</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="uhPWhOaahS">
                    <label for="uhPWhOaahS">Sequences</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="LpNAWXOmyB">
                    <label for="LpNAWXOmyB">Single Variable Calculus</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="WXNfMXMTjf">
                    <label for="WXNfMXMTjf">Trigonometry</label>
                    <ul>
        ...
        <l>
            <input type="checkbox" id="tbcojGlsMu" checked>
            <label for="tbcojGlsMu">Programming</label>
            <ul>
                <l>
                    <input type="checkbox" id="IISBKkJJge">
                    <label for="IISBKkJJge">Ansible</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="suIOoENeHz">
                    <label for="suIOoENeHz">Architecture</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="MMIBFjPhkV">
                    <label for="MMIBFjPhkV">Computer Graphics</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="OVfdrcVcyH">
                    <label for="OVfdrcVcyH">Databases</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="WyvuWAQQGD">
                    <label for="WyvuWAQQGD">Devops</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="bNjPgMwFbC">
                            <label for="bNjPgMwFbC">Cloud Providers</label>
                            <ul>
                                <l>
                                    <input type="checkbox" id="nppGPghTAb">
                                    <label for="nppGPghTAb">AWS</label>
                                    <ul>
                                        <l>
                                            <input type="checkbox" id="nHgtBntVab">
                                            <label for="nHgtBntVab">Cli</label>
                                            <ul>
                                        ...
                                        <l>
                                            <input type="checkbox" id="igRLtleqzO">
                                            <label for="igRLtleqzO">Dotnet</label>
                                            <ul>
                                        ...
                                        <l>
                                            <input type="checkbox" id="pOehBnmdbj">
                                            <label for="pOehBnmdbj">Ec 2</label>
                                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="KfMbLIGNmZ">
                            <label for="KfMbLIGNmZ">Events</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="UPiwgSaiqi">
                            <label for="UPiwgSaiqi">Localstack</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="FofjmCIlUr">
                            <label for="FofjmCIlUr">Pulumi</label>
                            <ul>
                                <l>
                                    <input type="checkbox" id="EHkDlMiPOr">
                                    <label for="EHkDlMiPOr">Dotnet</label>
                                    <ul>
                        ...
                        <l>
                            <input type="checkbox" id="NyoKrgSewf">
                            <label for="NyoKrgSewf">Serverless Framework</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="yBTPAlabyn">
                            <label for="yBTPAlabyn">Terraform</label>
                            <ul>
                                <l>
                                    <input type="checkbox" id="pjZArXrZYx">
                                    <label for="pjZArXrZYx">Functions</label>
                                    <ul>
                                ...
                                <l>
                                    <input type="checkbox" id="mBlWtLJRbx">
                                    <label for="mBlWtLJRbx">Meta Arguments</label>
                                    <ul>
                ...
                <l>
                    <input type="checkbox" id="CsjJHPsEHR">
                    <label for="CsjJHPsEHR">Docker</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="fTrLrLrNKA">
                    <label for="fTrLrLrNKA">Dotnet</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="CHoAlhbJXR">
                            <label for="CHoAlhbJXR">Cli</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="ERCNDJckAA">
                    <label for="ERCNDJckAA">Functional Programming</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="RSiEizUkCY">
                    <label for="RSiEizUkCY">Git</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="xnBMhOFuVL">
                            <label for="xnBMhOFuVL">Github</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="fSVuoqCzPm">
                    <label for="fSVuoqCzPm">Go</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="MyzGoKOuvG">
                    <label for="MyzGoKOuvG">Haskell</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="RIDLSnwPtL">
                    <label for="RIDLSnwPtL">Js</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="itNDLrInlR">
                            <label for="itNDLrInlR">Node</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="oajQXxfqyi">
                            <label for="oajQXxfqyi">D3</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="OzzfWnJzMh">
                            <label for="OzzfWnJzMh">Mocha</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="pCElNjrmYa">
                            <label for="pCElNjrmYa">P5js</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="YbvzCrjahX">
                            <label for="YbvzCrjahX">Typescript</label>
                            <ul>
                                <l>
                                    <input type="checkbox" id="ugPhZLjZML">
                                    <label for="ugPhZLjZML">Testing</label>
                                    <ul>
                ...
                <l>
                    <input type="checkbox" id="TKenAVxRoZ">
                    <label for="TKenAVxRoZ">Kafka</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="MamPayKhvJ">
                    <label for="MamPayKhvJ">Kubernetes</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="GQATuEFxTD">
                    <label for="GQATuEFxTD">Language</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="gAPHaPPKMi">
                    <label for="gAPHaPPKMi">Linux</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="LDJFokIOpy">
                            <label for="LDJFokIOpy">Bash</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="tHvDbIglGF">
                    <label for="tHvDbIglGF">Oauth</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="rfQQwOMKNO">
                    <label for="rfQQwOMKNO">Python</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="UZcaYtnqxb">
                            <label for="UZcaYtnqxb">Data Classes</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="vSfAVaweZd">
                            <label for="vSfAVaweZd">Libraries</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="aDduqhyufg">
                    <label for="aDduqhyufg">React</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="yhpomVGMcR">
                    <label for="yhpomVGMcR">Regular Expressions</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="VpsFrMJVkS">
                    <label for="VpsFrMJVkS">Rust</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="gnWIsmuzCf">
                            <label for="gnWIsmuzCf">Serde</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="FDSyuImVgQ">
                    <label for="FDSyuImVgQ">Vim</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="vOxWurPqth">
                    <label for="vOxWurPqth">Web</label>
                    <ul>
