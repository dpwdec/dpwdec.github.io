...
<ul>
    <div name="contents-index">
        ...
        <l>
            <input type="checkbox" id="KODsXHosTL" checked>
            <label for="KODsXHosTL">Math</label>
            <ul>
                <l>
                    <input type="checkbox" id="vdHyEFJICv">
                    <label for="vdHyEFJICv">Exponentials</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="PixkGtjZQB">
                    <label for="PixkGtjZQB">Linear Algebra</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="JnjDXqehaP">
                    <label for="JnjDXqehaP">Logarithms</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="CEtDydAZhb">
                    <label for="CEtDydAZhb">Sequences</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="hQnWmSUrza">
                    <label for="hQnWmSUrza">Single Variable Calculus</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="HklWPEfflZ">
                    <label for="HklWPEfflZ">Trigonometry</label>
                    <ul>
        ...
        <l>
            <input type="checkbox" id="ZpzxuNgavX" checked>
            <label for="ZpzxuNgavX">Programming</label>
            <ul>
                <l>
                    <input type="checkbox" id="YtAFkLiASb">
                    <label for="YtAFkLiASb">Ansible</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="PPAXXJmcTw">
                    <label for="PPAXXJmcTw">Architecture</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="EEejLDDbSj">
                    <label for="EEejLDDbSj">Computer Graphics</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="dpWnzkEyiC">
                    <label for="dpWnzkEyiC">Databases</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="nhoiFJLlvJ">
                    <label for="nhoiFJLlvJ">Devops</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="QQUTkhlpan">
                            <label for="QQUTkhlpan">Cloud Providers</label>
                            <ul>
                                <l>
                                    <input type="checkbox" id="MrHMGzAwOC">
                                    <label for="MrHMGzAwOC">AWS</label>
                                    <ul>
                                        <l>
                                            <input type="checkbox" id="lEKzRCUvyH">
                                            <label for="lEKzRCUvyH">Cli</label>
                                            <ul>
                                        ...
                                        <l>
                                            <input type="checkbox" id="wTZtFGsUMb">
                                            <label for="wTZtFGsUMb">Dotnet</label>
                                            <ul>
                                        ...
                                        <l>
                                            <input type="checkbox" id="ViRpMIDEFd">
                                            <label for="ViRpMIDEFd">Ec 2</label>
                                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="hTVabYjCdf">
                            <label for="hTVabYjCdf">Events</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="yvtJBjNEmI">
                            <label for="yvtJBjNEmI">Localstack</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="nYrUAcvtxO">
                            <label for="nYrUAcvtxO">Pulumi</label>
                            <ul>
                                <l>
                                    <input type="checkbox" id="PHHuuwWpLp">
                                    <label for="PHHuuwWpLp">Dotnet</label>
                                    <ul>
                        ...
                        <l>
                            <input type="checkbox" id="haDEVRhoaP">
                            <label for="haDEVRhoaP">Serverless Framework</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="rDLKIVsvbg">
                            <label for="rDLKIVsvbg">Terraform</label>
                            <ul>
                                <l>
                                    <input type="checkbox" id="noaCpGxmjQ">
                                    <label for="noaCpGxmjQ">Functions</label>
                                    <ul>
                                ...
                                <l>
                                    <input type="checkbox" id="EZQgXnatgt">
                                    <label for="EZQgXnatgt">Meta Arguments</label>
                                    <ul>
                ...
                <l>
                    <input type="checkbox" id="QSPgcqHuxE">
                    <label for="QSPgcqHuxE">Docker</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="ZczAmvDSmk">
                    <label for="ZczAmvDSmk">Dotnet</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="kguQQppvkL">
                            <label for="kguQQppvkL">Cli</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="TGnFlXVPLO">
                    <label for="TGnFlXVPLO">Functional Programming</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="QbYYqAcDoP">
                    <label for="QbYYqAcDoP">Git</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="ioXatuXIHq">
                            <label for="ioXatuXIHq">Github</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="yPnopDnpjV">
                    <label for="yPnopDnpjV">Go</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="QlamYUaSff">
                    <label for="QlamYUaSff">Haskell</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="FpSKcqFjpj">
                    <label for="FpSKcqFjpj">Js</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="PVcQMYnwwZ">
                            <label for="PVcQMYnwwZ">Node</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="UqgGYVPTwa">
                            <label for="UqgGYVPTwa">D3</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="bdcQyXNZJc">
                            <label for="bdcQyXNZJc">Mocha</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="XxeiwJIWMk">
                            <label for="XxeiwJIWMk">P5js</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="hwCdUFVPFO">
                            <label for="hwCdUFVPFO">Typescript</label>
                            <ul>
                                <l>
                                    <input type="checkbox" id="uAdrLypvFW">
                                    <label for="uAdrLypvFW">Testing</label>
                                    <ul>
                ...
                <l>
                    <input type="checkbox" id="cDnlhlHdcP">
                    <label for="cDnlhlHdcP">Kafka</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="knyqaQeKVu">
                    <label for="knyqaQeKVu">Kubernetes</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="zWjMSdusTe">
                    <label for="zWjMSdusTe">Language</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="YjnKFgjCow">
                    <label for="YjnKFgjCow">Linux</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="icgvuyJLSD">
                            <label for="icgvuyJLSD">Bash</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="ZeySBwONoe">
                    <label for="ZeySBwONoe">Oauth</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="kifywoiBoz">
                    <label for="kifywoiBoz">Prometheus</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="rVaoKCbcah">
                    <label for="rVaoKCbcah">Python</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="KMCGpQeYAf">
                            <label for="KMCGpQeYAf">Data Classes</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="OMOisuMHMD">
                            <label for="OMOisuMHMD">Libraries</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="IvZoHkzvPh">
                    <label for="IvZoHkzvPh">React</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="gJAwSMFQpH">
                    <label for="gJAwSMFQpH">Regular Expressions</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="DoXwXToHFb">
                    <label for="DoXwXToHFb">Rust</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="TwSLcHNyeE">
                            <label for="TwSLcHNyeE">Serde</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="MRgetAgJrM">
                    <label for="MRgetAgJrM">Shaders</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="rWisBGVEjS">
                            <label for="rWisBGVEjS">Glsl</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="YIKJaxUQIh">
                    <label for="YIKJaxUQIh">Vim</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="WGFIFAyoPn">
                    <label for="WGFIFAyoPn">Web</label>
                    <ul>
