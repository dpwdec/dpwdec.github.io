...
<ul>
    <div name="contents-index">
        ...
        <l>
            <input type="checkbox" id="lgZFVsNeos" checked>
            <label for="lgZFVsNeos">Math</label>
            <ul>
                <l>
                    <input type="checkbox" id="ZMlFgwTnGA">
                    <label for="ZMlFgwTnGA">Exponentials</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="pAIlmFuvxY">
                    <label for="pAIlmFuvxY">Linear Algebra</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="mvoJseXqCq">
                    <label for="mvoJseXqCq">Logarithms</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="rjWrltHCtw">
                    <label for="rjWrltHCtw">Sequences</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="TJCeMmvCEB">
                    <label for="TJCeMmvCEB">Single Variable Calculus</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="kyUYWGKQMV">
                    <label for="kyUYWGKQMV">Trigonometry</label>
                    <ul>
        ...
        <l>
            <input type="checkbox" id="VXjlFJgFVC" checked>
            <label for="VXjlFJgFVC">Programming</label>
            <ul>
                <l>
                    <input type="checkbox" id="ppxnzhDjFd">
                    <label for="ppxnzhDjFd">Ansible</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="CqoGJwaSjJ">
                    <label for="CqoGJwaSjJ">Architecture</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="szsfWvQesy">
                    <label for="szsfWvQesy">Computer Graphics</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="zsYaylGJsK">
                    <label for="zsYaylGJsK">Databases</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="mminIOabXj">
                    <label for="mminIOabXj">Devops</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="ydCoxmWQLS">
                            <label for="ydCoxmWQLS">Cloud Providers</label>
                            <ul>
                                <l>
                                    <input type="checkbox" id="lmBgCkniky">
                                    <label for="lmBgCkniky">AWS</label>
                                    <ul>
                                        <l>
                                            <input type="checkbox" id="CRFzYtvuGt">
                                            <label for="CRFzYtvuGt">Cli</label>
                                            <ul>
                                        ...
                                        <l>
                                            <input type="checkbox" id="ueoNvhOZxV">
                                            <label for="ueoNvhOZxV">Dotnet</label>
                                            <ul>
                                        ...
                                        <l>
                                            <input type="checkbox" id="IotFwRjGJT">
                                            <label for="IotFwRjGJT">Ec 2</label>
                                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="lGxoLkvbvL">
                            <label for="lGxoLkvbvL">Events</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="zsXgQLwadP">
                            <label for="zsXgQLwadP">Localstack</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="pRpAgixGbV">
                            <label for="pRpAgixGbV">Pulumi</label>
                            <ul>
                                <l>
                                    <input type="checkbox" id="fSwIbfHGDl">
                                    <label for="fSwIbfHGDl">Dotnet</label>
                                    <ul>
                        ...
                        <l>
                            <input type="checkbox" id="vZpkevzaNr">
                            <label for="vZpkevzaNr">Serverless Framework</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="BGyKoPralv">
                            <label for="BGyKoPralv">Terraform</label>
                            <ul>
                                <l>
                                    <input type="checkbox" id="SbMijPuPHo">
                                    <label for="SbMijPuPHo">Functions</label>
                                    <ul>
                                ...
                                <l>
                                    <input type="checkbox" id="QtHIuqvDzD">
                                    <label for="QtHIuqvDzD">Meta Arguments</label>
                                    <ul>
                ...
                <l>
                    <input type="checkbox" id="zDkGrluCjR">
                    <label for="zDkGrluCjR">Docker</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="DUUESmmfSt">
                    <label for="DUUESmmfSt">Dotnet</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="cqJDvanamb">
                            <label for="cqJDvanamb">Cli</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="kkxFVMJPyE">
                    <label for="kkxFVMJPyE">Functional Programming</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="mKvagSRRKp">
                    <label for="mKvagSRRKp">Git</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="IDFGmmsWxM">
                            <label for="IDFGmmsWxM">Github</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="ENMPcDBXxd">
                    <label for="ENMPcDBXxd">Go</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="urUXQIClwd">
                    <label for="urUXQIClwd">Haskell</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="XDjzBblxZG">
                    <label for="XDjzBblxZG">Js</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="EWcoRfbQdh">
                            <label for="EWcoRfbQdh">Node</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="csOyyLIWWm">
                            <label for="csOyyLIWWm">D3</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="CqhtphMPUQ">
                            <label for="CqhtphMPUQ">Mocha</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="tjARevowNK">
                            <label for="tjARevowNK">P5js</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="KlFUxVBbCl">
                            <label for="KlFUxVBbCl">Typescript</label>
                            <ul>
                                <l>
                                    <input type="checkbox" id="zkcZfNiAPt">
                                    <label for="zkcZfNiAPt">Testing</label>
                                    <ul>
                ...
                <l>
                    <input type="checkbox" id="kVrlQYyBme">
                    <label for="kVrlQYyBme">Kafka</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="qkhvrOyjzK">
                    <label for="qkhvrOyjzK">Kubernetes</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="lrGrZOqVUx">
                    <label for="lrGrZOqVUx">Language</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="fAJYEWTCUH">
                    <label for="fAJYEWTCUH">Linux</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="fGQtjsiLsl">
                            <label for="fGQtjsiLsl">Bash</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="VuLjQXbyRI">
                    <label for="VuLjQXbyRI">Oauth</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="JPxvlSEehw">
                    <label for="JPxvlSEehw">Prometheus</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="uKaadpOofM">
                    <label for="uKaadpOofM">Python</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="WDUhgNemor">
                            <label for="WDUhgNemor">Data Classes</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="JPSAHxnEEh">
                            <label for="JPSAHxnEEh">Libraries</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="vCNniRMdhs">
                    <label for="vCNniRMdhs">React</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="ViDmBLQRdu">
                    <label for="ViDmBLQRdu">Regular Expressions</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="qFibLIVyAM">
                    <label for="qFibLIVyAM">Rust</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="KiMsDCrHKR">
                            <label for="KiMsDCrHKR">Serde</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="AnDoQEDIGQ">
                    <label for="AnDoQEDIGQ">Shaders</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="BjLxcogTxm">
                            <label for="BjLxcogTxm">Glsl</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="KnxIsKBuGA">
                    <label for="KnxIsKBuGA">Vim</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="dWYJLFUFDp">
                    <label for="dWYJLFUFDp">Web</label>
                    <ul>
