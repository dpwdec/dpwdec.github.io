...
<ul>
    <div name="contents-index">
        ...
        <l>
            <input type="checkbox" id="TDScwDIdsh" checked>
            <label for="TDScwDIdsh">Math</label>
            <ul>
                <l>
                    <input type="checkbox" id="DtkGQMkynF">
                    <label for="DtkGQMkynF">Exponentials</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="owyFRJVFHx">
                    <label for="owyFRJVFHx">Linear Algebra</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="kMlgeVaOSr">
                    <label for="kMlgeVaOSr">Logarithms</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="JKUMKjUogM">
                    <label for="JKUMKjUogM">Sequences</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="FaCTskxnKc">
                    <label for="FaCTskxnKc">Single Variable Calculus</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="LoGMDDLquG">
                    <label for="LoGMDDLquG">Trigonometry</label>
                    <ul>
        ...
        <l>
            <input type="checkbox" id="eSiWjANwIV" checked>
            <label for="eSiWjANwIV">Programming</label>
            <ul>
                <l>
                    <input type="checkbox" id="fzQQSwvicZ">
                    <label for="fzQQSwvicZ">Ansible</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="wQaeAfSfuW">
                    <label for="wQaeAfSfuW">Architecture</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="ZMPIVboBtm">
                    <label for="ZMPIVboBtm">Computer Graphics</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="ECjAodFWPv">
                    <label for="ECjAodFWPv">Databases</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="EOgVBzSknQ">
                    <label for="EOgVBzSknQ">Devops</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="LXGfvtCeXR">
                            <label for="LXGfvtCeXR">Cloud Providers</label>
                            <ul>
                                <l>
                                    <input type="checkbox" id="OLZyTHmZDr">
                                    <label for="OLZyTHmZDr">AWS</label>
                                    <ul>
                                        <l>
                                            <input type="checkbox" id="fXfqSspGzo">
                                            <label for="fXfqSspGzo">Cli</label>
                                            <ul>
                                        ...
                                        <l>
                                            <input type="checkbox" id="rPqaawnguS">
                                            <label for="rPqaawnguS">Dotnet</label>
                                            <ul>
                                        ...
                                        <l>
                                            <input type="checkbox" id="yEkzaqKgBu">
                                            <label for="yEkzaqKgBu">Ec 2</label>
                                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="piIFjtgpSW">
                            <label for="piIFjtgpSW">Events</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="ZmJYAXnhlF">
                            <label for="ZmJYAXnhlF">Localstack</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="SNWRxRUlOS">
                            <label for="SNWRxRUlOS">Pulumi</label>
                            <ul>
                                <l>
                                    <input type="checkbox" id="nZIJzqSjlE">
                                    <label for="nZIJzqSjlE">Dotnet</label>
                                    <ul>
                        ...
                        <l>
                            <input type="checkbox" id="cxzbkKxaTX">
                            <label for="cxzbkKxaTX">Serverless Framework</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="dDSoVnblaV">
                            <label for="dDSoVnblaV">Terraform</label>
                            <ul>
                                <l>
                                    <input type="checkbox" id="bMasCiLxDV">
                                    <label for="bMasCiLxDV">Functions</label>
                                    <ul>
                                ...
                                <l>
                                    <input type="checkbox" id="WrnaNwfEUQ">
                                    <label for="WrnaNwfEUQ">Meta Arguments</label>
                                    <ul>
                ...
                <l>
                    <input type="checkbox" id="MrChAiQSXr">
                    <label for="MrChAiQSXr">Docker</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="lyVXWbgjvc">
                    <label for="lyVXWbgjvc">Dotnet</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="tqJBRxljkm">
                            <label for="tqJBRxljkm">Cli</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="KecPwnWMlp">
                    <label for="KecPwnWMlp">Functional Programming</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="giquSxdUIp">
                    <label for="giquSxdUIp">Git</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="XPkwqLZCHR">
                            <label for="XPkwqLZCHR">Github</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="DUhEyFhwPr">
                    <label for="DUhEyFhwPr">Go</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="yMxjvhkoAf">
                    <label for="yMxjvhkoAf">Haskell</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="iDLojGDAtP">
                    <label for="iDLojGDAtP">Js</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="zXasoOzUtC">
                            <label for="zXasoOzUtC">Node</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="JzSeDeQXAW">
                            <label for="JzSeDeQXAW">D3</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="OMSXlcvjlR">
                            <label for="OMSXlcvjlR">Mocha</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="KdRjxWvLcw">
                            <label for="KdRjxWvLcw">P5js</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="giydYKwXOs">
                            <label for="giydYKwXOs">Typescript</label>
                            <ul>
                                <l>
                                    <input type="checkbox" id="UGqTdetnHJ">
                                    <label for="UGqTdetnHJ">Testing</label>
                                    <ul>
                ...
                <l>
                    <input type="checkbox" id="GrfzzYtigV">
                    <label for="GrfzzYtigV">Kafka</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="QeYQLgacWx">
                    <label for="QeYQLgacWx">Kubernetes</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="cvPmxAMcRD">
                    <label for="cvPmxAMcRD">Language</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="eerPrbhyon">
                    <label for="eerPrbhyon">Linux</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="CotWNVZEbF">
                            <label for="CotWNVZEbF">Bash</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="qOupIRFiOG">
                    <label for="qOupIRFiOG">Oauth</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="uIXDAFCeEV">
                    <label for="uIXDAFCeEV">Python</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="rjLPhUNDMS">
                            <label for="rjLPhUNDMS">Data Classes</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="iucITHpymD">
                            <label for="iucITHpymD">Libraries</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="PPZlwmIhrV">
                    <label for="PPZlwmIhrV">React</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="WXeKVqtusy">
                    <label for="WXeKVqtusy">Regular Expressions</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="vWAAUIztHZ">
                    <label for="vWAAUIztHZ">Rust</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="OMaqQiEOQd">
                            <label for="OMaqQiEOQd">Serde</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="uzUgxPzhID">
                    <label for="uzUgxPzhID">Vim</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="YeCfxyQJPl">
                    <label for="YeCfxyQJPl">Web</label>
                    <ul>
