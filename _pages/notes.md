...
<ul>
    <div name="contents-index">
        ...
        <l>
            <input type="checkbox" id="VtBbUOMjWY" checked>
            <label for="VtBbUOMjWY">Math</label>
            <ul>
                <l>
                    <input type="checkbox" id="DSCkWzBfEc">
                    <label for="DSCkWzBfEc">Exponentials</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="LKeAvEAuls">
                    <label for="LKeAvEAuls">Linear Algebra</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="lXACKMxNCe">
                    <label for="lXACKMxNCe">Logarithms</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="fELnpuhRWH">
                    <label for="fELnpuhRWH">Sequences</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="OADHhEcDcV">
                    <label for="OADHhEcDcV">Single Variable Calculus</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="zTBtvpEGMP">
                    <label for="zTBtvpEGMP">Trigonometry</label>
                    <ul>
        ...
        <l>
            <input type="checkbox" id="YvSHohUVvo" checked>
            <label for="YvSHohUVvo">Programming</label>
            <ul>
                <l>
                    <input type="checkbox" id="GXHvxRAJje">
                    <label for="GXHvxRAJje">Ansible</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="RyFxigFouY">
                    <label for="RyFxigFouY">Architecture</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="DQrdgsDaZk">
                    <label for="DQrdgsDaZk">Computer Graphics</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="XlxWGRrkKW">
                    <label for="XlxWGRrkKW">Databases</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="Lqlklynqqd">
                    <label for="Lqlklynqqd">Devops</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="rpzjXZmfma">
                            <label for="rpzjXZmfma">Cloud Providers</label>
                            <ul>
                                <l>
                                    <input type="checkbox" id="puIwBVVBqj">
                                    <label for="puIwBVVBqj">AWS</label>
                                    <ul>
                                        <l>
                                            <input type="checkbox" id="uZhMjnEyLX">
                                            <label for="uZhMjnEyLX">Cli</label>
                                            <ul>
                                        ...
                                        <l>
                                            <input type="checkbox" id="uHaTKZBLrj">
                                            <label for="uHaTKZBLrj">Dotnet</label>
                                            <ul>
                                        ...
                                        <l>
                                            <input type="checkbox" id="wOwAsOjLwy">
                                            <label for="wOwAsOjLwy">Ec 2</label>
                                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="LhAmWpBJGZ">
                            <label for="LhAmWpBJGZ">Events</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="DBAmDQtuVA">
                            <label for="DBAmDQtuVA">Localstack</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="piQElzxTbA">
                            <label for="piQElzxTbA">Pulumi</label>
                            <ul>
                                <l>
                                    <input type="checkbox" id="csmFKbAylV">
                                    <label for="csmFKbAylV">Dotnet</label>
                                    <ul>
                        ...
                        <l>
                            <input type="checkbox" id="EtpLiqowsA">
                            <label for="EtpLiqowsA">Serverless Framework</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="fxpnNUSGnz">
                            <label for="fxpnNUSGnz">Terraform</label>
                            <ul>
                                <l>
                                    <input type="checkbox" id="WGCNbRQDWv">
                                    <label for="WGCNbRQDWv">Functions</label>
                                    <ul>
                                ...
                                <l>
                                    <input type="checkbox" id="dzVTDhSPgv">
                                    <label for="dzVTDhSPgv">Meta Arguments</label>
                                    <ul>
                ...
                <l>
                    <input type="checkbox" id="UyAofcQrvg">
                    <label for="UyAofcQrvg">Docker</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="ZxoAMmaBTW">
                    <label for="ZxoAMmaBTW">Dotnet</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="ULZHFkfLEq">
                            <label for="ULZHFkfLEq">Cli</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="mAfJEPrbeU">
                    <label for="mAfJEPrbeU">Functional Programming</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="wHmramNhAt">
                    <label for="wHmramNhAt">Git</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="KOuieuAPmk">
                            <label for="KOuieuAPmk">Github</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="txfaxsYsBp">
                    <label for="txfaxsYsBp">Go</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="ERhyeMxKaF">
                    <label for="ERhyeMxKaF">Haskell</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="lwHbUAwHpu">
                    <label for="lwHbUAwHpu">Js</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="KYjywgknYG">
                            <label for="KYjywgknYG">Node</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="WiAKQeUXDy">
                            <label for="WiAKQeUXDy">D3</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="YEcJBBQzDz">
                            <label for="YEcJBBQzDz">Mocha</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="NmnVqatxAg">
                            <label for="NmnVqatxAg">P5js</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="eVagLDwJyA">
                            <label for="eVagLDwJyA">Typescript</label>
                            <ul>
                                <l>
                                    <input type="checkbox" id="UluUNyWBjX">
                                    <label for="UluUNyWBjX">Testing</label>
                                    <ul>
                ...
                <l>
                    <input type="checkbox" id="czmNjwGCKR">
                    <label for="czmNjwGCKR">Kafka</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="ZRpKdvMYmp">
                    <label for="ZRpKdvMYmp">Kubernetes</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="wxGqCQGJww">
                    <label for="wxGqCQGJww">Language</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="cQkYoBExrB">
                    <label for="cQkYoBExrB">Linux</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="WQOiKDvTvA">
                            <label for="WQOiKDvTvA">Bash</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="dDMLAURZfK">
                    <label for="dDMLAURZfK">Oauth</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="bQMMbUCBdH">
                    <label for="bQMMbUCBdH">Prometheus</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="hrnNodvnjY">
                    <label for="hrnNodvnjY">Python</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="PIbFnrTbWS">
                            <label for="PIbFnrTbWS">Data Classes</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="OulKZjWtZF">
                            <label for="OulKZjWtZF">Libraries</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="CkzmQIqYVf">
                    <label for="CkzmQIqYVf">React</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="DbDaVNoEgz">
                    <label for="DbDaVNoEgz">Regular Expressions</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="FQQcIlkiqK">
                    <label for="FQQcIlkiqK">Rust</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="gsfzLOzGVw">
                            <label for="gsfzLOzGVw">Serde</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="ggZVGuIbqO">
                    <label for="ggZVGuIbqO">Shaders</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="MaBaYfsebN">
                            <label for="MaBaYfsebN">Glsl</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="YORairNhgM">
                    <label for="YORairNhgM">Vim</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="zVrmaTmgBh">
                    <label for="zVrmaTmgBh">Web</label>
                    <ul>
