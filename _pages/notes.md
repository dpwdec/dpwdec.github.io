...
<ul>
    <div name="contents-index">
        ...
        <l>
            <input type="checkbox" id="TKMMczUyUH" checked>
            <label for="TKMMczUyUH">Math</label>
            <ul>
                <l>
                    <input type="checkbox" id="oQgeKBWmAO">
                    <label for="oQgeKBWmAO">Exponentials</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="AgOopZILhs">
                    <label for="AgOopZILhs">Linear Algebra</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="vWTWRkzKfT">
                    <label for="vWTWRkzKfT">Logarithms</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="fGBsOhHLEp">
                    <label for="fGBsOhHLEp">Sequences</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="xwWidejeOT">
                    <label for="xwWidejeOT">Single Variable Calculus</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="IcBsZmoyOd">
                    <label for="IcBsZmoyOd">Trigonometry</label>
                    <ul>
        ...
        <l>
            <input type="checkbox" id="DLVaTattkN" checked>
            <label for="DLVaTattkN">Programming</label>
            <ul>
                <l>
                    <input type="checkbox" id="FNbAwgEzXZ">
                    <label for="FNbAwgEzXZ">Ansible</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="TdhAFPAVVp">
                    <label for="TdhAFPAVVp">Architecture</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="rhyfNVTmXW">
                    <label for="rhyfNVTmXW">Computer Graphics</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="XIpWuTVHwP">
                    <label for="XIpWuTVHwP">Databases</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="NOxiPRiRGd">
                    <label for="NOxiPRiRGd">Devops</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="rVottOIlaN">
                            <label for="rVottOIlaN">Cloud Providers</label>
                            <ul>
                                <l>
                                    <input type="checkbox" id="bFbzlwqjhT">
                                    <label for="bFbzlwqjhT">AWS</label>
                                    <ul>
                                        <l>
                                            <input type="checkbox" id="iamfPbrRcN">
                                            <label for="iamfPbrRcN">Cli</label>
                                            <ul>
                                        ...
                                        <l>
                                            <input type="checkbox" id="mfpWtkQsSk">
                                            <label for="mfpWtkQsSk">Dotnet</label>
                                            <ul>
                                        ...
                                        <l>
                                            <input type="checkbox" id="ncAneQvoVI">
                                            <label for="ncAneQvoVI">Ec 2</label>
                                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="cOAqvAzhLQ">
                            <label for="cOAqvAzhLQ">Events</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="utqmjzGJbF">
                            <label for="utqmjzGJbF">Localstack</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="iznqHaOQSI">
                            <label for="iznqHaOQSI">Pulumi</label>
                            <ul>
                                <l>
                                    <input type="checkbox" id="eegjbEsHNn">
                                    <label for="eegjbEsHNn">Dotnet</label>
                                    <ul>
                        ...
                        <l>
                            <input type="checkbox" id="EDoMgJEvri">
                            <label for="EDoMgJEvri">Serverless Framework</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="CmvoUEMVnx">
                            <label for="CmvoUEMVnx">Terraform</label>
                            <ul>
                                <l>
                                    <input type="checkbox" id="jCqQDXBhfH">
                                    <label for="jCqQDXBhfH">Functions</label>
                                    <ul>
                                ...
                                <l>
                                    <input type="checkbox" id="meYPpiqHxG">
                                    <label for="meYPpiqHxG">Meta Arguments</label>
                                    <ul>
                ...
                <l>
                    <input type="checkbox" id="UIXKwYOqzj">
                    <label for="UIXKwYOqzj">Docker</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="clDsXcDkWl">
                    <label for="clDsXcDkWl">Dotnet</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="WCvzqKWRYz">
                            <label for="WCvzqKWRYz">Cli</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="vuXqgbuJch">
                    <label for="vuXqgbuJch">Functional Programming</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="QQugieZKsj">
                    <label for="QQugieZKsj">Git</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="DDVzkkipRY">
                            <label for="DDVzkkipRY">Github</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="oDQrXdMxPV">
                    <label for="oDQrXdMxPV">Go</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="NQQwLkMlBa">
                    <label for="NQQwLkMlBa">Haskell</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="AzDfeSiFbQ">
                    <label for="AzDfeSiFbQ">Js</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="jhlUnbDSRH">
                            <label for="jhlUnbDSRH">Node</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="UPWUjScZUg">
                            <label for="UPWUjScZUg">D3</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="GZaxsEQLIk">
                            <label for="GZaxsEQLIk">Mocha</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="UnqNEeOQru">
                            <label for="UnqNEeOQru">P5js</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="PqUzvpFyrZ">
                            <label for="PqUzvpFyrZ">Typescript</label>
                            <ul>
                                <l>
                                    <input type="checkbox" id="nsvXtFvQFb">
                                    <label for="nsvXtFvQFb">Testing</label>
                                    <ul>
                ...
                <l>
                    <input type="checkbox" id="VSfdbWIpnC">
                    <label for="VSfdbWIpnC">Kafka</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="enMKjDvBqa">
                    <label for="enMKjDvBqa">Kubernetes</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="GFxiKrCAAk">
                    <label for="GFxiKrCAAk">Language</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="TnTbBFCnlK">
                    <label for="TnTbBFCnlK">Linux</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="SalzipcaPA">
                            <label for="SalzipcaPA">Bash</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="nDirMGOAEl">
                    <label for="nDirMGOAEl">Oauth</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="VwKyDhHada">
                    <label for="VwKyDhHada">Prometheus</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="YOqlCBadjm">
                    <label for="YOqlCBadjm">Python</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="hQKSWtpGMw">
                            <label for="hQKSWtpGMw">Data Classes</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="hNsfgXPHDU">
                            <label for="hNsfgXPHDU">Libraries</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="VsOQLCObvv">
                    <label for="VsOQLCObvv">React</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="SPWdcDwjPB">
                    <label for="SPWdcDwjPB">Regular Expressions</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="xSzrSpZdym">
                    <label for="xSzrSpZdym">Rust</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="CebRVvQdBY">
                            <label for="CebRVvQdBY">Serde</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="gopgeQjbWu">
                    <label for="gopgeQjbWu">Shaders</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="rQyhOvohwZ">
                            <label for="rQyhOvohwZ">Glsl</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="EGipGHpcxq">
                    <label for="EGipGHpcxq">Vim</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="JzbMmicyJY">
                    <label for="JzbMmicyJY">Web</label>
                    <ul>
