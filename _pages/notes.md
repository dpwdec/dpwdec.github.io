...
<ul>
    <div name="contents-index">
        ...
        <l>
            <input type="checkbox" id="jZGwqzkYLh" checked>
            <label for="jZGwqzkYLh">Math</label>
            <ul>
                <l>
                    <input type="checkbox" id="UgeCnbKJJN">
                    <label for="UgeCnbKJJN">Exponentials</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="emMTQJIYYd">
                    <label for="emMTQJIYYd">Linear Algebra</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="YUjMnqEpGX">
                    <label for="YUjMnqEpGX">Logarithms</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="JPIHODJGFM">
                    <label for="JPIHODJGFM">Sequences</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="guOkgzpfWd">
                    <label for="guOkgzpfWd">Single Variable Calculus</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="pKPaYurotj">
                    <label for="pKPaYurotj">Trigonometry</label>
                    <ul>
        ...
        <l>
            <input type="checkbox" id="VHXyMNQqlW" checked>
            <label for="VHXyMNQqlW">Programming</label>
            <ul>
                <l>
                    <input type="checkbox" id="wfXxLGuIIB">
                    <label for="wfXxLGuIIB">Ansible</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="MhKSgFklfr">
                    <label for="MhKSgFklfr">Architecture</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="TgDpNyozud">
                    <label for="TgDpNyozud">Computer Graphics</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="LuzjaKHILs">
                    <label for="LuzjaKHILs">Databases</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="DjYCCmQHju">
                    <label for="DjYCCmQHju">Devops</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="PdHbzcIwGd">
                            <label for="PdHbzcIwGd">Cloud Computing</label>
                            <ul>
                                <l>
                                    <input type="checkbox" id="eqJJqFUgYv">
                                    <label for="eqJJqFUgYv">AWS</label>
                                    <ul>
                                        <l>
                                            <input type="checkbox" id="nGIHMNsMuR">
                                            <label for="nGIHMNsMuR">Ec 2</label>
                                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="XekbnYlDUu">
                            <label for="XekbnYlDUu">Events</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="mtvyCfrRcM">
                            <label for="mtvyCfrRcM">Oauth</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="KGtgxrbwjs">
                            <label for="KGtgxrbwjs">Pulumi</label>
                            <ul>
                                <l>
                                    <input type="checkbox" id="dKukZOiyiX">
                                    <label for="dKukZOiyiX">Dotnet</label>
                                    <ul>
                        ...
                        <l>
                            <input type="checkbox" id="ecurtqeuTL">
                            <label for="ecurtqeuTL">Terraform</label>
                            <ul>
                                <l>
                                    <input type="checkbox" id="vRFUmIHyYT">
                                    <label for="vRFUmIHyYT">Functions</label>
                                    <ul>
                                ...
                                <l>
                                    <input type="checkbox" id="OqMwdnapPN">
                                    <label for="OqMwdnapPN">Meta Arguments</label>
                                    <ul>
                ...
                <l>
                    <input type="checkbox" id="ZtIoiTAyed">
                    <label for="ZtIoiTAyed">Docker</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="giJBjfNzcd">
                    <label for="giJBjfNzcd">Dotnet</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="dRUTSlSnYl">
                            <label for="dRUTSlSnYl">Cli</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="vvboOzlgIY">
                    <label for="vvboOzlgIY">Functional Programming</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="nsGWNQVeXD">
                    <label for="nsGWNQVeXD">Git</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="IzzhfYwCXU">
                            <label for="IzzhfYwCXU">Github</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="vgfUHeSUVI">
                    <label for="vgfUHeSUVI">Go</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="gerGZgOsqe">
                    <label for="gerGZgOsqe">Haskell</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="ntdATeOmnX">
                    <label for="ntdATeOmnX">Js</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="osuMnqubIO">
                            <label for="osuMnqubIO">Node</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="MNcGqRhvjR">
                            <label for="MNcGqRhvjR">Mocha</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="EuTFbaLGhn">
                            <label for="EuTFbaLGhn">P5js</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="uBJOfwpldg">
                            <label for="uBJOfwpldg">Typescript</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="IfxmfZpnBQ">
                    <label for="IfxmfZpnBQ">Kafka</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="feMhzKbkZZ">
                    <label for="feMhzKbkZZ">Kubernetes</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="SrdUgzeZBZ">
                    <label for="SrdUgzeZBZ">Language</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="xmnKiiRdBX">
                    <label for="xmnKiiRdBX">Linux</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="psboPwabbv">
                    <label for="psboPwabbv">Python</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="kbFrqIkicL">
                            <label for="kbFrqIkicL">Data Classes</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="xfwVKJSThr">
                            <label for="xfwVKJSThr">Libraries</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="yIuZBMpXcG">
                    <label for="yIuZBMpXcG">React</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="yIekPVJxvx">
                    <label for="yIekPVJxvx">Regular Expressions</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="rwdUXUAnSz">
                    <label for="rwdUXUAnSz">Rust</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="bEWlqWhqFV">
                            <label for="bEWlqWhqFV">Serde</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="lxzNBCDtsv">
                    <label for="lxzNBCDtsv">Vim</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="TBOpkSwWsc">
                    <label for="TBOpkSwWsc">Web</label>
                    <ul>
