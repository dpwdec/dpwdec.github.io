...
<ul>
    <div name="contents-index">
        ...
        <l>
            <input type="checkbox" id="DKOAPpnyTs" checked>
            <label for="DKOAPpnyTs">Math</label>
            <ul>
                <l>
                    <input type="checkbox" id="ICNobrrBIO">
                    <label for="ICNobrrBIO">Exponentials</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="DEJNVbhERw">
                    <label for="DEJNVbhERw">Linear Algebra</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="IssSiRoxMw">
                    <label for="IssSiRoxMw">Logarithms</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="HlIXqwhBFC">
                    <label for="HlIXqwhBFC">Sequences</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="jrjDUefRgl">
                    <label for="jrjDUefRgl">Single Variable Calculus</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="LykogGjuTh">
                    <label for="LykogGjuTh">Trigonometry</label>
                    <ul>
        ...
        <l>
            <input type="checkbox" id="YvDwzQJGuD" checked>
            <label for="YvDwzQJGuD">Programming</label>
            <ul>
                <l>
                    <input type="checkbox" id="ZhvPaUVMKU">
                    <label for="ZhvPaUVMKU">Ansible</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="ItjTVpGdOh">
                    <label for="ItjTVpGdOh">Architecture</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="wkDhFENSAH">
                    <label for="wkDhFENSAH">Computer Graphics</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="FbqRnAqwRY">
                    <label for="FbqRnAqwRY">Databases</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="oichrNDKHM">
                    <label for="oichrNDKHM">Devops</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="adZUNRBImW">
                            <label for="adZUNRBImW">Cloud Providers</label>
                            <ul>
                                <l>
                                    <input type="checkbox" id="RmYlGglvfZ">
                                    <label for="RmYlGglvfZ">AWS</label>
                                    <ul>
                                        <l>
                                            <input type="checkbox" id="XNSoSHwgWl">
                                            <label for="XNSoSHwgWl">Cli</label>
                                            <ul>
                                        ...
                                        <l>
                                            <input type="checkbox" id="mUclzCuIDq">
                                            <label for="mUclzCuIDq">Dotnet</label>
                                            <ul>
                                        ...
                                        <l>
                                            <input type="checkbox" id="KfqfzCqRcR">
                                            <label for="KfqfzCqRcR">Ec 2</label>
                                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="HYQkgKJYeS">
                            <label for="HYQkgKJYeS">Events</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="tQkASQjleq">
                            <label for="tQkASQjleq">Localstack</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="dlALtALKFO">
                            <label for="dlALtALKFO">Pulumi</label>
                            <ul>
                                <l>
                                    <input type="checkbox" id="MufLDGsWGa">
                                    <label for="MufLDGsWGa">Dotnet</label>
                                    <ul>
                        ...
                        <l>
                            <input type="checkbox" id="YFDWBZCLHw">
                            <label for="YFDWBZCLHw">Serverless Framework</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="vtPUwKWwGV">
                            <label for="vtPUwKWwGV">Terraform</label>
                            <ul>
                                <l>
                                    <input type="checkbox" id="RmVCVvRsZL">
                                    <label for="RmVCVvRsZL">Functions</label>
                                    <ul>
                                ...
                                <l>
                                    <input type="checkbox" id="sFrFfrpzYn">
                                    <label for="sFrFfrpzYn">Meta Arguments</label>
                                    <ul>
                ...
                <l>
                    <input type="checkbox" id="dkuaGDeLzF">
                    <label for="dkuaGDeLzF">Docker</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="jOKvaCvFxQ">
                    <label for="jOKvaCvFxQ">Dotnet</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="iygQgwUNWJ">
                            <label for="iygQgwUNWJ">Cli</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="zfIqKORVll">
                    <label for="zfIqKORVll">Functional Programming</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="YthEIOFNbR">
                    <label for="YthEIOFNbR">Git</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="gjhJeWwZQT">
                            <label for="gjhJeWwZQT">Github</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="uKCiXFJsjc">
                    <label for="uKCiXFJsjc">Go</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="khOpaLIqth">
                    <label for="khOpaLIqth">Haskell</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="myqSpWpPZE">
                    <label for="myqSpWpPZE">Js</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="vYaxKpHrne">
                            <label for="vYaxKpHrne">Node</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="eSMXkGdoJc">
                            <label for="eSMXkGdoJc">D3</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="IGcuahlUdW">
                            <label for="IGcuahlUdW">Mocha</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="towxMEWHBO">
                            <label for="towxMEWHBO">P5js</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="XYxoITunwR">
                            <label for="XYxoITunwR">Typescript</label>
                            <ul>
                                <l>
                                    <input type="checkbox" id="ehaOSCCfez">
                                    <label for="ehaOSCCfez">Testing</label>
                                    <ul>
                ...
                <l>
                    <input type="checkbox" id="cJrzHXiPty">
                    <label for="cJrzHXiPty">Kafka</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="ZQuVCfbbnp">
                    <label for="ZQuVCfbbnp">Kubernetes</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="QBlbyHqmaF">
                    <label for="QBlbyHqmaF">Language</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="oSKLeiHsdw">
                    <label for="oSKLeiHsdw">Linux</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="AHiGUdHoNk">
                            <label for="AHiGUdHoNk">Bash</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="fUhvqRtubh">
                    <label for="fUhvqRtubh">Oauth</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="HtJnGgfFCx">
                    <label for="HtJnGgfFCx">Prometheus</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="NGUEKBNRou">
                    <label for="NGUEKBNRou">Python</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="rpMyBqnOAr">
                            <label for="rpMyBqnOAr">Data Classes</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="MgSLkuKTVG">
                            <label for="MgSLkuKTVG">Libraries</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="yQYPoTYblX">
                    <label for="yQYPoTYblX">React</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="LVkJOnxtkg">
                    <label for="LVkJOnxtkg">Regular Expressions</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="rqbsRPlQLP">
                    <label for="rqbsRPlQLP">Rust</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="BlJdwgMVAR">
                            <label for="BlJdwgMVAR">Serde</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="CnIBnadlYN">
                    <label for="CnIBnadlYN">Shaders</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="AkYsymHvNm">
                            <label for="AkYsymHvNm">Glsl</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="YIRxCLThzS">
                    <label for="YIRxCLThzS">Vim</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="CZzvAdvLbG">
                    <label for="CZzvAdvLbG">Web</label>
                    <ul>
