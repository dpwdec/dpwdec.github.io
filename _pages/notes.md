...
<ul>
    <div name="contents-index">
        ...
        <l>
            <input type="checkbox" id="HrRWlUcERd" checked>
            <label for="HrRWlUcERd">Math</label>
            <ul>
                <l>
                    <input type="checkbox" id="FmQCcJEegV">
                    <label for="FmQCcJEegV">Exponentials</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="PVTgmxWNik">
                    <label for="PVTgmxWNik">Linear Algebra</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="fXMXClAWMw">
                    <label for="fXMXClAWMw">Logarithms</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="pJQCQjULvL">
                    <label for="pJQCQjULvL">Sequences</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="aLclzGDtdW">
                    <label for="aLclzGDtdW">Single Variable Calculus</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="bjmMrMlvPU">
                    <label for="bjmMrMlvPU">Trigonometry</label>
                    <ul>
        ...
        <l>
            <input type="checkbox" id="rMlsQEmhMp" checked>
            <label for="rMlsQEmhMp">Programming</label>
            <ul>
                <l>
                    <input type="checkbox" id="vkEGwpJIjP">
                    <label for="vkEGwpJIjP">Ansible</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="YmNRwkphyn">
                    <label for="YmNRwkphyn">Architecture</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="EkFWXGlOMn">
                    <label for="EkFWXGlOMn">Computer Graphics</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="qEnxkwbAIL">
                    <label for="qEnxkwbAIL">Databases</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="jKlwAlmPzF">
                    <label for="jKlwAlmPzF">Devops</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="xkjKonTQNb">
                            <label for="xkjKonTQNb">Cloud Providers</label>
                            <ul>
                                <l>
                                    <input type="checkbox" id="JmvgyBCrOp">
                                    <label for="JmvgyBCrOp">AWS</label>
                                    <ul>
                                        <l>
                                            <input type="checkbox" id="DAlvDoXDNg">
                                            <label for="DAlvDoXDNg">Cli</label>
                                            <ul>
                                        ...
                                        <l>
                                            <input type="checkbox" id="hhQcehLxgH">
                                            <label for="hhQcehLxgH">Dotnet</label>
                                            <ul>
                                        ...
                                        <l>
                                            <input type="checkbox" id="uDegLtIEdg">
                                            <label for="uDegLtIEdg">Ec 2</label>
                                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="tFKhAZwHhi">
                            <label for="tFKhAZwHhi">Events</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="QxhKgiemtV">
                            <label for="QxhKgiemtV">Localstack</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="nIdJmLOfFu">
                            <label for="nIdJmLOfFu">Pulumi</label>
                            <ul>
                                <l>
                                    <input type="checkbox" id="FTFPBapNue">
                                    <label for="FTFPBapNue">Dotnet</label>
                                    <ul>
                        ...
                        <l>
                            <input type="checkbox" id="viarlFsikJ">
                            <label for="viarlFsikJ">Serverless Framework</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="UUWblFluNP">
                            <label for="UUWblFluNP">Terraform</label>
                            <ul>
                                <l>
                                    <input type="checkbox" id="gkJplhxeTc">
                                    <label for="gkJplhxeTc">Functions</label>
                                    <ul>
                                ...
                                <l>
                                    <input type="checkbox" id="baHeXjuivI">
                                    <label for="baHeXjuivI">Meta Arguments</label>
                                    <ul>
                ...
                <l>
                    <input type="checkbox" id="alUHwAPLUt">
                    <label for="alUHwAPLUt">Docker</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="sPoMSDtNEQ">
                    <label for="sPoMSDtNEQ">Dotnet</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="diXHIaCKgn">
                            <label for="diXHIaCKgn">Cli</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="bMNHtLeScg">
                    <label for="bMNHtLeScg">Functional Programming</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="LIpJZLVrrX">
                    <label for="LIpJZLVrrX">Git</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="kqFvfLMvzW">
                            <label for="kqFvfLMvzW">Github</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="CBlnJbZsiY">
                    <label for="CBlnJbZsiY">Go</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="NyRUTLKJYO">
                    <label for="NyRUTLKJYO">Haskell</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="tJjuhZSwWV">
                    <label for="tJjuhZSwWV">Js</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="vhwFYHaohj">
                            <label for="vhwFYHaohj">Node</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="dZmRhweUrQ">
                            <label for="dZmRhweUrQ">D3</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="icjevGuiix">
                            <label for="icjevGuiix">Mocha</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="sZYPuAZVJM">
                            <label for="sZYPuAZVJM">P5js</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="tKTemAhXxk">
                            <label for="tKTemAhXxk">Typescript</label>
                            <ul>
                                <l>
                                    <input type="checkbox" id="BTgbUaMHTw">
                                    <label for="BTgbUaMHTw">Testing</label>
                                    <ul>
                ...
                <l>
                    <input type="checkbox" id="mQUuFwHkfV">
                    <label for="mQUuFwHkfV">Kafka</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="qcGVwfnhkO">
                    <label for="qcGVwfnhkO">Kubernetes</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="gnpWVNCwoP">
                    <label for="gnpWVNCwoP">Language</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="dOSsvcJiYZ">
                    <label for="dOSsvcJiYZ">Linux</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="BuHHoDIDUH">
                            <label for="BuHHoDIDUH">Bash</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="PJSCBDPWyf">
                    <label for="PJSCBDPWyf">Oauth</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="bplbhnXqDT">
                    <label for="bplbhnXqDT">Prometheus</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="LfIdLxNZoO">
                    <label for="LfIdLxNZoO">Python</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="TYTufeXUQZ">
                            <label for="TYTufeXUQZ">Data Classes</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="WEqsRBtkSl">
                            <label for="WEqsRBtkSl">Libraries</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="eOmoqNrUIE">
                    <label for="eOmoqNrUIE">React</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="ypabGwALSg">
                    <label for="ypabGwALSg">Regular Expressions</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="hLQWpIdpkv">
                    <label for="hLQWpIdpkv">Rust</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="aXKBUOoHSo">
                            <label for="aXKBUOoHSo">Serde</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="WEUZxVKCTH">
                    <label for="WEUZxVKCTH">Shaders</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="HnDXCTsTAb">
                            <label for="HnDXCTsTAb">Glsl</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="GWdxgpQwkQ">
                    <label for="GWdxgpQwkQ">Vim</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="AEPfErIbuI">
                    <label for="AEPfErIbuI">Web</label>
                    <ul>
