...
<ul>
    <div name="contents-index">
        ...
        <l>
            <input type="checkbox" id="MJwvEJWbZb" checked>
            <label for="MJwvEJWbZb">Math</label>
            <ul>
                <l>
                    <input type="checkbox" id="PoidDckEgl">
                    <label for="PoidDckEgl">Exponentials</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="HTcnSfnGHI">
                    <label for="HTcnSfnGHI">Linear Algebra</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="mJkLqDqpwI">
                    <label for="mJkLqDqpwI">Logarithms</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="btWykOZkqc">
                    <label for="btWykOZkqc">Sequences</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="mppuhKJuRa">
                    <label for="mppuhKJuRa">Single Variable Calculus</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="geMAPhcaqq">
                    <label for="geMAPhcaqq">Trigonometry</label>
                    <ul>
        ...
        <l>
            <input type="checkbox" id="licGiPIHjj" checked>
            <label for="licGiPIHjj">Programming</label>
            <ul>
                <l>
                    <input type="checkbox" id="NKjcbKBDUs">
                    <label for="NKjcbKBDUs">Ansible</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="DMNvcadaGL">
                    <label for="DMNvcadaGL">Architecture</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="xosLsnJReZ">
                    <label for="xosLsnJReZ">Computer Graphics</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="PfFUqCGvzh">
                    <label for="PfFUqCGvzh">Databases</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="GvRpEYAiTs">
                    <label for="GvRpEYAiTs">Devops</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="KVsnBCZbeE">
                            <label for="KVsnBCZbeE">Cloud Providers</label>
                            <ul>
                                <l>
                                    <input type="checkbox" id="ZFjnRELFDk">
                                    <label for="ZFjnRELFDk">AWS</label>
                                    <ul>
                                        <l>
                                            <input type="checkbox" id="PgphmZApeN">
                                            <label for="PgphmZApeN">Cli</label>
                                            <ul>
                                        ...
                                        <l>
                                            <input type="checkbox" id="hyKgIqHpDy">
                                            <label for="hyKgIqHpDy">Dotnet</label>
                                            <ul>
                                        ...
                                        <l>
                                            <input type="checkbox" id="pUfZxTyGfu">
                                            <label for="pUfZxTyGfu">Ec 2</label>
                                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="QzttgTfbaz">
                            <label for="QzttgTfbaz">Events</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="QYFyTRzUMz">
                            <label for="QYFyTRzUMz">Localstack</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="ONyePIfkxW">
                            <label for="ONyePIfkxW">Pulumi</label>
                            <ul>
                                <l>
                                    <input type="checkbox" id="RyGHJgMBVV">
                                    <label for="RyGHJgMBVV">Dotnet</label>
                                    <ul>
                        ...
                        <l>
                            <input type="checkbox" id="FPdRQtaEdv">
                            <label for="FPdRQtaEdv">Serverless Framework</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="iLNkhRYRpW">
                            <label for="iLNkhRYRpW">Terraform</label>
                            <ul>
                                <l>
                                    <input type="checkbox" id="eyItkKCNtR">
                                    <label for="eyItkKCNtR">Functions</label>
                                    <ul>
                                ...
                                <l>
                                    <input type="checkbox" id="iYHLqDKWsc">
                                    <label for="iYHLqDKWsc">Meta Arguments</label>
                                    <ul>
                ...
                <l>
                    <input type="checkbox" id="RJXyseNBep">
                    <label for="RJXyseNBep">Docker</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="CjqndDNLRL">
                    <label for="CjqndDNLRL">Dotnet</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="hgSfSyFFSP">
                            <label for="hgSfSyFFSP">Cli</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="dcesAismaC">
                    <label for="dcesAismaC">Functional Programming</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="mjeidGKDqg">
                    <label for="mjeidGKDqg">Git</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="ZMNkAsoxvT">
                            <label for="ZMNkAsoxvT">Github</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="nLEixRRizi">
                    <label for="nLEixRRizi">Go</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="qOOMntVkih">
                    <label for="qOOMntVkih">Haskell</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="fnvthgyxiW">
                    <label for="fnvthgyxiW">Js</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="UKtxmvWkAY">
                            <label for="UKtxmvWkAY">Node</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="tmbLsGvzCW">
                            <label for="tmbLsGvzCW">D3</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="vQXoGIWiTG">
                            <label for="vQXoGIWiTG">Mocha</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="AdAyIbLTMR">
                            <label for="AdAyIbLTMR">P5js</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="RLBOEAQBow">
                            <label for="RLBOEAQBow">Typescript</label>
                            <ul>
                                <l>
                                    <input type="checkbox" id="wSByJqoSvw">
                                    <label for="wSByJqoSvw">Testing</label>
                                    <ul>
                ...
                <l>
                    <input type="checkbox" id="oQNIxSnswT">
                    <label for="oQNIxSnswT">Kafka</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="xukuVYHXLO">
                    <label for="xukuVYHXLO">Kubernetes</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="rTzdRYuBGX">
                    <label for="rTzdRYuBGX">Language</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="bMRitcdDeR">
                    <label for="bMRitcdDeR">Linux</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="XCyYIQVhDG">
                            <label for="XCyYIQVhDG">Bash</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="liGAlGYVDI">
                    <label for="liGAlGYVDI">Oauth</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="gWeiRjzyYM">
                    <label for="gWeiRjzyYM">Python</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="VJITJtJlQR">
                            <label for="VJITJtJlQR">Data Classes</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="TmOVttLfSB">
                            <label for="TmOVttLfSB">Libraries</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="fsTdWKIhlv">
                    <label for="fsTdWKIhlv">React</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="hWYZKooTHR">
                    <label for="hWYZKooTHR">Regular Expressions</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="zmAxPPAuCA">
                    <label for="zmAxPPAuCA">Rust</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="asUEgqPqFO">
                            <label for="asUEgqPqFO">Serde</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="uRLUNiLmcS">
                    <label for="uRLUNiLmcS">Vim</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="rdLRiFulWn">
                    <label for="rdLRiFulWn">Web</label>
                    <ul>
