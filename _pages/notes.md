...
<ul>
    <div name="contents-index">
        ...
        <l>
            <input type="checkbox" id="CjgYTcIBWl" checked>
            <label for="CjgYTcIBWl">Math</label>
            <ul>
                <l>
                    <input type="checkbox" id="ARloMGjIHb">
                    <label for="ARloMGjIHb">Exponentials</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="ohlgRyNofP">
                    <label for="ohlgRyNofP">Linear Algebra</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="QZxTHKlDAg">
                    <label for="QZxTHKlDAg">Logarithms</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="EmrRCtMGlq">
                    <label for="EmrRCtMGlq">Sequences</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="NRnaYoOHVX">
                    <label for="NRnaYoOHVX">Single Variable Calculus</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="BSxPXsUNJm">
                    <label for="BSxPXsUNJm">Trigonometry</label>
                    <ul>
        ...
        <l>
            <input type="checkbox" id="qYRfpuxwBg" checked>
            <label for="qYRfpuxwBg">Programming</label>
            <ul>
                <l>
                    <input type="checkbox" id="FtbUFdkcdQ">
                    <label for="FtbUFdkcdQ">Ansible</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="eFEJnTQCeR">
                    <label for="eFEJnTQCeR">Architecture</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="gXcGPZvcev">
                    <label for="gXcGPZvcev">Computer Graphics</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="GAUtCvasMv">
                    <label for="GAUtCvasMv">Databases</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="SWfsZWGJaB">
                    <label for="SWfsZWGJaB">Devops</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="gsqpwcIwhK">
                            <label for="gsqpwcIwhK">Cloud Providers</label>
                            <ul>
                                <l>
                                    <input type="checkbox" id="UShpTPpSCJ">
                                    <label for="UShpTPpSCJ">AWS</label>
                                    <ul>
                                        <l>
                                            <input type="checkbox" id="xXcYvlPgtP">
                                            <label for="xXcYvlPgtP">Cli</label>
                                            <ul>
                                        ...
                                        <l>
                                            <input type="checkbox" id="eNSyKpjEBj">
                                            <label for="eNSyKpjEBj">Dotnet</label>
                                            <ul>
                                        ...
                                        <l>
                                            <input type="checkbox" id="XFFmXUirDn">
                                            <label for="XFFmXUirDn">Ec 2</label>
                                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="yAXBKiyhUH">
                            <label for="yAXBKiyhUH">Events</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="JpZLcWUKMI">
                            <label for="JpZLcWUKMI">Localstack</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="FNCVxbAZwi">
                            <label for="FNCVxbAZwi">Pulumi</label>
                            <ul>
                                <l>
                                    <input type="checkbox" id="tEACKTrDJQ">
                                    <label for="tEACKTrDJQ">Dotnet</label>
                                    <ul>
                        ...
                        <l>
                            <input type="checkbox" id="YaKKGJtMdv">
                            <label for="YaKKGJtMdv">Serverless Framework</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="qCbamqFcYn">
                            <label for="qCbamqFcYn">Terraform</label>
                            <ul>
                                <l>
                                    <input type="checkbox" id="lODJOrxPhg">
                                    <label for="lODJOrxPhg">Functions</label>
                                    <ul>
                                ...
                                <l>
                                    <input type="checkbox" id="uOMzzCHYkW">
                                    <label for="uOMzzCHYkW">Meta Arguments</label>
                                    <ul>
                ...
                <l>
                    <input type="checkbox" id="xIzvJAADxe">
                    <label for="xIzvJAADxe">Docker</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="PjlSaFWIKN">
                    <label for="PjlSaFWIKN">Dotnet</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="AEfJlSQxPI">
                            <label for="AEfJlSQxPI">Cli</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="HYNSxArvbo">
                    <label for="HYNSxArvbo">Functional Programming</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="vbsCfXFrnP">
                    <label for="vbsCfXFrnP">Git</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="bkXMfWGUSS">
                            <label for="bkXMfWGUSS">Github</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="xRjAVmiuvr">
                    <label for="xRjAVmiuvr">Go</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="WeOrkquArx">
                    <label for="WeOrkquArx">Haskell</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="IfTrbDSTMR">
                    <label for="IfTrbDSTMR">Js</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="wwrSCuQKwy">
                            <label for="wwrSCuQKwy">Node</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="bfSgudAshM">
                            <label for="bfSgudAshM">D3</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="nnRVaVITsb">
                            <label for="nnRVaVITsb">Mocha</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="xERKJABkcO">
                            <label for="xERKJABkcO">P5js</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="FEnTtzAQpX">
                            <label for="FEnTtzAQpX">Typescript</label>
                            <ul>
                                <l>
                                    <input type="checkbox" id="PdCGlvlLyd">
                                    <label for="PdCGlvlLyd">Testing</label>
                                    <ul>
                ...
                <l>
                    <input type="checkbox" id="PstzrYsohd">
                    <label for="PstzrYsohd">Kafka</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="CYkjiewnKR">
                    <label for="CYkjiewnKR">Kubernetes</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="idhfkaflYK">
                    <label for="idhfkaflYK">Language</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="AkJgUOAXiO">
                    <label for="AkJgUOAXiO">Linux</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="wUhjkKvJbB">
                            <label for="wUhjkKvJbB">Bash</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="jKCIsUmeQV">
                    <label for="jKCIsUmeQV">Oauth</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="CAAWCgkMap">
                    <label for="CAAWCgkMap">Prometheus</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="fxlqwknIKE">
                    <label for="fxlqwknIKE">Python</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="JBOQyqMtAB">
                            <label for="JBOQyqMtAB">Data Classes</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="kEoXfSymoe">
                            <label for="kEoXfSymoe">Libraries</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="LzPIwulzYv">
                    <label for="LzPIwulzYv">React</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="gZMFBilOgy">
                    <label for="gZMFBilOgy">Regular Expressions</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="TOPgNGwpvC">
                    <label for="TOPgNGwpvC">Rust</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="CKNfuuIyif">
                            <label for="CKNfuuIyif">Serde</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="QZXBSoPwLU">
                    <label for="QZXBSoPwLU">Shaders</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="CRzQulONdF">
                            <label for="CRzQulONdF">Glsl</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="AnHuncSlQD">
                    <label for="AnHuncSlQD">Vim</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="ycEyeKaCTR">
                    <label for="ycEyeKaCTR">Web</label>
                    <ul>
