...
<ul>
    <div name="contents-index">
        ...
        <l>
            <input type="checkbox" id="ComWFwUIBi" checked>
            <label for="ComWFwUIBi">Math</label>
            <ul>
                <l>
                    <input type="checkbox" id="PDofyZaqke">
                    <label for="PDofyZaqke">Exponentials</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="kstvAcYQME">
                    <label for="kstvAcYQME">Linear Algebra</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="belCotYSJI">
                    <label for="belCotYSJI">Logarithms</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="MXLctWxpSj">
                    <label for="MXLctWxpSj">Sequences</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="abMPOVgeYH">
                    <label for="abMPOVgeYH">Single Variable Calculus</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="kppgOmEaGg">
                    <label for="kppgOmEaGg">Trigonometry</label>
                    <ul>
        ...
        <l>
            <input type="checkbox" id="qcTjEjNaxm" checked>
            <label for="qcTjEjNaxm">Programming</label>
            <ul>
                <l>
                    <input type="checkbox" id="EGFMeuYfzZ">
                    <label for="EGFMeuYfzZ">Ansible</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="iKuWEOiDFY">
                    <label for="iKuWEOiDFY">Architecture</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="ktpwSZcNfm">
                    <label for="ktpwSZcNfm">Computer Graphics</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="gOvcmaVRTg">
                    <label for="gOvcmaVRTg">Databases</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="zBXsOcsDra">
                    <label for="zBXsOcsDra">Devops</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="qFgadNqZZw">
                            <label for="qFgadNqZZw">Cloud Providers</label>
                            <ul>
                                <l>
                                    <input type="checkbox" id="ZryXSUUFWU">
                                    <label for="ZryXSUUFWU">AWS</label>
                                    <ul>
                                        <l>
                                            <input type="checkbox" id="KyWVvpItWU">
                                            <label for="KyWVvpItWU">Cli</label>
                                            <ul>
                                        ...
                                        <l>
                                            <input type="checkbox" id="GnnTcpRLDl">
                                            <label for="GnnTcpRLDl">Dotnet</label>
                                            <ul>
                                        ...
                                        <l>
                                            <input type="checkbox" id="mLXEwPsEfA">
                                            <label for="mLXEwPsEfA">Ec 2</label>
                                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="BetEXcYJDo">
                            <label for="BetEXcYJDo">Events</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="LXADYmaCaZ">
                            <label for="LXADYmaCaZ">Localstack</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="pFVBXhnbwA">
                            <label for="pFVBXhnbwA">Pulumi</label>
                            <ul>
                                <l>
                                    <input type="checkbox" id="AFQEucjiql">
                                    <label for="AFQEucjiql">Dotnet</label>
                                    <ul>
                        ...
                        <l>
                            <input type="checkbox" id="dMcnUInYYx">
                            <label for="dMcnUInYYx">Serverless Framework</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="AUkbFSIiRU">
                            <label for="AUkbFSIiRU">Terraform</label>
                            <ul>
                                <l>
                                    <input type="checkbox" id="AAMmcKOIAZ">
                                    <label for="AAMmcKOIAZ">Functions</label>
                                    <ul>
                                ...
                                <l>
                                    <input type="checkbox" id="dKZwDVjYrm">
                                    <label for="dKZwDVjYrm">Meta Arguments</label>
                                    <ul>
                ...
                <l>
                    <input type="checkbox" id="sjCcfNFtOv">
                    <label for="sjCcfNFtOv">Docker</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="GWgYRylRbJ">
                    <label for="GWgYRylRbJ">Dotnet</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="RBssnODOPB">
                            <label for="RBssnODOPB">Cli</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="qHcjYuRheC">
                    <label for="qHcjYuRheC">Functional Programming</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="XdytrFJnnp">
                    <label for="XdytrFJnnp">Git</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="YjZyXODbsE">
                            <label for="YjZyXODbsE">Github</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="oPclQWvxZt">
                    <label for="oPclQWvxZt">Go</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="LeiPqHClLB">
                    <label for="LeiPqHClLB">Haskell</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="AVgZYtSSVl">
                    <label for="AVgZYtSSVl">Js</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="ZDYvTIejUw">
                            <label for="ZDYvTIejUw">Node</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="fWhdEmoppR">
                            <label for="fWhdEmoppR">D3</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="xHGhRrOvgk">
                            <label for="xHGhRrOvgk">Mocha</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="pzSOFiSICQ">
                            <label for="pzSOFiSICQ">P5js</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="STcZMzyhmL">
                            <label for="STcZMzyhmL">Typescript</label>
                            <ul>
                                <l>
                                    <input type="checkbox" id="oHndTXsBzr">
                                    <label for="oHndTXsBzr">Testing</label>
                                    <ul>
                ...
                <l>
                    <input type="checkbox" id="gTSxcGOeyH">
                    <label for="gTSxcGOeyH">Kafka</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="svXCqFxJLC">
                    <label for="svXCqFxJLC">Kubernetes</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="YHKZYgDcAz">
                    <label for="YHKZYgDcAz">Language</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="QazTTtioEj">
                    <label for="QazTTtioEj">Linux</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="dcCvEDUCbE">
                            <label for="dcCvEDUCbE">Bash</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="JTlwLEOkof">
                    <label for="JTlwLEOkof">Oauth</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="xRfQGeKVnU">
                    <label for="xRfQGeKVnU">Prometheus</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="XCDpVSiuQD">
                    <label for="XCDpVSiuQD">Python</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="qBGkQlYuvX">
                            <label for="qBGkQlYuvX">Data Classes</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="GowkIMcJjH">
                            <label for="GowkIMcJjH">Libraries</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="lWsXyasoym">
                    <label for="lWsXyasoym">React</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="gOhyRwtWjy">
                    <label for="gOhyRwtWjy">Regular Expressions</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="mhOKOOJWBX">
                    <label for="mhOKOOJWBX">Rust</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="viXcFuFbzF">
                            <label for="viXcFuFbzF">Serde</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="yFcMboWLpa">
                    <label for="yFcMboWLpa">Shaders</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="vLYAnHEyEf">
                            <label for="vLYAnHEyEf">Glsl</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="uoFbljOnTQ">
                    <label for="uoFbljOnTQ">Vim</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="SYcBpahrwC">
                    <label for="SYcBpahrwC">Web</label>
                    <ul>
