...
<ul>
    <div name="contents-index">
        ...
        <l>
            <input type="checkbox" id="vejcXSuDeD" checked>
            <label for="vejcXSuDeD">Math</label>
            <ul>
                <l>
                    <input type="checkbox" id="DhoCmzxtkI">
                    <label for="DhoCmzxtkI">Exponentials</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="OeGDiClzui">
                    <label for="OeGDiClzui">Linear Algebra</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="qDmPsFIrAP">
                    <label for="qDmPsFIrAP">Logarithms</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="vWTaKDZPgA">
                    <label for="vWTaKDZPgA">Sequences</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="kyoEplPANc">
                    <label for="kyoEplPANc">Single Variable Calculus</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="ZUeAhJuKBH">
                    <label for="ZUeAhJuKBH">Trigonometry</label>
                    <ul>
        ...
        <l>
            <input type="checkbox" id="zWhUOKJneW" checked>
            <label for="zWhUOKJneW">Programming</label>
            <ul>
                <l>
                    <input type="checkbox" id="oGdLABMAxI">
                    <label for="oGdLABMAxI">Ansible</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="XpwsSNtMGe">
                    <label for="XpwsSNtMGe">Architecture</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="NKsKvHDCaq">
                    <label for="NKsKvHDCaq">Computer Graphics</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="KWhuhKTzKH">
                    <label for="KWhuhKTzKH">Databases</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="BLGcRHwlnY">
                    <label for="BLGcRHwlnY">Devops</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="ywzoHEXQFi">
                            <label for="ywzoHEXQFi">Cloud Providers</label>
                            <ul>
                                <l>
                                    <input type="checkbox" id="mkZknWtmVV">
                                    <label for="mkZknWtmVV">AWS</label>
                                    <ul>
                                        <l>
                                            <input type="checkbox" id="TqjnvLETBW">
                                            <label for="TqjnvLETBW">Cli</label>
                                            <ul>
                                        ...
                                        <l>
                                            <input type="checkbox" id="soxTVitYZH">
                                            <label for="soxTVitYZH">Dotnet</label>
                                            <ul>
                                        ...
                                        <l>
                                            <input type="checkbox" id="OkkkcmMjEH">
                                            <label for="OkkkcmMjEH">Ec 2</label>
                                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="gYVoBHyxsD">
                            <label for="gYVoBHyxsD">Events</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="jsKtuXnMsF">
                            <label for="jsKtuXnMsF">Localstack</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="wahpxduEQp">
                            <label for="wahpxduEQp">Pulumi</label>
                            <ul>
                                <l>
                                    <input type="checkbox" id="svYzwRKFmi">
                                    <label for="svYzwRKFmi">Dotnet</label>
                                    <ul>
                        ...
                        <l>
                            <input type="checkbox" id="AOjZkpDvCO">
                            <label for="AOjZkpDvCO">Serverless Framework</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="PYYJbBbsCw">
                            <label for="PYYJbBbsCw">Terraform</label>
                            <ul>
                                <l>
                                    <input type="checkbox" id="NVSsLyhdwO">
                                    <label for="NVSsLyhdwO">Functions</label>
                                    <ul>
                                ...
                                <l>
                                    <input type="checkbox" id="oYtRDyRdmH">
                                    <label for="oYtRDyRdmH">Meta Arguments</label>
                                    <ul>
                ...
                <l>
                    <input type="checkbox" id="GFwaWCRvqH">
                    <label for="GFwaWCRvqH">Docker</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="PZCcNToNvS">
                    <label for="PZCcNToNvS">Dotnet</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="vyFHQUQWKh">
                            <label for="vyFHQUQWKh">Cli</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="LaNRkYAVWX">
                    <label for="LaNRkYAVWX">Functional Programming</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="YCTRInIStk">
                    <label for="YCTRInIStk">Git</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="armeIJuiWn">
                            <label for="armeIJuiWn">Github</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="TEwdhZtDcY">
                    <label for="TEwdhZtDcY">Go</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="XaEMVBHGAr">
                    <label for="XaEMVBHGAr">Haskell</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="fkxoZcCyBe">
                    <label for="fkxoZcCyBe">Js</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="JBGirTHjTs">
                            <label for="JBGirTHjTs">Node</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="htswUhDXfN">
                            <label for="htswUhDXfN">D3</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="hTGpiBSQmw">
                            <label for="hTGpiBSQmw">Mocha</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="eSVaGaGTJW">
                            <label for="eSVaGaGTJW">P5js</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="tybnOUwdhK">
                            <label for="tybnOUwdhK">Typescript</label>
                            <ul>
                                <l>
                                    <input type="checkbox" id="OVhJMnYkIO">
                                    <label for="OVhJMnYkIO">Testing</label>
                                    <ul>
                ...
                <l>
                    <input type="checkbox" id="LoaPXeGzpl">
                    <label for="LoaPXeGzpl">Kafka</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="UUssyiIBpR">
                    <label for="UUssyiIBpR">Kubernetes</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="PKAKGEbfIG">
                    <label for="PKAKGEbfIG">Language</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="PezHrcJQuL">
                    <label for="PezHrcJQuL">Linux</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="FpvoluEmvd">
                            <label for="FpvoluEmvd">Bash</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="lAWnZYFOPf">
                    <label for="lAWnZYFOPf">Oauth</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="aMUPlOAKXg">
                    <label for="aMUPlOAKXg">Prometheus</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="aBMXXDqvVW">
                    <label for="aBMXXDqvVW">Python</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="bJBIKcMWTQ">
                            <label for="bJBIKcMWTQ">Data Classes</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="twGPbtEDCz">
                            <label for="twGPbtEDCz">Libraries</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="TNkbHKtxWZ">
                    <label for="TNkbHKtxWZ">React</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="ifimLBSFlb">
                    <label for="ifimLBSFlb">Regular Expressions</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="brMwrLoAlF">
                    <label for="brMwrLoAlF">Rust</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="WBkhgBtKPE">
                            <label for="WBkhgBtKPE">Serde</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="CqDcUMyxsC">
                    <label for="CqDcUMyxsC">Shaders</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="PersiKZgdi">
                            <label for="PersiKZgdi">Glsl</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="ZCynDfvRaa">
                    <label for="ZCynDfvRaa">Vim</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="ItAIpVzmqK">
                    <label for="ItAIpVzmqK">Web</label>
                    <ul>
