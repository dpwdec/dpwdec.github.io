...
<ul>
    <div name="contents-index">
        ...
        <l>
            <input type="checkbox" id="JmWproybsY" checked>
            <label for="JmWproybsY">Math</label>
            <ul>
                <l>
                    <input type="checkbox" id="kQtXyeXxMp">
                    <label for="kQtXyeXxMp">Exponentials</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="RbbdPkgAaJ">
                    <label for="RbbdPkgAaJ">Linear Algebra</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="dwtFFIlczh">
                    <label for="dwtFFIlczh">Logarithms</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="dobMbnKoig">
                    <label for="dobMbnKoig">Sequences</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="BmWEjcghsz">
                    <label for="BmWEjcghsz">Single Variable Calculus</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="IURDGOmoNL">
                    <label for="IURDGOmoNL">Trigonometry</label>
                    <ul>
        ...
        <l>
            <input type="checkbox" id="eBJejAvMfa" checked>
            <label for="eBJejAvMfa">Programming</label>
            <ul>
                <l>
                    <input type="checkbox" id="RFPWGwbwSY">
                    <label for="RFPWGwbwSY">Ansible</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="JbQeDoboGs">
                    <label for="JbQeDoboGs">Architecture</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="ABiPbjOKZN">
                    <label for="ABiPbjOKZN">Computer Graphics</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="oVJidmOavM">
                    <label for="oVJidmOavM">Databases</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="KYzphLSeWt">
                    <label for="KYzphLSeWt">Devops</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="XTWefFPUin">
                            <label for="XTWefFPUin">Cloud Providers</label>
                            <ul>
                                <l>
                                    <input type="checkbox" id="sreIpnPgUt">
                                    <label for="sreIpnPgUt">AWS</label>
                                    <ul>
                                        <l>
                                            <input type="checkbox" id="xjYCrMLhee">
                                            <label for="xjYCrMLhee">Cli</label>
                                            <ul>
                                        ...
                                        <l>
                                            <input type="checkbox" id="fXYmRxKVru">
                                            <label for="fXYmRxKVru">Dotnet</label>
                                            <ul>
                                        ...
                                        <l>
                                            <input type="checkbox" id="geCsCqcZDG">
                                            <label for="geCsCqcZDG">Ec 2</label>
                                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="GyaFirsutY">
                            <label for="GyaFirsutY">Events</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="TZKpjnYuSL">
                            <label for="TZKpjnYuSL">Localstack</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="tBpyHCEzcw">
                            <label for="tBpyHCEzcw">Pulumi</label>
                            <ul>
                                <l>
                                    <input type="checkbox" id="HiiMyQalqM">
                                    <label for="HiiMyQalqM">Dotnet</label>
                                    <ul>
                        ...
                        <l>
                            <input type="checkbox" id="HrMJSoUwDC">
                            <label for="HrMJSoUwDC">Serverless Framework</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="HBZdsumcKL">
                            <label for="HBZdsumcKL">Terraform</label>
                            <ul>
                                <l>
                                    <input type="checkbox" id="HUAAbUceea">
                                    <label for="HUAAbUceea">Functions</label>
                                    <ul>
                                ...
                                <l>
                                    <input type="checkbox" id="nGGFRhUUiC">
                                    <label for="nGGFRhUUiC">Meta Arguments</label>
                                    <ul>
                ...
                <l>
                    <input type="checkbox" id="IamNbiekVk">
                    <label for="IamNbiekVk">Docker</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="tIQwGjKhmu">
                    <label for="tIQwGjKhmu">Dotnet</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="tXfAoPIHXa">
                            <label for="tXfAoPIHXa">Cli</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="gzGfOUNqaw">
                    <label for="gzGfOUNqaw">Functional Programming</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="LraLbhnkxs">
                    <label for="LraLbhnkxs">Git</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="OvOmrfimaK">
                            <label for="OvOmrfimaK">Github</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="gRlEPRHsRz">
                    <label for="gRlEPRHsRz">Go</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="SMdbwbcfcI">
                    <label for="SMdbwbcfcI">Haskell</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="BhMlyZNHSy">
                    <label for="BhMlyZNHSy">Js</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="SzxnbuDcGT">
                            <label for="SzxnbuDcGT">Node</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="purgWUqxTa">
                            <label for="purgWUqxTa">D3</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="oKpcYiEzGL">
                            <label for="oKpcYiEzGL">Mocha</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="uGrchmNWvB">
                            <label for="uGrchmNWvB">P5js</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="bqXdBUUzxW">
                            <label for="bqXdBUUzxW">Typescript</label>
                            <ul>
                                <l>
                                    <input type="checkbox" id="SDBYLxaMzE">
                                    <label for="SDBYLxaMzE">Testing</label>
                                    <ul>
                ...
                <l>
                    <input type="checkbox" id="SPxgVHdkRy">
                    <label for="SPxgVHdkRy">Kafka</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="sOTJFkqiDR">
                    <label for="sOTJFkqiDR">Kubernetes</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="GASuttytKA">
                    <label for="GASuttytKA">Language</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="hzQxKhOlbd">
                    <label for="hzQxKhOlbd">Linux</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="ROUUjeDsGh">
                            <label for="ROUUjeDsGh">Bash</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="gCFklIGFAh">
                    <label for="gCFklIGFAh">Oauth</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="BXHZRloYyp">
                    <label for="BXHZRloYyp">Prometheus</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="pTXaDmJTfc">
                    <label for="pTXaDmJTfc">Python</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="NvlosKKzRc">
                            <label for="NvlosKKzRc">Data Classes</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="UmhlLTiTXU">
                            <label for="UmhlLTiTXU">Libraries</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="VfotbdrimS">
                    <label for="VfotbdrimS">React</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="UWTvMjqgVI">
                    <label for="UWTvMjqgVI">Regular Expressions</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="hpWIDEaTCr">
                    <label for="hpWIDEaTCr">Rust</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="NfEBOTOmJU">
                            <label for="NfEBOTOmJU">Serde</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="rYLCRkaAPI">
                    <label for="rYLCRkaAPI">Shaders</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="bMLUEoTjxj">
                            <label for="bMLUEoTjxj">Glsl</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="yTTUgUVdte">
                    <label for="yTTUgUVdte">Vim</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="sPOatzAQAN">
                    <label for="sPOatzAQAN">Web</label>
                    <ul>
