...
<ul>
    <div name="contents-index">
        ...
        <l>
            <input type="checkbox" id="tBzTWyEhuz" checked>
            <label for="tBzTWyEhuz">Math</label>
            <ul>
                <l>
                    <input type="checkbox" id="fTKnCjYGPx">
                    <label for="fTKnCjYGPx">Exponentials</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="GQClDTdjCx">
                    <label for="GQClDTdjCx">Linear Algebra</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="tngFhZcaon">
                    <label for="tngFhZcaon">Logarithms</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="UrfqfqGnvN">
                    <label for="UrfqfqGnvN">Sequences</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="WOauRDngvl">
                    <label for="WOauRDngvl">Single Variable Calculus</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="kjxTHpwOwv">
                    <label for="kjxTHpwOwv">Trigonometry</label>
                    <ul>
        ...
        <l>
            <input type="checkbox" id="IEBAQBhMNj" checked>
            <label for="IEBAQBhMNj">Programming</label>
            <ul>
                <l>
                    <input type="checkbox" id="orvuoXrpuZ">
                    <label for="orvuoXrpuZ">Ansible</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="nsBxdJlQwq">
                    <label for="nsBxdJlQwq">Architecture</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="HpBpgovpis">
                    <label for="HpBpgovpis">Computer Graphics</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="GEQrVkhnOU">
                    <label for="GEQrVkhnOU">Databases</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="MqxJgYPhyP">
                    <label for="MqxJgYPhyP">Devops</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="fbbvDPFfmf">
                            <label for="fbbvDPFfmf">Cloud Providers</label>
                            <ul>
                                <l>
                                    <input type="checkbox" id="beeOOtzigC">
                                    <label for="beeOOtzigC">AWS</label>
                                    <ul>
                                        <l>
                                            <input type="checkbox" id="fOzKJjPkVl">
                                            <label for="fOzKJjPkVl">Cli</label>
                                            <ul>
                                        ...
                                        <l>
                                            <input type="checkbox" id="zxLsciTHVZ">
                                            <label for="zxLsciTHVZ">Dotnet</label>
                                            <ul>
                                        ...
                                        <l>
                                            <input type="checkbox" id="tEExidmzAo">
                                            <label for="tEExidmzAo">Ec 2</label>
                                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="TPAUNHQXTx">
                            <label for="TPAUNHQXTx">Events</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="TEQpSmKDYf">
                            <label for="TEQpSmKDYf">Localstack</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="hYLgXEwiyX">
                            <label for="hYLgXEwiyX">Pulumi</label>
                            <ul>
                                <l>
                                    <input type="checkbox" id="bkwyWSuZVd">
                                    <label for="bkwyWSuZVd">Dotnet</label>
                                    <ul>
                        ...
                        <l>
                            <input type="checkbox" id="NyXGJXNWop">
                            <label for="NyXGJXNWop">Serverless Framework</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="pZwlZYblta">
                            <label for="pZwlZYblta">Terraform</label>
                            <ul>
                                <l>
                                    <input type="checkbox" id="RVcELqakfG">
                                    <label for="RVcELqakfG">Functions</label>
                                    <ul>
                                ...
                                <l>
                                    <input type="checkbox" id="mlsrxPioXT">
                                    <label for="mlsrxPioXT">Meta Arguments</label>
                                    <ul>
                ...
                <l>
                    <input type="checkbox" id="agspRhAFjB">
                    <label for="agspRhAFjB">Docker</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="fIrcwxEwgq">
                    <label for="fIrcwxEwgq">Dotnet</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="bzGLZPiGXj">
                            <label for="bzGLZPiGXj">Cli</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="bcXjyuKuVa">
                    <label for="bcXjyuKuVa">Functional Programming</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="VUVjtFmbHw">
                    <label for="VUVjtFmbHw">Git</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="bDtsvzeGcZ">
                            <label for="bDtsvzeGcZ">Github</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="rutObXDPSd">
                    <label for="rutObXDPSd">Go</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="YLdQNiYvvw">
                    <label for="YLdQNiYvvw">Haskell</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="IYiQmhakQv">
                    <label for="IYiQmhakQv">Js</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="MyGETfoeql">
                            <label for="MyGETfoeql">Node</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="DNbGCqPCxh">
                            <label for="DNbGCqPCxh">D3</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="wnUJjSmsiO">
                            <label for="wnUJjSmsiO">Mocha</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="StycKZNtqk">
                            <label for="StycKZNtqk">P5js</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="DfqgqjaZgj">
                            <label for="DfqgqjaZgj">Typescript</label>
                            <ul>
                                <l>
                                    <input type="checkbox" id="wNNySVXQuT">
                                    <label for="wNNySVXQuT">Testing</label>
                                    <ul>
                ...
                <l>
                    <input type="checkbox" id="IERBiLweWO">
                    <label for="IERBiLweWO">Kafka</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="WwCjrubUVj">
                    <label for="WwCjrubUVj">Kubernetes</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="fhxyRdoFUM">
                    <label for="fhxyRdoFUM">Language</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="JoBTpssyci">
                    <label for="JoBTpssyci">Linux</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="hnLVIvFubG">
                            <label for="hnLVIvFubG">Bash</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="ADfEOvMZcv">
                    <label for="ADfEOvMZcv">Oauth</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="QcbiCNwNHX">
                    <label for="QcbiCNwNHX">Python</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="LjySgVBaWc">
                            <label for="LjySgVBaWc">Data Classes</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="aXsJzNZkcz">
                            <label for="aXsJzNZkcz">Libraries</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="JWnNzCPcXI">
                    <label for="JWnNzCPcXI">React</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="sHUfbbrNOg">
                    <label for="sHUfbbrNOg">Regular Expressions</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="ejEQBqXFjl">
                    <label for="ejEQBqXFjl">Rust</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="VNPrsbbNer">
                            <label for="VNPrsbbNer">Serde</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="StixaZUheg">
                    <label for="StixaZUheg">Shaders</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="nmmQyVOmbH">
                            <label for="nmmQyVOmbH">Glsl</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="OPeLfYQdce">
                    <label for="OPeLfYQdce">Vim</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="ewWFQyujkS">
                    <label for="ewWFQyujkS">Web</label>
                    <ul>
