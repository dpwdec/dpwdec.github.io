...
<ul>
    <div name="contents-index">
        ...
        <l>
            <input type="checkbox" id="ryZiOHXBDe" checked>
            <label for="ryZiOHXBDe">Math</label>
            <ul>
                <l>
                    <input type="checkbox" id="qVPatewbkW">
                    <label for="qVPatewbkW">Exponentials</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="VjQFfOjxzM">
                    <label for="VjQFfOjxzM">Linear Algebra</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="IXVZdWNzIO">
                    <label for="IXVZdWNzIO">Logarithms</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="RmvgnjcTLc">
                    <label for="RmvgnjcTLc">Sequences</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="xUHwmvtztN">
                    <label for="xUHwmvtztN">Single Variable Calculus</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="hlhipExFxL">
                    <label for="hlhipExFxL">Trigonometry</label>
                    <ul>
        ...
        <l>
            <input type="checkbox" id="wtLuDoXMWq" checked>
            <label for="wtLuDoXMWq">Programming</label>
            <ul>
                <l>
                    <input type="checkbox" id="MPcIJzbsmb">
                    <label for="MPcIJzbsmb">Ansible</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="YnzhwKvdBY">
                    <label for="YnzhwKvdBY">Architecture</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="UWNlHdvdZA">
                    <label for="UWNlHdvdZA">Computer Graphics</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="qMVpFWPbPN">
                    <label for="qMVpFWPbPN">Databases</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="dbQdBiKAfs">
                    <label for="dbQdBiKAfs">Devops</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="WyhalAamSc">
                            <label for="WyhalAamSc">Cloud Providers</label>
                            <ul>
                                <l>
                                    <input type="checkbox" id="pwbLokFfnL">
                                    <label for="pwbLokFfnL">AWS</label>
                                    <ul>
                                        <l>
                                            <input type="checkbox" id="DrCIAnEIGy">
                                            <label for="DrCIAnEIGy">Cli</label>
                                            <ul>
                                        ...
                                        <l>
                                            <input type="checkbox" id="GLsGBKuWoe">
                                            <label for="GLsGBKuWoe">Dotnet</label>
                                            <ul>
                                        ...
                                        <l>
                                            <input type="checkbox" id="QypidIEnkz">
                                            <label for="QypidIEnkz">Ec 2</label>
                                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="uXZTCBkxTb">
                            <label for="uXZTCBkxTb">Events</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="NtQFwlyxlq">
                            <label for="NtQFwlyxlq">Localstack</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="buHZNbxvpp">
                            <label for="buHZNbxvpp">Pulumi</label>
                            <ul>
                                <l>
                                    <input type="checkbox" id="tqJZrFRgGS">
                                    <label for="tqJZrFRgGS">Dotnet</label>
                                    <ul>
                        ...
                        <l>
                            <input type="checkbox" id="noWMMXCYcU">
                            <label for="noWMMXCYcU">Serverless Framework</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="CNpCsEzynZ">
                            <label for="CNpCsEzynZ">Terraform</label>
                            <ul>
                                <l>
                                    <input type="checkbox" id="neZgSAElNZ">
                                    <label for="neZgSAElNZ">Functions</label>
                                    <ul>
                                ...
                                <l>
                                    <input type="checkbox" id="qoFHPMAfjZ">
                                    <label for="qoFHPMAfjZ">Meta Arguments</label>
                                    <ul>
                ...
                <l>
                    <input type="checkbox" id="xUuZOqERIj">
                    <label for="xUuZOqERIj">Docker</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="RrZnqfCRoe">
                    <label for="RrZnqfCRoe">Dotnet</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="RjEJPyrtdP">
                            <label for="RjEJPyrtdP">Cli</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="xPugYPRZnc">
                    <label for="xPugYPRZnc">Functional Programming</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="RrnmaqBPuI">
                    <label for="RrnmaqBPuI">Git</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="DPdNdbVtQR">
                            <label for="DPdNdbVtQR">Github</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="fubeykxIjD">
                    <label for="fubeykxIjD">Go</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="CTcRNZuBGL">
                    <label for="CTcRNZuBGL">Haskell</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="JCUzPdDFKz">
                    <label for="JCUzPdDFKz">Js</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="hitWRNLIQX">
                            <label for="hitWRNLIQX">Node</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="vMWFdhhmsd">
                            <label for="vMWFdhhmsd">D3</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="QBpBjNIWUy">
                            <label for="QBpBjNIWUy">Mocha</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="sdjafDjyzZ">
                            <label for="sdjafDjyzZ">P5js</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="dAbrUEZFgv">
                            <label for="dAbrUEZFgv">Typescript</label>
                            <ul>
                                <l>
                                    <input type="checkbox" id="dPHMwLUdGh">
                                    <label for="dPHMwLUdGh">Testing</label>
                                    <ul>
                ...
                <l>
                    <input type="checkbox" id="nZnVqnjHxP">
                    <label for="nZnVqnjHxP">Kafka</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="PHPIFkdzRR">
                    <label for="PHPIFkdzRR">Kubernetes</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="oLJoNmPYRM">
                    <label for="oLJoNmPYRM">Language</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="YBwGdBXEmS">
                    <label for="YBwGdBXEmS">Linux</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="xWnNyCINjP">
                            <label for="xWnNyCINjP">Bash</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="HbQREzPASr">
                    <label for="HbQREzPASr">Oauth</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="IUjmrHwWsQ">
                    <label for="IUjmrHwWsQ">Prometheus</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="VIMKSYXNPu">
                    <label for="VIMKSYXNPu">Python</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="muqzGghpuE">
                            <label for="muqzGghpuE">Data Classes</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="GbrHyxfCvL">
                            <label for="GbrHyxfCvL">Libraries</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="CkZrcsLkAv">
                    <label for="CkZrcsLkAv">React</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="CSjCwZhwIF">
                    <label for="CSjCwZhwIF">Regular Expressions</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="JzsWPELreC">
                    <label for="JzsWPELreC">Rust</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="DfvJsmgQeN">
                            <label for="DfvJsmgQeN">Serde</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="pOShLzupyF">
                    <label for="pOShLzupyF">Shaders</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="iypAXyCxKd">
                            <label for="iypAXyCxKd">Glsl</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="sFkqkJgIOE">
                    <label for="sFkqkJgIOE">Vim</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="ABLwiroTTA">
                    <label for="ABLwiroTTA">Web</label>
                    <ul>
