...
<ul>
    <div name="contents-index">
        ...
        <l>
            <input type="checkbox" id="uOoRXIFqcJ" checked>
            <label for="uOoRXIFqcJ">Math</label>
            <ul>
                <l>
                    <input type="checkbox" id="OHWnjgDQxZ">
                    <label for="OHWnjgDQxZ">Exponentials</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="jIyEHLBhKa">
                    <label for="jIyEHLBhKa">Linear Algebra</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="NObSgymeRF">
                    <label for="NObSgymeRF">Logarithms</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="pijivamQsd">
                    <label for="pijivamQsd">Sequences</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="KRwTAkJLuf">
                    <label for="KRwTAkJLuf">Single Variable Calculus</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="RrpQUHcvGr">
                    <label for="RrpQUHcvGr">Trigonometry</label>
                    <ul>
        ...
        <l>
            <input type="checkbox" id="xlYeGLWNNz" checked>
            <label for="xlYeGLWNNz">Programming</label>
            <ul>
                <l>
                    <input type="checkbox" id="mBwnZtpbGb">
                    <label for="mBwnZtpbGb">Ansible</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="YXFBfoYKsp">
                    <label for="YXFBfoYKsp">Architecture</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="dMeiElcTan">
                    <label for="dMeiElcTan">Computer Graphics</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="HsKkIRFiCX">
                    <label for="HsKkIRFiCX">Databases</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="WNIsICgTaU">
                    <label for="WNIsICgTaU">Devops</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="DvAHyqMWXN">
                            <label for="DvAHyqMWXN">Cloud Providers</label>
                            <ul>
                                <l>
                                    <input type="checkbox" id="EAPNonAOIK">
                                    <label for="EAPNonAOIK">AWS</label>
                                    <ul>
                                        <l>
                                            <input type="checkbox" id="qkrNztFDkL">
                                            <label for="qkrNztFDkL">Cli</label>
                                            <ul>
                                        ...
                                        <l>
                                            <input type="checkbox" id="PVHkghLCuy">
                                            <label for="PVHkghLCuy">Dotnet</label>
                                            <ul>
                                        ...
                                        <l>
                                            <input type="checkbox" id="VTZvPxxGBA">
                                            <label for="VTZvPxxGBA">Ec 2</label>
                                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="KAOaCCCrAg">
                            <label for="KAOaCCCrAg">Events</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="pYWwJAujCw">
                            <label for="pYWwJAujCw">Localstack</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="WcVdZKYXik">
                            <label for="WcVdZKYXik">Pulumi</label>
                            <ul>
                                <l>
                                    <input type="checkbox" id="nkEDyyFycm">
                                    <label for="nkEDyyFycm">Dotnet</label>
                                    <ul>
                        ...
                        <l>
                            <input type="checkbox" id="hAFxzROprP">
                            <label for="hAFxzROprP">Serverless Framework</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="KlxDrYadoz">
                            <label for="KlxDrYadoz">Terraform</label>
                            <ul>
                                <l>
                                    <input type="checkbox" id="GPwhyuhcrJ">
                                    <label for="GPwhyuhcrJ">Functions</label>
                                    <ul>
                                ...
                                <l>
                                    <input type="checkbox" id="NMxNsEHJYT">
                                    <label for="NMxNsEHJYT">Meta Arguments</label>
                                    <ul>
                ...
                <l>
                    <input type="checkbox" id="oMpiJSnVfL">
                    <label for="oMpiJSnVfL">Docker</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="TjujPZYFaE">
                    <label for="TjujPZYFaE">Dotnet</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="jbvTddQvWs">
                            <label for="jbvTddQvWs">Cli</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="BFyESRsZKA">
                    <label for="BFyESRsZKA">Functional Programming</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="QTuisfCxFL">
                    <label for="QTuisfCxFL">Git</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="OsUQZBXITD">
                            <label for="OsUQZBXITD">Github</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="GHtwpxNiGc">
                    <label for="GHtwpxNiGc">Go</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="IkAucEQgJA">
                    <label for="IkAucEQgJA">Haskell</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="wHCdifTnlH">
                    <label for="wHCdifTnlH">Js</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="ImuRCyXdnM">
                            <label for="ImuRCyXdnM">Node</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="sDhEjeDdOd">
                            <label for="sDhEjeDdOd">D3</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="StnacXQDuq">
                            <label for="StnacXQDuq">Mocha</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="mfOQFubPGs">
                            <label for="mfOQFubPGs">P5js</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="rGRbZWDGgs">
                            <label for="rGRbZWDGgs">Typescript</label>
                            <ul>
                                <l>
                                    <input type="checkbox" id="XLwyCblcix">
                                    <label for="XLwyCblcix">Testing</label>
                                    <ul>
                ...
                <l>
                    <input type="checkbox" id="kUzyJTYprF">
                    <label for="kUzyJTYprF">Kafka</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="feqfcNPPMq">
                    <label for="feqfcNPPMq">Kubernetes</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="prdZZdyDJg">
                    <label for="prdZZdyDJg">Language</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="zeTFDSKqEg">
                    <label for="zeTFDSKqEg">Linux</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="YpaGwXHNls">
                            <label for="YpaGwXHNls">Bash</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="FoImHoEiOb">
                    <label for="FoImHoEiOb">Oauth</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="ebvnmYGAYI">
                    <label for="ebvnmYGAYI">Python</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="ZADZGwJdOx">
                            <label for="ZADZGwJdOx">Data Classes</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="UfrBDemEGf">
                            <label for="UfrBDemEGf">Libraries</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="ozuGvoyqoy">
                    <label for="ozuGvoyqoy">React</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="TqqDURJilp">
                    <label for="TqqDURJilp">Regular Expressions</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="cjJEMLExXU">
                    <label for="cjJEMLExXU">Rust</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="UhYKOncFEx">
                            <label for="UhYKOncFEx">Serde</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="GAuwjJMOQS">
                    <label for="GAuwjJMOQS">Shaders</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="YtUsIOCKwO">
                            <label for="YtUsIOCKwO">Glsl</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="lyEmkDjskH">
                    <label for="lyEmkDjskH">Vim</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="fHaxjfKKiL">
                    <label for="fHaxjfKKiL">Web</label>
                    <ul>
