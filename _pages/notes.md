...
<ul>
    <div name="contents-index">
        ...
        <l>
            <input type="checkbox" id="DNcgGAKVai" checked>
            <label for="DNcgGAKVai">Math</label>
            <ul>
                <l>
                    <input type="checkbox" id="yJzEHaJhdz">
                    <label for="yJzEHaJhdz">Exponentials</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="eNUbtVqTin">
                    <label for="eNUbtVqTin">Linear Algebra</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="bTxRhZNYdB">
                    <label for="bTxRhZNYdB">Logarithms</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="lxhcPAPwTo">
                    <label for="lxhcPAPwTo">Sequences</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="vFufSrbSRJ">
                    <label for="vFufSrbSRJ">Single Variable Calculus</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="jkJPFiMKAw">
                    <label for="jkJPFiMKAw">Trigonometry</label>
                    <ul>
        ...
        <l>
            <input type="checkbox" id="MiKcVbhhFt" checked>
            <label for="MiKcVbhhFt">Programming</label>
            <ul>
                <l>
                    <input type="checkbox" id="rkEjsEWfYW">
                    <label for="rkEjsEWfYW">Ansible</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="QmcIpdQySe">
                    <label for="QmcIpdQySe">Architecture</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="lYYSHnfnrB">
                    <label for="lYYSHnfnrB">Computer Graphics</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="VnXpNQyogJ">
                    <label for="VnXpNQyogJ">Databases</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="bAdZHMCDFv">
                    <label for="bAdZHMCDFv">Devops</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="SEvzsQxSWQ">
                            <label for="SEvzsQxSWQ">Cloud Providers</label>
                            <ul>
                                <l>
                                    <input type="checkbox" id="gcuGZiueIJ">
                                    <label for="gcuGZiueIJ">AWS</label>
                                    <ul>
                                        <l>
                                            <input type="checkbox" id="oNjNDyeKgu">
                                            <label for="oNjNDyeKgu">Cli</label>
                                            <ul>
                                        ...
                                        <l>
                                            <input type="checkbox" id="nuywKZBsKg">
                                            <label for="nuywKZBsKg">Dotnet</label>
                                            <ul>
                                        ...
                                        <l>
                                            <input type="checkbox" id="XhpIEZpFht">
                                            <label for="XhpIEZpFht">Ec 2</label>
                                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="koktsDYGMy">
                            <label for="koktsDYGMy">Events</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="pchjTJYwlC">
                            <label for="pchjTJYwlC">Localstack</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="OsCubQpMYB">
                            <label for="OsCubQpMYB">Pulumi</label>
                            <ul>
                                <l>
                                    <input type="checkbox" id="lfRwGmIYkm">
                                    <label for="lfRwGmIYkm">Dotnet</label>
                                    <ul>
                        ...
                        <l>
                            <input type="checkbox" id="SRcONoKVag">
                            <label for="SRcONoKVag">Serverless Framework</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="gdUTFNEvuJ">
                            <label for="gdUTFNEvuJ">Terraform</label>
                            <ul>
                                <l>
                                    <input type="checkbox" id="fwWaWgrBVn">
                                    <label for="fwWaWgrBVn">Functions</label>
                                    <ul>
                                ...
                                <l>
                                    <input type="checkbox" id="EGNHAnkFQc">
                                    <label for="EGNHAnkFQc">Meta Arguments</label>
                                    <ul>
                ...
                <l>
                    <input type="checkbox" id="AcArfBxGXj">
                    <label for="AcArfBxGXj">Docker</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="uAQzRREfoM">
                    <label for="uAQzRREfoM">Dotnet</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="cjFGGLnerX">
                            <label for="cjFGGLnerX">Cli</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="lqhMFxYosq">
                    <label for="lqhMFxYosq">Functional Programming</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="iYCNHuXNhN">
                    <label for="iYCNHuXNhN">Git</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="rjcFOddDpG">
                            <label for="rjcFOddDpG">Github</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="LzHdMEmaur">
                    <label for="LzHdMEmaur">Go</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="KEgbXGLbMJ">
                    <label for="KEgbXGLbMJ">Haskell</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="LAhYSIIWBe">
                    <label for="LAhYSIIWBe">Js</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="HNIwrNkqJt">
                            <label for="HNIwrNkqJt">Node</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="nZhSeyZStX">
                            <label for="nZhSeyZStX">D3</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="gFHVelVKBx">
                            <label for="gFHVelVKBx">Mocha</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="PDYzzJMrdo">
                            <label for="PDYzzJMrdo">P5js</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="fDLmtinsWz">
                            <label for="fDLmtinsWz">Typescript</label>
                            <ul>
                                <l>
                                    <input type="checkbox" id="mkwOdhFkhf">
                                    <label for="mkwOdhFkhf">Testing</label>
                                    <ul>
                ...
                <l>
                    <input type="checkbox" id="MNKjjJuDtn">
                    <label for="MNKjjJuDtn">Kafka</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="HjPViAfOFi">
                    <label for="HjPViAfOFi">Kubernetes</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="UPkfULuJth">
                    <label for="UPkfULuJth">Language</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="TKgVkQPhHh">
                    <label for="TKgVkQPhHh">Linux</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="WlGOZhcYff">
                            <label for="WlGOZhcYff">Bash</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="felYKPHrJe">
                    <label for="felYKPHrJe">Oauth</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="mYJLfnpozR">
                    <label for="mYJLfnpozR">Python</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="cqZKMsSSom">
                            <label for="cqZKMsSSom">Data Classes</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="vkpipaXMCe">
                            <label for="vkpipaXMCe">Libraries</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="tstYbtOcMG">
                    <label for="tstYbtOcMG">React</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="RanwlefUJz">
                    <label for="RanwlefUJz">Regular Expressions</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="lvwHxZvtco">
                    <label for="lvwHxZvtco">Rust</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="XSIOPOdPsB">
                            <label for="XSIOPOdPsB">Serde</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="aqynZzvQOT">
                    <label for="aqynZzvQOT">Vim</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="HigUffkpbh">
                    <label for="HigUffkpbh">Web</label>
                    <ul>
