...
<ul>
    <div name="contents-index">
        ...
        <l>
            <input type="checkbox" id="crieYAvjSY" checked>
            <label for="crieYAvjSY">Math</label>
            <ul>
                <l>
                    <input type="checkbox" id="bmCChxBSYg">
                    <label for="bmCChxBSYg">Exponentials</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="QXJyZvNwJJ">
                    <label for="QXJyZvNwJJ">Linear Algebra</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="euTuaVwdrE">
                    <label for="euTuaVwdrE">Logarithms</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="TQlhTTrwXf">
                    <label for="TQlhTTrwXf">Sequences</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="qmyRjyllAk">
                    <label for="qmyRjyllAk">Single Variable Calculus</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="ElEmKXJnfp">
                    <label for="ElEmKXJnfp">Trigonometry</label>
                    <ul>
        ...
        <l>
            <input type="checkbox" id="XPEOsuNotM" checked>
            <label for="XPEOsuNotM">Programming</label>
            <ul>
                <l>
                    <input type="checkbox" id="NcLmIBlkMR">
                    <label for="NcLmIBlkMR">Ansible</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="tQIvrkKJfo">
                    <label for="tQIvrkKJfo">Architecture</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="PoOxZLHipY">
                    <label for="PoOxZLHipY">Computer Graphics</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="IEetiPPxCd">
                    <label for="IEetiPPxCd">Databases</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="ZoPAxYVwXN">
                    <label for="ZoPAxYVwXN">Devops</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="JZwtGaXBFE">
                            <label for="JZwtGaXBFE">Cloud Computing</label>
                            <ul>
                                <l>
                                    <input type="checkbox" id="yHUAxcXIcG">
                                    <label for="yHUAxcXIcG">AWS</label>
                                    <ul>
                                        <l>
                                            <input type="checkbox" id="IKRDszrjPZ">
                                            <label for="IKRDszrjPZ">Cli</label>
                                            <ul>
                                        ...
                                        <l>
                                            <input type="checkbox" id="uFirlKKVNN">
                                            <label for="uFirlKKVNN">Dotnet</label>
                                            <ul>
                                        ...
                                        <l>
                                            <input type="checkbox" id="BufyozPzvQ">
                                            <label for="BufyozPzvQ">Ec 2</label>
                                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="BsGezGpjXL">
                            <label for="BsGezGpjXL">Events</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="UyBztJZozt">
                            <label for="UyBztJZozt">Oauth</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="pOvRIPwatQ">
                            <label for="pOvRIPwatQ">Pulumi</label>
                            <ul>
                                <l>
                                    <input type="checkbox" id="YQeUbEXxOV">
                                    <label for="YQeUbEXxOV">Dotnet</label>
                                    <ul>
                        ...
                        <l>
                            <input type="checkbox" id="BQPwEqRreO">
                            <label for="BQPwEqRreO">Terraform</label>
                            <ul>
                                <l>
                                    <input type="checkbox" id="GzYPgqujkh">
                                    <label for="GzYPgqujkh">Functions</label>
                                    <ul>
                                ...
                                <l>
                                    <input type="checkbox" id="HWpMGXtbjM">
                                    <label for="HWpMGXtbjM">Meta Arguments</label>
                                    <ul>
                ...
                <l>
                    <input type="checkbox" id="PsmCeGeTsA">
                    <label for="PsmCeGeTsA">Docker</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="vqsaWyXYmP">
                    <label for="vqsaWyXYmP">Dotnet</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="sjkfOQJDWB">
                            <label for="sjkfOQJDWB">Cli</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="EAJDhNHmcY">
                    <label for="EAJDhNHmcY">Functional Programming</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="RxkcVfNqPv">
                    <label for="RxkcVfNqPv">Git</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="aKEnVfHNOw">
                            <label for="aKEnVfHNOw">Github</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="lXKXhjFLgN">
                    <label for="lXKXhjFLgN">Go</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="ukiXoNohYg">
                    <label for="ukiXoNohYg">Haskell</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="FjIQeQwwXK">
                    <label for="FjIQeQwwXK">Js</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="uMpPQZAWkz">
                            <label for="uMpPQZAWkz">Node</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="EAaobvcMpX">
                            <label for="EAaobvcMpX">Mocha</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="RxCGCRTiVL">
                            <label for="RxCGCRTiVL">P5js</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="KMIAuLwGkH">
                            <label for="KMIAuLwGkH">Typescript</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="hokdsFqEeZ">
                    <label for="hokdsFqEeZ">Kafka</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="uIogoLDocX">
                    <label for="uIogoLDocX">Kubernetes</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="ZxWnlBNxzm">
                    <label for="ZxWnlBNxzm">Language</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="gfPztbGzMl">
                    <label for="gfPztbGzMl">Linux</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="aCdyZXheAA">
                    <label for="aCdyZXheAA">Python</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="aplVWcsrBe">
                            <label for="aplVWcsrBe">Data Classes</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="IYvOFyKqHU">
                            <label for="IYvOFyKqHU">Libraries</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="SYefwVxfUF">
                    <label for="SYefwVxfUF">React</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="oPnkOCGPeV">
                    <label for="oPnkOCGPeV">Regular Expressions</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="IdMbMfEYBu">
                    <label for="IdMbMfEYBu">Rust</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="fmPHAiTyDp">
                            <label for="fmPHAiTyDp">Serde</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="oHFjLwSyAw">
                    <label for="oHFjLwSyAw">Vim</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="MwpzAaHZuE">
                    <label for="MwpzAaHZuE">Web</label>
                    <ul>
