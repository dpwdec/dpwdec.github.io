...
<ul>
    <div name="contents-index">
        ...
        <l>
            <input type="checkbox" id="uQmrpVUZXV" checked>
            <label for="uQmrpVUZXV">Math</label>
            <ul>
                <l>
                    <input type="checkbox" id="TBOqQgDbpG">
                    <label for="TBOqQgDbpG">Exponentials</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="LTjbyXpATw">
                    <label for="LTjbyXpATw">Linear Algebra</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="mDaKRadTKO">
                    <label for="mDaKRadTKO">Logarithms</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="BzfvBtfOfd">
                    <label for="BzfvBtfOfd">Sequences</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="YyWvbOPLmg">
                    <label for="YyWvbOPLmg">Single Variable Calculus</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="dABwpGxTnq">
                    <label for="dABwpGxTnq">Trigonometry</label>
                    <ul>
        ...
        <l>
            <input type="checkbox" id="FbDOJlaORw" checked>
            <label for="FbDOJlaORw">Programming</label>
            <ul>
                <l>
                    <input type="checkbox" id="DEahWEZIXU">
                    <label for="DEahWEZIXU">Ansible</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="TZDzKhgdQv">
                    <label for="TZDzKhgdQv">Architecture</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="FQPwpvAFNj">
                    <label for="FQPwpvAFNj">Computer Graphics</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="LbWUJsHUAN">
                    <label for="LbWUJsHUAN">Databases</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="BoLnzaRGBg">
                    <label for="BoLnzaRGBg">Devops</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="KtvnlNpCdW">
                            <label for="KtvnlNpCdW">Cloud Providers</label>
                            <ul>
                                <l>
                                    <input type="checkbox" id="CZjABHTVGe">
                                    <label for="CZjABHTVGe">AWS</label>
                                    <ul>
                                        <l>
                                            <input type="checkbox" id="xeCMFyrlHp">
                                            <label for="xeCMFyrlHp">Cli</label>
                                            <ul>
                                        ...
                                        <l>
                                            <input type="checkbox" id="QYoEXqPPPg">
                                            <label for="QYoEXqPPPg">Dotnet</label>
                                            <ul>
                                        ...
                                        <l>
                                            <input type="checkbox" id="YzvsqUulEN">
                                            <label for="YzvsqUulEN">Ec 2</label>
                                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="QalkFnpTRU">
                            <label for="QalkFnpTRU">Events</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="CELSDRsMxv">
                            <label for="CELSDRsMxv">Localstack</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="cUhmPyxhRo">
                            <label for="cUhmPyxhRo">Pulumi</label>
                            <ul>
                                <l>
                                    <input type="checkbox" id="nIYRBJoEDd">
                                    <label for="nIYRBJoEDd">Dotnet</label>
                                    <ul>
                        ...
                        <l>
                            <input type="checkbox" id="BAAtwLjquF">
                            <label for="BAAtwLjquF">Serverless Framework</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="VXdflcdZqH">
                            <label for="VXdflcdZqH">Terraform</label>
                            <ul>
                                <l>
                                    <input type="checkbox" id="tqmAKNGcgk">
                                    <label for="tqmAKNGcgk">Functions</label>
                                    <ul>
                                ...
                                <l>
                                    <input type="checkbox" id="mQmhTWiJUi">
                                    <label for="mQmhTWiJUi">Meta Arguments</label>
                                    <ul>
                ...
                <l>
                    <input type="checkbox" id="ZcdmXttyqE">
                    <label for="ZcdmXttyqE">Docker</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="vPfKuiwsUl">
                    <label for="vPfKuiwsUl">Dotnet</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="QdTijJPNth">
                            <label for="QdTijJPNth">Cli</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="RibkizMfss">
                    <label for="RibkizMfss">Functional Programming</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="BWGbJvnSAy">
                    <label for="BWGbJvnSAy">Git</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="eATkdyLKrx">
                            <label for="eATkdyLKrx">Github</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="DbFztVPIgs">
                    <label for="DbFztVPIgs">Go</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="XKwBoYHiuG">
                    <label for="XKwBoYHiuG">Haskell</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="FWXunxHODU">
                    <label for="FWXunxHODU">Js</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="ZsacSdeeqz">
                            <label for="ZsacSdeeqz">Node</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="rkKHchPTWS">
                            <label for="rkKHchPTWS">D3</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="UnEMfbYDxC">
                            <label for="UnEMfbYDxC">Mocha</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="hXYuktvTLc">
                            <label for="hXYuktvTLc">P5js</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="jcIINygTUu">
                            <label for="jcIINygTUu">Typescript</label>
                            <ul>
                                <l>
                                    <input type="checkbox" id="XQzDDRpwzu">
                                    <label for="XQzDDRpwzu">Testing</label>
                                    <ul>
                ...
                <l>
                    <input type="checkbox" id="NKvPlIdTud">
                    <label for="NKvPlIdTud">Kafka</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="sBqbfmjTIj">
                    <label for="sBqbfmjTIj">Kubernetes</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="rKOGOhaIJh">
                    <label for="rKOGOhaIJh">Language</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="JYVcKmJJyo">
                    <label for="JYVcKmJJyo">Linux</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="oDkDmfQXKb">
                            <label for="oDkDmfQXKb">Bash</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="nWZoscIASQ">
                    <label for="nWZoscIASQ">Oauth</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="aJXiUUePnX">
                    <label for="aJXiUUePnX">Python</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="JXTMnQLgpx">
                            <label for="JXTMnQLgpx">Data Classes</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="ABpIHFHdpR">
                            <label for="ABpIHFHdpR">Libraries</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="dBmaBxXDEW">
                    <label for="dBmaBxXDEW">React</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="lCcnqsPtmd">
                    <label for="lCcnqsPtmd">Regular Expressions</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="KcJsiyvSad">
                    <label for="KcJsiyvSad">Rust</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="BTxZvgzMtp">
                            <label for="BTxZvgzMtp">Serde</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="pUxxEISBFy">
                    <label for="pUxxEISBFy">Shaders</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="WZzHfKrYjA">
                            <label for="WZzHfKrYjA">Glsl</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="MbMObpsTTE">
                    <label for="MbMObpsTTE">Vim</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="oMZouAHKFq">
                    <label for="oMZouAHKFq">Web</label>
                    <ul>
