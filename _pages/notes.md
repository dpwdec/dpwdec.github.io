...
<ul>
    <div name="contents-index">
        ...
        <l>
            <input type="checkbox" id="RyjBGYJzzw" checked>
            <label for="RyjBGYJzzw">Math</label>
            <ul>
                <l>
                    <input type="checkbox" id="zZfEKIHrPi">
                    <label for="zZfEKIHrPi">Exponentials</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="SOFLYlTUoC">
                    <label for="SOFLYlTUoC">Linear Algebra</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="LwlimnNJNo">
                    <label for="LwlimnNJNo">Logarithms</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="kKlInWYyoE">
                    <label for="kKlInWYyoE">Sequences</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="yGDresKHxd">
                    <label for="yGDresKHxd">Single Variable Calculus</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="zWGLFtdFgZ">
                    <label for="zWGLFtdFgZ">Trigonometry</label>
                    <ul>
        ...
        <l>
            <input type="checkbox" id="aVxBlvLtUn" checked>
            <label for="aVxBlvLtUn">Programming</label>
            <ul>
                <l>
                    <input type="checkbox" id="MoOwqrCuDj">
                    <label for="MoOwqrCuDj">Ansible</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="SOApriFNrp">
                    <label for="SOApriFNrp">Architecture</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="fserFdNoMR">
                    <label for="fserFdNoMR">Computer Graphics</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="vZMVPYTkRT">
                    <label for="vZMVPYTkRT">Databases</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="vBBakjlnli">
                    <label for="vBBakjlnli">Devops</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="AHmhBGCvzy">
                            <label for="AHmhBGCvzy">Cloud Providers</label>
                            <ul>
                                <l>
                                    <input type="checkbox" id="BXwPPpBSLZ">
                                    <label for="BXwPPpBSLZ">AWS</label>
                                    <ul>
                                        <l>
                                            <input type="checkbox" id="NtdHXtceom">
                                            <label for="NtdHXtceom">Cli</label>
                                            <ul>
                                        ...
                                        <l>
                                            <input type="checkbox" id="nzOAQCkgPL">
                                            <label for="nzOAQCkgPL">Dotnet</label>
                                            <ul>
                                        ...
                                        <l>
                                            <input type="checkbox" id="obikbMmfZu">
                                            <label for="obikbMmfZu">Ec 2</label>
                                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="FkkkTPRSNs">
                            <label for="FkkkTPRSNs">Events</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="hflxdacXXf">
                            <label for="hflxdacXXf">Localstack</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="hrMpdcIMrz">
                            <label for="hrMpdcIMrz">Pulumi</label>
                            <ul>
                                <l>
                                    <input type="checkbox" id="ZnjHODmFOk">
                                    <label for="ZnjHODmFOk">Dotnet</label>
                                    <ul>
                        ...
                        <l>
                            <input type="checkbox" id="JNzaPxsMKL">
                            <label for="JNzaPxsMKL">Serverless Framework</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="CykkHsDiUP">
                            <label for="CykkHsDiUP">Terraform</label>
                            <ul>
                                <l>
                                    <input type="checkbox" id="IrAtMbSnwT">
                                    <label for="IrAtMbSnwT">Functions</label>
                                    <ul>
                                ...
                                <l>
                                    <input type="checkbox" id="qPdfjtiUOq">
                                    <label for="qPdfjtiUOq">Meta Arguments</label>
                                    <ul>
                ...
                <l>
                    <input type="checkbox" id="Poabrabplr">
                    <label for="Poabrabplr">Docker</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="RBKmzaXlID">
                    <label for="RBKmzaXlID">Dotnet</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="vOyVOBAmvi">
                            <label for="vOyVOBAmvi">Cli</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="urjEwkjQjZ">
                    <label for="urjEwkjQjZ">Functional Programming</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="dVytoGovmG">
                    <label for="dVytoGovmG">Git</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="meazAqkxQo">
                            <label for="meazAqkxQo">Github</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="ZEvnxEIAko">
                    <label for="ZEvnxEIAko">Go</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="rWuvaFSRzx">
                    <label for="rWuvaFSRzx">Haskell</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="oAzLaqAqWi">
                    <label for="oAzLaqAqWi">Js</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="ZncPEBLHFg">
                            <label for="ZncPEBLHFg">Node</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="FycBwdkNMr">
                            <label for="FycBwdkNMr">D3</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="qZRWeKWGPh">
                            <label for="qZRWeKWGPh">Mocha</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="ExkNCMlKZL">
                            <label for="ExkNCMlKZL">P5js</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="dTsvMjeowo">
                            <label for="dTsvMjeowo">Typescript</label>
                            <ul>
                                <l>
                                    <input type="checkbox" id="jKbaXonCQy">
                                    <label for="jKbaXonCQy">Testing</label>
                                    <ul>
                ...
                <l>
                    <input type="checkbox" id="cfsExLAvws">
                    <label for="cfsExLAvws">Kafka</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="JcrUYOmqDR">
                    <label for="JcrUYOmqDR">Kubernetes</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="SmkUEGewuW">
                    <label for="SmkUEGewuW">Language</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="MHTmPWfkgW">
                    <label for="MHTmPWfkgW">Linux</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="SepzUAajeW">
                            <label for="SepzUAajeW">Bash</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="DEAwzygCsX">
                    <label for="DEAwzygCsX">Oauth</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="OURoyYwMmo">
                    <label for="OURoyYwMmo">Python</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="YfaZtSaxOE">
                            <label for="YfaZtSaxOE">Data Classes</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="OqdxAalKWJ">
                            <label for="OqdxAalKWJ">Libraries</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="YkHyQsKAjO">
                    <label for="YkHyQsKAjO">React</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="aiJgeGLSex">
                    <label for="aiJgeGLSex">Regular Expressions</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="ZGGChvmYUs">
                    <label for="ZGGChvmYUs">Rust</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="mjEGzCqEvU">
                            <label for="mjEGzCqEvU">Serde</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="viAstRbzNG">
                    <label for="viAstRbzNG">Shaders</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="BXbIeudjfo">
                            <label for="BXbIeudjfo">Glsl</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="tJtylYlshd">
                    <label for="tJtylYlshd">Vim</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="MGGACsaMHO">
                    <label for="MGGACsaMHO">Web</label>
                    <ul>
