...
<ul>
    <div name="contents-index">
        ...
        <l>
            <input type="checkbox" id="gbGMJosjVi" checked>
            <label for="gbGMJosjVi">Math</label>
            <ul>
                <l>
                    <input type="checkbox" id="JOyprlaGiP">
                    <label for="JOyprlaGiP">Exponentials</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="rOpElYhpSm">
                    <label for="rOpElYhpSm">Linear Algebra</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="OmznkzwpPq">
                    <label for="OmznkzwpPq">Logarithms</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="pDuYMICHAr">
                    <label for="pDuYMICHAr">Sequences</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="rBfahlUevA">
                    <label for="rBfahlUevA">Single Variable Calculus</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="BGWpPoelkF">
                    <label for="BGWpPoelkF">Trigonometry</label>
                    <ul>
        ...
        <l>
            <input type="checkbox" id="ecpPLcNFpe" checked>
            <label for="ecpPLcNFpe">Programming</label>
            <ul>
                <l>
                    <input type="checkbox" id="JOvDPEETCj">
                    <label for="JOvDPEETCj">Ansible</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="PYWJlbbgEi">
                    <label for="PYWJlbbgEi">Architecture</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="MCFqWosjsQ">
                    <label for="MCFqWosjsQ">Computer Graphics</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="fjPGBuVVuc">
                    <label for="fjPGBuVVuc">Databases</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="KLtsuAdGYS">
                    <label for="KLtsuAdGYS">Devops</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="yKpZIJtOyK">
                            <label for="yKpZIJtOyK">Cloud Providers</label>
                            <ul>
                                <l>
                                    <input type="checkbox" id="oTnLAeLUiF">
                                    <label for="oTnLAeLUiF">AWS</label>
                                    <ul>
                                        <l>
                                            <input type="checkbox" id="GoIaYoYKFr">
                                            <label for="GoIaYoYKFr">Cli</label>
                                            <ul>
                                        ...
                                        <l>
                                            <input type="checkbox" id="EnEKMTrdUR">
                                            <label for="EnEKMTrdUR">Dotnet</label>
                                            <ul>
                                        ...
                                        <l>
                                            <input type="checkbox" id="QkJJMYFbkg">
                                            <label for="QkJJMYFbkg">Ec 2</label>
                                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="wHOrHMnFZl">
                            <label for="wHOrHMnFZl">Events</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="IjuUWgfbYQ">
                            <label for="IjuUWgfbYQ">Localstack</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="zoqLUufXUM">
                            <label for="zoqLUufXUM">Pulumi</label>
                            <ul>
                                <l>
                                    <input type="checkbox" id="mMVrVktJez">
                                    <label for="mMVrVktJez">Dotnet</label>
                                    <ul>
                        ...
                        <l>
                            <input type="checkbox" id="IUBgXlNJka">
                            <label for="IUBgXlNJka">Serverless Framework</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="CgXZrDcggo">
                            <label for="CgXZrDcggo">Terraform</label>
                            <ul>
                                <l>
                                    <input type="checkbox" id="JJodzljhYo">
                                    <label for="JJodzljhYo">Functions</label>
                                    <ul>
                                ...
                                <l>
                                    <input type="checkbox" id="poePAhVbtu">
                                    <label for="poePAhVbtu">Meta Arguments</label>
                                    <ul>
                ...
                <l>
                    <input type="checkbox" id="DjgNrKQXET">
                    <label for="DjgNrKQXET">Docker</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="fIdzPWDAXG">
                    <label for="fIdzPWDAXG">Dotnet</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="PtiafIZezo">
                            <label for="PtiafIZezo">Cli</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="OfiREQnNGL">
                    <label for="OfiREQnNGL">Functional Programming</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="DzzqwtHOAP">
                    <label for="DzzqwtHOAP">Git</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="lcLVUEAOge">
                            <label for="lcLVUEAOge">Github</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="ZMwKgvmLIg">
                    <label for="ZMwKgvmLIg">Go</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="yKheqxECSx">
                    <label for="yKheqxECSx">Haskell</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="KMUIORUvSp">
                    <label for="KMUIORUvSp">Js</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="XgTcFBhStF">
                            <label for="XgTcFBhStF">Node</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="lRRtEgLJOU">
                            <label for="lRRtEgLJOU">D3</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="ACBcjUKlog">
                            <label for="ACBcjUKlog">Mocha</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="kZtQTWIDZv">
                            <label for="kZtQTWIDZv">P5js</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="XCbwZCRhnP">
                            <label for="XCbwZCRhnP">Typescript</label>
                            <ul>
                                <l>
                                    <input type="checkbox" id="LZukscfjng">
                                    <label for="LZukscfjng">Testing</label>
                                    <ul>
                ...
                <l>
                    <input type="checkbox" id="YaHSrDhKwr">
                    <label for="YaHSrDhKwr">Kafka</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="BbWVXPtPzi">
                    <label for="BbWVXPtPzi">Kubernetes</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="tpLRnJzGVL">
                    <label for="tpLRnJzGVL">Language</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="NLXcuHUXZr">
                    <label for="NLXcuHUXZr">Linux</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="PgUArVdxjW">
                            <label for="PgUArVdxjW">Bash</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="hTtvlEGAcU">
                    <label for="hTtvlEGAcU">Oauth</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="hJVzXYhjEY">
                    <label for="hJVzXYhjEY">Prometheus</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="dKFKYJxqet">
                    <label for="dKFKYJxqet">Python</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="agbquSTxks">
                            <label for="agbquSTxks">Data Classes</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="iJkSuGMTVJ">
                            <label for="iJkSuGMTVJ">Libraries</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="ZZfZzVEObM">
                    <label for="ZZfZzVEObM">React</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="chezNIpSEf">
                    <label for="chezNIpSEf">Regular Expressions</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="IwqhmHOwYX">
                    <label for="IwqhmHOwYX">Rust</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="vIdchXwXez">
                            <label for="vIdchXwXez">Serde</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="fDeNGvvPON">
                    <label for="fDeNGvvPON">Shaders</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="pmSytiyZeU">
                            <label for="pmSytiyZeU">Glsl</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="soMveZdisX">
                    <label for="soMveZdisX">Vim</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="XisdVTlEFc">
                    <label for="XisdVTlEFc">Web</label>
                    <ul>
