...
<ul>
    <div name="contents-index">
        ...
        <l>
            <input type="checkbox" id="pyplyMjvtY" checked>
            <label for="pyplyMjvtY">Math</label>
            <ul>
                <l>
                    <input type="checkbox" id="fAcYUUkhYT">
                    <label for="fAcYUUkhYT">Exponentials</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="MejheSfQcG">
                    <label for="MejheSfQcG">Linear Algebra</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="XYHSbYYXeq">
                    <label for="XYHSbYYXeq">Logarithms</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="jJVnelGUzU">
                    <label for="jJVnelGUzU">Sequences</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="xVcrGcnCcZ">
                    <label for="xVcrGcnCcZ">Single Variable Calculus</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="CpuQnJOpQE">
                    <label for="CpuQnJOpQE">Trigonometry</label>
                    <ul>
        ...
        <l>
            <input type="checkbox" id="wnPVgHAggO" checked>
            <label for="wnPVgHAggO">Programming</label>
            <ul>
                <l>
                    <input type="checkbox" id="slfgoyJivB">
                    <label for="slfgoyJivB">Ansible</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="QlGWnYgQvS">
                    <label for="QlGWnYgQvS">Architecture</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="TjwctOHcEU">
                    <label for="TjwctOHcEU">Computer Graphics</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="bZpAKhULta">
                    <label for="bZpAKhULta">Databases</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="DtFBwrfKwh">
                    <label for="DtFBwrfKwh">Devops</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="iZkoImfVyj">
                            <label for="iZkoImfVyj">Cloud Providers</label>
                            <ul>
                                <l>
                                    <input type="checkbox" id="mxozZErHfc">
                                    <label for="mxozZErHfc">AWS</label>
                                    <ul>
                                        <l>
                                            <input type="checkbox" id="FxyVcWpUZg">
                                            <label for="FxyVcWpUZg">Cli</label>
                                            <ul>
                                        ...
                                        <l>
                                            <input type="checkbox" id="NgrBLzqjTd">
                                            <label for="NgrBLzqjTd">Dotnet</label>
                                            <ul>
                                        ...
                                        <l>
                                            <input type="checkbox" id="LADSEWtZgJ">
                                            <label for="LADSEWtZgJ">Ec 2</label>
                                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="FYHmnnwJOf">
                            <label for="FYHmnnwJOf">Events</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="LNCaGVBAHS">
                            <label for="LNCaGVBAHS">Localstack</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="hVxJfGYxFk">
                            <label for="hVxJfGYxFk">Pulumi</label>
                            <ul>
                                <l>
                                    <input type="checkbox" id="TsgGywSvMs">
                                    <label for="TsgGywSvMs">Dotnet</label>
                                    <ul>
                        ...
                        <l>
                            <input type="checkbox" id="tftoNFdvEz">
                            <label for="tftoNFdvEz">Serverless Framework</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="mWSHDIIdbV">
                            <label for="mWSHDIIdbV">Terraform</label>
                            <ul>
                                <l>
                                    <input type="checkbox" id="ZekIJobmrf">
                                    <label for="ZekIJobmrf">Functions</label>
                                    <ul>
                                ...
                                <l>
                                    <input type="checkbox" id="qnrLSXiUyg">
                                    <label for="qnrLSXiUyg">Meta Arguments</label>
                                    <ul>
                ...
                <l>
                    <input type="checkbox" id="aqXMVedNFr">
                    <label for="aqXMVedNFr">Docker</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="JioLjOJRnV">
                    <label for="JioLjOJRnV">Dotnet</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="NDrpSpwYjE">
                            <label for="NDrpSpwYjE">Cli</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="vxqEeLlxDW">
                    <label for="vxqEeLlxDW">Functional Programming</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="lpLxOXrpuG">
                    <label for="lpLxOXrpuG">Git</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="PeJNVWotTh">
                            <label for="PeJNVWotTh">Github</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="pZuoazBtWi">
                    <label for="pZuoazBtWi">Go</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="qqcIRSKeof">
                    <label for="qqcIRSKeof">Haskell</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="VEIPWRvrLK">
                    <label for="VEIPWRvrLK">Js</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="cWUDxIIwWk">
                            <label for="cWUDxIIwWk">Node</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="uHAiuznqSr">
                            <label for="uHAiuznqSr">D3</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="LEgYyzqEQh">
                            <label for="LEgYyzqEQh">Mocha</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="VbKhjgJObw">
                            <label for="VbKhjgJObw">P5js</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="bxChYCHKEw">
                            <label for="bxChYCHKEw">Typescript</label>
                            <ul>
                                <l>
                                    <input type="checkbox" id="VdNJfibLLE">
                                    <label for="VdNJfibLLE">Testing</label>
                                    <ul>
                ...
                <l>
                    <input type="checkbox" id="pheDBESBlq">
                    <label for="pheDBESBlq">Kafka</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="vdbZcJstRW">
                    <label for="vdbZcJstRW">Kubernetes</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="FtXUTJEgUn">
                    <label for="FtXUTJEgUn">Language</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="WkDkzSvFOR">
                    <label for="WkDkzSvFOR">Linux</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="tlxrAQJmgx">
                            <label for="tlxrAQJmgx">Bash</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="iSTSREKQYZ">
                    <label for="iSTSREKQYZ">Oauth</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="QuntPtlPVL">
                    <label for="QuntPtlPVL">Python</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="JWWogLRnzm">
                            <label for="JWWogLRnzm">Data Classes</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="sJXhunVlRe">
                            <label for="sJXhunVlRe">Libraries</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="criqFQeGPP">
                    <label for="criqFQeGPP">React</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="ModfESBTDI">
                    <label for="ModfESBTDI">Regular Expressions</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="oTZbHoydzx">
                    <label for="oTZbHoydzx">Rust</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="tVzztRVDsv">
                            <label for="tVzztRVDsv">Serde</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="GDfPOdwDGA">
                    <label for="GDfPOdwDGA">Shaders</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="aWzUXeofoB">
                            <label for="aWzUXeofoB">Glsl</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="jMODuWkQes">
                    <label for="jMODuWkQes">Vim</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="fIGhipvuJp">
                    <label for="fIGhipvuJp">Web</label>
                    <ul>
