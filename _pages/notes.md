...
<ul>
    <div name="contents-index">
        ...
        <l>
            <input type="checkbox" id="sWrScgWaLJ" checked>
            <label for="sWrScgWaLJ">Math</label>
            <ul>
                <l>
                    <input type="checkbox" id="EsFKuTOXHr">
                    <label for="EsFKuTOXHr">Exponentials</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="UaywzgIDBP">
                    <label for="UaywzgIDBP">Linear Algebra</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="WUkDspdpVF">
                    <label for="WUkDspdpVF">Logarithms</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="MgRiwzPEoD">
                    <label for="MgRiwzPEoD">Sequences</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="BoPCRvFwIz">
                    <label for="BoPCRvFwIz">Single Variable Calculus</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="NUvRrHWaJF">
                    <label for="NUvRrHWaJF">Trigonometry</label>
                    <ul>
        ...
        <l>
            <input type="checkbox" id="QxzkQLkHfz" checked>
            <label for="QxzkQLkHfz">Programming</label>
            <ul>
                <l>
                    <input type="checkbox" id="rgzlyUgIQd">
                    <label for="rgzlyUgIQd">Ansible</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="NIAoYfjCJC">
                    <label for="NIAoYfjCJC">Architecture</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="EOcuRbIQio">
                    <label for="EOcuRbIQio">Computer Graphics</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="gRaAqgSfkm">
                    <label for="gRaAqgSfkm">Databases</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="KzuyaXmYLe">
                    <label for="KzuyaXmYLe">Devops</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="bFtKzrwjjB">
                            <label for="bFtKzrwjjB">Cloud Providers</label>
                            <ul>
                                <l>
                                    <input type="checkbox" id="WvjUcfnQAg">
                                    <label for="WvjUcfnQAg">AWS</label>
                                    <ul>
                                        <l>
                                            <input type="checkbox" id="rjsiIVwQZz">
                                            <label for="rjsiIVwQZz">Cli</label>
                                            <ul>
                                        ...
                                        <l>
                                            <input type="checkbox" id="pvrlytoLkQ">
                                            <label for="pvrlytoLkQ">Dotnet</label>
                                            <ul>
                                        ...
                                        <l>
                                            <input type="checkbox" id="eoprBWMCGd">
                                            <label for="eoprBWMCGd">Ec 2</label>
                                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="GkwVhTtJoz">
                            <label for="GkwVhTtJoz">Events</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="iVeCsxjJEK">
                            <label for="iVeCsxjJEK">Localstack</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="YpWJPkMwqR">
                            <label for="YpWJPkMwqR">Pulumi</label>
                            <ul>
                                <l>
                                    <input type="checkbox" id="AMhXmraVqr">
                                    <label for="AMhXmraVqr">Dotnet</label>
                                    <ul>
                        ...
                        <l>
                            <input type="checkbox" id="IjXDnUOKTE">
                            <label for="IjXDnUOKTE">Serverless Framework</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="hoOuiDurZn">
                            <label for="hoOuiDurZn">Terraform</label>
                            <ul>
                                <l>
                                    <input type="checkbox" id="KILsdYmzrG">
                                    <label for="KILsdYmzrG">Functions</label>
                                    <ul>
                                ...
                                <l>
                                    <input type="checkbox" id="qdAYkqwqtW">
                                    <label for="qdAYkqwqtW">Meta Arguments</label>
                                    <ul>
                ...
                <l>
                    <input type="checkbox" id="SBWaqqcCPx">
                    <label for="SBWaqqcCPx">Docker</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="fvsZFziCYX">
                    <label for="fvsZFziCYX">Dotnet</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="tqHDUZMQnq">
                            <label for="tqHDUZMQnq">Cli</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="zCHskQMbkT">
                    <label for="zCHskQMbkT">Functional Programming</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="GwKecSNpVN">
                    <label for="GwKecSNpVN">Git</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="fImatLKIuS">
                            <label for="fImatLKIuS">Github</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="lWmFWaWhuX">
                    <label for="lWmFWaWhuX">Go</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="JAaevssUrc">
                    <label for="JAaevssUrc">Haskell</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="dEMLZIYufS">
                    <label for="dEMLZIYufS">Js</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="LtbkaHqqIM">
                            <label for="LtbkaHqqIM">Node</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="GoKRjSDIVA">
                            <label for="GoKRjSDIVA">D3</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="WWiJLqVeHh">
                            <label for="WWiJLqVeHh">Mocha</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="KZRlJmOXlQ">
                            <label for="KZRlJmOXlQ">P5js</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="WaMAbdyRqh">
                            <label for="WaMAbdyRqh">Typescript</label>
                            <ul>
                                <l>
                                    <input type="checkbox" id="eoCvSsplsi">
                                    <label for="eoCvSsplsi">Testing</label>
                                    <ul>
                ...
                <l>
                    <input type="checkbox" id="rnrTShZJxL">
                    <label for="rnrTShZJxL">Kafka</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="jauDIzqqRX">
                    <label for="jauDIzqqRX">Kubernetes</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="NnRtYqaHTT">
                    <label for="NnRtYqaHTT">Language</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="GSLHaoPVKj">
                    <label for="GSLHaoPVKj">Linux</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="krzxcakmaM">
                            <label for="krzxcakmaM">Bash</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="NdhsiqdHzR">
                    <label for="NdhsiqdHzR">Oauth</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="FwTGmaJVql">
                    <label for="FwTGmaJVql">Python</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="JKBclTxyXb">
                            <label for="JKBclTxyXb">Data Classes</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="OSJTelOKNt">
                            <label for="OSJTelOKNt">Libraries</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="AYbGqlhPmm">
                    <label for="AYbGqlhPmm">React</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="vCufXKoghW">
                    <label for="vCufXKoghW">Regular Expressions</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="BwADbSrpOG">
                    <label for="BwADbSrpOG">Rust</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="NaNCyEdEAW">
                            <label for="NaNCyEdEAW">Serde</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="mVSVUzsjoj">
                    <label for="mVSVUzsjoj">Vim</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="jMQqFuFGKk">
                    <label for="jMQqFuFGKk">Web</label>
                    <ul>
