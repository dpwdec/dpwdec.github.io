...
<ul>
    <div name="contents-index">
        ...
        <l>
            <input type="checkbox" id="AAiWbfmFni" checked>
            <label for="AAiWbfmFni">Math</label>
            <ul>
                <l>
                    <input type="checkbox" id="gnMuNSgsUk">
                    <label for="gnMuNSgsUk">Exponentials</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="edscqnCgMO">
                    <label for="edscqnCgMO">Linear Algebra</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="qydgBVNLbM">
                    <label for="qydgBVNLbM">Logarithms</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="BESOcLuPIg">
                    <label for="BESOcLuPIg">Sequences</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="LxgstieQYy">
                    <label for="LxgstieQYy">Single Variable Calculus</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="TGHbPMjFub">
                    <label for="TGHbPMjFub">Trigonometry</label>
                    <ul>
        ...
        <l>
            <input type="checkbox" id="qvGReHAcAw" checked>
            <label for="qvGReHAcAw">Programming</label>
            <ul>
                <l>
                    <input type="checkbox" id="JXajGRkVWQ">
                    <label for="JXajGRkVWQ">Ansible</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="nqJDBdPFpN">
                    <label for="nqJDBdPFpN">Architecture</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="cXVjZxQive">
                    <label for="cXVjZxQive">Computer Graphics</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="FSuxgwvYqp">
                    <label for="FSuxgwvYqp">Databases</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="kmNWtVYXHT">
                    <label for="kmNWtVYXHT">Devops</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="UxguIMlEOU">
                            <label for="UxguIMlEOU">Cloud Providers</label>
                            <ul>
                                <l>
                                    <input type="checkbox" id="lxzntlIjKH">
                                    <label for="lxzntlIjKH">AWS</label>
                                    <ul>
                                        <l>
                                            <input type="checkbox" id="EXdfZfauJM">
                                            <label for="EXdfZfauJM">Cli</label>
                                            <ul>
                                        ...
                                        <l>
                                            <input type="checkbox" id="iPmUBAHwWi">
                                            <label for="iPmUBAHwWi">Dotnet</label>
                                            <ul>
                                        ...
                                        <l>
                                            <input type="checkbox" id="NuzjouPHCz">
                                            <label for="NuzjouPHCz">Ec 2</label>
                                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="FVYoUgJagw">
                            <label for="FVYoUgJagw">Events</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="bRDnzUlaHZ">
                            <label for="bRDnzUlaHZ">Localstack</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="AdivWFvCaV">
                            <label for="AdivWFvCaV">Pulumi</label>
                            <ul>
                                <l>
                                    <input type="checkbox" id="AqXswEEqDw">
                                    <label for="AqXswEEqDw">Dotnet</label>
                                    <ul>
                        ...
                        <l>
                            <input type="checkbox" id="pfcQJDsJzN">
                            <label for="pfcQJDsJzN">Serverless Framework</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="mfaEoQsjxu">
                            <label for="mfaEoQsjxu">Terraform</label>
                            <ul>
                                <l>
                                    <input type="checkbox" id="tiKBsaVnjA">
                                    <label for="tiKBsaVnjA">Functions</label>
                                    <ul>
                                ...
                                <l>
                                    <input type="checkbox" id="stwpuVwmvl">
                                    <label for="stwpuVwmvl">Meta Arguments</label>
                                    <ul>
                ...
                <l>
                    <input type="checkbox" id="AVOqQXocRM">
                    <label for="AVOqQXocRM">Docker</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="VkbLZXkfCX">
                    <label for="VkbLZXkfCX">Dotnet</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="bHthzmcRYP">
                            <label for="bHthzmcRYP">Cli</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="abmTrmKUXd">
                    <label for="abmTrmKUXd">Functional Programming</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="xqzWcKJodC">
                    <label for="xqzWcKJodC">Git</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="mKvpnEpVPI">
                            <label for="mKvpnEpVPI">Github</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="AipMDDqHeY">
                    <label for="AipMDDqHeY">Go</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="NFTDJTYQiJ">
                    <label for="NFTDJTYQiJ">Haskell</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="OLUUbxeVuB">
                    <label for="OLUUbxeVuB">Js</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="lLtVOzuUZY">
                            <label for="lLtVOzuUZY">Node</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="PjRjCtqPjh">
                            <label for="PjRjCtqPjh">D3</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="yRqBSEKUnV">
                            <label for="yRqBSEKUnV">Mocha</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="PQHDnrLFUL">
                            <label for="PQHDnrLFUL">P5js</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="LMJIqBAxCk">
                            <label for="LMJIqBAxCk">Typescript</label>
                            <ul>
                                <l>
                                    <input type="checkbox" id="SKJVHkUugi">
                                    <label for="SKJVHkUugi">Testing</label>
                                    <ul>
                ...
                <l>
                    <input type="checkbox" id="VdlMLzLLrk">
                    <label for="VdlMLzLLrk">Kafka</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="NXmKStUSzD">
                    <label for="NXmKStUSzD">Kubernetes</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="ltxTOEIcKY">
                    <label for="ltxTOEIcKY">Language</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="nUMrPjDVZs">
                    <label for="nUMrPjDVZs">Linux</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="IAeaojRZcB">
                            <label for="IAeaojRZcB">Bash</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="IruBOhmFKt">
                    <label for="IruBOhmFKt">Oauth</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="dXMQojnmsO">
                    <label for="dXMQojnmsO">Python</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="bEYhvagenm">
                            <label for="bEYhvagenm">Data Classes</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="TlfhzsfDnz">
                            <label for="TlfhzsfDnz">Libraries</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="MGVVScQezM">
                    <label for="MGVVScQezM">React</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="lMIybCWhgl">
                    <label for="lMIybCWhgl">Regular Expressions</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="WRUtcrYTeV">
                    <label for="WRUtcrYTeV">Rust</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="dqMCXUJgvs">
                            <label for="dqMCXUJgvs">Serde</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="lYpjXzEsoc">
                    <label for="lYpjXzEsoc">Shaders</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="sfRsBWWkGJ">
                            <label for="sfRsBWWkGJ">Glsl</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="COWNzXxskm">
                    <label for="COWNzXxskm">Vim</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="OQPLHeZdjE">
                    <label for="OQPLHeZdjE">Web</label>
                    <ul>
