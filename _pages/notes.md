...
<ul>
    <div name="contents-index">
        ...
        <l>
            <input type="checkbox" id="mqvpzCSzpP" checked>
            <label for="mqvpzCSzpP">Math</label>
            <ul>
                <l>
                    <input type="checkbox" id="YckufPVvuZ">
                    <label for="YckufPVvuZ">Exponentials</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="HyahNVdqId">
                    <label for="HyahNVdqId">Linear Algebra</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="SYBDDSRmRy">
                    <label for="SYBDDSRmRy">Logarithms</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="OlusXfgbSG">
                    <label for="OlusXfgbSG">Sequences</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="NtXHSdnCWi">
                    <label for="NtXHSdnCWi">Single Variable Calculus</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="adYWzbuKXE">
                    <label for="adYWzbuKXE">Trigonometry</label>
                    <ul>
        ...
        <l>
            <input type="checkbox" id="xZwjJsEJhQ" checked>
            <label for="xZwjJsEJhQ">Programming</label>
            <ul>
                <l>
                    <input type="checkbox" id="EXxumdFqko">
                    <label for="EXxumdFqko">Ansible</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="NYbgtOJRDz">
                    <label for="NYbgtOJRDz">Architecture</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="TmnFNUusNb">
                    <label for="TmnFNUusNb">Computer Graphics</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="YMlwqhkRSv">
                    <label for="YMlwqhkRSv">Databases</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="zspyyagwrn">
                    <label for="zspyyagwrn">Devops</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="kDAdmVETLJ">
                            <label for="kDAdmVETLJ">Cloud Computing</label>
                            <ul>
                                <l>
                                    <input type="checkbox" id="KCzvFSwKfQ">
                                    <label for="KCzvFSwKfQ">AWS</label>
                                    <ul>
                                        <l>
                                            <input type="checkbox" id="qgVSYfhiCG">
                                            <label for="qgVSYfhiCG">Cli</label>
                                            <ul>
                                        ...
                                        <l>
                                            <input type="checkbox" id="rwSQGzYEez">
                                            <label for="rwSQGzYEez">Ec 2</label>
                                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="otbjNKSzIQ">
                            <label for="otbjNKSzIQ">Events</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="NxtxGbGYtT">
                            <label for="NxtxGbGYtT">Oauth</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="dMRmWUaaXz">
                            <label for="dMRmWUaaXz">Pulumi</label>
                            <ul>
                                <l>
                                    <input type="checkbox" id="TYXSJMRzQw">
                                    <label for="TYXSJMRzQw">Dotnet</label>
                                    <ul>
                        ...
                        <l>
                            <input type="checkbox" id="TAXlIzXrEo">
                            <label for="TAXlIzXrEo">Terraform</label>
                            <ul>
                                <l>
                                    <input type="checkbox" id="qxuapqLRNo">
                                    <label for="qxuapqLRNo">Functions</label>
                                    <ul>
                                ...
                                <l>
                                    <input type="checkbox" id="UjcaoIolOy">
                                    <label for="UjcaoIolOy">Meta Arguments</label>
                                    <ul>
                ...
                <l>
                    <input type="checkbox" id="xLTVVgEAAm">
                    <label for="xLTVVgEAAm">Docker</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="uuHVYWbasb">
                    <label for="uuHVYWbasb">Dotnet</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="lRLvdTYqeM">
                            <label for="lRLvdTYqeM">Cli</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="gUGHubAOCZ">
                    <label for="gUGHubAOCZ">Functional Programming</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="VRjUfsiUrO">
                    <label for="VRjUfsiUrO">Git</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="ilojeRZAuW">
                            <label for="ilojeRZAuW">Github</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="txzOUpjAvw">
                    <label for="txzOUpjAvw">Go</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="QyvcrwGsIu">
                    <label for="QyvcrwGsIu">Haskell</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="WnVZWPvkWK">
                    <label for="WnVZWPvkWK">Js</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="PCvTKZpbsl">
                            <label for="PCvTKZpbsl">Node</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="adGPZiWOhj">
                            <label for="adGPZiWOhj">Mocha</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="khHbkKAcOI">
                            <label for="khHbkKAcOI">P5js</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="edzRxYBboG">
                            <label for="edzRxYBboG">Typescript</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="trTHLTufpn">
                    <label for="trTHLTufpn">Kafka</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="rvzKMYXRCQ">
                    <label for="rvzKMYXRCQ">Kubernetes</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="zidEGipjCn">
                    <label for="zidEGipjCn">Language</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="jlgSeRmxhU">
                    <label for="jlgSeRmxhU">Linux</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="eHELoPnXrd">
                    <label for="eHELoPnXrd">Python</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="aadeQoOgLD">
                            <label for="aadeQoOgLD">Data Classes</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="oOtcuQuVaS">
                            <label for="oOtcuQuVaS">Libraries</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="iKKiIAxNwA">
                    <label for="iKKiIAxNwA">React</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="kxpbZiDxMK">
                    <label for="kxpbZiDxMK">Regular Expressions</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="exTzfulEwP">
                    <label for="exTzfulEwP">Rust</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="eYEpkPXiJT">
                            <label for="eYEpkPXiJT">Serde</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="GxXwHXXQMt">
                    <label for="GxXwHXXQMt">Vim</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="WTkghJyXaN">
                    <label for="WTkghJyXaN">Web</label>
                    <ul>
