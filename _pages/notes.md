...
<ul>
    <div name="contents-index">
        ...
        <l>
            <input type="checkbox" id="XzPnynHvSM" checked>
            <label for="XzPnynHvSM">Math</label>
            <ul>
                <l>
                    <input type="checkbox" id="tdglaHZfbK">
                    <label for="tdglaHZfbK">Exponentials</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="SSSXlfLIoZ">
                    <label for="SSSXlfLIoZ">Linear Algebra</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="CjpETeizAL">
                    <label for="CjpETeizAL">Logarithms</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="mbJmwoHxvk">
                    <label for="mbJmwoHxvk">Sequences</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="uKdVlyfUTL">
                    <label for="uKdVlyfUTL">Single Variable Calculus</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="pRzWPgSOAo">
                    <label for="pRzWPgSOAo">Trigonometry</label>
                    <ul>
        ...
        <l>
            <input type="checkbox" id="PDyyXKovQK" checked>
            <label for="PDyyXKovQK">Programming</label>
            <ul>
                <l>
                    <input type="checkbox" id="KYmZTNdmjZ">
                    <label for="KYmZTNdmjZ">Ansible</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="PVBKYjZwBm">
                    <label for="PVBKYjZwBm">Architecture</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="sUAvuzrCTP">
                    <label for="sUAvuzrCTP">Computer Graphics</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="KSIaIKxgTR">
                    <label for="KSIaIKxgTR">Databases</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="tWMXFMDWnV">
                    <label for="tWMXFMDWnV">Devops</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="nUrpIHFPkp">
                            <label for="nUrpIHFPkp">Cloud Providers</label>
                            <ul>
                                <l>
                                    <input type="checkbox" id="SNNTJTIkrC">
                                    <label for="SNNTJTIkrC">AWS</label>
                                    <ul>
                                        <l>
                                            <input type="checkbox" id="tDkAxQEMhL">
                                            <label for="tDkAxQEMhL">Cli</label>
                                            <ul>
                                        ...
                                        <l>
                                            <input type="checkbox" id="TNdOLmbWKi">
                                            <label for="TNdOLmbWKi">Dotnet</label>
                                            <ul>
                                        ...
                                        <l>
                                            <input type="checkbox" id="wfinbJEVho">
                                            <label for="wfinbJEVho">Ec 2</label>
                                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="QTsdKbQYZb">
                            <label for="QTsdKbQYZb">Events</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="pXmuKUOKsJ">
                            <label for="pXmuKUOKsJ">Localstack</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="QLIqQCWHOf">
                            <label for="QLIqQCWHOf">Pulumi</label>
                            <ul>
                                <l>
                                    <input type="checkbox" id="gcqQXHMsoi">
                                    <label for="gcqQXHMsoi">Dotnet</label>
                                    <ul>
                        ...
                        <l>
                            <input type="checkbox" id="JJCcLtvEhM">
                            <label for="JJCcLtvEhM">Serverless Framework</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="AhFZXZzvJp">
                            <label for="AhFZXZzvJp">Terraform</label>
                            <ul>
                                <l>
                                    <input type="checkbox" id="cVYFBMoPMh">
                                    <label for="cVYFBMoPMh">Functions</label>
                                    <ul>
                                ...
                                <l>
                                    <input type="checkbox" id="ArfFHhabwJ">
                                    <label for="ArfFHhabwJ">Meta Arguments</label>
                                    <ul>
                ...
                <l>
                    <input type="checkbox" id="GxxeHXpVnl">
                    <label for="GxxeHXpVnl">Docker</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="rgxJroFNQP">
                    <label for="rgxJroFNQP">Dotnet</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="tUCWVajbQQ">
                            <label for="tUCWVajbQQ">Cli</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="wekLjTAYnC">
                    <label for="wekLjTAYnC">Functional Programming</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="mipziIAOLf">
                    <label for="mipziIAOLf">Git</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="YPoBApAjMv">
                            <label for="YPoBApAjMv">Github</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="lEJIyHSktR">
                    <label for="lEJIyHSktR">Go</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="MQYTuBzbuF">
                    <label for="MQYTuBzbuF">Haskell</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="LuwfxkgxCy">
                    <label for="LuwfxkgxCy">Js</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="YtzCJyegTU">
                            <label for="YtzCJyegTU">Node</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="uyVFcVxOIo">
                            <label for="uyVFcVxOIo">D3</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="qkQYyPxLCW">
                            <label for="qkQYyPxLCW">Mocha</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="EshfCIxkDz">
                            <label for="EshfCIxkDz">P5js</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="QwlfiDXuve">
                            <label for="QwlfiDXuve">Typescript</label>
                            <ul>
                                <l>
                                    <input type="checkbox" id="rmuOjglMuh">
                                    <label for="rmuOjglMuh">Testing</label>
                                    <ul>
                ...
                <l>
                    <input type="checkbox" id="BfYJubvHOO">
                    <label for="BfYJubvHOO">Kafka</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="ohbBnTMfeK">
                    <label for="ohbBnTMfeK">Kubernetes</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="OiwiEeFSNB">
                    <label for="OiwiEeFSNB">Language</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="QFnekwhTKB">
                    <label for="QFnekwhTKB">Linux</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="GmAtqLkPPA">
                            <label for="GmAtqLkPPA">Bash</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="bfNKxCfDqv">
                    <label for="bfNKxCfDqv">Oauth</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="mHWnZVVJYW">
                    <label for="mHWnZVVJYW">Prometheus</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="CUcNusmCnY">
                    <label for="CUcNusmCnY">Python</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="nkJFahOQnO">
                            <label for="nkJFahOQnO">Data Classes</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="KFCVSrkBWW">
                            <label for="KFCVSrkBWW">Libraries</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="uyxoNICSAf">
                    <label for="uyxoNICSAf">React</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="sFRVTUinjV">
                    <label for="sFRVTUinjV">Regular Expressions</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="htgKhJygmy">
                    <label for="htgKhJygmy">Rust</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="ksRonWTzIV">
                            <label for="ksRonWTzIV">Serde</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="BqdDMtksqK">
                    <label for="BqdDMtksqK">Shaders</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="BvSJfqVHYE">
                            <label for="BvSJfqVHYE">Glsl</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="jxyqwcgNrq">
                    <label for="jxyqwcgNrq">Vim</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="iExRBqsYYV">
                    <label for="iExRBqsYYV">Web</label>
                    <ul>
