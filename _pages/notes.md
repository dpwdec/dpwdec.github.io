...
<ul>
    <div name="contents-index">
        ...
        <l>
            <input type="checkbox" id="hMjOrDnhCb" checked>
            <label for="hMjOrDnhCb">Math</label>
            <ul>
                <l>
                    <input type="checkbox" id="ZpHlbUNviL">
                    <label for="ZpHlbUNviL">Exponentials</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="pptzWoVYlv">
                    <label for="pptzWoVYlv">Linear Algebra</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="DgVsldytKe">
                    <label for="DgVsldytKe">Logarithms</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="rcXEAToAuW">
                    <label for="rcXEAToAuW">Sequences</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="dOnXOILqZU">
                    <label for="dOnXOILqZU">Single Variable Calculus</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="ScxwBMIjBF">
                    <label for="ScxwBMIjBF">Trigonometry</label>
                    <ul>
        ...
        <l>
            <input type="checkbox" id="ezbrKEUEJg" checked>
            <label for="ezbrKEUEJg">Programming</label>
            <ul>
                <l>
                    <input type="checkbox" id="MBUvjDHzES">
                    <label for="MBUvjDHzES">Ansible</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="RnjqUjQUBg">
                    <label for="RnjqUjQUBg">Architecture</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="vQIEQLzPmU">
                    <label for="vQIEQLzPmU">Computer Graphics</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="QHGnVmghkq">
                    <label for="QHGnVmghkq">Databases</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="LNrtTrQDma">
                    <label for="LNrtTrQDma">Devops</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="nLxyCMgxxV">
                            <label for="nLxyCMgxxV">Cloud Providers</label>
                            <ul>
                                <l>
                                    <input type="checkbox" id="omyjNwIfvM">
                                    <label for="omyjNwIfvM">AWS</label>
                                    <ul>
                                        <l>
                                            <input type="checkbox" id="yTvwrrUuop">
                                            <label for="yTvwrrUuop">Cli</label>
                                            <ul>
                                        ...
                                        <l>
                                            <input type="checkbox" id="ZWIHPpxwlu">
                                            <label for="ZWIHPpxwlu">Dotnet</label>
                                            <ul>
                                        ...
                                        <l>
                                            <input type="checkbox" id="iAXqgPwvlB">
                                            <label for="iAXqgPwvlB">Ec 2</label>
                                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="tjJYyXhzEK">
                            <label for="tjJYyXhzEK">Events</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="MOvafqoXWa">
                            <label for="MOvafqoXWa">Localstack</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="pRyNzHmUOA">
                            <label for="pRyNzHmUOA">Pulumi</label>
                            <ul>
                                <l>
                                    <input type="checkbox" id="mEOJlcSKUe">
                                    <label for="mEOJlcSKUe">Dotnet</label>
                                    <ul>
                        ...
                        <l>
                            <input type="checkbox" id="CkmHvTklQM">
                            <label for="CkmHvTklQM">Serverless Framework</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="zyJYDQwQpM">
                            <label for="zyJYDQwQpM">Terraform</label>
                            <ul>
                                <l>
                                    <input type="checkbox" id="vLMgXRBAlN">
                                    <label for="vLMgXRBAlN">Functions</label>
                                    <ul>
                                ...
                                <l>
                                    <input type="checkbox" id="oJSbogtQUQ">
                                    <label for="oJSbogtQUQ">Meta Arguments</label>
                                    <ul>
                ...
                <l>
                    <input type="checkbox" id="tDnYnvLJIt">
                    <label for="tDnYnvLJIt">Docker</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="oxmPmvYrvd">
                    <label for="oxmPmvYrvd">Dotnet</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="NxshHEpMyI">
                            <label for="NxshHEpMyI">Cli</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="JfXxkHnieF">
                    <label for="JfXxkHnieF">Functional Programming</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="PsgsXVHOWX">
                    <label for="PsgsXVHOWX">Git</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="COUqxnGfXQ">
                            <label for="COUqxnGfXQ">Github</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="cIUFeWhZWR">
                    <label for="cIUFeWhZWR">Go</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="WVVlHLIIhe">
                    <label for="WVVlHLIIhe">Haskell</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="dkrNseJDCt">
                    <label for="dkrNseJDCt">Js</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="hxMXejyJkq">
                            <label for="hxMXejyJkq">Node</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="hThUbRGkgS">
                            <label for="hThUbRGkgS">D3</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="vFkAiDYtfZ">
                            <label for="vFkAiDYtfZ">Mocha</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="lyLXhjLVyf">
                            <label for="lyLXhjLVyf">P5js</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="NIpoZEpKHL">
                            <label for="NIpoZEpKHL">Typescript</label>
                            <ul>
                                <l>
                                    <input type="checkbox" id="ApyENNFVtr">
                                    <label for="ApyENNFVtr">Testing</label>
                                    <ul>
                ...
                <l>
                    <input type="checkbox" id="WDtejADHrp">
                    <label for="WDtejADHrp">Kafka</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="psDkMPmdAB">
                    <label for="psDkMPmdAB">Kubernetes</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="PrMPrrgbza">
                    <label for="PrMPrrgbza">Language</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="xVEUnBQNKa">
                    <label for="xVEUnBQNKa">Linux</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="SrotEDfgtT">
                            <label for="SrotEDfgtT">Bash</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="XtYayFhgcz">
                    <label for="XtYayFhgcz">Oauth</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="PpQpKLBMHF">
                    <label for="PpQpKLBMHF">Prometheus</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="qAViNGCtVn">
                    <label for="qAViNGCtVn">Python</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="VdYODuAUSI">
                            <label for="VdYODuAUSI">Data Classes</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="noSLxtoMaL">
                            <label for="noSLxtoMaL">Libraries</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="AdtQoigIMY">
                    <label for="AdtQoigIMY">React</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="fYTeEvZKtz">
                    <label for="fYTeEvZKtz">Regular Expressions</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="lNwQjcHrLE">
                    <label for="lNwQjcHrLE">Rust</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="huTPspPCcz">
                            <label for="huTPspPCcz">Serde</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="hGOkMLmVSL">
                    <label for="hGOkMLmVSL">Shaders</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="MebVEzsQhZ">
                            <label for="MebVEzsQhZ">Glsl</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="BomMcpTVKb">
                    <label for="BomMcpTVKb">Vim</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="dqiSbVHpPs">
                    <label for="dqiSbVHpPs">Web</label>
                    <ul>
