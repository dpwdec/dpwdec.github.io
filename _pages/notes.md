...
<ul>
    <div name="contents-index">
        ...
        <l>
            <input type="checkbox" id="QPUBhnaHvC" checked>
            <label for="QPUBhnaHvC">Math</label>
            <ul>
                <l>
                    <input type="checkbox" id="xZMIUAcEPW">
                    <label for="xZMIUAcEPW">Exponentials</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="JiYAGWmSdL">
                    <label for="JiYAGWmSdL">Linear Algebra</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="pSCVBDfHhg">
                    <label for="pSCVBDfHhg">Logarithms</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="iiCGnXZwLO">
                    <label for="iiCGnXZwLO">Sequences</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="aUoYpVMztn">
                    <label for="aUoYpVMztn">Single Variable Calculus</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="AeMpWzUwgF">
                    <label for="AeMpWzUwgF">Trigonometry</label>
                    <ul>
        ...
        <l>
            <input type="checkbox" id="xNVJYnRjgB" checked>
            <label for="xNVJYnRjgB">Programming</label>
            <ul>
                <l>
                    <input type="checkbox" id="hawzkoXzVG">
                    <label for="hawzkoXzVG">Ansible</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="IzpPRHWxBV">
                    <label for="IzpPRHWxBV">Architecture</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="DbbsUQbwHS">
                    <label for="DbbsUQbwHS">Computer Graphics</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="kspuXuILSj">
                    <label for="kspuXuILSj">Databases</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="xvDziXFqcO">
                    <label for="xvDziXFqcO">Devops</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="MLtIzpLLPQ">
                            <label for="MLtIzpLLPQ">Cloud Computing</label>
                            <ul>
                                <l>
                                    <input type="checkbox" id="DjlQzusREi">
                                    <label for="DjlQzusREi">AWS</label>
                                    <ul>
                                        <l>
                                            <input type="checkbox" id="GdtFNvIhIK">
                                            <label for="GdtFNvIhIK">Cli</label>
                                            <ul>
                                        ...
                                        <l>
                                            <input type="checkbox" id="pRlSUfrwjN">
                                            <label for="pRlSUfrwjN">Dotnet</label>
                                            <ul>
                                        ...
                                        <l>
                                            <input type="checkbox" id="yKYNkuzwQZ">
                                            <label for="yKYNkuzwQZ">Ec 2</label>
                                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="cKfmkpXXxx">
                            <label for="cKfmkpXXxx">Events</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="lnVcVbmlcJ">
                            <label for="lnVcVbmlcJ">Localstack</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="UIEhNRjSsq">
                            <label for="UIEhNRjSsq">Oauth</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="HFaTcEnmxZ">
                            <label for="HFaTcEnmxZ">Pulumi</label>
                            <ul>
                                <l>
                                    <input type="checkbox" id="xHydtuOrSM">
                                    <label for="xHydtuOrSM">Dotnet</label>
                                    <ul>
                        ...
                        <l>
                            <input type="checkbox" id="DZxBtVmppU">
                            <label for="DZxBtVmppU">Terraform</label>
                            <ul>
                                <l>
                                    <input type="checkbox" id="MCcFrFpZmB">
                                    <label for="MCcFrFpZmB">Functions</label>
                                    <ul>
                                ...
                                <l>
                                    <input type="checkbox" id="RPwndafLAA">
                                    <label for="RPwndafLAA">Meta Arguments</label>
                                    <ul>
                ...
                <l>
                    <input type="checkbox" id="bcEkBzAdkh">
                    <label for="bcEkBzAdkh">Docker</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="HJVnaWGUVu">
                    <label for="HJVnaWGUVu">Dotnet</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="mDxwrYPpeu">
                            <label for="mDxwrYPpeu">Cli</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="mqiGiFNgGC">
                    <label for="mqiGiFNgGC">Functional Programming</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="CdUatstjFA">
                    <label for="CdUatstjFA">Git</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="CVBmMIsrzB">
                            <label for="CVBmMIsrzB">Github</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="KQEhCiaxqJ">
                    <label for="KQEhCiaxqJ">Go</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="OzrMkoHgXi">
                    <label for="OzrMkoHgXi">Haskell</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="lrPniqKdxx">
                    <label for="lrPniqKdxx">Js</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="LxghPrGtZQ">
                            <label for="LxghPrGtZQ">Node</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="ilNfOfcUoN">
                            <label for="ilNfOfcUoN">D3</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="qXGIzNbYuk">
                            <label for="qXGIzNbYuk">Mocha</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="vfSyIrCRaN">
                            <label for="vfSyIrCRaN">P5js</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="MdpcEpSTik">
                            <label for="MdpcEpSTik">Typescript</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="zgBeDuazwi">
                    <label for="zgBeDuazwi">Kafka</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="yJIGKECiVO">
                    <label for="yJIGKECiVO">Kubernetes</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="ufxROnonyE">
                    <label for="ufxROnonyE">Language</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="wiviRDscGM">
                    <label for="wiviRDscGM">Linux</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="fRrPUYQAlG">
                            <label for="fRrPUYQAlG">Bash</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="MeZUAPsHDW">
                    <label for="MeZUAPsHDW">Python</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="ACdgBFPRnD">
                            <label for="ACdgBFPRnD">Data Classes</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="xsEwrunBae">
                            <label for="xsEwrunBae">Libraries</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="JeWfjEDWVd">
                    <label for="JeWfjEDWVd">React</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="aFYmFLNDyB">
                    <label for="aFYmFLNDyB">Regular Expressions</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="rnsKcJvqZZ">
                    <label for="rnsKcJvqZZ">Rust</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="qmVIsruJyd">
                            <label for="qmVIsruJyd">Serde</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="TJOWdBlAmf">
                    <label for="TJOWdBlAmf">Vim</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="GledeyFCCE">
                    <label for="GledeyFCCE">Web</label>
                    <ul>
