...
<ul>
    <div name="contents-index">
        ...
        <l>
            <input type="checkbox" id="XeRyfwklLG" checked>
            <label for="XeRyfwklLG">Math</label>
            <ul>
                <l>
                    <input type="checkbox" id="hSLIyuvfyH">
                    <label for="hSLIyuvfyH">Exponentials</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="gXtDJHnvxi">
                    <label for="gXtDJHnvxi">Linear Algebra</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="gKSijgQFmT">
                    <label for="gKSijgQFmT">Logarithms</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="RTYbftlpVj">
                    <label for="RTYbftlpVj">Sequences</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="sFOFvzdEXu">
                    <label for="sFOFvzdEXu">Single Variable Calculus</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="rPHpPyDthW">
                    <label for="rPHpPyDthW">Trigonometry</label>
                    <ul>
        ...
        <l>
            <input type="checkbox" id="XnsQjEcbYR" checked>
            <label for="XnsQjEcbYR">Programming</label>
            <ul>
                <l>
                    <input type="checkbox" id="YHzevtTIRt">
                    <label for="YHzevtTIRt">Ansible</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="mMifgUXrZN">
                    <label for="mMifgUXrZN">Architecture</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="HMfeQEUAgP">
                    <label for="HMfeQEUAgP">Computer Graphics</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="fitdCrHDin">
                    <label for="fitdCrHDin">Databases</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="WaunDIBjdV">
                    <label for="WaunDIBjdV">Devops</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="DTXUfnnYut">
                            <label for="DTXUfnnYut">Cloud Computing</label>
                            <ul>
                                <l>
                                    <input type="checkbox" id="HMRcfXOzxT">
                                    <label for="HMRcfXOzxT">AWS</label>
                                    <ul>
                                        <l>
                                            <input type="checkbox" id="pCMqEhmZZs">
                                            <label for="pCMqEhmZZs">Cli</label>
                                            <ul>
                                        ...
                                        <l>
                                            <input type="checkbox" id="EBoioXrxvx">
                                            <label for="EBoioXrxvx">Dotnet</label>
                                            <ul>
                                        ...
                                        <l>
                                            <input type="checkbox" id="LYgEAuXhhM">
                                            <label for="LYgEAuXhhM">Ec 2</label>
                                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="FsnnUNDMgC">
                            <label for="FsnnUNDMgC">Events</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="qnWFqCPKdv">
                            <label for="qnWFqCPKdv">Oauth</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="uHLuirlfjE">
                            <label for="uHLuirlfjE">Pulumi</label>
                            <ul>
                                <l>
                                    <input type="checkbox" id="pZIaAkAjrX">
                                    <label for="pZIaAkAjrX">Dotnet</label>
                                    <ul>
                        ...
                        <l>
                            <input type="checkbox" id="sOIbkSqmHf">
                            <label for="sOIbkSqmHf">Terraform</label>
                            <ul>
                                <l>
                                    <input type="checkbox" id="KCYRXRlFRq">
                                    <label for="KCYRXRlFRq">Functions</label>
                                    <ul>
                                ...
                                <l>
                                    <input type="checkbox" id="fydaeMaMzK">
                                    <label for="fydaeMaMzK">Meta Arguments</label>
                                    <ul>
                ...
                <l>
                    <input type="checkbox" id="nDEXMOmiNn">
                    <label for="nDEXMOmiNn">Docker</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="ODzhLVkZLF">
                    <label for="ODzhLVkZLF">Dotnet</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="kEhopuwOZD">
                            <label for="kEhopuwOZD">Cli</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="yjFQgrcgzl">
                    <label for="yjFQgrcgzl">Functional Programming</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="UOgOrOsDQZ">
                    <label for="UOgOrOsDQZ">Git</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="OlQORHWNfM">
                            <label for="OlQORHWNfM">Github</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="sVERdCgNXf">
                    <label for="sVERdCgNXf">Go</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="VRfSzFTTLe">
                    <label for="VRfSzFTTLe">Haskell</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="OHsCSeZhMZ">
                    <label for="OHsCSeZhMZ">Js</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="iKKaXChStt">
                            <label for="iKKaXChStt">Node</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="zDGVvVlJxN">
                            <label for="zDGVvVlJxN">Mocha</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="PumjZTpBZT">
                            <label for="PumjZTpBZT">P5js</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="SzyoVAVKWm">
                            <label for="SzyoVAVKWm">Typescript</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="RRpRtbCimd">
                    <label for="RRpRtbCimd">Kafka</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="FRYjtdBqpo">
                    <label for="FRYjtdBqpo">Kubernetes</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="bSpQnQQHJq">
                    <label for="bSpQnQQHJq">Language</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="HFRiLIWYZp">
                    <label for="HFRiLIWYZp">Linux</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="PPXBpNjNRS">
                    <label for="PPXBpNjNRS">Python</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="gfWFqbgZaD">
                            <label for="gfWFqbgZaD">Data Classes</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="sEsFWswLgi">
                            <label for="sEsFWswLgi">Libraries</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="IiHEpddtpk">
                    <label for="IiHEpddtpk">React</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="NBuheCcHjx">
                    <label for="NBuheCcHjx">Regular Expressions</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="SECfPKDHzP">
                    <label for="SECfPKDHzP">Rust</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="UjCdjfzuKX">
                            <label for="UjCdjfzuKX">Serde</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="kuRHXRorqo">
                    <label for="kuRHXRorqo">Vim</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="UYAVkKRZvV">
                    <label for="UYAVkKRZvV">Web</label>
                    <ul>
