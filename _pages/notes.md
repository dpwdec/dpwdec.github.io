...
<ul>
    <div name="contents-index">
        ...
        <l>
            <input type="checkbox" id="NjMxUtmpBq" checked>
            <label for="NjMxUtmpBq">Math</label>
            <ul>
                <l>
                    <input type="checkbox" id="evHqXwRkOn">
                    <label for="evHqXwRkOn">Exponentials</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="SGifyeWeuJ">
                    <label for="SGifyeWeuJ">Linear Algebra</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="MlfvLaybBc">
                    <label for="MlfvLaybBc">Logarithms</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="FMHlDxgifC">
                    <label for="FMHlDxgifC">Sequences</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="qqhEIEDCIZ">
                    <label for="qqhEIEDCIZ">Single Variable Calculus</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="BNVClJLwEn">
                    <label for="BNVClJLwEn">Trigonometry</label>
                    <ul>
        ...
        <l>
            <input type="checkbox" id="athQefpDuB" checked>
            <label for="athQefpDuB">Programming</label>
            <ul>
                <l>
                    <input type="checkbox" id="vUEVFCdqId">
                    <label for="vUEVFCdqId">Ansible</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="JFLYQcPHGU">
                    <label for="JFLYQcPHGU">Architecture</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="trBIlWWyFN">
                    <label for="trBIlWWyFN">Computer Graphics</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="PxqGasKWbJ">
                    <label for="PxqGasKWbJ">Databases</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="RIeKGBxfzE">
                    <label for="RIeKGBxfzE">Devops</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="kbjIjwbNYR">
                            <label for="kbjIjwbNYR">Cloud Providers</label>
                            <ul>
                                <l>
                                    <input type="checkbox" id="FImHXqrJxo">
                                    <label for="FImHXqrJxo">AWS</label>
                                    <ul>
                                        <l>
                                            <input type="checkbox" id="doJOJgotQm">
                                            <label for="doJOJgotQm">Cli</label>
                                            <ul>
                                        ...
                                        <l>
                                            <input type="checkbox" id="hzUYquobxz">
                                            <label for="hzUYquobxz">Dotnet</label>
                                            <ul>
                                        ...
                                        <l>
                                            <input type="checkbox" id="bwxFKJwrhI">
                                            <label for="bwxFKJwrhI">Ec 2</label>
                                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="BhMfDgmiWY">
                            <label for="BhMfDgmiWY">Events</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="YoHKEQatAO">
                            <label for="YoHKEQatAO">Localstack</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="vUUjvxDoBN">
                            <label for="vUUjvxDoBN">Pulumi</label>
                            <ul>
                                <l>
                                    <input type="checkbox" id="kEFhHwpvsE">
                                    <label for="kEFhHwpvsE">Dotnet</label>
                                    <ul>
                        ...
                        <l>
                            <input type="checkbox" id="LlgSDTYUpJ">
                            <label for="LlgSDTYUpJ">Serverless Framework</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="gXXRNcMtNe">
                            <label for="gXXRNcMtNe">Terraform</label>
                            <ul>
                                <l>
                                    <input type="checkbox" id="PoYjLRHqby">
                                    <label for="PoYjLRHqby">Functions</label>
                                    <ul>
                                ...
                                <l>
                                    <input type="checkbox" id="RfSJTTVPPF">
                                    <label for="RfSJTTVPPF">Meta Arguments</label>
                                    <ul>
                ...
                <l>
                    <input type="checkbox" id="DUaiMiutpg">
                    <label for="DUaiMiutpg">Docker</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="ZUpipjmHlV">
                    <label for="ZUpipjmHlV">Dotnet</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="aDarDphfrB">
                            <label for="aDarDphfrB">Cli</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="LcssIEdVGy">
                    <label for="LcssIEdVGy">Functional Programming</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="bwDjSCDjYD">
                    <label for="bwDjSCDjYD">Git</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="BDTvcTCfGr">
                            <label for="BDTvcTCfGr">Github</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="OPBulAPbXg">
                    <label for="OPBulAPbXg">Go</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="QnPtLXlQpC">
                    <label for="QnPtLXlQpC">Haskell</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="unKhgUEPLJ">
                    <label for="unKhgUEPLJ">Js</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="aujOYfenBU">
                            <label for="aujOYfenBU">Node</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="qdykUsHEfc">
                            <label for="qdykUsHEfc">D3</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="gBFpgLLhvQ">
                            <label for="gBFpgLLhvQ">Mocha</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="UlDpaslzDM">
                            <label for="UlDpaslzDM">P5js</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="SYGBocdfTd">
                            <label for="SYGBocdfTd">Typescript</label>
                            <ul>
                                <l>
                                    <input type="checkbox" id="UWCuKyWxPC">
                                    <label for="UWCuKyWxPC">Testing</label>
                                    <ul>
                ...
                <l>
                    <input type="checkbox" id="MSPehrxhDt">
                    <label for="MSPehrxhDt">Kafka</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="lTMTkMMbzZ">
                    <label for="lTMTkMMbzZ">Kubernetes</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="fwZmJYGqvz">
                    <label for="fwZmJYGqvz">Language</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="lQRFnsowyL">
                    <label for="lQRFnsowyL">Linux</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="SpzJzdNarC">
                            <label for="SpzJzdNarC">Bash</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="XNEAWceOOo">
                    <label for="XNEAWceOOo">Oauth</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="YGwIBnvGWe">
                    <label for="YGwIBnvGWe">Prometheus</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="NCZQNUaAff">
                    <label for="NCZQNUaAff">Python</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="PuFOEEVTge">
                            <label for="PuFOEEVTge">Data Classes</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="wTdLBASWnT">
                            <label for="wTdLBASWnT">Libraries</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="MQBvyucDOK">
                    <label for="MQBvyucDOK">React</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="eKyjLjTPlR">
                    <label for="eKyjLjTPlR">Regular Expressions</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="rGSGYwYiNF">
                    <label for="rGSGYwYiNF">Rust</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="lPtoVCiDvD">
                            <label for="lPtoVCiDvD">Serde</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="eyBZzcYPqf">
                    <label for="eyBZzcYPqf">Shaders</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="LMcikpkfTI">
                            <label for="LMcikpkfTI">Glsl</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="TGewmPsDAr">
                    <label for="TGewmPsDAr">Vim</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="HdyWbBBehd">
                    <label for="HdyWbBBehd">Web</label>
                    <ul>
