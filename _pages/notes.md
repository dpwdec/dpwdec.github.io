...
<ul>
    <div name="contents-index">
        ...
        <l>
            <input type="checkbox" id="NZwnHTTIqe" checked>
            <label for="NZwnHTTIqe">Math</label>
            <ul>
                <l>
                    <input type="checkbox" id="veqmNREGZy">
                    <label for="veqmNREGZy">Exponentials</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="GQpvnqwNCz">
                    <label for="GQpvnqwNCz">Linear Algebra</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="iyzdswaYQX">
                    <label for="iyzdswaYQX">Logarithms</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="DdIlKoHDVF">
                    <label for="DdIlKoHDVF">Sequences</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="ZvDfcWUyzU">
                    <label for="ZvDfcWUyzU">Single Variable Calculus</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="BguNCkGNNC">
                    <label for="BguNCkGNNC">Trigonometry</label>
                    <ul>
        ...
        <l>
            <input type="checkbox" id="WJsmVnIxYN" checked>
            <label for="WJsmVnIxYN">Programming</label>
            <ul>
                <l>
                    <input type="checkbox" id="aEFbgOKQXj">
                    <label for="aEFbgOKQXj">Ansible</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="XlzPqeEzev">
                    <label for="XlzPqeEzev">Architecture</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="PLTwibiNHa">
                    <label for="PLTwibiNHa">Computer Graphics</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="ATttxFMJZC">
                    <label for="ATttxFMJZC">Databases</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="cKwkRFeycn">
                    <label for="cKwkRFeycn">Devops</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="XCTfPGmKfq">
                            <label for="XCTfPGmKfq">Cloud Providers</label>
                            <ul>
                                <l>
                                    <input type="checkbox" id="RWdhEKbjOW">
                                    <label for="RWdhEKbjOW">AWS</label>
                                    <ul>
                                        <l>
                                            <input type="checkbox" id="vzQniJPkAM">
                                            <label for="vzQniJPkAM">Cli</label>
                                            <ul>
                                        ...
                                        <l>
                                            <input type="checkbox" id="tFrJmXrFYK">
                                            <label for="tFrJmXrFYK">Dotnet</label>
                                            <ul>
                                        ...
                                        <l>
                                            <input type="checkbox" id="nvhZQCtREo">
                                            <label for="nvhZQCtREo">Ec 2</label>
                                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="DDREJwZATM">
                            <label for="DDREJwZATM">Events</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="eCfKmrRoXY">
                            <label for="eCfKmrRoXY">Localstack</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="SANVAGHxLZ">
                            <label for="SANVAGHxLZ">Pulumi</label>
                            <ul>
                                <l>
                                    <input type="checkbox" id="timJQptCgG">
                                    <label for="timJQptCgG">Dotnet</label>
                                    <ul>
                        ...
                        <l>
                            <input type="checkbox" id="EZntrJWrnc">
                            <label for="EZntrJWrnc">Serverless Framework</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="XrgjtaKhRf">
                            <label for="XrgjtaKhRf">Terraform</label>
                            <ul>
                                <l>
                                    <input type="checkbox" id="qWtkIfQYSv">
                                    <label for="qWtkIfQYSv">Functions</label>
                                    <ul>
                                ...
                                <l>
                                    <input type="checkbox" id="MORlNaibCb">
                                    <label for="MORlNaibCb">Meta Arguments</label>
                                    <ul>
                ...
                <l>
                    <input type="checkbox" id="hemidlKFUe">
                    <label for="hemidlKFUe">Docker</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="NkBtqqtKWv">
                    <label for="NkBtqqtKWv">Dotnet</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="SWchgadCjD">
                            <label for="SWchgadCjD">Cli</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="WwFycFYwFT">
                    <label for="WwFycFYwFT">Functional Programming</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="CsNiFRGuPW">
                    <label for="CsNiFRGuPW">Git</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="wNSWVQvHeF">
                            <label for="wNSWVQvHeF">Github</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="ZzBlJGtoAz">
                    <label for="ZzBlJGtoAz">Go</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="swipHdyGdV">
                    <label for="swipHdyGdV">Haskell</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="XkubpYiuKf">
                    <label for="XkubpYiuKf">Js</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="efViuGRVRl">
                            <label for="efViuGRVRl">Node</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="pjWtCeaPfi">
                            <label for="pjWtCeaPfi">D3</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="buEEqMEnRp">
                            <label for="buEEqMEnRp">Mocha</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="FZuLkjlfxw">
                            <label for="FZuLkjlfxw">P5js</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="mqwyByOyaX">
                            <label for="mqwyByOyaX">Typescript</label>
                            <ul>
                                <l>
                                    <input type="checkbox" id="ZiuBqyqMeJ">
                                    <label for="ZiuBqyqMeJ">Testing</label>
                                    <ul>
                ...
                <l>
                    <input type="checkbox" id="UqEDcbtQZq">
                    <label for="UqEDcbtQZq">Kafka</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="KgugJhurRn">
                    <label for="KgugJhurRn">Kubernetes</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="KGgKMrSXti">
                    <label for="KGgKMrSXti">Language</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="YAGCxmDVmo">
                    <label for="YAGCxmDVmo">Linux</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="ewjmLaMOSE">
                            <label for="ewjmLaMOSE">Bash</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="cLnukHaMtY">
                    <label for="cLnukHaMtY">Oauth</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="sMPasLJSbf">
                    <label for="sMPasLJSbf">Python</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="EBRAPcteTj">
                            <label for="EBRAPcteTj">Data Classes</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="znwKzaajtn">
                            <label for="znwKzaajtn">Libraries</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="EnZwntMIQf">
                    <label for="EnZwntMIQf">React</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="qkeyJjKZsM">
                    <label for="qkeyJjKZsM">Regular Expressions</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="MUtKDVuASK">
                    <label for="MUtKDVuASK">Rust</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="vmjOBoVBCj">
                            <label for="vmjOBoVBCj">Serde</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="lUSnmxcvfS">
                    <label for="lUSnmxcvfS">Shaders</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="cESowmUXtw">
                            <label for="cESowmUXtw">Glsl</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="maHRJHXiSw">
                    <label for="maHRJHXiSw">Vim</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="hubnkxOSqE">
                    <label for="hubnkxOSqE">Web</label>
                    <ul>
