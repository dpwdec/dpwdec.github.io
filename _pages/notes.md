...
<ul>
    <div name="contents-index">
        ...
        <l>
            <input type="checkbox" id="NwOvfQcqUh" checked>
            <label for="NwOvfQcqUh">Math</label>
            <ul>
                <l>
                    <input type="checkbox" id="RmzapHIIsO">
                    <label for="RmzapHIIsO">Exponentials</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="cyUGzGAxfi">
                    <label for="cyUGzGAxfi">Linear Algebra</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="dtuWycqsdj">
                    <label for="dtuWycqsdj">Logarithms</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="npIBzyUxxP">
                    <label for="npIBzyUxxP">Sequences</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="iPJOilkqTM">
                    <label for="iPJOilkqTM">Single Variable Calculus</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="CkUbkfYwiy">
                    <label for="CkUbkfYwiy">Trigonometry</label>
                    <ul>
        ...
        <l>
            <input type="checkbox" id="MiZwntEeFc" checked>
            <label for="MiZwntEeFc">Programming</label>
            <ul>
                <l>
                    <input type="checkbox" id="IerITdeBhZ">
                    <label for="IerITdeBhZ">Ansible</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="zeZizxFmdi">
                    <label for="zeZizxFmdi">Architecture</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="MxdqwHKFFv">
                    <label for="MxdqwHKFFv">Computer Graphics</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="MIJvJpixLZ">
                    <label for="MIJvJpixLZ">Databases</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="yxpbGjjglb">
                    <label for="yxpbGjjglb">Devops</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="uuOVdqnaiu">
                            <label for="uuOVdqnaiu">Cloud Providers</label>
                            <ul>
                                <l>
                                    <input type="checkbox" id="BPPTwDdzuw">
                                    <label for="BPPTwDdzuw">AWS</label>
                                    <ul>
                                        <l>
                                            <input type="checkbox" id="kwctyiKVMX">
                                            <label for="kwctyiKVMX">Cli</label>
                                            <ul>
                                        ...
                                        <l>
                                            <input type="checkbox" id="KpzXPvLQGz">
                                            <label for="KpzXPvLQGz">Dotnet</label>
                                            <ul>
                                        ...
                                        <l>
                                            <input type="checkbox" id="tmLUeASUvu">
                                            <label for="tmLUeASUvu">Ec 2</label>
                                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="HnyYePzIFm">
                            <label for="HnyYePzIFm">Events</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="BgkOcTJyfs">
                            <label for="BgkOcTJyfs">Localstack</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="FDjbwiZskQ">
                            <label for="FDjbwiZskQ">Pulumi</label>
                            <ul>
                                <l>
                                    <input type="checkbox" id="kOoPLOcCNk">
                                    <label for="kOoPLOcCNk">Dotnet</label>
                                    <ul>
                        ...
                        <l>
                            <input type="checkbox" id="oLizTHrFJp">
                            <label for="oLizTHrFJp">Serverless Framework</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="ftkMPZwZrd">
                            <label for="ftkMPZwZrd">Terraform</label>
                            <ul>
                                <l>
                                    <input type="checkbox" id="flXaPtWTGZ">
                                    <label for="flXaPtWTGZ">Functions</label>
                                    <ul>
                                ...
                                <l>
                                    <input type="checkbox" id="lQrCUcBNSH">
                                    <label for="lQrCUcBNSH">Meta Arguments</label>
                                    <ul>
                ...
                <l>
                    <input type="checkbox" id="nAQkuxpJaI">
                    <label for="nAQkuxpJaI">Docker</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="AprOdcgVQn">
                    <label for="AprOdcgVQn">Dotnet</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="axUSyExXzW">
                            <label for="axUSyExXzW">Cli</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="SeaEeKEwcc">
                    <label for="SeaEeKEwcc">Functional Programming</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="yQsWDmXuKE">
                    <label for="yQsWDmXuKE">Git</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="fAgBYMdPsY">
                            <label for="fAgBYMdPsY">Github</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="bXmmkIoOxw">
                    <label for="bXmmkIoOxw">Go</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="zQEtMOCZIx">
                    <label for="zQEtMOCZIx">Haskell</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="WQGsFSLoop">
                    <label for="WQGsFSLoop">Js</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="AzYFxVnpec">
                            <label for="AzYFxVnpec">Node</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="jmkllBVhes">
                            <label for="jmkllBVhes">D3</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="QDapRKofag">
                            <label for="QDapRKofag">Mocha</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="ILDjTtOPOI">
                            <label for="ILDjTtOPOI">P5js</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="ZTsAKENTOO">
                            <label for="ZTsAKENTOO">Typescript</label>
                            <ul>
                                <l>
                                    <input type="checkbox" id="OkGCkpvPjR">
                                    <label for="OkGCkpvPjR">Testing</label>
                                    <ul>
                ...
                <l>
                    <input type="checkbox" id="ThKaRYqBgf">
                    <label for="ThKaRYqBgf">Kafka</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="ZvtKJmJfyy">
                    <label for="ZvtKJmJfyy">Kubernetes</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="MZGcKCjpvc">
                    <label for="MZGcKCjpvc">Language</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="HaoUjvpwTa">
                    <label for="HaoUjvpwTa">Linux</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="xbuuLalSfw">
                            <label for="xbuuLalSfw">Bash</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="kRMrkgWCoM">
                    <label for="kRMrkgWCoM">Oauth</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="gHxpbnfuKE">
                    <label for="gHxpbnfuKE">Prometheus</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="ZNABWuaZPq">
                    <label for="ZNABWuaZPq">Python</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="vvZwSLRkFD">
                            <label for="vvZwSLRkFD">Data Classes</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="IfrhGecaFz">
                            <label for="IfrhGecaFz">Libraries</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="pdhFuGVasf">
                    <label for="pdhFuGVasf">React</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="FsMnqXekhe">
                    <label for="FsMnqXekhe">Regular Expressions</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="LzoPJjpLMm">
                    <label for="LzoPJjpLMm">Rust</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="pdxzVJcTvt">
                            <label for="pdxzVJcTvt">Serde</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="jeVGdBnUeP">
                    <label for="jeVGdBnUeP">Shaders</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="AsNbUuoCZX">
                            <label for="AsNbUuoCZX">Glsl</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="BEhbTcRnsx">
                    <label for="BEhbTcRnsx">Vim</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="aGMnLaVjTd">
                    <label for="aGMnLaVjTd">Web</label>
                    <ul>
