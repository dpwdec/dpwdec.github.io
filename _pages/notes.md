...
<ul>
    <div name="contents-index">
        ...
        <l>
            <input type="checkbox" id="HXMkYrNCNS" checked>
            <label for="HXMkYrNCNS">Math</label>
            <ul>
                <l>
                    <input type="checkbox" id="yjdzPeZOnU">
                    <label for="yjdzPeZOnU">Exponentials</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="pZLmBHLEzk">
                    <label for="pZLmBHLEzk">Linear Algebra</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="EANVflpghh">
                    <label for="EANVflpghh">Logarithms</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="bktCgHMQpE">
                    <label for="bktCgHMQpE">Sequences</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="IUIJTxwCKr">
                    <label for="IUIJTxwCKr">Single Variable Calculus</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="ItVpEcXnTO">
                    <label for="ItVpEcXnTO">Trigonometry</label>
                    <ul>
        ...
        <l>
            <input type="checkbox" id="KIvpBEVqqL" checked>
            <label for="KIvpBEVqqL">Programming</label>
            <ul>
                <l>
                    <input type="checkbox" id="lPMYVHYJjo">
                    <label for="lPMYVHYJjo">Ansible</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="pTYvLzQpth">
                    <label for="pTYvLzQpth">Architecture</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="xwvkTGOYMf">
                    <label for="xwvkTGOYMf">Computer Graphics</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="LHYaggdhfF">
                    <label for="LHYaggdhfF">Databases</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="xeVoKIukYd">
                    <label for="xeVoKIukYd">Devops</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="MxqHvFXUhw">
                            <label for="MxqHvFXUhw">Cloud Providers</label>
                            <ul>
                                <l>
                                    <input type="checkbox" id="DpPbWUjLyX">
                                    <label for="DpPbWUjLyX">AWS</label>
                                    <ul>
                                        <l>
                                            <input type="checkbox" id="RHrDkMPhpX">
                                            <label for="RHrDkMPhpX">Cli</label>
                                            <ul>
                                        ...
                                        <l>
                                            <input type="checkbox" id="JjMHuGNnds">
                                            <label for="JjMHuGNnds">Dotnet</label>
                                            <ul>
                                        ...
                                        <l>
                                            <input type="checkbox" id="XpqvFKSHZl">
                                            <label for="XpqvFKSHZl">Ec 2</label>
                                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="mAjtbzUzcX">
                            <label for="mAjtbzUzcX">Events</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="vYgRadEgZd">
                            <label for="vYgRadEgZd">Localstack</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="GXIcrSmBIG">
                            <label for="GXIcrSmBIG">Pulumi</label>
                            <ul>
                                <l>
                                    <input type="checkbox" id="jVbBSEbSEQ">
                                    <label for="jVbBSEbSEQ">Dotnet</label>
                                    <ul>
                        ...
                        <l>
                            <input type="checkbox" id="kqTNwFqbUK">
                            <label for="kqTNwFqbUK">Serverless Framework</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="xIEOLOdiAE">
                            <label for="xIEOLOdiAE">Terraform</label>
                            <ul>
                                <l>
                                    <input type="checkbox" id="qVtfUoTXjE">
                                    <label for="qVtfUoTXjE">Functions</label>
                                    <ul>
                                ...
                                <l>
                                    <input type="checkbox" id="XstQJgruyl">
                                    <label for="XstQJgruyl">Meta Arguments</label>
                                    <ul>
                ...
                <l>
                    <input type="checkbox" id="FEhucdBXbJ">
                    <label for="FEhucdBXbJ">Docker</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="ICBzuByZpw">
                    <label for="ICBzuByZpw">Dotnet</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="jsmmHTnBYJ">
                            <label for="jsmmHTnBYJ">Cli</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="KUFoFxQxMV">
                    <label for="KUFoFxQxMV">Functional Programming</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="zCSABMcgCV">
                    <label for="zCSABMcgCV">Git</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="sBpmayqzsG">
                            <label for="sBpmayqzsG">Github</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="RVcveADlKw">
                    <label for="RVcveADlKw">Go</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="KXVcmmicPh">
                    <label for="KXVcmmicPh">Haskell</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="GJlXMMaWAe">
                    <label for="GJlXMMaWAe">Js</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="QfPqSeZeAu">
                            <label for="QfPqSeZeAu">Node</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="HPkPIzuMPI">
                            <label for="HPkPIzuMPI">D3</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="YmzikCqdHD">
                            <label for="YmzikCqdHD">Mocha</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="xaZHdBhgow">
                            <label for="xaZHdBhgow">P5js</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="wOIgaduMOc">
                            <label for="wOIgaduMOc">Typescript</label>
                            <ul>
                                <l>
                                    <input type="checkbox" id="vsWtRMqaDQ">
                                    <label for="vsWtRMqaDQ">Testing</label>
                                    <ul>
                ...
                <l>
                    <input type="checkbox" id="DDNxUyvaHr">
                    <label for="DDNxUyvaHr">Kafka</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="NuLCqFmEuO">
                    <label for="NuLCqFmEuO">Kubernetes</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="MGoNRrFhIp">
                    <label for="MGoNRrFhIp">Language</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="gZyGxHqqMf">
                    <label for="gZyGxHqqMf">Linux</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="aeMxlzSEqC">
                            <label for="aeMxlzSEqC">Bash</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="uwMWRmCKha">
                    <label for="uwMWRmCKha">Oauth</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="AAVZVdPaQH">
                    <label for="AAVZVdPaQH">Python</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="ELACXgYzzd">
                            <label for="ELACXgYzzd">Data Classes</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="tSHXXLcodE">
                            <label for="tSHXXLcodE">Libraries</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="vgVpJLJXUJ">
                    <label for="vgVpJLJXUJ">React</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="QytjXQfgoJ">
                    <label for="QytjXQfgoJ">Regular Expressions</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="GWuBZkZuTD">
                    <label for="GWuBZkZuTD">Rust</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="SfOMEgcyUl">
                            <label for="SfOMEgcyUl">Serde</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="Yahhugdjkq">
                    <label for="Yahhugdjkq">Vim</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="xPONVexpqj">
                    <label for="xPONVexpqj">Web</label>
                    <ul>
