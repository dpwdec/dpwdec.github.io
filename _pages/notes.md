...
<ul>
    <div name="contents-index">
        ...
        <l>
            <input type="checkbox" id="EDJrVjtveP" checked>
            <label for="EDJrVjtveP">Math</label>
            <ul>
                <l>
                    <input type="checkbox" id="ikQKXjMhxR">
                    <label for="ikQKXjMhxR">Exponentials</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="pcqLCLmpYB">
                    <label for="pcqLCLmpYB">Linear Algebra</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="pYnoLhjwKB">
                    <label for="pYnoLhjwKB">Logarithms</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="PfzgYGZSyA">
                    <label for="PfzgYGZSyA">Sequences</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="nezoRChnTo">
                    <label for="nezoRChnTo">Single Variable Calculus</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="BJAaeIYQkI">
                    <label for="BJAaeIYQkI">Trigonometry</label>
                    <ul>
        ...
        <l>
            <input type="checkbox" id="VDnpxtvqcR" checked>
            <label for="VDnpxtvqcR">Programming</label>
            <ul>
                <l>
                    <input type="checkbox" id="RpqUWhffvF">
                    <label for="RpqUWhffvF">Ansible</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="PLSOpodKEQ">
                    <label for="PLSOpodKEQ">Architecture</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="PWrbeMVyRA">
                    <label for="PWrbeMVyRA">Computer Graphics</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="nHeNynGwDG">
                    <label for="nHeNynGwDG">Databases</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="TTFunIlHHq">
                    <label for="TTFunIlHHq">Devops</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="foccqjhbXX">
                            <label for="foccqjhbXX">Cloud Providers</label>
                            <ul>
                                <l>
                                    <input type="checkbox" id="iETZOCeDFR">
                                    <label for="iETZOCeDFR">AWS</label>
                                    <ul>
                                        <l>
                                            <input type="checkbox" id="iOOLqyxdUc">
                                            <label for="iOOLqyxdUc">Cli</label>
                                            <ul>
                                        ...
                                        <l>
                                            <input type="checkbox" id="lJzbZOHXwb">
                                            <label for="lJzbZOHXwb">Dotnet</label>
                                            <ul>
                                        ...
                                        <l>
                                            <input type="checkbox" id="EANurtKYoF">
                                            <label for="EANurtKYoF">Ec 2</label>
                                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="wgLPEvfvFz">
                            <label for="wgLPEvfvFz">Events</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="zOppfCXnJW">
                            <label for="zOppfCXnJW">Localstack</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="GIvxxjlZIz">
                            <label for="GIvxxjlZIz">Pulumi</label>
                            <ul>
                                <l>
                                    <input type="checkbox" id="DSTuTEGxBZ">
                                    <label for="DSTuTEGxBZ">Dotnet</label>
                                    <ul>
                        ...
                        <l>
                            <input type="checkbox" id="oiKIuKXLJU">
                            <label for="oiKIuKXLJU">Serverless Framework</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="dHxCzvJzrn">
                            <label for="dHxCzvJzrn">Terraform</label>
                            <ul>
                                <l>
                                    <input type="checkbox" id="VlSDPXwLCm">
                                    <label for="VlSDPXwLCm">Functions</label>
                                    <ul>
                                ...
                                <l>
                                    <input type="checkbox" id="modQtAaEYV">
                                    <label for="modQtAaEYV">Meta Arguments</label>
                                    <ul>
                ...
                <l>
                    <input type="checkbox" id="miDCbkKIMi">
                    <label for="miDCbkKIMi">Docker</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="QfqcbmAxOR">
                    <label for="QfqcbmAxOR">Dotnet</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="mGqlcWEplf">
                            <label for="mGqlcWEplf">Cli</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="ZSuNXahNzK">
                    <label for="ZSuNXahNzK">Functional Programming</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="yCHHXCRgWL">
                    <label for="yCHHXCRgWL">Git</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="hqJPOqyoVN">
                            <label for="hqJPOqyoVN">Github</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="PPoEoQjDeN">
                    <label for="PPoEoQjDeN">Go</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="RaZeQdClre">
                    <label for="RaZeQdClre">Haskell</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="ihjOgJqkQR">
                    <label for="ihjOgJqkQR">Js</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="fePGkeOKqp">
                            <label for="fePGkeOKqp">Node</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="aATsqCWSFN">
                            <label for="aATsqCWSFN">D3</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="sMzKzkLBCn">
                            <label for="sMzKzkLBCn">Mocha</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="LJhuKDaOwX">
                            <label for="LJhuKDaOwX">P5js</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="YPDUjqNbUz">
                            <label for="YPDUjqNbUz">Typescript</label>
                            <ul>
                                <l>
                                    <input type="checkbox" id="mNpMclJXvl">
                                    <label for="mNpMclJXvl">Testing</label>
                                    <ul>
                ...
                <l>
                    <input type="checkbox" id="YRcaEWKEqN">
                    <label for="YRcaEWKEqN">Kafka</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="bmBgYOaUrM">
                    <label for="bmBgYOaUrM">Kubernetes</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="RULiLdPkUy">
                    <label for="RULiLdPkUy">Language</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="pFjStGYUcv">
                    <label for="pFjStGYUcv">Linux</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="RGkeSpZHhe">
                            <label for="RGkeSpZHhe">Bash</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="SRBJjOHsMS">
                    <label for="SRBJjOHsMS">Oauth</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="CwTZVtzjQA">
                    <label for="CwTZVtzjQA">Prometheus</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="WMjOuispVq">
                    <label for="WMjOuispVq">Python</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="TDiRGXuuXo">
                            <label for="TDiRGXuuXo">Data Classes</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="hcQcanaDFr">
                            <label for="hcQcanaDFr">Libraries</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="sZSwvcaBgW">
                    <label for="sZSwvcaBgW">React</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="mSVLrfoOMK">
                    <label for="mSVLrfoOMK">Regular Expressions</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="kCWoFMkopZ">
                    <label for="kCWoFMkopZ">Rust</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="oaawIeIPBY">
                            <label for="oaawIeIPBY">Serde</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="IFJmOohnTM">
                    <label for="IFJmOohnTM">Shaders</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="oLtsMgFFTA">
                            <label for="oLtsMgFFTA">Glsl</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="gjGCUTSWYi">
                    <label for="gjGCUTSWYi">Vim</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="zWCMZwHbVs">
                    <label for="zWCMZwHbVs">Web</label>
                    <ul>
