...
<ul>
    <div name="contents-index">
        ...
        <l>
            <input type="checkbox" id="ZwUbiYtjxn" checked>
            <label for="ZwUbiYtjxn">Math</label>
            <ul>
                <l>
                    <input type="checkbox" id="slXWkYvaAa">
                    <label for="slXWkYvaAa">Exponentials</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="wNSFJgtNfT">
                    <label for="wNSFJgtNfT">Linear Algebra</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="OHaHyNHYXk">
                    <label for="OHaHyNHYXk">Logarithms</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="QHLSfulhnc">
                    <label for="QHLSfulhnc">Sequences</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="tVAOkWKwhP">
                    <label for="tVAOkWKwhP">Single Variable Calculus</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="YrJhzBMCzk">
                    <label for="YrJhzBMCzk">Trigonometry</label>
                    <ul>
        ...
        <l>
            <input type="checkbox" id="kAMKvAmEzl" checked>
            <label for="kAMKvAmEzl">Programming</label>
            <ul>
                <l>
                    <input type="checkbox" id="sEtyEzvMrW">
                    <label for="sEtyEzvMrW">Ansible</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="XYHoNlFAwp">
                    <label for="XYHoNlFAwp">Architecture</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="ZoCEsijgDo">
                    <label for="ZoCEsijgDo">Computer Graphics</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="kTsLqedeuN">
                    <label for="kTsLqedeuN">Databases</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="DRbmTcnBkV">
                    <label for="DRbmTcnBkV">Devops</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="rcIQKXYZzp">
                            <label for="rcIQKXYZzp">Cloud Providers</label>
                            <ul>
                                <l>
                                    <input type="checkbox" id="wbSNWEtLhl">
                                    <label for="wbSNWEtLhl">AWS</label>
                                    <ul>
                                        <l>
                                            <input type="checkbox" id="ZxZbLzTSHV">
                                            <label for="ZxZbLzTSHV">Cli</label>
                                            <ul>
                                        ...
                                        <l>
                                            <input type="checkbox" id="eXIuZjtvSp">
                                            <label for="eXIuZjtvSp">Dotnet</label>
                                            <ul>
                                        ...
                                        <l>
                                            <input type="checkbox" id="OZedSfnrUZ">
                                            <label for="OZedSfnrUZ">Ec 2</label>
                                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="YqqXxJblcg">
                            <label for="YqqXxJblcg">Events</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="jvKMtqzLcF">
                            <label for="jvKMtqzLcF">Localstack</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="WelIMVmCVh">
                            <label for="WelIMVmCVh">Pulumi</label>
                            <ul>
                                <l>
                                    <input type="checkbox" id="qbNzsPaXpl">
                                    <label for="qbNzsPaXpl">Dotnet</label>
                                    <ul>
                        ...
                        <l>
                            <input type="checkbox" id="NvYfATDsgz">
                            <label for="NvYfATDsgz">Serverless Framework</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="LyLVGnHWqf">
                            <label for="LyLVGnHWqf">Terraform</label>
                            <ul>
                                <l>
                                    <input type="checkbox" id="qtZMQHOpEF">
                                    <label for="qtZMQHOpEF">Functions</label>
                                    <ul>
                                ...
                                <l>
                                    <input type="checkbox" id="YrhPEqxLRp">
                                    <label for="YrhPEqxLRp">Meta Arguments</label>
                                    <ul>
                ...
                <l>
                    <input type="checkbox" id="bFLTRwVocH">
                    <label for="bFLTRwVocH">Docker</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="TOtabSdHUD">
                    <label for="TOtabSdHUD">Dotnet</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="mJqNNFZcLM">
                            <label for="mJqNNFZcLM">Cli</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="oanNlbiIhC">
                    <label for="oanNlbiIhC">Functional Programming</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="CMTDPTwcEG">
                    <label for="CMTDPTwcEG">Git</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="cAoXhFzcBT">
                            <label for="cAoXhFzcBT">Github</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="oDjBYOMTBY">
                    <label for="oDjBYOMTBY">Go</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="qsOjFsmYaX">
                    <label for="qsOjFsmYaX">Haskell</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="UxrYMyHLpc">
                    <label for="UxrYMyHLpc">Js</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="kkSDcYkLoA">
                            <label for="kkSDcYkLoA">Node</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="ECbhmiKubR">
                            <label for="ECbhmiKubR">D3</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="OIgKXSnVZe">
                            <label for="OIgKXSnVZe">Mocha</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="CtppDuOQFF">
                            <label for="CtppDuOQFF">P5js</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="tqoLXbPcaK">
                            <label for="tqoLXbPcaK">Typescript</label>
                            <ul>
                                <l>
                                    <input type="checkbox" id="EIHvUmtZqB">
                                    <label for="EIHvUmtZqB">Testing</label>
                                    <ul>
                ...
                <l>
                    <input type="checkbox" id="QSalyBmiLJ">
                    <label for="QSalyBmiLJ">Kafka</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="DLUoLMUGRH">
                    <label for="DLUoLMUGRH">Kubernetes</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="nZXXJNPRYf">
                    <label for="nZXXJNPRYf">Language</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="ZBzXdASIjR">
                    <label for="ZBzXdASIjR">Linux</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="SYOBQGCOof">
                            <label for="SYOBQGCOof">Bash</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="tMYcUWcWOl">
                    <label for="tMYcUWcWOl">Oauth</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="UTOBtqEPAr">
                    <label for="UTOBtqEPAr">Prometheus</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="EUbznpoRiS">
                    <label for="EUbznpoRiS">Python</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="QgqhFxMcWj">
                            <label for="QgqhFxMcWj">Data Classes</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="gsxJicGTjs">
                            <label for="gsxJicGTjs">Libraries</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="sTUTetzOVV">
                    <label for="sTUTetzOVV">React</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="pbmumYDtGs">
                    <label for="pbmumYDtGs">Regular Expressions</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="ZDpVjRcuBI">
                    <label for="ZDpVjRcuBI">Rust</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="gXfxFZgTMu">
                            <label for="gXfxFZgTMu">Serde</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="EyVvjHJKOv">
                    <label for="EyVvjHJKOv">Shaders</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="bkXlQofRgt">
                            <label for="bkXlQofRgt">Glsl</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="cfdvmsbyRj">
                    <label for="cfdvmsbyRj">Vim</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="aAnYBYTIiE">
                    <label for="aAnYBYTIiE">Web</label>
                    <ul>
