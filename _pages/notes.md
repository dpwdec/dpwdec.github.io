...
<ul>
    <div name="contents-index">
        ...
        <l>
            <input type="checkbox" id="EdnkeLCwxc" checked>
            <label for="EdnkeLCwxc">Math</label>
            <ul>
                <l>
                    <input type="checkbox" id="VokXvSXNgG">
                    <label for="VokXvSXNgG">Exponentials</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="FTlCIHVKqG">
                    <label for="FTlCIHVKqG">Linear Algebra</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="lqiFfzgDbi">
                    <label for="lqiFfzgDbi">Logarithms</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="PAWIqkoUXA">
                    <label for="PAWIqkoUXA">Sequences</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="MPiKdDpcjt">
                    <label for="MPiKdDpcjt">Single Variable Calculus</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="LIZGSZpxlj">
                    <label for="LIZGSZpxlj">Trigonometry</label>
                    <ul>
        ...
        <l>
            <input type="checkbox" id="OFjjRfSWZW" checked>
            <label for="OFjjRfSWZW">Programming</label>
            <ul>
                <l>
                    <input type="checkbox" id="yqtWRwFcgG">
                    <label for="yqtWRwFcgG">Ansible</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="AyXPizFAjC">
                    <label for="AyXPizFAjC">Architecture</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="WVAkfygVVh">
                    <label for="WVAkfygVVh">Computer Graphics</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="uAIurHJKCf">
                    <label for="uAIurHJKCf">Databases</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="NyHaASXGmS">
                    <label for="NyHaASXGmS">Devops</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="bkcydxJsqg">
                            <label for="bkcydxJsqg">Cloud Providers</label>
                            <ul>
                                <l>
                                    <input type="checkbox" id="jDdkfRVJEW">
                                    <label for="jDdkfRVJEW">AWS</label>
                                    <ul>
                                        <l>
                                            <input type="checkbox" id="beYLnxiYzf">
                                            <label for="beYLnxiYzf">Cli</label>
                                            <ul>
                                        ...
                                        <l>
                                            <input type="checkbox" id="lYvAFeUdYm">
                                            <label for="lYvAFeUdYm">Dotnet</label>
                                            <ul>
                                        ...
                                        <l>
                                            <input type="checkbox" id="LIxNpqXyMs">
                                            <label for="LIxNpqXyMs">Ec 2</label>
                                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="UWhaBnBrVo">
                            <label for="UWhaBnBrVo">Events</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="EEKFcBGfZV">
                            <label for="EEKFcBGfZV">Localstack</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="DVWQxDanLX">
                            <label for="DVWQxDanLX">Pulumi</label>
                            <ul>
                                <l>
                                    <input type="checkbox" id="taMZiuWBXa">
                                    <label for="taMZiuWBXa">Dotnet</label>
                                    <ul>
                        ...
                        <l>
                            <input type="checkbox" id="nUfMzRMJca">
                            <label for="nUfMzRMJca">Serverless Framework</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="xwjuakmJnj">
                            <label for="xwjuakmJnj">Terraform</label>
                            <ul>
                                <l>
                                    <input type="checkbox" id="cIRgiFtzEV">
                                    <label for="cIRgiFtzEV">Functions</label>
                                    <ul>
                                ...
                                <l>
                                    <input type="checkbox" id="MtleYthboF">
                                    <label for="MtleYthboF">Meta Arguments</label>
                                    <ul>
                ...
                <l>
                    <input type="checkbox" id="yREkElQSpc">
                    <label for="yREkElQSpc">Docker</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="FCzjnkvBHH">
                    <label for="FCzjnkvBHH">Dotnet</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="NihRdsCToV">
                            <label for="NihRdsCToV">Cli</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="KucNrGxwWH">
                    <label for="KucNrGxwWH">Functional Programming</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="enoRFzDfza">
                    <label for="enoRFzDfza">Git</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="XdRXMsmyvJ">
                            <label for="XdRXMsmyvJ">Github</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="EmapAsSPuA">
                    <label for="EmapAsSPuA">Go</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="ijfWRHzXee">
                    <label for="ijfWRHzXee">Haskell</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="pvMkVkFKVa">
                    <label for="pvMkVkFKVa">Js</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="dTiERRnUmk">
                            <label for="dTiERRnUmk">Node</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="FWNPPgIrEU">
                            <label for="FWNPPgIrEU">D3</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="FLeiCbJxQD">
                            <label for="FLeiCbJxQD">Mocha</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="mSrENliSai">
                            <label for="mSrENliSai">P5js</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="MoAqkHfxxS">
                            <label for="MoAqkHfxxS">Typescript</label>
                            <ul>
                                <l>
                                    <input type="checkbox" id="PtaocwDEsb">
                                    <label for="PtaocwDEsb">Testing</label>
                                    <ul>
                ...
                <l>
                    <input type="checkbox" id="DhLtSuuwrJ">
                    <label for="DhLtSuuwrJ">Kafka</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="dZgXzhahCN">
                    <label for="dZgXzhahCN">Kubernetes</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="bUPkGeYbDR">
                    <label for="bUPkGeYbDR">Language</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="mrPYdURnpN">
                    <label for="mrPYdURnpN">Linux</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="rsEqSeGiBo">
                            <label for="rsEqSeGiBo">Bash</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="NJQMPPhdUt">
                    <label for="NJQMPPhdUt">Oauth</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="apGxlVNTWv">
                    <label for="apGxlVNTWv">Prometheus</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="FHWatWONTh">
                    <label for="FHWatWONTh">Python</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="FDdxZVfIGf">
                            <label for="FDdxZVfIGf">Data Classes</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="QuYbTWwMBA">
                            <label for="QuYbTWwMBA">Libraries</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="ZwjqdOAANf">
                    <label for="ZwjqdOAANf">React</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="VIUuosXLZk">
                    <label for="VIUuosXLZk">Regular Expressions</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="GSVTvptgMD">
                    <label for="GSVTvptgMD">Rust</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="BgwsizToUi">
                            <label for="BgwsizToUi">Serde</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="bDNoLrZRoY">
                    <label for="bDNoLrZRoY">Shaders</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="RDWyYCvlPe">
                            <label for="RDWyYCvlPe">Glsl</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="kcNlRDuxDz">
                    <label for="kcNlRDuxDz">Vim</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="DbIPQebCKr">
                    <label for="DbIPQebCKr">Web</label>
                    <ul>
