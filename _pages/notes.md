...
<ul>
    <div name="contents-index">
        ...
        <l>
            <input type="checkbox" id="bnsQYeXKOA" checked>
            <label for="bnsQYeXKOA">Math</label>
            <ul>
                <l>
                    <input type="checkbox" id="aIlhHFEyGD">
                    <label for="aIlhHFEyGD">Exponentials</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="pqMPsjouZz">
                    <label for="pqMPsjouZz">Linear Algebra</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="BJuYOajsdQ">
                    <label for="BJuYOajsdQ">Logarithms</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="ZmWiATAZrF">
                    <label for="ZmWiATAZrF">Sequences</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="GDZyKiMgVD">
                    <label for="GDZyKiMgVD">Single Variable Calculus</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="vgjptAiLyd">
                    <label for="vgjptAiLyd">Trigonometry</label>
                    <ul>
        ...
        <l>
            <input type="checkbox" id="DesUJzxGpc" checked>
            <label for="DesUJzxGpc">Programming</label>
            <ul>
                <l>
                    <input type="checkbox" id="itTdyoBrvM">
                    <label for="itTdyoBrvM">Ansible</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="eNJYGbrYnz">
                    <label for="eNJYGbrYnz">Architecture</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="LSZHGgjqjV">
                    <label for="LSZHGgjqjV">Computer Graphics</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="LcZixFTzfW">
                    <label for="LcZixFTzfW">Databases</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="uitwJoqucV">
                    <label for="uitwJoqucV">Devops</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="DpqyhXDmOi">
                            <label for="DpqyhXDmOi">Cloud Providers</label>
                            <ul>
                                <l>
                                    <input type="checkbox" id="yZbKvXlYDy">
                                    <label for="yZbKvXlYDy">AWS</label>
                                    <ul>
                                        <l>
                                            <input type="checkbox" id="xLtzyqwkAP">
                                            <label for="xLtzyqwkAP">Cli</label>
                                            <ul>
                                        ...
                                        <l>
                                            <input type="checkbox" id="rjTFIpXKAc">
                                            <label for="rjTFIpXKAc">Dotnet</label>
                                            <ul>
                                        ...
                                        <l>
                                            <input type="checkbox" id="OfukwzhFsx">
                                            <label for="OfukwzhFsx">Ec 2</label>
                                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="zCEOdcMsvt">
                            <label for="zCEOdcMsvt">Events</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="xOdOLPlwVd">
                            <label for="xOdOLPlwVd">Localstack</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="NDLkKJEPbh">
                            <label for="NDLkKJEPbh">Pulumi</label>
                            <ul>
                                <l>
                                    <input type="checkbox" id="DfmvxTQJwh">
                                    <label for="DfmvxTQJwh">Dotnet</label>
                                    <ul>
                        ...
                        <l>
                            <input type="checkbox" id="KmDmmbKyjE">
                            <label for="KmDmmbKyjE">Serverless Framework</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="lQorFuKqaE">
                            <label for="lQorFuKqaE">Terraform</label>
                            <ul>
                                <l>
                                    <input type="checkbox" id="jHdPlrKbjj">
                                    <label for="jHdPlrKbjj">Functions</label>
                                    <ul>
                                ...
                                <l>
                                    <input type="checkbox" id="QmJkWTMSDT">
                                    <label for="QmJkWTMSDT">Meta Arguments</label>
                                    <ul>
                ...
                <l>
                    <input type="checkbox" id="vxtswlvvqd">
                    <label for="vxtswlvvqd">Docker</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="fbKNyLaBEm">
                    <label for="fbKNyLaBEm">Dotnet</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="tpiBNTvZGU">
                            <label for="tpiBNTvZGU">Cli</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="EIEDWcTexO">
                    <label for="EIEDWcTexO">Functional Programming</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="kksoeAQeDv">
                    <label for="kksoeAQeDv">Git</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="BVlCJQCzlx">
                            <label for="BVlCJQCzlx">Github</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="NgUZqlOcgB">
                    <label for="NgUZqlOcgB">Go</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="lqkgnzkOPZ">
                    <label for="lqkgnzkOPZ">Haskell</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="MXsSUKNsEt">
                    <label for="MXsSUKNsEt">Js</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="CaFNlnTCjK">
                            <label for="CaFNlnTCjK">Node</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="jzZHAzgVhZ">
                            <label for="jzZHAzgVhZ">D3</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="QcdsNMoNPO">
                            <label for="QcdsNMoNPO">Mocha</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="TxxZzuwchO">
                            <label for="TxxZzuwchO">P5js</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="TaJfADfDAr">
                            <label for="TaJfADfDAr">Typescript</label>
                            <ul>
                                <l>
                                    <input type="checkbox" id="VdcuUMFWvL">
                                    <label for="VdcuUMFWvL">Testing</label>
                                    <ul>
                ...
                <l>
                    <input type="checkbox" id="TRSySjMkuT">
                    <label for="TRSySjMkuT">Kafka</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="QAWOfVjwHj">
                    <label for="QAWOfVjwHj">Kubernetes</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="VdKGQEZass">
                    <label for="VdKGQEZass">Language</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="AmqGwHrozc">
                    <label for="AmqGwHrozc">Linux</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="ZDjSMjRFvD">
                            <label for="ZDjSMjRFvD">Bash</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="nSuDkcgFSw">
                    <label for="nSuDkcgFSw">Oauth</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="WKNEJnBTpb">
                    <label for="WKNEJnBTpb">Python</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="cpVxSeaLOu">
                            <label for="cpVxSeaLOu">Data Classes</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="KXqBZxmuaF">
                            <label for="KXqBZxmuaF">Libraries</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="AoXcxGuhou">
                    <label for="AoXcxGuhou">React</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="SRkuoMGTxV">
                    <label for="SRkuoMGTxV">Regular Expressions</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="FtjnGWrWZV">
                    <label for="FtjnGWrWZV">Rust</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="XCtcPvdpzo">
                            <label for="XCtcPvdpzo">Serde</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="XSKcVbvGso">
                    <label for="XSKcVbvGso">Shaders</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="ZcNhoeMFWP">
                            <label for="ZcNhoeMFWP">Glsl</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="qmwpReupHS">
                    <label for="qmwpReupHS">Vim</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="KKswhnfmWo">
                    <label for="KKswhnfmWo">Web</label>
                    <ul>
