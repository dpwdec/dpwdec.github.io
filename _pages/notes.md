...
<ul>
    <div name="contents-index">
        ...
        <l>
            <input type="checkbox" id="yCUGZaZQOJ" checked>
            <label for="yCUGZaZQOJ">Math</label>
            <ul>
                <l>
                    <input type="checkbox" id="LqsfvUClmw">
                    <label for="LqsfvUClmw">Exponentials</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="LDgRTMRcuu">
                    <label for="LDgRTMRcuu">Linear Algebra</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="ZpjKDDKkJh">
                    <label for="ZpjKDDKkJh">Logarithms</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="EgjqwPXGLC">
                    <label for="EgjqwPXGLC">Sequences</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="mbPUPLtmaM">
                    <label for="mbPUPLtmaM">Single Variable Calculus</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="NNvRKodDRW">
                    <label for="NNvRKodDRW">Trigonometry</label>
                    <ul>
        ...
        <l>
            <input type="checkbox" id="lqCfpFwleU" checked>
            <label for="lqCfpFwleU">Programming</label>
            <ul>
                <l>
                    <input type="checkbox" id="rIufHJaJIM">
                    <label for="rIufHJaJIM">Ansible</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="YCgkjXymfW">
                    <label for="YCgkjXymfW">Architecture</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="ROcFJAbsRi">
                    <label for="ROcFJAbsRi">Computer Graphics</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="stBmYoizJO">
                    <label for="stBmYoizJO">Databases</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="UJGyugKkkq">
                    <label for="UJGyugKkkq">Devops</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="ccOMEjbSYj">
                            <label for="ccOMEjbSYj">Cloud Providers</label>
                            <ul>
                                <l>
                                    <input type="checkbox" id="eYXTgfMZjF">
                                    <label for="eYXTgfMZjF">AWS</label>
                                    <ul>
                                        <l>
                                            <input type="checkbox" id="zleWfYnUct">
                                            <label for="zleWfYnUct">Cli</label>
                                            <ul>
                                        ...
                                        <l>
                                            <input type="checkbox" id="QrZkmVatnh">
                                            <label for="QrZkmVatnh">Dotnet</label>
                                            <ul>
                                        ...
                                        <l>
                                            <input type="checkbox" id="RfRmxJKlSb">
                                            <label for="RfRmxJKlSb">Ec 2</label>
                                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="dyuYYIlkGI">
                            <label for="dyuYYIlkGI">Events</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="mjokUJvnAK">
                            <label for="mjokUJvnAK">Localstack</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="oJhGFFdtEl">
                            <label for="oJhGFFdtEl">Pulumi</label>
                            <ul>
                                <l>
                                    <input type="checkbox" id="imlCEzFhXx">
                                    <label for="imlCEzFhXx">Dotnet</label>
                                    <ul>
                        ...
                        <l>
                            <input type="checkbox" id="oPtPucdOFx">
                            <label for="oPtPucdOFx">Serverless Framework</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="rNhXWfSdhM">
                            <label for="rNhXWfSdhM">Terraform</label>
                            <ul>
                                <l>
                                    <input type="checkbox" id="JnuVdmqUKJ">
                                    <label for="JnuVdmqUKJ">Functions</label>
                                    <ul>
                                ...
                                <l>
                                    <input type="checkbox" id="nPkAXkQQqx">
                                    <label for="nPkAXkQQqx">Meta Arguments</label>
                                    <ul>
                ...
                <l>
                    <input type="checkbox" id="TjLdkHSqcB">
                    <label for="TjLdkHSqcB">Docker</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="FqIcfObSGm">
                    <label for="FqIcfObSGm">Dotnet</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="lonvKQdFyT">
                            <label for="lonvKQdFyT">Cli</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="geydBrYkvn">
                    <label for="geydBrYkvn">Functional Programming</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="dfxDyxpzZD">
                    <label for="dfxDyxpzZD">Git</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="gIeGiubbUM">
                            <label for="gIeGiubbUM">Github</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="pAVUYrnquU">
                    <label for="pAVUYrnquU">Go</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="HEOHmhLRaY">
                    <label for="HEOHmhLRaY">Haskell</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="mMZOJrQcvC">
                    <label for="mMZOJrQcvC">Js</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="RpGARvFsis">
                            <label for="RpGARvFsis">Node</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="jpeVkeIFWj">
                            <label for="jpeVkeIFWj">D3</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="SssHWJcYbb">
                            <label for="SssHWJcYbb">Mocha</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="nAuSvcSSlT">
                            <label for="nAuSvcSSlT">P5js</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="KtswfZqGGP">
                            <label for="KtswfZqGGP">Typescript</label>
                            <ul>
                                <l>
                                    <input type="checkbox" id="qIGYXOSOIk">
                                    <label for="qIGYXOSOIk">Testing</label>
                                    <ul>
                ...
                <l>
                    <input type="checkbox" id="bkjcXLCVvC">
                    <label for="bkjcXLCVvC">Kafka</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="kJfjiIokhK">
                    <label for="kJfjiIokhK">Kubernetes</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="KYGQvKclcG">
                    <label for="KYGQvKclcG">Language</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="SYgYgieeTu">
                    <label for="SYgYgieeTu">Linux</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="AzkoJBHUfr">
                            <label for="AzkoJBHUfr">Bash</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="lOENcJojkq">
                    <label for="lOENcJojkq">Oauth</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="RuGUZmNXWv">
                    <label for="RuGUZmNXWv">Prometheus</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="yLoSlYRloE">
                    <label for="yLoSlYRloE">Python</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="KAhYUBDqhC">
                            <label for="KAhYUBDqhC">Data Classes</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="ArvDQmnNiT">
                            <label for="ArvDQmnNiT">Libraries</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="eQClpUwNgV">
                    <label for="eQClpUwNgV">React</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="PZRSKyIeDU">
                    <label for="PZRSKyIeDU">Regular Expressions</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="DKQBYcenKK">
                    <label for="DKQBYcenKK">Rust</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="uKnBhgKqNE">
                            <label for="uKnBhgKqNE">Serde</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="IvJebffKok">
                    <label for="IvJebffKok">Shaders</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="CilJwHLyLF">
                            <label for="CilJwHLyLF">Glsl</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="nyLbfWVlKd">
                    <label for="nyLbfWVlKd">Vim</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="aFsZySQZZr">
                    <label for="aFsZySQZZr">Web</label>
                    <ul>
