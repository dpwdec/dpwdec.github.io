...
<ul>
    <div name="contents-index">
        ...
        <l>
            <input type="checkbox" id="saDSTsOOmN" checked>
            <label for="saDSTsOOmN">Math</label>
            <ul>
                <l>
                    <input type="checkbox" id="cJrLHQwqdd">
                    <label for="cJrLHQwqdd">Exponentials</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="ArWRtrRpiR">
                    <label for="ArWRtrRpiR">Linear Algebra</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="FCIGOLTvnS">
                    <label for="FCIGOLTvnS">Logarithms</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="LaIRNvtXQx">
                    <label for="LaIRNvtXQx">Sequences</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="YyDQIRyIuo">
                    <label for="YyDQIRyIuo">Single Variable Calculus</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="aYZwhLpANH">
                    <label for="aYZwhLpANH">Trigonometry</label>
                    <ul>
        ...
        <l>
            <input type="checkbox" id="NvnfmYqxQr" checked>
            <label for="NvnfmYqxQr">Programming</label>
            <ul>
                <l>
                    <input type="checkbox" id="hfsAzPPgke">
                    <label for="hfsAzPPgke">Ansible</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="MoLXMrzOIL">
                    <label for="MoLXMrzOIL">Architecture</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="FyLyIDSRwU">
                    <label for="FyLyIDSRwU">Computer Graphics</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="oVYwNmFfcz">
                    <label for="oVYwNmFfcz">Databases</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="ACZLxdxDaO">
                    <label for="ACZLxdxDaO">Devops</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="XCzBgKCyUx">
                            <label for="XCzBgKCyUx">Cloud Providers</label>
                            <ul>
                                <l>
                                    <input type="checkbox" id="BErlfQQHpR">
                                    <label for="BErlfQQHpR">AWS</label>
                                    <ul>
                                        <l>
                                            <input type="checkbox" id="xdcqJLFbRJ">
                                            <label for="xdcqJLFbRJ">Cli</label>
                                            <ul>
                                        ...
                                        <l>
                                            <input type="checkbox" id="EuuamtGSwz">
                                            <label for="EuuamtGSwz">Dotnet</label>
                                            <ul>
                                        ...
                                        <l>
                                            <input type="checkbox" id="YwAuYxCghT">
                                            <label for="YwAuYxCghT">Ec 2</label>
                                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="SWLVWJQvyj">
                            <label for="SWLVWJQvyj">Events</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="dLwfGCdhtn">
                            <label for="dLwfGCdhtn">Localstack</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="xWcMLanINT">
                            <label for="xWcMLanINT">Pulumi</label>
                            <ul>
                                <l>
                                    <input type="checkbox" id="YzfueJPpaH">
                                    <label for="YzfueJPpaH">Dotnet</label>
                                    <ul>
                        ...
                        <l>
                            <input type="checkbox" id="ZotzeUnphR">
                            <label for="ZotzeUnphR">Serverless Framework</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="nycVLJGNVf">
                            <label for="nycVLJGNVf">Terraform</label>
                            <ul>
                                <l>
                                    <input type="checkbox" id="LJDKuavjWL">
                                    <label for="LJDKuavjWL">Functions</label>
                                    <ul>
                                ...
                                <l>
                                    <input type="checkbox" id="brweLwERWU">
                                    <label for="brweLwERWU">Meta Arguments</label>
                                    <ul>
                ...
                <l>
                    <input type="checkbox" id="sxLBgEMsPq">
                    <label for="sxLBgEMsPq">Docker</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="WoXpNSOkWj">
                    <label for="WoXpNSOkWj">Dotnet</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="wEueInCDEv">
                            <label for="wEueInCDEv">Cli</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="hExkVQpboy">
                    <label for="hExkVQpboy">Functional Programming</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="IDzYARGQJe">
                    <label for="IDzYARGQJe">Git</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="yMaxFneFiH">
                            <label for="yMaxFneFiH">Github</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="bkYxyTvMFE">
                    <label for="bkYxyTvMFE">Go</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="arLinSxhvg">
                    <label for="arLinSxhvg">Haskell</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="KzthbSRgww">
                    <label for="KzthbSRgww">Js</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="tqzBsWmVfA">
                            <label for="tqzBsWmVfA">Node</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="TzaXVugyRg">
                            <label for="TzaXVugyRg">D3</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="JzcnJCrWBg">
                            <label for="JzcnJCrWBg">Mocha</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="EQuOTlqePc">
                            <label for="EQuOTlqePc">P5js</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="JoOSNrDsxi">
                            <label for="JoOSNrDsxi">Typescript</label>
                            <ul>
                                <l>
                                    <input type="checkbox" id="gSQFAunuvc">
                                    <label for="gSQFAunuvc">Testing</label>
                                    <ul>
                ...
                <l>
                    <input type="checkbox" id="zmWCYzwmZf">
                    <label for="zmWCYzwmZf">Kafka</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="SGNqfFYbip">
                    <label for="SGNqfFYbip">Kubernetes</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="UrkXsxSBEJ">
                    <label for="UrkXsxSBEJ">Language</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="oOEPhQMAXW">
                    <label for="oOEPhQMAXW">Linux</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="JhmXVNFwPg">
                            <label for="JhmXVNFwPg">Bash</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="PkbqEtezCf">
                    <label for="PkbqEtezCf">Oauth</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="vVThaStsTc">
                    <label for="vVThaStsTc">Prometheus</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="LkGvvlTtGb">
                    <label for="LkGvvlTtGb">Python</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="hXuiCJdsup">
                            <label for="hXuiCJdsup">Data Classes</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="pCcTxclBXO">
                            <label for="pCcTxclBXO">Libraries</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="oPDQBFYist">
                    <label for="oPDQBFYist">React</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="hEGRBNEjfV">
                    <label for="hEGRBNEjfV">Regular Expressions</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="hSlaHLdkge">
                    <label for="hSlaHLdkge">Rust</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="NdNsroxZMI">
                            <label for="NdNsroxZMI">Serde</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="rHewDDfNTw">
                    <label for="rHewDDfNTw">Shaders</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="TDPTNHhEXF">
                            <label for="TDPTNHhEXF">Glsl</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="GjLEOwVJoD">
                    <label for="GjLEOwVJoD">Vim</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="eHFLaSSGbi">
                    <label for="eHFLaSSGbi">Web</label>
                    <ul>
