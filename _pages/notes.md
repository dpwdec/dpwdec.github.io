...
<ul>
    <div name="contents-index">
        ...
        <l>
            <input type="checkbox" id="prHlutHWzn" checked>
            <label for="prHlutHWzn">Math</label>
            <ul>
                <l>
                    <input type="checkbox" id="fDTTJJDrvY">
                    <label for="fDTTJJDrvY">Exponentials</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="fFfvABRaEe">
                    <label for="fFfvABRaEe">Linear Algebra</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="dqnfQKwSQn">
                    <label for="dqnfQKwSQn">Logarithms</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="zgcArGmYzM">
                    <label for="zgcArGmYzM">Sequences</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="iOuBoXZtjX">
                    <label for="iOuBoXZtjX">Single Variable Calculus</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="mjjuZjXxKG">
                    <label for="mjjuZjXxKG">Trigonometry</label>
                    <ul>
        ...
        <l>
            <input type="checkbox" id="DEvFTWZKWg" checked>
            <label for="DEvFTWZKWg">Programming</label>
            <ul>
                <l>
                    <input type="checkbox" id="BdJbbadcDC">
                    <label for="BdJbbadcDC">Ansible</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="XJMekrwjVf">
                    <label for="XJMekrwjVf">Architecture</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="nlViJmHTmD">
                    <label for="nlViJmHTmD">Computer Graphics</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="JQAtkNZxtt">
                    <label for="JQAtkNZxtt">Databases</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="OAbkpEyWHm">
                    <label for="OAbkpEyWHm">Devops</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="sarwdymxpB">
                            <label for="sarwdymxpB">Cloud Providers</label>
                            <ul>
                                <l>
                                    <input type="checkbox" id="YEezTfDUCw">
                                    <label for="YEezTfDUCw">AWS</label>
                                    <ul>
                                        <l>
                                            <input type="checkbox" id="xknQQRBniL">
                                            <label for="xknQQRBniL">Cli</label>
                                            <ul>
                                        ...
                                        <l>
                                            <input type="checkbox" id="nInCTJvHHz">
                                            <label for="nInCTJvHHz">Dotnet</label>
                                            <ul>
                                        ...
                                        <l>
                                            <input type="checkbox" id="QWEozQWpps">
                                            <label for="QWEozQWpps">Ec 2</label>
                                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="BDGLKOOFcM">
                            <label for="BDGLKOOFcM">Events</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="WJtQiovNox">
                            <label for="WJtQiovNox">Localstack</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="CkCrGdtZke">
                            <label for="CkCrGdtZke">Pulumi</label>
                            <ul>
                                <l>
                                    <input type="checkbox" id="iltPJaNdVm">
                                    <label for="iltPJaNdVm">Dotnet</label>
                                    <ul>
                        ...
                        <l>
                            <input type="checkbox" id="xbArkDMgbE">
                            <label for="xbArkDMgbE">Serverless Framework</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="ruZLHdnbly">
                            <label for="ruZLHdnbly">Terraform</label>
                            <ul>
                                <l>
                                    <input type="checkbox" id="WGVefEojwB">
                                    <label for="WGVefEojwB">Functions</label>
                                    <ul>
                                ...
                                <l>
                                    <input type="checkbox" id="BNBDuoCUqm">
                                    <label for="BNBDuoCUqm">Meta Arguments</label>
                                    <ul>
                ...
                <l>
                    <input type="checkbox" id="CMWpDnOuYU">
                    <label for="CMWpDnOuYU">Docker</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="loyDIOVqNt">
                    <label for="loyDIOVqNt">Dotnet</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="erBSgCgyXC">
                            <label for="erBSgCgyXC">Cli</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="UKDcsafoqM">
                    <label for="UKDcsafoqM">Functional Programming</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="DDcsQQNJtr">
                    <label for="DDcsQQNJtr">Git</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="XVowwhxiJm">
                            <label for="XVowwhxiJm">Github</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="nhMSZbUMED">
                    <label for="nhMSZbUMED">Go</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="SDeCStSavz">
                    <label for="SDeCStSavz">Haskell</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="iTmXohYRKO">
                    <label for="iTmXohYRKO">Js</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="tieNfFssrm">
                            <label for="tieNfFssrm">Node</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="KQKIalmIie">
                            <label for="KQKIalmIie">D3</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="lmZuZwxitw">
                            <label for="lmZuZwxitw">Mocha</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="LbpvuKQMXQ">
                            <label for="LbpvuKQMXQ">P5js</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="hALCyWlvcj">
                            <label for="hALCyWlvcj">Typescript</label>
                            <ul>
                                <l>
                                    <input type="checkbox" id="ZFjLnWVubD">
                                    <label for="ZFjLnWVubD">Testing</label>
                                    <ul>
                ...
                <l>
                    <input type="checkbox" id="UwEfzQSkjC">
                    <label for="UwEfzQSkjC">Kafka</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="ffjOeXwhCA">
                    <label for="ffjOeXwhCA">Kubernetes</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="RKkAxqCcFn">
                    <label for="RKkAxqCcFn">Language</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="crbqFEzvcA">
                    <label for="crbqFEzvcA">Linux</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="avOdcVuZmz">
                            <label for="avOdcVuZmz">Bash</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="TMnUyFwBOw">
                    <label for="TMnUyFwBOw">Oauth</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="nCfDqcyAOt">
                    <label for="nCfDqcyAOt">Prometheus</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="lPBYHzxNyZ">
                    <label for="lPBYHzxNyZ">Python</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="RttxvECcZx">
                            <label for="RttxvECcZx">Data Classes</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="tQnwLBXpLS">
                            <label for="tQnwLBXpLS">Libraries</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="vxmGXjemSU">
                    <label for="vxmGXjemSU">React</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="adVedHrxmH">
                    <label for="adVedHrxmH">Regular Expressions</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="rFAtOsVeJu">
                    <label for="rFAtOsVeJu">Rust</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="SkEBCJGhEG">
                            <label for="SkEBCJGhEG">Serde</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="NjUmYjWQHd">
                    <label for="NjUmYjWQHd">Shaders</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="peTPtKXjMh">
                            <label for="peTPtKXjMh">Glsl</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="eInLsXWMlw">
                    <label for="eInLsXWMlw">Vim</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="rGbyeKrUbv">
                    <label for="rGbyeKrUbv">Web</label>
                    <ul>
