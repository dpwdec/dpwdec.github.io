...
<ul>
    <div name="contents-index">
        ...
        <l>
            <input type="checkbox" id="IOCyIGVTFd" checked>
            <label for="IOCyIGVTFd">Math</label>
            <ul>
                <l>
                    <input type="checkbox" id="fCFwSFrvyK">
                    <label for="fCFwSFrvyK">Exponentials</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="WtOLocqAKd">
                    <label for="WtOLocqAKd">Linear Algebra</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="IVZIAeUTQf">
                    <label for="IVZIAeUTQf">Logarithms</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="YsYsJmBKWv">
                    <label for="YsYsJmBKWv">Sequences</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="dmiFlnCvUM">
                    <label for="dmiFlnCvUM">Single Variable Calculus</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="zBroQGwYED">
                    <label for="zBroQGwYED">Trigonometry</label>
                    <ul>
        ...
        <l>
            <input type="checkbox" id="gktcpSIeev" checked>
            <label for="gktcpSIeev">Programming</label>
            <ul>
                <l>
                    <input type="checkbox" id="lCiaIYOfYH">
                    <label for="lCiaIYOfYH">Ansible</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="BauKyYadkB">
                    <label for="BauKyYadkB">Architecture</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="aegzQBvGmp">
                    <label for="aegzQBvGmp">Computer Graphics</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="IHHXAgSOsL">
                    <label for="IHHXAgSOsL">Databases</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="hDUZaRQWxb">
                    <label for="hDUZaRQWxb">Devops</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="RSIGSoehNf">
                            <label for="RSIGSoehNf">Cloud Providers</label>
                            <ul>
                                <l>
                                    <input type="checkbox" id="djJdquioze">
                                    <label for="djJdquioze">AWS</label>
                                    <ul>
                                        <l>
                                            <input type="checkbox" id="YSaYfkVofv">
                                            <label for="YSaYfkVofv">Cli</label>
                                            <ul>
                                        ...
                                        <l>
                                            <input type="checkbox" id="ncOMoQDtRu">
                                            <label for="ncOMoQDtRu">Dotnet</label>
                                            <ul>
                                        ...
                                        <l>
                                            <input type="checkbox" id="jrfISkcxJO">
                                            <label for="jrfISkcxJO">Ec 2</label>
                                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="bbYowslpoN">
                            <label for="bbYowslpoN">Events</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="jZKvQEJHWO">
                            <label for="jZKvQEJHWO">Localstack</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="ulPgpqQkAk">
                            <label for="ulPgpqQkAk">Pulumi</label>
                            <ul>
                                <l>
                                    <input type="checkbox" id="UBObFrpJsg">
                                    <label for="UBObFrpJsg">Dotnet</label>
                                    <ul>
                        ...
                        <l>
                            <input type="checkbox" id="xiSqdCXKxL">
                            <label for="xiSqdCXKxL">Serverless Framework</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="KavHZAkfvL">
                            <label for="KavHZAkfvL">Terraform</label>
                            <ul>
                                <l>
                                    <input type="checkbox" id="dcWMGStnoV">
                                    <label for="dcWMGStnoV">Functions</label>
                                    <ul>
                                ...
                                <l>
                                    <input type="checkbox" id="sKcChRCSDw">
                                    <label for="sKcChRCSDw">Meta Arguments</label>
                                    <ul>
                ...
                <l>
                    <input type="checkbox" id="QbycnKthxt">
                    <label for="QbycnKthxt">Docker</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="ugSbNdQqTR">
                    <label for="ugSbNdQqTR">Dotnet</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="IACWxiaWAi">
                            <label for="IACWxiaWAi">Cli</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="InfUQTDiKV">
                    <label for="InfUQTDiKV">Functional Programming</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="SLRPueBEkY">
                    <label for="SLRPueBEkY">Git</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="BnMZGTkJPR">
                            <label for="BnMZGTkJPR">Github</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="RWKuQBHtMo">
                    <label for="RWKuQBHtMo">Go</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="xzpSHGmVpo">
                    <label for="xzpSHGmVpo">Haskell</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="jtDBeEIynL">
                    <label for="jtDBeEIynL">Js</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="aiiyMzAKNS">
                            <label for="aiiyMzAKNS">Node</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="YXwAUdKHSC">
                            <label for="YXwAUdKHSC">D3</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="NgJpDeQeje">
                            <label for="NgJpDeQeje">Mocha</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="bahjNdoYUM">
                            <label for="bahjNdoYUM">P5js</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="pNyGysaYlr">
                            <label for="pNyGysaYlr">Typescript</label>
                            <ul>
                                <l>
                                    <input type="checkbox" id="DGUKnYWhJN">
                                    <label for="DGUKnYWhJN">Testing</label>
                                    <ul>
                ...
                <l>
                    <input type="checkbox" id="gEtMBWFGUO">
                    <label for="gEtMBWFGUO">Kafka</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="nuspLQlAth">
                    <label for="nuspLQlAth">Kubernetes</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="HnRnDAHKLN">
                    <label for="HnRnDAHKLN">Language</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="VToAMxYjKc">
                    <label for="VToAMxYjKc">Linux</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="kOUoTuzAcC">
                            <label for="kOUoTuzAcC">Bash</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="AiLfkValtI">
                    <label for="AiLfkValtI">Oauth</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="AABCQaQSSC">
                    <label for="AABCQaQSSC">Python</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="uDFeYnHMZH">
                            <label for="uDFeYnHMZH">Data Classes</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="jhwzlSNOeU">
                            <label for="jhwzlSNOeU">Libraries</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="bTYTeaMKFl">
                    <label for="bTYTeaMKFl">React</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="qydAqhmHbe">
                    <label for="qydAqhmHbe">Regular Expressions</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="EYoBmWDFvT">
                    <label for="EYoBmWDFvT">Rust</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="KnxKhKWlaL">
                            <label for="KnxKhKWlaL">Serde</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="tMckoyKeZI">
                    <label for="tMckoyKeZI">Vim</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="kkZxVhOeiX">
                    <label for="kkZxVhOeiX">Web</label>
                    <ul>
