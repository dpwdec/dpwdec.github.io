...
<ul>
    <div name="contents-index">
        ...
        <l>
            <input type="checkbox" id="ShPKDCJGeG" checked>
            <label for="ShPKDCJGeG">Math</label>
            <ul>
                <l>
                    <input type="checkbox" id="TznxxPBKgM">
                    <label for="TznxxPBKgM">Exponentials</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="iTkdCsptnX">
                    <label for="iTkdCsptnX">Linear Algebra</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="LKBaGaVHDH">
                    <label for="LKBaGaVHDH">Logarithms</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="oLYQAxHCVO">
                    <label for="oLYQAxHCVO">Sequences</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="aqYLjZFTqW">
                    <label for="aqYLjZFTqW">Single Variable Calculus</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="TeFeqOpyVW">
                    <label for="TeFeqOpyVW">Trigonometry</label>
                    <ul>
        ...
        <l>
            <input type="checkbox" id="nRbwkwnNwa" checked>
            <label for="nRbwkwnNwa">Programming</label>
            <ul>
                <l>
                    <input type="checkbox" id="MDWPMawHZy">
                    <label for="MDWPMawHZy">Ansible</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="oKAybtQKyq">
                    <label for="oKAybtQKyq">Architecture</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="NXLWvSisLT">
                    <label for="NXLWvSisLT">Computer Graphics</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="kzblGwOnyB">
                    <label for="kzblGwOnyB">Databases</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="CpRsExEtKZ">
                    <label for="CpRsExEtKZ">Devops</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="uZLvkprSkr">
                            <label for="uZLvkprSkr">Cloud Providers</label>
                            <ul>
                                <l>
                                    <input type="checkbox" id="RMFwWFKFnR">
                                    <label for="RMFwWFKFnR">AWS</label>
                                    <ul>
                                        <l>
                                            <input type="checkbox" id="VhoaDwgyxj">
                                            <label for="VhoaDwgyxj">Cli</label>
                                            <ul>
                                        ...
                                        <l>
                                            <input type="checkbox" id="CAmZrrCcIz">
                                            <label for="CAmZrrCcIz">Dotnet</label>
                                            <ul>
                                        ...
                                        <l>
                                            <input type="checkbox" id="xIlUjDpQwT">
                                            <label for="xIlUjDpQwT">Ec 2</label>
                                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="SoqNaEyljP">
                            <label for="SoqNaEyljP">Events</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="BNmRabekaL">
                            <label for="BNmRabekaL">Localstack</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="GVUkwWBthN">
                            <label for="GVUkwWBthN">Pulumi</label>
                            <ul>
                                <l>
                                    <input type="checkbox" id="IbTTtokEEU">
                                    <label for="IbTTtokEEU">Dotnet</label>
                                    <ul>
                        ...
                        <l>
                            <input type="checkbox" id="tELyRZlRKc">
                            <label for="tELyRZlRKc">Serverless Framework</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="HprdwmmKeS">
                            <label for="HprdwmmKeS">Terraform</label>
                            <ul>
                                <l>
                                    <input type="checkbox" id="SebGzzxsRx">
                                    <label for="SebGzzxsRx">Functions</label>
                                    <ul>
                                ...
                                <l>
                                    <input type="checkbox" id="jOqLgKYEpl">
                                    <label for="jOqLgKYEpl">Meta Arguments</label>
                                    <ul>
                ...
                <l>
                    <input type="checkbox" id="wVOGSXoZNp">
                    <label for="wVOGSXoZNp">Docker</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="TTxCyBPlJN">
                    <label for="TTxCyBPlJN">Dotnet</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="YGbtQRDRqB">
                            <label for="YGbtQRDRqB">Cli</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="lKEqSwDkTZ">
                    <label for="lKEqSwDkTZ">Functional Programming</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="nNUyTbWAPm">
                    <label for="nNUyTbWAPm">Git</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="seVVrAsgIt">
                            <label for="seVVrAsgIt">Github</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="VDauYYruHW">
                    <label for="VDauYYruHW">Go</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="dzsiJNqnvK">
                    <label for="dzsiJNqnvK">Haskell</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="CRCqcUOCDR">
                    <label for="CRCqcUOCDR">Js</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="zQGRXfeCMO">
                            <label for="zQGRXfeCMO">Node</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="EcToMelGDF">
                            <label for="EcToMelGDF">D3</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="qsaOArllcT">
                            <label for="qsaOArllcT">Mocha</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="MWqFBoeHRC">
                            <label for="MWqFBoeHRC">P5js</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="BYNhYPGlaP">
                            <label for="BYNhYPGlaP">Typescript</label>
                            <ul>
                                <l>
                                    <input type="checkbox" id="SuJtkfAKBk">
                                    <label for="SuJtkfAKBk">Testing</label>
                                    <ul>
                ...
                <l>
                    <input type="checkbox" id="EuOGtZOlwA">
                    <label for="EuOGtZOlwA">Kafka</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="NbwXRTlLph">
                    <label for="NbwXRTlLph">Kubernetes</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="EGbXJxzssc">
                    <label for="EGbXJxzssc">Language</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="mSVwrVMecQ">
                    <label for="mSVwrVMecQ">Linux</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="QzNqkrcMef">
                            <label for="QzNqkrcMef">Bash</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="UxxHYDNrrd">
                    <label for="UxxHYDNrrd">Oauth</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="ylEvyFcIkq">
                    <label for="ylEvyFcIkq">Prometheus</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="vegKrVRgwT">
                    <label for="vegKrVRgwT">Python</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="nDlSDVvnpf">
                            <label for="nDlSDVvnpf">Data Classes</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="rLedcAgOSw">
                            <label for="rLedcAgOSw">Libraries</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="LbaNdAMNYZ">
                    <label for="LbaNdAMNYZ">React</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="rZWaOlRhfk">
                    <label for="rZWaOlRhfk">Regular Expressions</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="omGpaPgRYj">
                    <label for="omGpaPgRYj">Rust</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="yButPXNais">
                            <label for="yButPXNais">Serde</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="OclTuYJqdi">
                    <label for="OclTuYJqdi">Shaders</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="JdBkWuOtDk">
                            <label for="JdBkWuOtDk">Glsl</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="jsVCZYbFOo">
                    <label for="jsVCZYbFOo">Vim</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="nSmtvghvdj">
                    <label for="nSmtvghvdj">Web</label>
                    <ul>
