...
<ul>
    <div name="contents-index">
        ...
        <l>
            <input type="checkbox" id="eYKJqWDTjz" checked>
            <label for="eYKJqWDTjz">Math</label>
            <ul>
                <l>
                    <input type="checkbox" id="SjrHgGwgtj">
                    <label for="SjrHgGwgtj">Exponentials</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="zKJsHFQeAr">
                    <label for="zKJsHFQeAr">Linear Algebra</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="zEHxUdyDwZ">
                    <label for="zEHxUdyDwZ">Logarithms</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="BleopXghFE">
                    <label for="BleopXghFE">Sequences</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="IHOaxMczHx">
                    <label for="IHOaxMczHx">Single Variable Calculus</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="UOcbbZacOG">
                    <label for="UOcbbZacOG">Trigonometry</label>
                    <ul>
        ...
        <l>
            <input type="checkbox" id="ZRCXxSnMWn" checked>
            <label for="ZRCXxSnMWn">Programming</label>
            <ul>
                <l>
                    <input type="checkbox" id="dqlQhUBvbL">
                    <label for="dqlQhUBvbL">Ansible</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="qkCxJIGRwy">
                    <label for="qkCxJIGRwy">Architecture</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="aVKYLZKQAR">
                    <label for="aVKYLZKQAR">Computer Graphics</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="izdORyDjxq">
                    <label for="izdORyDjxq">Databases</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="RegZpoZnuW">
                    <label for="RegZpoZnuW">Devops</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="iESPAXqFto">
                            <label for="iESPAXqFto">Cloud Providers</label>
                            <ul>
                                <l>
                                    <input type="checkbox" id="fAAzyJoCnB">
                                    <label for="fAAzyJoCnB">AWS</label>
                                    <ul>
                                        <l>
                                            <input type="checkbox" id="KBXyQUbwjG">
                                            <label for="KBXyQUbwjG">Cli</label>
                                            <ul>
                                        ...
                                        <l>
                                            <input type="checkbox" id="ZrhlxdsFSF">
                                            <label for="ZrhlxdsFSF">Dotnet</label>
                                            <ul>
                                        ...
                                        <l>
                                            <input type="checkbox" id="sHvIJnwduR">
                                            <label for="sHvIJnwduR">Ec 2</label>
                                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="oayIyfLPWr">
                            <label for="oayIyfLPWr">Events</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="cXVcMrlEBP">
                            <label for="cXVcMrlEBP">Localstack</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="OCQDRTjswy">
                            <label for="OCQDRTjswy">Pulumi</label>
                            <ul>
                                <l>
                                    <input type="checkbox" id="tUsqkIfLOs">
                                    <label for="tUsqkIfLOs">Dotnet</label>
                                    <ul>
                        ...
                        <l>
                            <input type="checkbox" id="XlwDDCXodR">
                            <label for="XlwDDCXodR">Serverless Framework</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="KEAtzkMwDj">
                            <label for="KEAtzkMwDj">Terraform</label>
                            <ul>
                                <l>
                                    <input type="checkbox" id="ENlSzQogSJ">
                                    <label for="ENlSzQogSJ">Functions</label>
                                    <ul>
                                ...
                                <l>
                                    <input type="checkbox" id="EyEEjrEhDc">
                                    <label for="EyEEjrEhDc">Meta Arguments</label>
                                    <ul>
                ...
                <l>
                    <input type="checkbox" id="DHboWinTpm">
                    <label for="DHboWinTpm">Docker</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="ywkafKBvZa">
                    <label for="ywkafKBvZa">Dotnet</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="EhYKCwqBjo">
                            <label for="EhYKCwqBjo">Cli</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="sqRYrouaoL">
                    <label for="sqRYrouaoL">Functional Programming</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="MESZySnsYn">
                    <label for="MESZySnsYn">Git</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="LXfioLxqnR">
                            <label for="LXfioLxqnR">Github</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="MBCoLmuuKM">
                    <label for="MBCoLmuuKM">Go</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="PfLnuKWyWz">
                    <label for="PfLnuKWyWz">Haskell</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="MIRLmCquTe">
                    <label for="MIRLmCquTe">Js</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="IgfvPjvUpa">
                            <label for="IgfvPjvUpa">Node</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="kkGdNbHwmq">
                            <label for="kkGdNbHwmq">D3</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="LqvxzkyfqS">
                            <label for="LqvxzkyfqS">Mocha</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="kFbqVSzRDs">
                            <label for="kFbqVSzRDs">P5js</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="omTXGDyOBg">
                            <label for="omTXGDyOBg">Typescript</label>
                            <ul>
                                <l>
                                    <input type="checkbox" id="yIFdMvWboS">
                                    <label for="yIFdMvWboS">Testing</label>
                                    <ul>
                ...
                <l>
                    <input type="checkbox" id="LljETDdrig">
                    <label for="LljETDdrig">Kafka</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="yguXubupKt">
                    <label for="yguXubupKt">Kubernetes</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="yKXEpRnmFc">
                    <label for="yKXEpRnmFc">Language</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="ugFuFIRGgQ">
                    <label for="ugFuFIRGgQ">Linux</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="yMGUSCPiqj">
                            <label for="yMGUSCPiqj">Bash</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="TKgsXiogtf">
                    <label for="TKgsXiogtf">Oauth</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="GraowqjzCX">
                    <label for="GraowqjzCX">Prometheus</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="ZQsZihhRAz">
                    <label for="ZQsZihhRAz">Python</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="geJigGgDSq">
                            <label for="geJigGgDSq">Data Classes</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="fsJJUbflaC">
                            <label for="fsJJUbflaC">Libraries</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="WwaUjiPlpy">
                    <label for="WwaUjiPlpy">React</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="JhmLQnzGpk">
                    <label for="JhmLQnzGpk">Regular Expressions</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="bkGTwsSQbQ">
                    <label for="bkGTwsSQbQ">Rust</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="vJijdQEKKl">
                            <label for="vJijdQEKKl">Serde</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="WTNHygmJyn">
                    <label for="WTNHygmJyn">Shaders</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="BCNQqDvFfe">
                            <label for="BCNQqDvFfe">Glsl</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="pbpCJSBiqi">
                    <label for="pbpCJSBiqi">Vim</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="pzOtaYViKb">
                    <label for="pzOtaYViKb">Web</label>
                    <ul>
