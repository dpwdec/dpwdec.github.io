...
<ul>
    <div name="contents-index">
        ...
        <l>
            <input type="checkbox" id="WSokZPodCy" checked>
            <label for="WSokZPodCy">Math</label>
            <ul>
                <l>
                    <input type="checkbox" id="IcmRSjxhqD">
                    <label for="IcmRSjxhqD">Exponentials</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="NWfeOrRTyK">
                    <label for="NWfeOrRTyK">Linear Algebra</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="IdEFRxAfUp">
                    <label for="IdEFRxAfUp">Logarithms</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="WFesGGGCnj">
                    <label for="WFesGGGCnj">Sequences</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="EIosBoBYsz">
                    <label for="EIosBoBYsz">Single Variable Calculus</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="OuDfyzqzcI">
                    <label for="OuDfyzqzcI">Trigonometry</label>
                    <ul>
        ...
        <l>
            <input type="checkbox" id="YcztdTBcHT" checked>
            <label for="YcztdTBcHT">Programming</label>
            <ul>
                <l>
                    <input type="checkbox" id="micrLWMeGA">
                    <label for="micrLWMeGA">Ansible</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="lDvYhJmjEu">
                    <label for="lDvYhJmjEu">Architecture</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="ioSwcCbVID">
                    <label for="ioSwcCbVID">Computer Graphics</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="GSlSrcXlQU">
                    <label for="GSlSrcXlQU">Databases</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="imVWNkZIxY">
                    <label for="imVWNkZIxY">Devops</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="pbFbIiQIkS">
                            <label for="pbFbIiQIkS">Cloud Providers</label>
                            <ul>
                                <l>
                                    <input type="checkbox" id="NRXFcUmxgT">
                                    <label for="NRXFcUmxgT">AWS</label>
                                    <ul>
                                        <l>
                                            <input type="checkbox" id="FdxPYOcVDO">
                                            <label for="FdxPYOcVDO">Cli</label>
                                            <ul>
                                        ...
                                        <l>
                                            <input type="checkbox" id="uzRmLlIGxw">
                                            <label for="uzRmLlIGxw">Dotnet</label>
                                            <ul>
                                        ...
                                        <l>
                                            <input type="checkbox" id="fKwUJGtahf">
                                            <label for="fKwUJGtahf">Ec 2</label>
                                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="jxhCPTcruz">
                            <label for="jxhCPTcruz">Events</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="XDkjdtmuBN">
                            <label for="XDkjdtmuBN">Localstack</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="fdKxHWosVz">
                            <label for="fdKxHWosVz">Pulumi</label>
                            <ul>
                                <l>
                                    <input type="checkbox" id="tDfHiQSrsv">
                                    <label for="tDfHiQSrsv">Dotnet</label>
                                    <ul>
                        ...
                        <l>
                            <input type="checkbox" id="CNaAFQAXKg">
                            <label for="CNaAFQAXKg">Serverless Framework</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="IMcarjtDuO">
                            <label for="IMcarjtDuO">Terraform</label>
                            <ul>
                                <l>
                                    <input type="checkbox" id="HJvMBAoTKm">
                                    <label for="HJvMBAoTKm">Functions</label>
                                    <ul>
                                ...
                                <l>
                                    <input type="checkbox" id="SNMvolYpvN">
                                    <label for="SNMvolYpvN">Meta Arguments</label>
                                    <ul>
                ...
                <l>
                    <input type="checkbox" id="RUObBPhKQh">
                    <label for="RUObBPhKQh">Docker</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="aFGfKVJArN">
                    <label for="aFGfKVJArN">Dotnet</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="oHQGXQBqKl">
                            <label for="oHQGXQBqKl">Cli</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="KAKqwxysJn">
                    <label for="KAKqwxysJn">Functional Programming</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="bhEDszFbyH">
                    <label for="bhEDszFbyH">Git</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="uEzatXjyUE">
                            <label for="uEzatXjyUE">Github</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="jNsGduOHte">
                    <label for="jNsGduOHte">Go</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="GBwECsCUNh">
                    <label for="GBwECsCUNh">Haskell</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="TccmZyAbgZ">
                    <label for="TccmZyAbgZ">Js</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="ohRVVNCxcV">
                            <label for="ohRVVNCxcV">Node</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="gffFARKPMF">
                            <label for="gffFARKPMF">D3</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="FqPwlgBsWD">
                            <label for="FqPwlgBsWD">Mocha</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="NXbkBCsmyn">
                            <label for="NXbkBCsmyn">P5js</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="ssDSbggpWY">
                            <label for="ssDSbggpWY">Typescript</label>
                            <ul>
                                <l>
                                    <input type="checkbox" id="bsKmMCtjuT">
                                    <label for="bsKmMCtjuT">Testing</label>
                                    <ul>
                ...
                <l>
                    <input type="checkbox" id="FTlLRNzYbF">
                    <label for="FTlLRNzYbF">Kafka</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="dxwwyYLnDI">
                    <label for="dxwwyYLnDI">Kubernetes</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="rTgDneHwdG">
                    <label for="rTgDneHwdG">Language</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="QhOXviDuHZ">
                    <label for="QhOXviDuHZ">Linux</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="mfUsfFjmrq">
                            <label for="mfUsfFjmrq">Bash</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="ZkLwhTxuHh">
                    <label for="ZkLwhTxuHh">Oauth</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="AUVmgguEjE">
                    <label for="AUVmgguEjE">Prometheus</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="cgThxkFwat">
                    <label for="cgThxkFwat">Python</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="yQnOgWLyis">
                            <label for="yQnOgWLyis">Data Classes</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="hfSPrpCQOp">
                            <label for="hfSPrpCQOp">Libraries</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="rOfQdmipPS">
                    <label for="rOfQdmipPS">React</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="SohGVDDYOh">
                    <label for="SohGVDDYOh">Regular Expressions</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="alvFAUNRQS">
                    <label for="alvFAUNRQS">Rust</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="ZSDrBMOOde">
                            <label for="ZSDrBMOOde">Serde</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="qnfoVihVey">
                    <label for="qnfoVihVey">Shaders</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="BMAFgTnFiC">
                            <label for="BMAFgTnFiC">Glsl</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="OVlvKMoBVP">
                    <label for="OVlvKMoBVP">Vim</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="TGTAZdDKuJ">
                    <label for="TGTAZdDKuJ">Web</label>
                    <ul>
