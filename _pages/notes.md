...
<ul>
    <div name="contents-index">
        ...
        <l>
            <input type="checkbox" id="mKTHqylTSE" checked>
            <label for="mKTHqylTSE">Math</label>
            <ul>
                <l>
                    <input type="checkbox" id="tYHdnDXBqs">
                    <label for="tYHdnDXBqs">Exponentials</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="tMywZeRBnE">
                    <label for="tMywZeRBnE">Linear Algebra</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="BIyWYyLmoT">
                    <label for="BIyWYyLmoT">Logarithms</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="PzHINdOITt">
                    <label for="PzHINdOITt">Sequences</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="uFFzraahFx">
                    <label for="uFFzraahFx">Single Variable Calculus</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="ZetHzfhUuZ">
                    <label for="ZetHzfhUuZ">Trigonometry</label>
                    <ul>
        ...
        <l>
            <input type="checkbox" id="xQbIKYsXDA" checked>
            <label for="xQbIKYsXDA">Programming</label>
            <ul>
                <l>
                    <input type="checkbox" id="ReAJhDzUYu">
                    <label for="ReAJhDzUYu">Ansible</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="fFherORGnu">
                    <label for="fFherORGnu">Architecture</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="GyuyqGTGwO">
                    <label for="GyuyqGTGwO">Computer Graphics</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="WzIWZFATex">
                    <label for="WzIWZFATex">Databases</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="GiswdNWwSo">
                    <label for="GiswdNWwSo">Devops</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="CwqAwUzHnL">
                            <label for="CwqAwUzHnL">Cloud Providers</label>
                            <ul>
                                <l>
                                    <input type="checkbox" id="bKycESzaYr">
                                    <label for="bKycESzaYr">AWS</label>
                                    <ul>
                                        <l>
                                            <input type="checkbox" id="UaeFzbtvDY">
                                            <label for="UaeFzbtvDY">Cli</label>
                                            <ul>
                                        ...
                                        <l>
                                            <input type="checkbox" id="YQBBnbTqPn">
                                            <label for="YQBBnbTqPn">Dotnet</label>
                                            <ul>
                                        ...
                                        <l>
                                            <input type="checkbox" id="pmhEvepgju">
                                            <label for="pmhEvepgju">Ec 2</label>
                                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="IqXpIfnnEC">
                            <label for="IqXpIfnnEC">Events</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="UduVJSPGIy">
                            <label for="UduVJSPGIy">Localstack</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="oBXOmTysxF">
                            <label for="oBXOmTysxF">Pulumi</label>
                            <ul>
                                <l>
                                    <input type="checkbox" id="TiyCBnLLqX">
                                    <label for="TiyCBnLLqX">Dotnet</label>
                                    <ul>
                        ...
                        <l>
                            <input type="checkbox" id="YVklJGVoQt">
                            <label for="YVklJGVoQt">Serverless Framework</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="YxCuoaOspZ">
                            <label for="YxCuoaOspZ">Terraform</label>
                            <ul>
                                <l>
                                    <input type="checkbox" id="PjIMOVkiop">
                                    <label for="PjIMOVkiop">Functions</label>
                                    <ul>
                                ...
                                <l>
                                    <input type="checkbox" id="IVwWQEOYNr">
                                    <label for="IVwWQEOYNr">Meta Arguments</label>
                                    <ul>
                ...
                <l>
                    <input type="checkbox" id="vFQIpUMUeN">
                    <label for="vFQIpUMUeN">Docker</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="RTxtBnSeCw">
                    <label for="RTxtBnSeCw">Dotnet</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="MgjEzFWpON">
                            <label for="MgjEzFWpON">Cli</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="aCPfLeXYDf">
                    <label for="aCPfLeXYDf">Functional Programming</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="CdBmPydCXb">
                    <label for="CdBmPydCXb">Git</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="RWKLmDbgPp">
                            <label for="RWKLmDbgPp">Github</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="eREAViXMXH">
                    <label for="eREAViXMXH">Go</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="luiEcIfIFX">
                    <label for="luiEcIfIFX">Haskell</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="tXoiUEqHai">
                    <label for="tXoiUEqHai">Js</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="UwHvHwscid">
                            <label for="UwHvHwscid">Node</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="sPvjXBlpDO">
                            <label for="sPvjXBlpDO">D3</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="WGiJasfYcO">
                            <label for="WGiJasfYcO">Mocha</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="TyPDNdemgu">
                            <label for="TyPDNdemgu">P5js</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="pQenDwztok">
                            <label for="pQenDwztok">Typescript</label>
                            <ul>
                                <l>
                                    <input type="checkbox" id="XtQZhZhgEA">
                                    <label for="XtQZhZhgEA">Testing</label>
                                    <ul>
                ...
                <l>
                    <input type="checkbox" id="BOSsyIfjQT">
                    <label for="BOSsyIfjQT">Kafka</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="DNpvRsMeqn">
                    <label for="DNpvRsMeqn">Kubernetes</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="MEsHnrDGao">
                    <label for="MEsHnrDGao">Language</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="evQmppGDwh">
                    <label for="evQmppGDwh">Linux</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="cuKAewlivb">
                            <label for="cuKAewlivb">Bash</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="lPsmubcydC">
                    <label for="lPsmubcydC">Oauth</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="ilABuCYjpw">
                    <label for="ilABuCYjpw">Python</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="TvMwzpMUGx">
                            <label for="TvMwzpMUGx">Data Classes</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="xVpsqZBGJN">
                            <label for="xVpsqZBGJN">Libraries</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="pFnkoKrjaK">
                    <label for="pFnkoKrjaK">React</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="vyEsGOnFMB">
                    <label for="vyEsGOnFMB">Regular Expressions</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="wPfmieBJzx">
                    <label for="wPfmieBJzx">Rust</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="CFuexharEo">
                            <label for="CFuexharEo">Serde</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="prZHmunoTk">
                    <label for="prZHmunoTk">Vim</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="WhMtYEtlYs">
                    <label for="WhMtYEtlYs">Web</label>
                    <ul>
