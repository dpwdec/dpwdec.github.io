...
<ul>
    <div name="contents-index">
        ...
        <l>
            <input type="checkbox" id="QGvqHMlLzu" checked>
            <label for="QGvqHMlLzu">Math</label>
            <ul>
                <l>
                    <input type="checkbox" id="PYfqYBMSrA">
                    <label for="PYfqYBMSrA">Exponentials</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="ORrGkNQTOm">
                    <label for="ORrGkNQTOm">Linear Algebra</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="mGjGkstZiE">
                    <label for="mGjGkstZiE">Logarithms</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="RREjWyQKEN">
                    <label for="RREjWyQKEN">Sequences</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="iODLEdosFE">
                    <label for="iODLEdosFE">Single Variable Calculus</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="bpNCEZqCGP">
                    <label for="bpNCEZqCGP">Trigonometry</label>
                    <ul>
        ...
        <l>
            <input type="checkbox" id="ghnJIBPZyR" checked>
            <label for="ghnJIBPZyR">Programming</label>
            <ul>
                <l>
                    <input type="checkbox" id="PheuSLgVZL">
                    <label for="PheuSLgVZL">Ansible</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="USObboVMtz">
                    <label for="USObboVMtz">Architecture</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="rocfJQBCkV">
                    <label for="rocfJQBCkV">Computer Graphics</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="ZgEqRsUIAA">
                    <label for="ZgEqRsUIAA">Databases</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="FpDfGcAhtH">
                    <label for="FpDfGcAhtH">Devops</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="GbjUhqWisd">
                            <label for="GbjUhqWisd">Cloud Providers</label>
                            <ul>
                                <l>
                                    <input type="checkbox" id="kStfUrcDsj">
                                    <label for="kStfUrcDsj">AWS</label>
                                    <ul>
                                        <l>
                                            <input type="checkbox" id="ZnFnannvyc">
                                            <label for="ZnFnannvyc">Cli</label>
                                            <ul>
                                        ...
                                        <l>
                                            <input type="checkbox" id="OidzMIHGeF">
                                            <label for="OidzMIHGeF">Dotnet</label>
                                            <ul>
                                        ...
                                        <l>
                                            <input type="checkbox" id="mymbYsuKtA">
                                            <label for="mymbYsuKtA">Ec 2</label>
                                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="jxBvYcdlql">
                            <label for="jxBvYcdlql">Events</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="BcNDKCHVWU">
                            <label for="BcNDKCHVWU">Localstack</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="TWmBHXgGMz">
                            <label for="TWmBHXgGMz">Pulumi</label>
                            <ul>
                                <l>
                                    <input type="checkbox" id="GGlsAANZqK">
                                    <label for="GGlsAANZqK">Dotnet</label>
                                    <ul>
                        ...
                        <l>
                            <input type="checkbox" id="KYstwSSVxW">
                            <label for="KYstwSSVxW">Serverless Framework</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="ENxSatKFWu">
                            <label for="ENxSatKFWu">Terraform</label>
                            <ul>
                                <l>
                                    <input type="checkbox" id="vboBgvppvm">
                                    <label for="vboBgvppvm">Functions</label>
                                    <ul>
                                ...
                                <l>
                                    <input type="checkbox" id="bTYygpYvIs">
                                    <label for="bTYygpYvIs">Meta Arguments</label>
                                    <ul>
                ...
                <l>
                    <input type="checkbox" id="gFOyMnUCAB">
                    <label for="gFOyMnUCAB">Docker</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="TxdOQdJZkA">
                    <label for="TxdOQdJZkA">Dotnet</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="EKXrSuCZWV">
                            <label for="EKXrSuCZWV">Cli</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="QBmGbnJcYP">
                    <label for="QBmGbnJcYP">Functional Programming</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="lhCLxMeolZ">
                    <label for="lhCLxMeolZ">Git</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="OJmPPOExrS">
                            <label for="OJmPPOExrS">Github</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="bjyXumQDxt">
                    <label for="bjyXumQDxt">Go</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="LuqUmnyjCF">
                    <label for="LuqUmnyjCF">Haskell</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="VeGlkMfHHi">
                    <label for="VeGlkMfHHi">Js</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="StkguxDIHH">
                            <label for="StkguxDIHH">Node</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="XCgJtasAVb">
                            <label for="XCgJtasAVb">D3</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="BathQZqXVE">
                            <label for="BathQZqXVE">Mocha</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="HRKoPWtudB">
                            <label for="HRKoPWtudB">P5js</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="ssYyvVDWOB">
                            <label for="ssYyvVDWOB">Typescript</label>
                            <ul>
                                <l>
                                    <input type="checkbox" id="KZAzwHvGch">
                                    <label for="KZAzwHvGch">Testing</label>
                                    <ul>
                ...
                <l>
                    <input type="checkbox" id="PemGXHMCHt">
                    <label for="PemGXHMCHt">Kafka</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="sWCaNrXTAT">
                    <label for="sWCaNrXTAT">Kubernetes</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="NaJkkHafHr">
                    <label for="NaJkkHafHr">Language</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="rMRNTQbddQ">
                    <label for="rMRNTQbddQ">Linux</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="HjNrADwERu">
                            <label for="HjNrADwERu">Bash</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="QbYkfRvWks">
                    <label for="QbYkfRvWks">Oauth</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="mBqlgoNkCy">
                    <label for="mBqlgoNkCy">Python</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="ajljnWiJel">
                            <label for="ajljnWiJel">Data Classes</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="kUTptMvmPg">
                            <label for="kUTptMvmPg">Libraries</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="zfWxrycoQe">
                    <label for="zfWxrycoQe">React</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="EQDYbQITZr">
                    <label for="EQDYbQITZr">Regular Expressions</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="YevOhdUpzR">
                    <label for="YevOhdUpzR">Rust</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="IgZxJgMHoO">
                            <label for="IgZxJgMHoO">Serde</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="aVYgKHZruA">
                    <label for="aVYgKHZruA">Vim</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="QWrzseEEcg">
                    <label for="QWrzseEEcg">Web</label>
                    <ul>
