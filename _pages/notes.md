...
<ul>
    <div name="contents-index">
        ...
        <l>
            <input type="checkbox" id="PsUDQeiaBH" checked>
            <label for="PsUDQeiaBH">Math</label>
            <ul>
                <l>
                    <input type="checkbox" id="TiJyGCippH">
                    <label for="TiJyGCippH">Exponentials</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="IcduAUPtLW">
                    <label for="IcduAUPtLW">Linear Algebra</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="gVJbxmlLWs">
                    <label for="gVJbxmlLWs">Logarithms</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="etpMBrPaIU">
                    <label for="etpMBrPaIU">Sequences</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="KArxlzKjVK">
                    <label for="KArxlzKjVK">Single Variable Calculus</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="QkeGtCfENn">
                    <label for="QkeGtCfENn">Trigonometry</label>
                    <ul>
        ...
        <l>
            <input type="checkbox" id="DMzWLrvvqh" checked>
            <label for="DMzWLrvvqh">Programming</label>
            <ul>
                <l>
                    <input type="checkbox" id="DXtAVpChvN">
                    <label for="DXtAVpChvN">Ansible</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="pIVqxqjbeG">
                    <label for="pIVqxqjbeG">Architecture</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="bbyUtrySBT">
                    <label for="bbyUtrySBT">Computer Graphics</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="VFNimwvocl">
                    <label for="VFNimwvocl">Databases</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="JBdZvLHddV">
                    <label for="JBdZvLHddV">Devops</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="BvakSaSjMu">
                            <label for="BvakSaSjMu">Cloud Providers</label>
                            <ul>
                                <l>
                                    <input type="checkbox" id="vULOZKIXhe">
                                    <label for="vULOZKIXhe">AWS</label>
                                    <ul>
                                        <l>
                                            <input type="checkbox" id="cPTjyQDIEO">
                                            <label for="cPTjyQDIEO">Cli</label>
                                            <ul>
                                        ...
                                        <l>
                                            <input type="checkbox" id="DeHrSLyLOA">
                                            <label for="DeHrSLyLOA">Dotnet</label>
                                            <ul>
                                        ...
                                        <l>
                                            <input type="checkbox" id="uRsteohiRx">
                                            <label for="uRsteohiRx">Ec 2</label>
                                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="IAThptCbIy">
                            <label for="IAThptCbIy">Events</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="iEgdoGjSrP">
                            <label for="iEgdoGjSrP">Localstack</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="flGakSLcmS">
                            <label for="flGakSLcmS">Pulumi</label>
                            <ul>
                                <l>
                                    <input type="checkbox" id="dgsQBYrHdu">
                                    <label for="dgsQBYrHdu">Dotnet</label>
                                    <ul>
                        ...
                        <l>
                            <input type="checkbox" id="rqsWPiAhLJ">
                            <label for="rqsWPiAhLJ">Serverless Framework</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="qBvEbIBmfX">
                            <label for="qBvEbIBmfX">Terraform</label>
                            <ul>
                                <l>
                                    <input type="checkbox" id="SjqMuqfkzf">
                                    <label for="SjqMuqfkzf">Functions</label>
                                    <ul>
                                ...
                                <l>
                                    <input type="checkbox" id="FzPfLNDRai">
                                    <label for="FzPfLNDRai">Meta Arguments</label>
                                    <ul>
                ...
                <l>
                    <input type="checkbox" id="FNcpRfEJGF">
                    <label for="FNcpRfEJGF">Docker</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="ihjnsNCjrT">
                    <label for="ihjnsNCjrT">Dotnet</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="KGyidyyEKK">
                            <label for="KGyidyyEKK">Cli</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="VNksMvudAu">
                    <label for="VNksMvudAu">Functional Programming</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="zSJwLkpoYL">
                    <label for="zSJwLkpoYL">Git</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="uVmmgusDXO">
                            <label for="uVmmgusDXO">Github</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="aaqLovSzSz">
                    <label for="aaqLovSzSz">Go</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="IHXWLAshEh">
                    <label for="IHXWLAshEh">Haskell</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="BPPJisrDUo">
                    <label for="BPPJisrDUo">Js</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="PiDuprujxA">
                            <label for="PiDuprujxA">Node</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="VAeTBdOfuD">
                            <label for="VAeTBdOfuD">D3</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="DPoajmiGey">
                            <label for="DPoajmiGey">Mocha</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="IAKVwvGYOK">
                            <label for="IAKVwvGYOK">P5js</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="rOdurinLel">
                            <label for="rOdurinLel">Typescript</label>
                            <ul>
                                <l>
                                    <input type="checkbox" id="UjnaJGKsaz">
                                    <label for="UjnaJGKsaz">Testing</label>
                                    <ul>
                ...
                <l>
                    <input type="checkbox" id="uTBJZfhbzG">
                    <label for="uTBJZfhbzG">Kafka</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="jJsOiPfwMj">
                    <label for="jJsOiPfwMj">Kubernetes</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="PCuFpHDzmH">
                    <label for="PCuFpHDzmH">Language</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="TGNXeViABz">
                    <label for="TGNXeViABz">Linux</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="lhfSPydYyY">
                            <label for="lhfSPydYyY">Bash</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="rxVXKpJUgK">
                    <label for="rxVXKpJUgK">Oauth</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="UjQvHilKeo">
                    <label for="UjQvHilKeo">Python</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="BnMzAelRci">
                            <label for="BnMzAelRci">Data Classes</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="iXgCXYQHPK">
                            <label for="iXgCXYQHPK">Libraries</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="MyHKYYmGwe">
                    <label for="MyHKYYmGwe">React</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="moSOWxwWYC">
                    <label for="moSOWxwWYC">Regular Expressions</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="bfvmrVMTMs">
                    <label for="bfvmrVMTMs">Rust</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="JZyvdvSpPR">
                            <label for="JZyvdvSpPR">Serde</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="ZzQVUOgmTr">
                    <label for="ZzQVUOgmTr">Vim</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="rDyjAZJrTZ">
                    <label for="rDyjAZJrTZ">Web</label>
                    <ul>
