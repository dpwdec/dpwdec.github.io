...
<ul>
    <div name="contents-index">
        ...
        <l>
            <input type="checkbox" id="gVjmkNWxso" checked>
            <label for="gVjmkNWxso">Math</label>
            <ul>
                <l>
                    <input type="checkbox" id="JEeILbjSUn">
                    <label for="JEeILbjSUn">Exponentials</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="vGUDVxCAXH">
                    <label for="vGUDVxCAXH">Linear Algebra</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="ODhGYkPkZj">
                    <label for="ODhGYkPkZj">Logarithms</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="TryWJMLeKS">
                    <label for="TryWJMLeKS">Sequences</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="ZIhJbjxcqE">
                    <label for="ZIhJbjxcqE">Single Variable Calculus</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="skNtAeIYkY">
                    <label for="skNtAeIYkY">Trigonometry</label>
                    <ul>
        ...
        <l>
            <input type="checkbox" id="oGFgIVzofm" checked>
            <label for="oGFgIVzofm">Programming</label>
            <ul>
                <l>
                    <input type="checkbox" id="KBxohInQrA">
                    <label for="KBxohInQrA">Ansible</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="axJtvdLesl">
                    <label for="axJtvdLesl">Architecture</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="cXLidsKYil">
                    <label for="cXLidsKYil">Computer Graphics</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="WTSUCXCwFU">
                    <label for="WTSUCXCwFU">Databases</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="UbNHwaDBAF">
                    <label for="UbNHwaDBAF">Devops</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="YFZSFDClon">
                            <label for="YFZSFDClon">Cloud Computing</label>
                            <ul>
                                <l>
                                    <input type="checkbox" id="ONjgxkzfGA">
                                    <label for="ONjgxkzfGA">AWS</label>
                                    <ul>
                                        <l>
                                            <input type="checkbox" id="wYRrAyxNuI">
                                            <label for="wYRrAyxNuI">Cli</label>
                                            <ul>
                                        ...
                                        <l>
                                            <input type="checkbox" id="GvDnQQaBnm">
                                            <label for="GvDnQQaBnm">Dotnet</label>
                                            <ul>
                                        ...
                                        <l>
                                            <input type="checkbox" id="pbsoAjqIyr">
                                            <label for="pbsoAjqIyr">Ec 2</label>
                                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="KRdQJXstRZ">
                            <label for="KRdQJXstRZ">Events</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="rYDPxRJccN">
                            <label for="rYDPxRJccN">Localstack</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="CuYqbeWKVy">
                            <label for="CuYqbeWKVy">Oauth</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="nNBThjpSeJ">
                            <label for="nNBThjpSeJ">Pulumi</label>
                            <ul>
                                <l>
                                    <input type="checkbox" id="ixTXLGSijv">
                                    <label for="ixTXLGSijv">Dotnet</label>
                                    <ul>
                        ...
                        <l>
                            <input type="checkbox" id="GZmfQrhwJX">
                            <label for="GZmfQrhwJX">Terraform</label>
                            <ul>
                                <l>
                                    <input type="checkbox" id="ZAlObWGPYj">
                                    <label for="ZAlObWGPYj">Functions</label>
                                    <ul>
                                ...
                                <l>
                                    <input type="checkbox" id="cphqZzraGb">
                                    <label for="cphqZzraGb">Meta Arguments</label>
                                    <ul>
                ...
                <l>
                    <input type="checkbox" id="WpVyeSAXRB">
                    <label for="WpVyeSAXRB">Docker</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="ygpMItYabZ">
                    <label for="ygpMItYabZ">Dotnet</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="GcsROkSEYT">
                            <label for="GcsROkSEYT">Cli</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="UWGNZGekYY">
                    <label for="UWGNZGekYY">Functional Programming</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="fzztHYyhwD">
                    <label for="fzztHYyhwD">Git</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="BThGURjRRG">
                            <label for="BThGURjRRG">Github</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="xthqDeioDj">
                    <label for="xthqDeioDj">Go</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="FIavljKDUw">
                    <label for="FIavljKDUw">Haskell</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="SbqYKzxFbn">
                    <label for="SbqYKzxFbn">Js</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="aqyWYMenmK">
                            <label for="aqyWYMenmK">Node</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="qOdBMRkFod">
                            <label for="qOdBMRkFod">D3</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="hObwgUKxsa">
                            <label for="hObwgUKxsa">Mocha</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="bNqFgSczXH">
                            <label for="bNqFgSczXH">P5js</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="CrdGjfqdzB">
                            <label for="CrdGjfqdzB">Typescript</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="AFWJteNvmf">
                    <label for="AFWJteNvmf">Kafka</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="uakHVQoFDh">
                    <label for="uakHVQoFDh">Kubernetes</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="UnzCwVhkDA">
                    <label for="UnzCwVhkDA">Language</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="nHssDoqdpN">
                    <label for="nHssDoqdpN">Linux</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="gKxZhoOQnT">
                            <label for="gKxZhoOQnT">Bash</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="nctQrQlFEX">
                    <label for="nctQrQlFEX">Python</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="plYjnGgHol">
                            <label for="plYjnGgHol">Data Classes</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="fnaDfKWLZV">
                            <label for="fnaDfKWLZV">Libraries</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="rBqklhjswY">
                    <label for="rBqklhjswY">React</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="MEhhAEdVGu">
                    <label for="MEhhAEdVGu">Regular Expressions</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="vGTiAApHfa">
                    <label for="vGTiAApHfa">Rust</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="noYqsoNiFU">
                            <label for="noYqsoNiFU">Serde</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="qfwEgYToAf">
                    <label for="qfwEgYToAf">Vim</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="ObXZjHbLfu">
                    <label for="ObXZjHbLfu">Web</label>
                    <ul>
