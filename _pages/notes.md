...
<ul>
    <div name="contents-index">
        ...
        <l>
            <input type="checkbox" id="dcIvpzkJSh" checked>
            <label for="dcIvpzkJSh">Math</label>
            <ul>
                <l>
                    <input type="checkbox" id="vqzAQcysaz">
                    <label for="vqzAQcysaz">Exponentials</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="dKQemxqKqn">
                    <label for="dKQemxqKqn">Linear Algebra</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="ugecgmRgiG">
                    <label for="ugecgmRgiG">Logarithms</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="tHNwJqRMFy">
                    <label for="tHNwJqRMFy">Sequences</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="ojThEAwykh">
                    <label for="ojThEAwykh">Single Variable Calculus</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="sUtDEtcMig">
                    <label for="sUtDEtcMig">Trigonometry</label>
                    <ul>
        ...
        <l>
            <input type="checkbox" id="OZBxBdZafA" checked>
            <label for="OZBxBdZafA">Programming</label>
            <ul>
                <l>
                    <input type="checkbox" id="NreNJkgUcs">
                    <label for="NreNJkgUcs">Ansible</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="jHHQybCNFB">
                    <label for="jHHQybCNFB">Architecture</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="eZTuyyHMVe">
                    <label for="eZTuyyHMVe">Computer Graphics</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="FljKBMdcfK">
                    <label for="FljKBMdcfK">Databases</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="RHYiYWYCJn">
                    <label for="RHYiYWYCJn">Devops</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="UHoVbNQKVO">
                            <label for="UHoVbNQKVO">Cloud Providers</label>
                            <ul>
                                <l>
                                    <input type="checkbox" id="qPhZNBdvAA">
                                    <label for="qPhZNBdvAA">AWS</label>
                                    <ul>
                                        <l>
                                            <input type="checkbox" id="MWdXQzekfX">
                                            <label for="MWdXQzekfX">Cli</label>
                                            <ul>
                                        ...
                                        <l>
                                            <input type="checkbox" id="NgMvRJBgvR">
                                            <label for="NgMvRJBgvR">Dotnet</label>
                                            <ul>
                                        ...
                                        <l>
                                            <input type="checkbox" id="GCMaoQSelH">
                                            <label for="GCMaoQSelH">Ec 2</label>
                                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="zyThDBRsMK">
                            <label for="zyThDBRsMK">Events</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="mMJcPPIvpn">
                            <label for="mMJcPPIvpn">Localstack</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="pzqTKoIAaQ">
                            <label for="pzqTKoIAaQ">Pulumi</label>
                            <ul>
                                <l>
                                    <input type="checkbox" id="UKhFClNTSR">
                                    <label for="UKhFClNTSR">Dotnet</label>
                                    <ul>
                        ...
                        <l>
                            <input type="checkbox" id="cFenwJvVwG">
                            <label for="cFenwJvVwG">Serverless Framework</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="EQAzSAKrvB">
                            <label for="EQAzSAKrvB">Terraform</label>
                            <ul>
                                <l>
                                    <input type="checkbox" id="fobnscxXIK">
                                    <label for="fobnscxXIK">Functions</label>
                                    <ul>
                                ...
                                <l>
                                    <input type="checkbox" id="hxBremXHlB">
                                    <label for="hxBremXHlB">Meta Arguments</label>
                                    <ul>
                ...
                <l>
                    <input type="checkbox" id="MExfrMihGH">
                    <label for="MExfrMihGH">Docker</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="hVfgfwNvEh">
                    <label for="hVfgfwNvEh">Dotnet</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="yWUnJZOvqf">
                            <label for="yWUnJZOvqf">Cli</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="CSUbIXGyrI">
                    <label for="CSUbIXGyrI">Functional Programming</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="IkCoKDXjzR">
                    <label for="IkCoKDXjzR">Git</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="RMCahXaUkq">
                            <label for="RMCahXaUkq">Github</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="oPYkklRzTw">
                    <label for="oPYkklRzTw">Go</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="DMKDVvNgow">
                    <label for="DMKDVvNgow">Haskell</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="BBsKtNOGPT">
                    <label for="BBsKtNOGPT">Js</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="YzbOMdldVx">
                            <label for="YzbOMdldVx">Node</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="WbbhKIMrcv">
                            <label for="WbbhKIMrcv">D3</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="mvNIzFWuVW">
                            <label for="mvNIzFWuVW">Mocha</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="xSlXwMHvjn">
                            <label for="xSlXwMHvjn">P5js</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="gqDIggPRym">
                            <label for="gqDIggPRym">Typescript</label>
                            <ul>
                                <l>
                                    <input type="checkbox" id="tZXeBWjSFq">
                                    <label for="tZXeBWjSFq">Testing</label>
                                    <ul>
                ...
                <l>
                    <input type="checkbox" id="TaPZLYjnlJ">
                    <label for="TaPZLYjnlJ">Kafka</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="HmhfGjDLuf">
                    <label for="HmhfGjDLuf">Kubernetes</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="JnjvGjeQgR">
                    <label for="JnjvGjeQgR">Language</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="pFxrjcZNdm">
                    <label for="pFxrjcZNdm">Linux</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="FbiQwPBpYY">
                            <label for="FbiQwPBpYY">Bash</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="NPmUCeTBvn">
                    <label for="NPmUCeTBvn">Oauth</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="auvmtlECmv">
                    <label for="auvmtlECmv">Prometheus</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="UDKKsyaLzt">
                    <label for="UDKKsyaLzt">Python</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="ugsYgVoUKE">
                            <label for="ugsYgVoUKE">Data Classes</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="qtjTlGvgvw">
                            <label for="qtjTlGvgvw">Libraries</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="YOuVORqxeb">
                    <label for="YOuVORqxeb">React</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="JEJjButvah">
                    <label for="JEJjButvah">Regular Expressions</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="flKtCkzHha">
                    <label for="flKtCkzHha">Rust</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="inSzAbVxki">
                            <label for="inSzAbVxki">Serde</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="KZQktlxQJq">
                    <label for="KZQktlxQJq">Shaders</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="UyOkoyeVZs">
                            <label for="UyOkoyeVZs">Glsl</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="fZWGzZBRCJ">
                    <label for="fZWGzZBRCJ">Vim</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="GozLPtoRmc">
                    <label for="GozLPtoRmc">Web</label>
                    <ul>
