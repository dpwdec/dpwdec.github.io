...
<ul>
    <div name="contents-index">
        ...
        <l>
            <input type="checkbox" id="HjBVetFSMN" checked>
            <label for="HjBVetFSMN">Math</label>
            <ul>
                <l>
                    <input type="checkbox" id="NewHxRotwQ">
                    <label for="NewHxRotwQ">Exponentials</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="uGwSCjllXI">
                    <label for="uGwSCjllXI">Linear Algebra</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="ojdrBFjuHf">
                    <label for="ojdrBFjuHf">Logarithms</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="WjYXRzvNQB">
                    <label for="WjYXRzvNQB">Sequences</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="sEcTPIdJRN">
                    <label for="sEcTPIdJRN">Single Variable Calculus</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="xreVDuqvMb">
                    <label for="xreVDuqvMb">Trigonometry</label>
                    <ul>
        ...
        <l>
            <input type="checkbox" id="HysXVcmBlN" checked>
            <label for="HysXVcmBlN">Programming</label>
            <ul>
                <l>
                    <input type="checkbox" id="EGpInvzgLK">
                    <label for="EGpInvzgLK">Ansible</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="TAmfWSPrjF">
                    <label for="TAmfWSPrjF">Architecture</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="ncJDkoDEtv">
                    <label for="ncJDkoDEtv">Computer Graphics</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="zQcklZcyIz">
                    <label for="zQcklZcyIz">Databases</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="iQyFoGwhbk">
                    <label for="iQyFoGwhbk">Devops</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="jLSRtCrlfs">
                            <label for="jLSRtCrlfs">Cloud Computing</label>
                            <ul>
                                <l>
                                    <input type="checkbox" id="YGEwfMyPNm">
                                    <label for="YGEwfMyPNm">AWS</label>
                                    <ul>
                                        <l>
                                            <input type="checkbox" id="fLeJHBiLpA">
                                            <label for="fLeJHBiLpA">Cli</label>
                                            <ul>
                                        ...
                                        <l>
                                            <input type="checkbox" id="BjjAVBxkpw">
                                            <label for="BjjAVBxkpw">Dotnet</label>
                                            <ul>
                                        ...
                                        <l>
                                            <input type="checkbox" id="gIeJfPUQMj">
                                            <label for="gIeJfPUQMj">Ec 2</label>
                                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="xvWhiiWtYU">
                            <label for="xvWhiiWtYU">Events</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="BAXXHxKAUL">
                            <label for="BAXXHxKAUL">Oauth</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="nDnwmEMQoh">
                            <label for="nDnwmEMQoh">Pulumi</label>
                            <ul>
                                <l>
                                    <input type="checkbox" id="FHjMQLxiCk">
                                    <label for="FHjMQLxiCk">Dotnet</label>
                                    <ul>
                        ...
                        <l>
                            <input type="checkbox" id="YYTxeJWSTe">
                            <label for="YYTxeJWSTe">Terraform</label>
                            <ul>
                                <l>
                                    <input type="checkbox" id="AagEUispXl">
                                    <label for="AagEUispXl">Functions</label>
                                    <ul>
                                ...
                                <l>
                                    <input type="checkbox" id="SbVeCGxvOR">
                                    <label for="SbVeCGxvOR">Meta Arguments</label>
                                    <ul>
                ...
                <l>
                    <input type="checkbox" id="tlXTjnSLRb">
                    <label for="tlXTjnSLRb">Docker</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="PZsImOeTpC">
                    <label for="PZsImOeTpC">Dotnet</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="sOyOVDyPNC">
                            <label for="sOyOVDyPNC">Cli</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="BgXiKKtuHS">
                    <label for="BgXiKKtuHS">Functional Programming</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="hLgDltRsOJ">
                    <label for="hLgDltRsOJ">Git</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="NKEiNwNRgN">
                            <label for="NKEiNwNRgN">Github</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="NFsrmlWonN">
                    <label for="NFsrmlWonN">Go</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="PXNJUxKQvk">
                    <label for="PXNJUxKQvk">Haskell</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="yDlEHwUbXv">
                    <label for="yDlEHwUbXv">Js</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="PXKjLJcauW">
                            <label for="PXKjLJcauW">Node</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="MWSDoiCsFw">
                            <label for="MWSDoiCsFw">Mocha</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="dtYVUpDhLI">
                            <label for="dtYVUpDhLI">P5js</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="eZjiSQrruO">
                            <label for="eZjiSQrruO">Typescript</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="etvuRasVFw">
                    <label for="etvuRasVFw">Kafka</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="EhWKQwJzGK">
                    <label for="EhWKQwJzGK">Kubernetes</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="hBQLshBkHf">
                    <label for="hBQLshBkHf">Language</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="kkptHMFONm">
                    <label for="kkptHMFONm">Linux</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="oNHWSWgwQw">
                    <label for="oNHWSWgwQw">Python</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="dEXsgQcWhV">
                            <label for="dEXsgQcWhV">Data Classes</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="CaFHzWUlwC">
                            <label for="CaFHzWUlwC">Libraries</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="VAJcmHSLTZ">
                    <label for="VAJcmHSLTZ">React</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="JuSEVWtScy">
                    <label for="JuSEVWtScy">Regular Expressions</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="JuNtnCapns">
                    <label for="JuNtnCapns">Rust</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="bIbXLHPFQi">
                            <label for="bIbXLHPFQi">Serde</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="IQZAKVXUXa">
                    <label for="IQZAKVXUXa">Vim</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="NyxJLXqVZo">
                    <label for="NyxJLXqVZo">Web</label>
                    <ul>
