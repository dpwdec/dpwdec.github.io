...
<ul>
    <div name="contents-index">
        ...
        <l>
            <input type="checkbox" id="MrHkTzWTCb" checked>
            <label for="MrHkTzWTCb">Math</label>
            <ul>
                <l>
                    <input type="checkbox" id="CNOgXzDTmy">
                    <label for="CNOgXzDTmy">Exponentials</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="zBNIXXmZVD">
                    <label for="zBNIXXmZVD">Linear Algebra</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="qtditmAaLh">
                    <label for="qtditmAaLh">Logarithms</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="qAEbLHPyJw">
                    <label for="qAEbLHPyJw">Sequences</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="ZmiDvVMnwU">
                    <label for="ZmiDvVMnwU">Single Variable Calculus</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="fmbuQcevzm">
                    <label for="fmbuQcevzm">Trigonometry</label>
                    <ul>
        ...
        <l>
            <input type="checkbox" id="fqhnbZXKno" checked>
            <label for="fqhnbZXKno">Programming</label>
            <ul>
                <l>
                    <input type="checkbox" id="qGIdExViMz">
                    <label for="qGIdExViMz">Ansible</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="ARjDyRjmBo">
                    <label for="ARjDyRjmBo">Architecture</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="xklWAfXGlM">
                    <label for="xklWAfXGlM">Computer Graphics</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="NFJUTdrwsl">
                    <label for="NFJUTdrwsl">Databases</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="UQrPJPjJDA">
                    <label for="UQrPJPjJDA">Devops</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="dCZClJtxbb">
                            <label for="dCZClJtxbb">Cloud Providers</label>
                            <ul>
                                <l>
                                    <input type="checkbox" id="yualbrHdMZ">
                                    <label for="yualbrHdMZ">AWS</label>
                                    <ul>
                                        <l>
                                            <input type="checkbox" id="wvOgWMVoyL">
                                            <label for="wvOgWMVoyL">Cli</label>
                                            <ul>
                                        ...
                                        <l>
                                            <input type="checkbox" id="KWCadZjazV">
                                            <label for="KWCadZjazV">Dotnet</label>
                                            <ul>
                                        ...
                                        <l>
                                            <input type="checkbox" id="KbagJpgyUh">
                                            <label for="KbagJpgyUh">Ec 2</label>
                                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="gQYCdwrrsy">
                            <label for="gQYCdwrrsy">Events</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="FnUUwwOTiZ">
                            <label for="FnUUwwOTiZ">Localstack</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="BMaROhmwyr">
                            <label for="BMaROhmwyr">Pulumi</label>
                            <ul>
                                <l>
                                    <input type="checkbox" id="fWZgtNcZFS">
                                    <label for="fWZgtNcZFS">Dotnet</label>
                                    <ul>
                        ...
                        <l>
                            <input type="checkbox" id="UnInkaxKkq">
                            <label for="UnInkaxKkq">Serverless Framework</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="UxuxzsJHev">
                            <label for="UxuxzsJHev">Terraform</label>
                            <ul>
                                <l>
                                    <input type="checkbox" id="MHHrYgRUAt">
                                    <label for="MHHrYgRUAt">Functions</label>
                                    <ul>
                                ...
                                <l>
                                    <input type="checkbox" id="HESizGzPFK">
                                    <label for="HESizGzPFK">Meta Arguments</label>
                                    <ul>
                ...
                <l>
                    <input type="checkbox" id="pKQxgvvkNQ">
                    <label for="pKQxgvvkNQ">Docker</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="VmakkfDdnv">
                    <label for="VmakkfDdnv">Dotnet</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="nLEyRwteAq">
                            <label for="nLEyRwteAq">Cli</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="GLSnfXCfWM">
                    <label for="GLSnfXCfWM">Functional Programming</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="CELptqOxUj">
                    <label for="CELptqOxUj">Git</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="hOMLYtmcUz">
                            <label for="hOMLYtmcUz">Github</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="mTXnMJuCfV">
                    <label for="mTXnMJuCfV">Go</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="CKoGAckpEX">
                    <label for="CKoGAckpEX">Haskell</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="SpTAJMNrSx">
                    <label for="SpTAJMNrSx">Js</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="rRhbypheKh">
                            <label for="rRhbypheKh">Node</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="kWKCmhqQfe">
                            <label for="kWKCmhqQfe">D3</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="NWsnPvfuUG">
                            <label for="NWsnPvfuUG">Mocha</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="orrslAuGFx">
                            <label for="orrslAuGFx">P5js</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="eJYjsjGPXZ">
                            <label for="eJYjsjGPXZ">Typescript</label>
                            <ul>
                                <l>
                                    <input type="checkbox" id="LSojphUHPZ">
                                    <label for="LSojphUHPZ">Testing</label>
                                    <ul>
                ...
                <l>
                    <input type="checkbox" id="FhgttKkyQV">
                    <label for="FhgttKkyQV">Kafka</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="LqCXWyNZxu">
                    <label for="LqCXWyNZxu">Kubernetes</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="JwkeeBzdGS">
                    <label for="JwkeeBzdGS">Language</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="rwXTtdIHOX">
                    <label for="rwXTtdIHOX">Linux</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="tCJcuVtdmS">
                            <label for="tCJcuVtdmS">Bash</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="hKcHCJUbur">
                    <label for="hKcHCJUbur">Oauth</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="pBOVHBLUWT">
                    <label for="pBOVHBLUWT">Prometheus</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="HNqgTShrXx">
                    <label for="HNqgTShrXx">Python</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="wCMmUYMDma">
                            <label for="wCMmUYMDma">Data Classes</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="hpNpILZvkv">
                            <label for="hpNpILZvkv">Libraries</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="wNlaLtMBJs">
                    <label for="wNlaLtMBJs">React</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="NmDsDZGPxS">
                    <label for="NmDsDZGPxS">Regular Expressions</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="fWYCfOhrLn">
                    <label for="fWYCfOhrLn">Rust</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="scBAFKKKrE">
                            <label for="scBAFKKKrE">Serde</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="mjUzkurMjM">
                    <label for="mjUzkurMjM">Shaders</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="zWwTmmJBef">
                            <label for="zWwTmmJBef">Glsl</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="XLpjdSAXFm">
                    <label for="XLpjdSAXFm">Vim</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="mwqRseldKs">
                    <label for="mwqRseldKs">Web</label>
                    <ul>
