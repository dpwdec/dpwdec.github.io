...
<ul>
    <div name="contents-index">
        ...
        <l>
            <input type="checkbox" id="fvGZhpMhof" checked>
            <label for="fvGZhpMhof">Math</label>
            <ul>
                <l>
                    <input type="checkbox" id="kmJwQZyPhR">
                    <label for="kmJwQZyPhR">Exponentials</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="WywBkEOrJA">
                    <label for="WywBkEOrJA">Linear Algebra</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="lSglDSTvAW">
                    <label for="lSglDSTvAW">Logarithms</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="BVrTdiXiuQ">
                    <label for="BVrTdiXiuQ">Sequences</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="gSWeGbnjTL">
                    <label for="gSWeGbnjTL">Single Variable Calculus</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="SfYGzgFQAg">
                    <label for="SfYGzgFQAg">Trigonometry</label>
                    <ul>
        ...
        <l>
            <input type="checkbox" id="WsdYSbxJpb" checked>
            <label for="WsdYSbxJpb">Programming</label>
            <ul>
                <l>
                    <input type="checkbox" id="JwWKcfJMos">
                    <label for="JwWKcfJMos">Ansible</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="fVlOStScyo">
                    <label for="fVlOStScyo">Architecture</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="BbZnCKNLNf">
                    <label for="BbZnCKNLNf">Computer Graphics</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="xLgLzyPxAF">
                    <label for="xLgLzyPxAF">Databases</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="hcGfmfVdtH">
                    <label for="hcGfmfVdtH">Devops</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="wuSpqEvYuL">
                            <label for="wuSpqEvYuL">Cloud Providers</label>
                            <ul>
                                <l>
                                    <input type="checkbox" id="VXBRZgJjgr">
                                    <label for="VXBRZgJjgr">AWS</label>
                                    <ul>
                                        <l>
                                            <input type="checkbox" id="vlEKycKhhZ">
                                            <label for="vlEKycKhhZ">Cli</label>
                                            <ul>
                                        ...
                                        <l>
                                            <input type="checkbox" id="pCIxptzpDn">
                                            <label for="pCIxptzpDn">Dotnet</label>
                                            <ul>
                                        ...
                                        <l>
                                            <input type="checkbox" id="XyBRZzsomN">
                                            <label for="XyBRZzsomN">Ec 2</label>
                                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="zfHSOqEqIs">
                            <label for="zfHSOqEqIs">Events</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="DCNSQQUFov">
                            <label for="DCNSQQUFov">Localstack</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="cLGoOvpqXO">
                            <label for="cLGoOvpqXO">Pulumi</label>
                            <ul>
                                <l>
                                    <input type="checkbox" id="GWEFcgNiIv">
                                    <label for="GWEFcgNiIv">Dotnet</label>
                                    <ul>
                        ...
                        <l>
                            <input type="checkbox" id="YjTSVJaziW">
                            <label for="YjTSVJaziW">Serverless Framework</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="AXKROFvgiW">
                            <label for="AXKROFvgiW">Terraform</label>
                            <ul>
                                <l>
                                    <input type="checkbox" id="xDbZnfJdOs">
                                    <label for="xDbZnfJdOs">Functions</label>
                                    <ul>
                                ...
                                <l>
                                    <input type="checkbox" id="GTsouldBhh">
                                    <label for="GTsouldBhh">Meta Arguments</label>
                                    <ul>
                ...
                <l>
                    <input type="checkbox" id="OFQVqTbKyW">
                    <label for="OFQVqTbKyW">Docker</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="ZqHadSeAin">
                    <label for="ZqHadSeAin">Dotnet</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="nDzpGHuVxM">
                            <label for="nDzpGHuVxM">Cli</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="cVREoAEdgM">
                    <label for="cVREoAEdgM">Functional Programming</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="SUbvUkvExZ">
                    <label for="SUbvUkvExZ">Git</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="BYKagTCRDU">
                            <label for="BYKagTCRDU">Github</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="gYTcZxAemF">
                    <label for="gYTcZxAemF">Go</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="ZDYYtLRKii">
                    <label for="ZDYYtLRKii">Haskell</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="ziTysPWNrm">
                    <label for="ziTysPWNrm">Js</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="nBPIECzkie">
                            <label for="nBPIECzkie">Node</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="lhEWguDgoc">
                            <label for="lhEWguDgoc">D3</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="hQxlYfEshe">
                            <label for="hQxlYfEshe">Mocha</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="BogSWCDkkW">
                            <label for="BogSWCDkkW">P5js</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="LmxmWZWFkT">
                            <label for="LmxmWZWFkT">Typescript</label>
                            <ul>
                                <l>
                                    <input type="checkbox" id="rgKcJvSLUm">
                                    <label for="rgKcJvSLUm">Testing</label>
                                    <ul>
                ...
                <l>
                    <input type="checkbox" id="DtGGqdxLwt">
                    <label for="DtGGqdxLwt">Kafka</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="TTLNrdzLdv">
                    <label for="TTLNrdzLdv">Kubernetes</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="BBLRtfKcrL">
                    <label for="BBLRtfKcrL">Language</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="wDQMzcTIZO">
                    <label for="wDQMzcTIZO">Linux</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="PcNYtWrYYt">
                            <label for="PcNYtWrYYt">Bash</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="WJNSnKswCB">
                    <label for="WJNSnKswCB">Oauth</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="aSlAtEMOJd">
                    <label for="aSlAtEMOJd">Prometheus</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="lNVAmWRoRp">
                    <label for="lNVAmWRoRp">Python</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="edoTuchYES">
                            <label for="edoTuchYES">Data Classes</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="uMbEWEeHSU">
                            <label for="uMbEWEeHSU">Libraries</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="AdpWUABfLD">
                    <label for="AdpWUABfLD">React</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="QWTKzudITd">
                    <label for="QWTKzudITd">Regular Expressions</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="iBKsIGNAdE">
                    <label for="iBKsIGNAdE">Rust</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="mnaDsRHVbh">
                            <label for="mnaDsRHVbh">Serde</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="jQIUajcAJF">
                    <label for="jQIUajcAJF">Shaders</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="PundHzCeMX">
                            <label for="PundHzCeMX">Glsl</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="CjTieZlYpO">
                    <label for="CjTieZlYpO">Vim</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="xaGtbqZduH">
                    <label for="xaGtbqZduH">Web</label>
                    <ul>
