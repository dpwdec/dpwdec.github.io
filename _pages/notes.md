...
<ul>
    <div name="contents-index">
        ...
        <l>
            <input type="checkbox" id="MwRHtpLZSa" checked>
            <label for="MwRHtpLZSa">Math</label>
            <ul>
                <l>
                    <input type="checkbox" id="VtcADLGZUe">
                    <label for="VtcADLGZUe">Exponentials</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="KzKMGWfhnA">
                    <label for="KzKMGWfhnA">Linear Algebra</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="qIKpIdlKxK">
                    <label for="qIKpIdlKxK">Logarithms</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="FpIzgrLHTj">
                    <label for="FpIzgrLHTj">Sequences</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="FDhFPYuoQO">
                    <label for="FDhFPYuoQO">Single Variable Calculus</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="FAEhRwumSJ">
                    <label for="FAEhRwumSJ">Trigonometry</label>
                    <ul>
        ...
        <l>
            <input type="checkbox" id="VeOrupWRti" checked>
            <label for="VeOrupWRti">Programming</label>
            <ul>
                <l>
                    <input type="checkbox" id="OItDJDkBXW">
                    <label for="OItDJDkBXW">Ansible</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="ntuSgVaNmd">
                    <label for="ntuSgVaNmd">Architecture</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="PfELfyOULU">
                    <label for="PfELfyOULU">Computer Graphics</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="YvmjzbnGWV">
                    <label for="YvmjzbnGWV">Databases</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="znYZGZUVxi">
                    <label for="znYZGZUVxi">Devops</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="jeqfMxhtdT">
                            <label for="jeqfMxhtdT">Cloud Providers</label>
                            <ul>
                                <l>
                                    <input type="checkbox" id="nwUAKvDrPe">
                                    <label for="nwUAKvDrPe">AWS</label>
                                    <ul>
                                        <l>
                                            <input type="checkbox" id="BHZHlvjQRT">
                                            <label for="BHZHlvjQRT">Cli</label>
                                            <ul>
                                        ...
                                        <l>
                                            <input type="checkbox" id="NsYmIsIANt">
                                            <label for="NsYmIsIANt">Dotnet</label>
                                            <ul>
                                        ...
                                        <l>
                                            <input type="checkbox" id="sBOVZWERHx">
                                            <label for="sBOVZWERHx">Ec 2</label>
                                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="JkYyycYCsp">
                            <label for="JkYyycYCsp">Events</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="CSIshBtOOK">
                            <label for="CSIshBtOOK">Localstack</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="McxAoRxAwa">
                            <label for="McxAoRxAwa">Pulumi</label>
                            <ul>
                                <l>
                                    <input type="checkbox" id="zNZcCpnjqG">
                                    <label for="zNZcCpnjqG">Dotnet</label>
                                    <ul>
                        ...
                        <l>
                            <input type="checkbox" id="YLFaBxyVoz">
                            <label for="YLFaBxyVoz">Serverless Framework</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="OgnnTQfkOF">
                            <label for="OgnnTQfkOF">Terraform</label>
                            <ul>
                                <l>
                                    <input type="checkbox" id="tXftmPylga">
                                    <label for="tXftmPylga">Functions</label>
                                    <ul>
                                ...
                                <l>
                                    <input type="checkbox" id="vsIBOePLkH">
                                    <label for="vsIBOePLkH">Meta Arguments</label>
                                    <ul>
                ...
                <l>
                    <input type="checkbox" id="mKQoEAHWAL">
                    <label for="mKQoEAHWAL">Docker</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="RInLyKTXVL">
                    <label for="RInLyKTXVL">Dotnet</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="daEgPGExTf">
                            <label for="daEgPGExTf">Cli</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="yErzyYVGWb">
                    <label for="yErzyYVGWb">Functional Programming</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="EeYsnCnHbd">
                    <label for="EeYsnCnHbd">Git</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="yhrIfuSiNU">
                            <label for="yhrIfuSiNU">Github</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="zhkGawhMVT">
                    <label for="zhkGawhMVT">Go</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="uxKQTpWvZP">
                    <label for="uxKQTpWvZP">Haskell</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="HsFnhSsnOM">
                    <label for="HsFnhSsnOM">Js</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="okPEZRgBSa">
                            <label for="okPEZRgBSa">Node</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="MFXzfeBbsF">
                            <label for="MFXzfeBbsF">D3</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="oOPHizbTTm">
                            <label for="oOPHizbTTm">Mocha</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="UJXENDzKIj">
                            <label for="UJXENDzKIj">P5js</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="BRWwTrxhds">
                            <label for="BRWwTrxhds">Typescript</label>
                            <ul>
                                <l>
                                    <input type="checkbox" id="rmedDXloza">
                                    <label for="rmedDXloza">Testing</label>
                                    <ul>
                ...
                <l>
                    <input type="checkbox" id="bZOjHZLfry">
                    <label for="bZOjHZLfry">Kafka</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="fJsAyktEhu">
                    <label for="fJsAyktEhu">Kubernetes</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="TccnhGYeTh">
                    <label for="TccnhGYeTh">Language</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="ordcHpzQvs">
                    <label for="ordcHpzQvs">Linux</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="YabSiKXUUX">
                            <label for="YabSiKXUUX">Bash</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="qLjJXnCsmX">
                    <label for="qLjJXnCsmX">Oauth</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="FxVDwnEhnf">
                    <label for="FxVDwnEhnf">Prometheus</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="QbLJsEWSfc">
                    <label for="QbLJsEWSfc">Python</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="QxZaLAdAPf">
                            <label for="QxZaLAdAPf">Data Classes</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="GizKVpJUGX">
                            <label for="GizKVpJUGX">Libraries</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="hrQWOCwCpD">
                    <label for="hrQWOCwCpD">React</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="uMhKIeLqdp">
                    <label for="uMhKIeLqdp">Regular Expressions</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="NEODyHmvgs">
                    <label for="NEODyHmvgs">Rust</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="nZjsecztKA">
                            <label for="nZjsecztKA">Serde</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="gmrVPNwNMB">
                    <label for="gmrVPNwNMB">Shaders</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="BjCpjlYTTn">
                            <label for="BjCpjlYTTn">Glsl</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="JssimdgFZN">
                    <label for="JssimdgFZN">Vim</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="AHpToePWIg">
                    <label for="AHpToePWIg">Web</label>
                    <ul>
