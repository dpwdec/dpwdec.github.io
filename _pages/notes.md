...
<ul>
    <div name="contents-index">
        ...
        <l>
            <input type="checkbox" id="CjxmmdhzqM" checked>
            <label for="CjxmmdhzqM">Math</label>
            <ul>
                <l>
                    <input type="checkbox" id="UZQNewTopT">
                    <label for="UZQNewTopT">Exponentials</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="VchONDWGDg">
                    <label for="VchONDWGDg">Linear Algebra</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="ijdqCsOaZI">
                    <label for="ijdqCsOaZI">Logarithms</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="LboRUTNZaq">
                    <label for="LboRUTNZaq">Sequences</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="PYLNQevWTq">
                    <label for="PYLNQevWTq">Single Variable Calculus</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="NzUwrUKwsC">
                    <label for="NzUwrUKwsC">Trigonometry</label>
                    <ul>
        ...
        <l>
            <input type="checkbox" id="HUsYCPBUTe" checked>
            <label for="HUsYCPBUTe">Programming</label>
            <ul>
                <l>
                    <input type="checkbox" id="ZrmNlHHGvO">
                    <label for="ZrmNlHHGvO">Ansible</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="vOAVVYsTsQ">
                    <label for="vOAVVYsTsQ">Architecture</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="LMLNFPtMyX">
                    <label for="LMLNFPtMyX">Computer Graphics</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="UbJvrBnaAy">
                    <label for="UbJvrBnaAy">Databases</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="qcyCKkTDWW">
                    <label for="qcyCKkTDWW">Devops</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="seuJanByLo">
                            <label for="seuJanByLo">Cloud Providers</label>
                            <ul>
                                <l>
                                    <input type="checkbox" id="TekQYLBRHU">
                                    <label for="TekQYLBRHU">AWS</label>
                                    <ul>
                                        <l>
                                            <input type="checkbox" id="HMZWNhMaXf">
                                            <label for="HMZWNhMaXf">Cli</label>
                                            <ul>
                                        ...
                                        <l>
                                            <input type="checkbox" id="bIKZhtqqZG">
                                            <label for="bIKZhtqqZG">Dotnet</label>
                                            <ul>
                                        ...
                                        <l>
                                            <input type="checkbox" id="DHhPMyAomI">
                                            <label for="DHhPMyAomI">Ec 2</label>
                                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="CxiPsEitEP">
                            <label for="CxiPsEitEP">Events</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="ikQYNXMtAO">
                            <label for="ikQYNXMtAO">Localstack</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="eXHgcpBMIj">
                            <label for="eXHgcpBMIj">Pulumi</label>
                            <ul>
                                <l>
                                    <input type="checkbox" id="JLjRBfGNBd">
                                    <label for="JLjRBfGNBd">Dotnet</label>
                                    <ul>
                        ...
                        <l>
                            <input type="checkbox" id="erDyNgKSGp">
                            <label for="erDyNgKSGp">Serverless Framework</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="nnVjryTUlm">
                            <label for="nnVjryTUlm">Terraform</label>
                            <ul>
                                <l>
                                    <input type="checkbox" id="BxcsorDMHY">
                                    <label for="BxcsorDMHY">Functions</label>
                                    <ul>
                                ...
                                <l>
                                    <input type="checkbox" id="sntMiLRfSs">
                                    <label for="sntMiLRfSs">Meta Arguments</label>
                                    <ul>
                ...
                <l>
                    <input type="checkbox" id="ccIavbfSrU">
                    <label for="ccIavbfSrU">Docker</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="rTWTrHxOKm">
                    <label for="rTWTrHxOKm">Dotnet</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="hAiXBhrAgb">
                            <label for="hAiXBhrAgb">Cli</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="IuwrlFUbWu">
                    <label for="IuwrlFUbWu">Functional Programming</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="bXQpdMNfLl">
                    <label for="bXQpdMNfLl">Git</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="tENWwkIhxj">
                            <label for="tENWwkIhxj">Github</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="bbEETWoQxc">
                    <label for="bbEETWoQxc">Go</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="NeHYTWRXWD">
                    <label for="NeHYTWRXWD">Haskell</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="DXJaYTcXDk">
                    <label for="DXJaYTcXDk">Js</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="WsibjPGVBb">
                            <label for="WsibjPGVBb">Node</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="aohwcAqrud">
                            <label for="aohwcAqrud">D3</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="sSETlaKsKA">
                            <label for="sSETlaKsKA">Mocha</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="gXpqqxEJfk">
                            <label for="gXpqqxEJfk">P5js</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="mqCyIxybMV">
                            <label for="mqCyIxybMV">Typescript</label>
                            <ul>
                                <l>
                                    <input type="checkbox" id="bQLxOPRzdy">
                                    <label for="bQLxOPRzdy">Testing</label>
                                    <ul>
                ...
                <l>
                    <input type="checkbox" id="CoKgfYZkWM">
                    <label for="CoKgfYZkWM">Kafka</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="xlOxJXWIAF">
                    <label for="xlOxJXWIAF">Kubernetes</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="LTodWbRHPC">
                    <label for="LTodWbRHPC">Language</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="BZtFqCvJjk">
                    <label for="BZtFqCvJjk">Linux</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="LENqPpspsA">
                            <label for="LENqPpspsA">Bash</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="WuNvrJLiaD">
                    <label for="WuNvrJLiaD">Oauth</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="fQAejeIwrU">
                    <label for="fQAejeIwrU">Python</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="pXVFzUTHnd">
                            <label for="pXVFzUTHnd">Data Classes</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="BjyRXxMRsK">
                            <label for="BjyRXxMRsK">Libraries</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="FEvyKVOHZe">
                    <label for="FEvyKVOHZe">React</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="PikoIoIoBo">
                    <label for="PikoIoIoBo">Regular Expressions</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="kcTukvRCpq">
                    <label for="kcTukvRCpq">Rust</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="yyIcqzivVl">
                            <label for="yyIcqzivVl">Serde</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="NnaxAQvoEh">
                    <label for="NnaxAQvoEh">Vim</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="kMPGBtoMmg">
                    <label for="kMPGBtoMmg">Web</label>
                    <ul>
