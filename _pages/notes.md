...
<ul>
    <div name="contents-index">
        ...
        <l>
            <input type="checkbox" id="nAOAySIaEV" checked>
            <label for="nAOAySIaEV">Math</label>
            <ul>
                <l>
                    <input type="checkbox" id="gQfeXhHhnN">
                    <label for="gQfeXhHhnN">Exponentials</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="pFJPPRTmDL">
                    <label for="pFJPPRTmDL">Linear Algebra</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="hslFtGDYJt">
                    <label for="hslFtGDYJt">Logarithms</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="RRHhghpvbu">
                    <label for="RRHhghpvbu">Sequences</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="RkkgwSTUSu">
                    <label for="RkkgwSTUSu">Single Variable Calculus</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="tnagiWMBdv">
                    <label for="tnagiWMBdv">Trigonometry</label>
                    <ul>
        ...
        <l>
            <input type="checkbox" id="lVFoyLWAUL" checked>
            <label for="lVFoyLWAUL">Programming</label>
            <ul>
                <l>
                    <input type="checkbox" id="hhcAotKttz">
                    <label for="hhcAotKttz">Ansible</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="nwNyIxVlNL">
                    <label for="nwNyIxVlNL">Architecture</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="ZMiGCsqflM">
                    <label for="ZMiGCsqflM">Computer Graphics</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="fYLpPKAoue">
                    <label for="fYLpPKAoue">Databases</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="fdNacCkbnc">
                    <label for="fdNacCkbnc">Devops</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="BWSTqyHWvI">
                            <label for="BWSTqyHWvI">Cloud Computing</label>
                            <ul>
                                <l>
                                    <input type="checkbox" id="obgUtGFDUo">
                                    <label for="obgUtGFDUo">AWS</label>
                                    <ul>
                                        <l>
                                            <input type="checkbox" id="QpfBYpoZbL">
                                            <label for="QpfBYpoZbL">Cli</label>
                                            <ul>
                                        ...
                                        <l>
                                            <input type="checkbox" id="lxTAEYZTbW">
                                            <label for="lxTAEYZTbW">Ec 2</label>
                                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="SXOfJIKCzu">
                            <label for="SXOfJIKCzu">Events</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="wHtqFAszmL">
                            <label for="wHtqFAszmL">Oauth</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="spAdXRMgAP">
                            <label for="spAdXRMgAP">Pulumi</label>
                            <ul>
                                <l>
                                    <input type="checkbox" id="VSigBLNqUK">
                                    <label for="VSigBLNqUK">Dotnet</label>
                                    <ul>
                        ...
                        <l>
                            <input type="checkbox" id="PBNRDWnsCM">
                            <label for="PBNRDWnsCM">Terraform</label>
                            <ul>
                                <l>
                                    <input type="checkbox" id="htFGAfoEXc">
                                    <label for="htFGAfoEXc">Functions</label>
                                    <ul>
                                ...
                                <l>
                                    <input type="checkbox" id="lOiZkdqTBh">
                                    <label for="lOiZkdqTBh">Meta Arguments</label>
                                    <ul>
                ...
                <l>
                    <input type="checkbox" id="MSuTzJawEg">
                    <label for="MSuTzJawEg">Docker</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="FivLNDGyKr">
                    <label for="FivLNDGyKr">Dotnet</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="OCoFfKOkgi">
                            <label for="OCoFfKOkgi">Cli</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="sJoxqqWfWF">
                    <label for="sJoxqqWfWF">Functional Programming</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="KmBQnsMStn">
                    <label for="KmBQnsMStn">Git</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="KEDzvrXqfb">
                            <label for="KEDzvrXqfb">Github</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="JzSPkCFYUr">
                    <label for="JzSPkCFYUr">Go</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="FSPCqnysHG">
                    <label for="FSPCqnysHG">Haskell</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="BMhzRMnXTy">
                    <label for="BMhzRMnXTy">Js</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="oaVUwBLPDz">
                            <label for="oaVUwBLPDz">Node</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="HsXotgBhaK">
                            <label for="HsXotgBhaK">Mocha</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="yQFPHyMqDb">
                            <label for="yQFPHyMqDb">P5js</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="kujibOSWJy">
                            <label for="kujibOSWJy">Typescript</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="KJROhKRYFx">
                    <label for="KJROhKRYFx">Kafka</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="YCSPPYDkjr">
                    <label for="YCSPPYDkjr">Kubernetes</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="cYnvOkYtnm">
                    <label for="cYnvOkYtnm">Language</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="iewyloyvsJ">
                    <label for="iewyloyvsJ">Linux</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="vJZCldzMmx">
                    <label for="vJZCldzMmx">Python</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="sCZTSlQFol">
                            <label for="sCZTSlQFol">Data Classes</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="fjPrfOzSBz">
                            <label for="fjPrfOzSBz">Libraries</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="LscWODnXUL">
                    <label for="LscWODnXUL">React</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="QZuAAJrxAo">
                    <label for="QZuAAJrxAo">Regular Expressions</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="DeDuddgymR">
                    <label for="DeDuddgymR">Rust</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="tcNsVpzZds">
                            <label for="tcNsVpzZds">Serde</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="cNzlTYQLvH">
                    <label for="cNzlTYQLvH">Vim</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="GWRaRtBudX">
                    <label for="GWRaRtBudX">Web</label>
                    <ul>
