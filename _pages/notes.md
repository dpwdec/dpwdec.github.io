...
<ul>
    <div name="contents-index">
        ...
        <l>
            <input type="checkbox" id="vxRkWjymGB" checked>
            <label for="vxRkWjymGB">Math</label>
            <ul>
                <l>
                    <input type="checkbox" id="wczAaVSmDe">
                    <label for="wczAaVSmDe">Exponentials</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="FWuKKDXFkZ">
                    <label for="FWuKKDXFkZ">Linear Algebra</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="jLuYbvcaLA">
                    <label for="jLuYbvcaLA">Logarithms</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="bYTVlRNZbi">
                    <label for="bYTVlRNZbi">Sequences</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="gMOPjmPvLJ">
                    <label for="gMOPjmPvLJ">Single Variable Calculus</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="KEoOnladvS">
                    <label for="KEoOnladvS">Trigonometry</label>
                    <ul>
        ...
        <l>
            <input type="checkbox" id="SSfoErzFAG" checked>
            <label for="SSfoErzFAG">Programming</label>
            <ul>
                <l>
                    <input type="checkbox" id="VdZDtuLhNN">
                    <label for="VdZDtuLhNN">Ansible</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="taaeFqXwYH">
                    <label for="taaeFqXwYH">Architecture</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="zFbsNWoaeI">
                    <label for="zFbsNWoaeI">Computer Graphics</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="kwDGIiJHUO">
                    <label for="kwDGIiJHUO">Databases</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="BZqulmkkOx">
                    <label for="BZqulmkkOx">Devops</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="aAQTJGSqDT">
                            <label for="aAQTJGSqDT">Cloud Providers</label>
                            <ul>
                                <l>
                                    <input type="checkbox" id="rBzBdOFuEN">
                                    <label for="rBzBdOFuEN">AWS</label>
                                    <ul>
                                        <l>
                                            <input type="checkbox" id="ZCWyLczsGN">
                                            <label for="ZCWyLczsGN">Cli</label>
                                            <ul>
                                        ...
                                        <l>
                                            <input type="checkbox" id="vEFOkzhGKN">
                                            <label for="vEFOkzhGKN">Dotnet</label>
                                            <ul>
                                        ...
                                        <l>
                                            <input type="checkbox" id="osAHXDoDwf">
                                            <label for="osAHXDoDwf">Ec 2</label>
                                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="PkuFmLsZrg">
                            <label for="PkuFmLsZrg">Events</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="tekGiLuEHm">
                            <label for="tekGiLuEHm">Localstack</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="MCpZYrFtKU">
                            <label for="MCpZYrFtKU">Pulumi</label>
                            <ul>
                                <l>
                                    <input type="checkbox" id="XXeMFSnxci">
                                    <label for="XXeMFSnxci">Dotnet</label>
                                    <ul>
                        ...
                        <l>
                            <input type="checkbox" id="VTMAwEBziX">
                            <label for="VTMAwEBziX">Serverless Framework</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="LXJgTmHXZZ">
                            <label for="LXJgTmHXZZ">Terraform</label>
                            <ul>
                                <l>
                                    <input type="checkbox" id="ymDjljaidr">
                                    <label for="ymDjljaidr">Functions</label>
                                    <ul>
                                ...
                                <l>
                                    <input type="checkbox" id="pvNlJswFHC">
                                    <label for="pvNlJswFHC">Meta Arguments</label>
                                    <ul>
                ...
                <l>
                    <input type="checkbox" id="sQuYRgcmlO">
                    <label for="sQuYRgcmlO">Docker</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="yjyOtLGXpb">
                    <label for="yjyOtLGXpb">Dotnet</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="gKlEeLqYKp">
                            <label for="gKlEeLqYKp">Cli</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="fIbnJotSqA">
                    <label for="fIbnJotSqA">Functional Programming</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="TObMhfMtyI">
                    <label for="TObMhfMtyI">Git</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="qmmIFwxRBy">
                            <label for="qmmIFwxRBy">Github</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="YfetHvzTFq">
                    <label for="YfetHvzTFq">Go</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="raUfjAzOpl">
                    <label for="raUfjAzOpl">Haskell</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="JBeqgjVPCI">
                    <label for="JBeqgjVPCI">Js</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="hSGcZiIDcr">
                            <label for="hSGcZiIDcr">Node</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="JFJxGBeEBi">
                            <label for="JFJxGBeEBi">D3</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="TLlyVHdwGK">
                            <label for="TLlyVHdwGK">Mocha</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="JBzGLFmIbU">
                            <label for="JBzGLFmIbU">P5js</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="VHtxQcTVKi">
                            <label for="VHtxQcTVKi">Typescript</label>
                            <ul>
                                <l>
                                    <input type="checkbox" id="cbTRcGvwfD">
                                    <label for="cbTRcGvwfD">Testing</label>
                                    <ul>
                ...
                <l>
                    <input type="checkbox" id="HAtitjlzdu">
                    <label for="HAtitjlzdu">Kafka</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="cEraYPSNrp">
                    <label for="cEraYPSNrp">Kubernetes</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="qsWmhlFiYW">
                    <label for="qsWmhlFiYW">Language</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="hImyEcNIgj">
                    <label for="hImyEcNIgj">Linux</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="tQaXSilZWb">
                            <label for="tQaXSilZWb">Bash</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="FVpwaCRCSP">
                    <label for="FVpwaCRCSP">Oauth</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="abEXVWmFZV">
                    <label for="abEXVWmFZV">Python</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="iBHKJOVwas">
                            <label for="iBHKJOVwas">Data Classes</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="nvcflhfnOJ">
                            <label for="nvcflhfnOJ">Libraries</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="EzNfixfURD">
                    <label for="EzNfixfURD">React</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="wJxTuJSojI">
                    <label for="wJxTuJSojI">Regular Expressions</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="LCdzzmpOIV">
                    <label for="LCdzzmpOIV">Rust</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="OEkMkMrGPQ">
                            <label for="OEkMkMrGPQ">Serde</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="kTKbuoJyFN">
                    <label for="kTKbuoJyFN">Shaders</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="HmBfGvuxqy">
                            <label for="HmBfGvuxqy">Glsl</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="vEKWPNYJIi">
                    <label for="vEKWPNYJIi">Vim</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="hnJqXPMmFg">
                    <label for="hnJqXPMmFg">Web</label>
                    <ul>
