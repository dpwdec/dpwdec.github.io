...
<ul>
    <div name="contents-index">
        ...
        <l>
            <input type="checkbox" id="nXysjPWyEz" checked>
            <label for="nXysjPWyEz">Math</label>
            <ul>
                <l>
                    <input type="checkbox" id="uxRiBeEnCa">
                    <label for="uxRiBeEnCa">Exponentials</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="hhYOMLxgCR">
                    <label for="hhYOMLxgCR">Linear Algebra</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="JFLYqkPpxK">
                    <label for="JFLYqkPpxK">Logarithms</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="HkcmawuCWc">
                    <label for="HkcmawuCWc">Sequences</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="qHmCPyjOzm">
                    <label for="qHmCPyjOzm">Single Variable Calculus</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="drPOgMMiYk">
                    <label for="drPOgMMiYk">Trigonometry</label>
                    <ul>
        ...
        <l>
            <input type="checkbox" id="McncqKnMAw" checked>
            <label for="McncqKnMAw">Programming</label>
            <ul>
                <l>
                    <input type="checkbox" id="eIsnWHZpgc">
                    <label for="eIsnWHZpgc">Ansible</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="ojDFbdMoMJ">
                    <label for="ojDFbdMoMJ">Architecture</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="maWxvdURUJ">
                    <label for="maWxvdURUJ">Computer Graphics</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="lGaWpIkSSi">
                    <label for="lGaWpIkSSi">Databases</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="NpaAoErBGs">
                    <label for="NpaAoErBGs">Devops</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="AGhXNzJgzI">
                            <label for="AGhXNzJgzI">Cloud Providers</label>
                            <ul>
                                <l>
                                    <input type="checkbox" id="qkjRQhSLzt">
                                    <label for="qkjRQhSLzt">AWS</label>
                                    <ul>
                                        <l>
                                            <input type="checkbox" id="rvtzRPOCUq">
                                            <label for="rvtzRPOCUq">Cli</label>
                                            <ul>
                                        ...
                                        <l>
                                            <input type="checkbox" id="pXIermvcQg">
                                            <label for="pXIermvcQg">Dotnet</label>
                                            <ul>
                                        ...
                                        <l>
                                            <input type="checkbox" id="cnuGWRBgfE">
                                            <label for="cnuGWRBgfE">Ec 2</label>
                                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="SyDLvReFNy">
                            <label for="SyDLvReFNy">Events</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="DPhmVwJsjg">
                            <label for="DPhmVwJsjg">Localstack</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="iHqclsOfGu">
                            <label for="iHqclsOfGu">Pulumi</label>
                            <ul>
                                <l>
                                    <input type="checkbox" id="FgedrCsDEN">
                                    <label for="FgedrCsDEN">Dotnet</label>
                                    <ul>
                        ...
                        <l>
                            <input type="checkbox" id="ekzQdXecqB">
                            <label for="ekzQdXecqB">Serverless Framework</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="iPJSocLpem">
                            <label for="iPJSocLpem">Terraform</label>
                            <ul>
                                <l>
                                    <input type="checkbox" id="MxqswpNIVd">
                                    <label for="MxqswpNIVd">Functions</label>
                                    <ul>
                                ...
                                <l>
                                    <input type="checkbox" id="CsSDJzZJAY">
                                    <label for="CsSDJzZJAY">Meta Arguments</label>
                                    <ul>
                ...
                <l>
                    <input type="checkbox" id="KMelkeyGXz">
                    <label for="KMelkeyGXz">Docker</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="ttQTJMaIjs">
                    <label for="ttQTJMaIjs">Dotnet</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="yiaaxMxGvq">
                            <label for="yiaaxMxGvq">Cli</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="mszZeCprsp">
                    <label for="mszZeCprsp">Functional Programming</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="incSxHWMlB">
                    <label for="incSxHWMlB">Git</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="emHVgFrasV">
                            <label for="emHVgFrasV">Github</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="NEqYDczwTe">
                    <label for="NEqYDczwTe">Go</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="kWBJlTSwnu">
                    <label for="kWBJlTSwnu">Haskell</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="TTmUvYLQAb">
                    <label for="TTmUvYLQAb">Js</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="FidNtgdIIU">
                            <label for="FidNtgdIIU">Node</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="LJRTBLCaBV">
                            <label for="LJRTBLCaBV">D3</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="jSdMOsAmLM">
                            <label for="jSdMOsAmLM">Mocha</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="HIGbwvXvPZ">
                            <label for="HIGbwvXvPZ">P5js</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="psHmAXLVdA">
                            <label for="psHmAXLVdA">Typescript</label>
                            <ul>
                                <l>
                                    <input type="checkbox" id="wWCwlUnaQo">
                                    <label for="wWCwlUnaQo">Testing</label>
                                    <ul>
                ...
                <l>
                    <input type="checkbox" id="ZDeyBnuzxB">
                    <label for="ZDeyBnuzxB">Kafka</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="evmUUGrfcB">
                    <label for="evmUUGrfcB">Kubernetes</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="jVUrpBioBl">
                    <label for="jVUrpBioBl">Language</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="oapHQjfcoq">
                    <label for="oapHQjfcoq">Linux</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="DPqkxYMzmO">
                            <label for="DPqkxYMzmO">Bash</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="vCudqXuXOn">
                    <label for="vCudqXuXOn">Oauth</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="mOUVkLsWuw">
                    <label for="mOUVkLsWuw">Python</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="RwACyQVVXW">
                            <label for="RwACyQVVXW">Data Classes</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="aueWtUAuKs">
                            <label for="aueWtUAuKs">Libraries</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="CdjFTAEoky">
                    <label for="CdjFTAEoky">React</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="rcRzXMtJei">
                    <label for="rcRzXMtJei">Regular Expressions</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="vfnuTFVDSV">
                    <label for="vfnuTFVDSV">Rust</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="DnBrifWhSZ">
                            <label for="DnBrifWhSZ">Serde</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="hCMqNTXuQg">
                    <label for="hCMqNTXuQg">Vim</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="PjpVyvSvAV">
                    <label for="PjpVyvSvAV">Web</label>
                    <ul>
