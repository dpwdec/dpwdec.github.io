...
<ul>
    <div name="contents-index">
        ...
        <l>
            <input type="checkbox" id="rKqSLxfGAV" checked>
            <label for="rKqSLxfGAV">Math</label>
            <ul>
                <l>
                    <input type="checkbox" id="knZbJncSWn">
                    <label for="knZbJncSWn">Exponentials</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="DivOhODeXL">
                    <label for="DivOhODeXL">Linear Algebra</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="opJyggouqR">
                    <label for="opJyggouqR">Logarithms</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="CzclfFmQKM">
                    <label for="CzclfFmQKM">Sequences</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="VPngAnPfJx">
                    <label for="VPngAnPfJx">Single Variable Calculus</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="lXRJaQlFxq">
                    <label for="lXRJaQlFxq">Trigonometry</label>
                    <ul>
        ...
        <l>
            <input type="checkbox" id="lnZGqDohNs" checked>
            <label for="lnZGqDohNs">Programming</label>
            <ul>
                <l>
                    <input type="checkbox" id="RXGgjtxtJU">
                    <label for="RXGgjtxtJU">Ansible</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="TQKUzcmQpd">
                    <label for="TQKUzcmQpd">Architecture</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="xhFsnDEyQk">
                    <label for="xhFsnDEyQk">Computer Graphics</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="SkCxrhyPOI">
                    <label for="SkCxrhyPOI">Databases</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="mGvKRZblES">
                    <label for="mGvKRZblES">Devops</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="BwZiWnZoEL">
                            <label for="BwZiWnZoEL">Cloud Computing</label>
                            <ul>
                                <l>
                                    <input type="checkbox" id="mYZQSSPADY">
                                    <label for="mYZQSSPADY">AWS</label>
                                    <ul>
                                        <l>
                                            <input type="checkbox" id="xEScjPclEM">
                                            <label for="xEScjPclEM">Ec 2</label>
                                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="uuGXbrHMfq">
                            <label for="uuGXbrHMfq">Events</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="nnCBWVhlWd">
                            <label for="nnCBWVhlWd">Oauth</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="UpDcrOfjdW">
                            <label for="UpDcrOfjdW">Pulumi</label>
                            <ul>
                                <l>
                                    <input type="checkbox" id="BTPhkZPALG">
                                    <label for="BTPhkZPALG">Dotnet</label>
                                    <ul>
                        ...
                        <l>
                            <input type="checkbox" id="TWZBJQmQpa">
                            <label for="TWZBJQmQpa">Terraform</label>
                            <ul>
                                <l>
                                    <input type="checkbox" id="ddQHmgbtAU">
                                    <label for="ddQHmgbtAU">Functions</label>
                                    <ul>
                                ...
                                <l>
                                    <input type="checkbox" id="rkcyFfyKQp">
                                    <label for="rkcyFfyKQp">Meta Arguments</label>
                                    <ul>
                ...
                <l>
                    <input type="checkbox" id="DOByXQSfkh">
                    <label for="DOByXQSfkh">Docker</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="udcyzsPxNY">
                    <label for="udcyzsPxNY">Dotnet</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="FgdvCkAKQE">
                            <label for="FgdvCkAKQE">Cli</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="ANuCHkDBmu">
                    <label for="ANuCHkDBmu">Functional Programming</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="IEZbetBOfJ">
                    <label for="IEZbetBOfJ">Git</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="rlMRSKZFmT">
                            <label for="rlMRSKZFmT">Github</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="AJPqXWEdNn">
                    <label for="AJPqXWEdNn">Go</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="oAsiemOZBE">
                    <label for="oAsiemOZBE">Haskell</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="JyDBRMVWZs">
                    <label for="JyDBRMVWZs">Js</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="QRgqhjmKkk">
                            <label for="QRgqhjmKkk">Node</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="pyKhefOzzZ">
                            <label for="pyKhefOzzZ">Mocha</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="MlzBHbTHrY">
                            <label for="MlzBHbTHrY">P5js</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="KMkOzILepi">
                            <label for="KMkOzILepi">Typescript</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="bpscrzJQrI">
                    <label for="bpscrzJQrI">Kafka</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="wdfIlYWwQV">
                    <label for="wdfIlYWwQV">Kubernetes</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="wCNJWFcBej">
                    <label for="wCNJWFcBej">Language</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="mmDRarsHIQ">
                    <label for="mmDRarsHIQ">Linux</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="aJnxMxUwqT">
                    <label for="aJnxMxUwqT">Python</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="mogWqpQBcb">
                            <label for="mogWqpQBcb">Data Classes</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="eVvszQUwNi">
                            <label for="eVvszQUwNi">Libraries</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="buFODKqJrD">
                    <label for="buFODKqJrD">React</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="ULCSgnDSlx">
                    <label for="ULCSgnDSlx">Regular Expressions</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="zIKThsuQdX">
                    <label for="zIKThsuQdX">Rust</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="FSQOnfnUgY">
                            <label for="FSQOnfnUgY">Serde</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="JAqadLxwPZ">
                    <label for="JAqadLxwPZ">Vim</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="QnxzqGGrml">
                    <label for="QnxzqGGrml">Web</label>
                    <ul>
