...
<ul>
    <div name="contents-index">
        ...
        <l>
            <input type="checkbox" id="tlRnfxHZQo" checked>
            <label for="tlRnfxHZQo">Math</label>
            <ul>
                <l>
                    <input type="checkbox" id="mBzWjhIllx">
                    <label for="mBzWjhIllx">Exponentials</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="bgVdVmjANM">
                    <label for="bgVdVmjANM">Linear Algebra</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="vLipzdESnI">
                    <label for="vLipzdESnI">Logarithms</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="MrRkdlChTA">
                    <label for="MrRkdlChTA">Sequences</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="aCpwVPiriC">
                    <label for="aCpwVPiriC">Single Variable Calculus</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="GHvKKosyBc">
                    <label for="GHvKKosyBc">Trigonometry</label>
                    <ul>
        ...
        <l>
            <input type="checkbox" id="EfDHSlTlvP" checked>
            <label for="EfDHSlTlvP">Programming</label>
            <ul>
                <l>
                    <input type="checkbox" id="TatUHaqrIy">
                    <label for="TatUHaqrIy">Ansible</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="nEUmRtnrsX">
                    <label for="nEUmRtnrsX">Architecture</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="oSotDSPyCt">
                    <label for="oSotDSPyCt">Computer Graphics</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="ttSjloaHYz">
                    <label for="ttSjloaHYz">Databases</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="CRMXejFQxT">
                    <label for="CRMXejFQxT">Devops</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="wUrIlyBkba">
                            <label for="wUrIlyBkba">Cloud Computing</label>
                            <ul>
                                <l>
                                    <input type="checkbox" id="YzFkjgcklS">
                                    <label for="YzFkjgcklS">AWS</label>
                                    <ul>
                                        <l>
                                            <input type="checkbox" id="vUSWvhcrVk">
                                            <label for="vUSWvhcrVk">Cli</label>
                                            <ul>
                                        ...
                                        <l>
                                            <input type="checkbox" id="EthaqyNKXi">
                                            <label for="EthaqyNKXi">Dotnet</label>
                                            <ul>
                                        ...
                                        <l>
                                            <input type="checkbox" id="RKAfQrXmDT">
                                            <label for="RKAfQrXmDT">Ec 2</label>
                                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="FbRLjsXhEq">
                            <label for="FbRLjsXhEq">Events</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="wgScUAVDDz">
                            <label for="wgScUAVDDz">Oauth</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="KXILQKuizB">
                            <label for="KXILQKuizB">Pulumi</label>
                            <ul>
                                <l>
                                    <input type="checkbox" id="tbZkIaYCmb">
                                    <label for="tbZkIaYCmb">Dotnet</label>
                                    <ul>
                        ...
                        <l>
                            <input type="checkbox" id="wjHIqWXykK">
                            <label for="wjHIqWXykK">Terraform</label>
                            <ul>
                                <l>
                                    <input type="checkbox" id="ApSkEBokRX">
                                    <label for="ApSkEBokRX">Functions</label>
                                    <ul>
                                ...
                                <l>
                                    <input type="checkbox" id="bdhoFiDzgC">
                                    <label for="bdhoFiDzgC">Meta Arguments</label>
                                    <ul>
                ...
                <l>
                    <input type="checkbox" id="WUprCAndJr">
                    <label for="WUprCAndJr">Docker</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="gyZxolcpgI">
                    <label for="gyZxolcpgI">Dotnet</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="anqMCJcwUO">
                            <label for="anqMCJcwUO">Cli</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="mEnRxhqXjG">
                    <label for="mEnRxhqXjG">Functional Programming</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="nDvsiEAzZk">
                    <label for="nDvsiEAzZk">Git</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="sTKijhOAcd">
                            <label for="sTKijhOAcd">Github</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="rtvuxlDscY">
                    <label for="rtvuxlDscY">Go</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="xCrrvmotmF">
                    <label for="xCrrvmotmF">Haskell</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="YJZpPJzsmR">
                    <label for="YJZpPJzsmR">Js</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="GqQgYsJNpu">
                            <label for="GqQgYsJNpu">Node</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="LejxOMWTEo">
                            <label for="LejxOMWTEo">Mocha</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="XbejKeMgru">
                            <label for="XbejKeMgru">P5js</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="OZZnCFIgIZ">
                            <label for="OZZnCFIgIZ">Typescript</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="UbDySJfwLs">
                    <label for="UbDySJfwLs">Kafka</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="LnaRPZFhhK">
                    <label for="LnaRPZFhhK">Kubernetes</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="HPkoWBtdgq">
                    <label for="HPkoWBtdgq">Language</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="MhSpHcYcCx">
                    <label for="MhSpHcYcCx">Linux</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="ThybQxpJRX">
                    <label for="ThybQxpJRX">Python</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="ZtCNgRXPik">
                            <label for="ZtCNgRXPik">Data Classes</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="KvQLdoyThe">
                            <label for="KvQLdoyThe">Libraries</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="xSyQEyBfiq">
                    <label for="xSyQEyBfiq">React</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="QzFPIZWkHo">
                    <label for="QzFPIZWkHo">Regular Expressions</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="rLquLTtWOV">
                    <label for="rLquLTtWOV">Rust</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="nAkpglMegB">
                            <label for="nAkpglMegB">Serde</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="HYWMgRjfxN">
                    <label for="HYWMgRjfxN">Vim</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="rizBAidLaq">
                    <label for="rizBAidLaq">Web</label>
                    <ul>
