...
<ul>
    <div name="contents-index">
        ...
        <l>
            <input type="checkbox" id="pbtSJUQFRG" checked>
            <label for="pbtSJUQFRG">Math</label>
            <ul>
                <l>
                    <input type="checkbox" id="BbCzoJWgLt">
                    <label for="BbCzoJWgLt">Exponentials</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="fOzvrARCnn">
                    <label for="fOzvrARCnn">Linear Algebra</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="owjPBpdIbM">
                    <label for="owjPBpdIbM">Logarithms</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="bmNRGAiHho">
                    <label for="bmNRGAiHho">Sequences</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="vzaSzVKZOc">
                    <label for="vzaSzVKZOc">Single Variable Calculus</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="xmoXTVbNpn">
                    <label for="xmoXTVbNpn">Trigonometry</label>
                    <ul>
        ...
        <l>
            <input type="checkbox" id="hzqIEzDvTd" checked>
            <label for="hzqIEzDvTd">Programming</label>
            <ul>
                <l>
                    <input type="checkbox" id="EOkOHRKeyU">
                    <label for="EOkOHRKeyU">Ansible</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="mijXyAtkAZ">
                    <label for="mijXyAtkAZ">Architecture</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="ZlgXuSLQBz">
                    <label for="ZlgXuSLQBz">Computer Graphics</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="zfNQDSpkSL">
                    <label for="zfNQDSpkSL">Databases</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="tQiSFShDWR">
                    <label for="tQiSFShDWR">Devops</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="ADOZSOGjKe">
                            <label for="ADOZSOGjKe">Cloud Providers</label>
                            <ul>
                                <l>
                                    <input type="checkbox" id="xBLIhsMGBV">
                                    <label for="xBLIhsMGBV">AWS</label>
                                    <ul>
                                        <l>
                                            <input type="checkbox" id="NzAHFBcHtR">
                                            <label for="NzAHFBcHtR">Cli</label>
                                            <ul>
                                        ...
                                        <l>
                                            <input type="checkbox" id="sTMquTbElM">
                                            <label for="sTMquTbElM">Dotnet</label>
                                            <ul>
                                        ...
                                        <l>
                                            <input type="checkbox" id="kNtTjYPhmV">
                                            <label for="kNtTjYPhmV">Ec 2</label>
                                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="kUlPGtUDux">
                            <label for="kUlPGtUDux">Events</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="RcCbRsqLdL">
                            <label for="RcCbRsqLdL">Localstack</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="JCCDefPUoS">
                            <label for="JCCDefPUoS">Pulumi</label>
                            <ul>
                                <l>
                                    <input type="checkbox" id="zgZPSJUIkw">
                                    <label for="zgZPSJUIkw">Dotnet</label>
                                    <ul>
                        ...
                        <l>
                            <input type="checkbox" id="dVzlzKhxVi">
                            <label for="dVzlzKhxVi">Serverless Framework</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="nSaoXlifZG">
                            <label for="nSaoXlifZG">Terraform</label>
                            <ul>
                                <l>
                                    <input type="checkbox" id="lLVtihMFwG">
                                    <label for="lLVtihMFwG">Functions</label>
                                    <ul>
                                ...
                                <l>
                                    <input type="checkbox" id="gTuwJytWhg">
                                    <label for="gTuwJytWhg">Meta Arguments</label>
                                    <ul>
                ...
                <l>
                    <input type="checkbox" id="ODiPUYzojf">
                    <label for="ODiPUYzojf">Docker</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="mKyZkjycFN">
                    <label for="mKyZkjycFN">Dotnet</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="rDeaPouYPW">
                            <label for="rDeaPouYPW">Cli</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="nMMymDVvFY">
                    <label for="nMMymDVvFY">Functional Programming</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="ErysWbLpOW">
                    <label for="ErysWbLpOW">Git</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="xwDReJEvBf">
                            <label for="xwDReJEvBf">Github</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="tPvqAWDIDg">
                    <label for="tPvqAWDIDg">Go</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="BEMJnJdDQv">
                    <label for="BEMJnJdDQv">Haskell</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="CJXLXCbYSV">
                    <label for="CJXLXCbYSV">Js</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="VdgSoQgMYH">
                            <label for="VdgSoQgMYH">Node</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="OYcTJXruhL">
                            <label for="OYcTJXruhL">D3</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="PSRSagIyAH">
                            <label for="PSRSagIyAH">Mocha</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="AynjFHVtDf">
                            <label for="AynjFHVtDf">P5js</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="BJPmhrcPIv">
                            <label for="BJPmhrcPIv">Typescript</label>
                            <ul>
                                <l>
                                    <input type="checkbox" id="uRpKsXWjpH">
                                    <label for="uRpKsXWjpH">Testing</label>
                                    <ul>
                ...
                <l>
                    <input type="checkbox" id="kjqbxkyznv">
                    <label for="kjqbxkyznv">Kafka</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="hITJdTRdca">
                    <label for="hITJdTRdca">Kubernetes</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="MuzwlTTjtH">
                    <label for="MuzwlTTjtH">Language</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="UFeJiTvKgc">
                    <label for="UFeJiTvKgc">Linux</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="UJVdtXtOqM">
                            <label for="UJVdtXtOqM">Bash</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="oybYqKKQAT">
                    <label for="oybYqKKQAT">Oauth</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="awBlomqQzK">
                    <label for="awBlomqQzK">Prometheus</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="TQeYhTrGLd">
                    <label for="TQeYhTrGLd">Python</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="RqGlerbbgP">
                            <label for="RqGlerbbgP">Data Classes</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="mYbykEbSBw">
                            <label for="mYbykEbSBw">Libraries</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="RGIpfwGffx">
                    <label for="RGIpfwGffx">React</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="OyJOuRsijy">
                    <label for="OyJOuRsijy">Regular Expressions</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="gzOYSCtOgC">
                    <label for="gzOYSCtOgC">Rust</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="mLOaCmSBxj">
                            <label for="mLOaCmSBxj">Serde</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="oMsneGILbm">
                    <label for="oMsneGILbm">Shaders</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="jVfLYsAwXd">
                            <label for="jVfLYsAwXd">Glsl</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="xVmSexKWWo">
                    <label for="xVmSexKWWo">Vim</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="bQfPHGgzJN">
                    <label for="bQfPHGgzJN">Web</label>
                    <ul>
