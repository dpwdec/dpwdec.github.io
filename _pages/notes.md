...
<ul>
    <div name="contents-index">
        ...
        <l>
            <input type="checkbox" id="uyEucXJXLE" checked>
            <label for="uyEucXJXLE">Math</label>
            <ul>
                <l>
                    <input type="checkbox" id="ExiWaDryvJ">
                    <label for="ExiWaDryvJ">Exponentials</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="EncoUZxSzI">
                    <label for="EncoUZxSzI">Linear Algebra</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="EtWkfaIsoh">
                    <label for="EtWkfaIsoh">Logarithms</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="EwdGyCmqpx">
                    <label for="EwdGyCmqpx">Sequences</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="nOyNCmpMbZ">
                    <label for="nOyNCmpMbZ">Single Variable Calculus</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="KZfVqLxIsy">
                    <label for="KZfVqLxIsy">Trigonometry</label>
                    <ul>
        ...
        <l>
            <input type="checkbox" id="ICtDvYGuZx" checked>
            <label for="ICtDvYGuZx">Programming</label>
            <ul>
                <l>
                    <input type="checkbox" id="GfwpPxMKVo">
                    <label for="GfwpPxMKVo">Ansible</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="UgHaTGHLAB">
                    <label for="UgHaTGHLAB">Architecture</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="eKaPecZGso">
                    <label for="eKaPecZGso">Computer Graphics</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="ndltUDiKbV">
                    <label for="ndltUDiKbV">Databases</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="VBocrJFTya">
                    <label for="VBocrJFTya">Devops</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="XgaBtLVMwB">
                            <label for="XgaBtLVMwB">Cloud Computing</label>
                            <ul>
                                <l>
                                    <input type="checkbox" id="qEjXNqnKWx">
                                    <label for="qEjXNqnKWx">AWS</label>
                                    <ul>
                                        <l>
                                            <input type="checkbox" id="QKCQSSqNbB">
                                            <label for="QKCQSSqNbB">Cli</label>
                                            <ul>
                                        ...
                                        <l>
                                            <input type="checkbox" id="ZWuRGGwgQW">
                                            <label for="ZWuRGGwgQW">Dotnet</label>
                                            <ul>
                                        ...
                                        <l>
                                            <input type="checkbox" id="JsqjjYvDrz">
                                            <label for="JsqjjYvDrz">Ec 2</label>
                                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="JIUbMMINyw">
                            <label for="JIUbMMINyw">Events</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="VupIrNOMGM">
                            <label for="VupIrNOMGM">Localstack</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="gmfNgXSNzG">
                            <label for="gmfNgXSNzG">Oauth</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="NwZHvflbqH">
                            <label for="NwZHvflbqH">Pulumi</label>
                            <ul>
                                <l>
                                    <input type="checkbox" id="TaXPqBxPdK">
                                    <label for="TaXPqBxPdK">Dotnet</label>
                                    <ul>
                        ...
                        <l>
                            <input type="checkbox" id="ioWZpWLXaa">
                            <label for="ioWZpWLXaa">Terraform</label>
                            <ul>
                                <l>
                                    <input type="checkbox" id="sXsVnIilAd">
                                    <label for="sXsVnIilAd">Functions</label>
                                    <ul>
                                ...
                                <l>
                                    <input type="checkbox" id="ycUdPwiaTe">
                                    <label for="ycUdPwiaTe">Meta Arguments</label>
                                    <ul>
                ...
                <l>
                    <input type="checkbox" id="NqcrHlyDld">
                    <label for="NqcrHlyDld">Docker</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="LTLTXbwOcH">
                    <label for="LTLTXbwOcH">Dotnet</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="qOVTJOTWSg">
                            <label for="qOVTJOTWSg">Cli</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="fmrHVgnwHF">
                    <label for="fmrHVgnwHF">Functional Programming</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="OnQauNSNnl">
                    <label for="OnQauNSNnl">Git</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="jCHEechWkW">
                            <label for="jCHEechWkW">Github</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="zHjAvcEVXK">
                    <label for="zHjAvcEVXK">Go</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="iALCuCmrTQ">
                    <label for="iALCuCmrTQ">Haskell</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="zcrSVXgZpU">
                    <label for="zcrSVXgZpU">Js</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="HegrCrDyvW">
                            <label for="HegrCrDyvW">Node</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="nsunfDIIJX">
                            <label for="nsunfDIIJX">D3</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="QyKFCOLGUm">
                            <label for="QyKFCOLGUm">Mocha</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="KWiHaeTdNo">
                            <label for="KWiHaeTdNo">P5js</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="MyTEcEGTWy">
                            <label for="MyTEcEGTWy">Typescript</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="XdPTZpdGKq">
                    <label for="XdPTZpdGKq">Kafka</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="ayXufGMBtf">
                    <label for="ayXufGMBtf">Kubernetes</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="CGLKCYpMVg">
                    <label for="CGLKCYpMVg">Language</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="StqKVEichm">
                    <label for="StqKVEichm">Linux</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="bVriBhbtjF">
                            <label for="bVriBhbtjF">Bash</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="ViNwAIXWug">
                    <label for="ViNwAIXWug">Python</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="CvTTITuAAD">
                            <label for="CvTTITuAAD">Data Classes</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="duAPavLooh">
                            <label for="duAPavLooh">Libraries</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="CYWXNmskSQ">
                    <label for="CYWXNmskSQ">React</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="WXQDcFFnJD">
                    <label for="WXQDcFFnJD">Regular Expressions</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="cdcolcOxUU">
                    <label for="cdcolcOxUU">Rust</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="ekdORLCXon">
                            <label for="ekdORLCXon">Serde</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="tmxZpwoowm">
                    <label for="tmxZpwoowm">Vim</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="ZVxdmqLAMx">
                    <label for="ZVxdmqLAMx">Web</label>
                    <ul>
