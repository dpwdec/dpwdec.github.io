...
<ul>
    <div name="contents-index">
        ...
        <l>
            <input type="checkbox" id="xtfYxgBglr" checked>
            <label for="xtfYxgBglr">Math</label>
            <ul>
                <l>
                    <input type="checkbox" id="OjbduoEEAX">
                    <label for="OjbduoEEAX">Exponentials</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="GrzxbAQxFq">
                    <label for="GrzxbAQxFq">Linear Algebra</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="vuyHWqsSqt">
                    <label for="vuyHWqsSqt">Logarithms</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="rKgULznwUT">
                    <label for="rKgULznwUT">Sequences</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="NRfyfeuVGV">
                    <label for="NRfyfeuVGV">Single Variable Calculus</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="gfreEVFsXK">
                    <label for="gfreEVFsXK">Trigonometry</label>
                    <ul>
        ...
        <l>
            <input type="checkbox" id="hSjOUiPoVo" checked>
            <label for="hSjOUiPoVo">Programming</label>
            <ul>
                <l>
                    <input type="checkbox" id="CmIwfxuZfE">
                    <label for="CmIwfxuZfE">Ansible</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="xYGGyqCgRj">
                    <label for="xYGGyqCgRj">Architecture</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="nIuivatqsM">
                    <label for="nIuivatqsM">Computer Graphics</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="EIOpRkUUvW">
                    <label for="EIOpRkUUvW">Databases</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="XHnjDrzpxo">
                    <label for="XHnjDrzpxo">Devops</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="DHOouUzJBT">
                            <label for="DHOouUzJBT">Cloud Providers</label>
                            <ul>
                                <l>
                                    <input type="checkbox" id="uTuNTRhyXi">
                                    <label for="uTuNTRhyXi">AWS</label>
                                    <ul>
                                        <l>
                                            <input type="checkbox" id="tPMTYhwQEV">
                                            <label for="tPMTYhwQEV">Cli</label>
                                            <ul>
                                        ...
                                        <l>
                                            <input type="checkbox" id="jrBkinIhBZ">
                                            <label for="jrBkinIhBZ">Dotnet</label>
                                            <ul>
                                        ...
                                        <l>
                                            <input type="checkbox" id="VlPENTBkTB">
                                            <label for="VlPENTBkTB">Ec 2</label>
                                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="zYfNqwFQMg">
                            <label for="zYfNqwFQMg">Events</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="wZRkFcQJaA">
                            <label for="wZRkFcQJaA">Localstack</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="DkDSBAXfNY">
                            <label for="DkDSBAXfNY">Pulumi</label>
                            <ul>
                                <l>
                                    <input type="checkbox" id="mNecbDtFyz">
                                    <label for="mNecbDtFyz">Dotnet</label>
                                    <ul>
                        ...
                        <l>
                            <input type="checkbox" id="jRIqtGTFwD">
                            <label for="jRIqtGTFwD">Serverless Framework</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="wWLUVziSXi">
                            <label for="wWLUVziSXi">Terraform</label>
                            <ul>
                                <l>
                                    <input type="checkbox" id="DEIhIyXnHI">
                                    <label for="DEIhIyXnHI">Functions</label>
                                    <ul>
                                ...
                                <l>
                                    <input type="checkbox" id="LKkTzDOsMA">
                                    <label for="LKkTzDOsMA">Meta Arguments</label>
                                    <ul>
                ...
                <l>
                    <input type="checkbox" id="dsMvKRQutt">
                    <label for="dsMvKRQutt">Docker</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="MRQcWHupMB">
                    <label for="MRQcWHupMB">Dotnet</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="swtDQuZVRB">
                            <label for="swtDQuZVRB">Cli</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="mTDjeiltUh">
                    <label for="mTDjeiltUh">Functional Programming</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="gtTzZGNLgR">
                    <label for="gtTzZGNLgR">Git</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="qEqXFKYPvC">
                            <label for="qEqXFKYPvC">Github</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="cexDstKMRo">
                    <label for="cexDstKMRo">Go</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="MsRbLnbTTX">
                    <label for="MsRbLnbTTX">Haskell</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="ZOmqIbNwRe">
                    <label for="ZOmqIbNwRe">Js</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="GetvhYcQfN">
                            <label for="GetvhYcQfN">Node</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="LPMGCAtXVQ">
                            <label for="LPMGCAtXVQ">D3</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="AOLpTejEzm">
                            <label for="AOLpTejEzm">Mocha</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="FMmAAZvqqP">
                            <label for="FMmAAZvqqP">P5js</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="aSFgYfKJCH">
                            <label for="aSFgYfKJCH">Typescript</label>
                            <ul>
                                <l>
                                    <input type="checkbox" id="LeOgcadKRC">
                                    <label for="LeOgcadKRC">Testing</label>
                                    <ul>
                ...
                <l>
                    <input type="checkbox" id="POYvuiRaTm">
                    <label for="POYvuiRaTm">Kafka</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="GIhEDsMiVE">
                    <label for="GIhEDsMiVE">Kubernetes</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="owsJWZlGUa">
                    <label for="owsJWZlGUa">Language</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="dkDMsQgzUF">
                    <label for="dkDMsQgzUF">Linux</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="WHUgcdXICu">
                            <label for="WHUgcdXICu">Bash</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="QwZdvzokJe">
                    <label for="QwZdvzokJe">Oauth</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="NHekaTSFNN">
                    <label for="NHekaTSFNN">Python</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="uTYqIHEjHu">
                            <label for="uTYqIHEjHu">Data Classes</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="ZoeUfrAebF">
                            <label for="ZoeUfrAebF">Libraries</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="RZmmaHCxkO">
                    <label for="RZmmaHCxkO">React</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="vErQBhaKah">
                    <label for="vErQBhaKah">Regular Expressions</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="XONIbUchHm">
                    <label for="XONIbUchHm">Rust</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="xlKqnqizSd">
                            <label for="xlKqnqizSd">Serde</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="mpcRtrZkcb">
                    <label for="mpcRtrZkcb">Vim</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="UVuIRdzjlg">
                    <label for="UVuIRdzjlg">Web</label>
                    <ul>
