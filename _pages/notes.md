...
<ul>
    <div name="contents-index">
        ...
        <l>
            <input type="checkbox" id="uWctzVCPLV" checked>
            <label for="uWctzVCPLV">Math</label>
            <ul>
                <l>
                    <input type="checkbox" id="BjwJMjVhrn">
                    <label for="BjwJMjVhrn">Exponentials</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="FquLJqEnLK">
                    <label for="FquLJqEnLK">Linear Algebra</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="mqYZmCdyKy">
                    <label for="mqYZmCdyKy">Logarithms</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="OYILUZzGVV">
                    <label for="OYILUZzGVV">Sequences</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="xFLexUiwet">
                    <label for="xFLexUiwet">Single Variable Calculus</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="cvjHGYBHiS">
                    <label for="cvjHGYBHiS">Trigonometry</label>
                    <ul>
        ...
        <l>
            <input type="checkbox" id="QqPtRVNbBl" checked>
            <label for="QqPtRVNbBl">Programming</label>
            <ul>
                <l>
                    <input type="checkbox" id="QEQqxihxRp">
                    <label for="QEQqxihxRp">Ansible</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="mUcSIPnpqJ">
                    <label for="mUcSIPnpqJ">Architecture</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="WRgPgCkYWp">
                    <label for="WRgPgCkYWp">Computer Graphics</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="AfIQPulFhS">
                    <label for="AfIQPulFhS">Databases</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="nUymgQqgiI">
                    <label for="nUymgQqgiI">Devops</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="FJyhWnpsXm">
                            <label for="FJyhWnpsXm">Cloud Computing</label>
                            <ul>
                                <l>
                                    <input type="checkbox" id="AMnxStwSRV">
                                    <label for="AMnxStwSRV">AWS</label>
                                    <ul>
                                        <l>
                                            <input type="checkbox" id="nPaeyaPTaA">
                                            <label for="nPaeyaPTaA">Cli</label>
                                            <ul>
                                        ...
                                        <l>
                                            <input type="checkbox" id="EunfghJNhj">
                                            <label for="EunfghJNhj">Dotnet</label>
                                            <ul>
                                        ...
                                        <l>
                                            <input type="checkbox" id="onQnkwaIzV">
                                            <label for="onQnkwaIzV">Ec 2</label>
                                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="MZuZaGGSUM">
                            <label for="MZuZaGGSUM">Events</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="pXnTLkSEiO">
                            <label for="pXnTLkSEiO">Localstack</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="QhgmwYwhXB">
                            <label for="QhgmwYwhXB">Oauth</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="BVEHRnuYhL">
                            <label for="BVEHRnuYhL">Pulumi</label>
                            <ul>
                                <l>
                                    <input type="checkbox" id="ZMlVhpHKcN">
                                    <label for="ZMlVhpHKcN">Dotnet</label>
                                    <ul>
                        ...
                        <l>
                            <input type="checkbox" id="ZBpTvwzmDa">
                            <label for="ZBpTvwzmDa">Terraform</label>
                            <ul>
                                <l>
                                    <input type="checkbox" id="MfOGZoNwdq">
                                    <label for="MfOGZoNwdq">Functions</label>
                                    <ul>
                                ...
                                <l>
                                    <input type="checkbox" id="xHgJmEoMJD">
                                    <label for="xHgJmEoMJD">Meta Arguments</label>
                                    <ul>
                ...
                <l>
                    <input type="checkbox" id="XOmBxUDoJB">
                    <label for="XOmBxUDoJB">Docker</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="qjsnBROIpv">
                    <label for="qjsnBROIpv">Dotnet</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="TAiNepxuEC">
                            <label for="TAiNepxuEC">Cli</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="dFqlwQzrhZ">
                    <label for="dFqlwQzrhZ">Functional Programming</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="jnVprEVAcU">
                    <label for="jnVprEVAcU">Git</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="gaNDMaHKoH">
                            <label for="gaNDMaHKoH">Github</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="WKxfByflMf">
                    <label for="WKxfByflMf">Go</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="RVIiIWwfSI">
                    <label for="RVIiIWwfSI">Haskell</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="WvRJPrcFZh">
                    <label for="WvRJPrcFZh">Js</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="WWlajcYptT">
                            <label for="WWlajcYptT">Node</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="EILbmylmce">
                            <label for="EILbmylmce">D3</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="nidTZSJxTr">
                            <label for="nidTZSJxTr">Mocha</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="kxEehHJNgy">
                            <label for="kxEehHJNgy">P5js</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="NsGFSkyuKI">
                            <label for="NsGFSkyuKI">Typescript</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="FUbWjKbezG">
                    <label for="FUbWjKbezG">Kafka</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="MNZoDjIXDn">
                    <label for="MNZoDjIXDn">Kubernetes</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="JMswiFJfAX">
                    <label for="JMswiFJfAX">Language</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="tiLScpvPNw">
                    <label for="tiLScpvPNw">Linux</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="MMxpFwsgrw">
                    <label for="MMxpFwsgrw">Python</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="rKOcqytkBo">
                            <label for="rKOcqytkBo">Data Classes</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="ZZfdjrdzgx">
                            <label for="ZZfdjrdzgx">Libraries</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="MLVEyfXCQV">
                    <label for="MLVEyfXCQV">React</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="tOozdUqXDD">
                    <label for="tOozdUqXDD">Regular Expressions</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="ZezXxLafiq">
                    <label for="ZezXxLafiq">Rust</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="aBSUFwCHjY">
                            <label for="aBSUFwCHjY">Serde</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="byzDnMBTNk">
                    <label for="byzDnMBTNk">Vim</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="BdjlFBSptr">
                    <label for="BdjlFBSptr">Web</label>
                    <ul>
