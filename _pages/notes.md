...
<ul>
    <div name="contents-index">
        ...
        <l>
            <input type="checkbox" id="WZjZaFtVHb" checked>
            <label for="WZjZaFtVHb">Math</label>
            <ul>
                <l>
                    <input type="checkbox" id="hxhDcZpVdj">
                    <label for="hxhDcZpVdj">Exponentials</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="FRXNMdXbiK">
                    <label for="FRXNMdXbiK">Linear Algebra</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="PEaRaPmpDZ">
                    <label for="PEaRaPmpDZ">Logarithms</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="UIpzsebcLK">
                    <label for="UIpzsebcLK">Sequences</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="VGfZpBMYQI">
                    <label for="VGfZpBMYQI">Single Variable Calculus</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="hFIVrdktEd">
                    <label for="hFIVrdktEd">Trigonometry</label>
                    <ul>
        ...
        <l>
            <input type="checkbox" id="gfqnTzeBMv" checked>
            <label for="gfqnTzeBMv">Programming</label>
            <ul>
                <l>
                    <input type="checkbox" id="CLmeMmwPyd">
                    <label for="CLmeMmwPyd">Ansible</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="XxvghVJeJV">
                    <label for="XxvghVJeJV">Architecture</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="ecPcIuNYgt">
                    <label for="ecPcIuNYgt">Computer Graphics</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="XkOSnolgnN">
                    <label for="XkOSnolgnN">Databases</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="beyZeQyRMv">
                    <label for="beyZeQyRMv">Devops</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="haHsaAJLRz">
                            <label for="haHsaAJLRz">Cloud Computing</label>
                            <ul>
                                <l>
                                    <input type="checkbox" id="qGHUjdowTB">
                                    <label for="qGHUjdowTB">AWS</label>
                                    <ul>
                                        <l>
                                            <input type="checkbox" id="BtBbhEsQvm">
                                            <label for="BtBbhEsQvm">Cli</label>
                                            <ul>
                                        ...
                                        <l>
                                            <input type="checkbox" id="WxoPXBUtmn">
                                            <label for="WxoPXBUtmn">Dotnet</label>
                                            <ul>
                                        ...
                                        <l>
                                            <input type="checkbox" id="zFpLsdavmp">
                                            <label for="zFpLsdavmp">Ec 2</label>
                                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="uMFKeFRFoK">
                            <label for="uMFKeFRFoK">Events</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="IlEGAdyeHy">
                            <label for="IlEGAdyeHy">Oauth</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="ltjHBsnEMK">
                            <label for="ltjHBsnEMK">Pulumi</label>
                            <ul>
                                <l>
                                    <input type="checkbox" id="ARzgPHnWWP">
                                    <label for="ARzgPHnWWP">Dotnet</label>
                                    <ul>
                        ...
                        <l>
                            <input type="checkbox" id="QvGzCdedWY">
                            <label for="QvGzCdedWY">Terraform</label>
                            <ul>
                                <l>
                                    <input type="checkbox" id="qBxvUcYbyu">
                                    <label for="qBxvUcYbyu">Functions</label>
                                    <ul>
                                ...
                                <l>
                                    <input type="checkbox" id="PqAVzJFXVm">
                                    <label for="PqAVzJFXVm">Meta Arguments</label>
                                    <ul>
                ...
                <l>
                    <input type="checkbox" id="tnVrAJtKlb">
                    <label for="tnVrAJtKlb">Docker</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="ZqCiUgrCSJ">
                    <label for="ZqCiUgrCSJ">Dotnet</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="OTKPaYJWal">
                            <label for="OTKPaYJWal">Cli</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="hyjYLWuYJr">
                    <label for="hyjYLWuYJr">Functional Programming</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="GHJrRWVgmr">
                    <label for="GHJrRWVgmr">Git</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="CstcDZFCSC">
                            <label for="CstcDZFCSC">Github</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="RLotaDjCPq">
                    <label for="RLotaDjCPq">Go</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="NNCxPmFcuc">
                    <label for="NNCxPmFcuc">Haskell</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="LuZyaFGOsJ">
                    <label for="LuZyaFGOsJ">Js</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="eRlAZuxHmt">
                            <label for="eRlAZuxHmt">Node</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="wpMvCKdLXy">
                            <label for="wpMvCKdLXy">Mocha</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="rzsTetLyql">
                            <label for="rzsTetLyql">P5js</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="NhXWKwMtTL">
                            <label for="NhXWKwMtTL">Typescript</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="DsoIUheQmp">
                    <label for="DsoIUheQmp">Kafka</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="sFRDwynXxc">
                    <label for="sFRDwynXxc">Kubernetes</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="umtbCkpDme">
                    <label for="umtbCkpDme">Language</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="AIPBcRJMnX">
                    <label for="AIPBcRJMnX">Linux</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="CURCHUPdHb">
                    <label for="CURCHUPdHb">Python</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="iVJrekDEgF">
                            <label for="iVJrekDEgF">Data Classes</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="LkgzZJvgmb">
                            <label for="LkgzZJvgmb">Libraries</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="bAWYSWPFBl">
                    <label for="bAWYSWPFBl">React</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="whzdEmFHHb">
                    <label for="whzdEmFHHb">Regular Expressions</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="YCWwTJWanp">
                    <label for="YCWwTJWanp">Rust</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="kwNMUciuoG">
                            <label for="kwNMUciuoG">Serde</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="zmEjFoCzMj">
                    <label for="zmEjFoCzMj">Vim</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="PuZfWjafOo">
                    <label for="PuZfWjafOo">Web</label>
                    <ul>
