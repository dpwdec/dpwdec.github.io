...
<ul>
    <div name="contents-index">
        ...
        <l>
            <input type="checkbox" id="tsOmDsdPve" checked>
            <label for="tsOmDsdPve">Math</label>
            <ul>
                <l>
                    <input type="checkbox" id="idYUxkdVwM">
                    <label for="idYUxkdVwM">Exponentials</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="WxXlgtyQly">
                    <label for="WxXlgtyQly">Linear Algebra</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="vYCOAKOijI">
                    <label for="vYCOAKOijI">Logarithms</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="kVHiIyqVzN">
                    <label for="kVHiIyqVzN">Sequences</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="McAMhYIZXH">
                    <label for="McAMhYIZXH">Single Variable Calculus</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="dUlPvrwdzB">
                    <label for="dUlPvrwdzB">Trigonometry</label>
                    <ul>
        ...
        <l>
            <input type="checkbox" id="bboVDavJZb" checked>
            <label for="bboVDavJZb">Programming</label>
            <ul>
                <l>
                    <input type="checkbox" id="MivCyaVCXp">
                    <label for="MivCyaVCXp">Ansible</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="dXWbiSRNQn">
                    <label for="dXWbiSRNQn">Architecture</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="ikaFzekaae">
                    <label for="ikaFzekaae">Computer Graphics</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="wNNnkLvPmP">
                    <label for="wNNnkLvPmP">Databases</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="qcAxzbUGmT">
                    <label for="qcAxzbUGmT">Devops</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="eylactfDyx">
                            <label for="eylactfDyx">Cloud Providers</label>
                            <ul>
                                <l>
                                    <input type="checkbox" id="BdbonhJDKD">
                                    <label for="BdbonhJDKD">AWS</label>
                                    <ul>
                                        <l>
                                            <input type="checkbox" id="STfyqOSNVY">
                                            <label for="STfyqOSNVY">Cli</label>
                                            <ul>
                                        ...
                                        <l>
                                            <input type="checkbox" id="hcHHAuicut">
                                            <label for="hcHHAuicut">Dotnet</label>
                                            <ul>
                                        ...
                                        <l>
                                            <input type="checkbox" id="GwwyssqbND">
                                            <label for="GwwyssqbND">Ec 2</label>
                                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="MxfuPyWIrd">
                            <label for="MxfuPyWIrd">Events</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="XFRgSxpDRK">
                            <label for="XFRgSxpDRK">Localstack</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="PlPvlqTSpx">
                            <label for="PlPvlqTSpx">Pulumi</label>
                            <ul>
                                <l>
                                    <input type="checkbox" id="asfLpbGKUq">
                                    <label for="asfLpbGKUq">Dotnet</label>
                                    <ul>
                        ...
                        <l>
                            <input type="checkbox" id="DQZrpHZKcX">
                            <label for="DQZrpHZKcX">Serverless Framework</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="zMpOapSQVH">
                            <label for="zMpOapSQVH">Terraform</label>
                            <ul>
                                <l>
                                    <input type="checkbox" id="YylccCEmXn">
                                    <label for="YylccCEmXn">Functions</label>
                                    <ul>
                                ...
                                <l>
                                    <input type="checkbox" id="AVXdffBLgZ">
                                    <label for="AVXdffBLgZ">Meta Arguments</label>
                                    <ul>
                ...
                <l>
                    <input type="checkbox" id="dpyLCTbHTZ">
                    <label for="dpyLCTbHTZ">Docker</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="zkgkNrsMQs">
                    <label for="zkgkNrsMQs">Dotnet</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="nxLKXnRVjc">
                            <label for="nxLKXnRVjc">Cli</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="ChZntWEKaE">
                    <label for="ChZntWEKaE">Functional Programming</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="AbFGVUJCms">
                    <label for="AbFGVUJCms">Git</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="GpPVlYJEzC">
                            <label for="GpPVlYJEzC">Github</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="lHBWDcUxGT">
                    <label for="lHBWDcUxGT">Go</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="iUsGDyxzpq">
                    <label for="iUsGDyxzpq">Haskell</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="tmyCWjqVGe">
                    <label for="tmyCWjqVGe">Js</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="hcarXbjDRM">
                            <label for="hcarXbjDRM">Node</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="lKrimBhOFy">
                            <label for="lKrimBhOFy">D3</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="SpYGqnnVFb">
                            <label for="SpYGqnnVFb">Mocha</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="OmNFIDResL">
                            <label for="OmNFIDResL">P5js</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="glMjHEVOwb">
                            <label for="glMjHEVOwb">Typescript</label>
                            <ul>
                                <l>
                                    <input type="checkbox" id="oYxUrciguV">
                                    <label for="oYxUrciguV">Testing</label>
                                    <ul>
                ...
                <l>
                    <input type="checkbox" id="VqRZVdIBIk">
                    <label for="VqRZVdIBIk">Kafka</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="QmXcDsEDzR">
                    <label for="QmXcDsEDzR">Kubernetes</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="eiLurmEDNN">
                    <label for="eiLurmEDNN">Language</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="KhGJLvObkP">
                    <label for="KhGJLvObkP">Linux</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="IGCDJnfVjK">
                            <label for="IGCDJnfVjK">Bash</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="mMoPsWUPXd">
                    <label for="mMoPsWUPXd">Oauth</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="TYKaaTxzqF">
                    <label for="TYKaaTxzqF">Prometheus</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="tYSitKdTlQ">
                    <label for="tYSitKdTlQ">Python</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="yARIifhOfX">
                            <label for="yARIifhOfX">Data Classes</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="wWQjSInfIu">
                            <label for="wWQjSInfIu">Libraries</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="kNSOeAhXPR">
                    <label for="kNSOeAhXPR">React</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="mnPVjQFVsH">
                    <label for="mnPVjQFVsH">Regular Expressions</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="AqAhEjPXuq">
                    <label for="AqAhEjPXuq">Rust</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="fQIHNYStiT">
                            <label for="fQIHNYStiT">Serde</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="LEEVZxCiGX">
                    <label for="LEEVZxCiGX">Shaders</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="BshmPvrbuQ">
                            <label for="BshmPvrbuQ">Glsl</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="btQNRMrKqS">
                    <label for="btQNRMrKqS">Vim</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="QCGZmpqkEQ">
                    <label for="QCGZmpqkEQ">Web</label>
                    <ul>
