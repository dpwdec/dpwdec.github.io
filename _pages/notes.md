...
<ul>
    <div name="contents-index">
        ...
        <l>
            <input type="checkbox" id="fFdWguPyRm" checked>
            <label for="fFdWguPyRm">Math</label>
            <ul>
                <l>
                    <input type="checkbox" id="PRPJUPHWAC">
                    <label for="PRPJUPHWAC">Exponentials</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="cymzeGhtbp">
                    <label for="cymzeGhtbp">Linear Algebra</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="URmxYkrkjN">
                    <label for="URmxYkrkjN">Logarithms</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="fUIpzIiiCW">
                    <label for="fUIpzIiiCW">Sequences</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="egDiafumTS">
                    <label for="egDiafumTS">Single Variable Calculus</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="bdzkLUooKC">
                    <label for="bdzkLUooKC">Trigonometry</label>
                    <ul>
        ...
        <l>
            <input type="checkbox" id="qRGDqdKpnz" checked>
            <label for="qRGDqdKpnz">Programming</label>
            <ul>
                <l>
                    <input type="checkbox" id="FeTVLFEukn">
                    <label for="FeTVLFEukn">Ansible</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="ncemtQPjNS">
                    <label for="ncemtQPjNS">Architecture</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="EkdaGVTLfG">
                    <label for="EkdaGVTLfG">Computer Graphics</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="HcXaNYnNgr">
                    <label for="HcXaNYnNgr">Databases</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="gmggpFmyuM">
                    <label for="gmggpFmyuM">Devops</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="itXOboGihE">
                            <label for="itXOboGihE">Cloud Computing</label>
                            <ul>
                                <l>
                                    <input type="checkbox" id="bXHsgbNurt">
                                    <label for="bXHsgbNurt">AWS</label>
                                    <ul>
                                        <l>
                                            <input type="checkbox" id="RwkKDAOlUi">
                                            <label for="RwkKDAOlUi">Ec 2</label>
                                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="tcsFQGjjXv">
                            <label for="tcsFQGjjXv">Events</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="mqjAGdeRly">
                            <label for="mqjAGdeRly">Oauth</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="sGiCKXjTGP">
                            <label for="sGiCKXjTGP">Pulumi</label>
                            <ul>
                                <l>
                                    <input type="checkbox" id="xCKRuANXMm">
                                    <label for="xCKRuANXMm">Dotnet</label>
                                    <ul>
                        ...
                        <l>
                            <input type="checkbox" id="KGgtqvJJLz">
                            <label for="KGgtqvJJLz">Terraform</label>
                            <ul>
                                <l>
                                    <input type="checkbox" id="HJMsQezVml">
                                    <label for="HJMsQezVml">Functions</label>
                                    <ul>
                                ...
                                <l>
                                    <input type="checkbox" id="NtzRaIDGDQ">
                                    <label for="NtzRaIDGDQ">Meta Arguments</label>
                                    <ul>
                ...
                <l>
                    <input type="checkbox" id="yGtjJtLkuY">
                    <label for="yGtjJtLkuY">Docker</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="tupSFiVGja">
                    <label for="tupSFiVGja">Dotnet</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="yGCuDpAxix">
                            <label for="yGCuDpAxix">Cli</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="SsarUrPoeI">
                    <label for="SsarUrPoeI">Functional Programming</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="HdluijnxBU">
                    <label for="HdluijnxBU">Git</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="eBkqmbcjvy">
                            <label for="eBkqmbcjvy">Github</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="goqxljsrZg">
                    <label for="goqxljsrZg">Go</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="oWvTOdIoIN">
                    <label for="oWvTOdIoIN">Haskell</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="PChSoWSeOU">
                    <label for="PChSoWSeOU">Js</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="zqHdqqWLcy">
                            <label for="zqHdqqWLcy">Node</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="RzsNYYVgoc">
                            <label for="RzsNYYVgoc">Mocha</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="DETDXJFueW">
                            <label for="DETDXJFueW">P5js</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="UcNEoKzHwo">
                            <label for="UcNEoKzHwo">Typescript</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="ZMfHoFWsnY">
                    <label for="ZMfHoFWsnY">Kafka</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="iBkYPKrAbe">
                    <label for="iBkYPKrAbe">Kubernetes</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="SRWEDnUldS">
                    <label for="SRWEDnUldS">Language</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="XeetDiXBFt">
                    <label for="XeetDiXBFt">Linux</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="YukMKVQAVO">
                    <label for="YukMKVQAVO">Python</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="vtXWrQhOQy">
                            <label for="vtXWrQhOQy">Data Classes</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="vkxSKTycGq">
                            <label for="vkxSKTycGq">Libraries</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="nfgKlSWBpX">
                    <label for="nfgKlSWBpX">React</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="sZAUALuGcr">
                    <label for="sZAUALuGcr">Regular Expressions</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="xkEyowSVBO">
                    <label for="xkEyowSVBO">Rust</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="CXXKRLeOWz">
                            <label for="CXXKRLeOWz">Serde</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="ysAZTIetwi">
                    <label for="ysAZTIetwi">Vim</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="WZQZwELzoq">
                    <label for="WZQZwELzoq">Web</label>
                    <ul>
