...
<ul>
    <div name="contents-index">
        ...
        <l>
            <input type="checkbox" id="wNbUQNBiHf" checked>
            <label for="wNbUQNBiHf">Math</label>
            <ul>
                <l>
                    <input type="checkbox" id="TLVcbYAcBa">
                    <label for="TLVcbYAcBa">Exponentials</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="etDNohxxpP">
                    <label for="etDNohxxpP">Linear Algebra</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="mGErfYGJEo">
                    <label for="mGErfYGJEo">Logarithms</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="ROYBTzeiBv">
                    <label for="ROYBTzeiBv">Sequences</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="YdKHUMyeQj">
                    <label for="YdKHUMyeQj">Single Variable Calculus</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="vAOjKoyZAa">
                    <label for="vAOjKoyZAa">Trigonometry</label>
                    <ul>
        ...
        <l>
            <input type="checkbox" id="LYfpDAwYFE" checked>
            <label for="LYfpDAwYFE">Programming</label>
            <ul>
                <l>
                    <input type="checkbox" id="ZPmVphrRLs">
                    <label for="ZPmVphrRLs">Ansible</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="SNAyinFMUZ">
                    <label for="SNAyinFMUZ">Architecture</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="OAcHlJMqqS">
                    <label for="OAcHlJMqqS">Computer Graphics</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="uZREUnaQLg">
                    <label for="uZREUnaQLg">Databases</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="UpdEZQkEsa">
                    <label for="UpdEZQkEsa">Devops</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="ysyAoNWEjG">
                            <label for="ysyAoNWEjG">Cloud Providers</label>
                            <ul>
                                <l>
                                    <input type="checkbox" id="IBWPFRpCtY">
                                    <label for="IBWPFRpCtY">AWS</label>
                                    <ul>
                                        <l>
                                            <input type="checkbox" id="mMRGvxAEPj">
                                            <label for="mMRGvxAEPj">Cli</label>
                                            <ul>
                                        ...
                                        <l>
                                            <input type="checkbox" id="fFxfPcFUsI">
                                            <label for="fFxfPcFUsI">Dotnet</label>
                                            <ul>
                                        ...
                                        <l>
                                            <input type="checkbox" id="aIlyyzbgDU">
                                            <label for="aIlyyzbgDU">Ec 2</label>
                                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="IaigJuwYxH">
                            <label for="IaigJuwYxH">Events</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="mNrkjoJUBo">
                            <label for="mNrkjoJUBo">Localstack</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="LmmMgXZuXT">
                            <label for="LmmMgXZuXT">Pulumi</label>
                            <ul>
                                <l>
                                    <input type="checkbox" id="xPvbEdOoAZ">
                                    <label for="xPvbEdOoAZ">Dotnet</label>
                                    <ul>
                        ...
                        <l>
                            <input type="checkbox" id="mKFlZadQuv">
                            <label for="mKFlZadQuv">Serverless Framework</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="wkEHDiXjBV">
                            <label for="wkEHDiXjBV">Terraform</label>
                            <ul>
                                <l>
                                    <input type="checkbox" id="RhFXRjyBIp">
                                    <label for="RhFXRjyBIp">Functions</label>
                                    <ul>
                                ...
                                <l>
                                    <input type="checkbox" id="ILZpRBqTJV">
                                    <label for="ILZpRBqTJV">Meta Arguments</label>
                                    <ul>
                ...
                <l>
                    <input type="checkbox" id="wDbxXjeKAV">
                    <label for="wDbxXjeKAV">Docker</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="cCpKUWZCWz">
                    <label for="cCpKUWZCWz">Dotnet</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="oZySnHELOr">
                            <label for="oZySnHELOr">Cli</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="DpuPfuQSjC">
                    <label for="DpuPfuQSjC">Functional Programming</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="eOWkFXZXkG">
                    <label for="eOWkFXZXkG">Git</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="mWjvXPYwXS">
                            <label for="mWjvXPYwXS">Github</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="vPldQxFNdB">
                    <label for="vPldQxFNdB">Go</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="rqNrbfcyyD">
                    <label for="rqNrbfcyyD">Haskell</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="hImmxmduDy">
                    <label for="hImmxmduDy">Js</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="TWXaEfhlkU">
                            <label for="TWXaEfhlkU">Node</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="EaWMfWgEgO">
                            <label for="EaWMfWgEgO">D3</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="NiLxlxEGbX">
                            <label for="NiLxlxEGbX">Mocha</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="WrkEoeKPve">
                            <label for="WrkEoeKPve">P5js</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="kHetChLnWJ">
                            <label for="kHetChLnWJ">Typescript</label>
                            <ul>
                                <l>
                                    <input type="checkbox" id="UrIgcZmMzB">
                                    <label for="UrIgcZmMzB">Testing</label>
                                    <ul>
                ...
                <l>
                    <input type="checkbox" id="jbnnULpETS">
                    <label for="jbnnULpETS">Kafka</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="zXQzBHnAYm">
                    <label for="zXQzBHnAYm">Kubernetes</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="JmWYfdemdX">
                    <label for="JmWYfdemdX">Language</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="WleRvSdRHF">
                    <label for="WleRvSdRHF">Linux</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="FfSROJHMEw">
                            <label for="FfSROJHMEw">Bash</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="nsHYlXvRQc">
                    <label for="nsHYlXvRQc">Oauth</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="LZAPeOtULl">
                    <label for="LZAPeOtULl">Python</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="xXUqhpcYxp">
                            <label for="xXUqhpcYxp">Data Classes</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="mNavuoNlCv">
                            <label for="mNavuoNlCv">Libraries</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="TAFkCCLHvR">
                    <label for="TAFkCCLHvR">React</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="SabBJBKkiN">
                    <label for="SabBJBKkiN">Regular Expressions</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="VVSuSlOXSo">
                    <label for="VVSuSlOXSo">Rust</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="rNHEYBvGYm">
                            <label for="rNHEYBvGYm">Serde</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="YAYlSsPIxg">
                    <label for="YAYlSsPIxg">Shaders</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="DErAnOazDh">
                            <label for="DErAnOazDh">Glsl</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="KgQbuKyqcm">
                    <label for="KgQbuKyqcm">Vim</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="ZUdeYBOBrO">
                    <label for="ZUdeYBOBrO">Web</label>
                    <ul>
