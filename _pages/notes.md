...
<ul>
    <div name="contents-index">
        ...
        <l>
            <input type="checkbox" id="uUxWzdtXtk" checked>
            <label for="uUxWzdtXtk">Math</label>
            <ul>
                <l>
                    <input type="checkbox" id="ECSKsSpMDc">
                    <label for="ECSKsSpMDc">Exponentials</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="DENgGmfdxq">
                    <label for="DENgGmfdxq">Linear Algebra</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="PmxrTKUkGb">
                    <label for="PmxrTKUkGb">Logarithms</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="WkdxcfLlbQ">
                    <label for="WkdxcfLlbQ">Sequences</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="ooZsTZbFZK">
                    <label for="ooZsTZbFZK">Single Variable Calculus</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="FEfqFZrxfs">
                    <label for="FEfqFZrxfs">Trigonometry</label>
                    <ul>
        ...
        <l>
            <input type="checkbox" id="foUmESJRdk" checked>
            <label for="foUmESJRdk">Programming</label>
            <ul>
                <l>
                    <input type="checkbox" id="GkwPmfHxiV">
                    <label for="GkwPmfHxiV">Ansible</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="EhnCPaIhfP">
                    <label for="EhnCPaIhfP">Architecture</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="GzmumxARbg">
                    <label for="GzmumxARbg">Computer Graphics</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="lDdWheTZEa">
                    <label for="lDdWheTZEa">Databases</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="caEHzTTuIq">
                    <label for="caEHzTTuIq">Devops</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="xVWlLswJYh">
                            <label for="xVWlLswJYh">Cloud Providers</label>
                            <ul>
                                <l>
                                    <input type="checkbox" id="ExmOLMhXYI">
                                    <label for="ExmOLMhXYI">AWS</label>
                                    <ul>
                                        <l>
                                            <input type="checkbox" id="VUawkJdKrg">
                                            <label for="VUawkJdKrg">Cli</label>
                                            <ul>
                                        ...
                                        <l>
                                            <input type="checkbox" id="ltRHXKjyZM">
                                            <label for="ltRHXKjyZM">Dotnet</label>
                                            <ul>
                                        ...
                                        <l>
                                            <input type="checkbox" id="VTkYviOslI">
                                            <label for="VTkYviOslI">Ec 2</label>
                                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="brhUUjfWLE">
                            <label for="brhUUjfWLE">Events</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="JYtALaCdws">
                            <label for="JYtALaCdws">Localstack</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="BoLflrCXta">
                            <label for="BoLflrCXta">Pulumi</label>
                            <ul>
                                <l>
                                    <input type="checkbox" id="TKgNCGYRdU">
                                    <label for="TKgNCGYRdU">Dotnet</label>
                                    <ul>
                        ...
                        <l>
                            <input type="checkbox" id="oJxxboSToJ">
                            <label for="oJxxboSToJ">Serverless Framework</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="DHcnVyiaKZ">
                            <label for="DHcnVyiaKZ">Terraform</label>
                            <ul>
                                <l>
                                    <input type="checkbox" id="oLEGAcNbFm">
                                    <label for="oLEGAcNbFm">Functions</label>
                                    <ul>
                                ...
                                <l>
                                    <input type="checkbox" id="ocUMVACcRB">
                                    <label for="ocUMVACcRB">Meta Arguments</label>
                                    <ul>
                ...
                <l>
                    <input type="checkbox" id="txNrXMIdLE">
                    <label for="txNrXMIdLE">Docker</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="bNoFPFKLCP">
                    <label for="bNoFPFKLCP">Dotnet</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="xoBUqAQSeZ">
                            <label for="xoBUqAQSeZ">Cli</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="VGTfUogCrP">
                    <label for="VGTfUogCrP">Functional Programming</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="YnkHROPznG">
                    <label for="YnkHROPznG">Git</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="xUaHyDijex">
                            <label for="xUaHyDijex">Github</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="HeWNCmAIIM">
                    <label for="HeWNCmAIIM">Go</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="LcPEiZyFtV">
                    <label for="LcPEiZyFtV">Haskell</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="aoeaGeKbnl">
                    <label for="aoeaGeKbnl">Js</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="fcQHDYvaLD">
                            <label for="fcQHDYvaLD">Node</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="fxDrVFavfc">
                            <label for="fxDrVFavfc">D3</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="OUmBPcwCFO">
                            <label for="OUmBPcwCFO">Mocha</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="dmnffbcTSH">
                            <label for="dmnffbcTSH">P5js</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="AdYZmqJRaY">
                            <label for="AdYZmqJRaY">Typescript</label>
                            <ul>
                                <l>
                                    <input type="checkbox" id="xpCgkSvJXK">
                                    <label for="xpCgkSvJXK">Testing</label>
                                    <ul>
                ...
                <l>
                    <input type="checkbox" id="sOjrUhYwAH">
                    <label for="sOjrUhYwAH">Kafka</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="HgBKKEbSoa">
                    <label for="HgBKKEbSoa">Kubernetes</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="bHapyTlURt">
                    <label for="bHapyTlURt">Language</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="wkhcLrUYwy">
                    <label for="wkhcLrUYwy">Linux</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="rFrkwQIYwZ">
                            <label for="rFrkwQIYwZ">Bash</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="aIhMCjzmqU">
                    <label for="aIhMCjzmqU">Oauth</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="cbtCgPwUWP">
                    <label for="cbtCgPwUWP">Python</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="vtHCLaAKge">
                            <label for="vtHCLaAKge">Data Classes</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="TgZRWkuYJv">
                            <label for="TgZRWkuYJv">Libraries</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="aJnyMDlkWf">
                    <label for="aJnyMDlkWf">React</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="bEJaIXeqRC">
                    <label for="bEJaIXeqRC">Regular Expressions</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="DNDKVQiFGj">
                    <label for="DNDKVQiFGj">Rust</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="qlJNuDMLof">
                            <label for="qlJNuDMLof">Serde</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="egGdejAsZA">
                    <label for="egGdejAsZA">Shaders</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="BHNJvBPZdN">
                            <label for="BHNJvBPZdN">Glsl</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="fJuNFUUWAg">
                    <label for="fJuNFUUWAg">Vim</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="eMFYKkyYBO">
                    <label for="eMFYKkyYBO">Web</label>
                    <ul>
