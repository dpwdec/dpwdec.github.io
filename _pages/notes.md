...
<ul>
    <div name="contents-index">
        ...
        <l>
            <input type="checkbox" id="KqOsxoxrAL" checked>
            <label for="KqOsxoxrAL">Math</label>
            <ul>
                <l>
                    <input type="checkbox" id="DTeiFGUtqg">
                    <label for="DTeiFGUtqg">Exponentials</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="oZzSGJuLNk">
                    <label for="oZzSGJuLNk">Linear Algebra</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="ReAIOKaofK">
                    <label for="ReAIOKaofK">Logarithms</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="TzQLREKMil">
                    <label for="TzQLREKMil">Sequences</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="WMYSMPLulH">
                    <label for="WMYSMPLulH">Single Variable Calculus</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="VqyKFehQWw">
                    <label for="VqyKFehQWw">Trigonometry</label>
                    <ul>
        ...
        <l>
            <input type="checkbox" id="cKzgiwyenq" checked>
            <label for="cKzgiwyenq">Programming</label>
            <ul>
                <l>
                    <input type="checkbox" id="ZqbKhUPnjl">
                    <label for="ZqbKhUPnjl">Ansible</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="nssuMoCuna">
                    <label for="nssuMoCuna">Architecture</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="hCzLdylgtH">
                    <label for="hCzLdylgtH">Computer Graphics</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="dvwzfsqQAJ">
                    <label for="dvwzfsqQAJ">Databases</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="ECssMXlazI">
                    <label for="ECssMXlazI">Devops</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="vQISgbZAMH">
                            <label for="vQISgbZAMH">Cloud Computing</label>
                            <ul>
                                <l>
                                    <input type="checkbox" id="USjalIqYlW">
                                    <label for="USjalIqYlW">AWS</label>
                                    <ul>
                                        <l>
                                            <input type="checkbox" id="lmrkaXiAWL">
                                            <label for="lmrkaXiAWL">Cli</label>
                                            <ul>
                                        ...
                                        <l>
                                            <input type="checkbox" id="YPCzWWvCFu">
                                            <label for="YPCzWWvCFu">Dotnet</label>
                                            <ul>
                                        ...
                                        <l>
                                            <input type="checkbox" id="rXMeKSDbBb">
                                            <label for="rXMeKSDbBb">Ec 2</label>
                                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="SJzCOdPmrU">
                            <label for="SJzCOdPmrU">Events</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="eyYpMjCslw">
                            <label for="eyYpMjCslw">Oauth</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="xgqafpuhEt">
                            <label for="xgqafpuhEt">Pulumi</label>
                            <ul>
                                <l>
                                    <input type="checkbox" id="vmEAfzgsYz">
                                    <label for="vmEAfzgsYz">Dotnet</label>
                                    <ul>
                        ...
                        <l>
                            <input type="checkbox" id="jzfVMrSmjt">
                            <label for="jzfVMrSmjt">Terraform</label>
                            <ul>
                                <l>
                                    <input type="checkbox" id="PiHadmsaRB">
                                    <label for="PiHadmsaRB">Functions</label>
                                    <ul>
                                ...
                                <l>
                                    <input type="checkbox" id="pZMZIglJvB">
                                    <label for="pZMZIglJvB">Meta Arguments</label>
                                    <ul>
                ...
                <l>
                    <input type="checkbox" id="wIDlxZeZRJ">
                    <label for="wIDlxZeZRJ">Docker</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="WblaULkmNC">
                    <label for="WblaULkmNC">Dotnet</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="zkVzAZuemH">
                            <label for="zkVzAZuemH">Cli</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="tXNtMhNXEw">
                    <label for="tXNtMhNXEw">Functional Programming</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="egBOcsutrt">
                    <label for="egBOcsutrt">Git</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="FHKsHnBWxE">
                            <label for="FHKsHnBWxE">Github</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="WmONgLFYgC">
                    <label for="WmONgLFYgC">Go</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="KOvTghTHCf">
                    <label for="KOvTghTHCf">Haskell</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="FpXTdtzjVk">
                    <label for="FpXTdtzjVk">Js</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="HhskMaIkTk">
                            <label for="HhskMaIkTk">Node</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="mKnsGsRJOW">
                            <label for="mKnsGsRJOW">Mocha</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="LZRLKFwwvv">
                            <label for="LZRLKFwwvv">P5js</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="IrYPHSZMUw">
                            <label for="IrYPHSZMUw">Typescript</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="vxAGlCnSdr">
                    <label for="vxAGlCnSdr">Kafka</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="qpmCNlcbPV">
                    <label for="qpmCNlcbPV">Kubernetes</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="gIMNvkaKTM">
                    <label for="gIMNvkaKTM">Language</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="GxJFlkRdvf">
                    <label for="GxJFlkRdvf">Linux</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="OAbpSmCsLI">
                    <label for="OAbpSmCsLI">Python</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="XCtXQloNNd">
                            <label for="XCtXQloNNd">Data Classes</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="RWyykClJiN">
                            <label for="RWyykClJiN">Libraries</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="DeFwKihzkh">
                    <label for="DeFwKihzkh">React</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="cQnByaYAvN">
                    <label for="cQnByaYAvN">Regular Expressions</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="FUaepvQrDR">
                    <label for="FUaepvQrDR">Rust</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="HodInTACac">
                            <label for="HodInTACac">Serde</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="QBCKSkRIPQ">
                    <label for="QBCKSkRIPQ">Vim</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="OGsIoDTUwj">
                    <label for="OGsIoDTUwj">Web</label>
                    <ul>
