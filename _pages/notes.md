...
<ul>
    <div name="contents-index">
        ...
        <l>
            <input type="checkbox" id="FQTLMCBPCX" checked>
            <label for="FQTLMCBPCX">Math</label>
            <ul>
                <l>
                    <input type="checkbox" id="onTHdwIDKU">
                    <label for="onTHdwIDKU">Exponentials</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="UHcuofggnb">
                    <label for="UHcuofggnb">Linear Algebra</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="hhhXJorNiK">
                    <label for="hhhXJorNiK">Logarithms</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="CzbmjCdsFs">
                    <label for="CzbmjCdsFs">Sequences</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="uCuWwPTrUK">
                    <label for="uCuWwPTrUK">Single Variable Calculus</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="ACOADUakLZ">
                    <label for="ACOADUakLZ">Trigonometry</label>
                    <ul>
        ...
        <l>
            <input type="checkbox" id="toPwtKJiYo" checked>
            <label for="toPwtKJiYo">Programming</label>
            <ul>
                <l>
                    <input type="checkbox" id="cWyKHCPcZr">
                    <label for="cWyKHCPcZr">Ansible</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="NvRhAAVJTb">
                    <label for="NvRhAAVJTb">Architecture</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="QMdJSIOjVZ">
                    <label for="QMdJSIOjVZ">Computer Graphics</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="ILHhNumkjT">
                    <label for="ILHhNumkjT">Databases</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="BWeHodUfvE">
                    <label for="BWeHodUfvE">Devops</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="mSwFyDVncG">
                            <label for="mSwFyDVncG">Cloud Providers</label>
                            <ul>
                                <l>
                                    <input type="checkbox" id="yGRMFkQebH">
                                    <label for="yGRMFkQebH">AWS</label>
                                    <ul>
                                        <l>
                                            <input type="checkbox" id="PymMnhmDAj">
                                            <label for="PymMnhmDAj">Cli</label>
                                            <ul>
                                        ...
                                        <l>
                                            <input type="checkbox" id="IZeyGijuDp">
                                            <label for="IZeyGijuDp">Dotnet</label>
                                            <ul>
                                        ...
                                        <l>
                                            <input type="checkbox" id="zNhmknAKat">
                                            <label for="zNhmknAKat">Ec 2</label>
                                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="lOMIoVBygV">
                            <label for="lOMIoVBygV">Events</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="jcIqdxPSWo">
                            <label for="jcIqdxPSWo">Localstack</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="AsFxgypoKy">
                            <label for="AsFxgypoKy">Pulumi</label>
                            <ul>
                                <l>
                                    <input type="checkbox" id="WEgeAKRuOp">
                                    <label for="WEgeAKRuOp">Dotnet</label>
                                    <ul>
                        ...
                        <l>
                            <input type="checkbox" id="qYPknjgNFJ">
                            <label for="qYPknjgNFJ">Serverless Framework</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="oSiAiPaJLh">
                            <label for="oSiAiPaJLh">Terraform</label>
                            <ul>
                                <l>
                                    <input type="checkbox" id="HsSmwAMRKJ">
                                    <label for="HsSmwAMRKJ">Functions</label>
                                    <ul>
                                ...
                                <l>
                                    <input type="checkbox" id="uGfDgUkEcT">
                                    <label for="uGfDgUkEcT">Meta Arguments</label>
                                    <ul>
                ...
                <l>
                    <input type="checkbox" id="nMQiIdVpxw">
                    <label for="nMQiIdVpxw">Docker</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="gHZYphhdVP">
                    <label for="gHZYphhdVP">Dotnet</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="JqwmlEYhXf">
                            <label for="JqwmlEYhXf">Cli</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="GkOvTbbbWr">
                    <label for="GkOvTbbbWr">Functional Programming</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="cfzhPdPtlT">
                    <label for="cfzhPdPtlT">Git</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="zDdwjnmIGd">
                            <label for="zDdwjnmIGd">Github</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="iiBdLQPySW">
                    <label for="iiBdLQPySW">Go</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="sRLBjYxUtL">
                    <label for="sRLBjYxUtL">Haskell</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="peOSqOutFm">
                    <label for="peOSqOutFm">Js</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="CjQWbKGYmE">
                            <label for="CjQWbKGYmE">Node</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="GtTbdcRdjY">
                            <label for="GtTbdcRdjY">D3</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="kWPtqfEONI">
                            <label for="kWPtqfEONI">Mocha</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="glpqUCrFhK">
                            <label for="glpqUCrFhK">P5js</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="LRbOmUzicM">
                            <label for="LRbOmUzicM">Typescript</label>
                            <ul>
                                <l>
                                    <input type="checkbox" id="kiPKbAJDXG">
                                    <label for="kiPKbAJDXG">Testing</label>
                                    <ul>
                ...
                <l>
                    <input type="checkbox" id="TNWwuOlxhr">
                    <label for="TNWwuOlxhr">Kafka</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="oTzxhWDgTN">
                    <label for="oTzxhWDgTN">Kubernetes</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="pBzFgYydHL">
                    <label for="pBzFgYydHL">Language</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="ZZRAWgpQqu">
                    <label for="ZZRAWgpQqu">Linux</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="hhvtPBvJvx">
                            <label for="hhvtPBvJvx">Bash</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="RGoBfxeuGr">
                    <label for="RGoBfxeuGr">Oauth</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="ymwwLdOCFn">
                    <label for="ymwwLdOCFn">Prometheus</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="RAIYUvtBAY">
                    <label for="RAIYUvtBAY">Python</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="bsqWOeKuot">
                            <label for="bsqWOeKuot">Data Classes</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="fPxKYeJKxd">
                            <label for="fPxKYeJKxd">Libraries</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="chNkGzYoQx">
                    <label for="chNkGzYoQx">React</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="DbpUalFwDY">
                    <label for="DbpUalFwDY">Regular Expressions</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="GPdfFSroYk">
                    <label for="GPdfFSroYk">Rust</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="ItwmYPYjfn">
                            <label for="ItwmYPYjfn">Serde</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="sItQWgZnYv">
                    <label for="sItQWgZnYv">Shaders</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="jltANvdTVm">
                            <label for="jltANvdTVm">Glsl</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="BpkHjtEQRn">
                    <label for="BpkHjtEQRn">Vim</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="vBPSygwzJF">
                    <label for="vBPSygwzJF">Web</label>
                    <ul>
