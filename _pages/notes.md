...
<ul>
    <div name="contents-index">
        ...
        <l>
            <input type="checkbox" id="wIHFdcroyJ" checked>
            <label for="wIHFdcroyJ">Math</label>
            <ul>
                <l>
                    <input type="checkbox" id="mAZFxcODrK">
                    <label for="mAZFxcODrK">Exponentials</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="iUdyNhmihW">
                    <label for="iUdyNhmihW">Linear Algebra</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="aGQegXwyZO">
                    <label for="aGQegXwyZO">Logarithms</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="MrMlwPGGGs">
                    <label for="MrMlwPGGGs">Sequences</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="aKPGJjAZRy">
                    <label for="aKPGJjAZRy">Single Variable Calculus</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="NePxgJIVjn">
                    <label for="NePxgJIVjn">Trigonometry</label>
                    <ul>
        ...
        <l>
            <input type="checkbox" id="bCkFAfyrQq" checked>
            <label for="bCkFAfyrQq">Programming</label>
            <ul>
                <l>
                    <input type="checkbox" id="XYUKbtiOpL">
                    <label for="XYUKbtiOpL">Ansible</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="TaLSDrKXDa">
                    <label for="TaLSDrKXDa">Architecture</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="qWtxHsMvcG">
                    <label for="qWtxHsMvcG">Computer Graphics</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="zcUlNYMkqw">
                    <label for="zcUlNYMkqw">Databases</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="fiiGAvUyIf">
                    <label for="fiiGAvUyIf">Devops</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="xvogVvvZwK">
                            <label for="xvogVvvZwK">Cloud Providers</label>
                            <ul>
                                <l>
                                    <input type="checkbox" id="HNvVLEecfu">
                                    <label for="HNvVLEecfu">AWS</label>
                                    <ul>
                                        <l>
                                            <input type="checkbox" id="mpgnPoOTen">
                                            <label for="mpgnPoOTen">Cli</label>
                                            <ul>
                                        ...
                                        <l>
                                            <input type="checkbox" id="wvAcoExfPX">
                                            <label for="wvAcoExfPX">Dotnet</label>
                                            <ul>
                                        ...
                                        <l>
                                            <input type="checkbox" id="hnNXgTycjq">
                                            <label for="hnNXgTycjq">Ec 2</label>
                                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="htAjNbyyzX">
                            <label for="htAjNbyyzX">Events</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="NnklSzosCs">
                            <label for="NnklSzosCs">Localstack</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="bAxgVkQkrU">
                            <label for="bAxgVkQkrU">Pulumi</label>
                            <ul>
                                <l>
                                    <input type="checkbox" id="QrLTSvhaho">
                                    <label for="QrLTSvhaho">Dotnet</label>
                                    <ul>
                        ...
                        <l>
                            <input type="checkbox" id="GVkLRTdyzk">
                            <label for="GVkLRTdyzk">Serverless Framework</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="KEvJEJjxjh">
                            <label for="KEvJEJjxjh">Terraform</label>
                            <ul>
                                <l>
                                    <input type="checkbox" id="DYjUvjFPoY">
                                    <label for="DYjUvjFPoY">Functions</label>
                                    <ul>
                                ...
                                <l>
                                    <input type="checkbox" id="OTiXhntdRJ">
                                    <label for="OTiXhntdRJ">Meta Arguments</label>
                                    <ul>
                ...
                <l>
                    <input type="checkbox" id="icYLnlzdNZ">
                    <label for="icYLnlzdNZ">Docker</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="eLgYobyNNV">
                    <label for="eLgYobyNNV">Dotnet</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="mQlGiXeglr">
                            <label for="mQlGiXeglr">Cli</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="aqxjKsodVh">
                    <label for="aqxjKsodVh">Functional Programming</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="YSXlVIFIpp">
                    <label for="YSXlVIFIpp">Git</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="IsyfHXeZpf">
                            <label for="IsyfHXeZpf">Github</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="QTIUMNWsxl">
                    <label for="QTIUMNWsxl">Go</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="VXECJeoMsy">
                    <label for="VXECJeoMsy">Haskell</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="IGdiYxtonU">
                    <label for="IGdiYxtonU">Js</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="XHpYxiUhfP">
                            <label for="XHpYxiUhfP">Node</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="GRtaHhkGyd">
                            <label for="GRtaHhkGyd">D3</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="YsIlGiWgHK">
                            <label for="YsIlGiWgHK">Mocha</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="FiyFFDAVOO">
                            <label for="FiyFFDAVOO">P5js</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="VJoGqFSgQu">
                            <label for="VJoGqFSgQu">Typescript</label>
                            <ul>
                                <l>
                                    <input type="checkbox" id="GMgsQctZAL">
                                    <label for="GMgsQctZAL">Testing</label>
                                    <ul>
                ...
                <l>
                    <input type="checkbox" id="SmEhUXOLvj">
                    <label for="SmEhUXOLvj">Kafka</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="aZnyPTbaqo">
                    <label for="aZnyPTbaqo">Kubernetes</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="cNQnxqiXGT">
                    <label for="cNQnxqiXGT">Language</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="bxxxChbIlL">
                    <label for="bxxxChbIlL">Linux</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="cVMqaZgqmT">
                            <label for="cVMqaZgqmT">Bash</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="YgBRNgxOpK">
                    <label for="YgBRNgxOpK">Oauth</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="WrSVnZmfej">
                    <label for="WrSVnZmfej">Prometheus</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="CYyiOKxfGx">
                    <label for="CYyiOKxfGx">Python</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="jsSKoGCOTA">
                            <label for="jsSKoGCOTA">Data Classes</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="BGlhxFTWvZ">
                            <label for="BGlhxFTWvZ">Libraries</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="PqaivbRZWp">
                    <label for="PqaivbRZWp">React</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="VmaBskDtwT">
                    <label for="VmaBskDtwT">Regular Expressions</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="aPJHCBUEeq">
                    <label for="aPJHCBUEeq">Rust</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="CVGOeYWJzN">
                            <label for="CVGOeYWJzN">Serde</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="xjzkukLDgP">
                    <label for="xjzkukLDgP">Shaders</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="QyduJfRgVF">
                            <label for="QyduJfRgVF">Glsl</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="SToSBCaHrD">
                    <label for="SToSBCaHrD">Vim</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="WgzPFZLiAm">
                    <label for="WgzPFZLiAm">Web</label>
                    <ul>
