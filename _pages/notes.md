...
<ul>
    <div name="contents-index">
        ...
        <l>
            <input type="checkbox" id="KzplketIxe" checked>
            <label for="KzplketIxe">Math</label>
            <ul>
                <l>
                    <input type="checkbox" id="RGxYpOwymw">
                    <label for="RGxYpOwymw">Exponentials</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="ofLMXAbWxa">
                    <label for="ofLMXAbWxa">Linear Algebra</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="boIbdGoulX">
                    <label for="boIbdGoulX">Logarithms</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="sXIjYnIePz">
                    <label for="sXIjYnIePz">Sequences</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="WSiSePyMyg">
                    <label for="WSiSePyMyg">Single Variable Calculus</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="TFgVoZLyEK">
                    <label for="TFgVoZLyEK">Trigonometry</label>
                    <ul>
        ...
        <l>
            <input type="checkbox" id="KzrXciWNuA" checked>
            <label for="KzrXciWNuA">Programming</label>
            <ul>
                <l>
                    <input type="checkbox" id="XgIRUhgFxj">
                    <label for="XgIRUhgFxj">Ansible</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="XLFynDYGJY">
                    <label for="XLFynDYGJY">Architecture</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="BVQjBmsqQf">
                    <label for="BVQjBmsqQf">Computer Graphics</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="HNUZvelnJl">
                    <label for="HNUZvelnJl">Databases</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="PFLTkXpFmQ">
                    <label for="PFLTkXpFmQ">Devops</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="zYCOHCHtqC">
                            <label for="zYCOHCHtqC">Cloud Providers</label>
                            <ul>
                                <l>
                                    <input type="checkbox" id="seblWrFmUI">
                                    <label for="seblWrFmUI">AWS</label>
                                    <ul>
                                        <l>
                                            <input type="checkbox" id="GIoNxPxrjx">
                                            <label for="GIoNxPxrjx">Cli</label>
                                            <ul>
                                        ...
                                        <l>
                                            <input type="checkbox" id="yPYxymHboE">
                                            <label for="yPYxymHboE">Dotnet</label>
                                            <ul>
                                        ...
                                        <l>
                                            <input type="checkbox" id="vNYRbcfjKa">
                                            <label for="vNYRbcfjKa">Ec 2</label>
                                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="KQbFUYgPmK">
                            <label for="KQbFUYgPmK">Events</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="vvIarCBEJF">
                            <label for="vvIarCBEJF">Localstack</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="NYBSHYqPFe">
                            <label for="NYBSHYqPFe">Pulumi</label>
                            <ul>
                                <l>
                                    <input type="checkbox" id="KzgPfzXKVo">
                                    <label for="KzgPfzXKVo">Dotnet</label>
                                    <ul>
                        ...
                        <l>
                            <input type="checkbox" id="LYXKuDFhuz">
                            <label for="LYXKuDFhuz">Serverless Framework</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="XUKZXAnbVe">
                            <label for="XUKZXAnbVe">Terraform</label>
                            <ul>
                                <l>
                                    <input type="checkbox" id="YsIyUVSBwC">
                                    <label for="YsIyUVSBwC">Functions</label>
                                    <ul>
                                ...
                                <l>
                                    <input type="checkbox" id="PvXrgcdpkh">
                                    <label for="PvXrgcdpkh">Meta Arguments</label>
                                    <ul>
                ...
                <l>
                    <input type="checkbox" id="zseTQMozDj">
                    <label for="zseTQMozDj">Docker</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="RwylSFVEQY">
                    <label for="RwylSFVEQY">Dotnet</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="XmHhmEBHIP">
                            <label for="XmHhmEBHIP">Cli</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="MYVXrcJZns">
                    <label for="MYVXrcJZns">Functional Programming</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="OSuSvqikDD">
                    <label for="OSuSvqikDD">Git</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="puPbkDvheN">
                            <label for="puPbkDvheN">Github</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="bbXQlgBygS">
                    <label for="bbXQlgBygS">Go</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="uhhaLowLxb">
                    <label for="uhhaLowLxb">Haskell</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="JpbUDzwwlj">
                    <label for="JpbUDzwwlj">Js</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="ypfOBctdKM">
                            <label for="ypfOBctdKM">Node</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="tGfJSbAQLO">
                            <label for="tGfJSbAQLO">D3</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="StgwqZnIht">
                            <label for="StgwqZnIht">Mocha</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="wMcDqzCTEU">
                            <label for="wMcDqzCTEU">P5js</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="NOrqEOENic">
                            <label for="NOrqEOENic">Typescript</label>
                            <ul>
                                <l>
                                    <input type="checkbox" id="udZRYwXXer">
                                    <label for="udZRYwXXer">Testing</label>
                                    <ul>
                ...
                <l>
                    <input type="checkbox" id="DIHWfANsNy">
                    <label for="DIHWfANsNy">Kafka</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="fLRkyzVEmH">
                    <label for="fLRkyzVEmH">Kubernetes</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="nZuNMsOGzF">
                    <label for="nZuNMsOGzF">Language</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="WNbVDFWjLr">
                    <label for="WNbVDFWjLr">Linux</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="RQtmWsgPnv">
                            <label for="RQtmWsgPnv">Bash</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="jsNYIqhAni">
                    <label for="jsNYIqhAni">Oauth</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="wMfotVXSJK">
                    <label for="wMfotVXSJK">Prometheus</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="uaEeTvtFrS">
                    <label for="uaEeTvtFrS">Python</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="wFryrrygWm">
                            <label for="wFryrrygWm">Data Classes</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="JyUtNTEysF">
                            <label for="JyUtNTEysF">Libraries</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="fdHcFvpxYX">
                    <label for="fdHcFvpxYX">React</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="sCbMpUQCng">
                    <label for="sCbMpUQCng">Regular Expressions</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="NUozSloqqf">
                    <label for="NUozSloqqf">Rust</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="EVwoKBQeRm">
                            <label for="EVwoKBQeRm">Serde</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="LrsmrmOusm">
                    <label for="LrsmrmOusm">Shaders</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="fDqAlcoReR">
                            <label for="fDqAlcoReR">Glsl</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="PTKNVSkdqH">
                    <label for="PTKNVSkdqH">Vim</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="sorZOuMpEp">
                    <label for="sorZOuMpEp">Web</label>
                    <ul>
