...
<ul>
    <div name="contents-index">
        ...
        <l>
            <input type="checkbox" id="XlBiiKxReF" checked>
            <label for="XlBiiKxReF">Math</label>
            <ul>
                <l>
                    <input type="checkbox" id="BrbkmmRxbd">
                    <label for="BrbkmmRxbd">Exponentials</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="WmrcYcHyFR">
                    <label for="WmrcYcHyFR">Linear Algebra</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="ZJaGslOXSH">
                    <label for="ZJaGslOXSH">Logarithms</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="NJmHRcmmxC">
                    <label for="NJmHRcmmxC">Sequences</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="PiYyiHQcLr">
                    <label for="PiYyiHQcLr">Single Variable Calculus</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="NUyCiTeZIj">
                    <label for="NUyCiTeZIj">Trigonometry</label>
                    <ul>
        ...
        <l>
            <input type="checkbox" id="lBMPVHULgh" checked>
            <label for="lBMPVHULgh">Programming</label>
            <ul>
                <l>
                    <input type="checkbox" id="nZQTgdwTZt">
                    <label for="nZQTgdwTZt">Ansible</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="KHTcdcMqIA">
                    <label for="KHTcdcMqIA">Architecture</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="dorAahNOwe">
                    <label for="dorAahNOwe">Computer Graphics</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="HKIFzaVQqg">
                    <label for="HKIFzaVQqg">Databases</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="rHyWInkNJv">
                    <label for="rHyWInkNJv">Devops</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="VOQFDdpZwk">
                            <label for="VOQFDdpZwk">Cloud Providers</label>
                            <ul>
                                <l>
                                    <input type="checkbox" id="GJGNTymzWf">
                                    <label for="GJGNTymzWf">AWS</label>
                                    <ul>
                                        <l>
                                            <input type="checkbox" id="ImGPTsgRqv">
                                            <label for="ImGPTsgRqv">Cli</label>
                                            <ul>
                                        ...
                                        <l>
                                            <input type="checkbox" id="wkVCrppeeX">
                                            <label for="wkVCrppeeX">Dotnet</label>
                                            <ul>
                                        ...
                                        <l>
                                            <input type="checkbox" id="SlMsNPrTOM">
                                            <label for="SlMsNPrTOM">Ec 2</label>
                                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="HLlgjpilsG">
                            <label for="HLlgjpilsG">Events</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="JhfVfSfVqd">
                            <label for="JhfVfSfVqd">Localstack</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="ABsZZUCzhy">
                            <label for="ABsZZUCzhy">Pulumi</label>
                            <ul>
                                <l>
                                    <input type="checkbox" id="xXnSMOBCPA">
                                    <label for="xXnSMOBCPA">Dotnet</label>
                                    <ul>
                        ...
                        <l>
                            <input type="checkbox" id="eKLjhUlmlx">
                            <label for="eKLjhUlmlx">Serverless Framework</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="RHKZBqDWER">
                            <label for="RHKZBqDWER">Terraform</label>
                            <ul>
                                <l>
                                    <input type="checkbox" id="yIXEwFGQBj">
                                    <label for="yIXEwFGQBj">Functions</label>
                                    <ul>
                                ...
                                <l>
                                    <input type="checkbox" id="CyZDhgqqEq">
                                    <label for="CyZDhgqqEq">Meta Arguments</label>
                                    <ul>
                ...
                <l>
                    <input type="checkbox" id="jPCalOReka">
                    <label for="jPCalOReka">Docker</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="CfdpswxnHP">
                    <label for="CfdpswxnHP">Dotnet</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="gBDgKsjSXH">
                            <label for="gBDgKsjSXH">Cli</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="ElbQfAKxZn">
                    <label for="ElbQfAKxZn">Functional Programming</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="wQAByVhRWk">
                    <label for="wQAByVhRWk">Git</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="LfDgUlOgpo">
                            <label for="LfDgUlOgpo">Github</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="ygrwYJpfGH">
                    <label for="ygrwYJpfGH">Go</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="vzJAIWSKGE">
                    <label for="vzJAIWSKGE">Haskell</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="iUUObWotdY">
                    <label for="iUUObWotdY">Js</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="OzWZMhTNuY">
                            <label for="OzWZMhTNuY">Node</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="ppVuKdzRLt">
                            <label for="ppVuKdzRLt">D3</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="ottbOfSywS">
                            <label for="ottbOfSywS">Mocha</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="nIFeVkDBZv">
                            <label for="nIFeVkDBZv">P5js</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="cypTKVLFRf">
                            <label for="cypTKVLFRf">Typescript</label>
                            <ul>
                                <l>
                                    <input type="checkbox" id="CmKHZndxVB">
                                    <label for="CmKHZndxVB">Testing</label>
                                    <ul>
                ...
                <l>
                    <input type="checkbox" id="YPLVsXcnvp">
                    <label for="YPLVsXcnvp">Kafka</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="lKjDMsrVlv">
                    <label for="lKjDMsrVlv">Kubernetes</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="VUHIPLUilK">
                    <label for="VUHIPLUilK">Language</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="NVxXjyYILK">
                    <label for="NVxXjyYILK">Linux</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="SlqhqDgivg">
                            <label for="SlqhqDgivg">Bash</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="OTerjRDjzS">
                    <label for="OTerjRDjzS">Oauth</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="faOwVnOgCh">
                    <label for="faOwVnOgCh">Python</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="RxiuaLmAun">
                            <label for="RxiuaLmAun">Data Classes</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="ptttMwbGvj">
                            <label for="ptttMwbGvj">Libraries</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="LKRkufdBsG">
                    <label for="LKRkufdBsG">React</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="cwdUvkDHDj">
                    <label for="cwdUvkDHDj">Regular Expressions</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="JZZhMauzOp">
                    <label for="JZZhMauzOp">Rust</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="IdcmsjJMec">
                            <label for="IdcmsjJMec">Serde</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="OZDqvGuuWz">
                    <label for="OZDqvGuuWz">Vim</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="nTZIzQPjJq">
                    <label for="nTZIzQPjJq">Web</label>
                    <ul>
