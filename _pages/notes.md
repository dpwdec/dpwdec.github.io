...
<ul>
    <div name="contents-index">
        ...
        <l>
            <input type="checkbox" id="rNwmnbLSbF" checked>
            <label for="rNwmnbLSbF">Math</label>
            <ul>
                <l>
                    <input type="checkbox" id="tqABhLCLtR">
                    <label for="tqABhLCLtR">Exponentials</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="dmMhFjGvsW">
                    <label for="dmMhFjGvsW">Linear Algebra</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="PjLmSwVczQ">
                    <label for="PjLmSwVczQ">Logarithms</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="AQyzVZjeHV">
                    <label for="AQyzVZjeHV">Sequences</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="vMBSxDeAxf">
                    <label for="vMBSxDeAxf">Single Variable Calculus</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="FNKYmOErKS">
                    <label for="FNKYmOErKS">Trigonometry</label>
                    <ul>
        ...
        <l>
            <input type="checkbox" id="gpVyuhREgk" checked>
            <label for="gpVyuhREgk">Programming</label>
            <ul>
                <l>
                    <input type="checkbox" id="jXybwrUtiZ">
                    <label for="jXybwrUtiZ">Ansible</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="iEkmhjYodk">
                    <label for="iEkmhjYodk">Architecture</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="NzDqZwzMPQ">
                    <label for="NzDqZwzMPQ">Computer Graphics</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="NUSmONCKXr">
                    <label for="NUSmONCKXr">Databases</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="gPwMXSPYdt">
                    <label for="gPwMXSPYdt">Devops</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="uCotOfUEHv">
                            <label for="uCotOfUEHv">Cloud Providers</label>
                            <ul>
                                <l>
                                    <input type="checkbox" id="vhzRdRTcEW">
                                    <label for="vhzRdRTcEW">AWS</label>
                                    <ul>
                                        <l>
                                            <input type="checkbox" id="jtmwglpcpM">
                                            <label for="jtmwglpcpM">Cli</label>
                                            <ul>
                                        ...
                                        <l>
                                            <input type="checkbox" id="mHTaieXTTv">
                                            <label for="mHTaieXTTv">Dotnet</label>
                                            <ul>
                                        ...
                                        <l>
                                            <input type="checkbox" id="qrqUTUyUZe">
                                            <label for="qrqUTUyUZe">Ec 2</label>
                                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="xyfftMgPXs">
                            <label for="xyfftMgPXs">Events</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="UqCBNrmymf">
                            <label for="UqCBNrmymf">Localstack</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="HxfLjyCtSu">
                            <label for="HxfLjyCtSu">Pulumi</label>
                            <ul>
                                <l>
                                    <input type="checkbox" id="CIgjZiegXM">
                                    <label for="CIgjZiegXM">Dotnet</label>
                                    <ul>
                        ...
                        <l>
                            <input type="checkbox" id="owaDkwFudt">
                            <label for="owaDkwFudt">Serverless Framework</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="ABVDuRYJLT">
                            <label for="ABVDuRYJLT">Terraform</label>
                            <ul>
                                <l>
                                    <input type="checkbox" id="RvDViopTFY">
                                    <label for="RvDViopTFY">Functions</label>
                                    <ul>
                                ...
                                <l>
                                    <input type="checkbox" id="DdQFpdPwsL">
                                    <label for="DdQFpdPwsL">Meta Arguments</label>
                                    <ul>
                ...
                <l>
                    <input type="checkbox" id="IOzhUdjNCc">
                    <label for="IOzhUdjNCc">Docker</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="FdeLluqzLa">
                    <label for="FdeLluqzLa">Dotnet</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="NFVMJwzOnj">
                            <label for="NFVMJwzOnj">Cli</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="WzhPnGbIVY">
                    <label for="WzhPnGbIVY">Functional Programming</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="BGyHRyFXSz">
                    <label for="BGyHRyFXSz">Git</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="mGqfVoDBUI">
                            <label for="mGqfVoDBUI">Github</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="BdQTZaOBWH">
                    <label for="BdQTZaOBWH">Go</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="HKqCRkSGip">
                    <label for="HKqCRkSGip">Haskell</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="qKijZzcldB">
                    <label for="qKijZzcldB">Js</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="CBBTroeOFm">
                            <label for="CBBTroeOFm">Node</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="OvrossyMVp">
                            <label for="OvrossyMVp">D3</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="ZcxDPpLVzE">
                            <label for="ZcxDPpLVzE">Mocha</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="DsDCaDDOpJ">
                            <label for="DsDCaDDOpJ">P5js</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="UDBciKFBNn">
                            <label for="UDBciKFBNn">Typescript</label>
                            <ul>
                                <l>
                                    <input type="checkbox" id="NUCHKHtGaK">
                                    <label for="NUCHKHtGaK">Testing</label>
                                    <ul>
                ...
                <l>
                    <input type="checkbox" id="YbHkXzwIko">
                    <label for="YbHkXzwIko">Kafka</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="khZSlIDDVI">
                    <label for="khZSlIDDVI">Kubernetes</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="ZWkUqGCDPY">
                    <label for="ZWkUqGCDPY">Language</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="EjJqxBmasJ">
                    <label for="EjJqxBmasJ">Linux</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="ycoAvVadmq">
                            <label for="ycoAvVadmq">Bash</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="qWUskxZFeC">
                    <label for="qWUskxZFeC">Oauth</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="nkyXGvuSkv">
                    <label for="nkyXGvuSkv">Python</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="yLgiIrJdQH">
                            <label for="yLgiIrJdQH">Data Classes</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="PgMdkXtHGW">
                            <label for="PgMdkXtHGW">Libraries</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="lXAmppQSls">
                    <label for="lXAmppQSls">React</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="tLDbDOKzCz">
                    <label for="tLDbDOKzCz">Regular Expressions</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="uoKTYHnSUp">
                    <label for="uoKTYHnSUp">Rust</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="VFnySdyADJ">
                            <label for="VFnySdyADJ">Serde</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="isbUqcgLXk">
                    <label for="isbUqcgLXk">Vim</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="SmJRzAsvNy">
                    <label for="SmJRzAsvNy">Web</label>
                    <ul>
