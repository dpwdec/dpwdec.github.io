...
<ul>
    <div name="contents-index">
        ...
        <l>
            <input type="checkbox" id="hLHTTQwsDy" checked>
            <label for="hLHTTQwsDy">Math</label>
            <ul>
                <l>
                    <input type="checkbox" id="cEbKldxnRs">
                    <label for="cEbKldxnRs">Exponentials</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="FdBuZxescD">
                    <label for="FdBuZxescD">Linear Algebra</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="GgkoLSaikk">
                    <label for="GgkoLSaikk">Logarithms</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="MkYiNVXJyH">
                    <label for="MkYiNVXJyH">Sequences</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="IimAswNLVD">
                    <label for="IimAswNLVD">Single Variable Calculus</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="OtUZOROgDK">
                    <label for="OtUZOROgDK">Trigonometry</label>
                    <ul>
        ...
        <l>
            <input type="checkbox" id="zXDtfhrUjb" checked>
            <label for="zXDtfhrUjb">Programming</label>
            <ul>
                <l>
                    <input type="checkbox" id="rMwOHVzphj">
                    <label for="rMwOHVzphj">Ansible</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="dPdxKaSCMo">
                    <label for="dPdxKaSCMo">Architecture</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="KBvqwndMrq">
                    <label for="KBvqwndMrq">Computer Graphics</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="UuFJtnzMbM">
                    <label for="UuFJtnzMbM">Databases</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="zJhenOZfGV">
                    <label for="zJhenOZfGV">Devops</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="aYUWdPDcWt">
                            <label for="aYUWdPDcWt">Cloud Providers</label>
                            <ul>
                                <l>
                                    <input type="checkbox" id="elbRyiHlUo">
                                    <label for="elbRyiHlUo">AWS</label>
                                    <ul>
                                        <l>
                                            <input type="checkbox" id="xjtdKRrOZu">
                                            <label for="xjtdKRrOZu">Cli</label>
                                            <ul>
                                        ...
                                        <l>
                                            <input type="checkbox" id="LHFZxTmvVG">
                                            <label for="LHFZxTmvVG">Dotnet</label>
                                            <ul>
                                        ...
                                        <l>
                                            <input type="checkbox" id="KkYReYsBWi">
                                            <label for="KkYReYsBWi">Ec 2</label>
                                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="LuhsIKPtiP">
                            <label for="LuhsIKPtiP">Events</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="LSxGICCTzc">
                            <label for="LSxGICCTzc">Localstack</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="EmkGUrrHIg">
                            <label for="EmkGUrrHIg">Pulumi</label>
                            <ul>
                                <l>
                                    <input type="checkbox" id="thJBHGSOuD">
                                    <label for="thJBHGSOuD">Dotnet</label>
                                    <ul>
                        ...
                        <l>
                            <input type="checkbox" id="NThdiZrXEz">
                            <label for="NThdiZrXEz">Serverless Framework</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="FEInlYYYwO">
                            <label for="FEInlYYYwO">Terraform</label>
                            <ul>
                                <l>
                                    <input type="checkbox" id="LeikNuVsoB">
                                    <label for="LeikNuVsoB">Functions</label>
                                    <ul>
                                ...
                                <l>
                                    <input type="checkbox" id="PmOzBlHEWg">
                                    <label for="PmOzBlHEWg">Meta Arguments</label>
                                    <ul>
                ...
                <l>
                    <input type="checkbox" id="DGmKNVdcDe">
                    <label for="DGmKNVdcDe">Docker</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="nlAydideaL">
                    <label for="nlAydideaL">Dotnet</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="txsFpsjZcS">
                            <label for="txsFpsjZcS">Cli</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="qizyxgAsPa">
                    <label for="qizyxgAsPa">Functional Programming</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="NBwtTJAfqu">
                    <label for="NBwtTJAfqu">Git</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="SbaLJevmNU">
                            <label for="SbaLJevmNU">Github</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="PfpzRhnIiP">
                    <label for="PfpzRhnIiP">Go</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="MuapBKrgkq">
                    <label for="MuapBKrgkq">Haskell</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="cxwuWxCBUT">
                    <label for="cxwuWxCBUT">Js</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="NJPEJUfxjs">
                            <label for="NJPEJUfxjs">Node</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="NZWyOSzpkS">
                            <label for="NZWyOSzpkS">D3</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="jVVAnofBNo">
                            <label for="jVVAnofBNo">Mocha</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="CeGYWjrvyw">
                            <label for="CeGYWjrvyw">P5js</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="EFXbBAUTGS">
                            <label for="EFXbBAUTGS">Typescript</label>
                            <ul>
                                <l>
                                    <input type="checkbox" id="HmyGGQOXhx">
                                    <label for="HmyGGQOXhx">Testing</label>
                                    <ul>
                ...
                <l>
                    <input type="checkbox" id="RtQexScRxw">
                    <label for="RtQexScRxw">Kafka</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="AuDjZbEXOI">
                    <label for="AuDjZbEXOI">Kubernetes</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="vTfFtFfGxr">
                    <label for="vTfFtFfGxr">Language</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="DQgXCKvDsE">
                    <label for="DQgXCKvDsE">Linux</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="fBqfqACkaj">
                            <label for="fBqfqACkaj">Bash</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="gozzBPvnhN">
                    <label for="gozzBPvnhN">Oauth</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="SWcuperRdW">
                    <label for="SWcuperRdW">Prometheus</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="nHnmHLngXK">
                    <label for="nHnmHLngXK">Python</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="bkegtUMJEz">
                            <label for="bkegtUMJEz">Data Classes</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="wkhfguQvcr">
                            <label for="wkhfguQvcr">Libraries</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="DHpcbSqKGJ">
                    <label for="DHpcbSqKGJ">React</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="QjQtoEjFAy">
                    <label for="QjQtoEjFAy">Regular Expressions</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="JaPRNrnvKk">
                    <label for="JaPRNrnvKk">Rust</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="ZyrEPxxMAo">
                            <label for="ZyrEPxxMAo">Serde</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="kFcOIcZsOP">
                    <label for="kFcOIcZsOP">Shaders</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="AToIYVQaff">
                            <label for="AToIYVQaff">Glsl</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="yyUbmfDWul">
                    <label for="yyUbmfDWul">Vim</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="dKtWKTbwUD">
                    <label for="dKtWKTbwUD">Web</label>
                    <ul>
