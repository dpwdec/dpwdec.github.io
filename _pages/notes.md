...
<ul>
    <div name="contents-index">
        ...
        <l>
            <input type="checkbox" id="sWNCidqVhI" checked>
            <label for="sWNCidqVhI">Math</label>
            <ul>
                <l>
                    <input type="checkbox" id="CuOAKXKkVe">
                    <label for="CuOAKXKkVe">Exponentials</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="VgMxRixKTh">
                    <label for="VgMxRixKTh">Linear Algebra</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="oEGcyefZHW">
                    <label for="oEGcyefZHW">Logarithms</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="NhiioumOMO">
                    <label for="NhiioumOMO">Sequences</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="LWViejGKsf">
                    <label for="LWViejGKsf">Single Variable Calculus</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="UhNOXJofbk">
                    <label for="UhNOXJofbk">Trigonometry</label>
                    <ul>
        ...
        <l>
            <input type="checkbox" id="ZGEEcZYVEB" checked>
            <label for="ZGEEcZYVEB">Programming</label>
            <ul>
                <l>
                    <input type="checkbox" id="dxRTNeWrwy">
                    <label for="dxRTNeWrwy">Ansible</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="ObQGOEWyvV">
                    <label for="ObQGOEWyvV">Architecture</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="lzUuOyozzo">
                    <label for="lzUuOyozzo">Computer Graphics</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="bnFrcXjwtC">
                    <label for="bnFrcXjwtC">Databases</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="yXKRSlONJZ">
                    <label for="yXKRSlONJZ">Devops</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="uIMJchAfAq">
                            <label for="uIMJchAfAq">Cloud Computing</label>
                            <ul>
                                <l>
                                    <input type="checkbox" id="NyPOIVgSZW">
                                    <label for="NyPOIVgSZW">AWS</label>
                                    <ul>
                                        <l>
                                            <input type="checkbox" id="hAfssYASBe">
                                            <label for="hAfssYASBe">Cli</label>
                                            <ul>
                                        ...
                                        <l>
                                            <input type="checkbox" id="RjrJIQcsCS">
                                            <label for="RjrJIQcsCS">Dotnet</label>
                                            <ul>
                                        ...
                                        <l>
                                            <input type="checkbox" id="GNmxWFdDmq">
                                            <label for="GNmxWFdDmq">Ec 2</label>
                                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="GGEKhDXKXY">
                            <label for="GGEKhDXKXY">Events</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="QBkWmyjIfa">
                            <label for="QBkWmyjIfa">Oauth</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="jXisVaPCgB">
                            <label for="jXisVaPCgB">Pulumi</label>
                            <ul>
                                <l>
                                    <input type="checkbox" id="YJNkUyDYmZ">
                                    <label for="YJNkUyDYmZ">Dotnet</label>
                                    <ul>
                        ...
                        <l>
                            <input type="checkbox" id="nvumttpezL">
                            <label for="nvumttpezL">Terraform</label>
                            <ul>
                                <l>
                                    <input type="checkbox" id="PHyaMOOGbq">
                                    <label for="PHyaMOOGbq">Functions</label>
                                    <ul>
                                ...
                                <l>
                                    <input type="checkbox" id="cwtkSgBIbP">
                                    <label for="cwtkSgBIbP">Meta Arguments</label>
                                    <ul>
                ...
                <l>
                    <input type="checkbox" id="kWrocxBUrU">
                    <label for="kWrocxBUrU">Docker</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="cCJjtSkldk">
                    <label for="cCJjtSkldk">Dotnet</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="khxJaoDulu">
                            <label for="khxJaoDulu">Cli</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="VPCJgDlZWe">
                    <label for="VPCJgDlZWe">Functional Programming</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="yKfIgphdKA">
                    <label for="yKfIgphdKA">Git</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="PKPraQYxrP">
                            <label for="PKPraQYxrP">Github</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="ggNrbczXOa">
                    <label for="ggNrbczXOa">Go</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="BhQmvaQJee">
                    <label for="BhQmvaQJee">Haskell</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="deIVxPxoIw">
                    <label for="deIVxPxoIw">Js</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="eUzSbvECTO">
                            <label for="eUzSbvECTO">Node</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="AlhFJmQanY">
                            <label for="AlhFJmQanY">Mocha</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="mFrXeCiNWh">
                            <label for="mFrXeCiNWh">P5js</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="pqUGMPHJvJ">
                            <label for="pqUGMPHJvJ">Typescript</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="xgNbBNQsLj">
                    <label for="xgNbBNQsLj">Kafka</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="kQnhvAVJKy">
                    <label for="kQnhvAVJKy">Kubernetes</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="KUnkgFJgXh">
                    <label for="KUnkgFJgXh">Language</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="upnDhNFsMt">
                    <label for="upnDhNFsMt">Linux</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="TTBhyMRBVq">
                    <label for="TTBhyMRBVq">Python</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="jXVKZAqaBo">
                            <label for="jXVKZAqaBo">Data Classes</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="vcfWCdcOiq">
                            <label for="vcfWCdcOiq">Libraries</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="mKGdQRBOtZ">
                    <label for="mKGdQRBOtZ">React</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="LQvSejJCLO">
                    <label for="LQvSejJCLO">Regular Expressions</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="sysdXwhnzL">
                    <label for="sysdXwhnzL">Rust</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="aaXxtNBfBQ">
                            <label for="aaXxtNBfBQ">Serde</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="vRuwHkfsRZ">
                    <label for="vRuwHkfsRZ">Vim</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="QCCEZHhQTB">
                    <label for="QCCEZHhQTB">Web</label>
                    <ul>
