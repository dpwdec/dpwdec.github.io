...
<ul>
    <div name="contents-index">
        ...
        <l>
            <input type="checkbox" id="xoMZAyYbjZ" checked>
            <label for="xoMZAyYbjZ">Math</label>
            <ul>
                <l>
                    <input type="checkbox" id="jGlzSfTYho">
                    <label for="jGlzSfTYho">Exponentials</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="otTPdRSZiD">
                    <label for="otTPdRSZiD">Linear Algebra</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="yOJusLLieA">
                    <label for="yOJusLLieA">Logarithms</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="FHEpAOfUPL">
                    <label for="FHEpAOfUPL">Sequences</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="HbmPvtBHev">
                    <label for="HbmPvtBHev">Single Variable Calculus</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="rMPCNLutpJ">
                    <label for="rMPCNLutpJ">Trigonometry</label>
                    <ul>
        ...
        <l>
            <input type="checkbox" id="ugiheAtsof" checked>
            <label for="ugiheAtsof">Programming</label>
            <ul>
                <l>
                    <input type="checkbox" id="HfrvAEyILw">
                    <label for="HfrvAEyILw">Ansible</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="TilJzIDZim">
                    <label for="TilJzIDZim">Architecture</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="WxCXJDqyZb">
                    <label for="WxCXJDqyZb">Computer Graphics</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="eXgjkGPxpK">
                    <label for="eXgjkGPxpK">Databases</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="OKyFVqQsLD">
                    <label for="OKyFVqQsLD">Devops</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="CLZrKxKhnY">
                            <label for="CLZrKxKhnY">Cloud Providers</label>
                            <ul>
                                <l>
                                    <input type="checkbox" id="lTmpdFIadl">
                                    <label for="lTmpdFIadl">AWS</label>
                                    <ul>
                                        <l>
                                            <input type="checkbox" id="KfErSGxTNZ">
                                            <label for="KfErSGxTNZ">Cli</label>
                                            <ul>
                                        ...
                                        <l>
                                            <input type="checkbox" id="EPRNgIgGsP">
                                            <label for="EPRNgIgGsP">Dotnet</label>
                                            <ul>
                                        ...
                                        <l>
                                            <input type="checkbox" id="IfkuPgKBya">
                                            <label for="IfkuPgKBya">Ec 2</label>
                                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="LcooTKnBtw">
                            <label for="LcooTKnBtw">Events</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="SqJJtCdBbh">
                            <label for="SqJJtCdBbh">Localstack</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="xFMAxWykUX">
                            <label for="xFMAxWykUX">Pulumi</label>
                            <ul>
                                <l>
                                    <input type="checkbox" id="LtPKaIAVap">
                                    <label for="LtPKaIAVap">Dotnet</label>
                                    <ul>
                        ...
                        <l>
                            <input type="checkbox" id="uNCEBgPLzq">
                            <label for="uNCEBgPLzq">Serverless Framework</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="lduuswtmsW">
                            <label for="lduuswtmsW">Terraform</label>
                            <ul>
                                <l>
                                    <input type="checkbox" id="PbLYrUakZe">
                                    <label for="PbLYrUakZe">Functions</label>
                                    <ul>
                                ...
                                <l>
                                    <input type="checkbox" id="EYIpfvGbEa">
                                    <label for="EYIpfvGbEa">Meta Arguments</label>
                                    <ul>
                ...
                <l>
                    <input type="checkbox" id="avAlrgqYVt">
                    <label for="avAlrgqYVt">Docker</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="tTKYylgWnd">
                    <label for="tTKYylgWnd">Dotnet</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="voVWLeMVqM">
                            <label for="voVWLeMVqM">Cli</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="LbsNRJxDws">
                    <label for="LbsNRJxDws">Functional Programming</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="MWbndkOfEe">
                    <label for="MWbndkOfEe">Git</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="CquaHDCzMg">
                            <label for="CquaHDCzMg">Github</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="mhoLCeYITC">
                    <label for="mhoLCeYITC">Go</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="jKIrZRsVAp">
                    <label for="jKIrZRsVAp">Haskell</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="uJGfxNjkuO">
                    <label for="uJGfxNjkuO">Js</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="pSRKnpdQyX">
                            <label for="pSRKnpdQyX">Node</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="yDOXYXeoBg">
                            <label for="yDOXYXeoBg">D3</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="DdZUqAtLRi">
                            <label for="DdZUqAtLRi">Mocha</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="VRtpZXaWFW">
                            <label for="VRtpZXaWFW">P5js</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="GTAnqDxauU">
                            <label for="GTAnqDxauU">Typescript</label>
                            <ul>
                                <l>
                                    <input type="checkbox" id="kbkKykjmAt">
                                    <label for="kbkKykjmAt">Testing</label>
                                    <ul>
                ...
                <l>
                    <input type="checkbox" id="YbVnvKhvQs">
                    <label for="YbVnvKhvQs">Kafka</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="mbLbyohPgy">
                    <label for="mbLbyohPgy">Kubernetes</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="BkynPAEhml">
                    <label for="BkynPAEhml">Language</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="hIkhGZkpqn">
                    <label for="hIkhGZkpqn">Linux</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="FJEkvcwwgZ">
                            <label for="FJEkvcwwgZ">Bash</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="xRTstIREyE">
                    <label for="xRTstIREyE">Oauth</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="QkbwwXWlJy">
                    <label for="QkbwwXWlJy">Python</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="GmUkIidACv">
                            <label for="GmUkIidACv">Data Classes</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="ikbKkbCUdi">
                            <label for="ikbKkbCUdi">Libraries</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="lzZjVRQJRU">
                    <label for="lzZjVRQJRU">React</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="dHXtHuliZQ">
                    <label for="dHXtHuliZQ">Regular Expressions</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="YQcerOgOsU">
                    <label for="YQcerOgOsU">Rust</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="yJwDLPZjWj">
                            <label for="yJwDLPZjWj">Serde</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="aZBDNgYCLz">
                    <label for="aZBDNgYCLz">Shaders</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="tivznzsNdr">
                            <label for="tivznzsNdr">Glsl</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="wIdXiDJybH">
                    <label for="wIdXiDJybH">Vim</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="UHoOvqsibG">
                    <label for="UHoOvqsibG">Web</label>
                    <ul>
