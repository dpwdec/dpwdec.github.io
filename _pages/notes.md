...
<ul>
    <div name="contents-index">
        ...
        <l>
            <input type="checkbox" id="IrnHvDFQiA" checked>
            <label for="IrnHvDFQiA">Math</label>
            <ul>
                <l>
                    <input type="checkbox" id="ronhdFNton">
                    <label for="ronhdFNton">Exponentials</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="WjgvRIivVP">
                    <label for="WjgvRIivVP">Linear Algebra</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="cAxZfNIsVM">
                    <label for="cAxZfNIsVM">Logarithms</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="cRjrfpbXMO">
                    <label for="cRjrfpbXMO">Sequences</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="QgrQRevgea">
                    <label for="QgrQRevgea">Single Variable Calculus</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="bBIlmNoUis">
                    <label for="bBIlmNoUis">Trigonometry</label>
                    <ul>
        ...
        <l>
            <input type="checkbox" id="xSGTFoWTgY" checked>
            <label for="xSGTFoWTgY">Programming</label>
            <ul>
                <l>
                    <input type="checkbox" id="lexsbKNdjf">
                    <label for="lexsbKNdjf">Ansible</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="RKnidbMrYw">
                    <label for="RKnidbMrYw">Architecture</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="aCxoxhlSdq">
                    <label for="aCxoxhlSdq">Computer Graphics</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="eqyCMXmZlL">
                    <label for="eqyCMXmZlL">Databases</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="RjnFumvUNk">
                    <label for="RjnFumvUNk">Devops</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="muiBOUjHvp">
                            <label for="muiBOUjHvp">Cloud Providers</label>
                            <ul>
                                <l>
                                    <input type="checkbox" id="jayfNQKsFO">
                                    <label for="jayfNQKsFO">AWS</label>
                                    <ul>
                                        <l>
                                            <input type="checkbox" id="qCeuNlMuIy">
                                            <label for="qCeuNlMuIy">Cli</label>
                                            <ul>
                                        ...
                                        <l>
                                            <input type="checkbox" id="PPfLQBJKBo">
                                            <label for="PPfLQBJKBo">Dotnet</label>
                                            <ul>
                                        ...
                                        <l>
                                            <input type="checkbox" id="LTPMLVLTvS">
                                            <label for="LTPMLVLTvS">Ec 2</label>
                                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="jOyaHrOjJz">
                            <label for="jOyaHrOjJz">Events</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="rxncSnlbep">
                            <label for="rxncSnlbep">Localstack</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="aCivJaWhln">
                            <label for="aCivJaWhln">Pulumi</label>
                            <ul>
                                <l>
                                    <input type="checkbox" id="IUbKgPgegV">
                                    <label for="IUbKgPgegV">Dotnet</label>
                                    <ul>
                        ...
                        <l>
                            <input type="checkbox" id="KzxYqNZsDi">
                            <label for="KzxYqNZsDi">Serverless Framework</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="kwbEnrNWxi">
                            <label for="kwbEnrNWxi">Terraform</label>
                            <ul>
                                <l>
                                    <input type="checkbox" id="EEQBjHOmfx">
                                    <label for="EEQBjHOmfx">Functions</label>
                                    <ul>
                                ...
                                <l>
                                    <input type="checkbox" id="SSebFPSlvO">
                                    <label for="SSebFPSlvO">Meta Arguments</label>
                                    <ul>
                ...
                <l>
                    <input type="checkbox" id="ZLUmVxkVEt">
                    <label for="ZLUmVxkVEt">Docker</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="htLxVQKGRu">
                    <label for="htLxVQKGRu">Dotnet</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="XIrXoywCVs">
                            <label for="XIrXoywCVs">Cli</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="fzVwWjRpVh">
                    <label for="fzVwWjRpVh">Functional Programming</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="xLzSrZdNox">
                    <label for="xLzSrZdNox">Git</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="ozyOPMCwsi">
                            <label for="ozyOPMCwsi">Github</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="WnyAgVmKvh">
                    <label for="WnyAgVmKvh">Go</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="odDgamAXmz">
                    <label for="odDgamAXmz">Haskell</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="QKeTaIAmVZ">
                    <label for="QKeTaIAmVZ">Js</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="YTJQbunJXf">
                            <label for="YTJQbunJXf">Node</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="NsBkEXbCzp">
                            <label for="NsBkEXbCzp">D3</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="LTRqJVVNRm">
                            <label for="LTRqJVVNRm">Mocha</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="RCzTQEiIvW">
                            <label for="RCzTQEiIvW">P5js</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="fbRcaXXbTw">
                            <label for="fbRcaXXbTw">Typescript</label>
                            <ul>
                                <l>
                                    <input type="checkbox" id="fGNPweYYvN">
                                    <label for="fGNPweYYvN">Testing</label>
                                    <ul>
                ...
                <l>
                    <input type="checkbox" id="soWRovSxce">
                    <label for="soWRovSxce">Kafka</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="GAysgruHAi">
                    <label for="GAysgruHAi">Kubernetes</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="awLDzqUyxf">
                    <label for="awLDzqUyxf">Language</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="hyqsPlwsXs">
                    <label for="hyqsPlwsXs">Linux</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="wLhJohIOVx">
                            <label for="wLhJohIOVx">Bash</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="bDXPngSyMn">
                    <label for="bDXPngSyMn">Oauth</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="XHQuBDndDP">
                    <label for="XHQuBDndDP">Python</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="GylgMMGhgz">
                            <label for="GylgMMGhgz">Data Classes</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="dclctWptOF">
                            <label for="dclctWptOF">Libraries</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="WkaWySIreR">
                    <label for="WkaWySIreR">React</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="jvMYLXsCKD">
                    <label for="jvMYLXsCKD">Regular Expressions</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="slIDeVyPhz">
                    <label for="slIDeVyPhz">Rust</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="PaTnsdANBB">
                            <label for="PaTnsdANBB">Serde</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="uNMxnIrXUg">
                    <label for="uNMxnIrXUg">Shaders</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="TWvrTBmXZy">
                            <label for="TWvrTBmXZy">Glsl</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="qXwXaETBri">
                    <label for="qXwXaETBri">Vim</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="lJbvICVhrk">
                    <label for="lJbvICVhrk">Web</label>
                    <ul>
