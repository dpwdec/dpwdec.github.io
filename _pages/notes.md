...
<ul>
    <div name="contents-index">
        ...
        <l>
            <input type="checkbox" id="KjLAndRKZE" checked>
            <label for="KjLAndRKZE">Math</label>
            <ul>
                <l>
                    <input type="checkbox" id="GScNUMIBoV">
                    <label for="GScNUMIBoV">Exponentials</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="GkrILnwgnR">
                    <label for="GkrILnwgnR">Linear Algebra</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="QXWkybfxsE">
                    <label for="QXWkybfxsE">Logarithms</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="HyoFJTwSfQ">
                    <label for="HyoFJTwSfQ">Sequences</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="ivuwbqXCxU">
                    <label for="ivuwbqXCxU">Single Variable Calculus</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="thKtOLHFuj">
                    <label for="thKtOLHFuj">Trigonometry</label>
                    <ul>
        ...
        <l>
            <input type="checkbox" id="HVoSsdfVed" checked>
            <label for="HVoSsdfVed">Programming</label>
            <ul>
                <l>
                    <input type="checkbox" id="lpkcheVYRm">
                    <label for="lpkcheVYRm">Ansible</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="NFFBJqxmib">
                    <label for="NFFBJqxmib">Architecture</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="XvshQKrgEA">
                    <label for="XvshQKrgEA">Computer Graphics</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="FHjsoOMUkW">
                    <label for="FHjsoOMUkW">Databases</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="RLdkNFFDWU">
                    <label for="RLdkNFFDWU">Devops</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="dazvIGinkN">
                            <label for="dazvIGinkN">Cloud Providers</label>
                            <ul>
                                <l>
                                    <input type="checkbox" id="jzWiHCbVaw">
                                    <label for="jzWiHCbVaw">AWS</label>
                                    <ul>
                                        <l>
                                            <input type="checkbox" id="QRlFdwvUmY">
                                            <label for="QRlFdwvUmY">Cli</label>
                                            <ul>
                                        ...
                                        <l>
                                            <input type="checkbox" id="ODlJfJYWCE">
                                            <label for="ODlJfJYWCE">Dotnet</label>
                                            <ul>
                                        ...
                                        <l>
                                            <input type="checkbox" id="jhIemELqud">
                                            <label for="jhIemELqud">Ec 2</label>
                                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="hOybDFgnVv">
                            <label for="hOybDFgnVv">Events</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="BVxWPPMQpy">
                            <label for="BVxWPPMQpy">Localstack</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="BFhsvWHUKY">
                            <label for="BFhsvWHUKY">Pulumi</label>
                            <ul>
                                <l>
                                    <input type="checkbox" id="ncLDBBMdla">
                                    <label for="ncLDBBMdla">Dotnet</label>
                                    <ul>
                        ...
                        <l>
                            <input type="checkbox" id="WzaMWTjTSA">
                            <label for="WzaMWTjTSA">Serverless Framework</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="LQqfRHavEq">
                            <label for="LQqfRHavEq">Terraform</label>
                            <ul>
                                <l>
                                    <input type="checkbox" id="ksSkPbjyOF">
                                    <label for="ksSkPbjyOF">Functions</label>
                                    <ul>
                                ...
                                <l>
                                    <input type="checkbox" id="ovywVAqJhM">
                                    <label for="ovywVAqJhM">Meta Arguments</label>
                                    <ul>
                ...
                <l>
                    <input type="checkbox" id="NMZyFmQxgx">
                    <label for="NMZyFmQxgx">Docker</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="OaOhWMBwhw">
                    <label for="OaOhWMBwhw">Dotnet</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="zPtWbGyWXZ">
                            <label for="zPtWbGyWXZ">Cli</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="AcFYxgZPNZ">
                    <label for="AcFYxgZPNZ">Functional Programming</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="kBqFdDPrle">
                    <label for="kBqFdDPrle">Git</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="goSDhrATNl">
                            <label for="goSDhrATNl">Github</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="ZFGHJWmasX">
                    <label for="ZFGHJWmasX">Go</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="BiqUycphFd">
                    <label for="BiqUycphFd">Haskell</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="uxqkfnAMoC">
                    <label for="uxqkfnAMoC">Js</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="ZLuOmaOQet">
                            <label for="ZLuOmaOQet">Node</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="qIOpVpNsjz">
                            <label for="qIOpVpNsjz">D3</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="rJRIEjPKeM">
                            <label for="rJRIEjPKeM">Mocha</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="ccRGXIHvWi">
                            <label for="ccRGXIHvWi">P5js</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="ScUCVEkzbD">
                            <label for="ScUCVEkzbD">Typescript</label>
                            <ul>
                                <l>
                                    <input type="checkbox" id="WNERvRiZGA">
                                    <label for="WNERvRiZGA">Testing</label>
                                    <ul>
                ...
                <l>
                    <input type="checkbox" id="rtKRdyNaJT">
                    <label for="rtKRdyNaJT">Kafka</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="WZTkArdHVq">
                    <label for="WZTkArdHVq">Kubernetes</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="tILHcrvloV">
                    <label for="tILHcrvloV">Language</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="ffHUROGPep">
                    <label for="ffHUROGPep">Linux</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="KGNYpemDiP">
                            <label for="KGNYpemDiP">Bash</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="hDGwRdifud">
                    <label for="hDGwRdifud">Oauth</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="KRodQpCJnZ">
                    <label for="KRodQpCJnZ">Python</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="OtRMUEyRRM">
                            <label for="OtRMUEyRRM">Data Classes</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="wlMOqiskTu">
                            <label for="wlMOqiskTu">Libraries</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="iDcnovhjhN">
                    <label for="iDcnovhjhN">React</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="bwgRWuSlsV">
                    <label for="bwgRWuSlsV">Regular Expressions</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="dmTrrdIgXQ">
                    <label for="dmTrrdIgXQ">Rust</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="xcerOIepXS">
                            <label for="xcerOIepXS">Serde</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="dimxlzKXak">
                    <label for="dimxlzKXak">Vim</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="BxTqIBJmGY">
                    <label for="BxTqIBJmGY">Web</label>
                    <ul>
