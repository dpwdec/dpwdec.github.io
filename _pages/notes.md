...
<ul>
    <div name="contents-index">
        ...
        <l>
            <input type="checkbox" id="RaOKvLErfO" checked>
            <label for="RaOKvLErfO">Math</label>
            <ul>
                <l>
                    <input type="checkbox" id="jVREMYgaxF">
                    <label for="jVREMYgaxF">Exponentials</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="aTWrKnNxLB">
                    <label for="aTWrKnNxLB">Linear Algebra</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="fyhEhrduya">
                    <label for="fyhEhrduya">Logarithms</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="VXmQmCmIUI">
                    <label for="VXmQmCmIUI">Sequences</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="LrzsIvjFAh">
                    <label for="LrzsIvjFAh">Single Variable Calculus</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="jOnODCTWOt">
                    <label for="jOnODCTWOt">Trigonometry</label>
                    <ul>
        ...
        <l>
            <input type="checkbox" id="kQDsmdBPeL" checked>
            <label for="kQDsmdBPeL">Programming</label>
            <ul>
                <l>
                    <input type="checkbox" id="QgPSWnMYZR">
                    <label for="QgPSWnMYZR">Ansible</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="LPKXRifiBv">
                    <label for="LPKXRifiBv">Architecture</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="ocvINYtDlQ">
                    <label for="ocvINYtDlQ">Computer Graphics</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="nqiNTYxfPT">
                    <label for="nqiNTYxfPT">Databases</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="rCTUWmPIjv">
                    <label for="rCTUWmPIjv">Devops</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="XTYJqWDTmP">
                            <label for="XTYJqWDTmP">Cloud Providers</label>
                            <ul>
                                <l>
                                    <input type="checkbox" id="fYLoTSFxBs">
                                    <label for="fYLoTSFxBs">AWS</label>
                                    <ul>
                                        <l>
                                            <input type="checkbox" id="mocBCRIPog">
                                            <label for="mocBCRIPog">Cli</label>
                                            <ul>
                                        ...
                                        <l>
                                            <input type="checkbox" id="ZAWZbJoqIW">
                                            <label for="ZAWZbJoqIW">Dotnet</label>
                                            <ul>
                                        ...
                                        <l>
                                            <input type="checkbox" id="XooRGUWJzX">
                                            <label for="XooRGUWJzX">Ec 2</label>
                                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="xBSgJzNbmD">
                            <label for="xBSgJzNbmD">Events</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="mpqcPgWiOM">
                            <label for="mpqcPgWiOM">Localstack</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="LLrWuPhgNG">
                            <label for="LLrWuPhgNG">Pulumi</label>
                            <ul>
                                <l>
                                    <input type="checkbox" id="yYFlCZzZTh">
                                    <label for="yYFlCZzZTh">Dotnet</label>
                                    <ul>
                        ...
                        <l>
                            <input type="checkbox" id="xAEKAOEfxZ">
                            <label for="xAEKAOEfxZ">Serverless Framework</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="HydQvCoBjp">
                            <label for="HydQvCoBjp">Terraform</label>
                            <ul>
                                <l>
                                    <input type="checkbox" id="XDuEJLQABf">
                                    <label for="XDuEJLQABf">Functions</label>
                                    <ul>
                                ...
                                <l>
                                    <input type="checkbox" id="AavtmZSxQb">
                                    <label for="AavtmZSxQb">Meta Arguments</label>
                                    <ul>
                ...
                <l>
                    <input type="checkbox" id="fdemPaiXWG">
                    <label for="fdemPaiXWG">Docker</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="haIMRlLxwu">
                    <label for="haIMRlLxwu">Dotnet</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="rATmPDWeOD">
                            <label for="rATmPDWeOD">Cli</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="PPFdKytgqV">
                    <label for="PPFdKytgqV">Functional Programming</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="qdNGnIdpWS">
                    <label for="qdNGnIdpWS">Git</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="kjFWCWOKHD">
                            <label for="kjFWCWOKHD">Github</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="xDVRAvpCXn">
                    <label for="xDVRAvpCXn">Go</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="IvdcMVNKXX">
                    <label for="IvdcMVNKXX">Haskell</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="IfLfjiuIao">
                    <label for="IfLfjiuIao">Js</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="AoVKtLysbt">
                            <label for="AoVKtLysbt">Node</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="uuORgRWHwK">
                            <label for="uuORgRWHwK">D3</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="vDVYKchnne">
                            <label for="vDVYKchnne">Mocha</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="BASZqNHbZm">
                            <label for="BASZqNHbZm">P5js</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="QZUVmLoipa">
                            <label for="QZUVmLoipa">Typescript</label>
                            <ul>
                                <l>
                                    <input type="checkbox" id="RhOrEBteiS">
                                    <label for="RhOrEBteiS">Testing</label>
                                    <ul>
                ...
                <l>
                    <input type="checkbox" id="wKFsGrWePM">
                    <label for="wKFsGrWePM">Kafka</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="zTagJjQiNx">
                    <label for="zTagJjQiNx">Kubernetes</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="zrSfVlhynh">
                    <label for="zrSfVlhynh">Language</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="nuMplvStrf">
                    <label for="nuMplvStrf">Linux</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="AKmDQBBoEj">
                            <label for="AKmDQBBoEj">Bash</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="KwbbVCTpQA">
                    <label for="KwbbVCTpQA">Oauth</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="oKbLmKbiEO">
                    <label for="oKbLmKbiEO">Python</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="tbuoQQSseI">
                            <label for="tbuoQQSseI">Data Classes</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="iuvGXqrXuc">
                            <label for="iuvGXqrXuc">Libraries</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="wyFzPFzGTB">
                    <label for="wyFzPFzGTB">React</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="dwcfqHdnwv">
                    <label for="dwcfqHdnwv">Regular Expressions</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="sUBnfNRJsD">
                    <label for="sUBnfNRJsD">Rust</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="GuAInvDXrZ">
                            <label for="GuAInvDXrZ">Serde</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="tLoBpbgTkn">
                    <label for="tLoBpbgTkn">Vim</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="eRpeYNCMML">
                    <label for="eRpeYNCMML">Web</label>
                    <ul>
