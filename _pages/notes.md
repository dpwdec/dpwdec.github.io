...
<ul>
    <div name="contents-index">
        ...
        <l>
            <input type="checkbox" id="WblKgkxDDJ" checked>
            <label for="WblKgkxDDJ">Math</label>
            <ul>
                <l>
                    <input type="checkbox" id="AflkvOlAHB">
                    <label for="AflkvOlAHB">Exponentials</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="GhmNCPiFQv">
                    <label for="GhmNCPiFQv">Linear Algebra</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="PofpZnInWu">
                    <label for="PofpZnInWu">Logarithms</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="GCPaaSBifs">
                    <label for="GCPaaSBifs">Sequences</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="MxiabOqxQo">
                    <label for="MxiabOqxQo">Single Variable Calculus</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="wbAOaYjtjU">
                    <label for="wbAOaYjtjU">Trigonometry</label>
                    <ul>
        ...
        <l>
            <input type="checkbox" id="mmTFLHSMPC" checked>
            <label for="mmTFLHSMPC">Programming</label>
            <ul>
                <l>
                    <input type="checkbox" id="bydJsAhFme">
                    <label for="bydJsAhFme">Ansible</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="SQYCgJZbSw">
                    <label for="SQYCgJZbSw">Architecture</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="FcmIUyBjpd">
                    <label for="FcmIUyBjpd">Computer Graphics</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="dynWuUShme">
                    <label for="dynWuUShme">Databases</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="NDGugNKdLm">
                    <label for="NDGugNKdLm">Devops</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="HXaAzhDlPP">
                            <label for="HXaAzhDlPP">Cloud Providers</label>
                            <ul>
                                <l>
                                    <input type="checkbox" id="rVxALjiXSf">
                                    <label for="rVxALjiXSf">AWS</label>
                                    <ul>
                                        <l>
                                            <input type="checkbox" id="qNqxUGifgW">
                                            <label for="qNqxUGifgW">Cli</label>
                                            <ul>
                                        ...
                                        <l>
                                            <input type="checkbox" id="iMlojjDZwM">
                                            <label for="iMlojjDZwM">Dotnet</label>
                                            <ul>
                                        ...
                                        <l>
                                            <input type="checkbox" id="dHTlzRYRXw">
                                            <label for="dHTlzRYRXw">Ec 2</label>
                                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="SCDSfQWODI">
                            <label for="SCDSfQWODI">Events</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="JoELVuxLfk">
                            <label for="JoELVuxLfk">Localstack</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="xjhPtCYGsV">
                            <label for="xjhPtCYGsV">Pulumi</label>
                            <ul>
                                <l>
                                    <input type="checkbox" id="WSRnASlkug">
                                    <label for="WSRnASlkug">Dotnet</label>
                                    <ul>
                        ...
                        <l>
                            <input type="checkbox" id="aexsSLtMeA">
                            <label for="aexsSLtMeA">Serverless Framework</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="dhqaLeAlmY">
                            <label for="dhqaLeAlmY">Terraform</label>
                            <ul>
                                <l>
                                    <input type="checkbox" id="zNCfDdSHnR">
                                    <label for="zNCfDdSHnR">Functions</label>
                                    <ul>
                                ...
                                <l>
                                    <input type="checkbox" id="SSqDmAyxCO">
                                    <label for="SSqDmAyxCO">Meta Arguments</label>
                                    <ul>
                ...
                <l>
                    <input type="checkbox" id="jLwMMJUwMU">
                    <label for="jLwMMJUwMU">Docker</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="sxDLMnxoUD">
                    <label for="sxDLMnxoUD">Dotnet</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="oZFiXktsro">
                            <label for="oZFiXktsro">Cli</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="THWoyGQrXp">
                    <label for="THWoyGQrXp">Functional Programming</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="UALEpvTXgF">
                    <label for="UALEpvTXgF">Git</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="YnVypiIOvi">
                            <label for="YnVypiIOvi">Github</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="nHJrYKAlRk">
                    <label for="nHJrYKAlRk">Go</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="IkLhxDTvyu">
                    <label for="IkLhxDTvyu">Haskell</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="bAnmvYLIia">
                    <label for="bAnmvYLIia">Js</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="cKZfiPpcYE">
                            <label for="cKZfiPpcYE">Node</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="umXjjJXlTc">
                            <label for="umXjjJXlTc">D3</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="IFvyjmXsTM">
                            <label for="IFvyjmXsTM">Mocha</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="HodeKruZlf">
                            <label for="HodeKruZlf">P5js</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="eAiDVJrJHp">
                            <label for="eAiDVJrJHp">Typescript</label>
                            <ul>
                                <l>
                                    <input type="checkbox" id="onBVDKeVok">
                                    <label for="onBVDKeVok">Testing</label>
                                    <ul>
                ...
                <l>
                    <input type="checkbox" id="kTRJwWJdpc">
                    <label for="kTRJwWJdpc">Kafka</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="slzUARCqca">
                    <label for="slzUARCqca">Kubernetes</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="UicxPNZRFj">
                    <label for="UicxPNZRFj">Language</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="pEJZMutcsH">
                    <label for="pEJZMutcsH">Linux</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="cINooFnYzX">
                            <label for="cINooFnYzX">Bash</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="panPuwURtK">
                    <label for="panPuwURtK">Oauth</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="zUyyRQAwFU">
                    <label for="zUyyRQAwFU">Python</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="VecXAnwtKJ">
                            <label for="VecXAnwtKJ">Data Classes</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="NaTQgTjoJZ">
                            <label for="NaTQgTjoJZ">Libraries</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="AFLnNsTxGz">
                    <label for="AFLnNsTxGz">React</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="FTwedUXqen">
                    <label for="FTwedUXqen">Regular Expressions</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="XatPGdPsSU">
                    <label for="XatPGdPsSU">Rust</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="NurZSeKnCR">
                            <label for="NurZSeKnCR">Serde</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="fwXMHOCqnb">
                    <label for="fwXMHOCqnb">Vim</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="QCsjDmtgHf">
                    <label for="QCsjDmtgHf">Web</label>
                    <ul>
