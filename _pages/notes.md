...
<ul>
    <div name="contents-index">
        ...
        <l>
            <input type="checkbox" id="scJonQEYRU" checked>
            <label for="scJonQEYRU">Math</label>
            <ul>
                <l>
                    <input type="checkbox" id="RVbQCliryT">
                    <label for="RVbQCliryT">Exponentials</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="bZTtrgUqtq">
                    <label for="bZTtrgUqtq">Linear Algebra</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="sYFjYocxVE">
                    <label for="sYFjYocxVE">Logarithms</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="kwcPoSVBAS">
                    <label for="kwcPoSVBAS">Sequences</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="dysbODJPdp">
                    <label for="dysbODJPdp">Single Variable Calculus</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="IKKSVbHeIf">
                    <label for="IKKSVbHeIf">Trigonometry</label>
                    <ul>
        ...
        <l>
            <input type="checkbox" id="FasyDPDLTR" checked>
            <label for="FasyDPDLTR">Programming</label>
            <ul>
                <l>
                    <input type="checkbox" id="avgcwGyZQC">
                    <label for="avgcwGyZQC">Ansible</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="PrzCxEdqmq">
                    <label for="PrzCxEdqmq">Architecture</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="qlKLEkmUEo">
                    <label for="qlKLEkmUEo">Computer Graphics</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="SScvCnETgB">
                    <label for="SScvCnETgB">Databases</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="dIDoLdrBqM">
                    <label for="dIDoLdrBqM">Devops</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="upOXvnOnqv">
                            <label for="upOXvnOnqv">Cloud Providers</label>
                            <ul>
                                <l>
                                    <input type="checkbox" id="yMlNhBLFKm">
                                    <label for="yMlNhBLFKm">AWS</label>
                                    <ul>
                                        <l>
                                            <input type="checkbox" id="kiZYNShdgb">
                                            <label for="kiZYNShdgb">Cli</label>
                                            <ul>
                                        ...
                                        <l>
                                            <input type="checkbox" id="EHcvlTOFRV">
                                            <label for="EHcvlTOFRV">Dotnet</label>
                                            <ul>
                                        ...
                                        <l>
                                            <input type="checkbox" id="MXysijwxoH">
                                            <label for="MXysijwxoH">Ec 2</label>
                                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="ZZsCxTZlIx">
                            <label for="ZZsCxTZlIx">Events</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="VNqaGBLDGV">
                            <label for="VNqaGBLDGV">Localstack</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="kflhdebNAm">
                            <label for="kflhdebNAm">Pulumi</label>
                            <ul>
                                <l>
                                    <input type="checkbox" id="UlgvqdHVDW">
                                    <label for="UlgvqdHVDW">Dotnet</label>
                                    <ul>
                        ...
                        <l>
                            <input type="checkbox" id="ICKkyBsXaf">
                            <label for="ICKkyBsXaf">Serverless Framework</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="izGoKHyKaj">
                            <label for="izGoKHyKaj">Terraform</label>
                            <ul>
                                <l>
                                    <input type="checkbox" id="KacFNpYnAI">
                                    <label for="KacFNpYnAI">Functions</label>
                                    <ul>
                                ...
                                <l>
                                    <input type="checkbox" id="MvswxtTaFk">
                                    <label for="MvswxtTaFk">Meta Arguments</label>
                                    <ul>
                ...
                <l>
                    <input type="checkbox" id="yXbUMlbkoD">
                    <label for="yXbUMlbkoD">Docker</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="oqYdSlPTzE">
                    <label for="oqYdSlPTzE">Dotnet</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="bMTXfgljsR">
                            <label for="bMTXfgljsR">Cli</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="SeeyhkKSnS">
                    <label for="SeeyhkKSnS">Functional Programming</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="vxECjFhyeX">
                    <label for="vxECjFhyeX">Git</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="puPeLqmiyg">
                            <label for="puPeLqmiyg">Github</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="aJQsOJOHYj">
                    <label for="aJQsOJOHYj">Go</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="OtBdUvLWmW">
                    <label for="OtBdUvLWmW">Haskell</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="OAXUsiicDb">
                    <label for="OAXUsiicDb">Js</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="JAOXzmXrBC">
                            <label for="JAOXzmXrBC">Node</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="yftceNQfnZ">
                            <label for="yftceNQfnZ">D3</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="gKlDWdEkBn">
                            <label for="gKlDWdEkBn">Mocha</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="RpFqZfUCyZ">
                            <label for="RpFqZfUCyZ">P5js</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="mlJZAsXzEb">
                            <label for="mlJZAsXzEb">Typescript</label>
                            <ul>
                                <l>
                                    <input type="checkbox" id="ZYBEHsodhK">
                                    <label for="ZYBEHsodhK">Testing</label>
                                    <ul>
                ...
                <l>
                    <input type="checkbox" id="NAzqhDlWbv">
                    <label for="NAzqhDlWbv">Kafka</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="lnTFUyTLrk">
                    <label for="lnTFUyTLrk">Kubernetes</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="DKaVGMGqsy">
                    <label for="DKaVGMGqsy">Language</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="LvxGvfxMXl">
                    <label for="LvxGvfxMXl">Linux</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="OIpjjacmeE">
                            <label for="OIpjjacmeE">Bash</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="oAozuyVhws">
                    <label for="oAozuyVhws">Oauth</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="ETwMEgFoyc">
                    <label for="ETwMEgFoyc">Python</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="udiBDqyNYW">
                            <label for="udiBDqyNYW">Data Classes</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="sTjCDvXyXl">
                            <label for="sTjCDvXyXl">Libraries</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="tgcJsNjNaM">
                    <label for="tgcJsNjNaM">React</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="dDfspTjHVd">
                    <label for="dDfspTjHVd">Regular Expressions</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="FkAXFSbpeR">
                    <label for="FkAXFSbpeR">Rust</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="pwsJqGRtFO">
                            <label for="pwsJqGRtFO">Serde</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="NgiWKtDnNl">
                    <label for="NgiWKtDnNl">Vim</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="UFEflcgSSu">
                    <label for="UFEflcgSSu">Web</label>
                    <ul>
