...
<ul>
    <div name="contents-index">
        ...
        <l>
            <input type="checkbox" id="maBCJQyicZ" checked>
            <label for="maBCJQyicZ">Math</label>
            <ul>
                <l>
                    <input type="checkbox" id="yjkGYTxOwH">
                    <label for="yjkGYTxOwH">Exponentials</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="QXvjSPeCZN">
                    <label for="QXvjSPeCZN">Linear Algebra</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="iflFiYnLLP">
                    <label for="iflFiYnLLP">Logarithms</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="EZWgdSemBL">
                    <label for="EZWgdSemBL">Sequences</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="PiXDuJbOBV">
                    <label for="PiXDuJbOBV">Single Variable Calculus</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="nxqnEdzYEO">
                    <label for="nxqnEdzYEO">Trigonometry</label>
                    <ul>
        ...
        <l>
            <input type="checkbox" id="cVpnbMgjiU" checked>
            <label for="cVpnbMgjiU">Programming</label>
            <ul>
                <l>
                    <input type="checkbox" id="DXyYvJbesZ">
                    <label for="DXyYvJbesZ">Ansible</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="yptsiXZzOj">
                    <label for="yptsiXZzOj">Architecture</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="gVnbHKEznf">
                    <label for="gVnbHKEznf">Computer Graphics</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="ZfLwdbqyTK">
                    <label for="ZfLwdbqyTK">Databases</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="vWqnuekbee">
                    <label for="vWqnuekbee">Devops</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="PHrvVJtQFm">
                            <label for="PHrvVJtQFm">Cloud Computing</label>
                            <ul>
                                <l>
                                    <input type="checkbox" id="ACAorlmLAv">
                                    <label for="ACAorlmLAv">AWS</label>
                                    <ul>
                                        <l>
                                            <input type="checkbox" id="pbGhpYVoNT">
                                            <label for="pbGhpYVoNT">Ec 2</label>
                                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="nnDZryyTYI">
                            <label for="nnDZryyTYI">Events</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="LSrdGvDRNP">
                            <label for="LSrdGvDRNP">Oauth</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="NUeUMigEdA">
                            <label for="NUeUMigEdA">Pulumi</label>
                            <ul>
                                <l>
                                    <input type="checkbox" id="VgePYYtHAS">
                                    <label for="VgePYYtHAS">Dotnet</label>
                                    <ul>
                        ...
                        <l>
                            <input type="checkbox" id="IMDLCyeejE">
                            <label for="IMDLCyeejE">Terraform</label>
                            <ul>
                                <l>
                                    <input type="checkbox" id="bksXoEadqE">
                                    <label for="bksXoEadqE">Functions</label>
                                    <ul>
                                ...
                                <l>
                                    <input type="checkbox" id="qAKwPUWYdd">
                                    <label for="qAKwPUWYdd">Meta Arguments</label>
                                    <ul>
                ...
                <l>
                    <input type="checkbox" id="LJnCRpnwOm">
                    <label for="LJnCRpnwOm">Docker</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="oGIxhpqWGt">
                    <label for="oGIxhpqWGt">Dotnet</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="WAKhUFYEPg">
                            <label for="WAKhUFYEPg">Cli</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="YUwbZxnpLU">
                    <label for="YUwbZxnpLU">Functional Programming</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="BAjyJBgVKu">
                    <label for="BAjyJBgVKu">Git</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="OJgXfnKSvX">
                            <label for="OJgXfnKSvX">Github</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="iqckrEoRtO">
                    <label for="iqckrEoRtO">Go</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="mKbgjTPBGu">
                    <label for="mKbgjTPBGu">Haskell</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="ZzjimlZyEd">
                    <label for="ZzjimlZyEd">Js</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="NBVmkJLOgP">
                            <label for="NBVmkJLOgP">Node</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="rLyKupHSjn">
                            <label for="rLyKupHSjn">Mocha</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="aPnvCejCdS">
                            <label for="aPnvCejCdS">P5js</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="tnXjeCOfyJ">
                            <label for="tnXjeCOfyJ">Typescript</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="FaMMaeCBFV">
                    <label for="FaMMaeCBFV">Kafka</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="OhUUDvbzjv">
                    <label for="OhUUDvbzjv">Kubernetes</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="NteAwhylZD">
                    <label for="NteAwhylZD">Language</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="lhjwbuyopt">
                    <label for="lhjwbuyopt">Linux</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="KRSeSRgRsl">
                    <label for="KRSeSRgRsl">Python</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="DIcEcfGJWK">
                            <label for="DIcEcfGJWK">Data Classes</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="RubgMFnhAZ">
                            <label for="RubgMFnhAZ">Libraries</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="VaYicYelKP">
                    <label for="VaYicYelKP">React</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="eAMTUbAtng">
                    <label for="eAMTUbAtng">Regular Expressions</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="YoXHgIZTqS">
                    <label for="YoXHgIZTqS">Rust</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="cUyIZYjjLu">
                            <label for="cUyIZYjjLu">Serde</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="HDgiRTBRsk">
                    <label for="HDgiRTBRsk">Vim</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="TBfGyNhNZW">
                    <label for="TBfGyNhNZW">Web</label>
                    <ul>
