...
<ul>
    <div name="contents-index">
        ...
        <l>
            <input type="checkbox" id="uIlHDTiueF" checked>
            <label for="uIlHDTiueF">Math</label>
            <ul>
                <l>
                    <input type="checkbox" id="UhLruwDKaA">
                    <label for="UhLruwDKaA">Exponentials</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="CuAIKhtzhI">
                    <label for="CuAIKhtzhI">Linear Algebra</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="FpNHVzCHYG">
                    <label for="FpNHVzCHYG">Logarithms</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="GrRdMUTVln">
                    <label for="GrRdMUTVln">Sequences</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="MPhJoJZbxH">
                    <label for="MPhJoJZbxH">Single Variable Calculus</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="SNifUiWydP">
                    <label for="SNifUiWydP">Trigonometry</label>
                    <ul>
        ...
        <l>
            <input type="checkbox" id="zBGVfgmjeT" checked>
            <label for="zBGVfgmjeT">Programming</label>
            <ul>
                <l>
                    <input type="checkbox" id="QuDCbgikZJ">
                    <label for="QuDCbgikZJ">Ansible</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="GpJHWbXRlE">
                    <label for="GpJHWbXRlE">Architecture</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="AhEOQAevpo">
                    <label for="AhEOQAevpo">Computer Graphics</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="bAajbhoExD">
                    <label for="bAajbhoExD">Databases</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="ZyqqsRmOVD">
                    <label for="ZyqqsRmOVD">Devops</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="jxEislrZQI">
                            <label for="jxEislrZQI">Cloud Providers</label>
                            <ul>
                                <l>
                                    <input type="checkbox" id="DASobusgJn">
                                    <label for="DASobusgJn">AWS</label>
                                    <ul>
                                        <l>
                                            <input type="checkbox" id="ZGuXzljRlM">
                                            <label for="ZGuXzljRlM">Cli</label>
                                            <ul>
                                        ...
                                        <l>
                                            <input type="checkbox" id="SCzWjJJPAW">
                                            <label for="SCzWjJJPAW">Dotnet</label>
                                            <ul>
                                        ...
                                        <l>
                                            <input type="checkbox" id="LPeMlZziQq">
                                            <label for="LPeMlZziQq">Ec 2</label>
                                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="lrJXQVeIlH">
                            <label for="lrJXQVeIlH">Events</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="hqJDAwREqA">
                            <label for="hqJDAwREqA">Localstack</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="dfyAYZRfWw">
                            <label for="dfyAYZRfWw">Pulumi</label>
                            <ul>
                                <l>
                                    <input type="checkbox" id="GiqApnUZHu">
                                    <label for="GiqApnUZHu">Dotnet</label>
                                    <ul>
                        ...
                        <l>
                            <input type="checkbox" id="TIlVFPauCH">
                            <label for="TIlVFPauCH">Serverless Framework</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="RDsTFUSygq">
                            <label for="RDsTFUSygq">Terraform</label>
                            <ul>
                                <l>
                                    <input type="checkbox" id="sbexwxphdt">
                                    <label for="sbexwxphdt">Functions</label>
                                    <ul>
                                ...
                                <l>
                                    <input type="checkbox" id="yQnTKzlTJq">
                                    <label for="yQnTKzlTJq">Meta Arguments</label>
                                    <ul>
                ...
                <l>
                    <input type="checkbox" id="oTcSblXoab">
                    <label for="oTcSblXoab">Docker</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="sSlQTblEex">
                    <label for="sSlQTblEex">Dotnet</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="wRdRJhYZxx">
                            <label for="wRdRJhYZxx">Cli</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="NQKdvPGMvS">
                    <label for="NQKdvPGMvS">Functional Programming</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="hLWWxhkEff">
                    <label for="hLWWxhkEff">Git</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="BzRlVXngPy">
                            <label for="BzRlVXngPy">Github</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="JcTTNTcoNZ">
                    <label for="JcTTNTcoNZ">Go</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="byvCJZvKwq">
                    <label for="byvCJZvKwq">Haskell</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="IvSkkTkozF">
                    <label for="IvSkkTkozF">Js</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="oLZdFjdauP">
                            <label for="oLZdFjdauP">Node</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="jDcWiTQWrl">
                            <label for="jDcWiTQWrl">D3</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="GiHEQulOHd">
                            <label for="GiHEQulOHd">Mocha</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="ynSKAjNuSN">
                            <label for="ynSKAjNuSN">P5js</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="edUHoozYPL">
                            <label for="edUHoozYPL">Typescript</label>
                            <ul>
                                <l>
                                    <input type="checkbox" id="DxthdqvjTY">
                                    <label for="DxthdqvjTY">Testing</label>
                                    <ul>
                ...
                <l>
                    <input type="checkbox" id="wjJSmeWMRb">
                    <label for="wjJSmeWMRb">Kafka</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="bzYYDlmNCR">
                    <label for="bzYYDlmNCR">Kubernetes</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="ClRWoAhjuI">
                    <label for="ClRWoAhjuI">Language</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="iOAYbtkdQG">
                    <label for="iOAYbtkdQG">Linux</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="mMkoSZmwnx">
                            <label for="mMkoSZmwnx">Bash</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="jiYWgQVpsW">
                    <label for="jiYWgQVpsW">Oauth</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="KPFYpHbnUg">
                    <label for="KPFYpHbnUg">Python</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="LaCrnySVQE">
                            <label for="LaCrnySVQE">Data Classes</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="HsvtevNGlZ">
                            <label for="HsvtevNGlZ">Libraries</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="jBooHjBanl">
                    <label for="jBooHjBanl">React</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="ZHtjBXoezw">
                    <label for="ZHtjBXoezw">Regular Expressions</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="XhhxHEqNlc">
                    <label for="XhhxHEqNlc">Rust</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="mhdRtMGliV">
                            <label for="mhdRtMGliV">Serde</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="tRRqNFyXGv">
                    <label for="tRRqNFyXGv">Vim</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="cDmMsghOxD">
                    <label for="cDmMsghOxD">Web</label>
                    <ul>
