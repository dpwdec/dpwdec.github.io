...
<ul>
    <div name="contents-index">
        ...
        <l>
            <input type="checkbox" id="GDnuxuuJmS" checked>
            <label for="GDnuxuuJmS">Math</label>
            <ul>
                <l>
                    <input type="checkbox" id="mRrhVQCYxE">
                    <label for="mRrhVQCYxE">Exponentials</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="UyRNoshubH">
                    <label for="UyRNoshubH">Linear Algebra</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="rdKQFuUrgO">
                    <label for="rdKQFuUrgO">Logarithms</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="xlQdXxLxcR">
                    <label for="xlQdXxLxcR">Sequences</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="npUTtgoNSV">
                    <label for="npUTtgoNSV">Single Variable Calculus</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="smnqJYzNbW">
                    <label for="smnqJYzNbW">Trigonometry</label>
                    <ul>
        ...
        <l>
            <input type="checkbox" id="hgRUpNVXbN" checked>
            <label for="hgRUpNVXbN">Programming</label>
            <ul>
                <l>
                    <input type="checkbox" id="uWmugGvXJR">
                    <label for="uWmugGvXJR">Ansible</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="CynkHXWsNe">
                    <label for="CynkHXWsNe">Architecture</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="BPrwMZbMuf">
                    <label for="BPrwMZbMuf">Computer Graphics</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="guZYxaowLB">
                    <label for="guZYxaowLB">Databases</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="GMXwjervvv">
                    <label for="GMXwjervvv">Devops</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="lBhvgiCCmK">
                            <label for="lBhvgiCCmK">Cloud Computing</label>
                            <ul>
                                <l>
                                    <input type="checkbox" id="fqCVjEmChh">
                                    <label for="fqCVjEmChh">AWS</label>
                                    <ul>
                                        <l>
                                            <input type="checkbox" id="SQvrUDILme">
                                            <label for="SQvrUDILme">Cli</label>
                                            <ul>
                                        ...
                                        <l>
                                            <input type="checkbox" id="tzkIurfneY">
                                            <label for="tzkIurfneY">Dotnet</label>
                                            <ul>
                                        ...
                                        <l>
                                            <input type="checkbox" id="KtnTcLXNWa">
                                            <label for="KtnTcLXNWa">Ec 2</label>
                                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="eWidTXZJFN">
                            <label for="eWidTXZJFN">Events</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="pvsjobeynB">
                            <label for="pvsjobeynB">Oauth</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="KgKpPfbhZY">
                            <label for="KgKpPfbhZY">Pulumi</label>
                            <ul>
                                <l>
                                    <input type="checkbox" id="FgXlIRNfwX">
                                    <label for="FgXlIRNfwX">Dotnet</label>
                                    <ul>
                        ...
                        <l>
                            <input type="checkbox" id="blfiIopTJX">
                            <label for="blfiIopTJX">Terraform</label>
                            <ul>
                                <l>
                                    <input type="checkbox" id="ZhwqxBbPYs">
                                    <label for="ZhwqxBbPYs">Functions</label>
                                    <ul>
                                ...
                                <l>
                                    <input type="checkbox" id="EwfOoDgRLU">
                                    <label for="EwfOoDgRLU">Meta Arguments</label>
                                    <ul>
                ...
                <l>
                    <input type="checkbox" id="kdncvaPAtP">
                    <label for="kdncvaPAtP">Docker</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="bBkNQtjJwR">
                    <label for="bBkNQtjJwR">Dotnet</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="ZoBpxyZkBJ">
                            <label for="ZoBpxyZkBJ">Cli</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="ofAHpgnexV">
                    <label for="ofAHpgnexV">Functional Programming</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="MtxbYGjQOj">
                    <label for="MtxbYGjQOj">Git</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="FJmydkZbtF">
                            <label for="FJmydkZbtF">Github</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="zsArKvQwhH">
                    <label for="zsArKvQwhH">Go</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="ltvZfxOZPB">
                    <label for="ltvZfxOZPB">Haskell</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="IbMSpwpWOq">
                    <label for="IbMSpwpWOq">Js</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="knHQDQfYXW">
                            <label for="knHQDQfYXW">Node</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="PtoQKDuprD">
                            <label for="PtoQKDuprD">Mocha</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="hOqcPHwXYu">
                            <label for="hOqcPHwXYu">P5js</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="yYlBAUdMCz">
                            <label for="yYlBAUdMCz">Typescript</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="WgnxoRqUIe">
                    <label for="WgnxoRqUIe">Kafka</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="YfIyfNDUdd">
                    <label for="YfIyfNDUdd">Kubernetes</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="kNoqjqaFdH">
                    <label for="kNoqjqaFdH">Language</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="mztxNnvlmg">
                    <label for="mztxNnvlmg">Linux</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="GSKzuYHwLy">
                    <label for="GSKzuYHwLy">Python</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="HzIblMaiDN">
                            <label for="HzIblMaiDN">Data Classes</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="LxRAONqTcL">
                            <label for="LxRAONqTcL">Libraries</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="btOVdGpYOx">
                    <label for="btOVdGpYOx">React</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="TBWsOJsUVM">
                    <label for="TBWsOJsUVM">Regular Expressions</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="whRXIoDVXQ">
                    <label for="whRXIoDVXQ">Rust</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="jhDfqUvZyF">
                            <label for="jhDfqUvZyF">Serde</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="XIjlUqOdTO">
                    <label for="XIjlUqOdTO">Vim</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="kuabQUZnsP">
                    <label for="kuabQUZnsP">Web</label>
                    <ul>
