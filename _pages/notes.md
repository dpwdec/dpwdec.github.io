...
<ul>
    <div name="contents-index">
        ...
        <l>
            <input type="checkbox" id="sPQPaCKUVY" checked>
            <label for="sPQPaCKUVY">Math</label>
            <ul>
                <l>
                    <input type="checkbox" id="ODbXvVIoHm">
                    <label for="ODbXvVIoHm">Exponentials</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="pkjhkFKeUL">
                    <label for="pkjhkFKeUL">Linear Algebra</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="eKwQyUuUNH">
                    <label for="eKwQyUuUNH">Logarithms</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="YqxFkPAujr">
                    <label for="YqxFkPAujr">Sequences</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="YcBUxpCmlD">
                    <label for="YcBUxpCmlD">Single Variable Calculus</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="DhbsSSvMnW">
                    <label for="DhbsSSvMnW">Trigonometry</label>
                    <ul>
        ...
        <l>
            <input type="checkbox" id="WrvMLbzIHp" checked>
            <label for="WrvMLbzIHp">Programming</label>
            <ul>
                <l>
                    <input type="checkbox" id="CYMGsMBZKs">
                    <label for="CYMGsMBZKs">Ansible</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="uNZcWPMYsP">
                    <label for="uNZcWPMYsP">Architecture</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="oemHCMITBj">
                    <label for="oemHCMITBj">Computer Graphics</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="pgEsVZFhyJ">
                    <label for="pgEsVZFhyJ">Databases</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="utfubSboUR">
                    <label for="utfubSboUR">Devops</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="tIIvLmUowd">
                            <label for="tIIvLmUowd">Cloud Providers</label>
                            <ul>
                                <l>
                                    <input type="checkbox" id="aVLCPUjhdv">
                                    <label for="aVLCPUjhdv">AWS</label>
                                    <ul>
                                        <l>
                                            <input type="checkbox" id="LwsrAsoBGd">
                                            <label for="LwsrAsoBGd">Cli</label>
                                            <ul>
                                        ...
                                        <l>
                                            <input type="checkbox" id="IuMlDbsoCt">
                                            <label for="IuMlDbsoCt">Dotnet</label>
                                            <ul>
                                        ...
                                        <l>
                                            <input type="checkbox" id="kHrNbWSRHI">
                                            <label for="kHrNbWSRHI">Ec 2</label>
                                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="skbsHHlLeB">
                            <label for="skbsHHlLeB">Events</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="BDNuHqQwLc">
                            <label for="BDNuHqQwLc">Localstack</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="KsZVWJyhvP">
                            <label for="KsZVWJyhvP">Pulumi</label>
                            <ul>
                                <l>
                                    <input type="checkbox" id="WCNwWHzWTM">
                                    <label for="WCNwWHzWTM">Dotnet</label>
                                    <ul>
                        ...
                        <l>
                            <input type="checkbox" id="oYBEgXmsGr">
                            <label for="oYBEgXmsGr">Serverless Framework</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="LcIhgFItxR">
                            <label for="LcIhgFItxR">Terraform</label>
                            <ul>
                                <l>
                                    <input type="checkbox" id="JHTWzKchAL">
                                    <label for="JHTWzKchAL">Functions</label>
                                    <ul>
                                ...
                                <l>
                                    <input type="checkbox" id="aeoLLeSFYQ">
                                    <label for="aeoLLeSFYQ">Meta Arguments</label>
                                    <ul>
                ...
                <l>
                    <input type="checkbox" id="rCYHSvHpmD">
                    <label for="rCYHSvHpmD">Docker</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="kwSOQTjlPB">
                    <label for="kwSOQTjlPB">Dotnet</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="EudFbIoBNm">
                            <label for="EudFbIoBNm">Cli</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="NRsnItSFNB">
                    <label for="NRsnItSFNB">Functional Programming</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="EjLvtEoCkp">
                    <label for="EjLvtEoCkp">Git</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="EJIRrlqGKH">
                            <label for="EJIRrlqGKH">Github</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="BpReQvoRHL">
                    <label for="BpReQvoRHL">Go</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="QxunuVIDzL">
                    <label for="QxunuVIDzL">Haskell</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="txtcoVMnrD">
                    <label for="txtcoVMnrD">Js</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="abfRWWTcVH">
                            <label for="abfRWWTcVH">Node</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="ecAoLDwfqn">
                            <label for="ecAoLDwfqn">D3</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="STHTiumxkr">
                            <label for="STHTiumxkr">Mocha</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="XFmXQZBsjF">
                            <label for="XFmXQZBsjF">P5js</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="hyiFJuCLjp">
                            <label for="hyiFJuCLjp">Typescript</label>
                            <ul>
                                <l>
                                    <input type="checkbox" id="WxRJatgEYm">
                                    <label for="WxRJatgEYm">Testing</label>
                                    <ul>
                ...
                <l>
                    <input type="checkbox" id="tHEaKiTUeD">
                    <label for="tHEaKiTUeD">Kafka</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="IjyWkkcmfT">
                    <label for="IjyWkkcmfT">Kubernetes</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="sxZktesDrz">
                    <label for="sxZktesDrz">Language</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="TbaaquSxCd">
                    <label for="TbaaquSxCd">Linux</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="efuUberWdU">
                            <label for="efuUberWdU">Bash</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="ecjBlXsznz">
                    <label for="ecjBlXsznz">Oauth</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="OQFcdgfqag">
                    <label for="OQFcdgfqag">Prometheus</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="dcvnOHvMoe">
                    <label for="dcvnOHvMoe">Python</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="PGoBKFBdaN">
                            <label for="PGoBKFBdaN">Data Classes</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="BqxqnjLbQQ">
                            <label for="BqxqnjLbQQ">Libraries</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="jAVLjqLRXP">
                    <label for="jAVLjqLRXP">React</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="JqdACDyPQI">
                    <label for="JqdACDyPQI">Regular Expressions</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="OsbyElGyev">
                    <label for="OsbyElGyev">Rust</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="NnlSSeSEsu">
                            <label for="NnlSSeSEsu">Serde</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="eadzfHupvp">
                    <label for="eadzfHupvp">Shaders</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="HajMDoActH">
                            <label for="HajMDoActH">Glsl</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="PxXTzWKdFa">
                    <label for="PxXTzWKdFa">Vim</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="HOZagFuCRj">
                    <label for="HOZagFuCRj">Web</label>
                    <ul>
