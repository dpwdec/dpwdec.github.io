...
<ul>
    <div name="contents-index">
        ...
        <l>
            <input type="checkbox" id="lrvDXPYSqC" checked>
            <label for="lrvDXPYSqC">Math</label>
            <ul>
                <l>
                    <input type="checkbox" id="esaBjWJRmQ">
                    <label for="esaBjWJRmQ">Exponentials</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="uyIckKZter">
                    <label for="uyIckKZter">Linear Algebra</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="HkbgnfRYpT">
                    <label for="HkbgnfRYpT">Logarithms</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="AACdSAejIN">
                    <label for="AACdSAejIN">Sequences</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="FfGYhIatWT">
                    <label for="FfGYhIatWT">Single Variable Calculus</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="FKFbKtyAaU">
                    <label for="FKFbKtyAaU">Trigonometry</label>
                    <ul>
        ...
        <l>
            <input type="checkbox" id="HLaoSPxxDj" checked>
            <label for="HLaoSPxxDj">Programming</label>
            <ul>
                <l>
                    <input type="checkbox" id="IrDBNTFOCK">
                    <label for="IrDBNTFOCK">Ansible</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="DQCPBfxhbU">
                    <label for="DQCPBfxhbU">Architecture</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="WhGqLokdJF">
                    <label for="WhGqLokdJF">Computer Graphics</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="qlahAfMKfF">
                    <label for="qlahAfMKfF">Databases</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="YapwyPpcCN">
                    <label for="YapwyPpcCN">Devops</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="SCnrkpKMYP">
                            <label for="SCnrkpKMYP">Cloud Computing</label>
                            <ul>
                                <l>
                                    <input type="checkbox" id="pYTCfRVVqM">
                                    <label for="pYTCfRVVqM">AWS</label>
                                    <ul>
                                        <l>
                                            <input type="checkbox" id="ZmaCevMbEg">
                                            <label for="ZmaCevMbEg">Cli</label>
                                            <ul>
                                        ...
                                        <l>
                                            <input type="checkbox" id="WGHVuPeCPb">
                                            <label for="WGHVuPeCPb">Dotnet</label>
                                            <ul>
                                        ...
                                        <l>
                                            <input type="checkbox" id="zKLuDfIPfV">
                                            <label for="zKLuDfIPfV">Ec 2</label>
                                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="MfemDjaMtR">
                            <label for="MfemDjaMtR">Events</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="vyuwGBlSOI">
                            <label for="vyuwGBlSOI">Oauth</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="VXiHsucLEk">
                            <label for="VXiHsucLEk">Pulumi</label>
                            <ul>
                                <l>
                                    <input type="checkbox" id="oleEAThjqR">
                                    <label for="oleEAThjqR">Dotnet</label>
                                    <ul>
                        ...
                        <l>
                            <input type="checkbox" id="gEzrysWPwQ">
                            <label for="gEzrysWPwQ">Terraform</label>
                            <ul>
                                <l>
                                    <input type="checkbox" id="gwmIvukEZg">
                                    <label for="gwmIvukEZg">Functions</label>
                                    <ul>
                                ...
                                <l>
                                    <input type="checkbox" id="FHxCUPOOVY">
                                    <label for="FHxCUPOOVY">Meta Arguments</label>
                                    <ul>
                ...
                <l>
                    <input type="checkbox" id="OiVvSDtETW">
                    <label for="OiVvSDtETW">Docker</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="bukvHbnlAT">
                    <label for="bukvHbnlAT">Dotnet</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="OWcDwzLEpA">
                            <label for="OWcDwzLEpA">Cli</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="eqaTOCKkMu">
                    <label for="eqaTOCKkMu">Functional Programming</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="JmYBEwnpcf">
                    <label for="JmYBEwnpcf">Git</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="qSwljNeZdY">
                            <label for="qSwljNeZdY">Github</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="IdjwlrSEAo">
                    <label for="IdjwlrSEAo">Go</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="DhRgDdNCkQ">
                    <label for="DhRgDdNCkQ">Haskell</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="QuskjBHtsO">
                    <label for="QuskjBHtsO">Js</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="emUHLropKf">
                            <label for="emUHLropKf">Node</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="IDJIlStrjX">
                            <label for="IDJIlStrjX">Mocha</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="FjvIooHZIx">
                            <label for="FjvIooHZIx">P5js</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="HsWqBFncib">
                            <label for="HsWqBFncib">Typescript</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="NmuWyQGXga">
                    <label for="NmuWyQGXga">Kafka</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="sniRoBGZkn">
                    <label for="sniRoBGZkn">Kubernetes</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="jtzkJgaXcA">
                    <label for="jtzkJgaXcA">Language</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="cMaApDJngV">
                    <label for="cMaApDJngV">Linux</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="uebhCWXnBc">
                    <label for="uebhCWXnBc">Python</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="nOylZgPFPl">
                            <label for="nOylZgPFPl">Data Classes</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="HJenuwPuIT">
                            <label for="HJenuwPuIT">Libraries</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="VJvPXVqyOT">
                    <label for="VJvPXVqyOT">React</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="NLmhZaYxjv">
                    <label for="NLmhZaYxjv">Regular Expressions</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="YxKZiGIgXq">
                    <label for="YxKZiGIgXq">Rust</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="FJLfwBLJDL">
                            <label for="FJLfwBLJDL">Serde</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="oUuAluFszK">
                    <label for="oUuAluFszK">Vim</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="zjGZmnTBDf">
                    <label for="zjGZmnTBDf">Web</label>
                    <ul>
