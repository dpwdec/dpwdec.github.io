...
<ul>
    <div name="contents-index">
        ...
        <l>
            <input type="checkbox" id="oXkreACMle" checked>
            <label for="oXkreACMle">Math</label>
            <ul>
                <l>
                    <input type="checkbox" id="ShTMaUucfT">
                    <label for="ShTMaUucfT">Exponentials</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="AfVIEjfYij">
                    <label for="AfVIEjfYij">Linear Algebra</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="ACZFcsFjIf">
                    <label for="ACZFcsFjIf">Logarithms</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="wZhuINNKef">
                    <label for="wZhuINNKef">Sequences</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="rgdAzdfIYL">
                    <label for="rgdAzdfIYL">Single Variable Calculus</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="sULZAZkIyX">
                    <label for="sULZAZkIyX">Trigonometry</label>
                    <ul>
        ...
        <l>
            <input type="checkbox" id="uBBUNcaovD" checked>
            <label for="uBBUNcaovD">Programming</label>
            <ul>
                <l>
                    <input type="checkbox" id="dHQIczcbpQ">
                    <label for="dHQIczcbpQ">Ansible</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="NPmwcAVvsX">
                    <label for="NPmwcAVvsX">Architecture</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="WEGNcjVPwW">
                    <label for="WEGNcjVPwW">Computer Graphics</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="ESbdmJEkPd">
                    <label for="ESbdmJEkPd">Databases</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="GxfTdlPwqy">
                    <label for="GxfTdlPwqy">Devops</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="VkpuELUkPZ">
                            <label for="VkpuELUkPZ">Cloud Providers</label>
                            <ul>
                                <l>
                                    <input type="checkbox" id="OVlOELSWHM">
                                    <label for="OVlOELSWHM">AWS</label>
                                    <ul>
                                        <l>
                                            <input type="checkbox" id="aBCbTMmgjO">
                                            <label for="aBCbTMmgjO">Cli</label>
                                            <ul>
                                        ...
                                        <l>
                                            <input type="checkbox" id="SwNUdFtiMM">
                                            <label for="SwNUdFtiMM">Dotnet</label>
                                            <ul>
                                        ...
                                        <l>
                                            <input type="checkbox" id="ViaduYgtiS">
                                            <label for="ViaduYgtiS">Ec 2</label>
                                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="xoLimSCImW">
                            <label for="xoLimSCImW">Events</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="OMbqtHFIzz">
                            <label for="OMbqtHFIzz">Localstack</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="OLmsFTmizm">
                            <label for="OLmsFTmizm">Pulumi</label>
                            <ul>
                                <l>
                                    <input type="checkbox" id="dGWWXjzjwR">
                                    <label for="dGWWXjzjwR">Dotnet</label>
                                    <ul>
                        ...
                        <l>
                            <input type="checkbox" id="lVCbDBToSd">
                            <label for="lVCbDBToSd">Serverless Framework</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="cqLFwSGYBa">
                            <label for="cqLFwSGYBa">Terraform</label>
                            <ul>
                                <l>
                                    <input type="checkbox" id="zdhqdjAJvc">
                                    <label for="zdhqdjAJvc">Functions</label>
                                    <ul>
                                ...
                                <l>
                                    <input type="checkbox" id="kgmbSQbNmq">
                                    <label for="kgmbSQbNmq">Meta Arguments</label>
                                    <ul>
                ...
                <l>
                    <input type="checkbox" id="jIDPIQnDMF">
                    <label for="jIDPIQnDMF">Docker</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="dgjnIaAdLH">
                    <label for="dgjnIaAdLH">Dotnet</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="ybPvlweZNW">
                            <label for="ybPvlweZNW">Cli</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="bXsLcbzSVl">
                    <label for="bXsLcbzSVl">Functional Programming</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="PnukvKgRVP">
                    <label for="PnukvKgRVP">Git</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="BGaDgZspXK">
                            <label for="BGaDgZspXK">Github</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="YqehMLEapt">
                    <label for="YqehMLEapt">Go</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="qxrJZWtKfs">
                    <label for="qxrJZWtKfs">Haskell</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="mIztMavAWe">
                    <label for="mIztMavAWe">Js</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="AmmOZyIPDm">
                            <label for="AmmOZyIPDm">Node</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="cZRKxZIbkl">
                            <label for="cZRKxZIbkl">D3</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="SVWHDcbKRh">
                            <label for="SVWHDcbKRh">Mocha</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="AGsnDvgfZr">
                            <label for="AGsnDvgfZr">P5js</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="pHacwekkqc">
                            <label for="pHacwekkqc">Typescript</label>
                            <ul>
                                <l>
                                    <input type="checkbox" id="OIwVtKpAcG">
                                    <label for="OIwVtKpAcG">Testing</label>
                                    <ul>
                ...
                <l>
                    <input type="checkbox" id="qOXODeSQEV">
                    <label for="qOXODeSQEV">Kafka</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="zCoCtQJgbU">
                    <label for="zCoCtQJgbU">Kubernetes</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="UBtDidPGuT">
                    <label for="UBtDidPGuT">Language</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="QXJzrVWQjV">
                    <label for="QXJzrVWQjV">Linux</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="SXEtQbwZeJ">
                            <label for="SXEtQbwZeJ">Bash</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="MdzKuUvpCX">
                    <label for="MdzKuUvpCX">Oauth</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="JazcaSfXdA">
                    <label for="JazcaSfXdA">Prometheus</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="bdYrHYEzbK">
                    <label for="bdYrHYEzbK">Python</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="pkyIJBjaHk">
                            <label for="pkyIJBjaHk">Data Classes</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="bkrGxcxsdB">
                            <label for="bkrGxcxsdB">Libraries</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="IfpKvtsznX">
                    <label for="IfpKvtsznX">React</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="CHluTbKLiX">
                    <label for="CHluTbKLiX">Regular Expressions</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="ulcbISpMMq">
                    <label for="ulcbISpMMq">Rust</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="hJwgDvmbTE">
                            <label for="hJwgDvmbTE">Serde</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="MadQVVXIkp">
                    <label for="MadQVVXIkp">Shaders</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="qQMBERnyuT">
                            <label for="qQMBERnyuT">Glsl</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="nHmJAInIuC">
                    <label for="nHmJAInIuC">Vim</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="rLXdrlVKoY">
                    <label for="rLXdrlVKoY">Web</label>
                    <ul>
