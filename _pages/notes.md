...
<ul>
    <div name="contents-index">
        ...
        <l>
            <input type="checkbox" id="QhlANwsuMk" checked>
            <label for="QhlANwsuMk">Math</label>
            <ul>
                <l>
                    <input type="checkbox" id="RwDoPuvyxy">
                    <label for="RwDoPuvyxy">Exponentials</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="jnVIKJtNTj">
                    <label for="jnVIKJtNTj">Linear Algebra</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="eXDlMcCJka">
                    <label for="eXDlMcCJka">Logarithms</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="sYBrRqsaIt">
                    <label for="sYBrRqsaIt">Sequences</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="thmbzdFpdE">
                    <label for="thmbzdFpdE">Single Variable Calculus</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="odhxPoDPJm">
                    <label for="odhxPoDPJm">Trigonometry</label>
                    <ul>
        ...
        <l>
            <input type="checkbox" id="ZFKUtcKqLS" checked>
            <label for="ZFKUtcKqLS">Programming</label>
            <ul>
                <l>
                    <input type="checkbox" id="OqcmkIIQfh">
                    <label for="OqcmkIIQfh">Ansible</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="dNdzerTWcd">
                    <label for="dNdzerTWcd">Architecture</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="MsQzSlwgja">
                    <label for="MsQzSlwgja">Computer Graphics</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="LznOBMGFQr">
                    <label for="LznOBMGFQr">Databases</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="ROfrVqnRUT">
                    <label for="ROfrVqnRUT">Devops</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="NiMQpxCDjE">
                            <label for="NiMQpxCDjE">Cloud Computing</label>
                            <ul>
                                <l>
                                    <input type="checkbox" id="YxmVlUYzXO">
                                    <label for="YxmVlUYzXO">AWS</label>
                                    <ul>
                                        <l>
                                            <input type="checkbox" id="wlcbDWZtIU">
                                            <label for="wlcbDWZtIU">Cli</label>
                                            <ul>
                                        ...
                                        <l>
                                            <input type="checkbox" id="wgCyApAbYq">
                                            <label for="wgCyApAbYq">Dotnet</label>
                                            <ul>
                                        ...
                                        <l>
                                            <input type="checkbox" id="iObRlgAVjc">
                                            <label for="iObRlgAVjc">Ec 2</label>
                                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="MDygStJxiK">
                            <label for="MDygStJxiK">Events</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="pkJyCNzIzR">
                            <label for="pkJyCNzIzR">Oauth</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="faVmJnpDlQ">
                            <label for="faVmJnpDlQ">Pulumi</label>
                            <ul>
                                <l>
                                    <input type="checkbox" id="yYcmAtrNqB">
                                    <label for="yYcmAtrNqB">Dotnet</label>
                                    <ul>
                        ...
                        <l>
                            <input type="checkbox" id="HByUanUkZk">
                            <label for="HByUanUkZk">Terraform</label>
                            <ul>
                                <l>
                                    <input type="checkbox" id="SVOJwdGokq">
                                    <label for="SVOJwdGokq">Functions</label>
                                    <ul>
                                ...
                                <l>
                                    <input type="checkbox" id="ENihHvaMPD">
                                    <label for="ENihHvaMPD">Meta Arguments</label>
                                    <ul>
                ...
                <l>
                    <input type="checkbox" id="IGKryXXERT">
                    <label for="IGKryXXERT">Docker</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="oreBIetNsi">
                    <label for="oreBIetNsi">Dotnet</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="DhGzqBRWlq">
                            <label for="DhGzqBRWlq">Cli</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="jRWyBgMdjG">
                    <label for="jRWyBgMdjG">Functional Programming</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="dopjnHqUOG">
                    <label for="dopjnHqUOG">Git</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="dnNYydfzpz">
                            <label for="dnNYydfzpz">Github</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="vGDPigtCjR">
                    <label for="vGDPigtCjR">Go</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="klMorOcvJu">
                    <label for="klMorOcvJu">Haskell</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="OqtgpsDBxf">
                    <label for="OqtgpsDBxf">Js</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="yNIqkoNSVP">
                            <label for="yNIqkoNSVP">Node</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="hwYrQcVcfC">
                            <label for="hwYrQcVcfC">Mocha</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="BBUFipFnuv">
                            <label for="BBUFipFnuv">P5js</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="BiyvBGnBTM">
                            <label for="BiyvBGnBTM">Typescript</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="YGWkuyqNvy">
                    <label for="YGWkuyqNvy">Kafka</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="aQTVRUcEsl">
                    <label for="aQTVRUcEsl">Kubernetes</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="juxvnBiQsb">
                    <label for="juxvnBiQsb">Language</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="nfEWKxXjql">
                    <label for="nfEWKxXjql">Linux</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="dSVyYwaPVx">
                    <label for="dSVyYwaPVx">Python</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="cvwtwuSKYA">
                            <label for="cvwtwuSKYA">Data Classes</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="RdhMplAsfy">
                            <label for="RdhMplAsfy">Libraries</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="DnrXeRUkmo">
                    <label for="DnrXeRUkmo">React</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="EqdCbQeBwW">
                    <label for="EqdCbQeBwW">Regular Expressions</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="ntKANpuyUQ">
                    <label for="ntKANpuyUQ">Rust</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="nhbNaYEPwR">
                            <label for="nhbNaYEPwR">Serde</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="zJwJinPJFj">
                    <label for="zJwJinPJFj">Vim</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="iUcNGdHAva">
                    <label for="iUcNGdHAva">Web</label>
                    <ul>
