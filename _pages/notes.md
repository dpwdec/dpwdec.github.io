...
<ul>
    <div name="contents-index">
        ...
        <l>
            <input type="checkbox" id="KvKhxdnhrQ" checked>
            <label for="KvKhxdnhrQ">Math</label>
            <ul>
                <l>
                    <input type="checkbox" id="tfsmkumoeP">
                    <label for="tfsmkumoeP">Exponentials</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="pvUFpkAyfq">
                    <label for="pvUFpkAyfq">Linear Algebra</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="yQbbmqJmJz">
                    <label for="yQbbmqJmJz">Logarithms</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="pRoXIXfTMH">
                    <label for="pRoXIXfTMH">Sequences</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="cdAXeACejZ">
                    <label for="cdAXeACejZ">Single Variable Calculus</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="qRDAfqywdz">
                    <label for="qRDAfqywdz">Trigonometry</label>
                    <ul>
        ...
        <l>
            <input type="checkbox" id="QPAngiieRE" checked>
            <label for="QPAngiieRE">Programming</label>
            <ul>
                <l>
                    <input type="checkbox" id="cEkybRcaeo">
                    <label for="cEkybRcaeo">Ansible</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="tKJKPAaxmA">
                    <label for="tKJKPAaxmA">Architecture</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="WMMLzuudqU">
                    <label for="WMMLzuudqU">Computer Graphics</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="hGqnYNrDwx">
                    <label for="hGqnYNrDwx">Databases</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="cOYpoEGDRe">
                    <label for="cOYpoEGDRe">Devops</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="uSTKkJMrfm">
                            <label for="uSTKkJMrfm">Cloud Computing</label>
                            <ul>
                                <l>
                                    <input type="checkbox" id="OSUCMjyJzU">
                                    <label for="OSUCMjyJzU">AWS</label>
                                    <ul>
                                        <l>
                                            <input type="checkbox" id="IlhKiTvasr">
                                            <label for="IlhKiTvasr">Cli</label>
                                            <ul>
                                        ...
                                        <l>
                                            <input type="checkbox" id="PuFtFBZjqx">
                                            <label for="PuFtFBZjqx">Dotnet</label>
                                            <ul>
                                        ...
                                        <l>
                                            <input type="checkbox" id="iXJFCVZrok">
                                            <label for="iXJFCVZrok">Ec 2</label>
                                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="BvbfmQCLyR">
                            <label for="BvbfmQCLyR">Events</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="QWMHlsRuLy">
                            <label for="QWMHlsRuLy">Oauth</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="evCwnvxKQB">
                            <label for="evCwnvxKQB">Pulumi</label>
                            <ul>
                                <l>
                                    <input type="checkbox" id="FtMScLhuqs">
                                    <label for="FtMScLhuqs">Dotnet</label>
                                    <ul>
                        ...
                        <l>
                            <input type="checkbox" id="shZRerGYen">
                            <label for="shZRerGYen">Terraform</label>
                            <ul>
                                <l>
                                    <input type="checkbox" id="QQytHahEQz">
                                    <label for="QQytHahEQz">Functions</label>
                                    <ul>
                                ...
                                <l>
                                    <input type="checkbox" id="qyfNxlDrSk">
                                    <label for="qyfNxlDrSk">Meta Arguments</label>
                                    <ul>
                ...
                <l>
                    <input type="checkbox" id="iRBlGIGbSU">
                    <label for="iRBlGIGbSU">Docker</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="WCvwWmiXFy">
                    <label for="WCvwWmiXFy">Dotnet</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="shgiFsHztj">
                            <label for="shgiFsHztj">Cli</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="xPFRBfiizS">
                    <label for="xPFRBfiizS">Functional Programming</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="UkbduuUOnu">
                    <label for="UkbduuUOnu">Git</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="WvPfsOGMBk">
                            <label for="WvPfsOGMBk">Github</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="sajfwmmwlL">
                    <label for="sajfwmmwlL">Go</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="yaTNnICrbC">
                    <label for="yaTNnICrbC">Haskell</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="EIGvYjjYvv">
                    <label for="EIGvYjjYvv">Js</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="HbsUXHcmqG">
                            <label for="HbsUXHcmqG">Node</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="VscFaEucAU">
                            <label for="VscFaEucAU">Mocha</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="oESnkCepHP">
                            <label for="oESnkCepHP">P5js</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="HzrNsmVdhE">
                            <label for="HzrNsmVdhE">Typescript</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="IobgFhpIOM">
                    <label for="IobgFhpIOM">Kafka</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="JfKBnZamHf">
                    <label for="JfKBnZamHf">Kubernetes</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="RgckJoUaKZ">
                    <label for="RgckJoUaKZ">Language</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="aPhSlTcJgk">
                    <label for="aPhSlTcJgk">Linux</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="rttoNSpnRK">
                    <label for="rttoNSpnRK">Python</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="gjOAQmvkLX">
                            <label for="gjOAQmvkLX">Data Classes</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="CtVtvJaQLr">
                            <label for="CtVtvJaQLr">Libraries</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="tIopKiRYsG">
                    <label for="tIopKiRYsG">React</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="cwBlslOQze">
                    <label for="cwBlslOQze">Regular Expressions</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="iGhWAZKsKA">
                    <label for="iGhWAZKsKA">Rust</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="IijlQDKumT">
                            <label for="IijlQDKumT">Serde</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="qDWmbxwwFo">
                    <label for="qDWmbxwwFo">Vim</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="cDRCocQPpZ">
                    <label for="cDRCocQPpZ">Web</label>
                    <ul>
