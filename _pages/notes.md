...
<ul>
    <div name="contents-index">
        ...
        <l>
            <input type="checkbox" id="wYLvnwqbdy" checked>
            <label for="wYLvnwqbdy">Math</label>
            <ul>
                <l>
                    <input type="checkbox" id="WlNMWnTHbC">
                    <label for="WlNMWnTHbC">Exponentials</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="DkyrgjcBQf">
                    <label for="DkyrgjcBQf">Linear Algebra</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="lVaVCyeUsP">
                    <label for="lVaVCyeUsP">Logarithms</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="DHJAGSLJIO">
                    <label for="DHJAGSLJIO">Sequences</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="utfMiIzbWW">
                    <label for="utfMiIzbWW">Single Variable Calculus</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="RhHxwDPxyF">
                    <label for="RhHxwDPxyF">Trigonometry</label>
                    <ul>
        ...
        <l>
            <input type="checkbox" id="RUvUhAYuFW" checked>
            <label for="RUvUhAYuFW">Programming</label>
            <ul>
                <l>
                    <input type="checkbox" id="QVWmesiTkM">
                    <label for="QVWmesiTkM">Ansible</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="NokwqqdcJw">
                    <label for="NokwqqdcJw">Architecture</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="sJSDcaGkrx">
                    <label for="sJSDcaGkrx">Computer Graphics</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="iiUAWJGBQG">
                    <label for="iiUAWJGBQG">Databases</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="FaFbkAQoFN">
                    <label for="FaFbkAQoFN">Devops</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="DxpsVOfcVl">
                            <label for="DxpsVOfcVl">Cloud Computing</label>
                            <ul>
                                <l>
                                    <input type="checkbox" id="eYRSGpaFNG">
                                    <label for="eYRSGpaFNG">AWS</label>
                                    <ul>
                                        <l>
                                            <input type="checkbox" id="SkvInvlUjc">
                                            <label for="SkvInvlUjc">Cli</label>
                                            <ul>
                                        ...
                                        <l>
                                            <input type="checkbox" id="oNlHMcSwcW">
                                            <label for="oNlHMcSwcW">Dotnet</label>
                                            <ul>
                                        ...
                                        <l>
                                            <input type="checkbox" id="PGHTQSpnVm">
                                            <label for="PGHTQSpnVm">Ec 2</label>
                                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="SfHbiRQThk">
                            <label for="SfHbiRQThk">Events</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="OKOagsLrrO">
                            <label for="OKOagsLrrO">Oauth</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="izCYJBMqEj">
                            <label for="izCYJBMqEj">Pulumi</label>
                            <ul>
                                <l>
                                    <input type="checkbox" id="vLAgkeVryL">
                                    <label for="vLAgkeVryL">Dotnet</label>
                                    <ul>
                        ...
                        <l>
                            <input type="checkbox" id="VslhDIzGPx">
                            <label for="VslhDIzGPx">Terraform</label>
                            <ul>
                                <l>
                                    <input type="checkbox" id="lcLGjomQby">
                                    <label for="lcLGjomQby">Functions</label>
                                    <ul>
                                ...
                                <l>
                                    <input type="checkbox" id="kAgSkJlhTF">
                                    <label for="kAgSkJlhTF">Meta Arguments</label>
                                    <ul>
                ...
                <l>
                    <input type="checkbox" id="AoyZKSBFBf">
                    <label for="AoyZKSBFBf">Docker</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="IKrRCRxrkt">
                    <label for="IKrRCRxrkt">Dotnet</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="plaXcqjfHC">
                            <label for="plaXcqjfHC">Cli</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="IsLrVXeCIw">
                    <label for="IsLrVXeCIw">Functional Programming</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="OaAVGeibuw">
                    <label for="OaAVGeibuw">Git</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="FHodoUBKpo">
                            <label for="FHodoUBKpo">Github</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="EWoVRHyNly">
                    <label for="EWoVRHyNly">Go</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="xdlLkQEqtu">
                    <label for="xdlLkQEqtu">Haskell</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="tqRmxYvKOo">
                    <label for="tqRmxYvKOo">Js</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="qGKNafbEmL">
                            <label for="qGKNafbEmL">Node</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="LNjBZwcbbw">
                            <label for="LNjBZwcbbw">Mocha</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="SjyizGPAVB">
                            <label for="SjyizGPAVB">P5js</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="yDHQdfgRtz">
                            <label for="yDHQdfgRtz">Typescript</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="IsMUfqcIwp">
                    <label for="IsMUfqcIwp">Kafka</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="lNDhfWNTCD">
                    <label for="lNDhfWNTCD">Kubernetes</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="QEgsMVkOmO">
                    <label for="QEgsMVkOmO">Language</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="HYvkAsAbYy">
                    <label for="HYvkAsAbYy">Linux</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="jNyzOolUnO">
                    <label for="jNyzOolUnO">Python</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="HLGcrKCtnq">
                            <label for="HLGcrKCtnq">Data Classes</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="SbqfUViJYC">
                            <label for="SbqfUViJYC">Libraries</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="IHymTfRekh">
                    <label for="IHymTfRekh">React</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="lwTukmSvsW">
                    <label for="lwTukmSvsW">Regular Expressions</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="oSoyiWmuGK">
                    <label for="oSoyiWmuGK">Rust</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="sCKAJkJdnB">
                            <label for="sCKAJkJdnB">Serde</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="PSfpwvMgWY">
                    <label for="PSfpwvMgWY">Vim</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="rxGaAPgRHq">
                    <label for="rxGaAPgRHq">Web</label>
                    <ul>
