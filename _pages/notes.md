...
<ul>
    <div name="contents-index">
        ...
        <l>
            <input type="checkbox" id="JRXAKtwZat" checked>
            <label for="JRXAKtwZat">Math</label>
            <ul>
                <l>
                    <input type="checkbox" id="wxkaZXdHnS">
                    <label for="wxkaZXdHnS">Exponentials</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="SaVQckaiXM">
                    <label for="SaVQckaiXM">Linear Algebra</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="clxzNNHVnF">
                    <label for="clxzNNHVnF">Logarithms</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="aTCgbODGSd">
                    <label for="aTCgbODGSd">Sequences</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="iQrfnsCZjS">
                    <label for="iQrfnsCZjS">Single Variable Calculus</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="Dckqnbkuju">
                    <label for="Dckqnbkuju">Trigonometry</label>
                    <ul>
        ...
        <l>
            <input type="checkbox" id="krEZyWaFzZ" checked>
            <label for="krEZyWaFzZ">Programming</label>
            <ul>
                <l>
                    <input type="checkbox" id="ehNLvRiYNn">
                    <label for="ehNLvRiYNn">Ansible</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="ALvjuffVcd">
                    <label for="ALvjuffVcd">Architecture</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="BDxVoSUYww">
                    <label for="BDxVoSUYww">Computer Graphics</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="lPfgMVLbNi">
                    <label for="lPfgMVLbNi">Databases</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="dMTBJDPlAU">
                    <label for="dMTBJDPlAU">Devops</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="MzsPhioBQz">
                            <label for="MzsPhioBQz">Cloud Providers</label>
                            <ul>
                                <l>
                                    <input type="checkbox" id="pqDrNsoWqf">
                                    <label for="pqDrNsoWqf">AWS</label>
                                    <ul>
                                        <l>
                                            <input type="checkbox" id="BVAtTxRcJo">
                                            <label for="BVAtTxRcJo">Cli</label>
                                            <ul>
                                        ...
                                        <l>
                                            <input type="checkbox" id="hnTZObAWAB">
                                            <label for="hnTZObAWAB">Dotnet</label>
                                            <ul>
                                        ...
                                        <l>
                                            <input type="checkbox" id="FIfpgBtmqw">
                                            <label for="FIfpgBtmqw">Ec 2</label>
                                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="vbcxbJnjrb">
                            <label for="vbcxbJnjrb">Events</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="czuPzuRwsb">
                            <label for="czuPzuRwsb">Localstack</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="cKFhQBFtAl">
                            <label for="cKFhQBFtAl">Pulumi</label>
                            <ul>
                                <l>
                                    <input type="checkbox" id="nFJOpegmcl">
                                    <label for="nFJOpegmcl">Dotnet</label>
                                    <ul>
                        ...
                        <l>
                            <input type="checkbox" id="HKNtWCmYmQ">
                            <label for="HKNtWCmYmQ">Serverless Framework</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="UoIIjCbXSj">
                            <label for="UoIIjCbXSj">Terraform</label>
                            <ul>
                                <l>
                                    <input type="checkbox" id="krAHiJEKuh">
                                    <label for="krAHiJEKuh">Functions</label>
                                    <ul>
                                ...
                                <l>
                                    <input type="checkbox" id="DLLWnUwXGk">
                                    <label for="DLLWnUwXGk">Meta Arguments</label>
                                    <ul>
                ...
                <l>
                    <input type="checkbox" id="rllNqJDbfd">
                    <label for="rllNqJDbfd">Docker</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="otvGVTivGF">
                    <label for="otvGVTivGF">Dotnet</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="HZOelEssIP">
                            <label for="HZOelEssIP">Cli</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="brvTfDEJmR">
                    <label for="brvTfDEJmR">Functional Programming</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="wNeRENGZjq">
                    <label for="wNeRENGZjq">Git</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="HwvSlrmCkw">
                            <label for="HwvSlrmCkw">Github</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="vqWMLjfmmE">
                    <label for="vqWMLjfmmE">Go</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="tTyvSBzoZY">
                    <label for="tTyvSBzoZY">Haskell</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="LSBWTbSjEc">
                    <label for="LSBWTbSjEc">Js</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="OEKphbmVKR">
                            <label for="OEKphbmVKR">Node</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="jcPCTZHtwL">
                            <label for="jcPCTZHtwL">D3</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="WQsdvZqhmY">
                            <label for="WQsdvZqhmY">Mocha</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="fxEaiPNDXK">
                            <label for="fxEaiPNDXK">P5js</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="uWUVPnKzQy">
                            <label for="uWUVPnKzQy">Typescript</label>
                            <ul>
                                <l>
                                    <input type="checkbox" id="qGWJLagbJu">
                                    <label for="qGWJLagbJu">Testing</label>
                                    <ul>
                ...
                <l>
                    <input type="checkbox" id="ksVajFuiEP">
                    <label for="ksVajFuiEP">Kafka</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="NEVwbGMHUx">
                    <label for="NEVwbGMHUx">Kubernetes</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="mhWYBHdozc">
                    <label for="mhWYBHdozc">Language</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="hqGEsNVsdb">
                    <label for="hqGEsNVsdb">Linux</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="XeTtSjEXza">
                            <label for="XeTtSjEXza">Bash</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="yrtQGIuapI">
                    <label for="yrtQGIuapI">Oauth</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="QmVCMKkYDE">
                    <label for="QmVCMKkYDE">Python</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="SptGeCRDaa">
                            <label for="SptGeCRDaa">Data Classes</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="wwxIChGSrT">
                            <label for="wwxIChGSrT">Libraries</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="hSXXXkmzSx">
                    <label for="hSXXXkmzSx">React</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="PLoXuYgLDe">
                    <label for="PLoXuYgLDe">Regular Expressions</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="fMlimMAJnb">
                    <label for="fMlimMAJnb">Rust</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="dMoyKCTZyY">
                            <label for="dMoyKCTZyY">Serde</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="iDnzwhwYEU">
                    <label for="iDnzwhwYEU">Shaders</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="FiCsSGjMlr">
                            <label for="FiCsSGjMlr">Glsl</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="KdYnMGjdZN">
                    <label for="KdYnMGjdZN">Vim</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="PbfVfjdqim">
                    <label for="PbfVfjdqim">Web</label>
                    <ul>
