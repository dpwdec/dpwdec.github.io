...
<ul>
    <div name="contents-index">
        ...
        <l>
            <input type="checkbox" id="vwTYOtKXBb" checked>
            <label for="vwTYOtKXBb">Math</label>
            <ul>
                <l>
                    <input type="checkbox" id="RpVqGVspPl">
                    <label for="RpVqGVspPl">Exponentials</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="vROSDLYDJt">
                    <label for="vROSDLYDJt">Linear Algebra</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="UCUEDVdqjl">
                    <label for="UCUEDVdqjl">Logarithms</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="GAvaZQViiy">
                    <label for="GAvaZQViiy">Sequences</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="cXejkCdehz">
                    <label for="cXejkCdehz">Single Variable Calculus</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="zFwdOCdcXx">
                    <label for="zFwdOCdcXx">Trigonometry</label>
                    <ul>
        ...
        <l>
            <input type="checkbox" id="YaUARLSVXy" checked>
            <label for="YaUARLSVXy">Programming</label>
            <ul>
                <l>
                    <input type="checkbox" id="jyDIKZcNFQ">
                    <label for="jyDIKZcNFQ">Ansible</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="EwEJAXokAy">
                    <label for="EwEJAXokAy">Architecture</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="VSLoejkGtS">
                    <label for="VSLoejkGtS">Computer Graphics</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="VxHtuYtakE">
                    <label for="VxHtuYtakE">Databases</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="NvUPHcdDCf">
                    <label for="NvUPHcdDCf">Devops</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="MbYDiWzuFW">
                            <label for="MbYDiWzuFW">Cloud Providers</label>
                            <ul>
                                <l>
                                    <input type="checkbox" id="VMBptniewM">
                                    <label for="VMBptniewM">AWS</label>
                                    <ul>
                                        <l>
                                            <input type="checkbox" id="uPQucwDJKh">
                                            <label for="uPQucwDJKh">Cli</label>
                                            <ul>
                                        ...
                                        <l>
                                            <input type="checkbox" id="cPqzJIUxnS">
                                            <label for="cPqzJIUxnS">Dotnet</label>
                                            <ul>
                                        ...
                                        <l>
                                            <input type="checkbox" id="utbyKfHrqs">
                                            <label for="utbyKfHrqs">Ec 2</label>
                                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="CXDbxwsUah">
                            <label for="CXDbxwsUah">Events</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="gBFAbjVOlb">
                            <label for="gBFAbjVOlb">Localstack</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="bEYhQIncKv">
                            <label for="bEYhQIncKv">Pulumi</label>
                            <ul>
                                <l>
                                    <input type="checkbox" id="IgGtmwUlkk">
                                    <label for="IgGtmwUlkk">Dotnet</label>
                                    <ul>
                        ...
                        <l>
                            <input type="checkbox" id="oXzuoMaszX">
                            <label for="oXzuoMaszX">Serverless Framework</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="CeJzLNsitl">
                            <label for="CeJzLNsitl">Terraform</label>
                            <ul>
                                <l>
                                    <input type="checkbox" id="eOleKdKYFW">
                                    <label for="eOleKdKYFW">Functions</label>
                                    <ul>
                                ...
                                <l>
                                    <input type="checkbox" id="TIimoxRDvb">
                                    <label for="TIimoxRDvb">Meta Arguments</label>
                                    <ul>
                ...
                <l>
                    <input type="checkbox" id="TxbTqaBpzT">
                    <label for="TxbTqaBpzT">Docker</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="lukrsMhWLh">
                    <label for="lukrsMhWLh">Dotnet</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="zHdJWLGWij">
                            <label for="zHdJWLGWij">Cli</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="rjLnVATvSc">
                    <label for="rjLnVATvSc">Functional Programming</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="WeqrNyymCK">
                    <label for="WeqrNyymCK">Git</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="QwdWGUIopL">
                            <label for="QwdWGUIopL">Github</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="vFRQlrWrPB">
                    <label for="vFRQlrWrPB">Go</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="TPcAdtKFgi">
                    <label for="TPcAdtKFgi">Haskell</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="miRpZlJFRX">
                    <label for="miRpZlJFRX">Js</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="eHPJgTAnbR">
                            <label for="eHPJgTAnbR">Node</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="AmYUePaKTB">
                            <label for="AmYUePaKTB">D3</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="PjQUXfXVyr">
                            <label for="PjQUXfXVyr">Mocha</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="aAyEbLVFCr">
                            <label for="aAyEbLVFCr">P5js</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="fFZkzqsurr">
                            <label for="fFZkzqsurr">Typescript</label>
                            <ul>
                                <l>
                                    <input type="checkbox" id="PiwhQUdSUM">
                                    <label for="PiwhQUdSUM">Testing</label>
                                    <ul>
                ...
                <l>
                    <input type="checkbox" id="naxWAkbQvu">
                    <label for="naxWAkbQvu">Kafka</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="csuLDrIvqP">
                    <label for="csuLDrIvqP">Kubernetes</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="zHYvysScpY">
                    <label for="zHYvysScpY">Language</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="wHkRaOIzab">
                    <label for="wHkRaOIzab">Linux</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="FhaZqJgcUR">
                            <label for="FhaZqJgcUR">Bash</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="BmiXBGeZXm">
                    <label for="BmiXBGeZXm">Oauth</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="EJIorlfAMK">
                    <label for="EJIorlfAMK">Prometheus</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="pvYjnVfQXH">
                    <label for="pvYjnVfQXH">Python</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="WnKfgQVaVX">
                            <label for="WnKfgQVaVX">Data Classes</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="MGqQolczbi">
                            <label for="MGqQolczbi">Libraries</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="EvjJiNdTCQ">
                    <label for="EvjJiNdTCQ">React</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="wgVUavbjTT">
                    <label for="wgVUavbjTT">Regular Expressions</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="hZbadGsbAX">
                    <label for="hZbadGsbAX">Rust</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="GYoKVJYuzq">
                            <label for="GYoKVJYuzq">Serde</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="ZFkGOYQHdW">
                    <label for="ZFkGOYQHdW">Shaders</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="pyGUabdQze">
                            <label for="pyGUabdQze">Glsl</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="JPWtzKlOUZ">
                    <label for="JPWtzKlOUZ">Vim</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="PWEjkrlrCj">
                    <label for="PWEjkrlrCj">Web</label>
                    <ul>
