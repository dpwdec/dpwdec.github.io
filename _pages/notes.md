...
<ul>
    <div name="contents-index">
        ...
        <l>
            <input type="checkbox" id="ECcecwhdqq" checked>
            <label for="ECcecwhdqq">Math</label>
            <ul>
                <l>
                    <input type="checkbox" id="CoVEzTLInU">
                    <label for="CoVEzTLInU">Exponentials</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="uuOEAdZZcP">
                    <label for="uuOEAdZZcP">Linear Algebra</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="hCKOexoZJc">
                    <label for="hCKOexoZJc">Logarithms</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="ViIqufEVyB">
                    <label for="ViIqufEVyB">Sequences</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="cfWgNSlhgM">
                    <label for="cfWgNSlhgM">Single Variable Calculus</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="yEuPetJnbb">
                    <label for="yEuPetJnbb">Trigonometry</label>
                    <ul>
        ...
        <l>
            <input type="checkbox" id="wiGsezdPeh" checked>
            <label for="wiGsezdPeh">Programming</label>
            <ul>
                <l>
                    <input type="checkbox" id="PahhmnUtEO">
                    <label for="PahhmnUtEO">Ansible</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="bZExKVnYVz">
                    <label for="bZExKVnYVz">Architecture</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="rkNjteuGOE">
                    <label for="rkNjteuGOE">Computer Graphics</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="dSOvNwHKvm">
                    <label for="dSOvNwHKvm">Databases</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="goAGoFkmVn">
                    <label for="goAGoFkmVn">Devops</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="MPHncMPcQk">
                            <label for="MPHncMPcQk">Cloud Computing</label>
                            <ul>
                                <l>
                                    <input type="checkbox" id="IqRrSApEEa">
                                    <label for="IqRrSApEEa">AWS</label>
                                    <ul>
                                        <l>
                                            <input type="checkbox" id="APEwDYQZWC">
                                            <label for="APEwDYQZWC">Cli</label>
                                            <ul>
                                        ...
                                        <l>
                                            <input type="checkbox" id="NtEjtSXAId">
                                            <label for="NtEjtSXAId">Dotnet</label>
                                            <ul>
                                        ...
                                        <l>
                                            <input type="checkbox" id="QtMMmrJTbG">
                                            <label for="QtMMmrJTbG">Ec 2</label>
                                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="iqRqlVESMS">
                            <label for="iqRqlVESMS">Events</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="WYvRVJUmwl">
                            <label for="WYvRVJUmwl">Oauth</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="GjifkQWBCr">
                            <label for="GjifkQWBCr">Pulumi</label>
                            <ul>
                                <l>
                                    <input type="checkbox" id="YVhpeMNtyA">
                                    <label for="YVhpeMNtyA">Dotnet</label>
                                    <ul>
                        ...
                        <l>
                            <input type="checkbox" id="IkGvAPorTV">
                            <label for="IkGvAPorTV">Terraform</label>
                            <ul>
                                <l>
                                    <input type="checkbox" id="FErfFSmFLV">
                                    <label for="FErfFSmFLV">Functions</label>
                                    <ul>
                                ...
                                <l>
                                    <input type="checkbox" id="YzbcjicRwd">
                                    <label for="YzbcjicRwd">Meta Arguments</label>
                                    <ul>
                ...
                <l>
                    <input type="checkbox" id="AkRdiHTNgi">
                    <label for="AkRdiHTNgi">Docker</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="ZAcuJiwyHX">
                    <label for="ZAcuJiwyHX">Dotnet</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="DmpdXvUycg">
                            <label for="DmpdXvUycg">Cli</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="doCyCEjqoX">
                    <label for="doCyCEjqoX">Functional Programming</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="GcAyPyKPRw">
                    <label for="GcAyPyKPRw">Git</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="meCugrJBcB">
                            <label for="meCugrJBcB">Github</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="gSrkRoybGf">
                    <label for="gSrkRoybGf">Go</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="QsQBjSdIdT">
                    <label for="QsQBjSdIdT">Haskell</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="DPiVwzPdbL">
                    <label for="DPiVwzPdbL">Js</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="ErunsTahFa">
                            <label for="ErunsTahFa">Node</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="XryEeGPBGn">
                            <label for="XryEeGPBGn">Mocha</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="zwgqcCeziv">
                            <label for="zwgqcCeziv">P5js</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="VZYJbPkyEl">
                            <label for="VZYJbPkyEl">Typescript</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="lVawjnqiiF">
                    <label for="lVawjnqiiF">Kafka</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="dXIgBvjQwW">
                    <label for="dXIgBvjQwW">Kubernetes</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="LuKLQTCRWn">
                    <label for="LuKLQTCRWn">Language</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="cZuKoAmOJh">
                    <label for="cZuKoAmOJh">Linux</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="hKLEIKpeky">
                    <label for="hKLEIKpeky">Python</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="XwqDpNXXrt">
                            <label for="XwqDpNXXrt">Data Classes</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="thSWgHOEHP">
                            <label for="thSWgHOEHP">Libraries</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="kLIlBMedsI">
                    <label for="kLIlBMedsI">React</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="WyDNCckisl">
                    <label for="WyDNCckisl">Regular Expressions</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="ovqDBZZseh">
                    <label for="ovqDBZZseh">Rust</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="gPQEgSmaxf">
                            <label for="gPQEgSmaxf">Serde</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="eUBHeyixIC">
                    <label for="eUBHeyixIC">Vim</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="rDJUMYNINI">
                    <label for="rDJUMYNINI">Web</label>
                    <ul>
