...
<ul>
    <div name="contents-index">
        ...
        <l>
            <input type="checkbox" id="ERgoysRrSS" checked>
            <label for="ERgoysRrSS">Math</label>
            <ul>
                <l>
                    <input type="checkbox" id="TNAzsZWpMk">
                    <label for="TNAzsZWpMk">Exponentials</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="iRPBuQgzYU">
                    <label for="iRPBuQgzYU">Linear Algebra</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="YzNHAyJCEa">
                    <label for="YzNHAyJCEa">Logarithms</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="nqFhvRpGoI">
                    <label for="nqFhvRpGoI">Sequences</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="JofnSKJHgz">
                    <label for="JofnSKJHgz">Single Variable Calculus</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="nbpmJjYwZS">
                    <label for="nbpmJjYwZS">Trigonometry</label>
                    <ul>
        ...
        <l>
            <input type="checkbox" id="DjShhdZjdd" checked>
            <label for="DjShhdZjdd">Programming</label>
            <ul>
                <l>
                    <input type="checkbox" id="BQfOfYxYFp">
                    <label for="BQfOfYxYFp">Ansible</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="jKlGRNMZKQ">
                    <label for="jKlGRNMZKQ">Architecture</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="WttPRFOKqu">
                    <label for="WttPRFOKqu">Computer Graphics</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="AMcHDqBFpq">
                    <label for="AMcHDqBFpq">Databases</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="OwQBrLYpzj">
                    <label for="OwQBrLYpzj">Devops</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="tnDCSsTFgs">
                            <label for="tnDCSsTFgs">Cloud Providers</label>
                            <ul>
                                <l>
                                    <input type="checkbox" id="QqWxecDpOu">
                                    <label for="QqWxecDpOu">AWS</label>
                                    <ul>
                                        <l>
                                            <input type="checkbox" id="TiDSklhgGa">
                                            <label for="TiDSklhgGa">Cli</label>
                                            <ul>
                                        ...
                                        <l>
                                            <input type="checkbox" id="CYSzqhKMHc">
                                            <label for="CYSzqhKMHc">Dotnet</label>
                                            <ul>
                                        ...
                                        <l>
                                            <input type="checkbox" id="EBQuMvbizd">
                                            <label for="EBQuMvbizd">Ec 2</label>
                                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="RSpLJPUhGZ">
                            <label for="RSpLJPUhGZ">Events</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="UDCmJNKNsg">
                            <label for="UDCmJNKNsg">Localstack</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="hUJxxchhxv">
                            <label for="hUJxxchhxv">Pulumi</label>
                            <ul>
                                <l>
                                    <input type="checkbox" id="tGMIEZbecK">
                                    <label for="tGMIEZbecK">Dotnet</label>
                                    <ul>
                        ...
                        <l>
                            <input type="checkbox" id="oXlXnXgyIr">
                            <label for="oXlXnXgyIr">Serverless Framework</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="wykFLgLtJJ">
                            <label for="wykFLgLtJJ">Terraform</label>
                            <ul>
                                <l>
                                    <input type="checkbox" id="cMnsAacuUp">
                                    <label for="cMnsAacuUp">Functions</label>
                                    <ul>
                                ...
                                <l>
                                    <input type="checkbox" id="ukBsXIlrBN">
                                    <label for="ukBsXIlrBN">Meta Arguments</label>
                                    <ul>
                ...
                <l>
                    <input type="checkbox" id="qJebshjimM">
                    <label for="qJebshjimM">Docker</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="lmpfZJrcXC">
                    <label for="lmpfZJrcXC">Dotnet</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="DqyjRwKohS">
                            <label for="DqyjRwKohS">Cli</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="knWifyPtef">
                    <label for="knWifyPtef">Functional Programming</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="VaEDzqRvcH">
                    <label for="VaEDzqRvcH">Git</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="HObpeKvMDt">
                            <label for="HObpeKvMDt">Github</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="qUVWCIjmlk">
                    <label for="qUVWCIjmlk">Go</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="CfejZZqjwG">
                    <label for="CfejZZqjwG">Haskell</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="EfAoOroinv">
                    <label for="EfAoOroinv">Js</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="xWaLLsFrGI">
                            <label for="xWaLLsFrGI">Node</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="WDeiQdHoxh">
                            <label for="WDeiQdHoxh">D3</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="UfWZzVljXZ">
                            <label for="UfWZzVljXZ">Mocha</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="juJyQdQxUy">
                            <label for="juJyQdQxUy">P5js</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="jjBiskoBYu">
                            <label for="jjBiskoBYu">Typescript</label>
                            <ul>
                                <l>
                                    <input type="checkbox" id="CSsGnQfqdy">
                                    <label for="CSsGnQfqdy">Testing</label>
                                    <ul>
                ...
                <l>
                    <input type="checkbox" id="sfwHkQBOSA">
                    <label for="sfwHkQBOSA">Kafka</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="JsmtmzAyMt">
                    <label for="JsmtmzAyMt">Kubernetes</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="YjXcSkwCdB">
                    <label for="YjXcSkwCdB">Language</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="DjjgECJNIY">
                    <label for="DjjgECJNIY">Linux</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="skDFGVcDwx">
                            <label for="skDFGVcDwx">Bash</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="JhZaznqkcJ">
                    <label for="JhZaznqkcJ">Oauth</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="ZhADMirfeS">
                    <label for="ZhADMirfeS">Prometheus</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="uYpVYQyeSD">
                    <label for="uYpVYQyeSD">Python</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="fjhyBAGpDB">
                            <label for="fjhyBAGpDB">Data Classes</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="DuOVBWiHNF">
                            <label for="DuOVBWiHNF">Libraries</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="SHAqNgPUhX">
                    <label for="SHAqNgPUhX">React</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="tqMKtaGpLw">
                    <label for="tqMKtaGpLw">Regular Expressions</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="tPELOdATUO">
                    <label for="tPELOdATUO">Rust</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="guJnffrpNs">
                            <label for="guJnffrpNs">Serde</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="UnttTWhQPY">
                    <label for="UnttTWhQPY">Shaders</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="UOexUylDWh">
                            <label for="UOexUylDWh">Glsl</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="YNZJkdaOte">
                    <label for="YNZJkdaOte">Vim</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="kyjLRxybQn">
                    <label for="kyjLRxybQn">Web</label>
                    <ul>
