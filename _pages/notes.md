...
<ul>
    <div name="contents-index">
        ...
        <l>
            <input type="checkbox" id="oGgOSzhUHg" checked>
            <label for="oGgOSzhUHg">Math</label>
            <ul>
                <l>
                    <input type="checkbox" id="bcVMqOGHHX">
                    <label for="bcVMqOGHHX">Exponentials</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="BADAysDpEH">
                    <label for="BADAysDpEH">Linear Algebra</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="NTKJjLSUYR">
                    <label for="NTKJjLSUYR">Logarithms</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="PrRnAOREWy">
                    <label for="PrRnAOREWy">Sequences</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="hgPjPHvKRu">
                    <label for="hgPjPHvKRu">Single Variable Calculus</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="VpejmyxRoJ">
                    <label for="VpejmyxRoJ">Trigonometry</label>
                    <ul>
        ...
        <l>
            <input type="checkbox" id="uYqjTDBLBe" checked>
            <label for="uYqjTDBLBe">Programming</label>
            <ul>
                <l>
                    <input type="checkbox" id="BNzwKLGYxl">
                    <label for="BNzwKLGYxl">Ansible</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="tpAsVhDPcj">
                    <label for="tpAsVhDPcj">Architecture</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="nEwdqIjqeW">
                    <label for="nEwdqIjqeW">Computer Graphics</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="RnlkOHTLTh">
                    <label for="RnlkOHTLTh">Databases</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="ycwHEeCVkG">
                    <label for="ycwHEeCVkG">Devops</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="xOXlfIQEoF">
                            <label for="xOXlfIQEoF">Cloud Providers</label>
                            <ul>
                                <l>
                                    <input type="checkbox" id="uzFlZsIxKb">
                                    <label for="uzFlZsIxKb">AWS</label>
                                    <ul>
                                        <l>
                                            <input type="checkbox" id="vIettZySuc">
                                            <label for="vIettZySuc">Cli</label>
                                            <ul>
                                        ...
                                        <l>
                                            <input type="checkbox" id="AgbdzzUgDK">
                                            <label for="AgbdzzUgDK">Dotnet</label>
                                            <ul>
                                        ...
                                        <l>
                                            <input type="checkbox" id="yNrwfbJBEO">
                                            <label for="yNrwfbJBEO">Ec 2</label>
                                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="EelpatfNjC">
                            <label for="EelpatfNjC">Events</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="BTCQlfyYUZ">
                            <label for="BTCQlfyYUZ">Localstack</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="qLZuovhTip">
                            <label for="qLZuovhTip">Pulumi</label>
                            <ul>
                                <l>
                                    <input type="checkbox" id="neGylkYZre">
                                    <label for="neGylkYZre">Dotnet</label>
                                    <ul>
                        ...
                        <l>
                            <input type="checkbox" id="BssHYqrMCm">
                            <label for="BssHYqrMCm">Serverless Framework</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="IADdaTpCEx">
                            <label for="IADdaTpCEx">Terraform</label>
                            <ul>
                                <l>
                                    <input type="checkbox" id="rZIQPuzJJh">
                                    <label for="rZIQPuzJJh">Functions</label>
                                    <ul>
                                ...
                                <l>
                                    <input type="checkbox" id="EzYpdbVNcB">
                                    <label for="EzYpdbVNcB">Meta Arguments</label>
                                    <ul>
                ...
                <l>
                    <input type="checkbox" id="YTekDuSlOK">
                    <label for="YTekDuSlOK">Docker</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="HVzVIVzSOg">
                    <label for="HVzVIVzSOg">Dotnet</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="qCJfXjkgpE">
                            <label for="qCJfXjkgpE">Cli</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="uYvCMJMKTi">
                    <label for="uYvCMJMKTi">Functional Programming</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="qoagNfwHbp">
                    <label for="qoagNfwHbp">Git</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="skTlTGqqwz">
                            <label for="skTlTGqqwz">Github</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="lHrVzEyEWp">
                    <label for="lHrVzEyEWp">Go</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="YCWvgmIfib">
                    <label for="YCWvgmIfib">Haskell</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="wUkcIJbSun">
                    <label for="wUkcIJbSun">Js</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="lqpbXQctvO">
                            <label for="lqpbXQctvO">Node</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="IGEZEKmbKS">
                            <label for="IGEZEKmbKS">D3</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="lWHSTjadRJ">
                            <label for="lWHSTjadRJ">Mocha</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="LUJvxNtROH">
                            <label for="LUJvxNtROH">P5js</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="ydtGxXOWUR">
                            <label for="ydtGxXOWUR">Typescript</label>
                            <ul>
                                <l>
                                    <input type="checkbox" id="czlWkMslbK">
                                    <label for="czlWkMslbK">Testing</label>
                                    <ul>
                ...
                <l>
                    <input type="checkbox" id="JDdUHIKdSw">
                    <label for="JDdUHIKdSw">Kafka</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="gezvDljVOt">
                    <label for="gezvDljVOt">Kubernetes</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="poNtcORdSY">
                    <label for="poNtcORdSY">Language</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="tNyzvGpbvl">
                    <label for="tNyzvGpbvl">Linux</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="AGCBjjCDAm">
                            <label for="AGCBjjCDAm">Bash</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="Lobvlzqjiw">
                    <label for="Lobvlzqjiw">Oauth</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="WqxwsXBkys">
                    <label for="WqxwsXBkys">Prometheus</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="TlbqFcsoOn">
                    <label for="TlbqFcsoOn">Python</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="rnqSZVuQcH">
                            <label for="rnqSZVuQcH">Data Classes</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="AjWoEbEEHE">
                            <label for="AjWoEbEEHE">Libraries</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="IhmsLXWYqD">
                    <label for="IhmsLXWYqD">React</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="tTVIURzvIp">
                    <label for="tTVIURzvIp">Regular Expressions</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="zDKZQdKVtY">
                    <label for="zDKZQdKVtY">Rust</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="KcgffnMdGx">
                            <label for="KcgffnMdGx">Serde</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="boezFnhOlq">
                    <label for="boezFnhOlq">Shaders</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="bhUpINwWVx">
                            <label for="bhUpINwWVx">Glsl</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="FStsGrrHLW">
                    <label for="FStsGrrHLW">Vim</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="cwyLSBvvSo">
                    <label for="cwyLSBvvSo">Web</label>
                    <ul>
