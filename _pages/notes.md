...
<ul>
    <div name="contents-index">
        ...
        <l>
            <input type="checkbox" id="WbbfrTwbcJ" checked>
            <label for="WbbfrTwbcJ">Math</label>
            <ul>
                <l>
                    <input type="checkbox" id="xRVWvuSJMT">
                    <label for="xRVWvuSJMT">Exponentials</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="jrdccEjAUF">
                    <label for="jrdccEjAUF">Linear Algebra</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="LsmWDmNYSA">
                    <label for="LsmWDmNYSA">Logarithms</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="jNtmIzyaOe">
                    <label for="jNtmIzyaOe">Sequences</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="GkwbiYNeKK">
                    <label for="GkwbiYNeKK">Single Variable Calculus</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="idTHlSmYAK">
                    <label for="idTHlSmYAK">Trigonometry</label>
                    <ul>
        ...
        <l>
            <input type="checkbox" id="KEQucPDrVq" checked>
            <label for="KEQucPDrVq">Programming</label>
            <ul>
                <l>
                    <input type="checkbox" id="MjlRjNzQBJ">
                    <label for="MjlRjNzQBJ">Ansible</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="WwbPuMYquR">
                    <label for="WwbPuMYquR">Architecture</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="gAsPyrcpIa">
                    <label for="gAsPyrcpIa">Computer Graphics</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="YnTErOzBLT">
                    <label for="YnTErOzBLT">Databases</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="eLVNkWMfXQ">
                    <label for="eLVNkWMfXQ">Devops</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="dCXEUmtTjD">
                            <label for="dCXEUmtTjD">Cloud Providers</label>
                            <ul>
                                <l>
                                    <input type="checkbox" id="llLeFgerGs">
                                    <label for="llLeFgerGs">AWS</label>
                                    <ul>
                                        <l>
                                            <input type="checkbox" id="HHGgvSEGdK">
                                            <label for="HHGgvSEGdK">Cli</label>
                                            <ul>
                                        ...
                                        <l>
                                            <input type="checkbox" id="sqQYEqRhek">
                                            <label for="sqQYEqRhek">Dotnet</label>
                                            <ul>
                                        ...
                                        <l>
                                            <input type="checkbox" id="DBremOTXLx">
                                            <label for="DBremOTXLx">Ec 2</label>
                                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="vtxpsHnClR">
                            <label for="vtxpsHnClR">Events</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="kcAjUvFDxP">
                            <label for="kcAjUvFDxP">Localstack</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="BxINkjWKyZ">
                            <label for="BxINkjWKyZ">Pulumi</label>
                            <ul>
                                <l>
                                    <input type="checkbox" id="CFpyoqvAvL">
                                    <label for="CFpyoqvAvL">Dotnet</label>
                                    <ul>
                        ...
                        <l>
                            <input type="checkbox" id="rvOmXLzJEd">
                            <label for="rvOmXLzJEd">Serverless Framework</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="oPLtGgvdWL">
                            <label for="oPLtGgvdWL">Terraform</label>
                            <ul>
                                <l>
                                    <input type="checkbox" id="rqWDVuziRZ">
                                    <label for="rqWDVuziRZ">Functions</label>
                                    <ul>
                                ...
                                <l>
                                    <input type="checkbox" id="ZzydULuMmw">
                                    <label for="ZzydULuMmw">Meta Arguments</label>
                                    <ul>
                ...
                <l>
                    <input type="checkbox" id="oZMNJAFrAG">
                    <label for="oZMNJAFrAG">Docker</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="bcbsLBtIxF">
                    <label for="bcbsLBtIxF">Dotnet</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="FrShxXVSGj">
                            <label for="FrShxXVSGj">Cli</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="upcdTxEEhG">
                    <label for="upcdTxEEhG">Functional Programming</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="cDNQlJfNJe">
                    <label for="cDNQlJfNJe">Git</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="DJyuSAwboP">
                            <label for="DJyuSAwboP">Github</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="RnQVBAeymp">
                    <label for="RnQVBAeymp">Go</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="pLpnjzAbIv">
                    <label for="pLpnjzAbIv">Haskell</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="FOHjeqwHSJ">
                    <label for="FOHjeqwHSJ">Js</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="kOZOVsbCzE">
                            <label for="kOZOVsbCzE">Node</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="QGDHXIEliF">
                            <label for="QGDHXIEliF">D3</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="VSuyuRGYJN">
                            <label for="VSuyuRGYJN">Mocha</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="tLdzaspXyO">
                            <label for="tLdzaspXyO">P5js</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="HcYHECWGbD">
                            <label for="HcYHECWGbD">Typescript</label>
                            <ul>
                                <l>
                                    <input type="checkbox" id="FNmDpNvTAV">
                                    <label for="FNmDpNvTAV">Testing</label>
                                    <ul>
                ...
                <l>
                    <input type="checkbox" id="XwyqlqUNOr">
                    <label for="XwyqlqUNOr">Kafka</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="SlzBoRSYgI">
                    <label for="SlzBoRSYgI">Kubernetes</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="vElrDCGscf">
                    <label for="vElrDCGscf">Language</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="RpViyMPHtS">
                    <label for="RpViyMPHtS">Linux</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="BmNMIalskE">
                            <label for="BmNMIalskE">Bash</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="XkGQxCOAiS">
                    <label for="XkGQxCOAiS">Oauth</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="yzyfWRkhTD">
                    <label for="yzyfWRkhTD">Prometheus</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="qURmiAHWIl">
                    <label for="qURmiAHWIl">Python</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="oRFnXrWmEG">
                            <label for="oRFnXrWmEG">Data Classes</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="DzcPxHvbxA">
                            <label for="DzcPxHvbxA">Libraries</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="WniXppkrZr">
                    <label for="WniXppkrZr">React</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="acOgFIQAYf">
                    <label for="acOgFIQAYf">Regular Expressions</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="UHMsIXWnzH">
                    <label for="UHMsIXWnzH">Rust</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="jEQSXyUFWm">
                            <label for="jEQSXyUFWm">Serde</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="oeBwXXwUJS">
                    <label for="oeBwXXwUJS">Shaders</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="phBUpWEErV">
                            <label for="phBUpWEErV">Glsl</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="QVzucCbRAA">
                    <label for="QVzucCbRAA">Vim</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="nbKCVxiwkZ">
                    <label for="nbKCVxiwkZ">Web</label>
                    <ul>
