...
<ul>
    <div name="contents-index">
        ...
        <l>
            <input type="checkbox" id="BttJtKuvLS" checked>
            <label for="BttJtKuvLS">Math</label>
            <ul>
                <l>
                    <input type="checkbox" id="LrTDiFYJKr">
                    <label for="LrTDiFYJKr">Exponentials</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="XFhbjldLga">
                    <label for="XFhbjldLga">Linear Algebra</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="vYEQTiQMiR">
                    <label for="vYEQTiQMiR">Logarithms</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="HfjCGRlbVz">
                    <label for="HfjCGRlbVz">Sequences</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="mzuhwQzzNr">
                    <label for="mzuhwQzzNr">Single Variable Calculus</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="SQPGpbpWhw">
                    <label for="SQPGpbpWhw">Trigonometry</label>
                    <ul>
        ...
        <l>
            <input type="checkbox" id="vhHsifKzBv" checked>
            <label for="vhHsifKzBv">Programming</label>
            <ul>
                <l>
                    <input type="checkbox" id="dNfleNfcWp">
                    <label for="dNfleNfcWp">Ansible</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="yfUTuwYgFg">
                    <label for="yfUTuwYgFg">Architecture</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="TyQKbKPrej">
                    <label for="TyQKbKPrej">Computer Graphics</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="OZHjRlRTzi">
                    <label for="OZHjRlRTzi">Databases</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="IhuAJpqahW">
                    <label for="IhuAJpqahW">Devops</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="dYwJcytmmN">
                            <label for="dYwJcytmmN">Cloud Providers</label>
                            <ul>
                                <l>
                                    <input type="checkbox" id="VzIgSzmHcX">
                                    <label for="VzIgSzmHcX">AWS</label>
                                    <ul>
                                        <l>
                                            <input type="checkbox" id="OoUiuWFkiO">
                                            <label for="OoUiuWFkiO">Cli</label>
                                            <ul>
                                        ...
                                        <l>
                                            <input type="checkbox" id="mchPzYtSUV">
                                            <label for="mchPzYtSUV">Dotnet</label>
                                            <ul>
                                        ...
                                        <l>
                                            <input type="checkbox" id="wbsDDxUPQP">
                                            <label for="wbsDDxUPQP">Ec 2</label>
                                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="MGmrIEQxKx">
                            <label for="MGmrIEQxKx">Events</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="HUbXslFnlY">
                            <label for="HUbXslFnlY">Localstack</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="rqhgfAoCXd">
                            <label for="rqhgfAoCXd">Pulumi</label>
                            <ul>
                                <l>
                                    <input type="checkbox" id="gXVqdHThpF">
                                    <label for="gXVqdHThpF">Dotnet</label>
                                    <ul>
                        ...
                        <l>
                            <input type="checkbox" id="mHFLjMIObA">
                            <label for="mHFLjMIObA">Serverless Framework</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="qmZPzATckB">
                            <label for="qmZPzATckB">Terraform</label>
                            <ul>
                                <l>
                                    <input type="checkbox" id="OoKkxrtsLE">
                                    <label for="OoKkxrtsLE">Functions</label>
                                    <ul>
                                ...
                                <l>
                                    <input type="checkbox" id="FNuQMyUPve">
                                    <label for="FNuQMyUPve">Meta Arguments</label>
                                    <ul>
                ...
                <l>
                    <input type="checkbox" id="HXFdiapFhS">
                    <label for="HXFdiapFhS">Docker</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="qjgyREoUkc">
                    <label for="qjgyREoUkc">Dotnet</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="kKPEUZeqnE">
                            <label for="kKPEUZeqnE">Cli</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="cKTCAaYiys">
                    <label for="cKTCAaYiys">Functional Programming</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="cQMwEFuEcF">
                    <label for="cQMwEFuEcF">Git</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="KFUUdYphEJ">
                            <label for="KFUUdYphEJ">Github</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="MnDITxJNJp">
                    <label for="MnDITxJNJp">Go</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="pZMvjhXIqG">
                    <label for="pZMvjhXIqG">Haskell</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="ccZxblbpom">
                    <label for="ccZxblbpom">Js</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="TZUXpfOZWu">
                            <label for="TZUXpfOZWu">Node</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="DmSwqgKBeX">
                            <label for="DmSwqgKBeX">D3</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="rbvFfDKuqG">
                            <label for="rbvFfDKuqG">Mocha</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="hXXWnVbchg">
                            <label for="hXXWnVbchg">P5js</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="BhjGyIzxca">
                            <label for="BhjGyIzxca">Typescript</label>
                            <ul>
                                <l>
                                    <input type="checkbox" id="IcFDVLYers">
                                    <label for="IcFDVLYers">Testing</label>
                                    <ul>
                ...
                <l>
                    <input type="checkbox" id="WPLqzgffrU">
                    <label for="WPLqzgffrU">Kafka</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="fAwikqvIul">
                    <label for="fAwikqvIul">Kubernetes</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="UZiRZjXzAg">
                    <label for="UZiRZjXzAg">Language</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="tLjxMjUfBM">
                    <label for="tLjxMjUfBM">Linux</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="JncQYwtCOb">
                            <label for="JncQYwtCOb">Bash</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="jEIqLBHXek">
                    <label for="jEIqLBHXek">Oauth</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="IYQWbxUbHe">
                    <label for="IYQWbxUbHe">Python</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="onLGApqODO">
                            <label for="onLGApqODO">Data Classes</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="uEKWFktJAU">
                            <label for="uEKWFktJAU">Libraries</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="LVjSnghwbp">
                    <label for="LVjSnghwbp">React</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="NDMZXjnfcB">
                    <label for="NDMZXjnfcB">Regular Expressions</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="BMHdBQMLwc">
                    <label for="BMHdBQMLwc">Rust</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="oThmZSamhY">
                            <label for="oThmZSamhY">Serde</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="wcqqVFCmSq">
                    <label for="wcqqVFCmSq">Vim</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="jFIddXwTRp">
                    <label for="jFIddXwTRp">Web</label>
                    <ul>
