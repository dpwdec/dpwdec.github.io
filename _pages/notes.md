...
<ul>
    <div name="contents-index">
        ...
        <l>
            <input type="checkbox" id="XoUNlHDGAV" checked>
            <label for="XoUNlHDGAV">Math</label>
            <ul>
                <l>
                    <input type="checkbox" id="TVtMKLiElu">
                    <label for="TVtMKLiElu">Exponentials</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="zmDdWkKMdh">
                    <label for="zmDdWkKMdh">Linear Algebra</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="wusQPNBZxd">
                    <label for="wusQPNBZxd">Logarithms</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="idZDxmRTNp">
                    <label for="idZDxmRTNp">Sequences</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="YeRCZykSMP">
                    <label for="YeRCZykSMP">Single Variable Calculus</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="KnUDPIefoT">
                    <label for="KnUDPIefoT">Trigonometry</label>
                    <ul>
        ...
        <l>
            <input type="checkbox" id="FCScFqUOxO" checked>
            <label for="FCScFqUOxO">Programming</label>
            <ul>
                <l>
                    <input type="checkbox" id="qaElsVJrVl">
                    <label for="qaElsVJrVl">Ansible</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="BntlPhmrmZ">
                    <label for="BntlPhmrmZ">Architecture</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="bikXdeCZib">
                    <label for="bikXdeCZib">Computer Graphics</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="FALESqgyOI">
                    <label for="FALESqgyOI">Databases</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="VhnHlIboma">
                    <label for="VhnHlIboma">Devops</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="NTzLwAVwpw">
                            <label for="NTzLwAVwpw">Cloud Computing</label>
                            <ul>
                                <l>
                                    <input type="checkbox" id="cjlgMlmNsl">
                                    <label for="cjlgMlmNsl">AWS</label>
                                    <ul>
                                        <l>
                                            <input type="checkbox" id="HYjAJJJwhm">
                                            <label for="HYjAJJJwhm">Cli</label>
                                            <ul>
                                        ...
                                        <l>
                                            <input type="checkbox" id="rFSgXXvisb">
                                            <label for="rFSgXXvisb">Dotnet</label>
                                            <ul>
                                        ...
                                        <l>
                                            <input type="checkbox" id="sbueAztbNl">
                                            <label for="sbueAztbNl">Ec 2</label>
                                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="HVxLpGoGip">
                            <label for="HVxLpGoGip">Events</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="mjKqjItPez">
                            <label for="mjKqjItPez">Localstack</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="msxjRBoiCr">
                            <label for="msxjRBoiCr">Oauth</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="CxJZHufeMG">
                            <label for="CxJZHufeMG">Pulumi</label>
                            <ul>
                                <l>
                                    <input type="checkbox" id="zXrmpAkKkU">
                                    <label for="zXrmpAkKkU">Dotnet</label>
                                    <ul>
                        ...
                        <l>
                            <input type="checkbox" id="ChyxsSPuRE">
                            <label for="ChyxsSPuRE">Terraform</label>
                            <ul>
                                <l>
                                    <input type="checkbox" id="oIaivdPgQP">
                                    <label for="oIaivdPgQP">Functions</label>
                                    <ul>
                                ...
                                <l>
                                    <input type="checkbox" id="JmxSQtCLku">
                                    <label for="JmxSQtCLku">Meta Arguments</label>
                                    <ul>
                ...
                <l>
                    <input type="checkbox" id="dICYpMUsmn">
                    <label for="dICYpMUsmn">Docker</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="wLBauvfddl">
                    <label for="wLBauvfddl">Dotnet</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="RYveubPcCV">
                            <label for="RYveubPcCV">Cli</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="ChpfiqCJjJ">
                    <label for="ChpfiqCJjJ">Functional Programming</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="tHSxygqUBV">
                    <label for="tHSxygqUBV">Git</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="oeLzPfLjEb">
                            <label for="oeLzPfLjEb">Github</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="YABUDsboTr">
                    <label for="YABUDsboTr">Go</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="CzuzamFjmX">
                    <label for="CzuzamFjmX">Haskell</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="SbbtEPyuWi">
                    <label for="SbbtEPyuWi">Js</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="zwSCLjpVEL">
                            <label for="zwSCLjpVEL">Node</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="DQhaPtgFOL">
                            <label for="DQhaPtgFOL">D3</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="XmFkipSepT">
                            <label for="XmFkipSepT">Mocha</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="QfsOkriZHO">
                            <label for="QfsOkriZHO">P5js</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="vcIodbXlhn">
                            <label for="vcIodbXlhn">Typescript</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="fEAwzoyFQM">
                    <label for="fEAwzoyFQM">Kafka</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="bFLSpWtuMI">
                    <label for="bFLSpWtuMI">Kubernetes</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="VhfLKlMFrW">
                    <label for="VhfLKlMFrW">Language</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="DRwGMUawcF">
                    <label for="DRwGMUawcF">Linux</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="ZlSUixmzso">
                            <label for="ZlSUixmzso">Bash</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="gFfrnYaKPc">
                    <label for="gFfrnYaKPc">Python</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="XyFLhwdnlq">
                            <label for="XyFLhwdnlq">Data Classes</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="HxUgCYCUpU">
                            <label for="HxUgCYCUpU">Libraries</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="sCOUDaZHli">
                    <label for="sCOUDaZHli">React</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="ChCMIhCiNA">
                    <label for="ChCMIhCiNA">Regular Expressions</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="CXOVxXcRRc">
                    <label for="CXOVxXcRRc">Rust</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="xsSVausIIV">
                            <label for="xsSVausIIV">Serde</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="IsXauXMjGL">
                    <label for="IsXauXMjGL">Vim</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="aRyLVrPHtc">
                    <label for="aRyLVrPHtc">Web</label>
                    <ul>
