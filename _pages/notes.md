...
<ul>
    <div name="contents-index">
        ...
        <l>
            <input type="checkbox" id="uhSbZAWpLz" checked>
            <label for="uhSbZAWpLz">Math</label>
            <ul>
                <l>
                    <input type="checkbox" id="CMODoPZDwj">
                    <label for="CMODoPZDwj">Exponentials</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="ubnpDtMRXR">
                    <label for="ubnpDtMRXR">Linear Algebra</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="ITVlULDmlL">
                    <label for="ITVlULDmlL">Logarithms</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="XmHxtUroZi">
                    <label for="XmHxtUroZi">Sequences</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="WXQiyMfDEP">
                    <label for="WXQiyMfDEP">Single Variable Calculus</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="QYSnHXuceG">
                    <label for="QYSnHXuceG">Trigonometry</label>
                    <ul>
        ...
        <l>
            <input type="checkbox" id="qoUvMlPliG" checked>
            <label for="qoUvMlPliG">Programming</label>
            <ul>
                <l>
                    <input type="checkbox" id="PXEwfkdeev">
                    <label for="PXEwfkdeev">Ansible</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="BxCXECnBNa">
                    <label for="BxCXECnBNa">Architecture</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="OFCeHDsOJp">
                    <label for="OFCeHDsOJp">Computer Graphics</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="UgNOavZgHE">
                    <label for="UgNOavZgHE">Databases</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="LAOOdaKSsW">
                    <label for="LAOOdaKSsW">Devops</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="CXnXontmEm">
                            <label for="CXnXontmEm">Cloud Computing</label>
                            <ul>
                                <l>
                                    <input type="checkbox" id="tyIunNShZx">
                                    <label for="tyIunNShZx">AWS</label>
                                    <ul>
                                        <l>
                                            <input type="checkbox" id="ukhuAGeSfy">
                                            <label for="ukhuAGeSfy">Cli</label>
                                            <ul>
                                        ...
                                        <l>
                                            <input type="checkbox" id="mJdsnmdkdL">
                                            <label for="mJdsnmdkdL">Dotnet</label>
                                            <ul>
                                        ...
                                        <l>
                                            <input type="checkbox" id="HlNbMYzrwS">
                                            <label for="HlNbMYzrwS">Ec 2</label>
                                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="MVkzuOvkmu">
                            <label for="MVkzuOvkmu">Events</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="bcIDbfCwti">
                            <label for="bcIDbfCwti">Localstack</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="qRqvJrvfid">
                            <label for="qRqvJrvfid">Oauth</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="LtPuEmBXZw">
                            <label for="LtPuEmBXZw">Pulumi</label>
                            <ul>
                                <l>
                                    <input type="checkbox" id="qsWyJbcOiy">
                                    <label for="qsWyJbcOiy">Dotnet</label>
                                    <ul>
                        ...
                        <l>
                            <input type="checkbox" id="mvxIYAodes">
                            <label for="mvxIYAodes">Terraform</label>
                            <ul>
                                <l>
                                    <input type="checkbox" id="BMVlqxREim">
                                    <label for="BMVlqxREim">Functions</label>
                                    <ul>
                                ...
                                <l>
                                    <input type="checkbox" id="QrJeEhKORy">
                                    <label for="QrJeEhKORy">Meta Arguments</label>
                                    <ul>
                ...
                <l>
                    <input type="checkbox" id="HiUADqZklo">
                    <label for="HiUADqZklo">Docker</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="bJdFkOdzpV">
                    <label for="bJdFkOdzpV">Dotnet</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="EcKydVVeDh">
                            <label for="EcKydVVeDh">Cli</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="VFJHvNdooF">
                    <label for="VFJHvNdooF">Functional Programming</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="HbvpShFWPL">
                    <label for="HbvpShFWPL">Git</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="fErJTwylnJ">
                            <label for="fErJTwylnJ">Github</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="qaNpRpoDaZ">
                    <label for="qaNpRpoDaZ">Go</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="UUCEZXBsHB">
                    <label for="UUCEZXBsHB">Haskell</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="ULkcFfUEvV">
                    <label for="ULkcFfUEvV">Js</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="QceXfwsnJV">
                            <label for="QceXfwsnJV">Node</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="QGzvxOrwrW">
                            <label for="QGzvxOrwrW">D3</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="VcLLnwhbyF">
                            <label for="VcLLnwhbyF">Mocha</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="yGUUScQhyS">
                            <label for="yGUUScQhyS">P5js</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="kWJBHqvrNL">
                            <label for="kWJBHqvrNL">Typescript</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="fheRxpXqkV">
                    <label for="fheRxpXqkV">Kafka</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="KZDuTMpjqy">
                    <label for="KZDuTMpjqy">Kubernetes</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="SXCnnxstMc">
                    <label for="SXCnnxstMc">Language</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="KboakjIQPu">
                    <label for="KboakjIQPu">Linux</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="XFAGSqoJzA">
                    <label for="XFAGSqoJzA">Python</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="vRXfOqeUFa">
                            <label for="vRXfOqeUFa">Data Classes</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="mWqqKKtUZi">
                            <label for="mWqqKKtUZi">Libraries</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="HhaREBiLDw">
                    <label for="HhaREBiLDw">React</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="fvKxTxWmsP">
                    <label for="fvKxTxWmsP">Regular Expressions</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="jbLpCcfRNC">
                    <label for="jbLpCcfRNC">Rust</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="AIFzWOqbqD">
                            <label for="AIFzWOqbqD">Serde</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="IUexyAGIHn">
                    <label for="IUexyAGIHn">Vim</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="abQXXlhgxm">
                    <label for="abQXXlhgxm">Web</label>
                    <ul>
