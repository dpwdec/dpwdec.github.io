...
<ul>
    <div name="contents-index">
        ...
        <l>
            <input type="checkbox" id="xYbXKUFlAq" checked>
            <label for="xYbXKUFlAq">Math</label>
            <ul>
                <l>
                    <input type="checkbox" id="rTQwPqYiXX">
                    <label for="rTQwPqYiXX">Exponentials</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="udWYKjTpYJ">
                    <label for="udWYKjTpYJ">Linear Algebra</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="FfcDgpiKjz">
                    <label for="FfcDgpiKjz">Logarithms</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="QihdgudEva">
                    <label for="QihdgudEva">Sequences</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="mpFiZoBkIU">
                    <label for="mpFiZoBkIU">Single Variable Calculus</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="clzNNykCkF">
                    <label for="clzNNykCkF">Trigonometry</label>
                    <ul>
        ...
        <l>
            <input type="checkbox" id="BzhxnlAnsX" checked>
            <label for="BzhxnlAnsX">Programming</label>
            <ul>
                <l>
                    <input type="checkbox" id="wncWCbqrzh">
                    <label for="wncWCbqrzh">Ansible</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="cmDAXFLBHQ">
                    <label for="cmDAXFLBHQ">Architecture</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="iZQOIvebpl">
                    <label for="iZQOIvebpl">Computer Graphics</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="NmNjmaZQtd">
                    <label for="NmNjmaZQtd">Databases</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="HRZbaqwEav">
                    <label for="HRZbaqwEav">Devops</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="lueJPJEYua">
                            <label for="lueJPJEYua">Cloud Providers</label>
                            <ul>
                                <l>
                                    <input type="checkbox" id="AMdlYzUUaY">
                                    <label for="AMdlYzUUaY">AWS</label>
                                    <ul>
                                        <l>
                                            <input type="checkbox" id="ionUFfjtow">
                                            <label for="ionUFfjtow">Cli</label>
                                            <ul>
                                        ...
                                        <l>
                                            <input type="checkbox" id="KnSGwgTiqU">
                                            <label for="KnSGwgTiqU">Dotnet</label>
                                            <ul>
                                        ...
                                        <l>
                                            <input type="checkbox" id="sRPiAcwHPH">
                                            <label for="sRPiAcwHPH">Ec 2</label>
                                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="FSNYtevren">
                            <label for="FSNYtevren">Events</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="sebNZkGLrK">
                            <label for="sebNZkGLrK">Localstack</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="zhihimyHnc">
                            <label for="zhihimyHnc">Pulumi</label>
                            <ul>
                                <l>
                                    <input type="checkbox" id="PmzwgMZslF">
                                    <label for="PmzwgMZslF">Dotnet</label>
                                    <ul>
                        ...
                        <l>
                            <input type="checkbox" id="XKUBHpaJYT">
                            <label for="XKUBHpaJYT">Serverless Framework</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="ggthfVHjTO">
                            <label for="ggthfVHjTO">Terraform</label>
                            <ul>
                                <l>
                                    <input type="checkbox" id="gXzjejGzrG">
                                    <label for="gXzjejGzrG">Functions</label>
                                    <ul>
                                ...
                                <l>
                                    <input type="checkbox" id="xFjxsCtTEF">
                                    <label for="xFjxsCtTEF">Meta Arguments</label>
                                    <ul>
                ...
                <l>
                    <input type="checkbox" id="BQjJWdUZAg">
                    <label for="BQjJWdUZAg">Docker</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="RrYazZUVJc">
                    <label for="RrYazZUVJc">Dotnet</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="OjbzSCRFZx">
                            <label for="OjbzSCRFZx">Cli</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="GWXiQPvOrV">
                    <label for="GWXiQPvOrV">Functional Programming</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="SasxWyRsgm">
                    <label for="SasxWyRsgm">Git</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="eVymWnSmJv">
                            <label for="eVymWnSmJv">Github</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="BahuOqezNK">
                    <label for="BahuOqezNK">Go</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="pGmikYpMon">
                    <label for="pGmikYpMon">Haskell</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="psHTdrzLQR">
                    <label for="psHTdrzLQR">Js</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="YwYlcCaMPj">
                            <label for="YwYlcCaMPj">Node</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="kvxKTFJcZI">
                            <label for="kvxKTFJcZI">D3</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="OmpCWkgioi">
                            <label for="OmpCWkgioi">Mocha</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="QMQDrqVcmg">
                            <label for="QMQDrqVcmg">P5js</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="dCvwaeZGWT">
                            <label for="dCvwaeZGWT">Typescript</label>
                            <ul>
                                <l>
                                    <input type="checkbox" id="inyXqygJGs">
                                    <label for="inyXqygJGs">Testing</label>
                                    <ul>
                ...
                <l>
                    <input type="checkbox" id="kyicyoMalp">
                    <label for="kyicyoMalp">Kafka</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="vBsEqJsxLm">
                    <label for="vBsEqJsxLm">Kubernetes</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="tlwYzxjlNN">
                    <label for="tlwYzxjlNN">Language</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="EJXpocAYLs">
                    <label for="EJXpocAYLs">Linux</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="vKbiajzLzT">
                            <label for="vKbiajzLzT">Bash</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="kiFwzVaSAt">
                    <label for="kiFwzVaSAt">Oauth</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="DQBrxFyQaI">
                    <label for="DQBrxFyQaI">Python</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="ZtqYSBnIIh">
                            <label for="ZtqYSBnIIh">Data Classes</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="AWWWGmgWnw">
                            <label for="AWWWGmgWnw">Libraries</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="psoGOTryhS">
                    <label for="psoGOTryhS">React</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="uEeKIQeDfp">
                    <label for="uEeKIQeDfp">Regular Expressions</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="ulLsWTRBAj">
                    <label for="ulLsWTRBAj">Rust</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="PBNDqCEtUH">
                            <label for="PBNDqCEtUH">Serde</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="wTMcVlJybm">
                    <label for="wTMcVlJybm">Shaders</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="NZtfuVYFmT">
                            <label for="NZtfuVYFmT">Glsl</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="enpXFHQwZD">
                    <label for="enpXFHQwZD">Vim</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="WiJGgLCXKY">
                    <label for="WiJGgLCXKY">Web</label>
                    <ul>
