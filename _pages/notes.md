...
<ul>
    <div name="contents-index">
        ...
        <l>
            <input type="checkbox" id="mWLAkvAmmM" checked>
            <label for="mWLAkvAmmM">Math</label>
            <ul>
                <l>
                    <input type="checkbox" id="ZwdUDqcavu">
                    <label for="ZwdUDqcavu">Exponentials</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="veVPyAjtTN">
                    <label for="veVPyAjtTN">Linear Algebra</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="ZJGbnuBYMW">
                    <label for="ZJGbnuBYMW">Logarithms</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="pRuAvxoFyu">
                    <label for="pRuAvxoFyu">Sequences</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="pLxWeGFFXs">
                    <label for="pLxWeGFFXs">Single Variable Calculus</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="yIMSVTRnso">
                    <label for="yIMSVTRnso">Trigonometry</label>
                    <ul>
        ...
        <l>
            <input type="checkbox" id="VuRazpyzyH" checked>
            <label for="VuRazpyzyH">Programming</label>
            <ul>
                <l>
                    <input type="checkbox" id="KAXAdMZAid">
                    <label for="KAXAdMZAid">Ansible</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="aOikbKsnKA">
                    <label for="aOikbKsnKA">Architecture</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="melWKfTZeu">
                    <label for="melWKfTZeu">Computer Graphics</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="bGzqwbsPVa">
                    <label for="bGzqwbsPVa">Databases</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="UMPecTTsxR">
                    <label for="UMPecTTsxR">Devops</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="HnOypNyguy">
                            <label for="HnOypNyguy">Cloud Providers</label>
                            <ul>
                                <l>
                                    <input type="checkbox" id="ftILekmcJk">
                                    <label for="ftILekmcJk">AWS</label>
                                    <ul>
                                        <l>
                                            <input type="checkbox" id="xpwDSCIwoI">
                                            <label for="xpwDSCIwoI">Cli</label>
                                            <ul>
                                        ...
                                        <l>
                                            <input type="checkbox" id="uhfTcRZcGN">
                                            <label for="uhfTcRZcGN">Dotnet</label>
                                            <ul>
                                        ...
                                        <l>
                                            <input type="checkbox" id="FYyhjvshrt">
                                            <label for="FYyhjvshrt">Ec 2</label>
                                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="BWyLHGBZZI">
                            <label for="BWyLHGBZZI">Events</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="tyXrSWZWJk">
                            <label for="tyXrSWZWJk">Localstack</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="TRFxDWteke">
                            <label for="TRFxDWteke">Pulumi</label>
                            <ul>
                                <l>
                                    <input type="checkbox" id="KaovnFkudd">
                                    <label for="KaovnFkudd">Dotnet</label>
                                    <ul>
                        ...
                        <l>
                            <input type="checkbox" id="eCqqFXJPZB">
                            <label for="eCqqFXJPZB">Serverless Framework</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="ZfQhrDdnrC">
                            <label for="ZfQhrDdnrC">Terraform</label>
                            <ul>
                                <l>
                                    <input type="checkbox" id="vAKPaiHWwM">
                                    <label for="vAKPaiHWwM">Functions</label>
                                    <ul>
                                ...
                                <l>
                                    <input type="checkbox" id="sFIvgWZkxX">
                                    <label for="sFIvgWZkxX">Meta Arguments</label>
                                    <ul>
                ...
                <l>
                    <input type="checkbox" id="UuQIYYOqvk">
                    <label for="UuQIYYOqvk">Docker</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="XYGEKmioJN">
                    <label for="XYGEKmioJN">Dotnet</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="PfGmDhsveA">
                            <label for="PfGmDhsveA">Cli</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="FEsNIjZCuK">
                    <label for="FEsNIjZCuK">Functional Programming</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="EKNWJTFZTz">
                    <label for="EKNWJTFZTz">Git</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="jyLVCsBuHx">
                            <label for="jyLVCsBuHx">Github</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="eRJAfGwysI">
                    <label for="eRJAfGwysI">Go</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="sjAXzDxNfd">
                    <label for="sjAXzDxNfd">Haskell</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="WNbSYtohQl">
                    <label for="WNbSYtohQl">Js</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="TQyLYJDnrQ">
                            <label for="TQyLYJDnrQ">Node</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="STkxqOQdFF">
                            <label for="STkxqOQdFF">D3</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="rkrQnQTuTx">
                            <label for="rkrQnQTuTx">Mocha</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="iErTHgdDTo">
                            <label for="iErTHgdDTo">P5js</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="ucOjQpAKvx">
                            <label for="ucOjQpAKvx">Typescript</label>
                            <ul>
                                <l>
                                    <input type="checkbox" id="TQlKADFqYL">
                                    <label for="TQlKADFqYL">Testing</label>
                                    <ul>
                ...
                <l>
                    <input type="checkbox" id="bkvbzOrXqn">
                    <label for="bkvbzOrXqn">Kafka</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="rIfAFiJhrO">
                    <label for="rIfAFiJhrO">Kubernetes</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="fwcgADwZkm">
                    <label for="fwcgADwZkm">Language</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="iFVIemAqzR">
                    <label for="iFVIemAqzR">Linux</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="hyixuxnMxs">
                            <label for="hyixuxnMxs">Bash</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="tHrTJuNQiP">
                    <label for="tHrTJuNQiP">Oauth</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="AHyyYkfyJB">
                    <label for="AHyyYkfyJB">Prometheus</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="XLeZjQoILI">
                    <label for="XLeZjQoILI">Python</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="IxKhlXOnqm">
                            <label for="IxKhlXOnqm">Data Classes</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="XrigEIANaK">
                            <label for="XrigEIANaK">Libraries</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="ZNIEDsPjqw">
                    <label for="ZNIEDsPjqw">React</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="QjeLKQIVsp">
                    <label for="QjeLKQIVsp">Regular Expressions</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="zJbtIHEDuM">
                    <label for="zJbtIHEDuM">Rust</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="OMGRpVBODf">
                            <label for="OMGRpVBODf">Serde</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="HNSbVDHSAm">
                    <label for="HNSbVDHSAm">Shaders</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="LCuYQODnHx">
                            <label for="LCuYQODnHx">Glsl</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="ABHMFIufUC">
                    <label for="ABHMFIufUC">Vim</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="WuaFeVqOMj">
                    <label for="WuaFeVqOMj">Web</label>
                    <ul>
