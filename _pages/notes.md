...
<ul>
    <div name="contents-index">
        ...
        <l>
            <input type="checkbox" id="yeHNIVRhFM" checked>
            <label for="yeHNIVRhFM">Math</label>
            <ul>
                <l>
                    <input type="checkbox" id="TxeEEeccWR">
                    <label for="TxeEEeccWR">Exponentials</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="IkBMskpdgG">
                    <label for="IkBMskpdgG">Linear Algebra</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="FOYjQarJaQ">
                    <label for="FOYjQarJaQ">Logarithms</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="MEOmISEyNN">
                    <label for="MEOmISEyNN">Sequences</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="BEwxTIZoQy">
                    <label for="BEwxTIZoQy">Single Variable Calculus</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="SkGwPmPXWd">
                    <label for="SkGwPmPXWd">Trigonometry</label>
                    <ul>
        ...
        <l>
            <input type="checkbox" id="OPxfnXEpAQ" checked>
            <label for="OPxfnXEpAQ">Programming</label>
            <ul>
                <l>
                    <input type="checkbox" id="wKPBwfIvQU">
                    <label for="wKPBwfIvQU">Ansible</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="KuWIDbJJSl">
                    <label for="KuWIDbJJSl">Architecture</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="jqUtyeEYNV">
                    <label for="jqUtyeEYNV">Computer Graphics</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="VzmHCKacIk">
                    <label for="VzmHCKacIk">Databases</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="YhqiNYlwAM">
                    <label for="YhqiNYlwAM">Devops</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="UIiPabULDo">
                            <label for="UIiPabULDo">Cloud Providers</label>
                            <ul>
                                <l>
                                    <input type="checkbox" id="hYGCkdYEFh">
                                    <label for="hYGCkdYEFh">AWS</label>
                                    <ul>
                                        <l>
                                            <input type="checkbox" id="EqwNcMYIOw">
                                            <label for="EqwNcMYIOw">Cli</label>
                                            <ul>
                                        ...
                                        <l>
                                            <input type="checkbox" id="pfjdQOiSRW">
                                            <label for="pfjdQOiSRW">Dotnet</label>
                                            <ul>
                                        ...
                                        <l>
                                            <input type="checkbox" id="EagNgNqChj">
                                            <label for="EagNgNqChj">Ec 2</label>
                                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="ZFKcVjTtyp">
                            <label for="ZFKcVjTtyp">Events</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="QePatEsijO">
                            <label for="QePatEsijO">Localstack</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="uESZWTLQIi">
                            <label for="uESZWTLQIi">Pulumi</label>
                            <ul>
                                <l>
                                    <input type="checkbox" id="RRLpANSGtK">
                                    <label for="RRLpANSGtK">Dotnet</label>
                                    <ul>
                        ...
                        <l>
                            <input type="checkbox" id="MMHSUcTfzY">
                            <label for="MMHSUcTfzY">Serverless Framework</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="ddMuFfocaa">
                            <label for="ddMuFfocaa">Terraform</label>
                            <ul>
                                <l>
                                    <input type="checkbox" id="SkKQmhbfxH">
                                    <label for="SkKQmhbfxH">Functions</label>
                                    <ul>
                                ...
                                <l>
                                    <input type="checkbox" id="pDCRALJDSZ">
                                    <label for="pDCRALJDSZ">Meta Arguments</label>
                                    <ul>
                ...
                <l>
                    <input type="checkbox" id="HwWrotiarp">
                    <label for="HwWrotiarp">Docker</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="pPXvqAHeOZ">
                    <label for="pPXvqAHeOZ">Dotnet</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="doivqbBZdu">
                            <label for="doivqbBZdu">Cli</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="ZRfqUGvhMF">
                    <label for="ZRfqUGvhMF">Functional Programming</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="cMbngpqxLu">
                    <label for="cMbngpqxLu">Git</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="AQlzPLOjkk">
                            <label for="AQlzPLOjkk">Github</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="MXpiNqJcKm">
                    <label for="MXpiNqJcKm">Go</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="vOihhgsVNk">
                    <label for="vOihhgsVNk">Haskell</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="WcspzdlmQu">
                    <label for="WcspzdlmQu">Js</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="XaOswqUVKh">
                            <label for="XaOswqUVKh">Node</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="eGxkiuwkwi">
                            <label for="eGxkiuwkwi">D3</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="nTJJCBAWba">
                            <label for="nTJJCBAWba">Mocha</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="zfSGazNcJn">
                            <label for="zfSGazNcJn">P5js</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="RBbhEdKaBH">
                            <label for="RBbhEdKaBH">Typescript</label>
                            <ul>
                                <l>
                                    <input type="checkbox" id="fdkKeCTJFk">
                                    <label for="fdkKeCTJFk">Testing</label>
                                    <ul>
                ...
                <l>
                    <input type="checkbox" id="GgizJcIrtN">
                    <label for="GgizJcIrtN">Kafka</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="mdpQArhwne">
                    <label for="mdpQArhwne">Kubernetes</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="HPFcmGzQxS">
                    <label for="HPFcmGzQxS">Language</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="wtuvNFcNNb">
                    <label for="wtuvNFcNNb">Linux</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="uvojoYagOc">
                            <label for="uvojoYagOc">Bash</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="bdguyFqquf">
                    <label for="bdguyFqquf">Oauth</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="NLBuUtHhGu">
                    <label for="NLBuUtHhGu">Prometheus</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="EKYfEzaSpZ">
                    <label for="EKYfEzaSpZ">Python</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="LJAcHXPLyF">
                            <label for="LJAcHXPLyF">Data Classes</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="TCzXwEXBSt">
                            <label for="TCzXwEXBSt">Libraries</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="vYqWxSIitz">
                    <label for="vYqWxSIitz">React</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="GTQywshNtQ">
                    <label for="GTQywshNtQ">Regular Expressions</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="CymQuvhchu">
                    <label for="CymQuvhchu">Rust</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="vqNwMWlFNn">
                            <label for="vqNwMWlFNn">Serde</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="RhvWzZXiVc">
                    <label for="RhvWzZXiVc">Shaders</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="GiIyWrsAte">
                            <label for="GiIyWrsAte">Glsl</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="vojVsSgoBP">
                    <label for="vojVsSgoBP">Vim</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="RlsQzSSbKC">
                    <label for="RlsQzSSbKC">Web</label>
                    <ul>
