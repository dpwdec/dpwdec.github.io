...
<ul>
    <div name="contents-index">
        ...
        <l>
            <input type="checkbox" id="oISwKISVsq" checked>
            <label for="oISwKISVsq">Math</label>
            <ul>
                <l>
                    <input type="checkbox" id="gHBNsCIWIO">
                    <label for="gHBNsCIWIO">Exponentials</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="mfeBmIEpKF">
                    <label for="mfeBmIEpKF">Linear Algebra</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="jDhBhwNXMs">
                    <label for="jDhBhwNXMs">Logarithms</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="aNupSXNFCg">
                    <label for="aNupSXNFCg">Sequences</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="EdnMBxVaBQ">
                    <label for="EdnMBxVaBQ">Single Variable Calculus</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="pYfOwHQBIC">
                    <label for="pYfOwHQBIC">Trigonometry</label>
                    <ul>
        ...
        <l>
            <input type="checkbox" id="iwTMEZTcKl" checked>
            <label for="iwTMEZTcKl">Programming</label>
            <ul>
                <l>
                    <input type="checkbox" id="nZGJCRJiHz">
                    <label for="nZGJCRJiHz">Ansible</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="qEdYJuQMRD">
                    <label for="qEdYJuQMRD">Architecture</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="GJJrAYaFDE">
                    <label for="GJJrAYaFDE">Computer Graphics</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="oeQmZYjbSt">
                    <label for="oeQmZYjbSt">Databases</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="BTLeMSLzZF">
                    <label for="BTLeMSLzZF">Devops</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="uxhIwNcBpR">
                            <label for="uxhIwNcBpR">Cloud Providers</label>
                            <ul>
                                <l>
                                    <input type="checkbox" id="mXSFhkYkIH">
                                    <label for="mXSFhkYkIH">AWS</label>
                                    <ul>
                                        <l>
                                            <input type="checkbox" id="bgwMjAPmJV">
                                            <label for="bgwMjAPmJV">Cli</label>
                                            <ul>
                                        ...
                                        <l>
                                            <input type="checkbox" id="luCGEDBvrd">
                                            <label for="luCGEDBvrd">Dotnet</label>
                                            <ul>
                                        ...
                                        <l>
                                            <input type="checkbox" id="aDGOIIkLSH">
                                            <label for="aDGOIIkLSH">Ec 2</label>
                                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="NDynAQBzpp">
                            <label for="NDynAQBzpp">Events</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="jDTirkeoba">
                            <label for="jDTirkeoba">Localstack</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="joVUaeqXNM">
                            <label for="joVUaeqXNM">Pulumi</label>
                            <ul>
                                <l>
                                    <input type="checkbox" id="IjdtHNaeJc">
                                    <label for="IjdtHNaeJc">Dotnet</label>
                                    <ul>
                        ...
                        <l>
                            <input type="checkbox" id="WhDQUeybXk">
                            <label for="WhDQUeybXk">Serverless Framework</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="vqBqUhldro">
                            <label for="vqBqUhldro">Terraform</label>
                            <ul>
                                <l>
                                    <input type="checkbox" id="QGoJlPyQIx">
                                    <label for="QGoJlPyQIx">Functions</label>
                                    <ul>
                                ...
                                <l>
                                    <input type="checkbox" id="xrNIThjIAt">
                                    <label for="xrNIThjIAt">Meta Arguments</label>
                                    <ul>
                ...
                <l>
                    <input type="checkbox" id="VfYEmZNdav">
                    <label for="VfYEmZNdav">Docker</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="kmlPTXMgKN">
                    <label for="kmlPTXMgKN">Dotnet</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="uswCPXchzE">
                            <label for="uswCPXchzE">Cli</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="ofaxkUhBMH">
                    <label for="ofaxkUhBMH">Functional Programming</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="tlkeFoPOkK">
                    <label for="tlkeFoPOkK">Git</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="bZamBnOqjK">
                            <label for="bZamBnOqjK">Github</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="FfnwyEHAoy">
                    <label for="FfnwyEHAoy">Go</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="NqiAtDRZKa">
                    <label for="NqiAtDRZKa">Haskell</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="TwPUNrXhNI">
                    <label for="TwPUNrXhNI">Js</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="rDorwOdcfM">
                            <label for="rDorwOdcfM">Node</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="WguKwtQEaa">
                            <label for="WguKwtQEaa">D3</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="gHpxJyIVTc">
                            <label for="gHpxJyIVTc">Mocha</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="hVCvallxvP">
                            <label for="hVCvallxvP">P5js</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="cOQmRcEmOW">
                            <label for="cOQmRcEmOW">Typescript</label>
                            <ul>
                                <l>
                                    <input type="checkbox" id="ikHyCBbKVE">
                                    <label for="ikHyCBbKVE">Testing</label>
                                    <ul>
                ...
                <l>
                    <input type="checkbox" id="GySWYiXWkq">
                    <label for="GySWYiXWkq">Kafka</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="SDErxbFUJA">
                    <label for="SDErxbFUJA">Kubernetes</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="IlFsywzOUq">
                    <label for="IlFsywzOUq">Language</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="trFsntVsoH">
                    <label for="trFsntVsoH">Linux</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="zRpkapwaXl">
                            <label for="zRpkapwaXl">Bash</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="RatPAPgNZh">
                    <label for="RatPAPgNZh">Oauth</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="qTRbTkuAzi">
                    <label for="qTRbTkuAzi">Python</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="BDuVkCDeSs">
                            <label for="BDuVkCDeSs">Data Classes</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="BBDdPRPsYX">
                            <label for="BBDdPRPsYX">Libraries</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="MWoZNVcDcd">
                    <label for="MWoZNVcDcd">React</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="tHYoluCFqW">
                    <label for="tHYoluCFqW">Regular Expressions</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="BjbqQtHzGq">
                    <label for="BjbqQtHzGq">Rust</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="VWCclEycFI">
                            <label for="VWCclEycFI">Serde</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="lObaMtdCrC">
                    <label for="lObaMtdCrC">Shaders</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="WZGbCBVdDF">
                            <label for="WZGbCBVdDF">Glsl</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="nkOJKXgrrK">
                    <label for="nkOJKXgrrK">Vim</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="XavGpxUfaU">
                    <label for="XavGpxUfaU">Web</label>
                    <ul>
