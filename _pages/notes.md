...
<ul>
    <div name="contents-index">
        ...
        <l>
            <input type="checkbox" id="lTIwpKIZhn" checked>
            <label for="lTIwpKIZhn">Math</label>
            <ul>
                <l>
                    <input type="checkbox" id="TiLGNONnGF">
                    <label for="TiLGNONnGF">Exponentials</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="sqqbjqoBNd">
                    <label for="sqqbjqoBNd">Linear Algebra</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="OOtwpafwQE">
                    <label for="OOtwpafwQE">Logarithms</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="PgRJnZdTvY">
                    <label for="PgRJnZdTvY">Sequences</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="OnBqinqoCL">
                    <label for="OnBqinqoCL">Single Variable Calculus</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="HkATSppFdw">
                    <label for="HkATSppFdw">Trigonometry</label>
                    <ul>
        ...
        <l>
            <input type="checkbox" id="BNiaEzizYU" checked>
            <label for="BNiaEzizYU">Programming</label>
            <ul>
                <l>
                    <input type="checkbox" id="IRlZJlradS">
                    <label for="IRlZJlradS">Ansible</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="LeugCcZdCh">
                    <label for="LeugCcZdCh">Architecture</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="jkNFeUQxiu">
                    <label for="jkNFeUQxiu">Computer Graphics</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="jWTMDHGcYz">
                    <label for="jWTMDHGcYz">Databases</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="gpAhcunCOG">
                    <label for="gpAhcunCOG">Devops</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="LuwYngBkUz">
                            <label for="LuwYngBkUz">Cloud Providers</label>
                            <ul>
                                <l>
                                    <input type="checkbox" id="qPoCbYqXWD">
                                    <label for="qPoCbYqXWD">AWS</label>
                                    <ul>
                                        <l>
                                            <input type="checkbox" id="ETDUyDQHiP">
                                            <label for="ETDUyDQHiP">Cli</label>
                                            <ul>
                                        ...
                                        <l>
                                            <input type="checkbox" id="CwGkQcTNup">
                                            <label for="CwGkQcTNup">Dotnet</label>
                                            <ul>
                                        ...
                                        <l>
                                            <input type="checkbox" id="LhLUuIdfLa">
                                            <label for="LhLUuIdfLa">Ec 2</label>
                                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="TRGQyQvDqy">
                            <label for="TRGQyQvDqy">Events</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="lCAMjHtuWm">
                            <label for="lCAMjHtuWm">Localstack</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="mGKZLanYcU">
                            <label for="mGKZLanYcU">Pulumi</label>
                            <ul>
                                <l>
                                    <input type="checkbox" id="PwQrYWygze">
                                    <label for="PwQrYWygze">Dotnet</label>
                                    <ul>
                        ...
                        <l>
                            <input type="checkbox" id="GoUESlJSak">
                            <label for="GoUESlJSak">Serverless Framework</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="MVFDNZyPHi">
                            <label for="MVFDNZyPHi">Terraform</label>
                            <ul>
                                <l>
                                    <input type="checkbox" id="hpaESzUhWf">
                                    <label for="hpaESzUhWf">Functions</label>
                                    <ul>
                                ...
                                <l>
                                    <input type="checkbox" id="AOOIShwZcZ">
                                    <label for="AOOIShwZcZ">Meta Arguments</label>
                                    <ul>
                ...
                <l>
                    <input type="checkbox" id="PeQEhSyItw">
                    <label for="PeQEhSyItw">Docker</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="cKWldqRdde">
                    <label for="cKWldqRdde">Dotnet</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="ABWQbxdqTo">
                            <label for="ABWQbxdqTo">Cli</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="dAfFnzoPoW">
                    <label for="dAfFnzoPoW">Functional Programming</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="kqatEFeJGZ">
                    <label for="kqatEFeJGZ">Git</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="nNOhRQLnEN">
                            <label for="nNOhRQLnEN">Github</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="fQFtPiKLRh">
                    <label for="fQFtPiKLRh">Go</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="CHFnvnmsPv">
                    <label for="CHFnvnmsPv">Haskell</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="mTOaFnjlJf">
                    <label for="mTOaFnjlJf">Js</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="eyVVmTyViK">
                            <label for="eyVVmTyViK">Node</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="mmqmZjRdWv">
                            <label for="mmqmZjRdWv">D3</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="JgBpRpxGkI">
                            <label for="JgBpRpxGkI">Mocha</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="eaixqxptzl">
                            <label for="eaixqxptzl">P5js</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="kNgnUdLdWZ">
                            <label for="kNgnUdLdWZ">Typescript</label>
                            <ul>
                                <l>
                                    <input type="checkbox" id="RAFgtuPGoY">
                                    <label for="RAFgtuPGoY">Testing</label>
                                    <ul>
                ...
                <l>
                    <input type="checkbox" id="kEKjDLHlHO">
                    <label for="kEKjDLHlHO">Kafka</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="TRHOJOLoYa">
                    <label for="TRHOJOLoYa">Kubernetes</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="jkOZNEQxjf">
                    <label for="jkOZNEQxjf">Language</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="xIufuRMpZR">
                    <label for="xIufuRMpZR">Linux</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="aFGqaEVOUK">
                            <label for="aFGqaEVOUK">Bash</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="vJRvLjVLkG">
                    <label for="vJRvLjVLkG">Oauth</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="haDMOEgkin">
                    <label for="haDMOEgkin">Prometheus</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="WTJUjuSNWW">
                    <label for="WTJUjuSNWW">Python</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="lsIRTIUavu">
                            <label for="lsIRTIUavu">Data Classes</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="sZpcalxRvJ">
                            <label for="sZpcalxRvJ">Libraries</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="OzMUKDqVYB">
                    <label for="OzMUKDqVYB">React</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="zdNnqpDLqy">
                    <label for="zdNnqpDLqy">Regular Expressions</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="jhMdpkjgMC">
                    <label for="jhMdpkjgMC">Rust</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="DKrumbmrSs">
                            <label for="DKrumbmrSs">Serde</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="LKBQzsEUbF">
                    <label for="LKBQzsEUbF">Shaders</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="joMnYKdflk">
                            <label for="joMnYKdflk">Glsl</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="eewiyWmjTG">
                    <label for="eewiyWmjTG">Vim</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="zkucIYnlCJ">
                    <label for="zkucIYnlCJ">Web</label>
                    <ul>
