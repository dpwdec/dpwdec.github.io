...
<ul>
    <div name="contents-index">
        ...
        <l>
            <input type="checkbox" id="mdPyJkAVtR" checked>
            <label for="mdPyJkAVtR">Math</label>
            <ul>
                <l>
                    <input type="checkbox" id="tgnAYldvJC">
                    <label for="tgnAYldvJC">Exponentials</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="CTNiHBeTbg">
                    <label for="CTNiHBeTbg">Linear Algebra</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="DpJcrUDbZJ">
                    <label for="DpJcrUDbZJ">Logarithms</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="OKGNZfMCSa">
                    <label for="OKGNZfMCSa">Sequences</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="TqDxeIccmo">
                    <label for="TqDxeIccmo">Single Variable Calculus</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="CenLTYNOiF">
                    <label for="CenLTYNOiF">Trigonometry</label>
                    <ul>
        ...
        <l>
            <input type="checkbox" id="ZZhPWKuXOT" checked>
            <label for="ZZhPWKuXOT">Programming</label>
            <ul>
                <l>
                    <input type="checkbox" id="JlTFruskDa">
                    <label for="JlTFruskDa">Ansible</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="TuIYzkEmqW">
                    <label for="TuIYzkEmqW">Architecture</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="AlpfljbRlM">
                    <label for="AlpfljbRlM">Computer Graphics</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="OnPKVWSsbM">
                    <label for="OnPKVWSsbM">Databases</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="xPeoacIIaf">
                    <label for="xPeoacIIaf">Devops</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="gHCmrPwSwu">
                            <label for="gHCmrPwSwu">Cloud Providers</label>
                            <ul>
                                <l>
                                    <input type="checkbox" id="QZwDXPYgZB">
                                    <label for="QZwDXPYgZB">AWS</label>
                                    <ul>
                                        <l>
                                            <input type="checkbox" id="hwwXpZteiG">
                                            <label for="hwwXpZteiG">Cli</label>
                                            <ul>
                                        ...
                                        <l>
                                            <input type="checkbox" id="saOYrXVPBm">
                                            <label for="saOYrXVPBm">Dotnet</label>
                                            <ul>
                                        ...
                                        <l>
                                            <input type="checkbox" id="OTtwFeaXbX">
                                            <label for="OTtwFeaXbX">Ec 2</label>
                                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="TZlFDsSvzJ">
                            <label for="TZlFDsSvzJ">Events</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="CybpoPRNHz">
                            <label for="CybpoPRNHz">Localstack</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="xgPrrgBauh">
                            <label for="xgPrrgBauh">Pulumi</label>
                            <ul>
                                <l>
                                    <input type="checkbox" id="VLQWbvIHYo">
                                    <label for="VLQWbvIHYo">Dotnet</label>
                                    <ul>
                        ...
                        <l>
                            <input type="checkbox" id="OPWaoVxBgT">
                            <label for="OPWaoVxBgT">Serverless Framework</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="eIxUFTgZnS">
                            <label for="eIxUFTgZnS">Terraform</label>
                            <ul>
                                <l>
                                    <input type="checkbox" id="RgStCNlHgc">
                                    <label for="RgStCNlHgc">Functions</label>
                                    <ul>
                                ...
                                <l>
                                    <input type="checkbox" id="YKpnWbolGK">
                                    <label for="YKpnWbolGK">Meta Arguments</label>
                                    <ul>
                ...
                <l>
                    <input type="checkbox" id="XoNQmEbyrU">
                    <label for="XoNQmEbyrU">Docker</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="eooyWZMnum">
                    <label for="eooyWZMnum">Dotnet</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="dDLJeKIDec">
                            <label for="dDLJeKIDec">Cli</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="YlEkrvjioY">
                    <label for="YlEkrvjioY">Functional Programming</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="WHnjQAVcVO">
                    <label for="WHnjQAVcVO">Git</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="uypKNLaImz">
                            <label for="uypKNLaImz">Github</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="WQVKgwdKak">
                    <label for="WQVKgwdKak">Go</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="HvBUMGIwGK">
                    <label for="HvBUMGIwGK">Haskell</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="hHTvzmZgXD">
                    <label for="hHTvzmZgXD">Js</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="HIkiXtOuvE">
                            <label for="HIkiXtOuvE">Node</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="oUozFQPTfm">
                            <label for="oUozFQPTfm">D3</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="daifBrIEho">
                            <label for="daifBrIEho">Mocha</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="JNNBoMFnzB">
                            <label for="JNNBoMFnzB">P5js</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="XLCHaQXsVY">
                            <label for="XLCHaQXsVY">Typescript</label>
                            <ul>
                                <l>
                                    <input type="checkbox" id="oeVgMBkFxc">
                                    <label for="oeVgMBkFxc">Testing</label>
                                    <ul>
                ...
                <l>
                    <input type="checkbox" id="HIDTlzWoOL">
                    <label for="HIDTlzWoOL">Kafka</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="aqqQNeENls">
                    <label for="aqqQNeENls">Kubernetes</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="GxJFbvjuSv">
                    <label for="GxJFbvjuSv">Language</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="WOOXgZjoRk">
                    <label for="WOOXgZjoRk">Linux</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="NjVBVCaBYV">
                            <label for="NjVBVCaBYV">Bash</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="ccvVALietl">
                    <label for="ccvVALietl">Oauth</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="ySNhmfkgll">
                    <label for="ySNhmfkgll">Prometheus</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="yVjiwKifRu">
                    <label for="yVjiwKifRu">Python</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="TKvFFJULeq">
                            <label for="TKvFFJULeq">Data Classes</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="pidQkIamPW">
                            <label for="pidQkIamPW">Libraries</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="UOOpaZICOP">
                    <label for="UOOpaZICOP">React</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="RpbpNpTcwa">
                    <label for="RpbpNpTcwa">Regular Expressions</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="WukQGRDdJk">
                    <label for="WukQGRDdJk">Rust</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="OGslBbuhKk">
                            <label for="OGslBbuhKk">Serde</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="AQClymmRNm">
                    <label for="AQClymmRNm">Shaders</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="lhdsfmmPAl">
                            <label for="lhdsfmmPAl">Glsl</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="bPfQfcKkdv">
                    <label for="bPfQfcKkdv">Vim</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="jsNTnIWCyf">
                    <label for="jsNTnIWCyf">Web</label>
                    <ul>
