...
<ul>
    <div name="contents-index">
        ...
        <l>
            <input type="checkbox" id="eCLYRISqXl" checked>
            <label for="eCLYRISqXl">Math</label>
            <ul>
                <l>
                    <input type="checkbox" id="eMtFJksoda">
                    <label for="eMtFJksoda">Exponentials</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="xjpjHsIITe">
                    <label for="xjpjHsIITe">Linear Algebra</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="iaHCImEPNA">
                    <label for="iaHCImEPNA">Logarithms</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="ZydSXbguYt">
                    <label for="ZydSXbguYt">Sequences</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="ltkabXcHwB">
                    <label for="ltkabXcHwB">Single Variable Calculus</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="sbVMzOKhbC">
                    <label for="sbVMzOKhbC">Trigonometry</label>
                    <ul>
        ...
        <l>
            <input type="checkbox" id="GUQXdTAgLy" checked>
            <label for="GUQXdTAgLy">Programming</label>
            <ul>
                <l>
                    <input type="checkbox" id="xgqrMVqqld">
                    <label for="xgqrMVqqld">Ansible</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="PMhBgFExoK">
                    <label for="PMhBgFExoK">Architecture</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="VbMEhNgHkG">
                    <label for="VbMEhNgHkG">Computer Graphics</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="lwBAtinXWD">
                    <label for="lwBAtinXWD">Databases</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="TawHGczAhy">
                    <label for="TawHGczAhy">Devops</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="kIMFVWHgWX">
                            <label for="kIMFVWHgWX">Cloud Providers</label>
                            <ul>
                                <l>
                                    <input type="checkbox" id="ZCJJgTZqyE">
                                    <label for="ZCJJgTZqyE">AWS</label>
                                    <ul>
                                        <l>
                                            <input type="checkbox" id="YBSODDCWsS">
                                            <label for="YBSODDCWsS">Cli</label>
                                            <ul>
                                        ...
                                        <l>
                                            <input type="checkbox" id="GQlwlvTpAF">
                                            <label for="GQlwlvTpAF">Dotnet</label>
                                            <ul>
                                        ...
                                        <l>
                                            <input type="checkbox" id="jJZMYBUlzU">
                                            <label for="jJZMYBUlzU">Ec 2</label>
                                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="CMdqQjlxff">
                            <label for="CMdqQjlxff">Events</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="airBFXwGtK">
                            <label for="airBFXwGtK">Localstack</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="hGuTFpHmaW">
                            <label for="hGuTFpHmaW">Pulumi</label>
                            <ul>
                                <l>
                                    <input type="checkbox" id="cuwFNpHsqF">
                                    <label for="cuwFNpHsqF">Dotnet</label>
                                    <ul>
                        ...
                        <l>
                            <input type="checkbox" id="LIooaTOGyG">
                            <label for="LIooaTOGyG">Serverless Framework</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="FnOiHYoxYk">
                            <label for="FnOiHYoxYk">Terraform</label>
                            <ul>
                                <l>
                                    <input type="checkbox" id="KkdsMbpHbY">
                                    <label for="KkdsMbpHbY">Functions</label>
                                    <ul>
                                ...
                                <l>
                                    <input type="checkbox" id="ZDPxUPrRvc">
                                    <label for="ZDPxUPrRvc">Meta Arguments</label>
                                    <ul>
                ...
                <l>
                    <input type="checkbox" id="pGlvvlEvyS">
                    <label for="pGlvvlEvyS">Docker</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="pRKWdtQPEr">
                    <label for="pRKWdtQPEr">Dotnet</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="jFUGqfiIXK">
                            <label for="jFUGqfiIXK">Cli</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="uYypqqzoPL">
                    <label for="uYypqqzoPL">Functional Programming</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="GvzAjFSKwr">
                    <label for="GvzAjFSKwr">Git</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="iSpOpJEnJI">
                            <label for="iSpOpJEnJI">Github</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="ndbyuLeIOT">
                    <label for="ndbyuLeIOT">Go</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="eivUsYrNhY">
                    <label for="eivUsYrNhY">Haskell</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="wvHXKDuDPv">
                    <label for="wvHXKDuDPv">Js</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="UmOCdtSnyv">
                            <label for="UmOCdtSnyv">Node</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="CdLOgzUsVp">
                            <label for="CdLOgzUsVp">D3</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="ZsfweRueGm">
                            <label for="ZsfweRueGm">Mocha</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="BrahQyayuZ">
                            <label for="BrahQyayuZ">P5js</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="BJtdTwyleZ">
                            <label for="BJtdTwyleZ">Typescript</label>
                            <ul>
                                <l>
                                    <input type="checkbox" id="NExhTnqnGE">
                                    <label for="NExhTnqnGE">Testing</label>
                                    <ul>
                ...
                <l>
                    <input type="checkbox" id="lEQUmHLzgg">
                    <label for="lEQUmHLzgg">Kafka</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="PKsQIGIjVI">
                    <label for="PKsQIGIjVI">Kubernetes</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="sokTxAfmLj">
                    <label for="sokTxAfmLj">Language</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="dfLtpelcTT">
                    <label for="dfLtpelcTT">Linux</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="guJaSEHScZ">
                            <label for="guJaSEHScZ">Bash</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="HLRFlpecSe">
                    <label for="HLRFlpecSe">Oauth</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="AyOEMTFbcd">
                    <label for="AyOEMTFbcd">Prometheus</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="wEIyOIqYyP">
                    <label for="wEIyOIqYyP">Python</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="dibvjlTAKi">
                            <label for="dibvjlTAKi">Data Classes</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="YXLanOCDUe">
                            <label for="YXLanOCDUe">Libraries</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="sbdokGChNS">
                    <label for="sbdokGChNS">React</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="NvtZzIamnE">
                    <label for="NvtZzIamnE">Regular Expressions</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="lsGJKzuOVy">
                    <label for="lsGJKzuOVy">Rust</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="SvnqmKJNqW">
                            <label for="SvnqmKJNqW">Serde</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="vhDqRKdxqc">
                    <label for="vhDqRKdxqc">Shaders</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="dnwcpKKPcT">
                            <label for="dnwcpKKPcT">Glsl</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="OQnYrhoMRd">
                    <label for="OQnYrhoMRd">Vim</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="bDMabyTnbh">
                    <label for="bDMabyTnbh">Web</label>
                    <ul>
