...
<ul>
    <div name="contents-index">
        ...
        <l>
            <input type="checkbox" id="VpnGlKpZxn" checked>
            <label for="VpnGlKpZxn">Math</label>
            <ul>
                <l>
                    <input type="checkbox" id="hykPzDavgF">
                    <label for="hykPzDavgF">Exponentials</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="AeUpPWJwlb">
                    <label for="AeUpPWJwlb">Linear Algebra</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="PAidZJaiYL">
                    <label for="PAidZJaiYL">Logarithms</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="hZNhGKlZqi">
                    <label for="hZNhGKlZqi">Sequences</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="PRZGJhyBOh">
                    <label for="PRZGJhyBOh">Single Variable Calculus</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="sRXZgEesSJ">
                    <label for="sRXZgEesSJ">Trigonometry</label>
                    <ul>
        ...
        <l>
            <input type="checkbox" id="JuTITEdFlM" checked>
            <label for="JuTITEdFlM">Programming</label>
            <ul>
                <l>
                    <input type="checkbox" id="JuVAgLJFxe">
                    <label for="JuVAgLJFxe">Ansible</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="rBHVyoQodv">
                    <label for="rBHVyoQodv">Architecture</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="BNHCGzUroV">
                    <label for="BNHCGzUroV">Computer Graphics</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="nqibhMGePw">
                    <label for="nqibhMGePw">Databases</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="lOHUtEuzyY">
                    <label for="lOHUtEuzyY">Devops</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="xJjXWVaFsv">
                            <label for="xJjXWVaFsv">Cloud Providers</label>
                            <ul>
                                <l>
                                    <input type="checkbox" id="WpuiLaJsQo">
                                    <label for="WpuiLaJsQo">AWS</label>
                                    <ul>
                                        <l>
                                            <input type="checkbox" id="AKQDbpCQeh">
                                            <label for="AKQDbpCQeh">Cli</label>
                                            <ul>
                                        ...
                                        <l>
                                            <input type="checkbox" id="ZgJHdHekgf">
                                            <label for="ZgJHdHekgf">Dotnet</label>
                                            <ul>
                                        ...
                                        <l>
                                            <input type="checkbox" id="EXfUpBwVID">
                                            <label for="EXfUpBwVID">Ec 2</label>
                                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="kqWBYEEpty">
                            <label for="kqWBYEEpty">Events</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="sCwXudaAvK">
                            <label for="sCwXudaAvK">Localstack</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="vdzWWLtPoc">
                            <label for="vdzWWLtPoc">Pulumi</label>
                            <ul>
                                <l>
                                    <input type="checkbox" id="zkUebFVxbE">
                                    <label for="zkUebFVxbE">Dotnet</label>
                                    <ul>
                        ...
                        <l>
                            <input type="checkbox" id="khZzxIntfQ">
                            <label for="khZzxIntfQ">Serverless Framework</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="XecgCKOohr">
                            <label for="XecgCKOohr">Terraform</label>
                            <ul>
                                <l>
                                    <input type="checkbox" id="qDNMmLvnrx">
                                    <label for="qDNMmLvnrx">Functions</label>
                                    <ul>
                                ...
                                <l>
                                    <input type="checkbox" id="SiVdaeOseP">
                                    <label for="SiVdaeOseP">Meta Arguments</label>
                                    <ul>
                ...
                <l>
                    <input type="checkbox" id="rKCYmQRWvh">
                    <label for="rKCYmQRWvh">Docker</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="HpEedAALzm">
                    <label for="HpEedAALzm">Dotnet</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="cwIHHufEGQ">
                            <label for="cwIHHufEGQ">Cli</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="oCMkAjEXbF">
                    <label for="oCMkAjEXbF">Functional Programming</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="WhxNFStDkX">
                    <label for="WhxNFStDkX">Git</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="rskMrMTMDc">
                            <label for="rskMrMTMDc">Github</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="uCGssstdEl">
                    <label for="uCGssstdEl">Go</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="hgInofWnOE">
                    <label for="hgInofWnOE">Haskell</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="bGvbeGqISe">
                    <label for="bGvbeGqISe">Js</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="liVoOAGJJd">
                            <label for="liVoOAGJJd">Node</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="AsrwDJoYAO">
                            <label for="AsrwDJoYAO">D3</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="lTTLospqbJ">
                            <label for="lTTLospqbJ">Mocha</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="JpSYeMggyP">
                            <label for="JpSYeMggyP">P5js</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="PMFySbapMD">
                            <label for="PMFySbapMD">Typescript</label>
                            <ul>
                                <l>
                                    <input type="checkbox" id="qCCdHhnFHO">
                                    <label for="qCCdHhnFHO">Testing</label>
                                    <ul>
                ...
                <l>
                    <input type="checkbox" id="lrmfwYGkin">
                    <label for="lrmfwYGkin">Kafka</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="DkhDTiSlRF">
                    <label for="DkhDTiSlRF">Kubernetes</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="bmJESSHdvG">
                    <label for="bmJESSHdvG">Language</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="WTeFMCbubp">
                    <label for="WTeFMCbubp">Linux</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="PQpHPDfxcu">
                            <label for="PQpHPDfxcu">Bash</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="syQgnRKmiO">
                    <label for="syQgnRKmiO">Oauth</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="jkUDzqSrsK">
                    <label for="jkUDzqSrsK">Python</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="FTvTTjdlJV">
                            <label for="FTvTTjdlJV">Data Classes</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="rZeQhnIFTy">
                            <label for="rZeQhnIFTy">Libraries</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="dXkUfsnBIo">
                    <label for="dXkUfsnBIo">React</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="PGShaotwGG">
                    <label for="PGShaotwGG">Regular Expressions</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="GQcUpClHLw">
                    <label for="GQcUpClHLw">Rust</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="EqFmKgMiLS">
                            <label for="EqFmKgMiLS">Serde</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="obSEKKyZVe">
                    <label for="obSEKKyZVe">Vim</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="jQJxayMIAj">
                    <label for="jQJxayMIAj">Web</label>
                    <ul>
