...
<ul>
    <div name="contents-index">
        ...
        <l>
            <input type="checkbox" id="tdHHEHcfYn" checked>
            <label for="tdHHEHcfYn">Math</label>
            <ul>
                <l>
                    <input type="checkbox" id="jtFCDkYQsc">
                    <label for="jtFCDkYQsc">Exponentials</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="wERSbIIaBE">
                    <label for="wERSbIIaBE">Linear Algebra</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="gkEIjJcIkZ">
                    <label for="gkEIjJcIkZ">Logarithms</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="mWGFqJCNSC">
                    <label for="mWGFqJCNSC">Sequences</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="CTeJbJoHuK">
                    <label for="CTeJbJoHuK">Single Variable Calculus</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="zkcStNxGku">
                    <label for="zkcStNxGku">Trigonometry</label>
                    <ul>
        ...
        <l>
            <input type="checkbox" id="XaLYbWctDx" checked>
            <label for="XaLYbWctDx">Programming</label>
            <ul>
                <l>
                    <input type="checkbox" id="aFptcahuPX">
                    <label for="aFptcahuPX">Ansible</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="yqLOeNOZle">
                    <label for="yqLOeNOZle">Architecture</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="ZNWHmdFEif">
                    <label for="ZNWHmdFEif">Computer Graphics</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="qyorICdRcu">
                    <label for="qyorICdRcu">Databases</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="IkVJYgyqfU">
                    <label for="IkVJYgyqfU">Devops</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="YnRODtxHqS">
                            <label for="YnRODtxHqS">Cloud Providers</label>
                            <ul>
                                <l>
                                    <input type="checkbox" id="ZCszFXvVGZ">
                                    <label for="ZCszFXvVGZ">AWS</label>
                                    <ul>
                                        <l>
                                            <input type="checkbox" id="roZWkzYWOk">
                                            <label for="roZWkzYWOk">Cli</label>
                                            <ul>
                                        ...
                                        <l>
                                            <input type="checkbox" id="mCbqfcJyWL">
                                            <label for="mCbqfcJyWL">Dotnet</label>
                                            <ul>
                                        ...
                                        <l>
                                            <input type="checkbox" id="ejHMwzeUWZ">
                                            <label for="ejHMwzeUWZ">Ec 2</label>
                                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="JsJBQsQggy">
                            <label for="JsJBQsQggy">Events</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="ZPGZQzQgJZ">
                            <label for="ZPGZQzQgJZ">Localstack</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="uSnlbWvVSJ">
                            <label for="uSnlbWvVSJ">Pulumi</label>
                            <ul>
                                <l>
                                    <input type="checkbox" id="CTvipsQEsv">
                                    <label for="CTvipsQEsv">Dotnet</label>
                                    <ul>
                        ...
                        <l>
                            <input type="checkbox" id="SgAjuMqjtw">
                            <label for="SgAjuMqjtw">Serverless Framework</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="qAfPVWhuhl">
                            <label for="qAfPVWhuhl">Terraform</label>
                            <ul>
                                <l>
                                    <input type="checkbox" id="rApmsuQVwI">
                                    <label for="rApmsuQVwI">Functions</label>
                                    <ul>
                                ...
                                <l>
                                    <input type="checkbox" id="sFKpeeOOYI">
                                    <label for="sFKpeeOOYI">Meta Arguments</label>
                                    <ul>
                ...
                <l>
                    <input type="checkbox" id="GPaGSSBulW">
                    <label for="GPaGSSBulW">Docker</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="AHedwkwcMl">
                    <label for="AHedwkwcMl">Dotnet</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="rBBGSPgdvm">
                            <label for="rBBGSPgdvm">Cli</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="aiEXIyIKGA">
                    <label for="aiEXIyIKGA">Functional Programming</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="UnhqETSvUG">
                    <label for="UnhqETSvUG">Git</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="opPVaOHpiM">
                            <label for="opPVaOHpiM">Github</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="XlGcTSAjMa">
                    <label for="XlGcTSAjMa">Go</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="qKvnWDoJyk">
                    <label for="qKvnWDoJyk">Haskell</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="JvYrLHybaE">
                    <label for="JvYrLHybaE">Js</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="DSCWrOAxdy">
                            <label for="DSCWrOAxdy">Node</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="wzHxpMeXiy">
                            <label for="wzHxpMeXiy">D3</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="OnuEwiHxlk">
                            <label for="OnuEwiHxlk">Mocha</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="sdAErPkRXr">
                            <label for="sdAErPkRXr">P5js</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="RJvLpvkixu">
                            <label for="RJvLpvkixu">Typescript</label>
                            <ul>
                                <l>
                                    <input type="checkbox" id="DzZboltobQ">
                                    <label for="DzZboltobQ">Testing</label>
                                    <ul>
                ...
                <l>
                    <input type="checkbox" id="PmwLUPlcqS">
                    <label for="PmwLUPlcqS">Kafka</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="YoGiichrgD">
                    <label for="YoGiichrgD">Kubernetes</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="QUtWahlWTC">
                    <label for="QUtWahlWTC">Language</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="ZSYgYCpzro">
                    <label for="ZSYgYCpzro">Linux</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="uasEKsATzG">
                            <label for="uasEKsATzG">Bash</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="YbrBSddEev">
                    <label for="YbrBSddEev">Oauth</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="vtkLXRYGrT">
                    <label for="vtkLXRYGrT">Prometheus</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="hRAHbpkBzU">
                    <label for="hRAHbpkBzU">Python</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="srSgwELmQE">
                            <label for="srSgwELmQE">Data Classes</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="plOfYPqBDS">
                            <label for="plOfYPqBDS">Libraries</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="nKsgobwhLC">
                    <label for="nKsgobwhLC">React</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="nuCfiboNXk">
                    <label for="nuCfiboNXk">Regular Expressions</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="VYVseJqxkM">
                    <label for="VYVseJqxkM">Rust</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="QCSZgHPERZ">
                            <label for="QCSZgHPERZ">Serde</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="HuDMgdkNSW">
                    <label for="HuDMgdkNSW">Shaders</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="qlllfMoArb">
                            <label for="qlllfMoArb">Glsl</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="DyfsepXFbj">
                    <label for="DyfsepXFbj">Vim</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="ZUoSigMzZx">
                    <label for="ZUoSigMzZx">Web</label>
                    <ul>
