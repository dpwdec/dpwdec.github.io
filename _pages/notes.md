...
<ul>
    <div name="contents-index">
        ...
        <l>
            <input type="checkbox" id="OQOdplmpWR" checked>
            <label for="OQOdplmpWR">Math</label>
            <ul>
                <l>
                    <input type="checkbox" id="qpkpFwKEJY">
                    <label for="qpkpFwKEJY">Exponentials</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="xoaOShxEdX">
                    <label for="xoaOShxEdX">Linear Algebra</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="lPXcUTUasO">
                    <label for="lPXcUTUasO">Logarithms</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="ShInBucgvC">
                    <label for="ShInBucgvC">Sequences</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="MswOlVMRvy">
                    <label for="MswOlVMRvy">Single Variable Calculus</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="gNOVggLFXU">
                    <label for="gNOVggLFXU">Trigonometry</label>
                    <ul>
        ...
        <l>
            <input type="checkbox" id="yehmbgglEb" checked>
            <label for="yehmbgglEb">Programming</label>
            <ul>
                <l>
                    <input type="checkbox" id="JdxwoHWofI">
                    <label for="JdxwoHWofI">Ansible</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="JITnQHhSRF">
                    <label for="JITnQHhSRF">Architecture</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="MxhYcBFUNL">
                    <label for="MxhYcBFUNL">Computer Graphics</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="BELUaEIFgK">
                    <label for="BELUaEIFgK">Databases</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="laVNCqIDFm">
                    <label for="laVNCqIDFm">Devops</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="fQumzLSDcm">
                            <label for="fQumzLSDcm">Cloud Providers</label>
                            <ul>
                                <l>
                                    <input type="checkbox" id="jJtnVcbiUx">
                                    <label for="jJtnVcbiUx">AWS</label>
                                    <ul>
                                        <l>
                                            <input type="checkbox" id="iWJMgDoPNi">
                                            <label for="iWJMgDoPNi">Cli</label>
                                            <ul>
                                        ...
                                        <l>
                                            <input type="checkbox" id="FDNgdkspyR">
                                            <label for="FDNgdkspyR">Dotnet</label>
                                            <ul>
                                        ...
                                        <l>
                                            <input type="checkbox" id="apLrkPKAXk">
                                            <label for="apLrkPKAXk">Ec 2</label>
                                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="PvWQVPdYPb">
                            <label for="PvWQVPdYPb">Events</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="KlZVjnraTP">
                            <label for="KlZVjnraTP">Localstack</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="JxlghlYbKC">
                            <label for="JxlghlYbKC">Pulumi</label>
                            <ul>
                                <l>
                                    <input type="checkbox" id="iwjVvcwAJz">
                                    <label for="iwjVvcwAJz">Dotnet</label>
                                    <ul>
                        ...
                        <l>
                            <input type="checkbox" id="qQvOTtKCXJ">
                            <label for="qQvOTtKCXJ">Serverless Framework</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="RzhbnVWbbi">
                            <label for="RzhbnVWbbi">Terraform</label>
                            <ul>
                                <l>
                                    <input type="checkbox" id="JlYIyygDqi">
                                    <label for="JlYIyygDqi">Functions</label>
                                    <ul>
                                ...
                                <l>
                                    <input type="checkbox" id="LeSdagMCDp">
                                    <label for="LeSdagMCDp">Meta Arguments</label>
                                    <ul>
                ...
                <l>
                    <input type="checkbox" id="fOShvXGmTj">
                    <label for="fOShvXGmTj">Docker</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="lFhDcKEzVX">
                    <label for="lFhDcKEzVX">Dotnet</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="hZGjtQaxHi">
                            <label for="hZGjtQaxHi">Cli</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="mZPOrOrDkD">
                    <label for="mZPOrOrDkD">Functional Programming</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="qoNHTDAkPb">
                    <label for="qoNHTDAkPb">Git</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="STutiaNqeJ">
                            <label for="STutiaNqeJ">Github</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="EFKlpinoKk">
                    <label for="EFKlpinoKk">Go</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="bJTovVyKGb">
                    <label for="bJTovVyKGb">Haskell</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="MfNbKIToby">
                    <label for="MfNbKIToby">Js</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="pDGkKCZPPd">
                            <label for="pDGkKCZPPd">Node</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="SZmHpzOvBu">
                            <label for="SZmHpzOvBu">D3</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="RlwlJiHWSx">
                            <label for="RlwlJiHWSx">Mocha</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="EdGMWHyyqT">
                            <label for="EdGMWHyyqT">P5js</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="IFRbzPViUz">
                            <label for="IFRbzPViUz">Typescript</label>
                            <ul>
                                <l>
                                    <input type="checkbox" id="OBEpaAOyAp">
                                    <label for="OBEpaAOyAp">Testing</label>
                                    <ul>
                ...
                <l>
                    <input type="checkbox" id="eYWKBBbBdd">
                    <label for="eYWKBBbBdd">Kafka</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="oOkYnuxWrw">
                    <label for="oOkYnuxWrw">Kubernetes</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="ZJDBsEotUt">
                    <label for="ZJDBsEotUt">Language</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="KkIFoyiMDq">
                    <label for="KkIFoyiMDq">Linux</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="wWHeYQGKIQ">
                            <label for="wWHeYQGKIQ">Bash</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="OVuQPoabwK">
                    <label for="OVuQPoabwK">Oauth</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="MUTGyWgLib">
                    <label for="MUTGyWgLib">Python</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="kxgooiIhWB">
                            <label for="kxgooiIhWB">Data Classes</label>
                            <ul>
                        ...
                        <l>
                            <input type="checkbox" id="sFEMarrfpk">
                            <label for="sFEMarrfpk">Libraries</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="MThLFJIDPL">
                    <label for="MThLFJIDPL">React</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="WnTlNpeVEc">
                    <label for="WnTlNpeVEc">Regular Expressions</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="xIfVdYjKuH">
                    <label for="xIfVdYjKuH">Rust</label>
                    <ul>
                        <l>
                            <input type="checkbox" id="OKkfvqyhkS">
                            <label for="OKkfvqyhkS">Serde</label>
                            <ul>
                ...
                <l>
                    <input type="checkbox" id="uDsAyYfPUp">
                    <label for="uDsAyYfPUp">Vim</label>
                    <ul>
                ...
                <l>
                    <input type="checkbox" id="gElBTyLXSw">
                    <label for="gElBTyLXSw">Web</label>
                    <ul>
