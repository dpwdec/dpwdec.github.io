...
You can **mock an integer's comparative operations** by reassigning the associated magic methods to a `mock` with a hard coded return value.
```py
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTE1ODcxMzM2NzMsLTYzODUyNjYyNiwtND
