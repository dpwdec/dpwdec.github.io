...
## Data
A **set** is a data storage object  that functions similarly to an array, the main difference being that it
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbODA1NDI3NzU2LC0xMTI1MTA1OTg1LC0xMT
U5NTI3MDQxXX0=
-->