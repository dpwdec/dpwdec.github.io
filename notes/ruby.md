...
```
The `require` gem modifier is a function designed to work with Rails. When setting up a Rails project there will be `config/application.rb` that will call `Bundler.require`
## Kernel Methods
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbNTU1NzIyNDc5LC0xMjEzOTg4NTQwLC0yOT
