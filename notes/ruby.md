...
```ruby
gem "my_gem" "~> 2.0" # give me a version of my gem that is in the category 2.0
gem "my_gem" "~> 2.5.0" # give me a version of my gem that is in the category 2.0
``` 
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbMTkzMDMxNDQ4NSwtMjkyMjE3NDI5LDk1Nz
