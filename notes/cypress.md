...
If you want to **execute server side configuration requests** during your Cypress tests you should use the `cy.task` method. This method takes the name of a task defined in the `plugins/inde
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTIxMDIyNzI5OCwtMTU2OTM4MzgzMSwtMj
